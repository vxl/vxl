...
IF(NOT HAS_NATIVE_MPEG)
  ...
  FIND_LIBRARY( NATIVE_MPEG2DEC_LIBRARY mpeg2dec
    /usr/local/lib
    /usr/lib
    /usr/local/livid/mpeg2dec/src/.libs
  )
  ...
  IF(NATIVE_MPEG_INCLUDE_PATH)
   IF(NATIVE_MPEG2_LIBRARY)
    IF(NATIVE_MPEG2DEC_LIBRARY)
      SET( HAS_NATIVE_MPEG "YES" )
      SET( NATIVE_MPEG_LIBRARIES ${NATIVE_MPEG2DEC_LIBRARY}
                                 ${NATIVE_MPEG2_LIBRARY}
                                 ${NATIVE_MPEG_VO_LIBRARY} )
    ENDIF(NATIVE_MPEG2DEC_LIBRARY)
