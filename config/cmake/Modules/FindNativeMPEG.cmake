...
IF(NOT HAS_NATIVE_MPEG)  
  ...
  FIND_LIBRARY( NATIVE_SDL_LIBRARY libSDL
    /usr/lib
    /usr/local/lib
  )
  ...
  IF(NATIVE_MPEG_INCLUDE_PATH)
    IF(NATIVE_MPEG_LIBRARY)
      IF(NATIVE_MPEG_VO_LIBRARY)
        IF(NATIVE_SDL_LIBRARY)
  
          SET( HAS_NATIVE_MPEG "YES" )
  
          INCLUDE_DIRECTORIES( ${NATIVE_MPEG_INCLUDE_PATH} )
          LINK_LIBRARIES( ${NATIVE_MPEG_LIBRARY} )
          LINK_LIBRARIES( ${NATIVE_MPEG_VO_LIBRARY} )
          LINK_LIBRARIES( ${NATIVE_SDL_LIBRARY})
 
        ENDIF(NATIVE_SDL_LIBRARY) 
      ENDIF(NATIVE_MPEG_VO_LIBRARY)
