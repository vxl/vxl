# Try to find OpenGL on UNIX systems.
...
IF(NOT HAS_OPENGL)
  ...
  ELSE (WIN32)
    ...
    FIND_PATH(OPENGL_XMESA_INCLUDE_PATH GL/xmesa.h
      /usr/share/doc/NVIDIA_GLX-1.0/include
      /usr/include
      /usr/local/include
      /usr/openwin/share/include
    ...
    IF(OPENGL_glu_LIBRARY)
      ...
      IF(OPENGL_XMESA_INCLUDE_PATH)
        SET( HAS_MESAGL "YES" )
        ADD_DEFINITIONS( -DMESA )
      ELSE(OPENGL_XMESA_INCLUDE_PATH)
        SET( HAS_MESAGL "NO" )
        ADD_DEFINITIONS( -DNO_MESA )
      ENDIF(OPENGL_XMESA_INCLUDE_PATH)
