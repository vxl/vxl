...
INCLUDE(${CMAKE_ROOT}/Modules/FindMFC.cmake)
 IF( WIN32 AND (EXISTS ${vxl_SOURCE_DIR}/v3p/j2k/Source/include/NCSEcw.h) AND WIN32SDK_FOUND AND MFC_FOUND)
  ...
  ENDIF( WIN32 AND (EXISTS ${vxl_SOURCE_DIR}/v3p/j2k/Source/include/NCSEcw.h)AND WIN32SDK_FOUND  AND MFC_FOUND)
 ENDIF( ECW_FOUND )
