...
ELSE( ECW_FOUND )
  ...
  IF( WIN32 AND WIN32SDK_FOUND AND MFC_FOUND AND EXISTS ${vxl_SOURCE_DIR}/v3p/j2k/Source/include/NCSEcw.h)
    SET( ECW_FOUND "YES" )
  ...
  ENDIF( WIN32 AND WIN32SDK_FOUND AND MFC_FOUND AND EXISTS ${vxl_SOURCE_DIR}/v3p/j2k/Source/include/NCSEcw.h)
ENDIF( ECW_FOUND )
