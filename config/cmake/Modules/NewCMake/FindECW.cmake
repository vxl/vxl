...
if(EXISTS ${CMAKE_SOURCE_DIR}/v3p/j2k/Source/include/NCSEcw.h )
if(EXISTS ${CMAKE_SOURCE_DIR}/v3p/j2k/Source/include/NCSUtil.h)
if(EXISTS ${CMAKE_SOURCE_DIR}/v3p/j2k/Source/include/NCScnet.h)
...
if( WIN32 AND J2K_SOURCES_FOUND AND WIN32SDK_FOUND AND MFC_FOUND)
    set( ECW_FOUND "YES" )
    set( ECW_INCLUDE_DIR ${CMAKE_SOURCE_DIR}/v3p/j2k/Source/include)
