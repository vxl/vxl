...
if(NOT VCL_CXX_HAS_HEADER_COMPLEX)
  message(FATAL_ERROR "Compiler is missing the <complex> header")
endif()
...
if(VCL_CXX_HAS_HEADER_COMPLEX)
  ...
  if(NOT VCL_COMPLEX_POW_WORKS)
     message(FATAL_ERROR "Pow function for complex numbers does not work for this compiler.")
  endif()
endif()
