...
/* (vcl_cv_cxx_has_bool=yes) (vcl_cv_cxx_has_bool=no) (vcl_cv_cxx_has_bool) */
...
/* (vcl_cv_cxx_has_typename=yes) (vcl_cv_cxx_has_typename=no) (vcl_cv_cxx_has_typename) */
...
/* (vcl_cv_cxx_has_export=yes) (vcl_cv_cxx_has_export=no) (vcl_cv_cxx_has_export) */
...
/* (vcl_cv_cxx_has_mutable=yes) (vcl_cv_cxx_has_mutable=no) (vcl_cv_cxx_has_mutable) */
...
/* (vcl_cv_cxx_has_explicit=yes) (vcl_cv_cxx_has_explicit=no) (vcl_cv_cxx_has_explicit) */
...
/* (vcl_cv_cxx_has_dynamic_cast=yes) (vcl_cv_cxx_has_dynamic_cast=no) (vcl_cv_cxx_has_dynamic_cast) */
...
/* (vcl_cv_cxx_check_for_scope=yes) (vcl_cv_cxx_check_for_scope=no) (vcl_cv_cxx_check_for_scope) */
...
/* (vcl_cv_cxx_default_value=no) (vcl_cv_cxx_default_value=yes) (vcl_cv_cxx_default_value) */
...
/* (vcl_cv_cxx_has_member_templates=yes) (vcl_cv_cxx_has_member_templates=no) (vcl_cv_cxx_has_member_templates) */
...
/* (vcl_cv_cxx_can_do_partial_specialization=yes) (vcl_cv_cxx_can_do_partial_specialization=no) (vcl_cv_cxx_can_do_partial_specialization) */
...
/* (vcl_cv_cxx_define_specialization=yes) (vcl_cv_cxx_define_specialization=no) (vcl_cv_cxx_define_specialization) */
...
echo """no" 1>&6) (VCL_ALLOWS_INLINE_INSTANTIATION) */
...
echo """yes" 1>&6) (VCL_NEEDS_INLINE_INSTANTIATION) */
...
/* (vcl_cv_cxx_static_const_init_int=yes) (vcl_cv_cxx_static_const_init_int=no) (vcl_cv_cxx_static_const_init_int) */
...
echo """no" 1>&6) (VCL_STATIC_CONST_INIT_FLOAT) */
...
echo """"no"" 1>&6
VCL_CAN_DO_STATIC_TEMPLATE_MEMBER="0") (VCL_CAN_DO_STATIC_TEMPLATE_MEMBER) */
...
echo """"no"" 1>&6
VCL_CAN_DO_NON_TYPE_FUNCTION_TEMPLATE_PARAMETER="0") (VCL_CAN_DO_NON_TYPE_FUNCTION_TEMPLATE_PARAMETER) */
...
echo """yes" 1>&6) (VCL_NEED_FRIEND_FOR_TEMPLATE_OVERLOAD) */
...
template <class T>
bool operator==(victor_base<T> const &, victor_base<T> const &){return 0;};
...
echo """yes" 1>&6) (VCL_OVERLOAD_CAST) */
...
template <class T>
bool operator==(vnl_vector<T> const &a, vnl_vector<T> const &){return 0;};
...
echo """no" 1>&6) (
VCL_NULL_TMPL_ARGS="<>";
echo """yes" 1>&6) (VCL_NULL_TMPL_ARGS) */
...
echo """no" 1>&6) (VCL_NO_STATIC_DATA_MEMBERS) */
...
echo """yes" 1>&6) (VCL_HAS_TEMPLATE_SYMBOLS) */
...
echo """"no"" 1>&6
VCL_CAN_DO_IMPLICIT_TEMPLATES="0") (VCL_CAN_DO_IMPLICIT_TEMPLATES) */
...
echo """"no"" 1>&6
VCL_CAN_DO_COMPLETE_DEFAULT_TYPE_PARAMETER="0") (VCL_CAN_DO_COMPLETE_DEFAULT_TYPE_PARAMETER) */
...
echo """"no"" 1>&6
VCL_CAN_DO_TEMPLATE_DEFAULT_TYPE_PARAMETER="0") (VCL_CAN_DO_TEMPLATE_DEFAULT_TYPE_PARAMETER) */
...
echo """no" 1>&6) (
VCL_SUNPRO_CLASS_SCOPE_HACK=", A";
echo """yes" 1>&6) (VCL_SUNPRO_CLASS_SCOPE_HACK) */
...
/* (vcl_cv_cxx_has_exceptions=yes) (vcl_cv_cxx_has_exceptions=no) (vcl_cv_cxx_has_exceptions) */
...
/* (vcl_cv_cxx_has_namespaces=yes) (vcl_cv_cxx_has_namespaces=no) (vcl_cv_cxx_has_namespaces) */
...
namespace foo {
  ...
  template <class T>
  T abs(complex<T> const &z) { return T(::vxl_sqrt(double(z.re*z.re + z.im+z.im))); }
}
...
/* (vcl_cv_cxx_allows_namespace_std=yes) (vcl_cv_cxx_allows_namespace_std=no) (vcl_cv_cxx_allows_namespace_std) */
...
/* (vcl_cv_cxx_needs_namespace_std=no) (vcl_cv_cxx_needs_namespace_std=yes) (vcl_cv_cxx_needs_namespace_std) */
...
/* (VXL_UNISTD_USLEEP_IS_VOID="0";) (VXL_UNISTD_USLEEP_IS_VOID="1";) (VXL_UNISTD_USLEEP_IS_VOID) */
#include <unistd.h>


int main() { { int x = usleep(0); };
return 0; }
#endif

#ifdef ac_vxl_has_qsort
/* (ac_vxl_has_qsort=yes) (ac_vxl_has_qsort=no) (ac_vxl_has_qsort) */
