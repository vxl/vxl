...
!MESSAGE 
!MESSAGE NMAKE /f "expat.mak" CFG="vil2 - Win32 Debug"
!MESSAGE 
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/contrib/mul" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "expat_EXPORTS"
