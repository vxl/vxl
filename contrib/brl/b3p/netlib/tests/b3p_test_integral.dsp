# Microsoft Developer Studio Project File - Name="b3p_test_integral" - Package Owner=<4>
...
# b3p_test_integral  == name of output library
#  /libpath:"$(VXLROOT)/v3p/netlib/$(OUTDIR)" "netlib.lib" /STACK:10000000  == libraries linked in 
# TARGTYPE "Win32 (x86) Application" 0x0103

CFG=b3p_test_integral - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "b3p_test_integral.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "b3p_test_integral.mak" CFG="b3p_test_integral - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "b3p_test_integral - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "b3p_test_integral - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "b3p_test_integral - Win32 Release"
...
# ADD CPP /I "$(VXLROOT)/vcl/config.win32" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "integral_test_EXPORTS"
...
!ELSEIF  "$(CFG)" == "b3p_test_integral - Win32 Debug"
...
# Name "b3p_test_integral - Win32 Release"
# Name "b3p_test_integral - Win32 Debug"

# Begin Group "Source Files"
# PROP Default_Filter ".c"
# Begin Source File
SOURCE=.\b3p_test_integral.c
# End Source File
# End Group
# End Target
# End Project
