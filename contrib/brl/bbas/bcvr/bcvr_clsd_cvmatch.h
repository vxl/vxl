...
public:
  bcvr_clsd_cvmatch();
  bcvr_clsd_cvmatch(const bsol_intrinsic_curve_2d_sptr c1, const bsol_intrinsic_curve_2d_sptr c2, double R,
                    int template_size = 3);

  bcvr_clsd_cvmatch(const vsol_polygon_2d_sptr p1, const vsol_polygon_2d_sptr p2, double R, double rms = 0.0f,  // fit lines to the input polygon before using
                    int template_size = 3);
