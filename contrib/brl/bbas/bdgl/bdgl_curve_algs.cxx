...
void bdgl_curve_algs::smooth_curve(vcl_vector<vgl_point_2d<double> > & curve, double sigma)
{
...
vdgl_digital_curve_sptr  bdgl_curve_algs::create_digital_curves(vcl_vector<vgl_point_2d<double> > & curve)
{
