...
public:
  ...
  static  bool closest_point_near(vdgl_edgel_chain_sptr const& ec, const int index, const double x, const double y,
                                  double & xc, double & yc);
  ...
  static bool intersect_line_fast(vdgl_digital_curve_sptr const& dc, vgl_line_2d<double> & line,
  ...
  // :Intersect the curve with an infinite line, return the index values
  static bool intersect_line(vdgl_digital_curve_sptr const& dc, vgl_line_2d<double> & line,
                             vcl_vector<double>& indices);
  ...
  static bool match_intersection(vdgl_digital_curve_sptr const& dc, vgl_line_2d<double>& line,
                                 vgl_point_2d<double> const& ref_point, double ref_gradient_angle,
