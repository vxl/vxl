...
static void test_lvcs()
{
  ...
  vcl_ifstream str("c:/mundy/LockheedMartin/2005Activities/DataCollect/ypg_geo_pts.wp");
  ...
  vcl_ofstream ostr("c:/mundy/LockheedMartin/2005Activities/DataCollect/ypg_cart_pts.wp");
  if(!ostr)
	vcl_cout << "Bad File\n";
