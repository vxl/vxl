// This is core/vgui/bgui_easy2D_tableau.h
#ifndef bgui_easy2D_tableau_h_
#define bgui_easy2D_tableau_h_
...
//
//  Contains classes: bgui_easy2D_tableau  bgui_easy2D_tableau_new
//
// \verbatim
// Modifications
...
//    01-OCT-2002  K.Y.McGaul - Moved bgui_easy2D to bgui_easy2D_tableau.
...
#include <bgui/bgui_easy2D_tableau_sptr.h>
...
class bgui_easy2D_tableau : public bgui_displaylist2D_tableau
{
 public:
  //: Constructor - don't use this, use bgui_easy2D_tableau_new.
  //  Create an easy2D with the given name.
  bgui_easy2D_tableau(const char* n="unnamed");

  //: Constructor - don't use this, use bgui_easy2D_tableau_new.
  //  Creates an easy2D with the given image tableau as child.
  bgui_easy2D_tableau(vgui_image_tableau_sptr const&, const char* n="unnamed");

  //: Constructor - don't use this, use bgui_easy2D_tableau_new.
  //  Creates an easy2D with the given child tableau.
  bgui_easy2D_tableau(vgui_tableau_sptr const&, const char* n="unnamed");
  ...
  //: Returns the type of this tableau ('bgui_easy2D_tableau').
  ...
  void remove(vgui_soview* vso) { bgui_displaybase_tableau::remove(vso); }

  //: Clear all soviews from the display.
  void clear() { bgui_displaybase_tableau::clear(); }

  //: Returns a list of all soviews on the display.
  vcl_vector<vgui_soview*> const &get_all() const
  { return bgui_displaybase_tableau::get_all(); }
 ...
 protected:
  //: Destructor - called by bgui_easy2D_tableau_sptr.
  ~bgui_easy2D_tableau() { }
...
//: Create a smart-pointer to a bgui_easy2D_tableau tableau.
struct bgui_easy2D_tableau_new : public bgui_easy2D_tableau_sptr
{
  //: Constructor - create an easy2D with the given name.
  bgui_easy2D_tableau_new(char const *n="unnamed") :
    bgui_easy2D_tableau_sptr(new bgui_easy2D_tableau(n)) { }

  //: Constructor - create an easy2D with the given image tableau as child.
  bgui_easy2D_tableau_new(vgui_image_tableau_sptr const& i, char const* n="unnamed") :
    bgui_easy2D_tableau_sptr(new bgui_easy2D_tableau(i, n)) { }

  //: Constructor - create an easy2D with the given child tableau.
  bgui_easy2D_tableau_new(vgui_tableau_sptr const& i, char const* n="unnamed") :
    bgui_easy2D_tableau_sptr(new bgui_easy2D_tableau(i, n)) { }
};

#endif // bgui_easy2D_tableau_h_
