...
bool bgui_image_utils::init_histogram()
{
  ...
  switch (type)
  {
    case  VIL_PIXEL_FORMAT_BYTE:
      min_val = static_cast<double>(vil_pixel_traits<unsigned char>::minval());
      max_val = static_cast<double>(vil_pixel_traits<unsigned char>::maxval());
    ...
    case  VIL_PIXEL_FORMAT_UINT_32:
      min_val = static_cast<double>(vil_pixel_traits<unsigned int>::minval());
      max_val = static_cast<double>(vil_pixel_traits<unsigned int>::maxval());
      hist_ = bsta_histogram<double>(min_val, max_val, bin_limit);
      return true;
    default:
      vcl_cout << "Format not supported by bgui_image_utils\n";
