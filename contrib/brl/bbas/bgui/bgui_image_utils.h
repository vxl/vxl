...
public:
  ...
  bool default_range_map(vgui_range_map_params_sptr& rmp, double gamma = 1.0, bool invert = false, bool gl_map = false,
                         bool cache = true);
...
private:
  ...
  bool set_data_by_random_blocks(const unsigned total_num_blocks, vil_blocked_image_resource_sptr const& bir,
                                 double fraction = 1.0);
