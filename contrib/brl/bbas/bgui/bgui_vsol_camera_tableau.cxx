...
void bgui_vsol_camera_tableau::add_spatial_object_3d(vsol_spatial_object_3d_sptr const& so)
{
  if( so->cast_to_point() )
    {
...
void bgui_vsol_camera_tableau::add_points_3d(vcl_vector<vsol_point_3d_sptr> const& points)
{
...
void bgui_vsol_camera_tableau::add_polygons_3d(vcl_vector<vsol_polygon_3d_sptr> const& polys)
{
