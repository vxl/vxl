...
void
bgui_vtol2D_rubberband_client::add_point(float x, float y)
{
  vtol2D_->add_point(x, y);
}

void
bgui_vtol2D_rubberband_client::add_line(float x0, float y0, float x1, float y1)
{
  vtol2D_->add_line(x0, y0, x1, y1);
}

void
bgui_vtol2D_rubberband_client::add_infinite_line(float a, float b, float c)
{
  vtol2D_->add_infinite_line(a, b, c);
}

void
bgui_vtol2D_rubberband_client::add_circle(float x, float y, float r)
{
  vtol2D_->add_circle(x, y, r);
}

void
bgui_vtol2D_rubberband_client::add_linestrip(int n, float const* x, float const* y)
{
  vtol2D_->add_linestrip(n, x, y);
}

void
bgui_vtol2D_rubberband_client::add_polygon(int n, float const* x, float const* y)
{
...
void
bgui_vtol2D_rubberband_client::add_box(float x0, float y0, float x1, float y1)
{
...
void
bgui_vtol2D_rubberband_client::clear_highlight()
{
  vtol2D_->highlight(0);
}
