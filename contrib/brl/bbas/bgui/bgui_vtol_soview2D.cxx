...
bgui_vtol_soview2D_dotted_digital_curve::bgui_vtol_soview2D_dotted_digital_curve(vdgl_digital_curve_sptr const& dc)
{
  if( !dc )
    {
...
bgui_vtol_soview2D_digital_curve::bgui_vtol_soview2D_digital_curve(vdgl_digital_curve_sptr const& dc)
{
  if( !dc )
    {
...
bgui_vtol_soview2D_edge_group::bgui_vtol_soview2D_edge_group(vcl_vector<vtol_edge_2d_sptr>& edges)
{
