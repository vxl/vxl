...
vil_image_resource_sptr bhdfs_vil_load_image_resource(char const* filename, bool verbose = true);

// : Load an image resource object from a file.
// Won't use plugins.
// \relatesalso vil_image_resource
vil_image_resource_sptr bhdfs_vil_load_image_resource_raw(char const *, bool verbose = true);
...
vil_pyramid_image_resource_sptr bhdfs_vil_load_pyramid_resource(char const* directory_or_file, bool verbose = true);
