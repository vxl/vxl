...
private:
  ...
  void propagate_dist(bil_cedt_contour * pf, bil_cedt_heap * heap, vbl_array_2d<double> & surface,
                      vbl_array_2d<unsigned char> & tag_array, vbl_array_2d<unsigned char> & dir_array, int y, int x,
                      int dir);

  void add_to_contour(bil_cedt_contour * pf, bil_cedt_heap * heap, vbl_array_2d<double> & surface,
                      vbl_array_2d<unsigned char> & tag_array, vbl_array_2d<unsigned char> & dir_array, double dist_x,
                      double dist_y, double dist, int y, int x, int dir, int position);
