...
void convert_RGB_to_Lab(vil_image_view<unsigned char> const& image, vil_image_view<float>& L_img,
                        vil_image_view<float>& a_img, vil_image_view<float>& b_img);

void convert_RGB_to_Lab(vil_image_view<vxl_byte> const& image, vil_image_view<double>& L_img,
                        vil_image_view<double>& a_img, vil_image_view<double>& b_img);
...
void convert_RGB_to_Luv(vil_image_view<unsigned char> const& image, vil_image_view<float>& L_img,
                        vil_image_view<float>& u_img, vil_image_view<float>& v_img);
