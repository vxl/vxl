...
template <class T>
void bil_finite_differences(const vil_image_view<T>& src_im, vil_image_view<T>& dxp_, vil_image_view<T>& dxm_,
                            vil_image_view<T>& dxc_, vil_image_view<T>& dyp_, vil_image_view<T>& dym_,
