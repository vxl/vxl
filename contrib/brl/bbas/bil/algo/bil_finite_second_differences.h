...
template <class T>
void bil_finite_second_differences(const vil_image_view<T>& src_im, const vil_image_view<T>& dxp_,
                                   const vil_image_view<T>& dxm_, const vil_image_view<T>& dyp_,
                                   const vil_image_view<T>& dym_, vil_image_view<T>& dxx_, vil_image_view<T>& dyy_,
