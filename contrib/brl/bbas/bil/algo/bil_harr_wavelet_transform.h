...
template <class T>
void bil_harr_wavelet_transform(const vil_image_view<T>& src, vil_image_view<T>& dest);

// : Computes the inverse of the Harr wavelet transform on each plane
template <class T>
void bil_harr_wavelet_inverse(const vil_image_view<T>& src, vil_image_view<T>& dest);
