...
public:
  ...
  bil_nms_params(double thresh = 1.0, PFIT_TYPE pfit_type = PFIT_3_POINTS, unsigned margin = 1, double rel_thresh = 2.5,
...
public:
  ...
  bil_nms(const bil_nms_params& nsp, const vil_image_view<double>& dir_x, const vil_image_view<double>& dir_y,
