...
public:
  ...
  vcl_vector<vil_image_view<unsigned char> > bil_wshed_2d_main(vil_image_view<unsigned char> src_img, double gsigma1,
                                                               double gsigma2, int min_x, int min_y, int max_x,
                                                               int max_y);
