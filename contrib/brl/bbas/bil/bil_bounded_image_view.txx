...
template <class T>
bil_bounded_image_view<T>::bil_bounded_image_view(const vil_image_view_base& rhs)
...
template <class T>
const T & bil_bounded_image_view<T>::gpix(unsigned i, unsigned j, unsigned p) const
{
  // assert(i<nib_); assert(j<njb_); //fill with zeros outside real data
...
template <class T>
T & bil_bounded_image_view<T>::gpix(unsigned i, unsigned j, unsigned p)
{
