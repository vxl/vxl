...
template <class T> 
void bil_convert(vil_image_resource_sptr const& resc, vil_image_resource_sptr& grey_resc){
...
void bil_convert_resource_to_grey(vil_image_resource_sptr const& resc, vil_image_resource_sptr& grey_resc, bool apply_mask){
...
#define macro(F, T)                              \
  case F: bil_convert<T>(resc, grey_resc); break
#if VXL_HAS_INT_64
