...
public:
  ...
  static vgl_polygon<double> parse_polygon_with_inner(vcl_string poly_kml_file, vgl_polygon<double>& outer,
                                                      vgl_polygon<double>& inter, unsigned& n_out, unsigned& n_in);
