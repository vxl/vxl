...
public:
  ...
  void get_mc_incident_halfedges(bmsh3d_halfedge* he, vcl_vector<bmsh3d_halfedge *>& incident_edges) const;

  // : given halfedge head, returns the set of incident edges of the inner face
  void get_mc_incident_edges(bmsh3d_halfedge* he, vcl_vector<bmsh3d_edge *>& incident_edges) const;
