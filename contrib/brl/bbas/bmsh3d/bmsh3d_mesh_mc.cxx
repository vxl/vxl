                      ...
                      bmsh3d_face_mc* &F1, bmsh3d_face_mc* &F2)
{
  ...
  vcl_cout << "face1" << vcl_endl;
  vcl_cout << E12->id() << "from " << E12->sV()->id() << " to" << E12->eV()->id() << vcl_endl;
                          ...
                          bmsh3d_mesh_mc* mesh)
{
  ...
  bmsh3d_vertex* prev_v = 0, *v_first, *v;
