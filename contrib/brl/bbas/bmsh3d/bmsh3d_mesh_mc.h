...
void mesh_break_face(bmsh3d_mesh_mc* M, bmsh3d_face_mc* F, bmsh3d_edge* E1, bmsh3d_edge* E2, bmsh3d_vertex* V1,
                     bmsh3d_vertex* V2, bmsh3d_face_mc * & F1, bmsh3d_face_mc * & F2);
...
bmsh3d_face * copy_inner_face(vcl_vector<bmsh3d_edge *> incident_edges, bmsh3d_mesh_mc* mesh);
