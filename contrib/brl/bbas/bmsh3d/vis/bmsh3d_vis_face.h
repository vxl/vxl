...
SoSeparator * draw_F(const bmsh3d_face* F, const SbColor& color, const float transp = 0.0f,
                     const bool user_defined_class = true);

SoSeparator * draw_F(const bmsh3d_face* F, const SoMaterial* material, const bool user_defined_class = true);

SoSeparator * draw_F_with_id(const bmsh3d_face* F, const SbColor& color, const SoBaseColor* idbasecolor,
                             const float transp = 0.0f, const bool user_defined_class = true);

SoSeparator * draw_F_with_id(const bmsh3d_face* F, const SoMaterial* material, const SoBaseColor* idbasecolor,
                             const bool user_defined_class = true);
