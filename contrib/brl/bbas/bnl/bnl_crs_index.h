// This is brl/bbas/bnl/bnl_crs_index.h
#ifndef bnl_crs_index_h_
#define bnl_crs_index_h_
...
class bnl_crs_index
{
 public:
  ...
  //: Constructor - default
  bnl_crs_index() : num_cols_(0) {}

  //: Constructor - from a binary mask
  bnl_crs_index(const vcl_vector<vcl_vector<bool> >& mask);
