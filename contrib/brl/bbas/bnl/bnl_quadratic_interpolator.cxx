...
void bnl_quadratic_interpolator::fill_scatter_matrix()
{
  ...
  s_.put(0, 0, x4);  s_.put(0, 1, x3y); s_.put(0, 2, x2y2); s_.put(0, 3, x3); s_.put(0, 4, x2y); s_.put(0, 5, -vx2);
  s_.put(0, 6, x2);
  s_.put(1, 0, x3y); s_.put(1, 1, x2y2); s_.put(1, 2, xy3); s_.put(1, 3, x2y); s_.put(1, 4, xy2); s_.put(1, 5, -vxy);
  s_.put(1, 6, xy);
  s_.put(2, 0, x2y2); s_.put(2, 1, xy3); s_.put(2, 2, y4);  s_.put(2, 3, xy2); s_.put(2, 4, y3); s_.put(2, 5, -vy2);
  s_.put(2, 6, y2);
  s_.put(3, 0, x3);  s_.put(3, 1, x2y); s_.put(3, 2, xy2); s_.put(3, 3, x2); s_.put(3, 4, xy); s_.put(3, 5, -vx);
  s_.put(3, 6, x);
  s_.put(4, 0, x2y); s_.put(4, 1, xy2); s_.put(4, 2, y3);  s_.put(4, 3, xy); s_.put(4, 4, y2); s_.put(4, 5, -vy);
  s_.put(4, 6, y);
  s_.put(5, 0, -vx2); s_.put(5, 1, -vxy); s_.put(5, 2, -vy2); s_.put(5, 3, -vx); s_.put(5, 4, -vy); s_.put(5, 5, v2);
  s_.put(5, 6, -v);
  s_.put(6, 0, x2);  s_.put(6, 1, xy);  s_.put(6, 2, y2);  s_.put(6, 3, x);  s_.put(6, 4, y);  s_.put(6, 5, -v);
  s_.put(6, 6, n);
}
