...
public:
  ...
  bool enqueue_write_buffer(const cl_command_queue& queue, vcl_string name, cl_bool block_write, vcl_size_t offset,
                            vcl_size_t cnb, const void* data, cl_uint num_events, const cl_event* ev1, cl_event* ev2);

  bool enqueue_read_buffer(const cl_command_queue& queue, vcl_string name, cl_bool block_read, vcl_size_t offset,
                           vcl_size_t cnb, void* data, cl_uint num_events, const cl_event* ev1, cl_event * ev2);
