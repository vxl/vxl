...
bool test_workspace()
{
  ...
  test_kernel.create_kernel( &mgr.context(),
                             &mgr.devices()[0], paths, "test_local_mem_access", "",
                             "bocl test local memory access kernel");
  ...
  vcl_size_t lthread[] = { 8, 8 };
  vcl_size_t gthread[] = { 20 * 8, 30 * 8 };
