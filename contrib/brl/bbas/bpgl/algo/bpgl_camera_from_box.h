...
{
public:
  static vpgl_perspective_camera<double> persp_camera_from_box(vgl_box_3d<double> const & box,
                                                               vgl_point_3d<double> const& camera_center, unsigned ni,
                                                               unsigned nj);

  static vpgl_affine_camera<double> affine_camera_from_box(vgl_box_3d<double> const & box,
                                                           vgl_vector_3d<double> const& ray, unsigned ni, unsigned nj);

#if 0 // Implement later if needed
  static vpgl_proj_camera<double> proj_camera_from_box(vgl_box_3d<double> const & box);
