#include "bpgl_camera_homographies.h"
// :
// \file
...
vgl_h_matrix_2d<double> bpgl_camera_homographies::homography_to_camera(vpgl_proj_camera<double> const& cam,
...
vgl_h_matrix_2d<double> bpgl_camera_homographies::homography_to_camera(vpgl_perspective_camera<double> const& cam,
                                                                       vgl_plane_3d<double> const& plane)
{
...
// : create a plane projective transformation from the camera image plane to the specified plane
vgl_h_matrix_2d<double> bpgl_camera_homographies::homography_from_camera(vpgl_proj_camera<double> const& cam,
                                                                         vgl_plane_3d<double> const& plane)
{
  vgl_h_matrix_2d<double> H =
    bpgl_camera_homographies::homography_to_camera(cam, plane);
  return H.get_inverse();
}

// : create a plane projective transformation from the camera image plane to the specified plane
vgl_h_matrix_2d<double> bpgl_camera_homographies::homography_from_camera(vpgl_perspective_camera<double> const& cam,
                                                                         vgl_plane_3d<double> const& plane)
{
  vgl_h_matrix_2d<double> H =
    bpgl_camera_homographies::homography_to_camera(cam, plane);
...
vpgl_perspective_camera<double> bpgl_camera_homographies::transform_camera_to_plane(
...
vpgl_proj_camera<double> bpgl_camera_homographies::transform_camera_to_plane(vpgl_proj_camera<double> const& cam,
                                                                             vgl_plane_3d<double> const& plane)
{
  vgl_homg_point_3d<double> hc = cam.camera_center();
  vgl_point_3d<double>      cp(hc);
...
vcl_vector<vgl_point_3d<double> > bpgl_camera_homographies::transform_points_to_plane(vgl_plane_3d<double> const& plane,
