// This is bbas/bpgl/algo/bpgl_fm_compute_ransac.h
#ifndef bpgl_fm_compute_ransac_h_
#define bpgl_fm_compute_ransac_h_
// :
// \file
...
class bpgl_fm_compute_ransac
{
public:
  bpgl_fm_compute_ransac() : outlier_thresh_(1), max_outlier_frac_(0.5),
  ...
  bool compute( const vcl_vector<vgl_point_2d<double> >& pr, const vcl_vector<vgl_point_2d<double> >& pl,
