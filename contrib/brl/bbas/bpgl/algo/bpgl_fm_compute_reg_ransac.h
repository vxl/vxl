...
public:
  ...
  virtual void  fm_to_params( const bpgl_reg_fundamental_matrix<double>&  fm, vnl_vector<double>& p) const;

  // Convert a parameter vector into a fundamental matrix.
  virtual void  params_to_fm( const vnl_vector<double>& p, bpgl_reg_fundamental_matrix<double>& fm) const;
