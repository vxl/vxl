...
vnl_double_3x3 bpgl_interpolate::logR(vnl_double_3x3 const& R)
{
  ...
  if( vcl_fabs(trace + 1.0) < tol )
    ...
    vcl_cerr << "In bpgl_interpolate::log_r - shouldn't happen! FIX!!!!\n";
    return log_r;
    }
...
vcl_vector<vnl_double_3x3> bpgl_interpolate::interpolateR(vnl_double_3x3 R0,
                                                          vnl_double_3x3 R1,
                                                          unsigned n_between)
{
...
bool bpgl_interpolate::interpolate(vpgl_perspective_camera<double> const& cam0,
...
bool bpgl_interpolate::interpolate_next(vpgl_perspective_camera<double> const& cam_prev,
