...
public: ~bpgl_interpolate();
  ...
  //
  static vcl_vector<vnl_double_3x3> interpolateR(vnl_double_3x3 R0, vnl_double_3x3 R1, unsigned n_between);

  // :Interpolate both R and t at the specified intervals
  static void interpolateRt(vnl_double_3x3 R0, vnl_double_3 t0, vnl_double_3x3 R1, vnl_double_3 t1, unsigned n_between,
                            vcl_vector<vnl_double_3x3>& Rintrp, vcl_vector<vnl_double_3>& tintrp);
  ...
  static bool interpolate(vpgl_perspective_camera<double> const& cam0, vpgl_perspective_camera<double> const& cam1,
                          unsigned n_between, vcl_vector<vpgl_perspective_camera<double> >& cams);
  ...
  static bool interpolate_next(vpgl_perspective_camera<double> const& prev, vpgl_perspective_camera<double> const& curr,
                               double const& rel_step_size, vpgl_perspective_camera<double>& next);
