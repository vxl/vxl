...
static void test_affine_rectify() {
	...
	scene_box.add(pmin);   scene_box.add(pmax);
	 ...
	 success = success && rip.compute_rectification(scene_box);
	TEST("affine rectify image pair", success, true);
}

TESTMAIN(test_affine_rectify);
