...
static void test_camera_homographies()
{
  ...
  vgl_h_matrix_2d<double> Ht =bpgl_camera_homographies::homography_to_camera(pc, pl);
  ...
  vgl_h_matrix_2d<double> Ht2 =
    bpgl_camera_homographies::homography_to_camera(pc, p2);
  ...
  vgl_h_matrix_2d<double> Ht3 =
    bpgl_camera_homographies::homography_to_camera(psc, p2);
  vgl_point_2d<double> ptp3 = Ht3(pt1);
  TEST_NEAR("test plane to image 45degrees perspective point1",
            ptp3.x(), 0.9998, 0.001);
  vgl_h_matrix_2d<double> Ht4 =bpgl_camera_homographies::homography_from_camera(psc, p2);
