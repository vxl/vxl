#ifndef bpgl_camera_estimator_txx_
#define bpgl_camera_estimator_txx_
...
template <class exp_edge_func>
void bpgl_camera_estimator<exp_edge_func>::set_estimation_params(double theta_range, double theta_step,
                                                                 double phi_range, double phi_step, double rot_range,
...
template <class exp_edge_func>
vil_image_view<float> bpgl_camera_estimator<exp_edge_func>::convert_to_spherical_coordinates(
