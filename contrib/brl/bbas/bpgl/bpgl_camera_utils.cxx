...
vpgl_perspective_camera<double> bpgl_camera_utils::camera_from_horizon(double focal_length, double principal_pt_u,
...
vpgl_perspective_camera<double> bpgl_camera_utils::camera_from_kml(double ni, double nj, double right_fov,
                                                                   double top_fov,
...
vgl_line_2d<double> bpgl_camera_utils::horizon(vpgl_perspective_camera<double> const& cam)
{
...
vcl_string bpgl_camera_utils::get_string(double ni, double nj, double right_f, double top_f, double alt, double head,
                                         double tilt, double roll)
{
...
void bpgl_camera_utils::camera_parameters(vpgl_perspective_camera<double> const& cam,
...
bool bpgl_camera_utils::camera_from_parameters(double rodrigues_x, double rodrigues_y,
                                               double rodrigues_z, double tx, double ty,
                                               double tz, double focal_length_u, double focal_length_v,
                                               double principal_pt_u, double principal_pt_v,
                                               vpgl_perspective_camera<double>& cam)
