// This is bbas/bpgl/bpgl_comp_rational_camera.txx
#ifndef bpgl_comp_rational_camera_txx_
#define bpgl_comp_rational_camera_txx_
// :
// \file
...
template <class T>
bpgl_comp_rational_camera<T>::bpgl_comp_rational_camera(vnl_matrix_fixed<T, 3, 3> const& M,
...
template <class T>
bpgl_comp_rational_camera<T>::bpgl_comp_rational_camera(const T tu, const T tv,
                                                        vpgl_rational_camera<T> const& rcam) :
...
template <class T>
bpgl_comp_rational_camera<T>::bpgl_comp_rational_camera(const T tu, const T tv, const T angle_in_radians,
                                                        vpgl_rational_camera<T> const& rcam) :
  vpgl_rational_camera<T>(rcam)
{
...
#endif // bpgl_comp_rational_camera_txx_
