...
vsol_polygon_3d_sptr depth_map_region::region_2d_to_3d(vsol_polygon_2d_sptr const& region_2d,
                                                       ...
                                                       vpgl_perspective_camera<double> const& cam)
{
  ...
  assert(vcl_fabs(dot) > vgl_tolerance<double>::position);
...
vgl_vector_3d<double> depth_map_region::perp_ortho_dir(vpgl_perspective_camera<double> const& cam)
{
...
void depth_map_region::set_region_3d(vpgl_perspective_camera<double> const& cam)
{
...
void depth_map_region::set_region_3d(double depth, vpgl_perspective_camera<double> const& cam)
{
...
bool depth_map_region::set_ground_plane_max_depth(double max_depth,
                                                  vpgl_perspective_camera<double> const& cam,
                                                  double proximity_scale_factor)
{
  ...
  if( needs_split )
    {
    return false;               // don't handle this case yet
    }
...
bool depth_map_region::img_to_region_plane(vpgl_perspective_camera<double> const& cam,
...
bool depth_map_region::update_depth_image(vil_image_view<float>& depth_image,
                                          vpgl_perspective_camera<double> const& cam,
