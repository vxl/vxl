...
vbl_array_2d<double> icam_cost_func::joint_probability(vnl_vector<double> const& samples,
...
vbl_array_2d<double> icam_cost_func::joint_probability(vnl_vector_fixed<double, 3> rodrigues,
                                                       vgl_vector_3d<double> trans)
{
  vnl_vector<double> pr(dt_.n_params() );
  vnl_vector<double> res;
