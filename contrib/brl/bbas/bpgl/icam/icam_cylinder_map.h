...
public:
  ...
  bool closest_camera(vgl_ray_3d<double> const& cyl_ray, vgl_point_3d<double> const& p, unsigned& cam_index, double& u,
                      double& v) const;
  ...
  bool render_map(vil_image_view<vxl_byte> const& backgnd, vpgl_camera_double_sptr const& cam, double theta,
                  vil_image_view<vxl_byte>& img, double scale = 1.0, float back_r = 0.0f, float back_g = 0.0f,
                  float back_b = 255.0f);
