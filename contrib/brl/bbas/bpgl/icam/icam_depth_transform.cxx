...
void icam_depth_transform::set_k(vnl_matrix_fixed<double, 3, 3> const& K_from,
...
icam_depth_transform::icam_depth_transform(vnl_matrix_fixed<double, 3, 3> const& K,
...
icam_depth_transform::icam_depth_transform(vnl_matrix_fixed<double, 3, 3> const& K_from,
                                           vnl_matrix_fixed<double, 3, 3> const& K_to,
                                           vil_image_view<double> const& depth,
                                           vgl_rotation_3d<double> const& rot,
                                           vgl_vector_3d<double> const& trans,
