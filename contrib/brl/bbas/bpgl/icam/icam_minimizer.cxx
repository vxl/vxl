...
bool icam_minimizer::exhaustive_rotation_search(vgl_vector_3d<double> const& trans,
                                                unsigned level,
                                                double min_allowed_overlap,
...
principal_ray_scan icam_minimizer::initialized_pray_scan(unsigned initial_level, unsigned search_level,
                                                         unsigned& n_pts)
{
...
bool icam_minimizer::initialized_rot_search(vgl_vector_3d<double> const& trans,
                                            vgl_rotation_3d<double>& initial_rot,
...
void icam_minimizer::set_origin_step_delta(vgl_box_3d<double> const& trans_box,
...
bool icam_minimizer::exhaustive_camera_search(vgl_box_3d<double> const& trans_box,
                                              vgl_vector_3d<double> const& trans_steps,
                                              unsigned level,
                                              double min_allowed_overlap,
                                              vgl_vector_3d<double>& min_trans,
...
// |dx |
// |< --initial step delta --->|
void icam_minimizer::reduce_search_box(vgl_vector_3d<double> const& center_trans,
...
bool icam_minimizer::pyramid_camera_search(vgl_vector_3d<double> const &
                                           start_trans,
...
bool icam_minimizer::camera_search( vgl_box_3d<double> const& trans_box,
                                    vgl_vector_3d<double> const& trans_steps,
                                    unsigned final_level,
                                    double min_allowed_overlap,
                                    bool refine,
...
vnl_matrix_fixed<double, 3, 3> icam_minimizer::to_calibration_matrix(unsigned level)
{
  return dt_pyramid_.to_calibration_matrix(level);
}

vnl_matrix_fixed<double, 3, 3> icam_minimizer::from_calibration_matrix_inv(unsigned level)
{
