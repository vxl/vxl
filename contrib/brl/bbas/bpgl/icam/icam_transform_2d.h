...
public:
  // : Default Constructor
  icam_transform_2d() : vgl_h_matrix_2d<double>(), vbl_ref_count(),
    form_(Identity) { vgl_h_matrix_2d<double>::set_identity(); }
  ...
  void set_affine(vgl_point_2d<double> const& p, vgl_vector_2d<double> const& u, vgl_vector_2d<double> const& v);
