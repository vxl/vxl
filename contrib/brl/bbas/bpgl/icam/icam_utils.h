...
public:
  ...
  static void image_bounds(unsigned source_ni, unsigned source_nj, icam_transform_2d const& t, unsigned& dest_ni,
  ...
  static icam_image<float> destination_mask(unsigned source_ni, unsigned source_nj, icam_transform_2d const& t);
