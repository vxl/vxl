...
public:
  ...
  virtual void set_images(vcl_map<unsigned, /*vil_image_view<float>**/ vcl_string>& images, vcl_map<unsigned,
                                                                                                    /*vil_image_view<double>**/ vcl_string>& depth_images);
  ...
  void mapped_image(unsigned viewpoint_id, vil_image_view<float> const& source_img, vgl_rotation_3d<double>& rot,
                    vgl_vector_3d<double>& trans, unsigned level, vil_image_view<float>& act_dest,
                    vil_image_view<float>& mapped_dest, icam_minimizer_params const& params);
