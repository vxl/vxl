...
!MESSAGE 
!MESSAGE NMAKE /f "icam_tests.mak" CFG="vil2 - Win32 Debug"
!MESSAGE 
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/contrib/mul" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "icam_tests_EXPORTS"
