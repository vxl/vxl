...
public:
  ...
  ihog_lsqr_cost_func(const ihog_image<float>& image1, const ihog_image<float>& image2, const ihog_world_roi& roi,
                      const ihog_transform_2d& init_xform );
  // : Constructor (one mask)
  ihog_lsqr_cost_func(const ihog_image<float>& image1, const ihog_image<float>& image2, const ihog_image<float>& mask,
                      const ihog_world_roi& roi, const ihog_transform_2d& init_xform, bool image1_mask = false );
  // : Constructor (two masks)
  ihog_lsqr_cost_func(const ihog_image<float>& image1, const ihog_image<float>& image2, const ihog_image<float>& mask1,
