...
public:
  ...
  ihog_minfo_cost_func(const ihog_image<float>& image1, const ihog_image<float>& image2, const ihog_world_roi& roi,
                       const ihog_transform_2d& init_xform, unsigned nbins = 16);
  // : Constructor (one mask)
  ihog_minfo_cost_func(const ihog_image<float>& image1, const ihog_image<float>& image2, const ihog_image<float>& mask,
                       const ihog_world_roi& roi, const ihog_transform_2d& init_xform, bool image1_mask = false,
                       unsigned nbins = 16);
  // : Constructor (two masks)
  ihog_minfo_cost_func(const ihog_image<float>& image1, const ihog_image<float>& image2, const ihog_image<float>& mask1,
                       const ihog_image<float>& mask2, const ihog_world_roi& roi, const ihog_transform_2d& init_xform,
                       unsigned nbins = 16);
  ...
  static double entropy_diff(vnl_vector<double>& mask_samples, vnl_vector<double>& from_samples,
                             vnl_vector<double>& to_samples, int nbins);
