...
public:
  // : Constructor
  ihog_minimizer( const ihog_image<float>& image1, const ihog_image<float>& image2, const ihog_world_roi& roi );

  // : Constructor initialized with a mask which would not include the values in registration.
  ihog_minimizer( const ihog_image<float>& image1, const ihog_image<float>& image2, const ihog_image<float>& image_mask,
                  const ihog_world_roi& roi, bool image1_mask = false );

  // : Constructor initialized with masks on both images.
  ihog_minimizer( const ihog_image<float>& image1, const ihog_image<float>& image2,
                  const ihog_image<float>& image1_mask, const ihog_image<float>& image2_mask,
