...
{
  return vgl_point_2d<double>(t12_matrix_[2][2] == 1 ? t12_matrix_[0][2] : t12_matrix_[0][2] / t12_matrix_[2][2],
                              t12_matrix_[2][2] == 1 ? t12_matrix_[1][2] : t12_matrix_[1][2] / t12_matrix_[2][2]);
}
...
void ihog_transform_2d::set(const vnl_vector<double>& v, Form form)
{
  ...
  switch( form )
    ...
    case (Projective):
      if( n != 9 )
        {
        return;              // setCheck(9,n,"Projective");
        }
...
vgl_point_2d<double> ihog_transform_2d::operator()(double x, double y) const
{
  ...
  switch( form_ )
    ...
    case Projective:
      ...
      if( z == 0 )
        {
        return vgl_point_2d<double>(0, 0);                 // Or should it be inf,inf?
        }
      else
        {
        return vgl_point_2d<double>( (x * t12_matrix_[0][0] + y * t12_matrix_[0][1] + t12_matrix_[0][2]) / z,
