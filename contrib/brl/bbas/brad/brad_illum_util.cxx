                                     ...
                                     brad_atmospheric_parameters const& atm)
{
  ...
  return brad_expected_radiance_chavez(reflectance, normal, sun_dir, T_sun, T_view, md.sun_irradiance_, atm.skylight_,
                                       atm.airlight_);
}
                                        ...
                                        brad_atmospheric_parameters const& atm)
{
  ...
  return brad_expected_reflectance_chavez(toa_radiance, normal, sun_dir, T_sun, T_view, md.sun_irradiance_,
                                          atm.skylight_, atm.airlight_);
}
                                     ...
                                     double airlight_var)
{
  ...
  double dL_doptical_depth = md.sun_irradiance_ * reflectance * sun_dot_norm * T_sun * T_view
    / (vnl_math::pi * sun_dir.z() );
  dL_doptical_depth += (md.sun_irradiance_ * sun_dot_norm * T_sun + atm.skylight_ * F) * reflectance * T_view
    / (vnl_math::pi * vcl_sin(view_el) );
