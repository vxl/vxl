...
{
public:
  brad_phongs_model_est(double sun_elev, double sun_azim, vnl_vector<double> & camera_elev,
                        vnl_vector<double> & camera_azim, vnl_vector<double> & obs, vnl_vector<double> & obs_weights,
                        bool with_grad);
  brad_phongs_model_est(double sun_elev, double sun_azim, vcl_vector<vnl_double_3> & viewing_dir,
                        vnl_vector<double> & obs, vnl_vector<double> & obs_weights, bool with_grad);
...
{
public:
  brad_phongs_model_approx_est(double sun_elev, double sun_azim, vnl_vector<double> & camera_elev,
                               vnl_vector<double> & camera_azim, vnl_vector<double> & obs,
                               vnl_vector<double> & obs_weights, bool with_grad);
  brad_phongs_model_approx_est(double sun_elev, double sun_azim, vcl_vector<vnl_double_3> & viewing_dir,
                               vnl_vector<double> & obs, vnl_vector<double> & obs_weights, bool with_grad);
