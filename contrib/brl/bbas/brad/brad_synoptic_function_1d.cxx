...
double brad_synoptic_function_1d::angle(double elev0, double az0, double elev1, double az1)
{
...
void brad_synoptic_function_1d::auto_corr_freq_amplitudes(vcl_vector<double>& freq_amplitudes)
{
  unsigned n = this->size();
  double   temp = n / 2;
