...
void vsl_b_write(vsl_b_ostream & os, const brad_atmospheric_parameters& m);

// : Binary load brad_atmospheric_parameters from stream.
void vsl_b_read(vsl_b_istream & is, brad_atmospheric_parameters& m);

// : Print summary
void vsl_print_summary(vcl_ostream & os, const brad_atmospheric_parameters& m);
