...
brdb_database::brdb_database(vcl_vector<brdb_relation_sptr> relations, vcl_vector<vcl_string> relation_names)
{
  ...
  for( ; (relations_itr != relations.end() ) && (relation_name_itr != relation_names.end() );
       ++relations_itr, ++relation_name_itr )
    {
...
brdb_database::get_all_relation_names() const
{
  ...
  for( vcl_map<vcl_string, brdb_relation_sptr>::const_iterator itr = relations_.begin(); itr != relations_.end();
       ++itr )
    {
