...
public:
  ...
  brdb_relation( const vcl_vector<vcl_string>& names, const vcl_vector<vcl_string>& types );
  ...
  brdb_relation( const vcl_vector<vcl_string>& names, const vcl_vector<brdb_tuple_sptr>& tuples,
