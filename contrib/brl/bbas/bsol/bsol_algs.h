...
public: ~bsol_algs();
  ...
  static vsol_point_2d_sptr closest_point(vsol_point_2d_sptr const& p, vcl_vector<vsol_point_2d_sptr> const& point_set,
                                          double& d);

  static vsol_point_3d_sptr closest_point(vsol_point_3d_sptr const& p, vcl_vector<vsol_point_3d_sptr> const& point_set,
                                          double& d);
  ...
  static vsol_polygon_2d_sptr transform_about_point(vsol_polygon_2d_sptr const& p, vsol_point_2d_sptr const& c,
