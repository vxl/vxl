...
bsol_distance_histogram::bsol_distance_histogram(const int nbins,
...
//
bool bsol_distance_histogram::distance_peaks(double& peak1, double& peak2, double min_peak_height_ratio)
{
