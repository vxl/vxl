...
//
// -----------------------------------------------------------------------------
vcl_vector<vsol_line_2d_sptr> bsol_hough_line_index::lines_at_index(const int r, const int theta)
{
...
int bsol_hough_line_index::dominant_directions(const int thresh, const float angle_tol,
                                               vcl_vector<int>& dirs)
{
...
//
int bsol_hough_line_index::dominant_line_groups(const int thresh, const float angle_tol,
