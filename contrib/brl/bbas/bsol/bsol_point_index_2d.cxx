...
vcl_vector<vsol_point_2d_sptr> bsol_point_index_2d::points(const int row, const int col)
{
  vcl_vector<vsol_point_2d_sptr> out;
  if( row < 0 || row >= nrows_ || col < 0 || col >= ncols_ )
    {
...
vsol_box_2d_sptr bsol_point_index_2d::index_cell(const double x, const double y)
{
