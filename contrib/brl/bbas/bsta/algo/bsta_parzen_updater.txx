...
void bsta_parzen_updater<parzen_dist_>::operator()( parzen_dist_& pdist,
                                                    const typename bsta_parzen_updater<parzen_dist_>::vector_& sample)
const
{
...
void bsta_parzen_adapt_bw_updater<parzen_dist_>::operator()( parzen_dist_& pdist,
                                                             const typename bsta_parzen_adapt_bw_updater<parzen_dist_>::vector_& sample)
const
{
  typedef typename parzen_dist_::math_type T;
...
template <class parzen_dist_>
void bsta_parzen_updater<parzen_dist_>::operator()( parzen_dist_ &,
                                                    const typename bsta_parzen_updater<parzen_dist_>::vector_ &) const {}

template <class parzen_dist_>
void bsta_parzen_adapt_bw_updater<parzen_dist_>::operator()( parzen_dist_ &,
                                                             const typename bsta_parzen_adapt_bw_updater<parzen_dist_>::vector_ &)
const {}
#endif
