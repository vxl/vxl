// This is brl/bbas/bsta/algo/bsta_sample_set.txx
#ifndef bsta_sample_set_txx_
#define bsta_sample_set_txx_
// :
// \file
...
bool
bsta_sample_set<T, n>::mean(typename bsta_parzen_sphere<T, n>::vector_type const& pt, typename bsta_parzen_sphere<T,
                                                                                                                  n>::vector_type& out)
{
...
bsta_sample_set<T, n>::mode_mean(int mode, vector_& out) const
{
  ...
  if( bsta_parzen<T,
                  n>::samples_.size() != weights_.size() || bsta_parzen<T, n>::samples_.size() != assignments_.size() )
    {
