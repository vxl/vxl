...
T sample_2d()
{
  T th[63] = {T(-3.14159), T(-3.04159), T(-2.94159), T(-2.84159), T(-2.74159), T(-2.64159), T(-2.54159), T(-2.44159), T(
                -2.34159), T(-2.24159), T(-2.14159), T(-2.04159), T(-1.94159), T(-1.84159), T(-1.74159), T(-1.64159), T(
                -1.54159),
              T(-1.44159), T(-1.34159), T(-1.24159), T(-1.14159), T(-1.04159), T(-0.941593), T(-0.841593), T(-0.741593),
              T(
                -0.641593), T(-0.541593), T(-0.441593), T(-0.341593), T(-0.241593), T(-0.141593), T(-0.0415927), T(
                0.0584073), T(
                0.158407), T(0.258407), T(0.358407), T(0.458407), T(0.558407), T(0.658407), T(0.758407), T(0.858407), T(
                0.958407),
              T(1.05841), T(1.15841), T(1.25841), T(1.35841), T(1.45841), T(1.55841), T(1.65841), T(1.75841),
              T(1.85841), T(
                1.95841), T(2.05841), T(2.15841), T(2.25841), T(2.35841), T(2.45841), T(2.55841), T(2.65841),
              T(2.75841), T(
                2.85841), T(2.95841), T(3.05841)};
  T F[63] =
    {0., T(2.6095722659260293e-10), T(5.495264987441105e-10), T(9.020304479490863e-10), T(1.3767321561343852e-9), T(
      2.0793149411956304e-9), T(3.2176050649407998e-9), T(5.226452812295283e-9), T(9.065857218918642e-9), T(
      1.6960623731203717e-8), T(3.42983263259157e-8), T(7.46401210328259e-8), T(1.7324941502870866e-7), T(
      4.2418306188751966e-7), T(1.0827355917064834e-6), T(2.84795706721355e-6), T(7.633043295732147e-6),
    T(0.0000206206), T(0.0000555655), T(0.00014786), T(0.000384842), T(0.000970898), T(0.00235433), T(0.00544528), T(
      0.0119301), T(0.0246132), T(0.0475855), T(0.0858954), T(0.144425), T(0.22601), T(0.329426), T(0.448365), T(
      0.572307), T(0.689283), T(0.78933), T(0.866992), T(0.921841), T(0.957206), T(0.978112), T(0.989501), T(0.995254),
    T(0.997965), T(0.999167), T(0.999672), T(0.999874), T(0.999953), T(0.999983), T(0.999994), T(0.999998), T(0.999999),
...
vgl_point_2d<T> sample_3d(T kappa)
{
  ...
  double t1 = exk - 1.0;
  double t2 = exk / t1;
  double t3 = vcl_log(t1 * (t2 - p) );
  double theta = vcl_acos( (-kappa + t3) / kappa);
...
template <class T>
void test_von_mises_update_type(T epsilon, const vcl_string& type_name)
{
