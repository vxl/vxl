...
public:
  ...
  bsta_joint_histogram_3d(const T range_a, const unsigned nbins_a, const T range_b, const unsigned nbins_b,
                          const T range_c, const unsigned nbins_c, const T min_prob = 0.0);

  // :More general constructor defining a signed value range
  bsta_joint_histogram_3d(const T min_a, const T max_a, const unsigned nbins_a, const T min_b, const T max_b,
                          const unsigned nbins_b, const T min_c, const T max_c, const unsigned nbins_c,
  ...
  bool bin_at_val(const T a, const T b, const T c, int& ia, int & ib, int& ic) const;
  ...
  void print_to_vrml(vcl_ostream& os, bool relative_prob_scale = true, T red = T(1), T green = T(0),
                     T blue = T(0) ) const;
