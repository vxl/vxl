#ifndef bsta_joint_histogram_3d_txx_
#define bsta_joint_histogram_3d_txx_
// :
// \file
...
template <class T>
void bsta_joint_histogram_3d<T>::bin_max_count(unsigned& ia, unsigned& ib, unsigned & ic) const
{
  ia = 0; ib = 0; ic = 0;
...
#endif // bsta_joint_histogram_3d_txx_
