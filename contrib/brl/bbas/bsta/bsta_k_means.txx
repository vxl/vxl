...
#define BSTA_K_MEANS_INSTANTIATE(T, n)      \
  ...
  template unsigned bsta_k_means_weighted(vcl_vector<vnl_vector<T> > &, unsigned &, const vcl_vector<T> &, \
                                          vcl_vector<vnl_vector<T> > *, vcl_vector<unsigned> *); \
  template unsigned bsta_k_means_weighted(vcl_vector<vnl_vector_fixed<T, n> > &, \
                                          ...
                                          vcl_vector<unsigned> * partition); \
  template unsigned bsta_k_means(vcl_vector<vnl_vector<T> > &, unsigned &, vcl_vector<vnl_vector<T> > *, \
                                 vcl_vector<unsigned> *); \
  template unsigned bsta_k_means(vcl_vector<vnl_vector_fixed<T, n> > &, unsigned &, vcl_vector<vnl_vector_fixed<T, \
                                                                                                                n> > *, \
                                 vcl_vector<unsigned> *)

#endif // bsta_k_means_txx_
