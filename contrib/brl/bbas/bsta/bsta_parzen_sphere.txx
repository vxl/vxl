...
template <class T, unsigned int n>
T compute_probability(typename bsta_distribution<T, n>::vector_type const& min_pt, typename bsta_distribution<T,
                                                                                                              n>::vector_type const& max_pt, vcl_vector<typename bsta_distribution<T,
                                                                                                                                                                                   n>::vector_type> const& samples,
                      T var)
{
  typedef typename bsta_distribution<T, n>::vector_type vect_t;
  typedef typename vcl_vector<vect_t>::const_iterator   sit_t;
...
template <class T>
T bsta_parzen_sphere<T, 1>::prob_density(typename bsta_distribution<T, 1>::vector_type const& pt) const
{
...
// \returns a probability
template <class T>
T bsta_parzen_sphere<T, 1>::probability(typename bsta_distribution<T, 1>::vector_type const& min_pt,
...
template <class T, unsigned int n>
T bsta_parzen_sphere<T, n>::nearest_sample(const typename bsta_distribution<T, n>::vector_type& pt,
...
template <class T>
T bsta_parzen_sphere<T, 1>::nearest_sample(const typename bsta_distribution<T, 1>::vector_type & pt,
                                           unsigned& index) const
{
