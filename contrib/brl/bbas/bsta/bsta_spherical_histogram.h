...
public:
  ...
  bsta_spherical_histogram(unsigned n_azimuth, unsigned n_elevation, T azimuth_start, T azimuth_range,
                           T elevation_start, T elevation_range, ang_units units = DEG,
                           angle_bounds az_branch_cut = B_180_180, angle_bounds el_poles = B_90_90);
