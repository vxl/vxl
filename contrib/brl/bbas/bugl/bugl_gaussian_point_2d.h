...
public:  
  bugl_gaussian_point_2d(T x, T y, vnl_matrix_fixed<T, 2, 2> & s):bugl_uncertainty_point_2d<T>(x, y) {sigma_ = s;}
  ~bugl_gaussian_point_2d() {}
};

#define BUGL_GAUSSIAN_POINT_2D_INSTANTIATE(T) extern "please include bugl/gaussian_point_2d_.txx first"
#endif
