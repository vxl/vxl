...
public:
  ...
  static void write_to_kml(bvgl_2d_geo_index_node_sptr root, unsigned const& depth, vcl_string const& kml_file,
                           vcl_string explanation = "location");
  ...
  static void write_to_kml_node(vcl_ofstream& ofs, bvgl_2d_geo_index_node_sptr n, unsigned const& current_depth,
                                unsigned const& depth, vcl_string explanation = "location");

  static void write_to_kml_node(vcl_ofstream& ofs, bvgl_2d_geo_index_node_sptr n, unsigned const& current_depth,
                                unsigned const& depth, vpgl_lvcs_sptr const& lvcs, vcl_string explanation = "location");
  ...
  static void get_leaves(bvgl_2d_geo_index_node_sptr root, vcl_vector<bvgl_2d_geo_index_node_sptr>& leaves,
                         vgl_box_2d<double> const& region);

  static void get_leaves(bvgl_2d_geo_index_node_sptr root, vcl_vector<bvgl_2d_geo_index_node_sptr>& leaves,
                         vgl_box_2d<float>  const& region);
  ...
  static void get_leaf(bvgl_2d_geo_index_node_sptr root, bvgl_2d_geo_index_node_sptr& leaf,
  ...
  static unsigned depth(bvgl_2d_geo_index_node_sptr node);
