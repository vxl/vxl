// This is brl/bbas/bvgl/algo/bvgl_2d_geo_index.txx
#ifndef bvgl_2d_geo_index_txx_
#define bvgl_2d_geo_index_txx_
// :
// \file
...
template <class Type>
void construct_sub_tree_poly(bvgl_2d_geo_index_node_sptr parent, double const& min_size,
...
#define BVGL_2D_GEO_INDEX_INSTANTIATE(T) \
  template bvgl_2d_geo_index_node_sptr bvgl_2d_geo_index::construct_tree<T>(vgl_box_2d<double> const & bbox, \
                                                                            double const & min_size); \
  template bvgl_2d_geo_index_node_sptr bvgl_2d_geo_index::construct_tree<T>(vgl_box_2d<float> const & bbox, \
  ...
  template bvgl_2d_geo_index_node_sptr bvgl_2d_geo_index::construct_tree<T>(vgl_box_2d<float> const & bbox, \
                                                                            float const & min_size, \
                                                                            vgl_polygon<float> const & poly); \
  template bvgl_2d_geo_index_node_sptr bvgl_2d_geo_index::read_and_construct<T>(vcl_string const & file_name, \
                                                                                double& min_size);

#endif // bvgl_2d_geo_index_txx_
