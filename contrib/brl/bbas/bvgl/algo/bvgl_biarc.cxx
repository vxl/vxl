...
bvgl_biarc::bvgl_biarc(vgl_point_2d<double> start, double start_angle, double k1, double len1, double k2, double len2)
...
bvgl_biarc::bvgl_biarc( vgl_point_2d<double> start, double start_angle,
...
// : Constructor - from 2 point-tangents
bvgl_biarc::bvgl_biarc(vgl_point_2d<double> start, vgl_vector_2d<double> start_tangent,
...
void bvgl_biarc::set_start_angle( double start_angle )
{
...
void bvgl_biarc::set_end_angle( double end_angle )
{
...
bool bvgl_biarc::is_consistent() const
{
  // check end point
  double len = this->len();
...
vgl_point_2d<double> bvgl_biarc::mid_pt() const
{
...
vgl_point_2d<double> bvgl_biarc::center1() const
{
...
vgl_point_2d<double> bvgl_biarc::center2() const
{
...
vgl_point_2d<double> bvgl_biarc::point_at( double s) const
{
...
vgl_vector_2d<double> bvgl_biarc::tangent_at( double s) const
{
  // assert(s >= 0 && s <= this->len());
...
double bvgl_biarc::curvature_at( double s) const
{
  assert(s >= 0 && s <= this->len() );
  if( s <= this->len1() )
    {
...
void bvgl_biarc::set_start_params( vgl_point_2d<double> start, double start_angle )
{
...
void bvgl_biarc::set_end_params( vgl_point_2d<double> end, double end_angle )
{
  this->set_end(end);
...
bool bvgl_biarc::compute_biarc_params()
{
...
bool bvgl_biarc::compute_biarc_params( vgl_point_2d<double> start, double start_angle,
                                       vgl_point_2d<double> end, double end_angle )
{
  this->set_start_params(start, start_angle);
  this->set_end_params(end, end_angle);
...
// : compute biar parameters, given start and end parameters
bool bvgl_biarc::compute_biarc_params(const vgl_point_2d<double>& start,
...
double bvgl_biarc::compute_join_theta(double k1, double k2)
{
...
// angle t0 to t1
double bvgl_biarc::compute_arclength(double t0, double t1, double k)
{
  double num = (t1 - t0);
...
void bvgl_biarc::print(vcl_ostream & os ) const
{
