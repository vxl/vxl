...
public:
  ...
  bvgl_biarc( vgl_point_2d<double> start, double start_angle, vgl_point_2d<double> end, double end_angle );

  // : Constructor - from 2 point-tangents
  bvgl_biarc( vgl_point_2d<double> start, vgl_vector_2d<double> start_tangent, vgl_point_2d<double> end,
  ...
  bool compute_biarc_params( vgl_point_2d<double> start, double start_angle, vgl_point_2d<double> end,
                             double end_angle );

  // : compute biar parameters, given start and end parameters
  bool compute_biarc_params(const vgl_point_2d<double>& start, const vgl_vector_2d<double>& start_tangent,
