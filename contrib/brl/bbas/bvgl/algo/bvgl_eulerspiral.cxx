...
private:
  ...
  bvgl_eulerspiral_optimization_function(unsigned int number_of_unknowns, unsigned int number_of_residuals,
...
bvgl_eulerspiral::bvgl_eulerspiral(vgl_point_2d<double> start, double start_angle, double k0, double gamma, double len)
...
bvgl_eulerspiral::bvgl_eulerspiral(vgl_point_2d<double> start, double start_angle,
...
// : Copy Constructor
bvgl_eulerspiral::bvgl_eulerspiral(const bvgl_eulerspiral & es )
...
void bvgl_eulerspiral::set_start_angle( double start_angle )
{
...
void bvgl_eulerspiral::set_end_angle( double end_angle )
{
...
vgl_point_2d<double> bvgl_eulerspiral::point_at_length( double s) const
{
  return this->compute_end_pt(this->k0(), this->gamma(), s);
}

vgl_point_2d<double> bvgl_eulerspiral::point_at( double s) const
{
  return point_at_length(s * length() );
}

// : Return tangent of a point on the eulerspiral with s arclength away from starting point
vgl_vector_2d<double> bvgl_eulerspiral::tangent_at_length( double s) const
{
  double angle;
...
vgl_vector_2d<double> bvgl_eulerspiral::tangent_at( double s) const
{
...
double bvgl_eulerspiral::curvature_at_length( double s ) const
{
  return this->k0() + s * this->gamma();
}

double bvgl_eulerspiral::curvature_at( double s ) const
{
  return curvature_at_length(s * length() );
}

// : compute extrinsic points of eulerspiral
void bvgl_eulerspiral::compute_spiral(vcl_vector<vgl_point_2d<double> >& spiral, double ds, int npts)
{
...
void bvgl_eulerspiral::init(const vgl_point_2d<double>& start, double start_angle, double k0, double gamma, double len)
{
...
void bvgl_eulerspiral::set_intrinsic_params(double k0, double gamma, double len)
{
  this->set_k0(k0);
  this->set_gamma(gamma);
  this->set_len(len);
...
void bvgl_eulerspiral::set_extrinsic_params(const vgl_point_2d<double>& start, double start_angle)
{
  this->set_start(start);
  this->set_start_angle(start_angle);
}
...
void bvgl_eulerspiral::set_start_params( vgl_point_2d<double> start, double start_angle )
{
  this->set_start(start);
  this->set_start_angle(start_angle);
}
...
void bvgl_eulerspiral::set_end_params( vgl_point_2d<double> end, double end_angle )
{
  this->set_end(end);
...
void bvgl_eulerspiral::set_params( vgl_point_2d<double> start, double start_angle,
                                   vgl_point_2d<double> end, double end_angle )
{
  this->set_start_params(start, start_angle);
  this->set_end_params(end, end_angle);
...
bool bvgl_eulerspiral::compute_es_params( bool use_lookup_table, bool use_levenberg_marquardt )
{
...
bool bvgl_eulerspiral::compute_es_params( vgl_point_2d<double> start, double start_angle,
                                          vgl_point_2d<double> end, double end_angle )
{
...
bool bvgl_eulerspiral::operator==(const bvgl_eulerspiral& that) const
{
...
// : assignment operator
bvgl_eulerspiral & bvgl_eulerspiral::operator=( bvgl_eulerspiral const& that)
{
...
void bvgl_eulerspiral::print(vcl_ostream & os )
{
...
inline double bvgl_eulerspiral::compute_error(double k0, double len)
{
...
vgl_point_2d<double> bvgl_eulerspiral::compute_end_pt( double k0, double gamma, double len, bool normalized ) const
{
...
bool bvgl_eulerspiral::compute_es_params_use_simple_gradient_descent( bool use_lookup_table )
{
  ...
  if( use_lookup_table )
    ...
    if( bvgl_eulerspiral_lookup_table::instance()->has_table() )
      ...
      num_offset_cycle =
        vnl_math::rnd( (this->end_angle() - this->start_angle() - turning_angle_est) / (  vnl_math::pi * 2) );
...
bool bvgl_eulerspiral::compute_es_params_use_levenberg_marquardt(bool use_lookup_table )
{
...
void bvgl_eulerspiral_lookup_table::look_up(double start_angle, double end_angle, double* k0, double* gamma,
                                            double* len,
...
bvgl_eulerspiral_optimization_function::bvgl_eulerspiral_optimization_function(unsigned int number_of_unknowns,
...
void bvgl_eulerspiral_optimization_function::f(vnl_vector<double> const& x, vnl_vector<double>& fx)
{
