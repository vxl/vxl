// This is brl/bbas/bvgl/bvgl_h_matrix_1d_compute.cxx
...
void bvgl_h_matrix_1d_compute::verbose(bool v) { verbose_=v; }
...
bool
bvgl_h_matrix_1d_compute::compute_array_dbl(const double p1[],
                                            const double p2[],
                                            int N,
                                            ...
                                            bvgl_h_matrix_1d<double>& )
{
  vcl_cerr << "\nbvgl_h_matrix_1d_compute::compute_cool_homg() :\n"
           ...
           << "overridden by a class derived from bvgl_h_matrix_1d_compute.\n";
  vcl_abort();
  return false;
}
...
bool
bvgl_h_matrix_1d_compute::compute(const vcl_vector<vgl_homg_point_1d<double> > &p1,
