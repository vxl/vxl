#include <bvgl/bvgl_h_matrix_1d_compute_optimize1.h>
#include <bvgl/bvgl_h_matrix_1d_compute_linear.h>
...
static
void do_compute(const vcl_vector<double> &z1,const vcl_vector<double> &z2,bvgl_h_matrix_1d<double>  &M)
{
  //
...
bvgl_h_matrix_1d_compute_optimize1(void) : bvgl_h_matrix_1d_compute() { }

bvgl_h_matrix_1d_compute_optimize1::~bvgl_h_matrix_1d_compute_optimize1() { }

bool bvgl_h_matrix_1d_compute_optimize1::
                  ...
                  bvgl_h_matrix_1d<double>& M)
{
  ...
  bvgl_h_matrix_1d_compute_linear C;
  C.compute(p1,p2,M);
  ...
  bvgl_h_matrix_1d<double>  K;
  do_compute(z1,z2,K);
  M=bvgl_h_matrix_1d<double> (K,M);      // refine M using the correction K.
  return true;
}
