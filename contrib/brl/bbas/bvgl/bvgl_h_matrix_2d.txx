//--*-c++-*------
// This is brl/bbas/bvgl/bvgl_h_matrix_2d.cxx
...
//: Default constructor
template <class T>
bvgl_h_matrix_2d<T>::bvgl_h_matrix_2d<T>()
{
}

//: Copy constructor
template <class T>
bvgl_h_matrix_2d<T>::bvgl_h_matrix_2d<T>(const bvgl_h_matrix_2d& M)
{
...
template <class T>
bvgl_h_matrix_2d<T>::bvgl_h_matrix_2d<T>(vcl_istream& s)
{
...
template <class T>
bvgl_h_matrix_2d<T>::bvgl_h_matrix_2d<T>(char const* filename)
{
...
//: Constructor
template <class T>
bvgl_h_matrix_2d<T>::bvgl_h_matrix_2d<T>(vnl_matrix_fixed<T,3,3> const& M):
  t12_matrix_ (M)
{
}
...
//: Constructor
template <class T>
bvgl_h_matrix_2d<T>::bvgl_h_matrix_2d<T> (const T* H)
  : t12_matrix_ (H)
{
}
