//--*-c++-*--
#ifndef bvgl_h_matrix_2d_compute_h_
#define bvgl_h_matrix_2d_compute_h_
//:
// \file
//
...
//      2. Obsoleted bool compute(bvgl_h_matrix_2d<double>  *). So don't use it!
...
class bvgl_h_matrix_2d_compute {
public:
  bvgl_h_matrix_2d_compute() : verbose_(false) { }
  virtual ~bvgl_h_matrix_2d_compute() { }
...
#endif // bvgl_h_matrix_2d_compute_h_
