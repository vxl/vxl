#ifndef _bvgl_h_matrix_2d_compute_linear_h
#define _bvgl_h_matrix_2d_compute_linear_h
//:
// \file
//
...
#include <bvgl/bvgl_h_matrix_2d_compute.h>
class bvgl_h_matrix_2d_compute_linear : public bvgl_h_matrix_2d_compute
{
...
bool compute_p(vcl_vector<vgl_homg_point_2d<double> > const& points1,
 ...
 public:
  bvgl_h_matrix_2d_compute_linear(bool allow_ideal_points = false);
  int minimum_number_of_correspondences() const { return 4; }
};

#endif // _bvgl_h_matrix_2d_compute_linear_h
