...
public:
  ...
  // Data Access---------------------------------------------------------------
  vgl_ray_3d<float> const & operator()(vcl_size_t scale, vcl_size_t i,
                                       vcl_size_t j) const { return pyramid_[scale][i][j]; }
  vgl_ray_3d<float>      & operator()(vcl_size_t scale, vcl_size_t i,
                                      vcl_size_t j)       { return pyramid_[scale][i][j]; }
