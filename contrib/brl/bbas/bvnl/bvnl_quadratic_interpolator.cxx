...
#include <bvnl/bvnl_quadratic_interpolator.h>
  ...
  for(int i=0; i<n; i++)
    {
      ...
      double yi4 = yi3*pyi;
      double xiyi = pxi*pyi;
      double xi2yi = pxi*xiyi;
      double xi3yi = xi3*pyi;
      double xi2yi2 = xi2*yi2;
      double xiyi2 = pxi*yi2; 
      double xiyi3 = pxi*yi3;
      double vixi2 = vi*xi2;
      double vixiyi = vi*xiyi;
      double viyi2 = vi*yi2;
      double vixi = vi*pxi;
      double viyi = vi*pyi;
      double vi2 = vi*vi;
