...
public:
  ...
  static vgl_point_3d<double> fit_sphere_to_corner(vgl_point_3d<double> P1, vgl_vector_3d<double> N1,
                                                   ...
                                                   vgl_point_3d<double> P3, vgl_vector_3d<double> N3, double r);

  static bool find_intersection_points(vgl_homg_point_2d<double> img_point1, vgl_homg_point_2d<double> img_point2,
                                       vsol_polygon_3d_sptr poly3d, vgl_point_3d<double>& point1,
                                       vgl_point_3d<double>& l1, vgl_point_3d<double>& l2, vgl_point_3d<double>& point2,
  ...
  static bool fit_circle(const vcl_list<vgl_point_2d<double> > & points, double & radius,
