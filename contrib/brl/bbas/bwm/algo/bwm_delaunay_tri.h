...
//:
// \file
// \brief Delaunay triangulation for a set of 3D points. Triangulation happens
//        in 2D by only using (x,y) component and moving them back to 3D
//
// \author Vishal Jain
// \date   6/10/2008
//
...
private:
  ...
  int CircumCircle(vgl_point_2d<double> p, 
