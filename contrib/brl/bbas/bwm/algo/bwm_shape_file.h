...
#if 0 // commented out
typedef enum { NULL = 0, POINT = 1, ARC = 3, POLYGON = 5, MULTIPOINT = 8, POINT3D = 11, ARC3D = 13, POLYGON3D = 15,
               MULTIPOINT3D = 18, POINTM = 21, ARCM = 23, POLYGONM = 25, MULTIPOINTM = 28,
               MULTIPATCHM = 31 } BWM_SHAPE_TYPE;
typedef enum { NULL, POINT, ARC = 3, POLYGON, MULTIPOINT, POINT3D, ARC3D, POLYGON3D, MULTIPOINT3D, POINTM, ARCM,
               POLYGONM, MULTIPOINTM,
               MULTIPATCHM }      BWM_SHAPE_TYPE;
#endif // 0
