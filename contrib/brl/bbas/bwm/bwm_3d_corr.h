...
public:
  ...
  // : replace a 3-d point
  bool update_match(vcl_string const& site, vgl_point_3d<double> old_pt, vgl_point_3d<double> new_pt);

  // :set a match
  void set_match(vcl_string const& site, const double x, const double y, const double z);
