                                 ...
                                 vgl_point_3d<double> p2)
{
  ...
  if (edge1 == 0 || edge2 == 0) {
    vcl_cerr << "bwm_observable_mesh::divide_face -- edges are not found in polygon " << vcl_endl;
    return;
  }
...
void bwm_observable_mesh::attach_inner_face(unsigned face_id, vsol_polygon_3d_sptr poly)
{
  ...
  if (outer_face != 0) {
    ...
    vcl_cerr << "bwm_observable_mesh::attach_inner_face() -- outer face id is not valid" << vcl_endl;
  }
}
