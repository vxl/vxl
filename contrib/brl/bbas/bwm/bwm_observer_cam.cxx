...
bool bwm_observer_cam::handle(const vgui_event &e)
{
  ...
  //////////////////////////////////////////////////////////////////////
  // Handling of the Right Mouse Click, which MOVES the selected polygon
  /*if (e.type == vgui_BUTTON_DOWN && 
      ...
      if (polygon_selected_ != 0) {
        float wx = e.wx;
        float wy = e.wy;     
        pi.window_to_image_coordinates(e.wx, e.wy, cur_pointx, cur_pointy);
        this->move_ground_plane(bwm_observer_mgr::BWM_MASTER_OBSERVER->get_proj_plane(), 
          new vsol_point_2d(cur_pointx, cur_pointy));
      }
      return true;
    }
