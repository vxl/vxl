...
void bwm_observer_cam_rat::center_pos()
{
...
bool bwm_observer_cam_rat::intersect_ray_and_plane(vgl_homg_point_2d<double> img_point,
...
void bwm_observer_cam_rat::save_all()
{
  vgui_dialog params("File Save");
...
void bwm_observer_cam_rat::save_gml()
{
  if (!lvcs_) {
...
void bwm_observer_cam_rat::save_x3d()
{
  if (lvcs_ != 0) {
    vcl_cerr << "Error: lvcs not defined.\n";
    return;
...
void bwm_observer_cam_rat::save_kml_collada()
{
  if (!lvcs_) {
    vcl_cerr << "Error: lvcs not defined.\n";
    return;
...
void bwm_observer_cam_rat::generate_textures()
{
  if (!lvcs_) {
...
void bwm_observer_cam_rat::load_lvcs()
{
  vcl_string filename = select_file();
...
vcl_string bwm_observer_cam_rat::select_file()
{
