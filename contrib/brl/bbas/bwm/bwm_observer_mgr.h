...
public:
  ...
  vcl_vector<bwm_observable_sptr> all_selected_observables(vcl_string const& soview_type) const;
  ...
  static void save_3d_corrs(vcl_string const& path, vcl_vector<bwm_3d_corr_sptr> const& corrs);

  // : load 3d_corrs from an ascii file
  void load_3d_corrs();

  static void load_3d_corrs(vcl_string const& path, vcl_vector<bwm_3d_corr_sptr>& corrs);
