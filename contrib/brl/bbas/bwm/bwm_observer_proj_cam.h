...
public:
  ...
  bwm_observer_proj_cam(bgui_image_tableau_sptr img, vcl_string name, vcl_string& image_path, vcl_string& cam_path,
                        vcl_string& sub_type, bool display_image_path);
  ...
  static vpgl_camera<double> * read_camera(vcl_string cam_path, vcl_string subtype, unsigned ni = 0, unsigned nj = 0);
