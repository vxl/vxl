...
public:
  ...
  bwm_observer_rat_cam(bgui_image_tableau_sptr img, vcl_string& name, vcl_string& image_path, vcl_string& cam_path,
  ...
  static vpgl_camera<double> * read_camera(vcl_string cam_path, bool& local);
