...
//: updates the soview objects on the pane. This is activated by the observer itself,
// not the observables. The change is due to the movement of projection plane, and 
