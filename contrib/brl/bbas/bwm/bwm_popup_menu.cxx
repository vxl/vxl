...
void bwm_popup_menu::get_menu(vgui_menu & menu)
{
  ...
  poly_draw_menu.add("Vertex...",
                     new vgui_command_simple<bwm_tableau_img>(img_tab, &bwm_tableau_img::set_vertex_mode) );
  submenu.separator();
...
//            vgui_key('-'));
  ...
  if( tab_->type_name().compare("bwm_tableau_proj_cam")    == 0 ||
    ...
    cal_submenu.add("Set Focal Length(pix)",
                    new vgui_command_simple<bwm_tableau_cam>(cam_tab, &bwm_tableau_cam::set_focal_length) );
    cal_submenu.add("Set Camera Height (m)",
                    new vgui_command_simple<bwm_tableau_cam>(cam_tab, &bwm_tableau_cam::set_cam_height) );
    cal_submenu.add("Define Horizon(selected line)",
                    new vgui_command_simple<bwm_tableau_cam>(cam_tab, &bwm_tableau_cam::set_horizon) );
    cal_submenu.add("Calibrate From Horizon",
                    new vgui_command_simple<bwm_tableau_cam>(cam_tab, &bwm_tableau_cam::calibrate_cam_from_horizon) );
    cal_submenu.add("Toggle Horizon",
                    new vgui_command_simple<bwm_tableau_cam>(cam_tab, &bwm_tableau_cam::toggle_cam_horizon) );
    ...
    cal_submenu.add("Add Ground Plane",
                    new vgui_command_simple<bwm_tableau_cam>(cam_tab, &bwm_tableau_cam::add_ground_plane) );
    ...
    cal_submenu.add("Edit Region Properties",
                    new vgui_command_simple<bwm_tableau_cam>(cam_tab, &bwm_tableau_cam::edit_region_props) );
    cal_submenu.add("Edit Region Weights",
                    new vgui_command_simple<bwm_tableau_cam>(cam_tab, &bwm_tableau_cam::edit_region_weights) );
    cal_submenu.add("Save Depth Map Scene",
                    new vgui_command_simple<bwm_tableau_cam>(cam_tab, &bwm_tableau_cam::save_depth_map_scene) );
    ...
    if( gen_tab )
      ...
      menu.separator();
      menu.add( "Ray image",
                new vgui_command_simple<bwm_tableau_generic_cam>(gen_tab, &bwm_tableau_generic_cam::ray_image) );
      }
    reg_submenu.add( "Set as EO", new vgui_command_simple<bwm_tableau_cam>(cam_tab, &bwm_tableau_cam::set_eo) );
    reg_submenu.separator();
    reg_submenu.add( "Set as Other Mode",
                     new vgui_command_simple<bwm_tableau_cam>(cam_tab, &bwm_tableau_cam::set_other_mode) );
    reg_submenu.separator();
  ...
  if( tab_->type_name().compare("bwm_tableau_video") == 0 )
    ...
    video_corr_submenu.add( "Add Match at Vertex",
                            new vgui_command_simple<bwm_tableau_video>(video_tab,
                                                                       &bwm_tableau_video::add_match_at_vertex) );
    video_corr_submenu.separator();
    ...
    video_corr_submenu.add( "Track Selected Corr ",
                            new vgui_command_simple<bwm_tableau_video>(video_tab,
                                                                       &bwm_tableau_video::
                                                                       set_selected_corr_for_tracking) );
    video_corr_submenu.separator();

    video_corr_submenu.add( "Stop Tracking Corr ",
                            new vgui_command_simple<bwm_tableau_video>(video_tab,
                                                                       &bwm_tableau_video::
                                                                       unset_selected_corr_for_tracking) );
    video_corr_submenu.separator();
