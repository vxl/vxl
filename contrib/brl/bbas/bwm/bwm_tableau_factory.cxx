...
else if (t->type_name.compare(FIDUCIAL_TABLEAU_TAG) == 0) {
    bwm_io_tab_config_fiducial* fid_io_tab = static_cast<bwm_io_tab_config_fiducial* > (t);
    bgui_image_tableau_sptr img = bgui_image_tableau_new();
    bwm_observer_fiducial* o =
