...
std::string bwm_tableau_proj_cam::save_camera()
{
  ...
  if (my_observer_->camera_adjusted()) {
    ...
    if(!cam){
      std::cout << " Null camera in bwm_tableau_proj_cam::save_camera()\n";
      return "";
    }
    ...
    if(cam->type_name()=="vpgl_proj_camera"||
      ...
      std::cout << " not projective camera type in bwm_tableau_proj_cam::save_camera()\n";
      return "";
    }
