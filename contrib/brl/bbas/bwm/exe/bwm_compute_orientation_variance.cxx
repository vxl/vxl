...
int main(int argc, char* * argv)
{
  ...
  if( argc != 3 )
    {
    vcl_cout
    << "usage: bwm_3d_fixed_transform -site_files <a txt file with the name of site xml files at each line> \n";
    return -1;
    }
  ...
  vcl_vector<vcl_vector<vcl_pair<vcl_pair<vnl_vector_fixed<double, 3>, vnl_matrix_fixed<double, 3, 3> >,
                                 unsigned> > > img_pt_norm_corrs;
  vnl_matrix_fixed<double, 3,
                   3> input_correspondence_cov;
