  ...
  for( unsigned i = 1; i < imgs.size(); i++ )
    ...
    for( unsigned ii = 0; ii < corrs.size(); ii++ )
      ...
      if( found1 && found2 )
        ...
        double                   val =
          vgl_homg_operators_2d<double>::perp_dist_squared( lr, vgl_homg_point_2d<double>( pt.first ) )
  ...
  for( unsigned i = 2; i < imgs.size(); i++ )
    ...
    for( unsigned ii = 0; ii < corrs.size(); ii++ )
      ...
      if( found1 && found2 && found3 )
        ...
        vgl_homg_point_2d<double> pt2_r =
          TFT.image2_transfer_qd(vgl_homg_point_2d<double>(pt1), vgl_homg_point_2d<double>(pt3) );
        double min_dist =
          vgl_homg_operators_2d<double>::distance_squared(pt2_r, vgl_homg_point_2d<double>(pt2) );
...
int main(int argc, char* * argv)
{
  ...
  if( argc < 5 )
    ...
    vcl_cout
      <<
    "usage: bwm_triangulate_2d_corrs -site <site file> -out <folder to save output> -t <threshold to declare fg/bg in pixels>\n";
    return -1;
    }
