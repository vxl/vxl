...
bwm_reg_edge_champher::bwm_reg_edge_champher(unsigned col_off, unsigned row_off,
...
//
// -----------------------------------------------------------------------------
void bwm_reg_edge_champher::initialize_arrays(vcl_vector<vsol_digital_curve_2d_sptr> const& edges)
{
...
//
// -----------------------------------------------------------------------------
unsigned bwm_reg_edge_champher::minimum_5(unsigned a, unsigned b, unsigned c, unsigned d, unsigned e)
{
  if( (a <= b) && (a <= c) && (a <= d) && (a <= e) )
    {
    return 1;
