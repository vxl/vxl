...
public:
  bwm_reg_image() {}
  bwm_reg_image(vil_image_resource_sptr const& image, vpgl_rational_camera<double> const& rcam,
  ...
  // : Compute edges
  bool compute_edges(float sigma, float noise_thresh, double radius_3d);
