...
public:
  ...
  static bool back_project_edges(vcl_vector<vsol_digital_curve_2d_sptr> const& edges_2d,
                                 vpgl_rational_camera<double> const& rcam, vgl_plane_3d<double> const& pl,
...
// Forward project a set of 3d digital curves onto an image
  static
  void project_edges(vcl_vector<vsol_digital_curve_3d_sptr> const& edges_3d, vpgl_rational_camera<double> const& rcam,
