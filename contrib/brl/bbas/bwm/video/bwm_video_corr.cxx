...
{
  std::map<unsigned, vgl_point_2d<double> >::iterator iter = matches_.begin();
...
unsigned bwm_video_corr::min_frame()
{
  ...
  std::map<unsigned, vgl_point_2d<double> >::iterator mit = matches_.begin();
...
void bwm_video_corr::x_write(std::ostream &os)
{
   ...
   std::map<unsigned, vgl_point_2d<double> >::iterator
     iter = matches_.begin();
