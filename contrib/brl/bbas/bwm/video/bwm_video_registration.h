...
public:
  ...
  static bool output_frame_bounds_planar(bwm_video_cam_istream_sptr& cam_stream,
                                         vgl_plane_3d<double> const& world_plane, unsigned input_ni, unsigned input_nj,
                                         vsol_box_2d_sptr& bounds, double& world_sample_distance,
  ...
  static bool register_image_stream_planar(vidl_istream_sptr& in_stream, bwm_video_cam_istream_sptr& cam_istream,
                                           vgl_plane_3d<double> const& world_plane, vsol_box_2d_sptr const& bounds,
                                           double world_sample_distance, vidl_ostream_sptr& out_stream,
                                           unsigned skip_frames = 0, bool preserve_float = true);

  // : Map input stream onto world plane and write out the homographies
  static
  bool register_planar_homographies(bwm_video_cam_istream_sptr& cam_istream, vgl_plane_3d<double> const& world_plane,
                                    vsol_box_2d_sptr const& bounds, double world_sample_distance,
                                    vcl_string const& homg_out_dir, unsigned skip_frames = 0);
