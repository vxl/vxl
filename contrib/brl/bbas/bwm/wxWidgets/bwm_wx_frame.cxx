  ...
  : wxFrame(parent, id, title, pos, size, type)
{
  ...
  corresp_menu->Append(Menu_Corr_Delete, wxT("&Delete Last Correspondences"),
                       wxT("Delete the last recorded Correspondence") );
  corresp_menu->Append(Menu_Corr_Delete_all, wxT("&Delete All Correspondences"),
                       wxT("Delete all of recorded Correspondence") );
