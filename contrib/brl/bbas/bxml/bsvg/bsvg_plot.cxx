...
void bsvg_plot::add_axes(float x_min, float x_max, float y_min, float y_max, float stroke_width)
{
  ...
  bsvg_line* line_xm =
    new bsvg_line(axes_orig_x_ + h2_x, axes_orig_y_, axes_orig_x_ + h2_x, axes_orig_y_ + (margin_ / 4.0f) );
  ...
  bsvg_line* line_ym = new bsvg_line(axes_orig_x_ - (margin_ / 4.0f), axes_orig_y_ - h2_y, axes_orig_x_,
                                     axes_orig_y_ - h2_y);
...
void bsvg_plot::add_line(const vcl_vector<float>& xs, const vcl_vector<float>& ys, const vcl_string& color,
                         float stroke_width)
{
...
bsvg_group * bsvg_plot::add_x_labels_helper(const vcl_vector<vcl_string>& x_labels, const vcl_string& color,
...
void bsvg_plot::add_bars(const vcl_vector<float>& heights, const vcl_vector<vcl_string>& x_labels, bool vertical_labels,
...
void bsvg_plot::add_bars(const vcl_vector<float>& heights, const vcl_vector<float>& x_labels, bool vertical_labels,
                         const vcl_string& color)
{
  bsvg_group* g = add_bars_helper(heights, color);
...
void bsvg_plot::add_splice(float center_x, float center_y, float radius, float start_angle, float end_angle,
                           const vcl_string& color)
{
