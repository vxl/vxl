...
public:
  ...
  bsvg_plot(float w, float h, float viewBox_x, float viewBox_y, float viewBox_w, float viewBox_h) : bsvg_document(w, h,
                                                                                                                  viewBox_x, viewBox_y, viewBox_w,
                                                                                                                  viewBox_h),
    margin_(default_margin), font_size_(default_font_size) {}
  ...
  void add_line(const vcl_vector<float>& xs, const vcl_vector<float>& ys, const vcl_string& color,
  ...
  void add_bars(const vcl_vector<float>& heights, const vcl_vector<float>& x_labels, bool vertical_labels,
                const vcl_string& color);

  void add_bars(const vcl_vector<float>& heights, const vcl_vector<vcl_string>& x_labels, bool vertical_labels,
                const vcl_string& color);
  ...
  bsvg_group * add_x_labels_helper(const vcl_vector<vcl_string>& x_labels, const vcl_string& color,
  ...
  void add_splice(float center_x, float center_y, float radius, float start_angle, float end_angle,
                  const vcl_string& color);
  ...
  void add_splice(float center_x, float center_y, float radius, float start_angle, float end_angle, unsigned red,
