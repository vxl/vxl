...
void bsvg_register::register_process()
{
  ...
  REG_PROCESS_FUNC_CONS(bprb_func_process, bprb_batch_process_manager, bsvg_bar_plot_initialize_process,
                        "bsvgBarPlotInitializeProcess");
  REG_PROCESS_FUNC_CONS(bprb_func_process, bprb_batch_process_manager, bsvg_bar_plot_add_process,
                        "bsvgBarPlotAddProcess");
  ...
  REG_PROCESS_FUNC_CONS(bprb_func_process, bprb_batch_process_manager, bsvg_plot_initialize_process,
                        "bsvgPlotInitializeProcess");
  REG_PROCESS_FUNC_CONS(bprb_func_process, bprb_batch_process_manager, bsvg_roc_plot_add_process,
                        "bsvgROCPlotAddProcess");
}
