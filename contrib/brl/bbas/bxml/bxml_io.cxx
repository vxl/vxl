...
int bxml_io::_current_object_index = 1;
vcl_vector<bxml_input_converter_sptr> bxml_io::_input_converters;
...
{
  for(vcl_vector<bxml_input_converter_sptr>::iterator cit=_input_converters.begin();
      cit != _input_converters.end(); cit++) {
...
void bxml_io::register_input_converter(bxml_input_converter_sptr conv)
{
  ...
  _input_converters.push_back(conv);
}
