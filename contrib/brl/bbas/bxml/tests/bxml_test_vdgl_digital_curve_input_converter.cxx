// This is brl/bbas/bxml/tests/bxml_test_vsol_point2d_input_converter.cxx
...
int main(int, char **)
{
  ...
  vcl_cout << "Testing bxml_vdgl_digital_curve_input_converter" << vcl_endl;
