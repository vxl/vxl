...
public:
  // : Constructor
  imesh_imls_surface(const imesh_mesh& mesh, double eps = 0.01, double lambda = 0.1, bool enforce_bounded = false,
  ...
  //  \a eps2 is epsilon^2
  static double line_integral(const vgl_point_3d<double>& x, const vgl_point_3d<double>& p0,
                              const vgl_point_3d<double>& p1, double v0, double v1, double eps);

  // : The derivative of the line integral with respect to x
  static vgl_vector_3d<double> line_integral_deriv(const vgl_point_3d<double>& x, const vgl_point_3d<double>& p0,
                                                   const vgl_point_3d<double>& p1, double v0, double v1, double eps2);
  ...
  //  \a eps2 is epsilon^2
  static vgl_vector_2d<double> split_triangle_quadrature(const vgl_point_3d<double>& x, const vgl_point_3d<double>& m,
                                                         const vgl_point_3d<double>& pp, const vgl_point_3d<double>& pm,
                                                         double v0, double v1, double v2, double eps);

  // : area integral of the squared weight function times a linearly interpolated value
  //  \a eps2 is epsilon^2
  template <class T, class F>
  static T triangle_quadrature(F quad_func, const vgl_point_3d<double>& x, const vgl_point_3d<double>& p0,
                               const vgl_point_3d<double>& p1, const vgl_point_3d<double>& p2,
                               const vgl_vector_3d<double>& n, double v0, double v1, double v2, double eps);
  ...
  //  call triangle_quadrature to first split an arbitrary triangle
  //  \a eps2 is epsilon^2
  static integral_data split_triangle_quadrature_with_deriv(const vgl_point_3d<double>& x,
                                                            const vgl_point_3d<double>& m,
                                                            const vgl_point_3d<double>& pp,
                                                            const vgl_point_3d<double>& pm, double v0, double v1,
                                                            double v2, double eps);
...
vgl_point_3d<double> bisect(const imesh_imls_surface& f, vgl_point_3d<double> pp, vgl_point_3d<double> pn,
...
//  Return true if successful
bool snap_to_surface_with_normal(const imesh_imls_surface& f, vgl_point_3d<double>& p, vgl_vector_3d<double> n,
...
//  Return true if successful
bool snap_to_surface(const imesh_imls_surface& f, vgl_vector_3d<double> dir, vgl_point_3d<double>& p, double step = 0.5,
                     double eps = 1e-5);
