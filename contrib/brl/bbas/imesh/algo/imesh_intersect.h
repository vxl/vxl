...
bool imesh_intersect_triangle(const vgl_point_3d<double>& p, const vgl_vector_3d<double>& d,
                              const vgl_point_3d<double>& a, const vgl_point_3d<double>& b,
                              const vgl_point_3d<double>& c, double& dist, double& u, double& v);
...
bool imesh_intersect_triangle(const vgl_point_3d<double>& p, const vgl_vector_3d<double>& d,
                              const vgl_point_3d<double>& a, const vgl_point_3d<double>& b,
                              const vgl_point_3d<double>& c, const vgl_vector_3d<double>& n, double& dist, double& u,
                              double& v);
...
//  \param dist is the distance to the triangle (returned by reference)
//  \param u and \param v are the barycentric coordinates of the intersection
bool imesh_intersect_triangle_min_dist(const vgl_point_3d<double>& p, const vgl_vector_3d<double>& d,
                                       const vgl_point_3d<double>& a, const vgl_point_3d<double>& b,
                                       const vgl_point_3d<double>& c, const vgl_vector_3d<double>& n, double& dist,
                                       double& u, double& v);
...
int imesh_intersect_min_dist(const vgl_point_3d<double>& p, const vgl_vector_3d<double>& d, const imesh_mesh& mesh,
...
unsigned char imesh_triangle_closest_point(const vgl_point_3d<double>& p, const vgl_point_3d<double>& a,
                                           const vgl_point_3d<double>& b, const vgl_point_3d<double>& c,
                                           const vgl_vector_3d<double>& n, double& dist, double& u, double& v);
...
//  \param u and \param v are the barycentric coordinates of the closest point
unsigned char imesh_triangle_closest_point(const vgl_point_3d<double>& p, const vgl_point_3d<double>& a,
                                           const vgl_point_3d<double>& b, const vgl_point_3d<double>& c, double& dist,
                                           double& u, double& v);

// : Find the closest point on the triangle a,b,c to point p
//  \param dist is the distance to the triangle (returned by reference)
vgl_point_3d<double> imesh_triangle_closest_point(const vgl_point_3d<double>& p, const vgl_point_3d<double>& a,
                                                  const vgl_point_3d<double>& b, const vgl_point_3d<double>& c,
                                                  double& dist);
...
int imesh_closest_point(const vgl_point_3d<double>& p, const imesh_mesh& mesh, vgl_point_3d<double>& cp, double* u = 0,
                        double* v = 0);
...
//  \param u and \param v are the barycentric coordinates of the intersection
unsigned char imesh_triangle_intersect(const vgl_point_2d<double>& p, const vgl_vector_2d<double>& d,
                                       const vgl_point_2d<double>& a, const vgl_point_2d<double>& b,
                                       const vgl_point_2d<double>& c, double& u, double& v);
...
unsigned char imesh_triangle_intersect(double& u, double& v, const double& du, const double& dv,
