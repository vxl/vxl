...
public:
  ...
  imesh_pca_mesh(const imesh_mesh& mesh, const vnl_vector<double>& mean, const vnl_vector<double>& std_devs,
...
// : Read a PCA file
bool imesh_read_pca(const vcl_string& pca_file, vnl_vector<double>& mean, vnl_vector<double>& std_devs,
...
// : Write a PCA file
bool imesh_write_pca(const vcl_string& filename, const vnl_vector<double>& mean, const vnl_vector<double>& std_devs,
                     const vnl_matrix<double>& pc);
