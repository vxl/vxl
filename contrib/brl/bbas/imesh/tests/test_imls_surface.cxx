...
static void test_imls_surface()
{
  ...
  for( ; u > 0.01; u *= alpha )
    {
    vgl_point_3d<double> p0i( (1 - u) * p0.x() + u * p2.x(), (1 - u) * p0.y() + u * p2.y(),
                              (1 - u) * p0.z() + u * p2.z() );
    vgl_point_3d<double> p1i( (1 - u) * p1.x() + u * p2.x(), (1 - u) * p1.y() + u * p2.y(),
                              (1 - u) * p1.z() + u * p2.z() );
  ...
  n = cross_product(p1 - p0, p2 - p0) / 2.0;
    ...
    typedef T (*                              F) (const vgl_point_3d<double> &, const vgl_point_3d<double> &,
                                                  const vgl_point_3d<double> &, const vgl_point_3d<double> &, double,
