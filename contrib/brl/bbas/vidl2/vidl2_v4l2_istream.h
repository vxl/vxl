// This is brl/bbas/vidl2/vidl2_v4l2_istream.h
#ifndef vidl2_v4l2_istream_h_
#define vidl2_v4l2_istream_h_
//:
// \file
// \brief Adapter for class vidl2_istream
//
...
class vidl2_v4l2_istream: public vidl2_istream {
  ...
  public:
    //: Constructor
    vidl2_v4l2_istream(vidl2_v4l2_device& device);

    //: Destructor
    virtual ~vidl2_v4l2_istream() {dev.stop_capturing();}
    ...
    virtual vidl2_pixel_format format() const { return v4l2_to_vidl2(dev.get_v4l2_format()); }
