#ifndef volm_conf_buffer_txx_
#define volm_conf_buffer_txx_
...
volm_conf_buffer<T>::volm_conf_buffer()
  : current_id_(0), buffer_size_(0), active_buffer_(0), m_(NOT_INITIALIZED), file_name_(""), global_current_id_(0),
  ofs_ptr_(0), ifs_ptr_(0), prev_length_(-1), read_in_(0)
{
  length_vec_.clear();
}
...
volm_conf_buffer<T>::volm_conf_buffer(float const& buffer_capacity)
  : current_id_(0), m_(NOT_INITIALIZED), file_name_(""), global_current_id_(0), ofs_ptr_(0), ifs_ptr_(0), prev_length_(
    -1), read_in_(0)
{
  length_vec_.clear();
