...
private:
  ...
  void project(vpgl_perspective_camera<double> const& cam, vgl_polygon<double> const& poly, float& min_dist, float& phi,
  ...
  void project(vpgl_perspective_camera<double> const& cam, double const& pixel_i, double const& pixel_j, float& dist,
               float& phi);
