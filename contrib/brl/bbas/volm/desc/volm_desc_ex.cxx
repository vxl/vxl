...
volm_desc_ex::volm_desc_ex(vcl_vector<unsigned char> const& index_dst,
...
unsigned volm_desc_ex::bin_index(unsigned const& dist_idx, unsigned const& orient_idx, unsigned const& land_idx) const
{
  ...
  if( orient_idx == depth_map_region::POROUS || orient_idx == depth_map_region::INFINT ||
      orient_idx == depth_map_region::NON_PLANAR )
    {
...
unsigned volm_desc_ex::bin_index(double const& dist, depth_map_region::orientation const& orient,
                                 unsigned const& land) const
{
