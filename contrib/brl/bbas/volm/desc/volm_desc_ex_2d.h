...
public:
  ...
  volm_desc_ex_2d(vcl_vector<double> const& radius, double const& h_width = 360.0, double const& h_inc = 360.0,
  ...
  void set_count(unsigned const& dist_idx, unsigned const& land_idx, unsigned const& heading_idx,
