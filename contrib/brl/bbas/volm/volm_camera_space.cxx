...
volm_camera_space::volm_camera_space(vcl_vector<double> const& top_fovs, double altitude,
...
volm_camera_space::volm_camera_space(double top_fov_mid, double top_fov_rad, double top_fov_inc,
                                     double altitude,
                                     unsigned ni, unsigned nj,
                                     double head_mid,  double head_radius, double head_inc,
                                     double tilt_mid, double tilt_radius,  double tilt_inc,
