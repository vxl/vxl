...
void volm_geo_index::write_to_kml_node(vcl_ofstream& ofs, volm_geo_index_node_sptr n, unsigned current_depth,
...
volm_geo_index_node_sptr volm_geo_index::get_closest(volm_geo_index_node_sptr root, double lat, double lon,
                                                     unsigned& hyp_id)
{
  if( !root )
    {
