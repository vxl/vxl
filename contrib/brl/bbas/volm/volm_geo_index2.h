...
public:
  ...
  static bool prune_tree(volm_geo_index2_node_sptr root, vgl_polygon<double> const& poly);
  ...
  static void write_to_kml_node(vcl_ofstream& ofs, volm_geo_index2_node_sptr n, unsigned current_depth, unsigned depth,
  ...
  static void get_leaf(volm_geo_index2_node_sptr root, volm_geo_index2_node_sptr& leaf,
