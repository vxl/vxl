...
#define VOLM_GEO_INDEX2_INSTANTIATE(T) \
  ...
  template volm_geo_index2_node_sptr volm_geo_index2::construct_tree<T>(vgl_box_2d<double> bbox, \
  ...
  template volm_geo_index2_node_sptr volm_geo_index2::construct_tree<T>(volm_tile t, const double& min_size, \
                                                                        vgl_polygon<float> const & poly); \
  template volm_geo_index2_node_sptr volm_geo_index2::read_and_construct<T>(vcl_string const & flie_name, \
                                                                            double& min_size)
