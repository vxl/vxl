...
vcl_map<int, volm_attributes> create_label_map()
{
  ...
  m[0] =
    volm_attributes(0, "invalid",                                                 vil_rgb<vxl_byte>(255,  0,    0) );      // invalid
  m[volm_label_table::WATER] =
    volm_attributes(1, "Open Water",                         vil_rgb<vxl_byte>(0,    0,    100) );
  m[12] =
    volm_attributes(2, "Perennial Ice/Snow",                                      vil_rgb<vxl_byte>(255,  255,  200) );       //
  m[volm_label_table::DEVELOPED_OPEN] =
    volm_attributes(3, "Developed, Open Space",     vil_rgb<vxl_byte>(50,   0,    0) );
  m[volm_label_table::DEVELOPED_LOW] = volm_attributes(4, "Developed, Low Intensity",   vil_rgb<vxl_byte>(100,  0,
                                                                                                          10) );
  m[volm_label_table::DEVELOPED_MED] =
    volm_attributes(4, "Developed, Medium Intensity", vil_rgb<vxl_byte>(200,  0,    100) );                                   //  (combined with prev class)
  m[volm_label_table::DEVELOPED_HIGH] =
    volm_attributes(5, "Developed, High Intensity", vil_rgb<vxl_byte>(220,  0,    100) );                     //
  m[volm_label_table::SAND] = volm_attributes(6, "Barren Land Beach",  vil_rgb<vxl_byte>(170,  170,  170) );  //
  m[41] =
    volm_attributes(7, "Deciduous Forest",                    vil_rgb<vxl_byte>(0,    200,  0) );                           //
  m[42] =
    volm_attributes(8, "Evergreen Forest",                    vil_rgb<vxl_byte>(0,    250,  0) );                           //
  m[43] =
    volm_attributes(9, "Mixed Forest",                        vil_rgb<vxl_byte>(0,    100,  0) );                           //
  m[51] =                     volm_attributes(10, "Dwarf Scrub (Alaska only)",           vil_rgb<vxl_byte>(10,   50,
                                                                                                           0) );             //
  m[52] =                     volm_attributes(10, "Shrub/Scrub",                         vil_rgb<vxl_byte>(10,   50,
                                                                                                           0) );             //
  m[71] =                     volm_attributes(11, "Grassland/Herbaceous",               vil_rgb<vxl_byte>(0,    100,
                                                                                                          20) );            //
  m[72] =                     volm_attributes(11, "Sedge/Herbaceous (Alaska only)",     vil_rgb<vxl_byte>(0,    150,
                                                                                                          10) );            //
  m[73] =                     volm_attributes(11, "lichens",                            vil_rgb<vxl_byte>(0,    170,
                                                                                                          10) );            //
  m[74] =                     volm_attributes(11, "Moss (Alaska only)",                 vil_rgb<vxl_byte>(0,    200,
                                                                                                          10) );            //
  m[81] =
    volm_attributes(12, "Pasture Hay",                        vil_rgb<vxl_byte>(0,    120,  120) );                          //
  m[82] =                     volm_attributes(13, "Cultivated Crops",                   vil_rgb<vxl_byte>(210,  105,
                                                                                                          30) );            //
  m[90] =
    volm_attributes(14, "Woody Wetlands Marina",            vil_rgb<vxl_byte>(176,  196,  222) );                          //
  m[95] =
    volm_attributes(14, "Emergent Herbaceous Wetlands",       vil_rgb<vxl_byte>(176,  196,  255) );                          //
  m[volm_label_table::BUILDING] =
    volm_attributes(15, "building",                       vil_rgb<vxl_byte>(255,  255,  255) );                              //

  m[101] =
    volm_attributes(16, "airports",                                          vil_rgb<vxl_byte>(0,    255,  255) );
  m[102] =
    volm_attributes(17, "beaches",                                          vil_rgb<vxl_byte>(0,    200,  255) );
  m[103] =
    volm_attributes(18, "bridges",                                          vil_rgb<vxl_byte>(255,  10,   0) );
  m[104] =
    volm_attributes(19, "cemeteries",                                          vil_rgb<vxl_byte>(176,  176,  176) );
  m[105] =
    volm_attributes(20, "fcc_towers",                                          vil_rgb<vxl_byte>(255,  20,   0) );
  m[volm_label_table::FORT] =
    volm_attributes(21, "forts",                                          vil_rgb<vxl_byte>(255,  50,   0) );
  m[107] =
    volm_attributes(22, "golf_courses",                                          vil_rgb<vxl_byte>(0,    255,  200) );
  m[108] =
    volm_attributes(23, "harbors",                                          vil_rgb<vxl_byte>(255,  100,  0) );
  m[109] =
    volm_attributes(24, "hotels",                                          vil_rgb<vxl_byte>(255,  255,  200) );
  m[110] =
    volm_attributes(25, "lighthouses",                                          vil_rgb<vxl_byte>(255,  200,  0) );
  m[111] =
    volm_attributes(26, "marinas",                                          vil_rgb<vxl_byte>(255,  255,  100) );
  m[112] =
    volm_attributes(27, "mines",                                          vil_rgb<vxl_byte>(255,  0,    100) );
  m[113] =
    volm_attributes(28, "parks",                                          vil_rgb<vxl_byte>(10,   255,  1) );
  m[volm_label_table::PIER] =
    volm_attributes(29, "piers",                              vil_rgb<vxl_byte>(0,  0,    0) );
  m[115] =      volm_attributes(30, "wharves",                                          vil_rgb<vxl_byte>(255,  0,
                                                                                                          41) );
  m[116] =
    volm_attributes(31, "roads",                                            vil_rgb<vxl_byte>(255,  100,    41) );
  m[117] =
    volm_attributes(32, "parking_lots",                                     vil_rgb<vxl_byte>(255,  200,    41) );
  m[118] =
    volm_attributes(33, "beach_walkway",                                    vil_rgb<vxl_byte>(255,  200,    241) );
  m[volm_label_table::BUILDING_TALL] =
    volm_attributes(34, "tall_building",            vil_rgb<vxl_byte>(255,  200,    41) );                                        // has more than 5 floor height, >20 m of height (building itself), e.g. count at least 5 floors on the building. warning: if a building with 3 floors (12 m) is on top of a hill of ~8 m, it may be categorized as tall
...
void volm_category_attribute::read_category(vcl_map<vcl_string, volm_category_attribute> & category_table,
                                            vcl_string fname)
{
...
{
  for( vcl_map<unsigned char, vcl_vector<unsigned char> >::iterator iter = fallback_id.begin();
       iter != fallback_id.end(); iter++ )
    {
    vcl_cout << volm_label_table::land_string(iter->first) << " (" << (int)iter->first << "):\t";
    for( unsigned k = 0; k < iter->second.size(); k++ )
      {
      vcl_cout << volm_label_table::land_string(iter->second[k]) << '(' << (int)iter->second[k] << ", w: "
               << fallback_weight[iter->first][k] << ")\t";
      }
    vcl_cout << '\n';
    }
}
...
bool volm_io::read_labelme(vcl_string xml_file, vcl_string category_file, depth_map_scene_sptr& depth_scene,
                           vcl_string& img_category)
{
  ...
  for( unsigned i = 0; i < polys.size(); i++ )
    ...
    // ground plane
             ...
             (type == "beach" || type == "water" || type == "flat" || type == "road" || type == "grass" ||
              type == "sand" ||
              type == "dock" || type == "street") )
      {
      unsigned land_id =
        volm_label_table::land_id[volm_label_table::get_id_closest_name(category_table[type].lnd_)].id_;
                              ...
                              vcl_string& query_name)
{
  ...
  if( num_objs != object_land_types.size() || num_objs != object_mindist.size() ||
    ...
    {
    vcl_cerr << "ERROR parsing tag file " << xml_file
             << ": incomplete object properties definition, check tags in xml file\n";
    return false;
    }
  if( !parser.image_ni() || !parser.image_nj() )
    {
    vcl_cerr << "ERROR parsing tag file " << xml_file
             << ": missing image size information, check <nrows> and <ncols>\n";
    return false;
    }
  ...
  for( unsigned i = 0; i < num_objs; i++ )
    ...
    if( volm_osm_category_io::tag_to_volm_land_table.find(land_type) ==
        volm_osm_category_io::tag_to_volm_land_table.end() )
      {
      continue;
      }
    vsol_polygon_2d_sptr  poly = bsol_algs::poly_from_vgl(polys[i]);
                                   ...
                                   vcl_string& query_name)
{
  ...
  if( !parser.image_ni() || !parser.image_nj() )
    {
    vcl_cerr << "ERROR parsing tag file " << xml_file
             << ": missing image size or image name, check <nrows>, <ncols> or <filename>\n";
    return false;
    }
...
unsigned char volm_io::scale_score_to_1_255_sig(float const& kl, float const & ku, float const& threshold,
                                                float const& score)
{
  float t = threshold;
  float x;
...
bool volm_rationale::write_top_matches(vcl_multiset<vcl_pair<float, volm_rationale>, std::greater<vcl_pair<float,
                                                                                                           volm_rationale> > >& top_matches,
                                       vcl_string& filename)
{
...
bool volm_rationale::read_top_matches(vcl_multiset<vcl_pair<float, volm_rationale>, std::greater<vcl_pair<float,
                                                                                                          volm_rationale> > >& top_matches,
                                      vcl_string& filename)
{
...
int volm_io::read_gt_file(vcl_string gt_file, vcl_vector<vcl_pair<vgl_point_3d<double>, vcl_pair<vcl_pair<vcl_string,
                                                                                                          int>,
                                                                                                 vcl_string> > >& samples)
{
...
void volm_weight::equal_weight(vcl_vector<volm_weight>& weights, depth_map_scene_sptr dms)
{
  ...
  for( unsigned i = 0; i < dms->scene_regions().size(); i++ )
    {
    weights.push_back(volm_weight(dms->scene_regions()[i]->name(), dms->scene_regions()[i]->name(), 0.25f, 0.25f, 0.25f,
                                  0.25f, w_obj) );
    }
...
bool volm_io::read_building_file(vcl_string file, vcl_vector<vcl_pair<vgl_polygon<double>,
                                                                      vgl_point_2d<double> > >& builds,
...
bool volm_io::write_sme_kml_type(vcl_string file, vcl_string type_name, vcl_vector<vcl_pair<vgl_point_2d<double>,
                                                                                            int> >& objects)
{
  vcl_ofstream ofs(file.c_str() );
  bkml_write::open_document(ofs);
