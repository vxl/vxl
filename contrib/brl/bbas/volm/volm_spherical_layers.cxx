...
#define TOL -1E-8
volm_spherical_layers::volm_spherical_layers(vpgl_perspective_camera<double> const& cam,
...
volm_spherical_layers::volm_spherical_layers(depth_map_scene_sptr const& dm_scene,
                                             double altitude,
                                             volm_spherical_container_sptr const& sph_vol,
                                             volm_spherical_shell_container_sptr const& sph_shell,
                                             unsigned char invalid,
...
unsigned char volm_spherical_layers::fetch_depth(double const& u, double const& v,
...
bool volm_spherical_layers::compute_layers()
{
  ...
  vil_image_view<float>             gp_depth_img = dm_scene_->depth_map("ground_plane", log_downsample_ratio_,
                                                                        d_threshold_);
  unsigned count = 0;
