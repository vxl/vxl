...
{
public:
  volm_spherical_region_index(vcl_map<vcl_string, vcl_string> & index_file_paths, vcl_string usph_file_path);
  volm_spherical_region_index(vcl_map<vcl_string, vcl_vector<unsigned char> > & index_file_paths,
                              vsph_unit_sphere_sptr & usph);
  volm_spherical_region_index(float * boxes, int num_depth_regions, int num_orientation_regions, int num_nlcd_regions,
                              int sky_regions);
