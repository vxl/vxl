// This is contrib/brl/bbas/volm/volm_utils.txx
#ifndef volm_utils_txx_
#define volm_utils_txx_
// :
// \file
...
#define VOLM_UTILS_INSTANTIATE(T) \
  ...
  template vgl_polygon<T> volm_utils::poly_contains(vcl_vector<vgl_point_2d<T> > const & p_out, \
                                                    vgl_polygon<T> const & p_in); \
  template vgl_polygon<T> volm_utils::poly_contains(vgl_polygon<T> const & p_out, vgl_polygon<T> const & p_in)

#endif // volm_utils_txx_
