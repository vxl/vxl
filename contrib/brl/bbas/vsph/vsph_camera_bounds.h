...
public:
  ...
  static void pixel_solid_angle(vpgl_perspective_camera<double> const& cam, unsigned u, unsigned v,
                                vgl_ray_3d<double>& cone_axis, double& cone_half_angle, double& solid_angle);
  ...
  // Angles in radians and steradians
  static void pixel_solid_angle(vpgl_perspective_camera<double> const& cam, double& cone_half_angle,
                                double& solid_angle);
  ...
  // Angles in radians and steradians
  static void image_solid_angle(vpgl_perspective_camera<double> const& cam, vgl_ray_3d<double>& cone_axis,
                                double& cone_half_angle, double& solid_angle);
  ...
  // Angles in radians and steradians
  static void image_solid_angle(vpgl_perspective_camera<double> const& cam, double& cone_half_angle,
                                double& solid_angle);

  // : the solid angle for a scene bounding box.
  // The cone is tangent to the 3-d scene box.
  // Angles in radians and steradians
  static bool box_solid_angle(vpgl_perspective_camera<double> const& cam, vgl_box_3d<double> const& box,
                              vgl_ray_3d<double>& cone_axis, double& cone_half_angle, double& solid_angle);
  ...
  //  identity camera
  static void relative_transf(vpgl_perspective_camera<double> const& c0, vpgl_perspective_camera<double> const& c1,
                              vgl_rotation_3d<double>& rel_rot, vgl_vector_3d<double>& rel_trans);
  ...
  static bool pixel_cylinder(vpgl_generic_camera<double> const& cam, unsigned u, unsigned v,
                             vgl_ray_3d<double>& cylinder_axis, double& cylinder_radius);
  ...
  static bool planar_bounding_box(vpgl_perspective_camera<double> const& c, vgl_box_2d<double>& bbox,
                                  double z_plane = 0.0);

  // : The union of the planar bounding boxes at specific z plane for each camera passed in
  static bool planar_bounding_box(vcl_vector<vpgl_perspective_camera<double> > const& cams, vgl_box_2d<double>& bbox,
                                  double z_plane = 0.0);
