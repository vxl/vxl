...
public:
  ...
  vsph_sph_cover_2d(vsph_sph_box_2d const& region_bb, vcl_vector<vsph_sph_point_2d> const& region_rays,
                    double area_per_ray, double min_area_fraction = 0.9);
  ...
  vsph_sph_cover_2d transform(double t_theta, double t_phi, double scale, double theta_c, double phi_c,
                              bool in_radians) const;

private:
  // : compute area fraction inside the region
  double inside_area(vsph_sph_box_2d const& bb, vcl_vector<vsph_sph_point_2d> const& region_rays,
...
bool intersection(vsph_sph_cover_2d const& c1, vsph_sph_cover_2d const& c2, vsph_sph_cover_2d& cover_inter);
