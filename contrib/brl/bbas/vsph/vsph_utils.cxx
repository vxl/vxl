...
double vsph_utils::sph_inter_area(vsph_sph_box_2d const& b1, vsph_sph_box_2d const& b2)
{
  ...
  switch( flags )
    ...
    case 6: {
      ...
      if( vsph_utils::azimuth_in_interval(ha1, b1_a_phi, b1_b_phi, b1_c_phi,
                                          in_radians) &&
          vsph_utils::azimuth_in_interval(ha1, b2_a_phi, b2_b_phi, b2_c_phi, in_radians) )
        {
    ...
    case 15: {
      double dph2 = 0.0;
      vsph_utils::half_angle(b1_min_ph, b2_max_ph, ha1, ha2, in_radians);
      if( vsph_utils::azimuth_in_interval(ha1, b2_a_phi, b2_b_phi, b2_c_phi,
                                          in_radians) &&
...
void vsph_utils::ray_spherical_coordinates(vpgl_perspective_camera<double> const& cam,
                                           double u, double v,
...
vgl_polygon<double> vsph_utils::project_poly_onto_unit_sphere(vpgl_perspective_camera<double> const& cam,
