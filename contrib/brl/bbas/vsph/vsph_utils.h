...
public:
  ...
  static void half_angle(double phi_a, double phi_b, double& ang_1, double& ang_2, bool in_radians = true);
  ...
  static double distance_on_usphere(vsph_sph_point_2d const& a, vsph_sph_point_2d const& b);
  ...
  // {"radians", "degrees"}
  static void ray_spherical_coordinates(vpgl_perspective_camera<double> const& cam, double u, double v,
                                        double& elevation, double& azimuth, vcl_string units = "radians");
  ...
  //
  static vgl_polygon<double> project_poly_onto_unit_sphere(vpgl_perspective_camera<double> const& cam,
  ...
  static bool azimuth_in_interval(double phi, double a_phi_, double b_phi, double c_phi, bool in_radians);
