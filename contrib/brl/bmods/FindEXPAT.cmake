...
if(NOT EXPAT_FOUND)
  ...
  #
  if(NOT EXPAT_FOUND)
    if(EXISTS ${CMAKE_SOURCE_DIR}/contrib/brl/b3p/expat/expat.h)
      set( EXPAT_FOUND "YES" )
      set( EXPAT_LIBRARIES expat )
      set( EXPAT_LIBRARY expat )
      set( EXPAT_INCLUDE_DIRS ${CMAKE_SOURCE_DIR}/contrib/brl/b3p/expat ${CMAKE_BINARY_DIR}/contrib/brl/b3p/expat )
      set( EXPAT_INCLUDE_DIR  ${CMAKE_SOURCE_DIR}/contrib/brl/b3p/expat ${CMAKE_BINARY_DIR}/contrib/brl/b3p/expat )
...
if(EXPAT_FOUND) # EXPATPP requires EXPAT
  ...
  if( EXPATPP_SYSTEM_INCLUDE_DIR AND EXPATPP_SYSTEM_LIBRARY )
    ...
    if(EXISTS ${CMAKE_SOURCE_DIR}/contrib/brl/b3p/expatpp/expatpp.h)
      set( EXPATPP_FOUND "YES" )
      set( EXPATPP_LIBRARIES expatpp )
      set( EXPATPP_LIBRARY expatpp )
      set( EXPATPP_INCLUDE_DIRS ${CMAKE_SOURCE_DIR}/contrib/brl/b3p/expatpp ${CMAKE_BINARY_DIR}/contrib/brl/b3p/expatpp )
      set( EXPATPP_INCLUDE_DIR ${CMAKE_SOURCE_DIR}/contrib/brl/b3p/expatpp ${CMAKE_BINARY_DIR}/contrib/brl/b3p/expatpp )
