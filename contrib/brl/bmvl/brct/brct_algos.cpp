...
vnl_vector_fixed<double, 3> brct_algos::bundle_reconstruct_3d_point(vcl_vector<vnl_vector_fixed<double, 2> > &pts, vcl_vector<vnl_double_3x4>  &Ps)
{
  int nviews = pts.size();
...
brct_algos::add_box_vrml(double xmin, double ymin, double zmin, double xmax, double ymax, double zmax)
{
