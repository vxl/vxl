...
//
//  Input:
//  1) A set of tracked vdgl_digital_curve(s) Currently these
//     curves are read in from a track file, which is generated by
//     a 2-d tracking algorithm. The tracks are stored in tracks_.
//
//  2) A timestamp file that gives the observation time for each frame
//     in milliseconds
//
//  3) The calibration matrix K_ for the camera.  Currently this
//     matrix is hard-coded in ::init_cam_intrinsic()
//
//  4) Initial epipole image location e_, a 2-d point.
//
//  Internals:
