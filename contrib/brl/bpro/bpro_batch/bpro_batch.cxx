...
PyObject * get_bbas_1d_array_int(PyObject * /*self*/, PyObject * args)
{
  ...
  vcl_string relation_name = "bbas_1d_array_int_sptr_data";
  ...
  if( selec->size() != 1 )
    {
    vcl_cout << "in get_bbas_1d_array_int() - no relation with type" << relation_name << " id: " << id << vcl_endl;
  ...
  if( !selec->get_value(vcl_string("value"), brdb_value) )
    {
    vcl_cout << "in get_bbas_1d_array_int() didn't get value\n";
    return array_1d;
    }

  if( !brdb_value )
    {
    vcl_cout << "in get_bbas_1d_array_int() - null value\n";
    return array_1d;
    }

  brdb_value_t<bbas_1d_array_int_sptr>* result_out =
    static_cast<brdb_value_t<bbas_1d_array_int_sptr> *>(brdb_value.ptr() );
  value = result_out->value();
...
PyObject * get_bbas_1d_array_unsigned(PyObject * /*self*/, PyObject * args)
{
  ...
  vcl_string relation_name = "bbas_1d_array_unsigned_sptr_data";
  ...
  if( selec->size() != 1 )
    {
    vcl_cout << "in get_bbas_1d_array_unsigned() - no relation with type" << relation_name << " id: " << id << vcl_endl;
  ...
  if( !selec->get_value(vcl_string("value"), brdb_value) )
    {
    vcl_cout << "in get_bbas_1d_array_unsigned() didn't get value\n";
    return array_1d;
    }

  if( !brdb_value )
    {
    vcl_cout << "in get_bbas_1d_array_unsigned() - null value\n";
    return array_1d;
    }

  brdb_value_t<bbas_1d_array_unsigned_sptr>* result_out =
    static_cast<brdb_value_t<bbas_1d_array_unsigned_sptr> *>(brdb_value.ptr() );
  value = result_out->value();
...
PyObject * get_bbas_1d_array_float(PyObject * /*self*/, PyObject * args)
{
  ...
  brdb_value_t<bbas_1d_array_float_sptr>* result_out =
    static_cast<brdb_value_t<bbas_1d_array_float_sptr> *>(brdb_value.ptr() );
  value = result_out->value();
...
PyObject * get_output_double_array(PyObject * /*self*/, PyObject * args)
{
  ...
  brdb_value_t<bbas_1d_array_double_sptr>* result_out =
    static_cast<brdb_value_t<bbas_1d_array_double_sptr> *>(brdb_value.ptr() );
  value = result_out->value();
...
PyObject * get_bbas_1d_array_string(PyObject * /*self*/, PyObject * args)
{
  ...
  brdb_value_t<bbas_1d_array_string_sptr>* result_out =
    static_cast<brdb_value_t<bbas_1d_array_string_sptr> *>(brdb_value.ptr() );
  value = result_out->value();
