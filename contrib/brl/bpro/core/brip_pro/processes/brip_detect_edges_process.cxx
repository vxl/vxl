...
{
  using namespace brip_detect_edges_process_globals;
...
bool brip_detect_edges_process(bprb_func_process& pro)
{
 using namespace brip_detect_edges_process_globals;
  ...
  vil_image_view<vxl_byte> edge_image = brip_edge::detect_edges(input_image,noise_multiplier,smooth,automatic_threshold,junctionp,aggressive_junction_closure);
