// This is brl/bpro/core/vidl2_pro/processes/vidl2_open_ostream_process.cxx
...
//: Constructor
bool vidl2_open_ostream_process_cons(bprb_func_process& pro)
{
  //input
  bool ok=false;
...
bool vidl2_open_ostream_process(bprb_func_process& pro)
{
  if (pro.n_inputs()< 2) {
  ...
  pro.set_output_val<vidl2_ostream_sptr>(0, vostr);
  return true;
}
