// This is brl/bpro/core/vil_pro/processes/vil_load_image_view_process.cxx
#include <iostream>
#include <string>
...
//: Constructor
bool vil_load_image_view_process_cons(bprb_func_process& pro)
{
  //input
  bool ok=false;
...
//: Execute the process
bool vil_load_image_view_process(bprb_func_process& pro)
{
  // Sanity check
  if (pro.n_inputs()< 1) {
