...
bool vil_shadow_ridge_detection_process(bprb_func_process& pro)
{
  ...
  vil_image_view<unsigned> * shadow_border_conn_region =
    new vil_image_view<unsigned>(out_img->ni(), out_img->nj() );
  vil_image_view<unsigned char> * shadow_border_conn_thresh_region = new vil_image_view<unsigned char>(
      out_img->ni(), out_img->nj() );
  vil_image_view<float> * shadow_border_dist_thresholded = new vil_image_view<float>(out_img->ni(),
                                                                                     out_img->nj() );
