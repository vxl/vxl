...
bool vpgl_perturb_persp_cam_orient_process(bprb_func_process& pro)
{
  ...
  vcl_cout << "sampled theta: " << 180.0 * (ap.theta / vnl_math::pi) << " phi: " << 180.0 * (ap.phi / vnl_math::pi)
           << vcl_endl;
  ...
  vcl_cout << "delta_x with sampled theta: " << ap.theta << " at height: " << h << " is: " << delta_x << " cm."
           << vcl_endl;
#endif
