...
public:
  ...
  bapl_affine2d_est( const vcl_vector<vnl_vector<double> > & from_pts, const vcl_vector<vnl_vector<double> > & to_pts );
...
protected:
  void normalize( const vcl_vector<vnl_vector<double> >& pts, const vcl_vector<double>& wgts,
                  vcl_vector<vnl_vector<double> > & norm_pts, vnl_vector<double> & center,
