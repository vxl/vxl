...
public:
  ...
  bapl_lowe_keypoint();
  // : Constructor
  bapl_lowe_keypoint( bapl_lowe_pyramid_set_sptr pyramid_set, double i, double j, double s = 1, double o = 0 );
  ...
  bapl_lowe_keypoint( bapl_lowe_pyramid_set_sptr pyramid_set, double i, double j, double s, double o,
