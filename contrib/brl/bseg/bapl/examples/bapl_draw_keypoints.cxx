...
int main( int argc, char* argv[] )
{
  ...
  vul_arg<vcl_string> key_path("-keys",
                               "Just display keypoints if keypoint file is available, otherwise will extract keys");
  ...
  grey_image_sptr =
    vil_new_image_resource_of_view( *vil_convert_to_grey_using_rgb_weighting( color_image_sptr->get_view() ) );
