...
bool pair_intersect(bbgm_mask_pair_feature const& mp0, bbgm_mask_pair_feature const& mp1,
...
bbgm_pair_group_feature pair_group_merge(bbgm_pair_group_feature const& pg0, bbgm_pair_group_feature const& pg1,
                                         float p_path = 1.0f);
