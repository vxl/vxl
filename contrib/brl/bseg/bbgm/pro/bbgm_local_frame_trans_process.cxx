// This is brl/bseg/bbgm/pro/bbgm_local_frame_trans_process.cxx
...
//: Constructor
bbgm_local_frame_trans_process::bbgm_local_frame_trans_process()
{
  //input
  input_data_.resize(8,brdb_value_sptr(0));
  input_types_.resize(8);
  input_types_[0]= "bbgm_image_sptr"; //background model
  input_types_[1]= "vil_image_view_base_sptr"; //input frame
  input_types_[2]= "vil_image_view_base_sptr"; //smoothed input frame
  input_types_[3]= "vil_image_view_base_sptr"; //x gradient component
  input_types_[4]= "vil_image_view_base_sptr"; //y gradient component
...
//: Execute the process
bool
bbgm_local_frame_trans_process::execute()
{
  // Sanity check
  ...
  vil_image_view_base_sptr temp = input1->value();
  ...
  brdb_value_t<double>* input5 =
    static_cast<brdb_value_t<double>* >(input_data_[5].ptr());
  double min_eigenvalue =  input5->value();

  brdb_value_t<double>* input6 =
    static_cast<brdb_value_t<double>* >(input_data_[6].ptr());
  double max_condition_number =  input6->value();

  brdb_value_t<double>* input7 =
    static_cast<brdb_value_t<double>* >(input_data_[7].ptr());
  double max_translation =  input7->value();
