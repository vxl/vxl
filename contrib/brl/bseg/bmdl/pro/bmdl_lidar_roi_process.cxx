                                       ...
                                       vpgl_lidar_camera*& camera)
{
  ...
  if (gtif->PCS_WGS84_UTM_zone(utm_zone, h))
  {
    ...
    if (gtif->gtif_trans_matrix(trans_matrix_values)){
      ...
      vpgl_lidar_camera::comp_trans_matrix(sx1, sy1, sz1, tiepoints, trans_matrix);
    } else {
