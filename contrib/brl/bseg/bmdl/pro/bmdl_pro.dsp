# Microsoft Developer Studio Project File - Name="bmdl_pro" - Package Owner=<4>
...
# bmdl_pro  == name of output library
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/contrib/mul" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "bmdl_pro_EXPORTS"
...
!ELSEIF  "$(CFG)" == "bmdl_pro - Win32 Debug"
...
# Name "bmdl_pro - Win32 Release"
# Name "bmdl_pro - Win32 Debug"
