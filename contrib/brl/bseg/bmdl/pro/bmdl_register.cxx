...
void bmdl_register::register_process()
{
  ...
  REG_PROCESS_FUNC_CONS(bprb_func_process, bprb_batch_process_manager, bmdl_trace_boundaries_process,
                        "bmdlTraceBoundariesProcess");
  REG_PROCESS_FUNC_CONS(bprb_func_process, bprb_batch_process_manager, bmdl_generate_mesh_process,
                        "bmdlGenerateMeshProcess");
