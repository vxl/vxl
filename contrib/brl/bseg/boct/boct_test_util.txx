...
void create_random_configuration_tree(boct_tree<T>* tree)
{
    for(unsigned int i=0;i<100;i++)
    {
        ...
        boct_tree_cell<T>* curr_cell=static_cast<boct_tree_cell<T>*>(tree->locate_point(p));
...
#define BOCT_TEST_UTIL_INSTANTIATE(T) \
template void create_random_configuration_tree(boct_tree<vgl_point_3d<double> >*);