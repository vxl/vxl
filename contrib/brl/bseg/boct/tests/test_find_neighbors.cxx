                               ...
                               vcl_vector<boct_tree_cell_sptr> & neighbors)
{
    ...
    for(unsigned i=0;i<leaf_nodes.size();i++)
    {
        ...
        if(!intersectionbox.is_empty())
        {
            ...
            switch(face)
            {
            case boct_tree_cell::NONE:

                break;

            case boct_tree_cell::X_LOW:
                {
