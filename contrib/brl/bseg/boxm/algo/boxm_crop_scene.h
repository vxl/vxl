...
boxm_scene<boct_tree<short, T_data> > *  boxm_crop_scene(boxm_scene<boct_tree<short, T_data> > * scene_in,
                                                         vgl_box_3d<double> bbox)
{
  ...
  boxm_scene<boct_tree<short, T_data> > * scene_out =
    new boxm_scene<boct_tree<short, T_data> >(scene_in->lvcs(), min_point, block_dim,
                                              scene_in->world_dim(), scene_in->save_internal_nodes() );
  ...
  boct_tree<short,
            T_data> * tree_out =
    tree_in->clone_and_intersect(root, tree_in->root_level(), vgl_box_3d<double>(norm_bbox_min, norm_bbox_max) );
