...
public:
  ...
  void split_scene(boxm_scene<sample_tree_type> & scene_in, boxm_scene<apm_tree_type> & apm_scene,
...
// : A function to split an boxm_sample tree, into an appearance and an occupancy tree
template <boxm_apm_type APM_MODEL>
void boxm_split_sample<APM_MODEL>::split_tree(sample_tree_type * tree_in, apm_tree_type * apm_tree,
                                              alpha_tree_type * alpha_tree)
{
