// This is brl/bseg/bvpl/pro/processes/boxm_merge_mixtures_process.cxx
...
bool boxm_merge_mixtures_process(bprb_func_process& pro)
{
  ...
  //check input's validity
  if (!mog_scene) {
    vcl_cout <<  " :-- Grid is not of valid type!\n";
    return false;
  }
  ...
  gauss_scene->set_paths(mog_scene->path(), "bsta_f1");
  gauss_scene->set_appearance_model(BSTA_F1);
