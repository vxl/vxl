...
bool boxm_remove_level0_process(bprb_func_process& pro)
{
  ...
  if( boxm_scene<boct_tree<short,
    ...
    boxm_scene<boct_tree<short, float> > * scene_out = new boxm_scene<boct_tree<short, float> >(
        scene_in->lvcs(), scene_in->origin(), scene_in->block_dim(),
        scene_in->world_dim(),
        scene_in->max_level(),
        scene_in->init_level(),
        scene_in->load_all_blocks(),
        scene_in->save_internal_nodes() );
