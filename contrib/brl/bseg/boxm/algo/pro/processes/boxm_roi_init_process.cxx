...
// functions
bool roi_init(vcl_string img_path, vpgl_camera_double_sptr camera, vgl_box_3d<double> box,
              vil_image_view<unsigned char> & roi_img);

// : projects the box on the image by taking the union of all the projected corners
vgl_box_2d<double> * project_box(vpgl_camera_double_sptr cam, vgl_box_3d<double> box);
