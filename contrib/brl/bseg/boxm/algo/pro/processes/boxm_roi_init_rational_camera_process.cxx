...
// functions
bool roi_init(vcl_string const& image_path, vpgl_rational_camera<double>* camera, vgl_box_3d<double> box,
              vpgl_lvcs lvcs, float uncertainty, vil_image_view<unsigned char>* nitf_image_unsigned_char,
...
vgl_box_2d<double> * project_box(vpgl_rational_camera<double>* cam, vpgl_lvcs lvcs, vgl_box_3d<double> box, float r);
                                                             ...
                                                             vpgl_local_rational_camera<double>& local_camera)
{
  ...
  if( roi->pixel_format() == VIL_PIXEL_FORMAT_UINT_16 )
    ...
    *nitf_image_unsigned_char = vil_image_view<unsigned char>(roi);
    ...
    {
    vcl_cout << "boxm_roi_init_rational_camera_process - Unsupported Pixel Format = " << roi->pixel_format()
             << vcl_endl;
    }
