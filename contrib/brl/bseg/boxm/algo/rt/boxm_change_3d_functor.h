...
public:
  ...
  inline bool step_cell(unsigned int i, unsigned int j, vgl_point_3d<double> s0, vgl_point_3d<double> s1,
                        boxm_sample<APM>& cell_value, boxm_scalar_sample<float>& scalar)
  {
                    ...
                    float prob_ratio)
{
  ...
  boxm_aux_scene<T_loc, T_data,  sample_datatype> aux_scene(&scene, chng_name, boxm_aux_scene<T_loc, T_data,
  ...
  boxm_raytrace_function<change_functor, T_loc, T_data, sample_datatype> raytracer_chng(scene, aux_scene,
                                                                                        cam.ptr(),
                                                                                        change_image.ni(),
                                                                                        change_image.nj() );
