                            ...
                            unsigned ni, unsigned nj)
{
  ...
  boxm_aux_scene<T_loc, T_data, boxm_scalar_sample<sample_datatype> > aux_scene(&scene,
                                                                                boxm_aux_traits<BOXM_AUX_SCALAR_SAMPLE>::storage_subdir(),
                                                                                boxm_aux_scene<T_loc, T_data,
                                                                                               boxm_scalar_sample<sample_datatype> >::CLONE);

  typedef boxm_num_rays_functor<T_data::apm_type, boxm_scalar_sample<sample_datatype> > functor_type;
  boxm_raytrace_function<functor_type, T_loc, T_data, boxm_scalar_sample<sample_datatype> > raytracer(scene, aux_scene,
                                                                                                      cam.ptr(), ni,
                                                                                                      nj);
