...
bool boxm_opt2_optimizer<T_loc, APM, AUX>::update()
{
  ...
  vcl_vector<boxm_opt2_sample<typename boxm_apm_traits<APM>::obs_datatype> > aux_samples;
  ...
  while( !iter.end() )
    ...
    for( unsigned i = 0; i < cells.size(); ++i )
      ...
      vcl_vector<typename boxm_apm_traits<APM>::obs_datatype> obs_vector;
      ...
      boxm_apm_traits<APM>::apm_processor::compute_appearance(obs_vector, pre_vector, vis_vector, data.appearance_,
                                                              min_sigma);
