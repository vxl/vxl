                               ...
                               int bin = -1)             // FIXME - unused
{
  ...
  boxm_aux_scene<T_loc, T_data, boxm_aux_edge_sample<sample_datatype> > aux_scene(&scene,
                                                                                  boxm_aux_traits<BOXM_AUX_NULL>::storage_subdir(),
                                                                                  boxm_aux_scene<T_loc, T_data,
                                                                                                 boxm_aux_edge_sample<sample_datatype> >::LOAD);
  ...
  expfunctor                                        exp_functor(expected, mask, expected.ni(),
                                                                expected.nj(), true, false);
