...
//  float threshold) // degrees of freedom
{
  ...
  boxm_aux_scene<T_loc, T_data, boxm_edge_tangent_sample<sample_datatype> > aux_scene(&scene,
                                                                                      boxm_aux_traits<BOXM_AUX_NULL>::storage_subdir(),
                                                                                      boxm_aux_scene<T_loc, T_data,
                                                                                                     boxm_edge_tangent_sample<sample_datatype> >::LOAD);
  ...
  expfunctor                                        exp_functor(expected, cam,
                                                                /*threshold,*/ expected.ni(), expected.nj(), true,
                                                                false);
