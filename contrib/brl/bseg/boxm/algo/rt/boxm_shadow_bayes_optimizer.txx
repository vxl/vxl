...
boxm_shadow_bayes_optimizer<T_loc,APM,AUX>::boxm_shadow_bayes_optimizer(
  ...
  : image_ids_(image_ids), scene_(scene), min_app_sigma_(min_app_sigma), shadow_prior_(shadow_prior),
    shadow_mean_(shadow_mean), shadow_sigma_(shadow_sigma),verbose_(verbose),
    debug_pt_(debug_pt), max_cell_P_(0.995f), min_cell_P_(0.0001f)
{}
