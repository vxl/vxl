                       ...
                       vcl_string sun_occ_name)
{
  ...
  boxm_aux_scene<T_loc, T_data,  sample_datatype> aux_scene(&scene, sun_occ_name, boxm_aux_scene<T_loc, T_data,
  ...
  boxm_raytrace_function<sun_vis, T_loc, T_data, sample_datatype> raytracer_vis(scene, aux_scene,
                                                                                cam.ptr(), sun_ni, sun_nj);
