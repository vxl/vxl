                                          ...
                                          bool use_black_background = false)
{
  ...
  if( vpgl_rational_camera<double> * rcam = dynamic_cast<vpgl_rational_camera<double> *>(cam.ptr() ) )
    ...
    projection_plane = boxm_rational_camera_utils::boxm_find_parallel_image_plane(rcam, top, bottom,
        ...
        for( ; cell_it != vis_cells.end(); cell_it++ )
          ...
          // if (sample.alpha>0.001)
            ...
            if( dynamic_cast<vpgl_perspective_camera<double> *>(cam.ptr() ) )
              ...
              {
              boxm_rational_camera_utils::project_corners_rational_camera(corners, rcam, projection_plane, xverts,
                                                                          yverts, vertdists);
              }
            ...
            typename T_data::obs_datatype cell_expected  =
              T_data::apm_processor::expected_color(sample.appearance(bin) );
            // get  alpha
  ...
  vil_transform2<float, typename T_data::obs_datatype, normalize_expected_functor_splatting<T_data> >(vis, expected,
                                                                                                      norm_fn);
