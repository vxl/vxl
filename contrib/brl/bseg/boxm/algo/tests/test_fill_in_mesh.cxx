...
static void test_fill_in_mesh()
{
  ...
  while( !iter.end() )
    ...
    boct_tree<short,
              boxm_sample<BOXM_APM_MOG_GREY> > * tree = new boct_tree<short, boxm_sample<BOXM_APM_MOG_GREY> >(7, 6);
  ...
  boct_tree_cell<short, boxm_sample<BOXM_APM_MOG_GREY> >* cell0 = tree->locate_point_global(vgl_point_3d<double>(3, 3,
                                                                                                                 6) );
