...
boxm_cell_vis_graph_iterator<T_loc, T_data>::boxm_cell_vis_graph_iterator(vpgl_camera_double_sptr cam,
                                                                          ...
                                                                          unsigned img_ni,
                                                                          unsigned img_nj) : camera_(cam), img_ni_(
    img_ni), img_nj_(img_nj)
{
  if( !tree )
    {
...
template <class T_loc, class T_data>
void boxm_cell_vis_graph_iterator<T_loc, T_data>::form_graph_per_cell(boct_tree_cell<T_loc, T_data>* cell,
                                                                      boct_face_idx face_idx, boct_tree<T_loc,
                                                                                                        T_data>* tree)
{
