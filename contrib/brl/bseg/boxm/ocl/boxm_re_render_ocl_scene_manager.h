#ifndef boxm_re_render_ocl_scene_manager_h_
#define boxm_re_render_ocl_scene_manager_h_
//:
// \file
...
class boxm_re_render_ocl_scene_manager : public bocl_manager<boxm_re_render_ocl_scene_manager>
{
 ...
 public:
  ...
  boxm_re_render_ocl_scene_manager() :
    program_(0),
    block_ptrs_(0),
    mem_ptrs_(0),
    cells_(0),
  ...
  bool init_re_render(boxm_ocl_scene *scene,
...
#endif // boxm_re_render_ocl_scene_manager_h_
