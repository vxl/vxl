#ifndef boxm_render_image_manager_h_
#define boxm_render_image_manager_h_
//:
// \file
...
class boxm_render_image_manager : public bocl_manager<boxm_render_image_manager<T_data> >
{
 public:
  ...
  bool init_ray_trace(boxm_scene<tree_type> *scene,
 ...
 protected:
  ...
  vil_image_view<obs_type>  output_img_;
