#ifndef boxm_render_single_block_manager_h_
#define boxm_render_single_block_manager_h_
//:
// \file
...
bool save_output_image(vcl_string filename);
...
#endif // boxm_render_single_block_manager_h_
