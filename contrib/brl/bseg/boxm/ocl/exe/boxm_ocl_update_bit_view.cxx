...
int main(int argc, char ** argv)
{
  ...
  // handle argument
  vcl_cout<<"BIT SCENE UPDATE"<<vcl_endl;
  ...
  vul_arg<unsigned> ei("-ei", "Width of Expected Image", 1280);
  vul_arg<unsigned> ej("-ej", "Height of Expected Image", 720);
  ...
  boxm_update_bit_tableau_new update_tableau;
