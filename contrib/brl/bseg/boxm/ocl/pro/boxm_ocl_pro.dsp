# Microsoft Developer Studio Project File - Name="boxm_ocl_pro" - Package Owner=<4>
...
# boxm_ocl_pro  == name of output library
...
!IF  "$(CFG)" == "boxm_ocl_pro - Win32 Release"
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/contrib/brl/bseg" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "boxm_ocl_pro_EXPORTS"
...
!ELSEIF  "$(CFG)" == "boxm_ocl_pro - Win32 Debug"
...
# Name "boxm_ocl_pro - Win32 Release"
# Name "boxm_ocl_pro - Win32 Debug"
...
# Begin Source File
SOURCE=.\boxm_ocl_register.h
# End Source File
# Begin Source File
SOURCE=.\boxm_ocl_processes.h
# End Source File
# End Group
# End Target
# End Project
