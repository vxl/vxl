// This is brl/bseg/boxm/ocl/view/boxm_ocl_render_bit_tableau.h
#ifndef boxm_ocl_render_bit_tableau_h
#define boxm_ocl_render_bit_tableau_h
//:
// \file
...
class boxm_ocl_render_bit_tableau : public boxm_cam_tableau
{
 public:
  ...
  virtual ~boxm_ocl_render_bit_tableau() {}
...
//: Create a smart-pointer to a boxm_ocl_render_bit_tableau tableau.
struct boxm_ocl_render_bit_tableau_new : public boxm_ocl_render_bit_tableau_sptr
{
  //: Constructor - create an empty vgui_easy3D_tableau.
  typedef boxm_ocl_render_bit_tableau_sptr base;
  boxm_ocl_render_bit_tableau_new() : base( new boxm_ocl_render_bit_tableau ) { }
};

#endif // boxm_ocl_render_bit_tableau_h
