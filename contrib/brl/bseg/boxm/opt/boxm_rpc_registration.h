...
//              boxm_line_samples<float> line_samples=expected_edge_image(m-u,n-v);
//              if(line_samples.smallest_index_>-1)
//              {      
//                  float min_dist=1e5;
//                  for(unsigned p=0;p<1;p++)
//                  {
//                        //vcl_cout<<".";
//                      if(line_samples.num_obs_[p]>0)
//                      {
//                        float dx=line_samples.x_[p]+u-edge_image(m,n,0);
//                        float dy=line_samples.y_[p]+v-edge_image(m,n,1);
//
//                        float sintheta1=vcl_sin(edge_image(m,n,2));
//                        float costheta1=vcl_cos(edge_image(m,n,2));
//
//                        float sintheta2=vcl_sin(line_samples.theta_[p]);
//                        float costheta2=vcl_cos(line_samples.theta_[p]);
//
//                        //float dist=vcl_sqrt(dx*dx+dy*dy);
//                        //if(dist<min_dist)
//                        //    min_dist=dist;
//
//                        float dist=10*(1-vcl_fabs(sintheta1*sintheta2+costheta2*costheta1))+vcl_sqrt(dx*dx+dy*dy);
//                        if(dist<min_dist)
//                            min_dist=dist;
//
...
//  //      for (int n=offset_search_size; n<nj-offset_search_size; n++) {
//  //        if (edge_image(m,n,0)!=-1 || edge_image(m,n,1)!=-1 || edge_image(m,n,2)!=-1) {
//  //            boxm_line_samples<float> line_samples=expected_edge_image(m-best_offset_u,n-best_offset_v);
//  //            if(line_samples.smallest_index_>-1)
//  //            {      
//  //                float min_dist=1e5;
//  //                for(unsigned p=0;p<5;p++)
//  //                {
//  //                  if(line_samples.num_obs_[p]>3)
//  //                  {
//  //                      float dx=line_samples.x_[p]+u-edge_image(m,n,0);
//  //                      float dy=line_samples.y_[p]+v-edge_image(m,n,1);
//
