...
static void test_ray_trace(octree_test_driver& driver)
{
  ...
  if(results){
   int test[] = {0,0,3,0, 250,250,250,250,
              ...
              3,3,3,0, 434,434,434,434,
              2,3,3,0, 1,1,1,1,
              2,2,2,0, 434,434,434,434,
              1,1,1,0, 434,434,434,434,
              0,1,1,0, 1,1,1,1,
              0,0,0,0, 434,434,434,434,
              0,3,3,0, 434,434,434,434,
              0,2,3,0, 1,1,1,1,
              1,2,2,0, 434,434,434,434,
              2,1,1,0, 434,434,434,434,
              2,0,1,0, 1,1,1,1,
              3,0,0,0, 434,434,434,434,
              3,0,3,0, 434,434,434,434,
              2,0,3,0, 1,1,1,1,
              2,1,2,0, 434,434,434,434,
              1,2,1,0, 434,434,434,434,
              0,2,1,0, 1,1,1,1,
              0,3,0,0, 434,434,434,434};
    bool good = true;
    for(size_t i= 0; i<size; i++)
      good = good && results[i]==test[i];
