...
static void test_boxm_plane_propagation_process()
{
  ...
  REG_PROCESS_FUNC_CONS(bprb_func_process, bprb_batch_process_manager, boxm_plane_propagate_process, "boxmPlanePropagationProcess");
...
TESTMAIN(test_boxm_plane_propagation_process);
