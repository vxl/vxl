...
void boxm_mog_grey_processor::update_appearance(vcl_vector<boxm_apm_traits<BOXM_APM_MOG_GREY>::obs_datatype> const& obs,
...
void boxm_mog_grey_processor::compute_appearance(
  vcl_vector<boxm_apm_traits<BOXM_APM_MOG_GREY>::obs_datatype> const& obs, vcl_vector<float> const& obs_weights,
  boxm_apm_traits<BOXM_APM_MOG_GREY>::apm_datatype & model, float min_sigma)
{
  vcl_vector<float> pre(obs.size(), 0.0f);
  compute_appearance(obs, pre, obs_weights, model, min_sigma);
  return;
...
void boxm_mog_grey_processor::finalize_appearance(
  vcl_vector<boxm_apm_traits<BOXM_APM_MOG_GREY>::obs_datatype> const& obs,
...
void boxm_mog_grey_processor::compute_appearance(
  vcl_vector<boxm_apm_traits<BOXM_APM_MOG_GREY>::obs_datatype> const& obs, vcl_vector<float> const& pre,
  vcl_vector<float> const& vis, boxm_apm_traits<BOXM_APM_MOG_GREY>::apm_datatype & model, float min_sigma)
{
