...
{
  double normal = (xverts[id2] - xverts[id1]) * (yverts[id3] - yverts[id2]) - (yverts[id2] - yverts[id1])
    * (xverts[id3] - xverts[id2]);
                                   ...
                                   vpgl_camera_double_sptr cam)
{
  ...
  for( ; face_it != faces.end(); ++face_it )
    ...
    double xs[] =
     {face_projected[0].x(), face_projected[1].x(), face_projected[2].x(), face_projected[3].x()};
    double ys[] =
     {face_projected[0].y(), face_projected[1].y(), face_projected[2].y(), face_projected[3].y()};
