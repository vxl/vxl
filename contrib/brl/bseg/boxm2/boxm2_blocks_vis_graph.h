...
public:
  ...
  boxm2_block_vis_graph(vcl_map<boxm2_block_id, boxm2_block_metadata> & blkmetadata,
                        vpgl_generic_camera<double> const& cam );
  vcl_list<boxm2_block_vis_graph_node_sptr>::iterator find(const boxm2_block_id & id,
                                                           vcl_list<boxm2_block_vis_graph_node_sptr> & list_nodes );
