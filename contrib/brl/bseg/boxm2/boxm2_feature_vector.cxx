...
float prob_correspondence(boxm2_feature_vector& f1, float surface_prob1, boxm2_feature_vector& f2, float surface_prob2,
                          double feature_sim_variance)
{
  float d_square = 0.0;
  ...
  float dif_prob =
    (float)(vnl_math::one_over_sqrt2pi / vcl_sqrt(feature_sim_variance)
            * vcl_exp(-0.5 * d_square / feature_sim_variance) );
