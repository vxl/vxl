...
boxm2_block_metadata boxm2_scene::get_block_metadata_const(boxm2_block_id const& id) const
{
  vcl_map<boxm2_block_id, boxm2_block_metadata>::const_iterator iter;
  for( iter = blocks_.begin(); iter != blocks_.end(); ++iter )
    {
...
vcl_vector<boxm2_block_id> boxm2_scene::get_vis_blocks_opt(vpgl_perspective_camera<double>* cam,  unsigned int ni,
                                                           unsigned int nj)
{
  vcl_vector<boxm2_block_id> vis_order;
  if( !cam )
...
vcl_vector<boxm2_block_id>
boxm2_scene::get_vis_order_from_ray(vgl_point_3d<double> const& origin, vgl_vector_3d<double> const& dir,
                                    double distance)
{
  // Map of distance, id
  vcl_vector<boxm2_block_id>     vis_order;
...
bool boxm2_scene::is_block_visible(boxm2_block_metadata & data, vpgl_camera<double> const& cam, unsigned int ni,
                                   unsigned int nj )
{
