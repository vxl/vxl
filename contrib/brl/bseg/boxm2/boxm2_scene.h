...
public:
  ...
  vcl_vector<boxm2_block_id> get_vis_order_from_ray(vgl_point_3d<double> const& origin,
                                                    vgl_vector_3d<double> const& dir, double distance);
  ...
  void min_block_index(vgl_point_3d<int> & idx, vgl_point_3d<double> & local_origin) const;

  // : gets max block index in all dims
  void max_block_index(vgl_point_3d<int> & idx, vgl_point_3d<double> & local_origin) const;
  ...
  bool contains(vgl_point_3d<double> const& p, boxm2_block_id& bid, vgl_point_3d<double>& local_coords) const;
