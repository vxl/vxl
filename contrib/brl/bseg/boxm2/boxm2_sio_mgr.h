...
class boxm2_sio_mgr
{
  public:
    ...
    //: saves data to disk
    template <boxm2_data_type data_type> 
    static void save_block_data(vcl_string dir, boxm2_block_id block_id, boxm2_data_base* block_data );

    //TODO create data load and save functions

};
template <boxm2_data_type data_type> 
boxm2_data_base *  load_block_data(vcl_string dir, boxm2_block_id block_id)
{
    ...
    return new boxm2_data<data_type>(bytes,buflength,block_id); 
}
