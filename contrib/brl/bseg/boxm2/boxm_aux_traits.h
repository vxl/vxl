#ifndef boxm2_aux_traits_h_
#define boxm2_aux_traits_h_
//:
// \file

#include <vcl_string.h>
#include <boxm2/sample/boxm_vis_implicit_sample.h>
#include <boxm2/sample/boxm_update_sample.h>
