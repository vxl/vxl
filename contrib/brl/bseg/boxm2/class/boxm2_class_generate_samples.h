...
{
public:
  boxm2_class_generate_samples(vcl_string xml_label, vcl_string eoPath, vcl_string irPath, vcl_size_t K = 1000);
...
vcl_string pixel_class(int i, int j, vcl_vector<vgl_polygon<double> >& polygons, vcl_vector<vcl_string>& classes);
