...
public:
                 ...
                 vil_image_view<float> * vis_img, boxm2_block_id spt_bid, int spt_data_index)
  {
    alpha_data_ = new boxm2_data<BOXM2_ALPHA>(alpha_data->data_buffer(),
                                              alpha_data->buffer_length(), alpha_data->block_id() );
    pts_data_ = new boxm2_data<BOXM2_POINT>(pts_data->data_buffer(), pts_data->buffer_length(), pts_data->block_id() );
    sums_data_ = new boxm2_data<BOXM2_FLOAT16>(sums_data->data_buffer(),
                                               sums_data->buffer_length(), sums_data->block_id() );
...
public:
  ...
  {
    covs_data_ = new boxm2_data<BOXM2_COVARIANCE>(covs_data->data_buffer(),
                                                  covs_data->buffer_length(), covs_data->block_id() );
    sums_data_ = new boxm2_data<BOXM2_FLOAT16>(sums_data->data_buffer(),
                                               sums_data->buffer_length(), sums_data->block_id() );
    cov_C_ = cov_C;
    cov_v_ = cov_v;
