...
public:
  ...
  bool init_data(vcl_vector<boxm2_data_base *> & datas, vil_image_view<float> * input_img)
  {
    ...
    aux2_data_ = new boxm2_data<BOXM2_NUM_OBS_SINGLE>(datas[2]->data_buffer(),
...
public:
  ...
  bool init_data(vcl_vector<boxm2_data_base *> & datas, vil_image_view<float>* pre_img, vil_image_view<float>* vis_img)
  {
    ...
    aux1_data_ = new boxm2_data<BOXM2_AUX1>(datas[1]->data_buffer(), datas[1]->buffer_length(), datas[1]->block_id() );
    alpha_data_ =
      new boxm2_data<BOXM2_ALPHA>(datas[2]->data_buffer(), datas[2]->buffer_length(), datas[2]->block_id() );
...
public:
  ...
  bool init_data(vcl_vector<boxm2_data_base *> & datas, vil_image_view<float> * pre_img,
...
public:
  ...
  bool init_data(boxm2_data_base * alph, boxm2_data_base * mog, boxm2_stream_cache_sptr str_cache,
