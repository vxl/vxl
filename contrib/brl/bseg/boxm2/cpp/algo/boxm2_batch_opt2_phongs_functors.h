...
public:
  ...
  bool init_data(vcl_vector<boxm2_data_base *> & datas,
                 ...
                 float sun_azim)
  {
    aux0_data_       = new boxm2_data<BOXM2_AUX0>(datas[0]->data_buffer(),
                                                  datas[0]->buffer_length(), datas[0]->block_id() );
    aux1_data_       = new boxm2_data<BOXM2_AUX1>(datas[1]->data_buffer(),
                                                  datas[1]->buffer_length(), datas[1]->block_id() );
    aux0_view_data_  = new boxm2_data<BOXM2_AUX0>(datas[2]->data_buffer(),
                                                  datas[2]->buffer_length(), datas[2]->block_id() );
    aux1_view_data_  = new boxm2_data<BOXM2_AUX1>(datas[3]->data_buffer(),
                                                  datas[3]->buffer_length(), datas[3]->block_id() );
    aux2_view_data_  = new boxm2_data<BOXM2_AUX2>(datas[4]->data_buffer(),
                                                  datas[4]->buffer_length(), datas[4]->block_id() );
    aux3_view_data_  = new boxm2_data<BOXM2_AUX3>(datas[5]->data_buffer(),
                                                  datas[5]->buffer_length(), datas[5]->block_id() );
    alpha_data_      = new boxm2_data<BOXM2_ALPHA>(datas[6]->data_buffer(),
                                                   datas[6]->buffer_length(), datas[6]->block_id() );
    phongs_data_     = new boxm2_data<BOXM2_FLOAT8>(datas[7]->data_buffer(),
                                                    datas[7]->buffer_length(), datas[7]->block_id() );
...
public:
                 ...
                 vil_image_view<float> * beta_denom)
  {
    ...
    phongs_data_     = new boxm2_data<BOXM2_FLOAT8>(datas[7]->data_buffer(),
                                                    datas[7]->buffer_length(), datas[7]->block_id() );
    aux_data_        = new boxm2_data<BOXM2_AUX>(datas[8]->data_buffer(), datas[8]->buffer_length(),
                                                 datas[8]->block_id() );
...
public:
                 ...
                 boxm2_data_base * uncertain)
  {
    ...
    uncertain_data_ = new boxm2_data<BOXM2_AUX1>(uncertain->data_buffer(),
                                                 uncertain->buffer_length(), uncertain->block_id() );
    id_ = alph->block_id();
    return true;
  }
