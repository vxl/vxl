...
private:
  ...
  vcl_vector<vcl_pair<vgl_point_3d<int>, vgl_point_3d<double> > >  neighbor_points(
  ...
  vcl_vector<vcl_pair<vgl_point_3d<int>, float> > eval_neighbors(boxm2_block_metadata data,
                                                                 const boct_bit_tree& bit_tree,
                                                                 const vcl_vector<vcl_pair<vgl_point_3d<int>,
                                                                                           vgl_point_3d<double> > >& neighbors, const boxm2_array_3d<uchar16>& trees, const boxm2_data_traits<BOXM2_ALPHA>::datatype* alpha_data,
                                                                 int curr_depth);
  ...
  float apply_filter(vcl_vector<vcl_pair<vgl_point_3d<int>, float> > neighbors, vcl_vector<vcl_pair<vgl_point_3d<int>,
                                                                                                    float> > filter);
