                                                    ...
                                                    boxm2_data_base * normal_albedo_model)
{
  ...
  for( unsigned int m = 0; m < num_images_; ++m )
    ...
    for( unsigned n = 0; n < num_normals_; ++n )
      ...
      double var_offset = brad_radiance_variance_chavez(0.0, normals_[n], metadata_[m], atm_params_[m], reflectance_var,
                                                        optical_depth_var, skylight_var, airlight_var);
      radiance_var_offsets_[m][n] = var_offset;
      // compute scale
      double var = brad_radiance_variance_chavez(1.0, normals_[n], metadata_[m], atm_params_[m], reflectance_var,
                                                 optical_depth_var, skylight_var, airlight_var);
