...
public:
                 ...
                 vil_image_view<float> * input_img)
  {
    ...
    alpha_data_ =
      new boxm2_data<BOXM2_GAMMA>(datas[1]->data_buffer(), datas[1]->buffer_length(), datas[1]->block_id() );
    mog3_data_ = new boxm2_data<BOXM2_MOG3_GREY>(datas[2]->data_buffer(), datas[2]->buffer_length(),
                                                 datas[2]->block_id() );
    pre_img_ = pre_img;
    vis_img_ = vis_img;
    PI_cum = 0.0;
  ...
  inline bool step_cell(float ray_vol, int index, unsigned i, unsigned j)
  {
    ...
    float PI =
      boxm2_processor_type<BOXM2_MOG3_GREY>::type::prob_density(mog3_data_->data()[index], (*input_img_)(i, j) );
...
public:
  ...
  inline bool process_cell(int index)
  {
    ...
    if( aux[0] > 1e-10f )
      ...
      boxm2_processor_type<BOXM2_MOG3_GREY>::type::update_gauss_mixture_3(mog3, nobs_float, mean_obs, vis, 0.09f,
                                                                          0.03f);
