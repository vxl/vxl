...
class boxm2_export_oriented_point_cloud_function
{
 public:
  ...
  static void exportPointCloudPLY(const boxm2_scene_sptr& scene, boxm2_block_metadata data, boxm2_block* blk,
                                  boxm2_data_base* alpha, boxm2_data_base* mog, boxm2_data_base* vis, boxm2_data_base* exp, boxm2_data_base* nobs,
                                  boxm2_data_base* points, boxm2_data_base* normals, vcl_vector<boxm2_data_base*> taylor_coeff,
                                  boxm2_data_base* ray_dir_sum, boxm2_data_base* ray_dir_weighted_sum, vcl_ofstream& file,
                                  bool output_aux, float vis_t, float nmag_t, float prob_t, float exp_t, vgl_box_3d<double> bb, unsigned& num_vertices);
