...
public:
  ...
  static void  update_app_model(vnl_vector_fixed<unsigned char, 2> & apm, vnl_vector_fixed<float, 4> & nobs, float x,
                                float w, float init_sigma, float min_sigma);

  static void compute_app_model(vnl_vector_fixed<unsigned char, 2> & apm, vcl_vector<float> const& obs,
