...
{
 public:
  typedef boxm2_data_traits<BOXM2_ALPHA>::datatype datatype;
  ...
  {
    alpha_data_=new boxm2_data<BOXM2_ALPHA>(output_alph->data_buffer(),output_alph->buffer_length(),output_alph->block_id());
    str_cache_ = str_cache;
    data_type_ = boxm2_data_traits<BOXM2_ALPHA>::prefix();
  ...
  inline bool process_cell(int index)
  {
    ...
    vcl_vector<datatype> out = str_cache_->get_next<BOXM2_ALPHA,datatype>(id_, index);
