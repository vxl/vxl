...
public:
  ...
  int move_data( boct_bit_tree& unrefined_tree, boct_bit_tree& merged_tree, float*   alpha, uchar8*  mog,
                 ushort4* num_obs, float*   alpha_cpy, uchar8*  mog_cpy, ushort4* num_obs_cpy);
...
////////////////////////////////////////////////////////////////////////////////
void boxm2_merge_block( boxm2_scene_sptr scene, boxm2_block* blk, vcl_vector<boxm2_data_base *> & datas,
