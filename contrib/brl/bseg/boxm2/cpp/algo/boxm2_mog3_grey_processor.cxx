                                            ...
                                            vnl_vector_fixed<float, 3> & new_component)
{
  ...
  // variance
  new_component[1] = w1 * var1 / denominator + w2 * var2 / denominator + (mu1 - mu2) * (mu1 - mu2)
    * (w1 * w2 / denominator / denominator);
  // weight
                                                ...
                                                vnl_vector_fixed<unsigned char, 8> & mog3_3)
{
  ...
  for( unsigned i = 0; i < 3; i++ )
    ...
    for( unsigned j = 0; j < 3; j++ )
      ...
      if( merge_gauss(mog3_float_1[i * 3 + 0], mog3_float_1[i * 3 + 1], w1c, mog3_float_2[j * 3 + 0],
                      mog3_float_2[j * 3 + 1], w2c, new_component) )
        {
                                                  ...
                                                  float min_sigma)
{
  ...
  mog3[1] = (unsigned char)vcl_floor(boxm2_mog3_grey_processor::clamp(vcl_sqrt(model.distribution(
                                                                                 0).var() ), 0, 1) * 255.0f);
  ...
  mog3[4] = (unsigned char)vcl_floor(boxm2_mog3_grey_processor::clamp(vcl_sqrt(model.distribution(
                                                                                 1).var() ), 0, 1) * 255.0f);
  ...
  mog3[7] = (unsigned char)vcl_floor(boxm2_mog3_grey_processor::clamp(vcl_sqrt(model.distribution(
                                                                                 2).var() ), 0, 1) * 255.0f);
