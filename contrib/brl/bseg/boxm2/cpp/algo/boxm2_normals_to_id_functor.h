...
public:
  ...
  bool init_data(vcl_vector<boxm2_data_base *> & datas, float nmag_t, float vis_t)
  {
    ...
    point_data_ =
      new boxm2_data<BOXM2_POINT>(datas[1]->data_buffer(), datas[1]->buffer_length(), datas[1]->block_id() );
    normal_data_ =
      new boxm2_data<BOXM2_NORMAL>(datas[2]->data_buffer(), datas[2]->buffer_length(), datas[2]->block_id() );
    vis_score_data_ = new boxm2_data<BOXM2_VIS_SCORE>(datas[3]->data_buffer(),
                                                      datas[3]->buffer_length(), datas[3]->block_id() );
    label_short_data_ = new boxm2_data<BOXM2_LABEL_SHORT>(datas[4]->data_buffer(),
