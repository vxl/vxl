...
void boxm2_points_to_volume::fillBlockByTri(boxm2_block_metadata& data, boxm2_block* blk,
                                            vcl_vector<vcl_vector<float> >& alphas)
{
  ...
  vcl_cout << "  num block/tri intersections: " << numInts << vcl_endl;
