...
public:
  ...
  bool init_data(vcl_vector<boxm2_data_base *> & datas,
                 ...
                 int & nelems)
  {
    alpha_data_        = new boxm2_data<BOXM2_ALPHA>(datas[0]->data_buffer(),
                                                     datas[0]->buffer_length(), datas[0]->block_id() );
    data_ptr           = datas[1];
    seg_len_           = &seg_len;
    alpha_             = &alpha;
  ...
  inline bool step_cell(float seg_len, int index, unsigned i, unsigned j, float abs_depth)
  {
    ...
    switch( boxm2_data_info::data_type(prefix_) )
      ...
      case BOXM2_MOG3_GREY:
        {
        boxm2_data<BOXM2_MOG3_GREY>* mog3_grey_app_data_ = new boxm2_data<BOXM2_MOG3_GREY>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
      ...
      case BOXM2_FLOAT8:
        {
        boxm2_data<BOXM2_FLOAT8>* mog3_grey_app_data_ = new boxm2_data<BOXM2_FLOAT8>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
      ...
      case BOXM2_FLOAT:
        {
        boxm2_data<BOXM2_FLOAT>* app_data = new boxm2_data<BOXM2_FLOAT>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
      ...
      case BOXM2_AUX0:
        {
        boxm2_data<BOXM2_AUX0>* app_data  = new boxm2_data<BOXM2_AUX0>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
      ...
      case BOXM2_AUX1:
        {
        boxm2_data<BOXM2_AUX1>* app_data  = new boxm2_data<BOXM2_AUX1>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
      ...
      case BOXM2_AUX2:
        {
        boxm2_data<BOXM2_AUX2>* app_data  = new boxm2_data<BOXM2_AUX2>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
      ...
      case BOXM2_AUX3:
        {
        boxm2_data<BOXM2_AUX3>* app_data  = new boxm2_data<BOXM2_AUX3>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
      ...
      case BOXM2_EXPECTATION:
        {
        boxm2_data<BOXM2_EXPECTATION>* app_data  = new boxm2_data<BOXM2_EXPECTATION>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
      ...
      case BOXM2_NUM_OBS:
        {
        boxm2_data<BOXM2_NUM_OBS>* num_obs_data  = new boxm2_data<BOXM2_NUM_OBS>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
      ...
      case BOXM2_POINT:
        {
        boxm2_data<BOXM2_POINT>* point_data  = new boxm2_data<BOXM2_POINT>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
      ...
      case BOXM2_NORMAL:
        {
        boxm2_data<BOXM2_NORMAL>* point_data  = new boxm2_data<BOXM2_NORMAL>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
      ...
      case BOXM2_VIS_SCORE:
        {
        boxm2_data<BOXM2_VIS_SCORE>* point_data  = new boxm2_data<BOXM2_VIS_SCORE>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
      ...
      case BOXM2_COVARIANCE:
        {
        boxm2_data<BOXM2_COVARIANCE>* point_data  = new boxm2_data<BOXM2_COVARIANCE>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
      ...
      case BOXM2_LABEL_SHORT:
        {
        boxm2_data<BOXM2_LABEL_SHORT>* point_data  = new boxm2_data<BOXM2_LABEL_SHORT>(
            data_ptr->data_buffer(), data_ptr->buffer_length(), data_ptr->block_id() );
...
public:
                 ...
                 float intensity)
  {
    ...
    mog3_data_ = new boxm2_data<BOXM2_MOG3_GREY>(datas[0]->data_buffer(), datas[0]->buffer_length(),
                                                 datas[0]->block_id() );
  ...
  {
    app_density_->push_back(boxm2_processor_type<BOXM2_MOG3_GREY>::type::prob_density(mog3_data_->data()[index],
                                                                                      intensity_) );
    return true;
  }
