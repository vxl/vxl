...
public:
  ...
  bool init_data(boxm2_block* blk, vcl_vector<boxm2_data_base *> & datas, float prob_thresh, vcl_string app_type,
                 vcl_string flow_prefix = "resultant");
  ...
  int move_data(boct_bit_tree& unrefined_tree, boct_bit_tree& refined_tree, float*  alpha_cpy, float* alpha_sav_cpy,
                T* mog_cpy, T* mog_sav_cpy, float4*   flow_cpy, float4*   flow_res_cpy);
...
////////////////////////////////////////////////////////////////////////////////
void boxm2_refine_block_with_labels( boxm2_block* blk, vcl_vector<boxm2_data_base *> & datas, float prob_thresh,
                                     bool is_random = true);
