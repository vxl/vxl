...
bool boxm2_refine_block_multi_data::init_data(boxm2_scene_sptr scene, boxm2_block_sptr blk,
...
bool boxm2_refine_block_multi_data::match_refine(vcl_vector<vcl_string> const& prefixes,
                                                 vbl_array_3d<int> const& depths_to_match)
{
  ...
  int nx = static_cast<int>(trees.get_row1_count() ), ny = static_cast<int>(trees.get_row2_count() ),
    nz = static_cast<int>(trees.get_row3_count() );
