...
public:
  ...
  bool init_data(boxm2_scene_sptr scene, boxm2_block_sptr blk, vcl_vector<vcl_string> const& prefixes,
                 float prob_thresh);
  ...
  // : refine bit tree
  boct_bit_tree refine_bit_tree(boct_bit_tree& curr_tree, int buff_offset);

  // : move data into new location
  int move_data(boct_bit_tree& unrefined_tree, boct_bit_tree& refined_tree, vcl_vector<vcl_size_t> const& type_sizes,
...
// REFINE FUNCTION BASED ON ALPHA
////////////////////////////////////////////////////////////////////////////////
void boxm2_refine_block_multi_data_function( boxm2_scene_sptr scene, boxm2_block_sptr blk,
                                             vcl_vector<vcl_string> const& prefixes, float prob_thresh);
