#ifndef boxm2_cpp_change_detection_process_h
#define boxm2_cpp_change_detection_process_h
//:
// \file
#include "boxm2_cpp_process_base.h"
#include <vil/vil_image_view.h>

class boxm2_cpp_change_detection_process : public boxm2_cpp_process_base
{
  public:
    boxm2_cpp_change_detection_process() : image_(0), vis_img_(0) {}
