// This is brl/bseg/boxm2/cpp/pro/processes/boxm2_cpp_cone_update_image_process.cxx
...
bool boxm2_cpp_cone_update_image_process_cons(bprb_func_process& pro)
{
...
bool boxm2_cpp_cone_update_image_process(bprb_func_process& pro)
{
  ...
  if( vil_image_view<float> * input_image = dynamic_cast<vil_image_view<float> *>(float_image.ptr() ) )
    ...
    if( !foundDataType )
      {
      vcl_cout
      << "BOXM2_OCL_CONE_UPDATE_IMAGE_PROCESS ERROR: scene doesn't have BOXM2_MOG3_GREY or BOXM2_MOG3_GREY_16 data type"
      << vcl_endl;
      return false;
      }
    ...
    return boxm2_update_cone_image(scene, data_type, num_obs_type, cam, input_image,
                                   input_image->ni(), input_image->nj() );
    }
