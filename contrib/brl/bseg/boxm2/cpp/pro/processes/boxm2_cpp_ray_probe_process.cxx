...
bool boxm2_cpp_ray_probe_process(bprb_func_process& pro)
{
  ...
  vsph_camera_bounds::pixel_solid_angle(*(vpgl_perspective_camera<double> *)(
                                          cam.ptr() ), pi, pj, ray_ij, cone_half_angle, solid_angle);
  ...
  for( id = vis_order.begin(); id != vis_order.end(); ++id )
    ...
    cast_ray_per_block<boxm2_ray_probe_functor>(ray_probe_functor, scene_info_wrapper->info, blk, cam, pi + 1, pj + 1,
                                                pi, pj);
    }
