...
public:
  ...
  virtual boxm2_data_base * get_data_base(boxm2_scene_sptr & scene, boxm2_block_id id, vcl_string type,
                                          vcl_size_t num_bytes = 0, bool read_only = true) = 0;
  ...
  virtual boxm2_data_base * get_data_base_new(boxm2_scene_sptr & scene, boxm2_block_id id, vcl_string type = 0,
                                              vcl_size_t num_bytes = 0, bool read_only = true) = 0;
  ...
  virtual void replace_data_base(boxm2_scene_sptr & scene, boxm2_block_id id, vcl_string type,
                                 boxm2_data_base* replacement) = 0;

  // : returns data pointer to data specified by ID and data_type
  template <boxm2_data_type T>
  boxm2_data<T> * get_data(boxm2_scene_sptr & scene, boxm2_block_id id, vcl_size_t num_bytes = 0,
                           bool read_only = true);
