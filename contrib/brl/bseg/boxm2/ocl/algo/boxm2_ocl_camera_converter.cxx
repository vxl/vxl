                                                    ...
                                                    bool create_ray_o_d_buffers)
{
  if( cam->type_name() == "vpgl_perspective_camera" )
    ...
    boxm2_ocl_util::set_generic_camera(cam,
                                       (cl_float *) ray_origins->cpu_buffer(),
                                       (cl_float *) ray_directions->cpu_buffer(), cl_ni, cl_nj, i_min, j_min);
    ...
    boxm2_ocl_util::set_generic_camera(gcam,
                                       (cl_float *) ray_origins->cpu_buffer(),
                                       (cl_float *) ray_directions->cpu_buffer(), cl_ni, cl_nj, i_min, j_min);
    if( create_ray_o_d_buffers )
      {
