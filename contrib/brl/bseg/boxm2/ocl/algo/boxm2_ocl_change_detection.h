...
bool get_scene_appearances(boxm2_scene_sptr    scene, vcl_string&         data_type, vcl_string&         num_obs_type,
                           vcl_string&         options, int&                apptypesize, vcl_string identifier);
...
{
public:
  static bool change_detect(vil_image_view<float>&    change_img, vil_image_view<vxl_byte>& rgb_change_img,
                            bocl_device_sptr          device, boxm2_scene_sptr          scene,
                            boxm2_opencl_cache_sptr   opencl_cache, vpgl_camera_double_sptr   cam,
                            vil_image_view_base_sptr  img, vil_image_view_base_sptr  exp_img,
                            int                       n, vcl_string                norm_type,
...
{
public:
  static bool change_detect(  vil_image_view<float>&    change_img, bocl_device_sptr          device,
                              boxm2_scene_sptr          scene, boxm2_opencl_cache_sptr   opencl_cache,
                              vpgl_camera_double_sptr   cam, vil_image_view_base_sptr  img,
                              vil_image_view_base_sptr  exp_img, int                       n,
                              vcl_string                norm_type, bool                      pmax = false);
...
{
public:
  static bool change_detect(  vil_image_view<float>&    change_img, vil_image_view<float>&    vis_img,
                              bocl_device_sptr          device, boxm2_scene_sptr          scene,
                              boxm2_opencl_cache_sptr   opencl_cache, vpgl_camera_double_sptr   cam,
                              vil_image_view_base_sptr  img, vcl_string identifier = "", bool max_density = false,
                              float nearfactor = 100000.0f, float farfactor = 0.000001f);
