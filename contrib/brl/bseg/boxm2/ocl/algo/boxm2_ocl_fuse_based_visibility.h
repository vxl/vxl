...
{
public:
  static bool fuse_based_visibility( boxm2_scene_sptr         sceneA, boxm2_scene_sptr         sceneB,
                                     bocl_device_sptr         device, boxm2_opencl_cache_sptr  opencl_cache);
...
{
public:
  static bool fuse_based_orientation( boxm2_scene_sptr         sceneA, boxm2_scene_sptr         sceneB,
                                      bocl_device_sptr         device, boxm2_opencl_cache_sptr  opencl_cache);
...
{
public:
  static bool fuse_surface_density( boxm2_scene_sptr         sceneA, boxm2_scene_sptr         sceneB,
                                    bocl_device_sptr         device, boxm2_opencl_cache_sptr  opencl_cache);
