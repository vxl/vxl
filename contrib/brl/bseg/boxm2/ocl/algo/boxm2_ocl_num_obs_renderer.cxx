...
bool boxm2_ocl_num_obs_renderer::compile_kernels(bocl_device_sptr device, vcl_vector<bocl_kernel *> & vec_kernels,
                                                 boxm2_data_type data_type)
{
  ...
  if( data_type == BOXM2_NUM_OBS_VIEW )
    ...
    {
    vcl_cerr << "ERROR: boxm2_ocl_num_obs_renderer::compile_kernels(): Unsupported num_obs type " << data_type
             << vcl_endl;
    return false;
    }
  return true;
