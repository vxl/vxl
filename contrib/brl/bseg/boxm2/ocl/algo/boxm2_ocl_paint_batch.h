...
{
public:
  static void paint_block( boxm2_scene_sptr           scene, bocl_device_sptr           device,
                           boxm2_stream_cache_sptr    str_cache, boxm2_opencl_cache_sptr    opencl_cache,
                           cl_command_queue           & queue, vcl_string                 data_type,
                           boxm2_block_id             id, bsta_sigma_normalizer_sptr n_table );
