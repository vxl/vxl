                                   ...
                                   float thresh)
{
  ...
  for( blk_iter = blocks.begin(); blk_iter != blocks.end(); ++blk_iter )
    ...
    // set up tree copy
    bocl_mem_sptr blk_copy = opencl_cache->alloc_mem(numTrees * sizeof(cl_uchar16), new cl_uchar16[numTrees],
    ...
    bocl_mem_sptr tree_sizes = opencl_cache->alloc_mem(sizeof(cl_int) * numTrees, new cl_int[numTrees],
