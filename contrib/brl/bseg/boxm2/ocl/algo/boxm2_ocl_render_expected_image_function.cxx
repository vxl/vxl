                             ...
                             vcl_size_t startJ)
{
  ...
  vcl_cout << "Scene : " << scene->data_path() << ' ' << vis_order.size() << " cache size "
           << opencl_cache->bytes_in_cache() << vcl_endl;
                                  ...
                                  const brad_atmospheric_parameters_sptr atm_params)
{
  ...
  bocl_mem_sptr radiance_offsets = new bocl_mem(
      device->context(), radiance_offsets_buff, sizeof(float) * num_normals, "radiance offset buffer");
