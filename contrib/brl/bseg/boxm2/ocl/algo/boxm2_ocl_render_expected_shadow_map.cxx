...
void boxm2_ocl_render_expected_shadow_map::compile_kernel(bocl_device_sptr device,
                                                          vcl_vector<bocl_kernel *> & vec_kernels, vcl_string opts)
{
  ...
  options +=
    " -D STEP_CELL=step_cell_render_sun_vis(aux_args.auxsun,aux_args.alpha,data_ptr,d*linfo->block_len,vis,aux_args.expint)";
