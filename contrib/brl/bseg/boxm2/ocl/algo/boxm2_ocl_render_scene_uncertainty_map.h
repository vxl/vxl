...
{
public:
  static bool render_scene_uncertainty_map( boxm2_scene_sptr & scene, bocl_device_sptr & device,
                                            boxm2_opencl_cache_sptr & opencl_cache, unsigned ni, unsigned nj,
                                            vcl_string ident, vil_image_view<float> * exp_image,
                                            vil_image_view<unsigned char> * vis_image, vcl_string cam_dir_1,
                                            vcl_string cam_dir_2);

private:
  static   vnl_float_4 compute_cubic_trajectory(float phi_min, float phi_max, float theta_min, float theta_max,
