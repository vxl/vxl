...
{
public:
  static bool update_auxQ( boxm2_scene_sptr         scene, bocl_device_sptr         device,
                           boxm2_opencl_cache_sptr  opencl_cache, vpgl_camera_double_sptr  cam,
                           vil_image_view_base_sptr img, vcl_string               in_identifier = "",
                           vcl_string               view_ident = "", float resnearfactor = 100000.0,
...
private:
  ...
  static bool validate_appearances(boxm2_scene_sptr scene, vcl_string& data_type, int& appTypeSize,
                                   vcl_string& nobs_type, vcl_string& options, bool& isRGB);
...
public:
  ...
  static bool accumulate_product(boxm2_scene_sptr         scene, bocl_device_sptr         device,
                                 boxm2_opencl_cache_sptr  opencl_cache, vcl_string identifier);

  static bool compute_probability(boxm2_scene_sptr         scene, bocl_device_sptr         device,
