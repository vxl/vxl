...
{
public:
  static bool update_sky( boxm2_scene_sptr         scene, bocl_device_sptr         device,
...
{
public:
  static bool update_sky2( boxm2_scene_sptr         scene, bocl_device_sptr         device,
                           boxm2_opencl_cache_sptr  opencl_cache);

  static bool accumulate_sky_evidence( boxm2_scene_sptr         scene, bocl_device_sptr         device,
                                       boxm2_opencl_cache_sptr  opencl_cache, vpgl_camera_double_sptr  cam,
                                       vil_image_view_base_sptr sky_img);
