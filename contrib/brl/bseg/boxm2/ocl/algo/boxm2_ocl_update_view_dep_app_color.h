...
private:
  ...
  static bool validate_appearances(boxm2_scene_sptr scene, vcl_string const& ident, vcl_string& data_type,
                                   int& appTypeSize, vcl_string& nobs_type, vcl_string& options);
