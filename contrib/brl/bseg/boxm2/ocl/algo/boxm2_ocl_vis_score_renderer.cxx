...
::allocate_render_buffers(int cl_ni, int cl_nj)
{
  ...
  exp_vis_score_image_ = opencl_cache_->alloc_mem(cl_ni * cl_nj * sizeof(cl_float), img_buff_,
                                                  "exp vis_score image buffer");
...
::compile_kernels(bocl_device_sptr device)
{
  ...
  vcl_string options =
    "-D RENDER_VIS_SCORE -D STEP_CELL=step_cell_render_vis_score(aux_args,data_ptr,d*linfo->block_len)";
