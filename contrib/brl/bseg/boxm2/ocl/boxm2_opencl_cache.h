...
public:
  ...
  bocl_mem * get_data(boxm2_scene_sptr scene, boxm2_block_id, vcl_size_t num_bytes = 0, bool read_only = true,
                      vcl_string ident = "");
  bocl_mem * get_data(boxm2_scene_sptr scene, boxm2_block_id, vcl_string type, vcl_size_t num_bytes = 0,
                      bool read_only = true);

  template <boxm2_data_type T>
  bocl_mem * get_data_new(boxm2_scene_sptr scene, boxm2_block_id, vcl_size_t num_bytes = 0, bool read_only = true);
  bocl_mem * get_data_new(boxm2_scene_sptr scene, boxm2_block_id id, vcl_string type, vcl_size_t num_bytes = 0,
                          bool read_only = true);
  ...
  void deep_replace_data(boxm2_scene_sptr scene, boxm2_block_id id, vcl_string type, bocl_mem* mem,
                         bool read_only = true);
...
template <boxm2_data_type T>
bocl_mem * boxm2_opencl_cache::get_data(boxm2_scene_sptr scene, boxm2_block_id id, vcl_size_t num_bytes, bool read_only,
                                        vcl_string ident )
{
...
template <boxm2_data_type T>
bocl_mem * boxm2_opencl_cache::get_data_new(boxm2_scene_sptr scene, boxm2_block_id id, vcl_size_t num_bytes,
                                            bool read_only)
{
