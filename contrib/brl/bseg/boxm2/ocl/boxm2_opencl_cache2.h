#ifndef boxm2_opencl_cache2_h
#define boxm2_opencl_cache2_h
//:
// \file
...
class boxm2_opencl_cache2: public vbl_ref_count
{
  public:
    typedef vnl_vector_fixed<unsigned char, 16> uchar16;

  public:
    boxm2_opencl_cache2(bocl_device_sptr device);
    ~boxm2_opencl_cache2() { if (cpu_cache_) cpu_cache_ = 0;
                            this->clear_cache();
                          }

    void set_context(cl_context& context);
    boxm2_cache2_sptr get_cpu_cache() { return cpu_cache_; }
...
typedef vbl_smart_ptr<boxm2_opencl_cache2> boxm2_opencl_cache2_sptr;
...
template<boxm2_data_type T>
bocl_mem* boxm2_opencl_cache2::get_data_new(boxm2_scene_sptr scene,boxm2_block_id id, vcl_size_t num_bytes, bool read_only)
{
