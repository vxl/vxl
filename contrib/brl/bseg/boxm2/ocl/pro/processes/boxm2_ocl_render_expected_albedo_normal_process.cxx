...
bool boxm2_ocl_render_expected_albedo_normal_process(bprb_func_process& pro)
{
  ...
  bocl_mem_sptr exp_albedo_normal = opencl_cache->alloc_mem(4 * cl_ni * cl_nj * sizeof(float), exp_buff,
                                                            "exp normal albedo buffer");
  ...
  for( unsigned int j = 0; j < nj; ++j )
    ...
    for( unsigned int i = 0; i < ni; ++i )
      ...
      if( mask_val > mask_thresh )
        ...
        expected_normal =
          vgl_vector_3d<double>( (*exp_normal_out)(i, j, 0), (*exp_normal_out)(i, j, 1), (*exp_normal_out)(i, j, 2) );
