...
bool boxm2_ocl_render_gl_expected_color_process(bprb_func_process& pro)
{
  ...
  if( !foundDataType )
    {
    vcl_cout << "boxm2_ocl_render_gl_expected_color_process ERROR: scene doesn't have BOXM2_GAUSS_RGB data type"
             << vcl_endl;
    return false;
    }
  ...
  bocl_mem_sptr exp_color = opencl_cache->alloc_mem(cl_ni * cl_nj * sizeof(cl_float) * 4, buff,
