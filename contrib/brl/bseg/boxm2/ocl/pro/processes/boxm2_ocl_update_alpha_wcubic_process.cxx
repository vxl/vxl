...
namespace boxm2_ocl_update_alpha_wcubic_process_globals
{
...
void compile_kernel(bocl_device_sptr device, vcl_vector<bocl_kernel *> & vec_kernels, vcl_string opts)
{
  ...
  vcl_string   bayes_opt = options
    + " -D BAYES -D BAYES_CUBIC -D STEP_CELL=step_cell_bayes_cubic(aux_args,data_ptr,llid,d) ";
...
bool boxm2_ocl_update_alpha_wcubic_process_cons(bprb_func_process& pro)
{
  using namespace boxm2_ocl_update_alpha_wcubic_process_globals;
...
bool boxm2_ocl_update_alpha_wcubic_process(bprb_func_process& pro)
{
  using namespace boxm2_ocl_update_alpha_wcubic_process_globals;
