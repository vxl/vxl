...
namespace boxm2_ocl_update_alpha_wphongs_process_globals
{
  ...
  void compile_kernel(bocl_device_sptr device,vcl_vector<bocl_kernel*> & vec_kernels,vcl_string opts)
  {
    ...
    vcl_string pre_opts = options + " -D PREINF -D PREINF_PHONGS -D STEP_CELL=step_cell_preinf_phongs(aux_args,data_ptr,llid,d) ";
    ...
    vcl_string bayes_opt = options + " -D BAYES -D BAYES_PHONGS -D STEP_CELL=step_cell_bayes_phongs(aux_args,data_ptr,llid,d) ";
