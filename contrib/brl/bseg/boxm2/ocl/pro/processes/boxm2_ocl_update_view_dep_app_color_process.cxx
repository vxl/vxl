...
bool boxm2_ocl_update_view_dep_app_color_process(bprb_func_process& pro)
{
  using namespace boxm2_ocl_update_view_dep_app_color_process_globals;
#if 0 // unused!
  ...
  return boxm2_ocl_update_view_dep_app_color::update(scene, device, opencl_cache, cam, img, ident, mask_sptr,
                                                     update_alpha, mog_var);
}
