...
public:
  static char * construct_block_test_stream( int numBuffers, int treeLen, int* nums, double* dims, int init_level,
                                             int max_level, int max_mb );
  ...
  template <class T>
  static void  fill_random(T * b, T * e, vnl_random & rng);
