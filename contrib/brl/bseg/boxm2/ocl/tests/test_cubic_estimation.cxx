...
void test_cubic_estimation()
{
  ...
  inverse_test.create_kernel(&device->context(),
                             device->device_id(), src_paths, "test_matrix4x4_inverse", "", "test matrix 4x4 kernel");
  ...
  cubic_fit_test.create_kernel(&device->context(),
                               device->device_id(), src_paths, "test_cubic_fit", "", "test cubic fitting kernel");
