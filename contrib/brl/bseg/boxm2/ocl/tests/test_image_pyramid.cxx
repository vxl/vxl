...
void test_image()
{
  ...
  pyramid_test.create_kernel(&device->context(),
                             device->device_id(), src_paths, "test_image_pyramid", " -D IMG_TYPE=float ",
                             "test image pyramid kernel");
...
void test_ray_pyramid()
{
  ...
  bocl_kernel pyramid_test;
  pyramid_test.create_kernel(&device->context(),
                             device->device_id(), src_paths, "test_ray_pyramid", "", "test ray pyramid kernel");
