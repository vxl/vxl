...
void test_refine_trees_kernel()
{
  ...
  if(!refine_trees.create_kernel( &gpu_pro->context(), &gpu_pro->devices()[0], src_paths, "refine_trees", "-D MOG_TYPE_8", "boxm2 opencl refine trees (pass one)") ) {
  ...
  vcl_cout<<"outputing new tree sizes"<<vcl_endl;
  ...
  refine_data.create_kernel( &gpu_pro->context(), &gpu_pro->devices()[0], src_paths, "refine_data", "-D MOG_TYPE_4 ", "boxm2 opencl refine data size 4 (pass three)"); 
