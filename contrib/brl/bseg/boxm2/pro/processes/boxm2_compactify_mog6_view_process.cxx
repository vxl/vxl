...
bool boxm2_compactify_mog6_view_process(bprb_func_process& pro)
{
  ...
  for(iter = blocks.begin(); iter != blocks.end(); iter++)
  {
    ...
    {
      boxm2_data_base* app = cache->get_data_base(iter->first, boxm2_data_traits<BOXM2_MOG6_VIEW>::prefix(),0);
      ...
      boxm2_data_base* app_compact = cache->get_data_base(iter->first, boxm2_data_traits<BOXM2_MOG6_VIEW_COMPACT>::prefix(), num_el * boxm2_data_traits<BOXM2_MOG6_VIEW_COMPACT>::datasize());
    ...
    {
      boxm2_data_base* app = cache->get_data_base(iter->first, boxm2_data_traits<BOXM2_GAUSS_RGB_VIEW>::prefix(),0);
      ...
      boxm2_data_base* app_compact = cache->get_data_base(iter->first, boxm2_data_traits<BOXM2_GAUSS_RGB_VIEW_COMPACT>::prefix(), num_el * boxm2_data_traits<BOXM2_GAUSS_RGB_VIEW_COMPACT>::datasize());
