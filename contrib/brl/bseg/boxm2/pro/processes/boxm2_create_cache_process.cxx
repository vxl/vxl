...
bool boxm2_create_rw_cache_process_cons(bprb_func_process& pro)
{
  using namespace boxm2_create_cache_process_globals;
...
bool boxm2_create_rw_cache_process(bprb_func_process& pro)
{
  using namespace boxm2_create_cache_process_globals;
  ...
  boxm2_cache::instance()->enable_write();
