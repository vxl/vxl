...
bool boxm2_scene_from_nvm_txt_process(bprb_func_process& pro)
{
  ...
  vgl_box_3d<double> box(vgl_point_3d<double>(x_center, y_center,
                                              z_center), width, height, depth, vgl_box_3d<double>::centre );
  ...
  for( vcl_map<vcl_string, vpgl_perspective_camera<double> *>::iterator iter = cams.begin(); iter != cams.end();
       ++iter )
    {
