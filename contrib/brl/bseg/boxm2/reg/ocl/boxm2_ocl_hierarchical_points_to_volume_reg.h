...
public:
  ...
  boxm2_ocl_hierarchical_points_to_volume_reg( boxm2_opencl_cache_sptr  & cache, float * pts, boxm2_scene_sptr sceneB,
                                               int npts, bocl_device_sptr device, bool do_vary_scale);
