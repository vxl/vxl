...
public:
  ...
  boxm2_ocl_hierarchical_reg( boxm2_opencl_cache_sptr  & cache, boxm2_scene_sptr sceneA, boxm2_scene_sptr sceneB,
                              bocl_device_sptr device, int nbins, bool do_vary_scale);
