...
boxm2_ocl_reg_minfo_func::boxm2_ocl_reg_minfo_func( boxm2_opencl_cache2_sptr& cacheA,
                                                    boxm2_stream_scene_cache& cacheB,
                                                    bocl_device_sptr device,
                                                    int nbins,
                                                    double scale)
: vnl_cost_function(6), boxm2_ocl_reg_mutual_info(cacheA,cacheB,device,nbins, scale)
{
