...
void test_asio_data()
{
    // initialize generic random data buffer
    ...
    // async write to disk while counting flops
    ...
    // async read and count flops
    // TODO: this is sort of a hacky way to test a data block
    baio read_status;
