...
void boxm2_util_convert_nvm(vcl_string nvm_file, vcl_string img_dir, vcl_map<vcl_string, CamType *>& cams,
                            vcl_vector<vgl_point_3d<double> > &  pts, vgl_box_3d<double>& bbox, double& resolution,
