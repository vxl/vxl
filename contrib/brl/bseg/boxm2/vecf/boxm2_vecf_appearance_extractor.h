...
{
public:
  boxm2_vecf_appearance_extractor(boxm2_scene_sptr target_scene,
                                  boxm2_vecf_composite_head_model& source_model) : head_model_(source_model)
  {
...
private:
  ...
  color_APM        left_upper_lid_app_, right_upper_lid_app_, right_lower_lid_app_, left_lower_lid_app_,
    left_eyelid_crease_app_, right_eyelid_crease_app_, left_iris_app_, right_iris_app_, left_sclera_app_,
    right_sclera_app_, left_pupil_app_, right_pupil_app_;
