...
void boxm2_vecf_articulated_scene::clear_target(boxm2_scene_sptr target_scene)
{
  ...
  boxm2_data_base*           alpha_db     =
    boxm2_cache::instance()->get_data_base(target_scene, blocks[0], alpha_prefix);
  boxm2_data_base* gray_app_db  = boxm2_cache::instance()->get_data_base(target_scene, blocks[0],
                                                                         gray_APM_prefix);
  boxm2_data_base* color_app_db = boxm2_cache::instance()->get_data_base(target_scene, blocks[0],
                                                                         color_APM_prefix + "_"
                                                                         + (this->color_apm_id_) );
...
double boxm2_vecf_articulated_scene::interp_generic_double(vgl_point_3d<double>* neighbors, double* probs,
...
double8 boxm2_vecf_articulated_scene::interp_generic_double8(vgl_point_3d<double>* neighbors, double8* probs,
                                                             vgl_point_3d<double> p )
{
