...
void boxm2_vecf_composite_head_model_articulation::register_play_sequences(
  boxm2_vecf_composite_head_parameters const&  head_params)
{
    {
    vcl_vector<boxm2_vecf_composite_head_parameters> default_articulation;
    double                                           ddt = 0.9;
...
// ============================== brow angle articulation ====================
    {
    vcl_vector<boxm2_vecf_composite_head_parameters> brow_angle_articulation;
    //  adjust brow angle
...
// ============================== eyelid radius articulation ====================
    {
    vcl_vector<boxm2_vecf_composite_head_parameters> eye_radius_articulation;
    double                                           rad = 18;
    for( int i = 0; i < 6; ++i )
      {
...
// ============================== head scale articulation ====================
    {
    vcl_vector<boxm2_vecf_composite_head_parameters> head_scale_articulation;
    double                                           ddt = 0.9;
    // scale head
    double scale = 1.0;
    for( int i = 0; i < 6; ++i )
...
// ============================== eyelid_dt close articulation ====================
    {
    vcl_vector<boxm2_vecf_composite_head_parameters> eyelid_dt_closed_articulation;
    // slowly close
    for( int i = 0; i < 1; i++ )
      {
      double                               ddt = 0.9;
...
// ============================== look dir articulation ====================
    ...
    for( unsigned i = 0; i <= num_frames; ++i )
      ...
      head_params_local_cpy.l_orbit_params_.eye_pointing_dir_ = vgl_vector_3d<double>(interped_rot_l.get(0,
                                                                                                         2),
                                                                                      interped_rot_l.get(1,
                                                                                                         2),
                                                                                      interped_rot_l.get(2, 2) );
      head_params_local_cpy.r_orbit_params_.eye_pointing_dir_ = vgl_vector_3d<double>(interped_rot_r.get(0,
                                                                                                         2),
                                                                                      interped_rot_r.get(1,
                                                                                                         2),
                                                                                      interped_rot_r.get(2, 2) );
