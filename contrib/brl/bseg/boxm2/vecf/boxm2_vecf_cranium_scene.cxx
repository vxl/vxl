...
void boxm2_vecf_cranium_scene::extract_block_data()
{
  ...
  cranium_base_  = boxm2_cache::instance()->get_data_base(base_model_, *iter_blk, boxm2_data_traits<BOXM2_PIXEL>::prefix(
                                                            "cranium") );
...
// constructors
boxm2_vecf_cranium_scene::boxm2_vecf_cranium_scene(vcl_string const& scene_file) : boxm2_vecf_articulated_scene(
    scene_file), source_model_exists_(true), alpha_data_(0), app_data_(0), nobs_data_(0), cranium_data_(0),
...
boxm2_vecf_cranium_scene::boxm2_vecf_cranium_scene(vcl_string const& scene_file, vcl_string const& geometry_file) :
  boxm2_vecf_articulated_scene(scene_file), source_model_exists_(false), alpha_data_(0), app_data_(0), nobs_data_(0),
  cranium_data_(0), intrinsic_change_(false)
{
...
bool boxm2_vecf_cranium_scene::is_type_global(vgl_point_3d<double> const& global_pt,
                                              boxm2_vecf_cranium_scene::anat_type  type) const
{
  unsigned indx;
...
bool boxm2_vecf_cranium_scene::find_nearest_data_index(boxm2_vecf_cranium_scene::anat_type type,
                                                     ...
                                                     vcl_vector<bool>& valid) const
{
  ...
  vcl_cout << "computed " << cnt << " pts out of " << nt << " for cranium vector field in " << t.real() / 1000.0
           << " sec.\n";
}
...
//
void boxm2_vecf_cranium_scene::interpolate_vector_field(vgl_point_3d<double> const& src, unsigned sindx, unsigned dindx,
                                                        unsigned tindx,
