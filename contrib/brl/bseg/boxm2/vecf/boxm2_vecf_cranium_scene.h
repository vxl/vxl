...
public:
  ...
  boxm2_vecf_cranium_scene() : source_model_exists_(false), alpha_data_(0), app_data_(0), nobs_data_(0),
    cranium_data_(0), target_alpha_data_(0), target_app_data_(0), target_nobs_data_(0), extrinsic_only_(false),
    target_blk_(0), target_data_extracted_(false), boxm2_vecf_articulated_scene(), sigma_(0.5f) {}
  ...
  bool find_nearest_data_index(boxm2_vecf_cranium_scene::anat_type type, vgl_point_3d<double> const& probe,
