...
public:
  ...
  enum mids { LEFT_EYE_MEDIAL_CANTHUS, LEFT_EYE_LATERAL_CANTHUS, LEFT_EYE_INFERIOR_MARGIN,
              LEFT_EYE_SUPERIOR_MARGIN, LEFT_EYE_SUPERIOR_CREASE, LEFT_SCLERA, LEFT_INFERIOR_LID_SURFACE, LEFT_Nz,
              LEFT_IRIS_RADIUS,
              RIGHT_EYE_MEDIAL_CANTHUS, RIGHT_EYE_LATERAL_CANTHUS, RIGHT_EYE_INFERIOR_MARGIN,
              RIGHT_EYE_SUPERIOR_MARGIN, RIGHT_EYE_SUPERIOR_CREASE, RIGHT_SCLERA, RIGHT_INFERIOR_LID_SURFACE, RIGHT_Nz,
              RIGHT_IRIS_RADIUS };
  boxm2_vecf_fit_orbit() : nominal_canthus_angle_rad_(0.110498), has_inferior_surface_pts_(true),
    from_image_data_(false), image_height_(0.0)
  {fill_smid_map(); }
