#ifndef boxm2_vecf_mandible_articulation_h_
#define boxm2_vecf_mandible_articulation_h_
//:
// \file
// \brief  Articulation for the mandible model
//
// \author J.L. Mundy
...
class boxm2_vecf_mandible_articulation : public boxm2_vecf_scene_articulation{
 public:
  boxm2_vecf_mandible_articulation();
  ~boxm2_vecf_mandible_articulation() override{
    params_.clear();
  }
 ...
 boxm2_vecf_articulated_params& operator [] (unsigned i) override {
   return params_[i] ; }
 private:
  std::vector<boxm2_vecf_mandible_params> params_;
  std::map<std::string,std::vector<boxm2_vecf_mandible_params> > play_sequence_map_;


};
#endif// boxm2_vecf_mandible_articulation
