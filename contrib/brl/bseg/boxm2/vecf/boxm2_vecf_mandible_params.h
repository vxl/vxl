...
public:
  ...
  boxm2_vecf_mandible_params() :  ramus_length_(1.0), mandible_intensity_(static_cast<unsigned char>(100) ),
    left_ramus_intensity_(static_cast<unsigned char>(110) ), offset_(vgl_vector_3d<double>(0.0, 0.0, 0.0) ),
    jaw_opening_angle_rad_(0.0), max_jaw_opening_angle_rad_(0.6), planar_surface_dist_thresh_(2.0)
  {
  }
