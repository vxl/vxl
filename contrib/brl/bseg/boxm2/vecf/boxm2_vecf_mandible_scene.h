...
public:
  ...
  boxm2_vecf_mandible_scene() : alpha_base_(0), app_base_(0), nobs_base_(0), mandible_data_(0), left_ramus_(0),
    left_angle_(0),
    body_(0), right_angle_(0), right_ramus_(0), target_alpha_base_(0), target_app_base_(0), target_nobs_base_(0),
    extrinsic_only_(false), target_blk_(0), target_data_extracted_(false), boxm2_vecf_articulated_scene(),
    sigma_(0.5f) {}
  ...
  bool find_nearest_data_index(boxm2_vecf_mandible_scene::anat_type type, vgl_point_3d<double> const& probe,
                               double cell_len, unsigned& data_indx, int& found_depth) const;
