...
public:
  ...
  boxm2_vecf_orbit_param_stats(vcl_map<vcl_string, vcl_pair<boxm2_vecf_orbit_params,
                                                            boxm2_vecf_orbit_params> > const& param_map) :
    param_map_(param_map) {}

  void add_param_pair(vcl_string patient_id, vcl_pair<boxm2_vecf_orbit_params,
                                                      boxm2_vecf_orbit_params> const& param_pair)
  {
