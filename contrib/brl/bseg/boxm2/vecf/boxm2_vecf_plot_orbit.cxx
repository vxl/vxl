...
void boxm2_vecf_plot_orbit::plot_inferior_margin(boxm2_vecf_orbit_params const& opr, bool is_right, double xm_min,
                                                 double xm_max, vcl_vector<vgl_point_3d<double> >& pts)
{
...
void boxm2_vecf_plot_orbit::plot_superior_margin(boxm2_vecf_orbit_params const& opr, bool is_right, double xm_min,
                                                 double xm_max, vcl_vector<vgl_point_3d<double> >& pts)
{
...
void boxm2_vecf_plot_orbit::plot_crease(boxm2_vecf_orbit_params const& opr, bool is_right, double xm_min, double xm_max,
...
bool boxm2_vecf_plot_orbit::plot_limits(vcl_vector<vgl_point_3d<double> > const& inf_pts,
                                        vcl_vector<vgl_point_3d<double> > const& sup_pts, int& imin, int& imax)
{
