...
{
public:
  boxm2_vecf_similarity_transform_mapper(vgl_rotation_3d<double> const& rot, vgl_vector_3d<double> const& trans,
...
{
public:
  boxm2_vecf_similarity_transform(vgl_rotation_3d<double> const& rot, vgl_vector_3d<double> const& trans,
                                  vgl_vector_3d<double> const& scale);
private:
