...
public:
  ...
  boxm2_vecf_skull_params() : left_lateral_canthus_(vgl_point_3d<double>(59.1, 23.52, 52.78) ),
    right_lateral_canthus_(vgl_point_3d<double>(-59.1, 23.52, 52.78) ),
    mid_upper_jaw_(vgl_point_3d<double>(0.0, -59.26, 78.9) ),
    mid_forehead_(vgl_point_3d<double>(0.33, 70.68, 81.95) ),
    mid_forehead_normal_(vgl_vector_3d<double>(0.078, 0.133, 0.988) ),
