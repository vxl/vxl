...
boxm2_vecf_skull_scene::boxm2_vecf_skull_scene( vcl_string const& base_scene_path, vcl_string const& mandible_geo_path)
  : boxm2_vecf_articulated_scene(), target_data_extracted_(false)
{
  //resolve the mandible and cranium paths
  vcl_string mandible_path = base_scene_path + "mandible/mandible.xml";
  vcl_string cranium_path = base_scene_path + "cranium/cranium.xml";
...
bool boxm2_vecf_skull_scene::set_params(boxm2_vecf_articulated_params const& params)
{
  try{
    ...
    vcl_cout<<" Can't downcast to skull parameters! PARAMATER ASSIGNMENT PHAILED!"<<vcl_endl;
    return false;
  }
