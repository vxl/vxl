...
public:
  ...
  bool compute_forward_transform(boxm2_scene_sptr source, boxm2_block_id const& blk_id,
  ...
  bool compute_inverse_transform(boxm2_scene_sptr target, boxm2_block_id const& blk_id,
...
private:
  ...
  bool compute_transformed_pts(boxm2_scene_sptr scene, boxm2_block_id const& blk_id, T & f,
