#ifndef boxm2_vecf_vector_field_txx_included_
#define boxm2_vecf_vector_field_txx_included_
...
template <class T>
bool boxm2_vecf_vector_field<T>::compute_forward_transform(boxm2_scene_sptr source,
...
template <class T>
bool boxm2_vecf_vector_field<T>::compute_inverse_transform(boxm2_scene_sptr target,
                                                           boxm2_block_id const& blk_id,
...
template <class T>
bool boxm2_vecf_vector_field<T>::compute_transformed_pts(boxm2_scene_sptr scene, boxm2_block_id const& blk_id,
                                                         T & f,
