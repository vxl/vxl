...
boxm2_vecf_ocl_composite_transform::boxm2_vecf_ocl_composite_transform(
  vcl_vector<boxm2_vecf_ocl_vector_field_sptr> xforms)
  : xforms_(xforms)
{
}

// : compute vector field, writing to gpu cache
bool boxm2_vecf_ocl_composite_transform::compute_forward_transform(boxm2_scene_sptr source,
...
bool boxm2_vecf_ocl_composite_transform::compute_inverse_transform(boxm2_scene_sptr target,
                                                                   boxm2_block_id const& blk_id,
                                                                   bocl_mem* pts_target,
                                                                   bocl_mem* pts_source,
                                                                   cl_command_queue & queue)
