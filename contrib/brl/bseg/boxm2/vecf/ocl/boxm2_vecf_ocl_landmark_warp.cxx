...
boxm2_vecf_ocl_landmark_warp::boxm2_vecf_ocl_landmark_warp(vcl_vector<vgl_point_3d<double> > const& control_pts_source,
  ...
  : boxm2_vecf_ocl_vector_field_adaptor( boxm2_vecf_vector_field_base_sptr(
                                           new boxm2_vecf_landmark_warp<boxm2_vecf_inverse_square_weighting_function>(
                                             control_pts_source,
                                             control_pts_target,
                                             boxm2_vecf_inverse_square_weighting_function(weight_fun_max,
                                                                                          weight_fun_x_at_10_percent)
                                             )
                                           )
                                         )
{
