...
boxm2_vecf_ocl_ssd_func::boxm2_vecf_ocl_ssd_func(unsigned nx, unsigned ni, unsigned nj,
                                                 boxm2_vecf_ocl_transform_scene_sptr tscn,
                                                 boxm2_scene_sptr target_scene, boxm2_opencl_cache_sptr ocl_cache) :
  ni_(ni), nj_(nj),
  vnl_least_squares_function(nx, ni * nj, vnl_least_squares_function::no_gradient), tscn_(tscn), renderer_(target_scene,
                                                                                                           ocl_cache),
...
bool boxm2_vecf_ocl_ssd_func::render_scene_appearance(vpgl_camera_double_sptr const& cam,
                                                      vil_image_view<float>& expected_img,
