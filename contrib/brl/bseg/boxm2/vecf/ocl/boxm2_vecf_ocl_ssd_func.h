...
public:
  ...
  boxm2_vecf_ocl_ssd_func(unsigned nx, unsigned ni, unsigned nj, boxm2_vecf_ocl_transform_scene_sptr tscn,
...
protected:
  ...
  bool render_scene_appearance(vpgl_camera_double_sptr const & cam, vil_image_view<float>& expected_img,
                               vil_image_view<float>& vis_img, unsigned ni, unsigned nj);
