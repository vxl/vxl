...
{
public:
  boxm2_vecf_ocl_transform_minimizer(boxm2_scene_sptr& source_scene, boxm2_scene_sptr& target_scene,
                                     boxm2_opencl_cache_sptr ocl_cache, vil_image_view<float> const& ref_img,
