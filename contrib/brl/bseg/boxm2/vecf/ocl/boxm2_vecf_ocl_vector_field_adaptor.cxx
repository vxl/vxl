...
bool boxm2_vecf_ocl_vector_field_adaptor::compute_forward_transform(boxm2_scene_sptr source,
                                                                    ...
                                                                    cl_command_queue & queue)
{
  ...
  if( !good_read )
    {
    vcl_cerr << "ERROR: boxm2_vecf_ocl_vector_field_adaptor::compute_forward_transform(): bad read of source points"
             << vcl_endl;
    return false;
    }
  ...
  if( !good_write )
    {
    vcl_cerr << "ERROR: boxm2_vecf_ocl_vector_field_adaptor::compute_forward_transform(): bad write of target points"
             << vcl_endl;
    return false;
    }
...
bool boxm2_vecf_ocl_vector_field_adaptor::compute_inverse_transform(boxm2_scene_sptr target,
                                                                    boxm2_block_id const& blk_id,
                                                                    bocl_mem* pts_target,
                                                                    bocl_mem* pts_source,
                                                                    cl_command_queue & queue)
{
  ...
  if( !good_read )
    {
    vcl_cerr << "ERROR: boxm2_vecf_ocl_vector_field_adaptor::compute_forward_transform(): bad read of target points"
             << vcl_endl;
    return false;
    }
  ...
  if( !good_write )
    {
    vcl_cerr << "ERROR: boxm2_vecf_ocl_vector_field_adaptor::compute_forward_transform(): bad write of source points"
             << vcl_endl;
    return false;
    }
