...
#  if CRISTINA
  vcl_string           cr_base_path = "c:/Users/mundy/VisionSystems/Janus/experiments/Helena/cristina/";
  boxm2_vecf_fit_orbit cr_fo;
  vcl_string           cr_right_anchor_path = cr_base_path + "cristina_right_anchors.txt";
  good = cr_fo.read_anchor_file(cr_right_anchor_path);
  if( !good )
    {
    return;
    }
  vcl_string cr_right_sclera_path = cr_base_path + "cristina_right_sclera.txt";
  ...
  vcl_string cr_left_anchor_path = cr_base_path + "cristina_left_anchors.txt";
  good = cr_fo.read_anchor_file(cr_left_anchor_path);
  if( !good )
    {
    return;
    }
  vcl_string cr_left_sclera_path = cr_base_path + "cristina_left_sclera.txt";
  ...
  boxm2_vecf_fit_margins cr_right_fmargs(cr_fo.orbit_data("right_eye_inferior_margin"), cr_fo.orbit_data(
                                           "right_eye_superior_margin"),
  ...
  vcl_string   cr_right_param_path = cr_base_path + "cristina_right_orbit_params.txt";
  vcl_ofstream cr_rpstr(cr_right_param_path.c_str() );
  ...
  boxm2_vecf_fit_margins cr_left_fmargs(cr_fo.orbit_data("left_eye_inferior_margin"), cr_fo.orbit_data(
                                          "left_eye_superior_margin"),
  ...
  cr_lostr.close();
  vcl_string   cr_left_param_path = cr_base_path + "cristina_left_orbit_params.txt";
  vcl_ofstream cr_lpstr(cr_left_param_path.c_str() );
  cr_lpstr << cr_fo.left_params() << '\n';
  cr_lpstr.close();

#  endif // CRISTINA
#  if P069
  vcl_string           p69_base_path = "c:/Users/mundy/VisionSystems/Janus/experiments/Helena/patient_069/";
  boxm2_vecf_fit_orbit p69_fo;
  vcl_string           p69_right_anchor_path = p69_base_path + "patient_069_right_anchors.txt";
  good = p69_fo.read_anchor_file(p69_right_anchor_path);
  if( !good )
    {
    return;
    }
  vcl_string p69_right_sclera_path = p69_base_path + "patient_069_right_sclera.txt";
  // vcl_string right_sclera_path = base_path + "patient_069_right_lower_lid_cover.txt";
  ...
  vcl_string p69_left_anchor_path = p69_base_path + "patient_069_left_anchors.txt";
  good = p69_fo.read_anchor_file(p69_left_anchor_path);
  if( !good )
    {
    return;
    }
  vcl_string p69_left_sclera_path = p69_base_path + "patient_069_left_sclera.txt";
  ...
  // non-linear fit
  boxm2_vecf_fit_margins p69_right_fmargs(p69_fo.orbit_data("right_eye_inferior_margin"), p69_fo.orbit_data(
                                            "right_eye_superior_margin"),
  ...
  vcl_string   p69_right_param_path = p69_base_path + "patient_069_right_orbit_params.txt";
  vcl_ofstream p69_rpstr(p69_right_param_path.c_str() );
  ...
  // non-linear fit
  boxm2_vecf_fit_margins p69_left_fmargs(p69_fo.orbit_data("left_eye_inferior_margin"), p69_fo.orbit_data(
                                           "left_eye_superior_margin"),
  ...
  vcl_string   p69_left_marg_path = p69_base_path + "patient_069_left_margin_fit.txt";
  vcl_ofstream p69_lmstr(p69_left_marg_path.c_str() );
  ...
  vcl_string   p69_left_param_path = p69_base_path + "patient_069_left_orbit_params.txt";
  vcl_ofstream p69_lpstr(p69_left_param_path.c_str() );
  p69_lpstr << p69_fo.left_params() << '\n';
  p69_lpstr.close();
#  endif // P069
#  if P113
  vcl_string           p113_base_path = "c:/Users/mundy/VisionSystems/Janus/experiments/Helena/patient_113/";
  boxm2_vecf_fit_orbit p113_fo;
  vcl_string           p113_right_anchor_path = p113_base_path + "patient_113_right_anchors.txt";
  good = p113_fo.read_anchor_file(p113_right_anchor_path);
  if( !good )
    {
    return;
    }
  vcl_string p113_right_sclera_path = p113_base_path + "patient_113_right_sclera.txt";
  // vcl_string right_sclera_path = p113_base_path + "patient_113_right_lower_lid_cover.txt";
  ...
  vcl_string p113_left_anchor_path = p113_base_path + "patient_113_left_anchors.txt";
  good = p113_fo.read_anchor_file(p113_left_anchor_path);
  if( !good )
    {
    return;
    }
  vcl_string p113_left_sclera_path = p113_base_path + "patient_113_left_sclera.txt";
  ...
  // non-linear fit
  boxm2_vecf_fit_margins p113_right_fmargs(p113_fo.orbit_data("right_eye_inferior_margin"), p113_fo.orbit_data(
                                             "right_eye_superior_margin"), true);
  p113_right_fmargs.set_initial_guess( p113_fo.right_params() );
  p113_right_fmargs.fit(&vcl_cout, true);
  ...
  vcl_string   p113_right_marg_path = p113_base_path + "patient_113_right_margin_fit.txt";
  vcl_ofstream p113_rmstr(p113_right_marg_path.c_str() );
  ...
  p113_rostr.close();
  vcl_string   p113_right_param_path = p113_base_path + "patient_113_right_orbit_params.txt";
  vcl_ofstream p113_rpstr(p113_right_param_path.c_str() );
  ...
  // non-linear fit
  boxm2_vecf_fit_margins p113_left_fmargs(p113_fo.orbit_data("left_eye_inferior_margin"), p113_fo.orbit_data(
                                            "left_eye_superior_margin") );
  p113_left_fmargs.set_initial_guess( p113_fo.left_params() );
  p113_left_fmargs.fit(&vcl_cout, true);
  ...
  vcl_string   p113_left_marg_path = p113_base_path + "patient_113_left_margin_fit.txt";
  vcl_ofstream p113_lmstr(p113_left_marg_path.c_str() );
  ...
  vcl_string   p113_left_param_path = p113_base_path + "patient_113_left_orbit_params.txt";
...
#  if bs00
  ...
  vcl_string           bs00_right_anchor_path = bs00_base_path + "bs00_right_anchors.txt";
  good = bs00_fo.read_anchor_file(bs00_right_anchor_path);
  if( !good )
    {
    return;
    }
  vcl_string bs00_right_sclera_path = bs00_base_path + "bs00_right_sclera.txt";
  // vcl_string right_sclera_path = base_path + "bs00_right_lower_lid_cover.txt";
  ...
  vcl_string bs00_left_anchor_path = bs00_base_path + "bs00_left_anchors.txt";
  good = bs00_fo.read_anchor_file(bs00_left_anchor_path);
  if( !good )
    {
    return;
    }
  vcl_string bs00_left_sclera_path = bs00_base_path + "bs00_left_sclera.txt";
  ...
  // non-linear fit
  boxm2_vecf_fit_margins bs00_right_fmargs(bs00_fo.orbit_data("right_eye_inferior_margin"), bs00_fo.orbit_data(
                                             "right_eye_superior_margin"), true);
  bs00_right_fmargs.set_initial_guess( bs00_fo.right_params() );
  bs00_right_fmargs.fit(&vcl_cout, true);
  ...
  vcl_string   bs00_right_marg_path = bs00_base_path + "bs00_right_margin_fit.txt";
  vcl_ofstream bs00_rmstr(bs00_right_marg_path.c_str() );
  ...
  bs00_rostr.close();
  vcl_string   bs00_right_param_path = bs00_base_path + "bs00_right_orbit_params.txt";
  vcl_ofstream bs00_rpstr(bs00_right_param_path.c_str() );
  ...
  // non-linear fit
  boxm2_vecf_fit_margins bs00_left_fmargs(bs00_fo.orbit_data("left_eye_inferior_margin"), bs00_fo.orbit_data(
                                            "left_eye_superior_margin") );
  bs00_left_fmargs.set_initial_guess( bs00_fo.left_params() );
  bs00_left_fmargs.fit(&vcl_cout, true);
  ...
  vcl_string   bs00_left_marg_path = bs00_base_path + "bs00_left_margin_fit.txt";
  vcl_ofstream bs00_lmstr(bs00_left_marg_path.c_str() );
  ...
  bs00_lostr.close();
  vcl_string   bs00_left_param_path = bs00_base_path + "bs00_left_orbit_params.txt";
  vcl_ofstream bs00_lpstr(bs00_left_param_path.c_str() );
