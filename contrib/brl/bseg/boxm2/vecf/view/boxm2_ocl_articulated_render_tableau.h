...
public:
  ...
  bool init(bocl_device_sptr device, boxm2_opencl_cache_sptr opencl_cache,
            boxm2_vecf_articulated_scene_sptr articulated_scene, boxm2_vecf_scene_articulation* sa,
            boxm2_scene_sptr target_scene, unsigned ni, unsigned nj, vpgl_perspective_camera<double>* cam,
