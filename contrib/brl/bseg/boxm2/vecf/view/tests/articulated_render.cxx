...
int main(int argc, char * * argv)
{
  ...
  if( scene_t == "eye" )
    ...
    boxm2_vecf_composite_head_model* composite_head_model = new boxm2_vecf_composite_head_model(articulated_scene_path,
                                                                                                eye_model_path);
    ...
    boxm2_vecf_composite_head_model_articulation* head_model_articulation =
      new boxm2_vecf_composite_head_model_articulation();
    ...
    boxm2_vecf_mandible_scene* mandible_scene = new boxm2_vecf_mandible_scene(articulated_scene_path,
                                                                              geometry_path);
