...
public:
  ...
  bool init(bocl_device_sptr device, boxm2_opencl_cache_sptr opencl_cache, boxm2_scene_sptr scene, unsigned ni,
            unsigned nj, vpgl_perspective_camera<double>* cam, vcl_string identifier = "",
            vcl_list<vgl_point_3d<double> > waypoints = vcl_list<vgl_point_3d<double> >(0),
