...
void boxm2_view_utils::add_vrml_animation(vcl_ostream & os,vcl_vector<vpgl_camera_double_sptr > &  cameras)
{
    ...
    os<<"DEF camerapath PositionInterpolator {\n";
    os<<"\tkey [\n";
    for(unsigned i=0;i<cameras.size();i++)
        os<<inc*(float)i<<",";
    os<<"]\n";
    ...
    os<<"DEF camerarot OrientationInterpolator {\n";
    os<<"\tkey [";
    for(unsigned i=0;i<cameras.size();i++)
        os<<inc*(float)i<<",";
    os<<"]\n";
    ...
    os<<"ROUTE Clock.fraction_changed  TO camerapath.set_fraction \n";
    os<<"ROUTE Clock.fraction_changed  TO camerarot.set_fraction \n";
    os<<"ROUTE camerapath.value_changed TO flypos.position \n";
    os<<"ROUTE camerarot.value_changed TO flypos.orientation \n";
    os<<vcl_endl;
}
