...
public:
  ...
  void add_dems(boxm2_scene_sptr scene, unsigned interval_i, unsigned interval_j, float altitude,
  ...
  bool add(boxm2_scene_sptr scene, vgl_box_3d<double>& scene_bounding_box, double lon, double lat, double elev,
  ...
  void generate_output_tile(vcl_vector<float>& scores, int uncertainty_size_i, int uncertainty_size_j, float cut_off,
