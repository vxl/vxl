...
bool boxm2_volm_wr3db_index_params::query_params_equal(boxm2_volm_wr3db_index_params& p1,
                                                       boxm2_volm_wr3db_index_params& p2)
{
...
boxm2_volm_wr3db_index::boxm2_volm_wr3db_index(unsigned layer_size, float buffer_capacity) :
  layer_size_(layer_size), buffer_size_(0), current_id_(0), current_global_id_(0), m_(NOT_INITIALIZED), file_name_(""),
  active_buffer_(0)
{
...
bool boxm2_volm_wr3db_index::add_to_index(vcl_vector<uchar>& values)
{
  ...
  if( values.size() != layer_size_ )
    ...
    vcl_cout
      <<
    "In boxm2_volm_wr3db_index::add_to_index() -- size of value array is not consistent with layer size of this index object!\n";
    return false;
    }
