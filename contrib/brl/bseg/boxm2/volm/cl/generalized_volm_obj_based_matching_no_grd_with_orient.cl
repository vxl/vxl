...
__kernel void generalized_volm_obj_based_matching_no_grd_with_orient(__global unsigned*                 n_cam,         // query -- number of cameras (single unsigned)
                                                                     ...
                                                                     __local float*      local_depth_interval)         // depth_interval on local memory
{
  ...
  if ( cam_id < ln_cam && ind_id < ln_ind ) {
    ...
    score[score_id] = score_sky + score_obj;
