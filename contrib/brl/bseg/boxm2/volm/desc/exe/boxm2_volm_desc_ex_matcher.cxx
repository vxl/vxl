...
{
  // query input
  vul_arg<vcl_string> depth_scene("-dms", "depth map scene file", "Z:/projects/FINDER/P-1B/P1b_Test1/p1b_test1_001/p1b_test1_001.vsl");
  // index and geolocation
  vul_arg<unsigned> world_id("-world", "world id to specify the ROI region", 2);
  vul_arg<unsigned> tile_id("-tile", "tile id to specify which tile are being matched", 1);
  vul_arg<vcl_string> geo_hypo_folder("-geo", "folder where the geolocation for this tile is stored", "Z:/projects/FINDER/P-1B/hypo_gts/geoindex_wr2_only_gt/");
  vul_arg<vcl_string> desc_index_folder("-index", "directory that contains the created wr3db indices", "z:/projects/FINDER/P-1B/index_2d/wr2/");
  vul_arg<vcl_string> out_folder("-out", "output folder for the query image", "D:/work/find/2d_ex_matcher/phase1_b/radius_10_20_50_100_200_500/p1b_test1_001/p1b_test1_001-2DexistenceRUN/");
  ...
  vul_arg<bool> is_ex_2d("-ex2d", "option to execute 2D existance matcher", true);
  // post processing related
  vul_arg<vcl_string> gt_file("-gt", "ground truth files", "z:/projects/FINDER/P-1B/P1b_Test1/p1b_test1_gt_locs.txt");
  ...
  vul_arg<unsigned> id("-imgid", "query image id", 1);
  ...
  if (id() < 10)
    ...
    image_name << "p1b_test" << test_id() << id();
