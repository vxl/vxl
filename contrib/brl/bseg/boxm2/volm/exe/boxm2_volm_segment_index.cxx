...
int main(int argc, char** argv)
{
    ...
    //while(leaf_id <  leaves.size())
    {
        ...
        vcl_cout<<index_depth_file<<vcl_endl;
        vcl_cout<<index_orient_file<<vcl_endl;

        vcl_cout<<"Out: "<<outconfig<<vcl_endl;
        vcl_cout<<"Out data: "<<outdata<<vcl_endl;
   ...
   vcl_ofstream os("e:/data/Finder/matcher.wrl");
    ...
    volm_vrml_io::display_spherical_region_layer_by_attrbute(os,region_index.index_regions(),spherical_region_attributes::NLCD,1.05,0.01);
    volm_vrml_io::display_spherical_region_layer_by_attrbute(os,region_index.index_regions(),spherical_region_attributes::SKY,1.05,0.01);
