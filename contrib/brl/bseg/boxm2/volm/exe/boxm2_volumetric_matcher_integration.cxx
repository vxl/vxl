...
int main(int argc, char** argv)
{
  ...
  vul_arg<int>        use_ps0("-ps0", "choose to use pass 0 regional matcher", 1);
  vul_arg<int>        use_ps1("-ps1", "choose to use pass 1 obj_based order matcher", 1);
  vul_arg<int>        use_ps2("-ps2", "choose to use pass 2 obj_based orient matcher", 1);
