...
int main(int argc, char* * argv)
{
  ...
  // load the volm_query
  vcl_cout << " sph_shell , point angle = " << sph_shell->point_angle() << " top_angle = " << sph_shell->top_angle()
           << vcl_endl;
  ...
  vcl_cout << "\n==================================================================================================\n"
           << "\t\t  5. Generate output of pass 1 matcher for zone " << zone_id() << " and tile " << tile_id()
           << ", store it in\n"
           << "\t\t     " << out_folder() << '\n'
           << "==================================================================================================\n"
           << vcl_endl;
