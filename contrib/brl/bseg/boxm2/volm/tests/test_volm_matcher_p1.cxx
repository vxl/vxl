...
static void test_volm_matcher_p1()
{
  ...
  // add a sky object
  vsol_point_2d_sptr
    ps0 = new vsol_point_2d(0.0, 200.0);   vsol_point_2d_sptr ps1 = new vsol_point_2d(1280.0, 200.0);
  vsol_point_2d_sptr
    ps2 = new vsol_point_2d(1280.0, 0.0);  vsol_point_2d_sptr ps3 = new vsol_point_2d(0.0, 0.0);
  vcl_vector<vsol_point_2d_sptr>
  verts_sky;
  verts_sky.push_back(ps0);  verts_sky.push_back(ps1);  verts_sky.push_back(ps2);  verts_sky.push_back(ps3);
  vsol_polygon_2d_sptr sp = new vsol_polygon_2d(verts_sky);
  depth_scene->add_sky(sp, 255, "sky");
  // add an object
  vsol_point_2d_sptr pb0 = new vsol_point_2d(0.000, 720.0);  vsol_point_2d_sptr pb1 = new vsol_point_2d(
      425.0, 500.0);
  vsol_point_2d_sptr pb2 = new vsol_point_2d(420.0, 200.0);  vsol_point_2d_sptr pb3 = new vsol_point_2d(
      0.000, 200.0);
