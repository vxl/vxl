                                                 ...
                                                 bocl_mem_sptr& cl_output )
{
  ...
  bocl_mem_sptr blk_copy = ocl_cache->alloc_mem(numTrees * sizeof(cl_uchar16), new cl_uchar16[numTrees],
  ...
  bocl_mem_sptr tree_sizes = ocl_cache->alloc_mem(sizeof(cl_int) * numTrees, new cl_int[numTrees],
