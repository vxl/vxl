                                 ...
                                 vpgl_camera_double_sptr  cam)
{
  ...
  for( unsigned int i = 0; i < ocl_caches.size(); ++i )
    ...
    bocl_mem_sptr cl_output =
      new bocl_mem(device->context(), output_arr, sizeof(float) * cl_ni * cl_nj, "output buffer");
  ...
  boxm2_multi_update_helper helper(queues, ray_os, ray_ds, img_dims, tnearfarptrs, lookups, outputs, grp, vis_orders,
                                   ocl_caches, maxBlocks);
