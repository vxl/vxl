                    ...
                    boxm2_scene & new_scene)
{
  ...
  while( !iter.end() )
    ...
    boxm2_data<BOXM2_NORMAL> * normals_data =
      new boxm2_data<BOXM2_NORMAL>(b1, data_size * sizeof(boxm2_data_traits<BOXM2_NORMAL>::datatype), block_id);
    char*                     b2 = reinterpret_cast<char *>(pointa_arr);
    boxm2_data<BOXM2_POINT> * points_data =
      new boxm2_data<BOXM2_POINT>(b2, data_size * sizeof(boxm2_data_traits<BOXM2_POINT>::datatype), block_id);
    char*                     b3 = reinterpret_cast<char *>(alpha_arr);
    boxm2_data<BOXM2_ALPHA> * alpha_data =
      new boxm2_data<BOXM2_ALPHA>(b3, data_size * sizeof(boxm2_data_traits<BOXM2_ALPHA>::datatype), block_id);
