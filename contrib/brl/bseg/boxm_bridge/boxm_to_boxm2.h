...
void deconstruct_sample(boxm_sample<BOXM_APM_MOG_GREY> sample, float & alpha,
...
void convert_data(boct_tree_cell<T_loc, T_data>* tree_cell, float* alpha,
                  boxm2_data_traits<BOXM2_MOG3_GREY>::datatype* data,
                  boxm2_data_traits<BOXM2_NUM_OBS>::datatype* num_obs, int& data_idx);
