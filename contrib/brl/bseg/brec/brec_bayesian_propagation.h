...
{
public:
  brec_bayesian_propagation(vil_image_view<vxl_byte>& inp, vil_image_view<float>& prob_density) : img_view_(inp),
    prob_density_(prob_density) { convert_img(); }
  ...
  bool directional_pass(brec_fg_pair_density& fgp, brec_fg_bg_pair_density& fgbgp, brec_bg_pair_density& bgp, int ii,
                        int jj);
  ...
  bool directional_pass_using_prob_density_as_bgp(brec_fg_pair_density& fgp, brec_fg_bg_pair_density& fgbgp, int ii,
                                                  int jj);

  bool pass_using_prob_density_as_bgp(brec_fg_pair_density& fgp, brec_fg_bg_pair_density& fgbgp,
...
{
public:
  brec_area_density(float lambda1, float k1, float lambda2, float k2) : back_model_(lambda1, k1), fore_model_(lambda2,
                                                                                                              k2)  {}
