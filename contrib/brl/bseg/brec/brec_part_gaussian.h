...
public:
  ...
  brec_part_gaussian(float x, float y, float strength, float lambda0, float lambda1, float theta, bool bright,
                     unsigned type);
  ...
  bool construct_bg_response_model(vil_image_view<float>& mean_img, vil_image_view<float>& std_dev_img,
                                   vil_image_view<float> & lambda_img, vil_image_view<float> & k_img);

  bool construct_bg_response_model_gauss(vil_image_view<float>& mean_img, vil_image_view<float>& std_dev_img,
                                         vil_image_view<float> & mu_img, vil_image_view<float> & sigma_img);
  ...
  bool construct_class_response_models(vil_image_view<float>& img, vil_image_view<float>& class_prob_img,
                                       vil_image_view<bool>& mask_img, double & lambda, double & k,
                                       double & lambda_non_class, double & k_non_class);
  ...
  virtual bool update_response_hist(vil_image_view<float>& img, vil_image_view<float>& fg_prob_img,
                                    vil_image_view<bool>& mask_img, bsta_histogram<float>& fg_h);
  ...
  virtual bool update_foreground_posterior(vil_image_view<float>& inp, vil_image_view<float>& fg_prob_img,
  ...
  bool extract(vil_image_view<float>& img, vil_image_view<float>& fg_prob_img, float rot_angle, vcl_string model_dir,
               vcl_vector<brec_part_instance_sptr>& instances, float prior_class);
  ...
  bool extract(vil_image_view<float>& img, vil_image_view<float>& class_prob_image, float rot_angle,
