// This is brl/bseg/brec/pro/brec_glitch_process.cxx
...
//: Constructor
brec_glitch_process::brec_glitch_process()
{
  //input
...
//: Execute the process
bool
brec_glitch_process::execute()
{
  // Sanity check
  if (!this->verify_inputs()){
    vcl_cerr << "In brec_glitch_process::execute() -"
             << " invalid inputs\n";
    return false;
  }
