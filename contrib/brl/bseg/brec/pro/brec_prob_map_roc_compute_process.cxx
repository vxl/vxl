// This is brl/bseg/brec/pro/brec_prob_map_roc_compute_process.cxx
...
//: Constructor
brec_prob_map_roc_compute_process::brec_prob_map_roc_compute_process()
{
  //input
...
//: Execute the process
bool
brec_prob_map_roc_compute_process::execute()
{
  // Sanity check
  if (!this->verify_inputs()){
    vcl_cerr << "In brec_prob_map_roc_compute_process::execute() -"
             << " invalid inputs\n";
    return false;
  }
  ...
  brdb_value_sptr output0 = new brdb_value_t<float>((float)pa[best_id]);
