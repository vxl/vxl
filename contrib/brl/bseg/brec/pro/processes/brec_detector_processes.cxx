...
bool brec_detect_hierarchy_process(bprb_func_process& pro)
{
  ...
  if( inp_prob_map->pixel_format() == VIL_PIXEL_FORMAT_BOOL )
    ...
    vcl_cout << "checking proper conversion of bool to float: min val in the image: " << min << " max: " << max
             << vcl_endl;
    }
  ...
  brec_part_hierarchy::generate_output_map_posterior(parts_upper_most, output_map_float,
  ...
  brec_part_hierarchy::generate_output_img(parts_upper_most, orig_img, output_img1,
                                           brec_posterior_types::CLASS_FOREGROUND);
  ...
  brec_part_hierarchy::generate_output_img(parts_upper_most, orig_img, output_img2,
                                           brec_posterior_types::CLASS_BACKGROUND);
  ...
  brec_part_hierarchy::generate_output_img(parts_upper_most, orig_img, output_img3,
                                           brec_posterior_types::NON_CLASS_FOREGROUND);
  ...
  brec_part_hierarchy::generate_output_img(parts_upper_most, orig_img, output_img4,
                                           brec_posterior_types::NON_CLASS_BACKGROUND);
