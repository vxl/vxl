...
static void test_brec_parts()
{
  ...
  vcl_vector<brec_part_instance_sptr> parts_0_0;
  TEST("testing brec parts ",
       extract_gaussian_primitives(img, lambda0, lambda1, theta, bright, 0.01f, 0.1f, 0, parts_0_0), true);
  ...
  theta = 90.0f;
  vcl_vector<brec_part_instance_sptr> parts_0_1;
  TEST("testing brec parts ",
       extract_gaussian_primitives(img, lambda0, lambda1, theta, bright, 0.01f, 0.1f, 1, parts_0_1), true);
  ...
  theta = 45.0f;
  TEST("testing brec parts ", extract_gaussian_primitives(img, lambda0, lambda1, theta, bright, 0.01f, 0.1f, 2,
                                                          parts), true);

  theta = 135.0f;
  TEST("testing brec parts ", extract_gaussian_primitives(img, lambda0, lambda1, theta, bright, 0.01f, 0.1f, 3,
                                                          parts), true);
  ...
  vcl_cout << "p_1_0 edge to second part training d1: " << d1 << " angle: " << a1 * vnl_math::deg_per_rad
           << " degrees\n"
           << "p_1_0 edge to second part training d2: " << d2 << " angle: " << a2 * vnl_math::deg_per_rad
           << " degrees\n";
  ...
  vcl_cout << "p_2_0 edge to second part training d: " << d1 << " angle: " << a1 * vnl_math::deg_per_rad
           << " degrees\n";
