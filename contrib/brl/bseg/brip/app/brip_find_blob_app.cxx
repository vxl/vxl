...
int main(int argc, char * argv[])
{
  ...
  lambda0 = (float)std::stod(argv[4]);      // determines length of object being searched for
  lambda1 = (float)std::stod(argv[5]);      // determines width of object being searched for
  neighborhood_radius = (int)std::stoi(argv[6]); // radius of neighbor to search for local maxima in
