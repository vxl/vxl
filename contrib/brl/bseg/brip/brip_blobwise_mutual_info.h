...
template <class T>
void brip_blobwise_mutual_info( const vil_image_view<T>& img1, const vil_image_view<T>& img2,
                                const vil_image_view<T>& weights, const vil_image_view<bool>& mask,
                                vil_image_view<T>& mi_img );

template <class T>
void brip_blobwise_kl_div( const vil_image_view<T>& img1, const vil_image_view<T>& img2,
                           const vil_image_view<bool>& mask, vil_image_view<T>& mi_img );

// : calculates the kl divergeance D_kl ( P || Q );
inline
double brip_hist_kl_div(const vcl_vector<double>& P, double magP,
