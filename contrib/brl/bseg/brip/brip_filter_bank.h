...
public:
  ...
  brip_filter_bank(unsigned n_levels, double scale_range, float lambda0, float lambda1, float theta_interval,
                   float cuttoff_ratio);

  brip_filter_bank(unsigned n_levels, double scale_range, float lambda0, float lambda1, float theta_interval,
                   float cuttoff_ratio, vil_image_view<float> const& image);
  ...
  void set_params(unsigned n_levels, double scale_range, float lambda0, float lambda1, float theta_interval,
                  float cuttoff_ratio);
