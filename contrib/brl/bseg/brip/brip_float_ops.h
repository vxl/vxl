...
class brip_float_ops
{
 public:
  ...
  static vil_memory_image_of<unsigned short>
    convert_to_short(vil_memory_image_of<float> const & image,
                     const float min_val, const float max_val);

  //: converts a vil_image to a float image
  static vil_memory_image_of<float>
    convert_to_float(vil_image const & image);
  ...
  //: converts an RGB image to a float image
  static vil_memory_image_of<float>
    convert_to_float(vil_memory_image_of<vil_rgb<unsigned char> > const& image);
