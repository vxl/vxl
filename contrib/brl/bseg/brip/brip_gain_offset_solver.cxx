...
brip_gain_offset_solver(vil_image_view<float> const& model_image,
  ...
  gain_(1.0f), offset_(0.0f), model_image_(model_image), 
  test_image_(test_image), t_mask_(false), m_mask_(false), n_valid_pix_(0)
{
  ni_ = model_image.ni();
  nj_ = model_image.nj();
}
...
brip_gain_offset_solver(vil_image_view<float> const& model_image,
  ...
  gain_(1.0f), offset_(0.0f), model_image_(model_image), 
  test_image_(test_image), model_mask_(model_mask), test_mask_(test_mask),
