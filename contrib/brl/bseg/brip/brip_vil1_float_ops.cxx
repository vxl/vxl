...
vil1_memory_image_of<vil1_rgb<unsigned char> > brip_vil1_float_ops::half_resolution(
  vil1_memory_image_of<vil1_rgb<unsigned char> > const & input,
  float filter_coef)
{
...
//
bool brip_vil1_float_ops::local_maximum(vbl_array_2d<float> const & neighborhood,
                                        int n, float& value)
{
  bool local_max = true;
