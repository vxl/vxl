                                         ...
                                         vil_image_resource_sptr const& B)
{
  ...
  vil_image_view<unsigned char> cR = brip_vil_float_ops::convert_to_byte(fR);
                            ...
                            bool bright, bool output_response_mask)
{
  ...
  brip_1d_gaussian_kernel(s1, 0.02, ra1, ker1);
  int r0 = ra0, r1 = ra1;
  unsigned nrows = 2*ra1+1, ncols = 2*ra0+1;
...
//define the size of the rotated 2-d operator
  ...
  unsigned nrows_rot = 2*rj+1, ncols_rot = 2*ri+1;
  //compute rotated operator
  vbl_array_2d<double> rot_coef(nrows_rot ,ncols_rot);
