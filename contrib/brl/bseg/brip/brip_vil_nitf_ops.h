...
public:
  ...
  static bool truncate_nitf_bits(vil_nitf2_image const& nitf, vil_image_view<unsigned char>& output);
  ...
  static bool truncate_nitf_bits(vil_nitf2_image const& nitf, vil_image_view<vxl_uint_16>& output);
