...
{
  os << "brip_watershed_params:" << vcl_endl << "[---" << vcl_endl;
  os << "sigma " << wp.sigma_ << vcl_endl;
  os << "thresh " << wp.thresh_ << vcl_endl;
  os << "eight connected? " << wp.eight_connected_ << vcl_endl;
  os << "verbose " << wp.verbose_ << vcl_endl;
  os << "---]" << vcl_endl;
  return os;
}
