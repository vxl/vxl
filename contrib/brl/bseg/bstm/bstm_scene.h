...
public:
  ...
  vcl_vector<bstm_block_id> get_vis_order_from_pt(vgl_point_3d<double> const& pt,
  ...
  bool contains(vgl_point_3d<double> const& p, bstm_block_id& bid, vgl_point_3d<double>& local_coords, double const t,
