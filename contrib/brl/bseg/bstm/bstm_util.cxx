                                  ...
                                  float& prob, vnl_vector_fixed<unsigned char, 3>& rgb)
{
  ...
  vnl_vector_fixed<unsigned char, 8> time_treebits = time_blk->get_cell_tt(data_offset, local_t);
  ...
  vnl_vector_fixed<unsigned char,
                   8> color = ( (vnl_vector_fixed<unsigned char, 8> *)int_base->data_buffer() )[data_offset_t];
...
vnl_vector_fixed<float, 3>  bstm_util::expected_color( vnl_vector_fixed<unsigned char, 8> mog)
{
...
bool bstm_util::verify_appearance(bstm_scene& scene, const vcl_vector<vcl_string>& valid_types, vcl_string& data_type,
                                  int& appTypeSize )
{
  bool foundDataType = false;
...
vil_image_view_base_sptr bstm_util::prepare_input_image(vil_image_view_base_sptr loaded_image, bool force_grey)
{
