...
bstm_majority_filter::bstm_majority_filter(bstm_block_metadata data, bstm_block* blk, bstm_time_block* blk_t,
                                           bstm_data_base* changes)
{
  ...
  bstm_data_traits<BSTM_CHANGE>::datatype* new_change_data =
    (bstm_data_traits<BSTM_CHANGE>::datatype *)new_change->data_buffer();
  bstm_data_traits<BSTM_CHANGE>::datatype * change_data =
    (bstm_data_traits<BSTM_CHANGE>::datatype *)changes->data_buffer();
...
bstm_majority_filter::neighbor_points( vgl_point_3d<double>& cellCenter, double side_len,
                                       boxm2_array_3d<uchar16>& trees )
{
