...
private:
  ...
  void move_data(bstm_time_tree old_tree, bstm_time_tree merged_tree,  int depth,
...
////////////////////////////////////////////////////////////////////////////////
void bstm_merge_tt_blk( bstm_time_block* t_blk, bstm_block* blk, vcl_vector<bstm_data_base *> & datas,
                        float prob_thresh);
