...
public:
  ...
  // : "default" constructor
  bstm_refine_blk_in_space_function(bstm_time_block* t_blk, bstm_block* blk, vcl_vector<bstm_data_base *> & datas,
                                    float change_prob_t);
...
private:
  ...
  void move_data(bstm_time_tree& old_time_tree, bstm_time_tree& time_tree,
