...
bstm_refine_blk_in_space_function<APM_DATA_TYPE, NOBS_DATA_TYPE>::bstm_refine_blk_in_space_function(
  bstm_time_block* t_blk, bstm_block* blk, vcl_vector<bstm_data_base *> & datas, float change_prob_t)
{
...
template <bstm_data_type APM_DATA_TYPE, bstm_data_type NOBS_DATA_TYPE>
bool bstm_refine_blk_in_space_function<APM_DATA_TYPE, NOBS_DATA_TYPE>::init_data(bstm_time_block* blk_t,
                                                                                 bstm_block* blk,
...
bool bstm_refine_blk_in_space_function<APM_DATA_TYPE, NOBS_DATA_TYPE>::refine(vcl_vector<bstm_data_base *>& datas)
{
  ...
  bstm_data_base* newC =
    new bstm_data_base(new char[dataSize * bstm_data_traits < BSTM_CHANGE > ::datasize()],
                       dataSize * bstm_data_traits<BSTM_CHANGE>::datasize(), id);
  ...
  typename bstm_data_traits<APM_DATA_TYPE>::datatype
  *  mog_cpy = (typename bstm_data_traits<APM_DATA_TYPE>::datatype *)newM->data_buffer();
  typename bstm_data_traits<NOBS_DATA_TYPE>::datatype
  *  numobs_cpy = (typename bstm_data_traits<NOBS_DATA_TYPE>::datatype *)newN->data_buffer();
...
template <bstm_data_type APM_DATA_TYPE, bstm_data_type NOBS_DATA_TYPE>
void bstm_refine_blk_in_space_function<APM_DATA_TYPE, NOBS_DATA_TYPE>::move_data(bstm_time_tree& old_time_tree,
...
template <bstm_data_type APM_DATA_TYPE, bstm_data_type NOBS_DATA_TYPE>
int bstm_refine_blk_in_space_function<APM_DATA_TYPE, NOBS_DATA_TYPE>::move_time_trees(boct_bit_tree& unrefined_tree,
                                                                                      boct_bit_tree& refined_tree,
                                                                                      bstm_time_block* newTimeBlk,
                                                                                      bstm_data_traits<BSTM_CHANGE>::datatype *  newC )
{
  int newSize = refined_tree.num_cells();
...
template <bstm_data_type APM_DATA_TYPE, bstm_data_type NOBS_DATA_TYPE>
boct_bit_tree bstm_refine_blk_in_space_function<APM_DATA_TYPE, NOBS_DATA_TYPE>::refine_bit_tree(
  const boct_bit_tree& unrefined_tree)
{
