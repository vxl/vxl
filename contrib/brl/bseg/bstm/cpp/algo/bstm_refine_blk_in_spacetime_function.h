...
private:
  ...
  void move_data(bstm_time_tree& unrefined_time_tree, bstm_time_tree& refined_time_tree,
                 ...
                 bstm_data_traits<BSTM_NUM_OBS_VIEW_COMPACT>::datatype * numobs_cpy, int depth);
...
////////////////////////////////////////////////////////////////////////////////
void bstm_refine_block_spacetime( bstm_time_block* t_blk, bstm_block* blk, vcl_vector<bstm_data_base *> & datas,
                                  float prob_thresh);
