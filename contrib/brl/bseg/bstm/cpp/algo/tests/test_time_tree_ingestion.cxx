...
void test_time_tree_ingestion()
{
  ...
  for(int i = 0; i < DATA_LEN; tree_data[i] = '0', i++);
  ...
  for(int i = 0; i < leaf_bits.size(); i++)
    vcl_cout << "Data at leaf " << leaf_bits[i] << " is " << tree_data[tree.get_relative_index(leaf_bits[i])] << vcl_endl;



  bool good = true;
  good = good && (tree.bit_at(0)  == 1);
  good = good && (tree.bit_at(1)  == 1);
  good = good && (tree.bit_at(2)  == 1);
  good = good && (tree.bit_at(3)  == 1);
  good = good && (tree.bit_at(4)  == 1);
  good = good && (tree.bit_at(5)  == 1);
  good = good && (tree.bit_at(7)  == 1);
  good = good && (tree.bit_at(8)  == 1);
  good = good && (tree.bit_at(9)  == 0);
  good = good && (tree.bit_at(10)  == 1);
  good = good && (tree.bit_at(11)  == 1);
  good = good && (tree.bit_at(12)  == 1);
  good = good && (tree.bit_at(15)  == 0);
  good = good && (tree.bit_at(16)  == 1);
  good = good && (tree.bit_at(17)  == 0);
  good = good && (tree.bit_at(18)  == 1);
  good = good && (tree.bit_at(21)  == 1);
  good = good && (tree.bit_at(22)  == 1);
  good = good && (tree.bit_at(23)  == 0);
  good = good && (tree.bit_at(24)  == 1);
  good = good && (tree.bit_at(25)  == 1);
  good = good && (tree.bit_at(26)  == 1);
