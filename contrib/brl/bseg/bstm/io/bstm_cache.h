...
public:
  ...
  static bool         exists() { return bstm_cache::instance_ != 0; }
  ...
  virtual bstm_data_base * get_data_base(bstm_block_id id, vcl_string type, vcl_size_t num_bytes = 0,
  ...
  virtual bstm_data_base * get_data_base_new(bstm_block_id id, vcl_string type = 0, vcl_size_t num_bytes = 0,
                                             bool read_only = true) = 0;
...
{
public:
  bstm_cache_destroyer(bstm_cache_sptr s = 0);
