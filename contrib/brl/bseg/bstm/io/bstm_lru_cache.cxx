...
void bstm_lru_cache::clear_cache()
{
  ...
  cached_data_.clear();
  for( vcl_map<bstm_block_id, bstm_block *>::iterator iter = cached_blocks_.begin(); iter != cached_blocks_.end();
       iter++ )
    {
    delete iter->second;
    }
...
bstm_data_base * bstm_lru_cache::get_data_base_new(bstm_block_id id, vcl_string type, vcl_size_t num_bytes,
                                                   bool read_only)
{
