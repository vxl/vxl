...
public:
  static bool change_detect(vil_image_view<float>&    change_img, bocl_device_sptr          device,
                            bstm_scene_sptr          scene, bstm_opencl_cache_sptr   opencl_cache,
                            vpgl_camera_double_sptr   cam, vil_image_view_base_sptr  img,
                            vil_image_view_base_sptr  mask_img, vcl_string                norm_type,
                            float                     time);
...
{
public:
  static bool update_change( vil_image_view<float>&    change_img, bocl_device_sptr          device,
                             bstm_scene_sptr          scene, bstm_opencl_cache_sptr   opencl_cache,
                             vpgl_camera_double_sptr   cam, vil_image_view_base_sptr  img,
                             vil_image_view_base_sptr  mask_img, float                     time );
