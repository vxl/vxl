                              ...
                              bool render_label)
{
  ...
  for( id = vis_order.begin(); id != vis_order.end(); ++id )
    ...
    bocl_mem* mog       =
      opencl_cache->get_data(*id, data_type, alpha->num_bytes() / alphaTypeSize * apptypesize, false);
    ...
    if( render_label )
      {
      label =
        opencl_cache->get_data(*id, label_data_type, alpha->num_bytes() / alphaTypeSize * label_apptypesize, true);
      }
