...
void bstm_util_cams_and_box_to_scene(vcl_vector<CamType>& cams, vgl_box_3d<double>   bbox, bstm_scene&         uscene,
                                     unsigned time_steps = 32, int nblks = 5);
...
bool bstm_util_has_percent_views(int i, int j, double percent, vgl_vector_3d<unsigned> pixPerBlock,
                                 vil_image_view<vxl_byte>& cntimg, int num_views);
