...
bool bstm_cam_tableau::handle(vgui_event const & e)
{
  ...
  if( e.type == vgui_KEY_PRESS )
    ...
    if( e.key == vgui_key('r') )
      ...
      stare_point_ = default_stare_point_;  // vgl_homg_point_3d<double>(0,0,0);
      cam_.set_camera_center(vgl_point_3d<double>(stare_point_.x(), default_cam_.camera_center().y(),
                                                  stare_point_.z() ) );
      ...
      stare_point_ = default_stare_point_;  // vgl_homg_point_3d<double>(0,0,0);
      cam_.set_camera_center(vgl_point_3d<double>(default_cam_.camera_center().x(), stare_point_.y(),
                                                  stare_point_.z() ) );
      cam_.look_at(stare_point_);
      }
      ...
      stare_point_ = default_stare_point_;  // vgl_homg_point_3d<double>(0,0,0);
      cam_.set_camera_center(vgl_point_3d<double>(stare_point_.x(), stare_point_.y(),
                                                  default_cam_.camera_center().z() ) );
      cam_.look_at(stare_point_);
      }
    this->post_redraw();
    }
