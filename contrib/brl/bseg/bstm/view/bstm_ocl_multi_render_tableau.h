...
public:
  ...
  bool init(vcl_vector<bocl_device_sptr> devices, vcl_vector<bstm_opencl_cache_sptr> opencl_caches,
            bstm_scene_sptr scene, unsigned ni, unsigned nj, vpgl_perspective_camera<double>* cam,
