...
public:
  ...
  bool init(bocl_device_sptr device, bstm_opencl_cache_sptr opencl_cache, bstm_scene_sptr scene, unsigned ni,
            unsigned nj, vpgl_perspective_camera<double>* cam, vgui_slider_tableau_sptr slider);
