...
#include <bstm_multi/io/space_time_cache.h>
...
typedef vbl_smart_ptr<space_time_scene<bstm_multi_block> >
    bstm_multi_scene_sptr;
typedef vbl_smart_ptr<space_time_cache<bstm_multi_block> >
