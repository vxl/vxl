#ifndef bvpgl_camera_estimator_txx_
                                                        ...
                                                        vpgl_perspective_camera<double> *cam)
{
  ...
  for (int iter=0; iter<max_iter_rot_angle_; iter++) {
    ...
    double vx,vy,vz;
    bvpgl_camera_estimator<exp_edge_func>::convert_angles_to_vector(theta,phi,vx,vy,vz);
...
#undef BVPGL_CAMERA_ESTIMATOR_INSTANTIATE
#define BVPGL_CAMERA_ESTIMATOR_INSTANTIATE(T) \
template class bvpgl_camera_estimator<T >
