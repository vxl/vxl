...
public:
  ...
  void suppress_and_combine(bvxm_voxel_grid<T>* grid_in,  bvpl_kernel_vector_sptr kernel_vector, bvpl_neighb_operator<T,
                                                                                                                      F>* oper, bvxm_voxel_grid<vnl_vector_fixed<float, 3> >* out_grid,
  ...
  void suppress_and_combine(bvxm_voxel_grid<float>* ocp_grid, bvxm_voxel_grid<bsta_num_obs<bsta_gauss_sf1> >* app_grid,
                            bvpl_kernel_vector_sptr kernel_vector, bvpl_combined_neighb_operator<OCP_FUNC,
                                                                                                 APP_FUNC>* oper,
  ...
  template <class T>
  void local_non_maxima_suppression(bvxm_voxel_grid<T>* grid_in, bvpl_kernel_sptr kernel);
  ...
  void  keep_top_responses(bvxm_voxel_grid<vnl_vector_fixed<float, n_responses> >* top_resp_grid,
                           bvxm_voxel_grid<float>* grid_in, bvxm_voxel_grid<vnl_vector_fixed<int,
                                                                                             n_responses> >* id_grid,
                           int this_id);
  ...
  void  keep_top_responses(bvxm_voxel_grid<vnl_vector_fixed<float, n_responses> >* top_resp_grid,
                           ...
                           bvxm_voxel_grid<vnl_vector_fixed<int, n_responses> >* id_grid, int this_id);
...
void bvpl_discriminative_non_max_suppression::suppress_and_combine(bvxm_voxel_grid<T>* grid_in,
                                                                   ...
                                                                   bvxm_voxel_grid<vnl_vector_fixed<float,
                                                                                                    3> >* out_grid,
                                                                   bvxm_voxel_grid<vnl_vector_fixed<int, 3> >* id_grid)
{
...
template <unsigned n_responses>
void  bvpl_discriminative_non_max_suppression::keep_top_responses(bvxm_voxel_grid<vnl_vector_fixed<float,
                                                                                                   n_responses> >* top_resp_grid,
                                                                  bvxm_voxel_grid<float>* grid_in,
                                                                  bvxm_voxel_grid<vnl_vector_fixed<int,
                                                                                                   n_responses> >* id_grid,
                                                                  int this_id)
{
