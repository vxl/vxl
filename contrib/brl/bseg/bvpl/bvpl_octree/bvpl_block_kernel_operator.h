...
public:
  ...
  void operate(boxm_scene<boct_tree<short, T_data> > & scene_in, F functor, bvpl_kernel_sptr kernel, unsigned i,
               unsigned j, unsigned k, boxm_scene<boct_tree<short, T_data> > & scene_out, boxm_scene<boct_tree<short,
                                                                                                               bool> > & valid_scene,
               double cell_length);
