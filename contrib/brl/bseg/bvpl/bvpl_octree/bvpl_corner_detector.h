// This is bvpl_harris_detector.h
#ifndef bvpl_corner_detector_h
#define bvpl_corner_detector_h

//:
// \file
// \brief A class to detect 3d harris cornes, based on the 2nd moment matrix 
...
public:
  ...
  //  However, features bellow the harris threshold are set as invalid in the valid_scene (in place)
