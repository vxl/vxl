// This is bvpl_discover_pca_kernels.h
...
public:
  ...
  //: Accces the coefficients
  const vnl_vector<double>& weights() { return weights_; }
  
  //: Accces the mean of samples
  ...
  const unsigned long nsamples() { return nsamples_; }
  
  //: Return dimension of the features
  const unsigned feature_dim() { return feature_dim_; } 
