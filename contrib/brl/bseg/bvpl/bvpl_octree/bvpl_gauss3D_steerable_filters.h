...
public:
  ...
  bool basis_response_at_leaves(boxm_scene<boct_tree<short, vnl_vector_fixed<float,
                                                                             bvpl_gauss3D_steerable_filters::DIM_> > > * scene, boxm_scene<boct_tree<short,
                                                                                                                                                     bool> > * valid_scene,
                                double cell_length);
  ...
  bool multiscale_basis_response(boxm_scene<boct_tree<short, vnl_vector_fixed<float,
                                                                              bvpl_gauss3D_steerable_filters::DIM_> > > * scene, boxm_scene<boct_tree<short,
                                                                                                                                                      bool> > * valid_scene,
  ...
  vcl_vector<vcl_vector<vcl_string> > basis() {return basis_; }
  vcl_vector<vcl_string> basis_names() {return basis_names_; }
  vcl_map<vcl_string, vnl_vector_fixed<float, 5> > separable_taps() {return separable_taps_; }

  bool rotation_invariant_interpolation(boxm_scene<boct_tree<short, vnl_vector_fixed<float,
                                                                                     bvpl_gauss3D_steerable_filters::DIM_> > > * scene, boxm_scene<boct_tree<short,
                                                                                                                                                             bool> > * valid_scene);
...
protected:
  ...
  vcl_vector<vgl_vector_3d<int> > axis_;
};
#endif
