...
public:
  ...
  void compute_laptev_corners(bvpl_global_taylor_sptr global_taylor, int scene_id, int block_i, int block_j,
                              int block_k);
  ...
  void compute_beaudet_corners(bvpl_global_taylor_sptr global_taylor, int scene_id, int block_i, int block_j,
                               int block_k);

  // : Threshold corners below a threshold
  void threshold_laptev_corners(bvpl_global_taylor_sptr global_taylor, int scene_id, float thresh,
