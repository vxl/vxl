...
protected:
  ...
  virtual void combine_kernel_responses(boct_tree<short, bvpl_octree_sample<T_data> >* tree_out, boct_tree<short,
                                                                                                           T_data>* tree_curr,
                                        int id_curr) = 0;
  ...
  void keep_max_response_tree(boct_tree<short, bvpl_octree_sample<T_data> >* tree_out, boct_tree<short,
                                                                                                 T_data>* new_tree,
                              int new_id);
...
template <class T_data>
void bvpl_octree_vector_operator<T_data>::keep_max_response_tree(boct_tree<short,
                                                                           bvpl_octree_sample<T_data> >* tree_out,
