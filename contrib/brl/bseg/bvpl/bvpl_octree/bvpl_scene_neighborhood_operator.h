...
public:
  ...
  void operate(boxm_scene<boct_tree<short, T_data_in> > * scene_in, F functor, vgl_box_3d<double> roi,
  ...
  void operate(boxm_scene<boct_tree<short, T_data_in1> > * scene_in1, boxm_scene<boct_tree<short,
                                                                                           T_data_in2> > * scene_in2,
               F functor, vgl_box_3d<double> roi, boxm_scene<boct_tree<short,
                                                                       T_data_out> > * scene_out);
