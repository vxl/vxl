...
bool bvpl_compute_scene_statistics(boxm_scene<boct_tree<short, vnl_vector_fixed<float, DIM> > > * scene,
                                   bsta_histogram<float> & response_hist )
{
...
bool bvpl_compute_scene_statistics(boxm_scene<boct_tree<T_loc, T_data> >* scene, bsta_histogram<float>& response_hist,
