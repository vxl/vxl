                                     ...
                                     int block_i, int block_j, int block_k, unsigned long tree_nsamples)
{
  ...
  float tree_ncells = error_leaves.size();
...
bool bvpl_taylor_basis::assemble_basis(bvpl_taylor_scenes_map_sptr taylor_scenes,int block_i, int block_j, int block_k)
{
  ...
  vcl_cout << "Caution: Using hardcoded size for taylor reconstruction" << vcl_endl;
  ...
  if(!basis_scene)
  {
    vcl_cerr << "Error in reconstruct: Faild to cast output scene" << vcl_endl;
    return false;
  }
  ...
  {
    vcl_cerr << "Error in assemble_basis: Faild to load taylor scenes" << vcl_endl;
    return false;
  }
