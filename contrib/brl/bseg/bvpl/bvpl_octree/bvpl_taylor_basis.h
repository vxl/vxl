...
public:
  ...
  static bool compute_approximation_error(boxm_scene_base_sptr data_scene_base, boxm_scene_base_sptr basis_scene_base,
                                          boxm_scene_base_sptr error_scene_base, bvpl_taylor_basis_loader loader,
                                          int block_i, int block_j, int block_k, double cell_length);

  // : Sums the square errors for a percenatge of random samples
  static double sum_errors(boxm_scene_base_sptr error_scene_base, int block_i, int block_j, int block_k,
