  ...
  switch( scene_base->appearence_model() )
    ...
    case BSTA_GAUSS_F1:
      ...
      boxm_scene<boct_tree<short, bool> > * valid_scene =
        new boxm_scene<boct_tree<short, bool> >(scene_in->lvcs(), scene_in->origin(),
      ...
      if( functor_name == "gauss_convolution" )
        ...
        // operate on scene
        block_oper.operate(*scene_in, functor, kernel, block_i, block_j, block_k, *scene_out, *valid_scene,
                           cell_length);
        // clean memory
