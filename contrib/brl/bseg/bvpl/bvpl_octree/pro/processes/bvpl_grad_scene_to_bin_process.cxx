...
//        vsl_b_write(os, (float)grad[0]);
//        vsl_b_write(os, (float)grad[1]);
//        vsl_b_write(os, (float)grad[2]);
//        vsl_b_write(os, (float)p_x);
...
//       os << (float)p_x;
        ...
        //if(n_grads <10)
        {
          os << (float)centroid.x() << " " << (float)centroid.y() << " " << centroid.z() << " " << grad[0] << " " << grad[1] << " " << grad[0] << " " << p_x << "\n";
        }
