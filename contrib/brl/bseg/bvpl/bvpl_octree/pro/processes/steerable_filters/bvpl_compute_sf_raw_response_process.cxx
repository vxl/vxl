...
bool bvpl_compute_sf_raw_response_process(bprb_func_process& pro)
{
  ...
  if( boxm_scene<response_tree_type> * scene_in =
        dynamic_cast<boxm_scene<response_tree_type> *>(scene_base.as_pointer() ) )
    {
    double cell_length = scene_in->finest_cell_length();

    if( boxm_scene<valid_tree_type> * valid_scene =
          dynamic_cast<boxm_scene<valid_tree_type> *>(valid_scene_base.as_pointer() ) )
      {
