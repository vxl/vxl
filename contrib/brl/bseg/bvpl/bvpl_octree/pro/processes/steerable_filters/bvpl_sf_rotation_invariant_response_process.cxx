...
//: global variables
namespace bvpl_rotation_invariant_response_process_globals
{
...
bool bvpl_rotation_invariant_response_process_cons(bprb_func_process& pro)
{
  using namespace bvpl_rotation_invariant_response_process_globals ;
...
//: the process
bool bvpl_rotation_invariant_response_process(bprb_func_process& pro)
{
  using namespace bvpl_rotation_invariant_response_process_globals;
