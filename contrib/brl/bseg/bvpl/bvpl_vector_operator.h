...
public:
  ...
  void apply_and_suppress(bvxm_voxel_grid<T>* grid, bvpl_kernel_vector_sptr kernel_vector, bvpl_neighb_operator<T,
                                                                                                                F>* oper, bvxm_voxel_grid<T>* out_grid,
  ...
  template <class T>
  void filter_response(bvxm_voxel_grid<T>* grid_in, bvxm_voxel_grid<int>* id_grid, int targed_id,
  ...
  void get_response(bvxm_voxel_grid<vnl_vector_fixed<float, n_responses> >* resp_grid,
                    bvxm_voxel_grid<vnl_vector_fixed<int, n_responses> >* id_grid, unsigned idx,
  ...
  void get_max_orientation_grid(bvxm_voxel_grid<T>* out_grid, bvxm_voxel_grid<T>* temp_grid,
                                bvxm_voxel_grid<int>* id_grid, int temp_orientation);
