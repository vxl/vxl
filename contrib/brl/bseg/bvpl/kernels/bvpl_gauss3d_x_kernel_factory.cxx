...
bvpl_gauss3d_x_kernel_factory::bvpl_gauss3d_x_kernel_factory(float s1, float s2, float s3, float supp1, float supp2,
                                                             float supp3)
{
  // set variances of kernel
  sigma1_ = s1;
...
{
  bsta_gauss_if3 gauss_kernel(vnl_float_3(0, 0, 0),
                              vnl_float_3(sigma1_ * sigma1_, sigma2_ * sigma2_, sigma3_ * sigma3_) );
