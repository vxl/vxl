...
{
public:
  bvpl_taylor_basis_loader() : path_(""), min_point_(vgl_point_3d<int>() ), max_point_(vgl_point_3d<int>() ),
    degree_(0) {}
  ...
  bvpl_taylor_basis_loader(vcl_string path,
                           ...
                           unsigned degree = 2) : path_(path), min_point_(min_point), max_point_(max_point), degree_(
      degree) {}
