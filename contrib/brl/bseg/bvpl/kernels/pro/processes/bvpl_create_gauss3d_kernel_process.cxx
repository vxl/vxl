...
//: global variables
namespace bvpl_create_gauss3d_kernel_process_globals
{
...
bool bvpl_create_gauss3d_kernel_process_cons(bprb_func_process& pro)
{
...
//:the process
bool bvpl_create_gauss3d_kernel_process(bprb_func_process& pro)
{
  using namespace bvpl_create_gauss3d_kernel_process_globals;
  ...
  //Create the factory
  bvpl_gauss3d_kernel_factory factory(sigma1, sigma2, sigma3);
