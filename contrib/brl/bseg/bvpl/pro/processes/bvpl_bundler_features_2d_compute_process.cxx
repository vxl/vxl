...
bool bvpl_bundler_features_2d_compute_process( bprb_func_process& pro )
{
        ...
        k_itr != k_end; ++k_itr )
  {
    ...
    unsigned nx = max_pt.x() - min_pt.x() + 1;
  ...
  {
#ifndef __DEBUG
    vcl_cout << "Processing point: " << i << " of " << num_pts << vcl_endl;
#endif //_DEBUG
    double x,y,z;
    ...
    {
#ifndef __DEBUG
      vcl_cout << "\tProcessing view: " << j << " of " << num_views << vcl_endl;
#endif //__DEBUG
