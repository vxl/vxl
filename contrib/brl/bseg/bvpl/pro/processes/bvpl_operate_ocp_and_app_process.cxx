...
bool bvpl_operate_ocp_and_app_process(bprb_func_process& pro)
{
  ...
  vcl_string                ocp_functor_name = pro.get_input<vcl_string>(i++);
    ...
    if( bvxm_voxel_grid<gauss_type>* app_grid = dynamic_cast<bvxm_voxel_grid<gauss_type> *>(app_grid_base.ptr() ) )
      ...
      if( app_functor_name == "gauss_convolution" )
        ...
        if( ocp_functor_name == "find_surface" )
          ...
          bvpl_combined_neighb_operator<bvpl_find_surface_functor, bvpl_gauss_convolution_functor> oper(ocp_functor,
                                                                                                        app_func);
        ...
        if( ocp_functor_name == "edge_geometric_mean" )
          {
          bvpl_edge_geometric_mean_functor<float>
                                                                                                                 ocp_functor;
          bvpl_combined_neighb_operator<bvpl_edge_geometric_mean_functor<float>, bvpl_gauss_convolution_functor> oper(
            ocp_functor, app_func);
          bvpl_discriminative_non_max_suppression
            vector_oper;
          vector_oper.suppress_and_combine(ocp_grid, app_grid, kernel, &oper, grid_out, id_grid);
          pro.set_output_val<bvxm_voxel_grid_base_sptr>(0, grid_out);
          pro.set_output_val<bvxm_voxel_grid_base_sptr>(1, id_grid);
      ...
      if( app_functor_name == "positive_gauss_convolution" )
        ...
        if( ocp_functor_name == "find_surface" )
          {
          bvpl_find_surface_functor                                                                  ocp_functor;
          bvpl_combined_neighb_operator<bvpl_find_surface_functor, bvpl_positive_gauss_conv_functor> oper(ocp_functor,
                                                                                                          app_func);
          bvpl_discriminative_non_max_suppression vector_oper;
          vector_oper.suppress_and_combine(ocp_grid, app_grid, kernel, &oper, grid_out, id_grid);
          pro.set_output_val<bvxm_voxel_grid_base_sptr>(0, grid_out);
        ...
        if( ocp_functor_name == "edge_geometric_mean" )
          ...
          bvpl_edge_geometric_mean_functor<float>
                                                                                                                   ocp_functor;
          bvpl_combined_neighb_operator<bvpl_edge_geometric_mean_functor<float>, bvpl_positive_gauss_conv_functor> oper(
            ocp_functor, app_func);
          bvpl_discriminative_non_max_suppression
            vector_oper;
          vector_oper.suppress_and_combine(ocp_grid, app_grid, kernel, &oper, grid_out, id_grid);
      ...
      if( app_functor_name == "negative_gauss_convolution" )
        ...
        if( ocp_functor_name == "find_surface" )
          {
          bvpl_find_surface_functor                                                                  ocp_functor;
          bvpl_combined_neighb_operator<bvpl_find_surface_functor, bvpl_negative_gauss_conv_functor> oper(ocp_functor,
                                                                                                          app_func);
          bvpl_discriminative_non_max_suppression vector_oper;
          vector_oper.suppress_and_combine(ocp_grid, app_grid, kernel, &oper, grid_out, id_grid);
          pro.set_output_val<bvxm_voxel_grid_base_sptr>(0, grid_out);
        ...
        if( ocp_functor_name == "edge_geometric_mean" )
          ...
          bvpl_edge_geometric_mean_functor<float>
                                                                                                                   ocp_functor;
          bvpl_combined_neighb_operator<bvpl_edge_geometric_mean_functor<float>, bvpl_negative_gauss_conv_functor> oper(
            ocp_functor, app_func);
          bvpl_discriminative_non_max_suppression
            vector_oper;
          vector_oper.suppress_and_combine(ocp_grid, app_grid, kernel, &oper, grid_out, id_grid);
