...
bvpl_corner_search_functor::bvpl_corner_search_functor(int this_id, vcl_vector<vnl_float_3> axes,
...
void bvpl_corner_search_functor::apply(int& id, bvpl_kernel_dispatch & /*d*/, vgl_point_3d<int> p1,
                                       vgl_point_3d<int> p2)
{
