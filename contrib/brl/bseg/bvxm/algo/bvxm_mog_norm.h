...
public:
  ...
  static bool mog_l2_grid(bvxm_voxel_grid_base_sptr apm_grid_base, bvxm_voxel_grid_base_sptr mask_grid_base,
                          bvxm_voxel_grid_base_sptr dist_grid_base, bool reference_given,
