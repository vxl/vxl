  ...
  if (use_expected_) {
    ...
    while(iterate_again) {
      ...
      if (apm_type == "apm_mog_grey") {
        ...
        vcl_cerr << "error: unsupported appearance model type " << apm_type << " ! " << vcl_endl;
      }
