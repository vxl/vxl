...
public:
  ...
  breg3d_zero_occupancy_borders_process(const breg3d_zero_occupancy_borders_process& other) : bprb_process(*static_cast<
                                                                                                             const
                                                                                                             bprb_process
                                                                                                             *>(&other) )
  {}
  ...
  // : Clone the process
  virtual breg3d_zero_occupancy_borders_process * clone() const
  {
    return new breg3d_zero_occupancy_borders_process(*this);
  }
