...
public:
  ...
  static void convert_image_types(const vil_image_view<T_from>& inp_image, vil_image_view<T_to>& out_image, float scale,
                                  float offset);

};

template <class T_from, class T_to>
void bvxm_edge_util::convert_image_types(const vil_image_view<T_from>& inp_image, vil_image_view<T_to>& out_image,
