...
public:
  ...
  bool  region_prob_density(bvxm_voxel_slab<float> & probabilities, bvxm_voxel_slab<mix_gauss_type> const& appear,
                            bvxm_voxel_slab<float> const& obs, bvxm_voxel_slab<float> const& mask);

  bvxm_voxel_slab<float> prob_range(bvxm_voxel_slab<mix_gauss_type> const& appear,
                                    bvxm_voxel_slab<float> const& obs_min, bvxm_voxel_slab<float> const& obs_max);

  bool update( bvxm_voxel_slab<mix_gauss_type> & appear, bvxm_voxel_slab<float> const& obs,
