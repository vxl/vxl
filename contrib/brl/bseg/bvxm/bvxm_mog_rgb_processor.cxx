...
// : Expected value
bvxm_voxel_slab<bvxm_mog_rgb_processor::obs_datatype> bvxm_mog_rgb_processor::expected_color(
...
bvxm_voxel_slab<bvxm_mog_rgb_processor::obs_datatype> bvxm_mog_rgb_processor::most_probable_mode_color(
  bvxm_voxel_slab<mix_gauss_type> const& appear)
{
  // the output
...
bvxm_voxel_slab<bvxm_mog_rgb_processor::obs_datatype> bvxm_mog_rgb_processor::sample(
  bvxm_voxel_slab<mix_gauss_type> const& appear)
{
  // the output
  bvxm_voxel_slab<obs_datatype> color(appear.nx(), appear.ny(), appear.nz() );
