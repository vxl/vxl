...
template <class T>
bool bvxm_von_mises_tangent_processor<T>::tangent_3d_from_2d(T img_a0, T img_b0, T img_c0,
...
template <class T>
bool bvxm_von_mises_tangent_processor<T>::pos_dir_from_tangent_plane(vgl_plane_3d<T> const& plane,
...
template <class T>
bool bvxm_von_mises_tangent_processor<T>::pos_dir_from_image_tangent(T img_a, T img_b, T img_c,
...
template <class T>
bool bvxm_von_mises_tangent_processor<T>::update(bvxm_voxel_slab<dir_dist_t> & dir_dist,
                                                 ...
                                                 bvxm_voxel_slab<bool> const& flag)
{
  ...
  for( ;
    ...
    if( *flag_it )
      ...
      if( prob < 0.05 )
        {
        continue;             // JLM temporary hardcoded threshold
        }
...
#endif // bvxm_von_mises_tangent_processor_txx_
