...
inline bvxm_opinion operator+(bvxm_opinion const& lhs,
                              bvxm_opinion const& rhs) { return bvxm_opinion(lhs.b() + rhs.b() ); }
...
inline vcl_ostream & operator<<(vcl_ostream& s,
                                bvxm_opinion const& o) { s << "bvxm_opinion [b=" << o.b() << " u=" << o.u() << ']'
                                                           << vcl_endl; return s; }
