...
{
  vcl_cerr
  << "vsl_b_write() -- Binary io, NOT IMPLEMENTED, signatures defined to use bvxm_voxel_slab_base as a brdb_value\n";
  return;
}
...
{
  vcl_cerr
  << "vsl_b_read() -- Binary io, NOT IMPLEMENTED, signatures defined to use bvxm_voxel_slab_base as a brdb_value\n";
  return;
}
