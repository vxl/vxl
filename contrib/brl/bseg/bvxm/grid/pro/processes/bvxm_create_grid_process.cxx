...
bool bvxm_create_grid_process(bprb_func_process& pro)
{
  ...
  if( datatype == "float" )
    ...
    bvxm_voxel_grid_base_sptr grid =
      new bvxm_voxel_grid<float>(input_path, vgl_vector_3d<unsigned>(dim_x, dim_y, dim_z) );
    ...
    {
    bvxm_voxel_grid_base_sptr grid =
      new bvxm_voxel_grid<bool>(input_path, vgl_vector_3d<unsigned>(dim_x, dim_y, dim_z) );
    pro.set_output_val<bvxm_voxel_grid_base_sptr>(0, grid);
    return true;
    }
    ...
    {
    bvxm_voxel_grid_base_sptr grid =
      new bvxm_voxel_grid<bvxm_opinion>(input_path, vgl_vector_3d<unsigned>(dim_x, dim_y, dim_z) );
    pro.set_output_val<bvxm_voxel_grid_base_sptr>(0, grid);
    return true;
    }
    ...
    bvxm_voxel_grid_base_sptr grid =
      new bvxm_voxel_grid<mix_gauss_type>(input_path, vgl_vector_3d<unsigned>(dim_x, dim_y, dim_z) );
    pro.set_output_val<bvxm_voxel_grid_base_sptr>(0, grid);
    return true;
    }
  else if( datatype == "vnl_vector_fixed_float_3" )
    {
    bvxm_voxel_grid_base_sptr grid = new bvxm_voxel_grid<vnl_vector_fixed<float, 3> >(input_path, vgl_vector_3d<unsigned>(
                                                                                        dim_x, dim_y,
                                                                                        dim_z) );
    pro.set_output_val<bvxm_voxel_grid_base_sptr>(0, grid);
    return true;
    ...
    {
    bvxm_voxel_grid_base_sptr grid = new bvxm_voxel_grid<vnl_vector_fixed<float, 4> >(input_path, vgl_vector_3d<unsigned>(
                                                                                        dim_x, dim_y,
                                                                                        dim_z) );
    pro.set_output_val<bvxm_voxel_grid_base_sptr>(0, grid);
    return true;
