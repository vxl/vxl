...
bool bvxm_crop_grid_process(bprb_func_process& pro)
{
  ...
  else if( bvxm_voxel_grid<bvxm_opinion> * opinion_input_grid =
  ...
  else if( bvxm_voxel_grid<gauss_type> * gauss_input_grid =
  ...
  else if( bvxm_voxel_grid<vnl_float_4> * four_input_grid =
             dynamic_cast<bvxm_voxel_grid<vnl_float_4> *>(input_grid.ptr() ) )
    {
