// This is brl/bseg/bvxm/pro/bvxm_create_normalized_image_process.h
...
class bvxm_create_normalized_image_process : public bprb_process
{
 public:
  ...
  bvxm_create_normalized_image_process(const bvxm_create_normalized_image_process& other)
  : bprb_process(*static_cast<const bprb_process*>(&other)) {}

  ~bvxm_create_normalized_image_process() {}

  //: Clone the process
  virtual bvxm_create_normalized_image_process* clone() const
  { return new bvxm_create_normalized_image_process(*this); }
