...
#if 1 //Isa commented out this: This is temporarly commented out in order to reproduce Thom's initial results
          if (bigendian) {
...
#else   //Temporary hack: Remove when Thom's results have been proved
