...
bool bvxm_estimate_camera_process(bprb_func_process& pro)
{
  ...
  double theta_range = 12.0 * deg2rad, theta_step = 0.05 * deg2rad, phi_range = 12.0 * deg2rad,
    phi_step = 0.05 * deg2rad, rot_range = 10.0 * deg2rad, rot_step = 1.0 * deg2rad;
  ...
  cam_estimator.set_estimation_params(theta_range, theta_step, phi_range, phi_step, rot_range, rot_step,
                                      max_iter_rot_angle);
