...
bvxm_voxel_slab_base_sptr create_mog_image_using_grey_processor(vcl_string model_dir, bvxm_voxel_world_sptr& vox_world,
...
static void test_bvxm_normalize_image_process()
{
  ...
  bvxm_voxel_slab_base_sptr mog_image = create_mog_image_using_grey_processor(
      model_dir.c_str(), vox_world, expected_image);
