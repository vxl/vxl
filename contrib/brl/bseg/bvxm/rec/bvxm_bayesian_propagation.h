...
public:
  ...
  bvxm_bayesian_propagation(vil_image_view<float>& bg_map) : bg_map_(bg_map) {}

  bool initialize_bg_map(float high_prior = 0.9f, float top_percentile = 0.1f);

  bool horizontal_pass(bvxm_fg_pair_density& fgp, bvxm_fg_bg_pair_density& fgbgp, bvxm_bg_pair_density& bgp);
  bool directional_pass(bvxm_fg_pair_density& fgp, bvxm_fg_bg_pair_density& fgbgp, bvxm_bg_pair_density& bgp, int ii, int jj);

  bool horizontal_pass_using_prob_density_as_bgp(bvxm_fg_pair_density& fgp, bvxm_fg_bg_pair_density& fgbgp);
  bool vertical_pass_using_prob_density_as_bgp(bvxm_fg_pair_density& fgp, bvxm_fg_bg_pair_density& fgbgp);
  bool directional_pass_using_prob_density_as_bgp(bvxm_fg_pair_density& fgp, bvxm_fg_bg_pair_density& fgbgp, int ii, int jj);

  bool pass_using_prob_density_as_bgp(bvxm_fg_pair_density& fgp, bvxm_fg_bg_pair_density& fgbgp, vil_image_view<float>& temp);

  bool run(bvxm_fg_pair_density& fgp, bvxm_fg_bg_pair_density& fgbgp, bvxm_bg_pair_density& bgp, int npasses = 1);
  bool run_using_prob_density_as_bgp(bvxm_fg_pair_density& fgp, bvxm_fg_bg_pair_density& fgbgp, int npasses = 1);
