// This is contrib/bvxm/rec/bvxm_part_hierarchy.h
...
public:
  ...
  void extract_upper_layer(vcl_vector<bvxm_part_instance_sptr>& extracted_parts, 
    unsigned ni, unsigned nj, float detection_threshold, vcl_vector<bvxm_part_instance_sptr>& extracted_upper_parts);
