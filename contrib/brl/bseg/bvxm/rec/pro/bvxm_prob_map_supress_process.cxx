#include "bvxm_prob_map_supress_process.h"
...
bvxm_prob_map_supress_process::bvxm_prob_map_supress_process()
{
  //inputs
...
bool bvxm_prob_map_supress_process::execute()
{
  // Sanity check
  ...
  vil_image_view<float> dummy(ni, nj), dummy2(ni, nj), dummy3(ni, nj), dummy4(ni, nj);
  dummy.fill(max);
  ...
  //vil_save(dummy_byte, "./vehicle_map_inverse.png");
