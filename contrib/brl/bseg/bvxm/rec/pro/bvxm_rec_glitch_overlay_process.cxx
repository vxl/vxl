// This is brl/bseg/bvxm/rec/pro/bvxm_rec_glitch_overlay_process.cxx
#include "bvxm_rec_glitch_overlay_process.h"
//:
// \file
...
//: Constructor
bvxm_rec_glitch_overlay_process::bvxm_rec_glitch_overlay_process()
{
  //input
...
//: Execute the process
bool
bvxm_rec_glitch_overlay_process::execute()
{
  // Sanity check
  if (!this->verify_inputs()){
    vcl_cerr << "In bvxm_rec_glitch_overlay_process::execute() -"
             << " invalid inputs\n";
    return false;
  }
  ...
  bvxm_glitch::extend_prob_to_square_region(c_size, map, out);
