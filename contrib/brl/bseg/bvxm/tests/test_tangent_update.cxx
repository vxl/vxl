...
bool tangent_image(vpgl_perspective_camera<double> const* cam, vgl_infinite_line_3d<double> const& line_3d,
                   double image_error_radius, vil_image_view<float>* tan_image)
{
...
static void test_tangent_update()
{
  ...
  TEST_NEAR("test updated direction distribution", mud[0] + mud[1] + mud[2] + 1.0f / kappa, 1.732050807 + nobsd - 2.0f,
            1e-6);
