...
static void test_tangent_update()
{
  ...
  //
  //============= test ray processsor with perfect data ======================
  //
  ...
  vcl_cout << "camera 0 *center* " << c0->get_camera_center() << '\n';
  vcl_cout << "camera 1 *center* " << c1->get_camera_center() << '\n';
  vcl_cout << "camera 2 *center* " << c2->get_camera_center() << '\n';
  ...
  vcl_cout << "(0,0,0)->" << vgl_point_2d<double>(c0->project(c00)) << '\n';
  vcl_cout << "(5,0,0)->" << vgl_point_2d<double>(c0->project(c10)) << '\n';
  vcl_cout << "(0,5,0)->" << vgl_point_2d<double>(c0->project(c01)) << '\n';
  vcl_cout << "(5,5,0)->" << vgl_point_2d<double>(c0->project(c11)) << '\n';
  vcl_cout << "voxel world corners in camera 1\n";
  vcl_cout << "(0,0,0)->" << vgl_point_2d<double>(c1->project(c00)) << '\n';
  vcl_cout << "(5,0,0)->" << vgl_point_2d<double>(c1->project(c10)) << '\n';
  vcl_cout << "(0,5,0)->" << vgl_point_2d<double>(c1->project(c01)) << '\n';
  vcl_cout << "(5,5,0)->" << vgl_point_2d<double>(c1->project(c11)) << '\n';
  vcl_cout << "voxel world corners in camera 2\n";
  vcl_cout << "(0,0,0)->" << vgl_point_2d<double>(c2->project(c00)) << '\n';
  vcl_cout << "(5,0,0)->" << vgl_point_2d<double>(c2->project(c10)) << '\n';
  vcl_cout << "(0,5,0)->" << vgl_point_2d<double>(c2->project(c01)) << '\n';
  vcl_cout << "(5,5,0)->" << vgl_point_2d<double>(c2->project(c11)) << '\n';
...
#if 0
  //
  //============= test ray processsor with noisy data ======================
  //
  update_success = true;
  ...
  planes.push_back(vgl_plane_3d<double>(0.548674, -0.432393, -0.715537, -43.5871));
  planes.push_back(vgl_plane_3d<double>(0.588869, -0.441348, -0.677085, -45.619));
  planes.push_back(vgl_plane_3d<double>(0.623675, -0.523734, -0.580286, -50.6641));
  planes.push_back(vgl_plane_3d<double>(0.625087, -0.577003, -0.525675, -52.8468));
  planes.push_back(vgl_plane_3d<double>(0.685963, -0.600205, -0.411351, -56.5028));
  planes.push_back(vgl_plane_3d<double>(-0.698784, 0.653447, 0.291046, 59.2007));
  planes.push_back(vgl_plane_3d<double>(-0.715996, 0.68723, 0.122737, 61.2933));
  planes.push_back(vgl_plane_3d<double>(-0.705237, 0.70682, -0.0551943, 61.4763));
  planes.push_back(vgl_plane_3d<double>(-0.688649, 0.673296, -0.269136, 59.1564));
  planes.push_back(vgl_plane_3d<double>(0.649432, -0.601921, 0.464681, -54.1332));
  planes.push_back(vgl_plane_3d<double>(-0.520232, 0.467336, 0.714811, 43.76));
  planes.push_back(vgl_plane_3d<double>(-0.483641, 0.482089, 0.730535, 42.8933));
  planes.push_back(vgl_plane_3d<double>(-0.510775, 0.434404, 0.741891, 42.0785));
  planes.push_back(vgl_plane_3d<double>(0.509235, -0.442755, -0.738003, -42.2039));
  planes.push_back(vgl_plane_3d<double>(0.598526, -0.394519, -0.697224, -44.0743));
  planes.push_back(vgl_plane_3d<double>(0.57679, -0.454419, -0.678834, -45.5965));
  planes.push_back(vgl_plane_3d<double>(0.657091, -0.508597, -0.556382, -51.446));
  planes.push_back(vgl_plane_3d<double>(0.615269, -0.586592, -0.526645, -52.894));
  planes.push_back(vgl_plane_3d<double>(0.695664, -0.600032, -0.394986, -56.9672));
  planes.push_back(vgl_plane_3d<double>(-0.698014, 0.659298, 0.279469, 59.4179));
  planes.push_back(vgl_plane_3d<double>(0.642563, -0.600573, 0.475841, -53.8482));
  planes.push_back(vgl_plane_3d<double>(-0.485003, 0.478106, 0.732248, 42.6716));
  planes.push_back(vgl_plane_3d<double>(0.540018, -0.418333, -0.730327, -42.4096));
  planes.push_back(vgl_plane_3d<double>(0.539065, -0.446844, -0.713961, -43.6953));
  planes.push_back(vgl_plane_3d<double>(-0.664266, 0.566153, 0.48808, 54.2134));
  planes.push_back(vgl_plane_3d<double>(-0.7264, 0.68346, 0.0722881, 61.5753));
  planes.push_back(vgl_plane_3d<double>(-0.712671, 0.691969, -0.115233, 61.1809));
  planes.push_back(vgl_plane_3d<double>(-0.680231, 0.665795, -0.306598, 58.3956));
  planes.push_back(vgl_plane_3d<double>(0.634285, -0.603643, 0.483009, -53.754));
  planes.push_back(vgl_plane_3d<double>(-0.516749, 0.465635, 0.718439, 43.4822));
  planes.push_back(vgl_plane_3d<double>(-0.532607, 0.414477, 0.737928, 42.1126));
  planes.push_back(vgl_plane_3d<double>(0.517689, -0.439086, -0.734304, -42.4402));
  planes.push_back(vgl_plane_3d<double>(0.549794, -0.441542, -0.709061, -43.9967));
  planes.push_back(vgl_plane_3d<double>(0.590554, -0.457122, -0.665045, -46.1956));
  planes.push_back(vgl_plane_3d<double>(0.595241, -0.503461, -0.626271, -48.4808));
  planes.push_back(vgl_plane_3d<double>(0.637005, -0.532552, -0.557327, -51.628));
  planes.push_back(vgl_plane_3d<double>(0.676165, -0.564935, -0.472915, -54.6711));
  planes.push_back(vgl_plane_3d<double>(-0.69297, 0.614464, 0.377131, 57.4514));
  planes.push_back(vgl_plane_3d<double>(0.69961, -0.669562, -0.249462, -59.8512));
  planes.push_back(vgl_plane_3d<double>(-0.715962, 0.694683, 0.0693803, 61.5591));
  planes.push_back(vgl_plane_3d<double>(-0.715381, 0.683568, -0.144792, 60.8299));
  planes.push_back(vgl_plane_3d<double>(0.684953, -0.637682, 0.352421, -57.3216));
  planes.push_back(vgl_plane_3d<double>(-0.52007, 0.456974, 0.721596, 43.2585));
  planes.push_back(vgl_plane_3d<double>(0.528574, -0.431593, -0.730983, -42.6288));
  planes.push_back(vgl_plane_3d<double>(0.570125, -0.429754, -0.700192, -44.404));
  planes.push_back(vgl_plane_3d<double>(0.615801, -0.496418, -0.611848, -49.0148));
  planes.push_back(vgl_plane_3d<double>(0.659619, -0.523962, -0.538856, -52.2182));
  planes.push_back(vgl_plane_3d<double>(-0.656362, 0.582268, 0.479742, 54.4518));
  planes.push_back(vgl_plane_3d<double>(0.700516, -0.616266, -0.359852, -57.8066));
  planes.push_back(vgl_plane_3d<double>(-0.714899, 0.664226, 0.218455, 60.2885));
  planes.push_back(vgl_plane_3d<double>(-0.717838, 0.694559, 0.04791, 61.6234));
  planes.push_back(vgl_plane_3d<double>(0.710361, -0.685558, 0.159363, -60.8077));
  planes.push_back(vgl_plane_3d<double>(-0.675597, 0.646403, -0.354587, 57.2442));
  planes.push_back(vgl_plane_3d<double>(-0.497109, 0.486057, 0.71877, 43.4578));
  planes.push_back(vgl_plane_3d<double>(-0.528637, 0.417225, 0.739234, 42.1204));
  planes.push_back(vgl_plane_3d<double>(0.522817, -0.439771, -0.730249, -42.6491));
  planes.push_back(vgl_plane_3d<double>(0.427178, -0.529172, -0.733141, -42.3359));
  planes.push_back(vgl_plane_3d<double>(0.62753, -0.494254, -0.601597, -49.4515));
  planes.push_back(vgl_plane_3d<double>(0.703954, -0.620522, -0.345546, -58.0937));
  planes.push_back(vgl_plane_3d<double>(-0.727901, 0.685567, 0.0125787, 61.7201));
  planes.push_back(vgl_plane_3d<double>(-0.70875, 0.681868, -0.180913, 60.5072));
  planes.push_back(vgl_plane_3d<double>(0.677235, -0.623893, 0.390014, -56.4256));
  planes.push_back(vgl_plane_3d<double>(-0.509639, 0.46449, 0.724236, 43.1061));
  planes.push_back(vgl_plane_3d<double>(0.516222, -0.431992, -0.739525, -42.1699));
  planes.push_back(vgl_plane_3d<double>(0.577871, -0.43265, -0.692011, -44.7954));
  planes.push_back(vgl_plane_3d<double>(0.591776, -0.469869, -0.654999, -46.9072));
  planes.push_back(vgl_plane_3d<double>(0.604973, -0.513093, -0.608887, -49.4073));
  planes.push_back(vgl_plane_3d<double>(-0.620909, 0.611106, 0.490939, 54.0752));
  planes.push_back(vgl_plane_3d<double>(0.724924, -0.665907, -0.176217, -60.8058));
  planes.push_back(vgl_plane_3d<double>(-0.716708, 0.697287, 0.0109315, 61.6121));
  planes.push_back(vgl_plane_3d<double>(0.667254, -0.632211, 0.393804, -56.283));
  planes.push_back(vgl_plane_3d<double>(-0.536984, 0.421891, 0.730517, 42.5845));
  planes.push_back(vgl_plane_3d<double>(0.54799, -0.423347, -0.721446, -43.135));
  planes.push_back(vgl_plane_3d<double>(0.571107, -0.441157, -0.692255, -44.7929));
  planes.push_back(vgl_plane_3d<double>(0.599161, -0.522051, -0.607017, -49.5332));
  planes.push_back(vgl_plane_3d<double>(0.610538, -0.568233, -0.551684, -51.7647));
  planes.push_back(vgl_plane_3d<double>(0.671252, -0.591074, -0.447272, -55.4253));
  planes.push_back(vgl_plane_3d<double>(-0.712105, 0.679614, 0.176155, 60.9133));
  planes.push_back(vgl_plane_3d<double>(-0.724748, 0.688592, -0.0241104, 61.6027));
  planes.push_back(vgl_plane_3d<double>(-0.705201, 0.67126, -0.228256, 59.8412));
  planes.push_back(vgl_plane_3d<double>(0.592515, -0.632831, 0.498449, -53.0998));
  ...
  for(vcl_list<vgl_plane_3d<double> >::iterator pit = planes.begin();
      pit != planes.end(); ++pit)
    {
     ...
     vsum += dirv;
      ...
      vcl_cout << vcl_acos(dp)*180.0/3.14159 << ' ' << vsum.length()/cnt 
               << ' ' << d0.length() << '\n';
    }
