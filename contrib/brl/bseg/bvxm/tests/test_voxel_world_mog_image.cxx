...
static void test_voxel_world_mog_image()
{
  ...
  TEST("testing mixture of gaussian image creation",
       vox_world->mixture_of_gaussians_image<APM_MOG_GREY>(meta2, mog_image, 0), true);
  ...
  TEST("testing mixture of gaussian image creation with samplling",
       vox_world->mog_image_with_random_order_sampling<APM_MOG_GREY>(meta2, 10, mog_image2, 0), true);
  ...
  bvxm_voxel_slab_base_sptr mog_image2;
  TEST("testing mixture of gaussian image with sampling", vox_world2->mog_image_with_random_order_sampling<APM_MOG_GREY>(
         meta3, 5, mog_image2, 0,
         0), true);
#endif
}
