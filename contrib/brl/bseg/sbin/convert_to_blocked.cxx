...
static bool convert_to_blocked(std::string const& image_indir,
  ...
  std::string outfile = image_outdir + "/blk";
...
int main(int argc,char * argv[])
{
  if (argc<3)
  {
    std::cout<<"Usage : convert_to_blocked.exe image_in_dir image_out_dir [block_size]\n";
    return -1;
  }
