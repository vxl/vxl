...
!MESSAGE 
!MESSAGE NMAKE /f "seg.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "seg.mak" CFG="seg - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "seg - Win32 MinSizeRel" (based on "Win32 (x86) Application")
!MESSAGE "seg - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "seg - Win32 RelWithDebInfo" (based on "Win32 (x86) Application")
!MESSAGE "seg - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD CPP  /I "$(VXLROOT)\vcl" /I "$(VXLROOT)\core" /I "$(VXLROOT)\vcl" /I "$(VXLROOT)\vcl\config.win32" /I "$(VXLROOT)\core" /I "$(VXLROOT)\contrib\brl" /I "$(VXLROOT)\contrib\brl\bbas" /I "$(VXLROOT)\contrib\brl\bseg" /I "$(VXLROOT)\contrib\oxl" /I "$(VXLROOT)\contrib\gel"   -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_OPENGL /D "seg_EXPORTS"
...
!ELSEIF  "$(CFG)" == "seg - Win32 MinSizeRel"
# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 0
...
# PROP Target_Dir ""
# ADD BASE CPP /nologo  /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS"  /FD /c
# ADD CPP /nologo  /D "WIN32"  /I "$(VXLROOT)\vcl" /I "$(VXLROOT)\core" /I "$(VXLROOT)\vcl" /I "$(VXLROOT)\vcl\config.win32" /I "$(VXLROOT)\core" /I "$(VXLROOT)\contrib\brl" /I "$(VXLROOT)\contrib\brl\bbas" /I "$(VXLROOT)\contrib\brl\bseg" /I "$(VXLROOT)\contrib\oxl" /I "$(VXLROOT)\contrib\gel"   -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_OPENGL /D "NDEBUG" /D "_CONSOLE" /D "_MBCS"  /FD /c
# ADD CPP  /I "$(VXLROOT)\vcl" /I "$(VXLROOT)\core" /I "$(VXLROOT)\vcl" /I "$(VXLROOT)\vcl\config.win32" /I "$(VXLROOT)\core" /I "$(VXLROOT)\contrib\brl" /I "$(VXLROOT)\contrib\brl\bbas" /I "$(VXLROOT)\contrib\brl\bseg" /I "$(VXLROOT)\contrib\oxl" /I "$(VXLROOT)\contrib\gel"   -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_OPENGL /D "seg_EXPORTS"
# ADD CPP /nologo /W3 /Zm1000 /GX /GR
...
!ELSEIF  "$(CFG)" == "seg - Win32 RelWithDebInfo"
...
# Name "seg - Win32 Release"
# Name "seg - Win32 Debug"
# Name "seg - Win32 MinSizeRel"
# Name "seg - Win32 RelWithDebInfo"
