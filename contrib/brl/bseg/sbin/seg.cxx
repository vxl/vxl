...
int main(int argc, char** argv)
{
  ...
  win->get_adaptor()->set_tableau(segv_segmentation_manager::instance());
  win->set_statusbar(true);
  win->enable_vscrollbar(true);
  win->enable_hscrollbar(true);
  win->show();
  segv_segmentation_manager::instance()->set_window(win);
  segv_segmentation_manager::instance()->post_redraw();
