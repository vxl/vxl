...
sdet_atmospheric_image_classifier::classify_image_blocks_qual2(vil_image_view<float> const& image, vcl_map<vcl_string,
                                                                                                                                               ...
                                                                                                                                               float>& cat_percentage_map)
{
  ...
  vcl_cout << "margin: " << margin << ", max_j: " << max_j << ", max_i: " << max_i << ", block_size: " << block_size_
           << vcl_endl;
  ...
  for( vcl_map<vcl_string, float>::iterator iter = cat_percentage_map.begin(); iter != cat_percentage_map.end();
       iter++ )
    {
...
vil_image_view<float> sdet_atmospheric_image_classifier::classify_image_blocks_expected(
