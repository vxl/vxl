...
public:
  ...
  // : default constructor
  sdet_curvelet() : ref_edgel(0), edgel_chain(0), curve_model(0), forward(true), length(0.0), quality(0.0),
    used(false) {}

  // : constructor 1
  sdet_curvelet(sdet_edgel* e) : ref_edgel(e), edgel_chain(0), curve_model(0), forward(true), length(0.0), quality(0.0),
    used(false) {}
