...
sdet_denoise_mrf_params::sdet_denoise_mrf_params(const sdet_denoise_mrf_params& dmp)
...
sdet_denoise_mrf_params::sdet_denoise_mrf_params(double radius, double kappa, double beta)
{
...
{
  return os << "sdet_denoise_mrf_params:\n[---\n"
