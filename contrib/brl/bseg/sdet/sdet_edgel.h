...
public:
  ...
  // : constructor
  //
  sdet_edgel(vgl_point_2d<double> new_pt, double tan, double conf = 0.0, double der = 0.0, double uncer = 0.0,
             sdet_appearance* lapp = new sdet_intensity(0.0), sdet_appearance* rapp = new sdet_intensity(0.0) );
