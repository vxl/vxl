...
sdet_fit_lines_params::sdet_fit_lines_params(const sdet_fit_lines_params& flp)
...
sdet_fit_lines_params::sdet_fit_lines_params(int min_fit_length,
                                             double rms_distance)
{
...
{
  return os << "sdet_fit_lines_params:\n[---\n"
