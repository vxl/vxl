...
sdet_grid_finder_params::sdet_grid_finder_params(const sdet_grid_finder_params& gfp)
  : gevd_param_mixin()
{
...
sdet_grid_finder_params::sdet_grid_finder_params(const int n_lines_x, const int n_lines_y,
...
{
  return os << "sdet_grid_finder_params:\n[---\n"
