...
sdet_harris_detector_params::sdet_harris_detector_params(const sdet_harris_detector_params& hdp)
  : gevd_param_mixin()
{
...
sdet_harris_detector_params::sdet_harris_detector_params(const float sigma,
                                                         const float thresh,
                                                         const int n,
...
{
  return os << "sdet_harris_detector_params:\n[---\n"
