...
{
public:
  sdet_harris_detector_params(const float sigma = 1.0f, const float thresh = 2.0f, const int n = 1,
                              const float percent_corners = 80.0f, const float scale_factor = 0.04f,
