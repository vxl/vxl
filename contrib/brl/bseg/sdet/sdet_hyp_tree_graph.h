...
public:
  ...
  sdet_hyp_tree_node(sdet_curvelet* cvlet_, int id = -1, bool newdir = true) : tree_id(id), dir(newdir), cvlet(cvlet_),
    parent(0) {}
...
protected:
  ...
  void print_all_paths()
  {
    ...
    vcl_cout << "Current Hypothesis tree: TREE ID = " << this->tree_id
             << "----------------------------------------------------------" << vcl_endl;
