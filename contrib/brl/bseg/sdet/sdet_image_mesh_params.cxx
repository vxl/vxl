...
sdet_image_mesh_params::sdet_image_mesh_params(const sdet_image_mesh_params& imp)
...
sdet_image_mesh_params::sdet_image_mesh_params(float smooth, float thresh,
                                               int min_fit_length,
                                               double rms_distance,
...
{
  return os << "sdet_image_mesh_params:\n[---\n"
