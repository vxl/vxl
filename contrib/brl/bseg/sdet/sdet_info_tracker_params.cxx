...
// This is brl/bseg/sdet/sdet_info_tracker_params.cxx
#include <sdet/sdet_info_tracker_params.h>
//:
// \file
// See sdet_info_tracker_params.h
//
//-----------------------------------------------------------------------------
...
sdet_info_tracker_params(const sdet_info_tracker_params& tp)
{
...
sdet_info_tracker_params::
sdet_info_tracker_params(const int n_samples, 
...
void sdet_info_tracker_params::InitParams(int n_samples, 
                                          float search_radius,
                                          float angle_range,
                                          float scale_range,
                                          float sigma,
...
//    vcl_endl otherwise.
bool sdet_info_tracker_params::SanityCheck()
{
...
{
  os << "sdet_info_tracker_params:" << vcl_endl << "[---" << vcl_endl;
