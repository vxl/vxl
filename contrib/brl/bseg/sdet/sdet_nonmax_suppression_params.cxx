...
sdet_nonmax_suppression_params::sdet_nonmax_suppression_params(const sdet_nonmax_suppression_params& nsp)
  : gevd_param_mixin()
{
  InitParams(nsp.thresh_, nsp.pfit_type_);
}

sdet_nonmax_suppression_params::sdet_nonmax_suppression_params(const double thresh, const int pfit_type)
{
...
{
  return os << "sdet_nonmax_suppression_params:\n[---\n"
