...
sdet_region_proc_params::sdet_region_proc_params(const sdet_region_proc_params& rpp)
  : gevd_param_mixin()
{
...
sdet_region_proc_params::sdet_region_proc_params(const sdet_detector_params& dp,
                                                 bool verbose,
                                                 bool debug,
                                                 int array_scale
                                                 )
...
{
  return os << "sdet_region_proc_params:\n[---\n"
            << rpp.dp_ << "\n  ---\n"
