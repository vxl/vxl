...
public:
  ...
  // : constructor
  sdet_sel_base(sdet_edgemap_sptr edgemap, sdet_curvelet_map& cvlet_map, sdet_edgel_link_graph& edge_link_graph,
  ...
  void build_curvelets_greedy(unsigned max_size_to_group, bool use_flag = false,  bool clear_existing = true,
                              bool verbose = false);

  // : form curvelets around the given edgel in a greedy fashion
  virtual void build_curvelets_greedy_for_edge(sdet_edgel* eA, unsigned max_size_to_group, bool use_flag = false,
  ...
  bool triplet_is_supported(sdet_edgel* eX, sdet_edgel* eA, sdet_edgel* eY, unsigned min_group_size);
  ...
  double compute_path_metric2(vcl_vector<sdet_edgel *>& Pchain, vcl_vector<sdet_edgel *>& Tchain,
