...
// enumeration for link algo choices
  ...
  sdet_symbolic_edge_linker_params(double nrad = 3.5, double gap = 2.0, bool adap_uncer = true, double dx = 0.4,
                                   double dt = 15.0, unsigned curve_model = 5, double token_len = 1.0,
                                   double max_k = 0.2, double max_gamma = 0.05, unsigned grouping_algo = 0,
                                   unsigned cvlet_type = 0, unsigned app_usage = 0, double app_thresh = 0.2,
                                   unsigned max_size_to_group = 7, bool formCompleteCvletMap = false,
                                   bool formLinkGraph = true, bool use_all_cvlet = false, unsigned linkgraph_algo = 0,
...
protected:
  ...
  void InitParams(double nrad, double gap, bool adap_uncer, double dx, double dt, unsigned curve_model,
                  double token_len, double max_k, double max_gamma, unsigned grouping_algo, unsigned cvlet_type,
                  unsigned app_usage, double app_thresh, unsigned max_size_to_group, bool formCompleteCvletMap,
                  bool formLinkGraph, bool use_all_cvlet, unsigned linkgraph_algo, unsigned min_size_to_link,
                  unsigned linking_algo, unsigned num_link_iters, bool get_final_contours);
