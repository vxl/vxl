...
class sdet_vehicle_finder_params : public gevd_param_mixin
{
 public:
  sdet_vehicle_finder_params(
                          const sdet_watershed_region_proc_params& wrpp = sdet_watershed_region_proc_params(),
 ...
 ~sdet_vehicle_finder_params(){}
  ...
  bool SanityCheck();
 friend
   vcl_ostream& operator<<(vcl_ostream& os, const sdet_vehicle_finder_params& rpp);
 protected:
 void InitParams(
                 const sdet_watershed_region_proc_params& wrpp,
