...
protected:
  ...
  void draw_regions(vcl_vector<vtol_intensity_face_sptr>& regions, bool verts = false);
  ...
  void add_image_at(vil_image_resource_sptr const& image, const unsigned col, const unsigned row,
