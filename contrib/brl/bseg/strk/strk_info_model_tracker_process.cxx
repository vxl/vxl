// This is brl/bseg/strk/strk_info_model_tracker_process.cxx
#include "strk_info_model_tracker_process.h"
...
bool strk_info_model_tracker_process::execute()
{
  ...
  {
    vcl_cout << "In strk_info_model_tracker_process::execute() -"
  ...
  if (first_frame_)
  {
    ...
    {
      vcl_cout << "In strk_info_model_tracker_process::execute() -"
               << " input doesn't have the right number of faces\n";
      failure_ = true;
      return false;
    }
