...
// This is brl/strk/strk_info_tracker_process.cxx
...
bool strk_info_tracker_process::execute()
{
  ...
  if (this->get_N_input_images()!=1)
    {
      vcl_cout << "In strk_info_tracker_process::execute() - not exactly one"
               << " input image \n";
      failure_ = true;
      return false;
    }
  ...
  if(first_frame_)
    {
      ...
      if(!get_N_input_topo_objs())
        {
          vcl_cout << "In strk_info_tracker_process::execute() - no input"
                   << "correlation face  \n";
          failure_ = true;
          return false;
        }
      ...
      if(!f2d)
        {
          vcl_cout << "In strk_info_tracker_process::execute() - input"
