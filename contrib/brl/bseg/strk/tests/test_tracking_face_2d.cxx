...
static void test_tracking_face_2d()
{
  ...
  vil1_image left_image = vil1_load("c:/images/Calibration/image0005_left.bmp");
  vil1_image right_image = vil1_load("c:/images/Calibration/image0005_right.bmp");
  ...
  bool rhomg = 
  brip_vil1_float_ops::homography(right_flt, R, right_scaled);
  ...
  vil1_save(left_byte, "c:/images/Calibration/image0005_left_scaled.tif");
  vil1_save(right_byte, "c:/images/Calibration/image0005_right_scaled.tif");
  ...
  for(int r = 1; r<20; ++r) 
    {
      ...
      vcl_cout << "Nsamples = "<< npix 
               << "  jent0 = " << jent0 << " jent1.0 = " << jent1
               << "\n" << vcl_flush;
      vcl_cout << "Random Comb Distribution = \n";
...
TESTMAIN(test_tracking_face_2d);
