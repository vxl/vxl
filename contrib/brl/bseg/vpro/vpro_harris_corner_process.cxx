...
// This is brl/vpro/vpro_harris_corner_process.cxx
...
vpro_harris_corner_process::vpro_harris_corner_process(sdet_harris_detector_params & hdp) : sdet_harris_detector_params(hdp)
{
}
...
bool vpro_harris_corner_process::execute()
{
  if (this->get_N_input_images()!=1)
    {
      vcl_cout << "In vpro_harris_corner_process::execute() - not exactly one"
               << " input image \n";
      return false;
    }
