...
void vpro_motion_process::compute_motion(vil1_image ix,
                                         vil1_image iy) // FIXME: unused
{
...
void vpro_motion_process::update_queue(vil1_image ix,
                                       vil1_image iy) // FIXME: unused
{
  queuex_[0]=queuex_[1];
//queuey_[0]=queuey_[1];
...
bool vpro_motion_process::execute()
{
  ...
  {
    vcl_cout << "In vpro_motion_process::execute() - not at exactly one input image\n";
    return false;
  }
