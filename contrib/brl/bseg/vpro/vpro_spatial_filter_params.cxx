...
{
  os << "vpro_spatial_filter_params:" << vcl_endl << "[---" << vcl_endl;
  os << "show_filtered_fft " << vsfp.show_filtered_fft_ << vcl_endl;
  os << "dir_fx " << vsfp.dir_fx_ << vcl_endl;
  os << "dir_fy " << vsfp.dir_fy_ << vcl_endl;
  os << "f0 " << vsfp.f0_ << vcl_endl;
  os << "radius " << vsfp.radius_ << vcl_endl;
  os << "---]" << vcl_endl;
  return os;
}
