...
void vvid_command_line_player::write_status(vcl_string output_file, int iframe)
{
  ...
  outstream << "<status>\n";
  outstream << "  <basic>\n";
  outstream << "    <info percent_completed=\""<<percent_done<<"\"/>\n";
  outstream << "  </basic>\n";
  outstream << "  <optional>\n";
  outstream << "    <info number_of_frames_processed=\""<<iframe<<"\"/>\n";
  outstream << "    <info total_number_of_frames=\""<<nframes_<<"\"/>\n";
  outstream << "  </optional>\n";
  outstream << "</status>\n";
														...
														vcl_vector<float> frame_scores)
{
  ...
  outstream << "  <description>Video Frame Scores</description>\n";
  outstream << "  <frames>\n";
  outstream << "    <video name=\""<<video_name<<"\" totalframes=\""<<frame_scores.size()<<"\">\n";
  int frame_idx = 0;
                                                ...
                                                vcl_string param_block_name)
{
  ...
  outstream << "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n";
  outstream << "<vxl>\n";
  outstream << "  <params app=\""<<param_block_name<<"\" nparams=\""<<n_args<<"\">\n";
  ...
  for (vcl_vector<vul_arg_base*>::iterator arg_it = arg_list.args_.begin();
       arg_it != arg_list.args_.end(); arg_it++)
    {
      ...
      outstream << "    <param command=\""<<command<<"\"";
