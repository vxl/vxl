...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/contrib/conversions" /I "$(VXLROOT)/Numerics" /I "$(VXLROOT)/COOL" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "test_CoolMatrix_conversions_EXPORTS"
