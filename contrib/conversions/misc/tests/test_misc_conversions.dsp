# Microsoft Developer Studio Project File - Name="test_misc_conversions" - Package Owner=<4>
...
# test_misc_conversions  == name of output library
#  /libpath:"$(VXLROOT)/core/$(OUTDIR)" /libpath:"$(VXLROOT)/vcl/$(OUTDIR)" "vnl.lib" "vcl.lib" "vbl.lib" /STACK:10000000  == libraries linked in 
# TARGTYPE "Win32 (x86) Application" 0x0103

CFG=test_misc_conversions - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "test_misc_conversions.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "test_misc_conversions.mak" CFG="test_misc_conversions - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "test_misc_conversions - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "test_misc_conversions - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "test_misc_conversions - Win32 Release"
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/contrib/conversions" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "test_misc_conversions_EXPORTS"
...
!ELSEIF  "$(CFG)" == "test_misc_conversions - Win32 Debug"
...
# Name "test_misc_conversions - Win32 Release"
# Name "test_misc_conversions - Win32 Debug"
