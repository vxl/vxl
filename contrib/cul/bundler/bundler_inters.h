...
struct bundler_inters_feature : public vbl_ref_count
  ...
  bundler_inters_feature(double row, double col, const vnl_vector<double> & d, const bundler_inters_image_sptr & img,
                         int index_in_image);
...
struct bundler_inters_match_set
  ...
  void add_match(bundler_inters_feature_sptr f1, bundler_inters_feature_sptr f2);
  ...
  double get_homography_inlier_percentage(int num_ransac_rounds, double thresh_sq) const;
