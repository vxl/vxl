...
{
public:
  virtual bool operator()(bundler_inters_reconstruction & reconstruction) = 0;
...
public:
  ...
  virtual bool operator()(bundler_inters_reconstruction & reconstruction,
...
{
public:
  virtual void operator()(const vcl_vector<bundler_inters_image_sptr> & to_add,
...
{
public:
  virtual void operator()(bundler_inters_reconstruction & reconstruction,
...
{
public:
  virtual void operator()(bundler_inters_reconstruction & reconstruction) = 0;
