...
public:
  ...
  bool operator()(bundler_inters_reconstruction & reconstruction, vcl_vector<bundler_inters_image_sptr> & to_add);
...
public:
  ...
  void operator()(const vcl_vector<bundler_inters_image_sptr> & to_add, bundler_inters_reconstruction & reconstruction,
...
public:
  ...
  void operator()(bundler_inters_reconstruction & reconstruction,
