...
public:
  ...
  bundler_inters_image_sptr operator()(const vil_image_resource_sptr & image, const double exif_focal_len);
...
public:
  ...
  void operator()(const vcl_vector<bundler_inters_image_sptr> & features,
...
public:
  ...
  // : Performs the feature matching
  void operator()(const bundler_inters_image_pair & to_match, bundler_inters_match_set & matches);
...
public:
  ...
  void operator()(vcl_vector<bundler_inters_match_set> & match_set, vcl_vector<bundler_inters_image_sptr> & images,
