...
!MESSAGE "gevd - Win32 MinSizeRel" (based on "Win32 (x86) Static Library")
!MESSAGE "gevd - Win32 Release" (based on "Win32 (x86) Static Library")
!MESSAGE "gevd - Win32 RelWithDebInfo" (based on "Win32 (x86) Static Library")
# Begin Project
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vxl" /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vcl/config.win32-VC60" /I "$(VXLROOT)/vxl" /I "$(VXLROOT)/gel"    -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_OPENGL /D "gevd_EXPORTS"
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
!ELSEIF  "$(CFG)" == "gevd - Win32 MinSizeRel"
...
!ELSEIF  "$(CFG)" == "gevd - Win32 RelWithDebInfo"
...
# Name "gevd - Win32 MinSizeRel"
# Name "gevd - Win32 RelWithDebInfo"
