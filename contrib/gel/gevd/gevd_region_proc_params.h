...
{
public:
  gevd_region_proc_params(float expand_scale = 2.0f, float burt_adelson_factor = .4f, bool debug = false,
                          bool verbose = false, gevd_detector_params const & = gevd_detector_params() );
...
protected:
  void InitParams(float expand_scale, float burt_adelson_factor, bool debug, bool verbose,
