...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "$(IUEROOT)/vxl" /I "$(IUEROOT)/gel" /I "$(IUEROOT)/vxl/config.win32-vc60" /D "ANSI_DECLARATORS" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "NO_TIMER" /D "TRILIBRARY" /D "_AFXDLL" /D "_MBCS" /FD /GZ /c
