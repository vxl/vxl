// This is gel/mrc/vpgl/algo/vpgl_bundle_rolling_shutter_adjust.cxx
#include "vpgl_bundle_rolling_shutter_adjust.h"
//:
// \file
...
void
vpgl_bundle_rolling_shutter_adj_lsqr::f(vnl_vector<double> const& a,
...
vpgl_bundle_rolling_shutter_adj_lsqr::rod_to_matrix(const double* r) const
{
...
vnl_vector<double>
vpgl_bundle_rolling_shutter_adj_lsqr::create_param_vector(const vcl_vector<vpgl_perspective_camera<double> >& cameras,
...
//===============================================================
// Static functions for vpgl_bundle_rolling_shutter_adjust
//===============================================================


vpgl_bundle_rolling_shutter_adjust::vpgl_bundle_rolling_shutter_adjust()
  : ba_func_(NULL),
    use_weights_(false),
    use_gradient_(true),
    start_error_(0.0),
...
//: Bundle Adjust
bool
vpgl_bundle_rolling_shutter_adjust::optimize(vcl_vector<vpgl_perspective_camera<double> >& cameras,
                                             ...
                                             const vcl_vector<vcl_vector<bool> >& mask)
{
  ...
  delete ba_func_;
  ba_func_ = new vpgl_bundle_rolling_shutter_adj_lsqr(K,image_points,mask,r,use_weights_);
