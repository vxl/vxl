// This is gel/mrc/vpgl/algo/vpgl_bundle_rolling_shutter_adjust.h
#ifndef vpgl_bundle_rolling_shutter_adjust_h_
#define vpgl_bundle_rolling_shutter_adjust_h_
//:
// \file
...
class vpgl_bundle_rolling_shutter_adj_lsqr : public vnl_sparse_lst_sqr_function
{
 public:
  //: Constructor
...
class vpgl_bundle_rolling_shutter_adjust
{
 public:
  //: Constructor
  vpgl_bundle_rolling_shutter_adjust();
  //: Destructor
  ~vpgl_bundle_rolling_shutter_adjust();
 ...
 private:
  ...
  vpgl_bundle_rolling_shutter_adj_lsqr* ba_func_;
...
#endif // vpgl_bundle_rolling_shutter_adjust_h_
