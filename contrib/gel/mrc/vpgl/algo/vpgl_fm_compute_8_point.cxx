...
#ifndef _vpgl_fm_compute_8_point_cxx_
#define _vpgl_fm_compute_8_point_cxx_
//:
// \file
  ...
  vpgl_fundamental_matrix<double>& fm )
{
  ...
  // Solve!
  vnl_matrix<double> S(8,9);
  for( int i = 0; i < pr_norm.size(); i++ ){
...
#endif //_vpgl_fm_compute_8_point_cxx_
