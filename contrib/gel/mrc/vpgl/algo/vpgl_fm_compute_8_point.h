...
#ifndef _vpgl_fm_compute_8_point_h_
#define _vpgl_fm_compute_8_point_h_
//:
// \file
// \brief The 8 point algorithm for computing a fundamental matrix from point
// correspondences.
...
#endif // _vpgl_fm_compute_8_point_h_
