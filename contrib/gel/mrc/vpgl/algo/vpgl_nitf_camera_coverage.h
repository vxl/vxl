...
//:
// There are several algoirthms useful when determing which geografical regions
...
class vpgl_nitf_camera_coverage
{
 ...
 //: Saves to an input file, the filenames of the NITF images which contain the specified 
 //  geografic position. The inputs  to this function are: A vector of vgl_point_3d<double> with the
