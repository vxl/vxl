...
{
 public:
  //: given a depth transform, produce a 1-d array of samples from a source image that is transformed with respect to the destination.
  ...
  //: given a depth transform from dest to source, produce an image which is the resampling of the source to the destination.
  //  The mask indicates which pixels in the destination are valid, i.e. mask == 1
