...
static void test_minimizer()
{
  ...
  vcl_cout << "Rotated principal ray = " << Rpa*pa << '\n';
  ...
  vcl_cout << "True Translation \n" << tr << '\n'; 
  vcl_cout << "end error " << minimizer.end_error() << '\n';
  vcl_cout << "Minimized focal length "<< minimizer.to_fl() << '\n';
  vcl_cout << "Minimized Rotation \n" << minimizer.rotation().as_matrix() 
           << '\n';
  vcl_cout << "Minimized Translation \n" << minimizer.translation() << '\n';
#endif
  ...
  vcl_cout << "min cost " << min_cost << "  min rod " << min_rod 
           << " fraction " << min_frac << '\n';
#endif
  ...
  vcl_cout << "granular rotation with correct translation is " 
           << min_rot.as_rodrigues() << '\n';
  vcl_cout << "error for correct transformation is " << min_error  
  ...
  for(double tro = -.5; tro<=.5; tro+=0.01){
    ...
    vcl_cout << "min error " << min_error << " with " << min_overl 
             << " overlap\n";
    vcl_cout << "rotation at minimum is " << min_rot.as_rodrigues() << '\n';
  ...
  vcl_cout << "actual translation     " << tr << '\n';
  vcl_cout << "global min translation " << global_min_tr << '\n';
#endif
...
vcl_cout << "global min overlap " << min_overl << '\n';
  vcl_cout << "global min translation     " << min_trans << '\n';
  vcl_cout << "global min rotation " << global_min_rot.as_rodrigues() << '\n';
