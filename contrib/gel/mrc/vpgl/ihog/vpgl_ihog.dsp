# Microsoft Developer Studio Project File - Name="vpgl_ihog" - Package Owner=<4>
...
# vpgl_ihog  == name of output library

# TARGTYPE "Win32 (x86) Static Library" 0x0104

CFG=vpgl_ihog - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "vpgl_ihog.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "vpgl_ihog.mak" CFG="vpgl_ihog - Win32 Debug"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "vpgl_ihog - Win32 Debug" (based on "Win32 (x86) Static Library")
!MESSAGE "vpgl_ihog - Win32 Release" (based on "Win32 (x86) Static Library")
# Begin Project
...
!IF  "$(CFG)" == "vpgl_ihog - Win32 Release"
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/contrib/gel" /I "$(VXLROOT)/contrib/gel/mrc" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_OPENGL /D "vpgl_ihog_EXPORTS"
...
!ELSEIF  "$(CFG)" == "vpgl_ihog - Win32 Debug"
...
# Name "vpgl_ihog - Win32 Release"
# Name "vpgl_ihog - Win32 Debug"
