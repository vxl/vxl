...
static void test_segmented_rolling_shutter_camera()
{
  ...
  vpgl_segmented_rolling_shutter_camera<double> rc(cam_map);
  ...
  vpgl_segmented_rolling_shutter_camera<double> P_rot =
    vpgl_segmented_rolling_shutter_camera<double>::postmultiply(P, tr);
  vcl_cout << "P_rot\n" << P_rot << '\n';
  ...
  // test look_at
  {
    ...
    vpgl_segmented_rolling_shutter_camera<double> P(K, center, R);
    P.look_at(target);
  ...
  vpgl_segmented_rolling_shutter_camera<double> P_rott =
    vpgl_segmented_rolling_shutter_camera<double>::postmultiply(P, tr);
  ...
  vpgl_segmented_rolling_shutter_camera<double> Po;
  ...
  vpgl_segmented_rolling_shutter_camera<double> Pin;
  is >> Pin;
  ...
  vpgl_segmented_rolling_shutter_camera<double> Ptc(Ko, rot, t);
  eql = cams_near_equal(Po, Ptc, 0.01);
  TEST("translation constructor", eql, true);
  vpgl_segmented_rolling_shutter_camera<double> Pts(Po);
