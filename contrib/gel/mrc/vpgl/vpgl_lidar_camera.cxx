// This is gel/mrc/vpgl/vpgl_lidar_camera.cxx
#include "vpgl_lidar_camera.h"
//:
// \file
...
vpgl_lidar_camera::vpgl_lidar_camera()
{
...
vpgl_lidar_camera::vpgl_lidar_camera(vpgl_lidar_camera const& rhs)
{
...
void vpgl_lidar_camera::project(const double x, const double y, const double z,
...
void vpgl_lidar_camera::backproject(const double u, const double v,
...
void vpgl_lidar_camera::translate(double tx, double ty)
{
  trans_matrix_[0][3] += tx;
  trans_matrix_[1][3] -= ty;
}

void vpgl_lidar_camera::img_to_wgs(const unsigned i, const unsigned j,
...
bool vpgl_lidar_camera::operator==(vpgl_lidar_camera const& rhs) const
{
                         ...
                         vpgl_lidar_camera& p)
{
  ...
  s >> (*lvcs);
  p = vpgl_lidar_camera(tr_matrix, lvcs, tiepoints);
  return s ;
}

bool vpgl_lidar_camera::comp_trans_matrix(double sx1, double sy1, double sz1,//vil_geotiff_header* gtif,
...
void vpgl_lidar_camera::b_read(vsl_b_istream &is)
{
...
void vpgl_lidar_camera::b_write(vsl_b_ostream &os) const
{
