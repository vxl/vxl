...
#ifndef _vpgl_rational_camera_h
#define _vpgl_rational_camera_h

//-----------------------------------------------------------------------------
//
// .NAME vpgl_rational_camera
// .LIBRARY IUCameras
...
// .FILE Source
//
// .FILE vpgl_rational_camera.cxx
//
// .SECTION Description:
//      The camera class for a generic rational camera.
//      Ported from TargetJr by M. Laymon
//
// .SECTION Author:
//     $Author: mlaymon $
//     $Revision: 1.1 $ 
//     $Date: 2003/12/11 18:16:46 $
//
//     GE Global Research
//
...
//  virtual BasicCameraInterface* Copy() const ;
  ...
  // init_pt_ ATTRIBUTE IN THIS CLASS SEEMS UNECESSARY.
#if 0
...
private:
  ...
  //  vnl_vector<float> * init_pt_ ;  // REMOVE THIS ? DUPLICATES init_pt in vpgl_basic_camera ?
