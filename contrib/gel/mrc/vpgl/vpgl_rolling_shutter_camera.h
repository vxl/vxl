// This is gel/mrc/vpgl/vpgl_rolling_shutter_camera.h
#ifndef vpgl_rolling_shutter_camera_h_
#define vpgl_rolling_shutter_camera_h_
//:
// \file
...
template <class T>
class vpgl_rolling_shutter_camera : public vpgl_camera<T>
{
 public:
  //: default constructor
  vpgl_rolling_shutter_camera(){}

  virtual ~vpgl_rolling_shutter_camera() {}

  virtual vcl_string type_name() const { return "vpgl_rolling_shutter_camera"; }

  //: Clone `this': creation of a new object and initialization
  //  See Prototype pattern
  virtual vpgl_rolling_shutter_camera<T>* clone(void) const=0;
...
#endif // vpgl_rolling_shutter_camera_h_
