// This is gel/mrc/vpgl/vpgl_segmented_rolling_shutter_camera.h
#ifndef vpgl_segmented_rolling_shutter_camera_h_
#define vpgl_segmented_rolling_shutter_camera_h_
//:
// \file
...
template <class T>
class vpgl_segmented_rolling_shutter_camera : public vpgl_rolling_shutter_camera<T>
{
 ...
 public:
  ...
  const_iterator end  () const { return cam_map_.end(); }
     ...
     //: default constructor
  vpgl_segmented_rolling_shutter_camera();


  //: Constructor from a rational camera and a geographic origin
  vpgl_segmented_rolling_shutter_camera(maptype camera_segments);

  virtual ~vpgl_segmented_rolling_shutter_camera() {}

  virtual vcl_string type_name() const { return "vpgl_segmented_rolling_shutter_camera"; }

  //: Clone `this': creation of a new object and initialization
  //  See Prototype pattern
  virtual vpgl_segmented_rolling_shutter_camera<T>* clone(void) const;
 ...
 //: project function for a point
  ...
  unsigned int num_segments(){return this->cam_map_.size();}
...
//: Creates a local rational camera from a file
  // \relatesalso vpgl_segmented_rolling_shutter_camera
template <class T>
...
// \relatesalso vpgl_segmented_rolling_shutter_camera
template <class T>
vcl_ostream& operator<<(vcl_ostream& s, const vpgl_segmented_rolling_shutter_camera<T>& p);

//: Read from stream
// \relatesalso vpgl_segmented_rolling_shutter_camera
template <class T>
vcl_istream& operator>>(vcl_istream& is, vpgl_segmented_rolling_shutter_camera<T>& p);

#define VPGL_SEGMENTED_ROLLING_SHUTTER_CAMERA_INSTANTIATE(T) extern "please include vgl/vpgl_segmented_rolling_shutter_camera.txx first"


#endif // vpgl_segmented_rolling_shutter_camera_h_
