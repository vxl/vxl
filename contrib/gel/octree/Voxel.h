...
struct Voxel
  {
  Voxel( unsigned char d = 0, unsigned char xx = 0, unsigned char yx = 0, unsigned char zx = 0) : depth(d), x(xx),
    y(yx), z(zx) {}
...
#if 0
bool operator==( const Voxel & a,
                 const Voxel & b) { return a.depth == b.depth && a.x == b.x && a.y == b.y && a.z == b.z; }
#endif // 0
