...
# 
# /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vxl" /I "$(VXLROOT)/vcl/config.win32-VC60" /I "$(VXLROOT)/oxl" /I "$(VXLROOT)/gel" /I "$(VXLROOT)/v3p/jpeg" /I "$(VXLROOT)/v3p/png" /I "$(VXLROOT)/v3p/zlib" /I "$(VXLROOT)/v3p/tiff"  == include path
...
#  /LIBPATH:"$(VXLROOT)/lib/$(IntDir)"  /LIBPATH:"$(VXLROOT)/lib/"  /LIBPATH:"$(VXLROOT)/bin/$(IntDir)"  /LIBPATH:"$(VXLROOT)/bin/"  /LIBPATH:"$(VXLROOT)/oxl/mvl/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/oxl/mvl"  /LIBPATH:"$(VXLROOT)/vxl/vgl/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/vxl/vgl"  /LIBPATH:"$(VXLROOT)/vcl/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/vcl"  /LIBPATH:"$(VXLROOT)/vxl/vnl/algo/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/vxl/vnl/algo"  /LIBPATH:"$(VXLROOT)/v3p/netlib/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/v3p/netlib"  /LIBPATH:"$(VXLROOT)/vxl/vnl/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/vxl/vnl"  /LIBPATH:"$(VXLROOT)/vxl/vbl/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/vxl/vbl"  /LIBPATH:"$(VXLROOT)/vxl/vul/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/vxl/vul"  /LIBPATH:"$(VXLROOT)/vxl/vil/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/vxl/vil"  /LIBPATH:"$(VXLROOT)/vxl/vpl/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/vxl/vpl"  /LIBPATH:"$(VXLROOT)/v3p/jpeg/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/v3p/jpeg"  /LIBPATH:"$(VXLROOT)/v3p/png/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/v3p/png"  /LIBPATH:"$(VXLROOT)/v3p/zlib/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/v3p/zlib"  /LIBPATH:"$(VXLROOT)/v3p/tiff/$(OUTDIR)"  /LIBPATH:"$(VXLROOT)/v3p/tiff"  "opengl32.lib" "glu32.lib" "mvl.lib" "vgl.lib" "vcl.lib" "vnl_algo.lib" "netlib.lib" "vnl.lib" "vbl.lib" "vul.lib" "vil.lib" "vpl.lib" "jpeg.lib" "png.lib" "zlib.lib" "tiff.lib" /STACK:10000000  == libraries linked in 
...
!MESSAGE "octree - Win32 MinSizeRel" (based on "Win32 (x86) Application")
!MESSAGE "octree - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "octree - Win32 RelWithDebInfo" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vxl" /I "$(VXLROOT)/vcl/config.win32-VC60" /I "$(VXLROOT)/oxl" /I "$(VXLROOT)/gel" /I "$(VXLROOT)/v3p/jpeg" /I "$(VXLROOT)/v3p/png" /I "$(VXLROOT)/v3p/zlib" /I "$(VXLROOT)/v3p/tiff"    -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_OPENGL -DHAS_JPEG -DHAS_PNG -DHAS_ZLIB -DHAS_TIFF /D "octree_EXPORTS"
...
!ELSEIF  "$(CFG)" == "octree - Win32 MinSizeRel"
# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 0
...
# PROP Target_Dir ""
# ADD BASE CPP /nologo  /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS"  /FD /c
# ADD CPP /nologo  /D "WIN32" /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vxl" /I "$(VXLROOT)/vcl/config.win32-VC60" /I "$(VXLROOT)/oxl" /I "$(VXLROOT)/gel" /I "$(VXLROOT)/v3p/jpeg" /I "$(VXLROOT)/v3p/png" /I "$(VXLROOT)/v3p/zlib" /I "$(VXLROOT)/v3p/tiff"    -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_OPENGL -DHAS_JPEG -DHAS_PNG -DHAS_ZLIB -DHAS_TIFF /D "NDEBUG" /D "_CONSOLE" /D "_MBCS"  /FD /c
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vxl" /I "$(VXLROOT)/vcl/config.win32-VC60" /I "$(VXLROOT)/oxl" /I "$(VXLROOT)/gel" /I "$(VXLROOT)/v3p/jpeg" /I "$(VXLROOT)/v3p/png" /I "$(VXLROOT)/v3p/zlib" /I "$(VXLROOT)/v3p/tiff"    -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_OPENGL -DHAS_JPEG -DHAS_PNG -DHAS_ZLIB -DHAS_TIFF /D "octree_EXPORTS"
# ADD CPP /W3 /Zm1000 /GX /GR
# ADD CPP /MD /O1
# ADD BASE RSC /l 0x409 /d "NDEBUG"
...
!ELSEIF  "$(CFG)" == "octree - Win32 RelWithDebInfo"
...
# Name "octree - Win32 MinSizeRel"
# Name "octree - Win32 RelWithDebInfo"
...
SOURCE=.\Templates/vcl_map+vbl_triple+uint.uint.uint-.vnl_double_2~-.cxx

# End Source File
# Begin Source File

SOURCE=.\Templates/vcl_map+vbl_triple+uint.uint.uint-.vnl_double_3~-.cxx
