...
class pop_vertex
{
 public:
  ...
  //: find a path to another vertex - should be protected and
  //  accessed by freind edge TODO
  ...
  //: a flag to which states whether or not the vertex
  //  has been touched during a search
  bool touched_;
