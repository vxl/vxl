...
static void test_vdgl_io()
{
  ...
  dc->set_p0(new vsol_point_2d(e1.x(), e1.y()));
  dc->set_p1(new vsol_point_2d(e4.x(), e4.y()));
  ...
  vdgl_digital_curve_sptr dca = new vdgl_digital_curve(intp);
  dca->set_p0(new vsol_point_2d(e1.x(), e1.y()));
  dca->set_p1(new vsol_point_2d(e4.x(), e4.y()));
