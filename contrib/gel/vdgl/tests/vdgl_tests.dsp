...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "$(IUEROOT)\vcl\config.win32-vc60" /I "$(IUEROOT)\vcl" /I "$(IUEROOT)\vxl" /I "$(IUEROOT)\gel" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /Fp"Debug/itc.pch" /YX /FD /GZ /c
...
# ADD LINK32 vil.lib vgl.lib vbl.lib vnl.lib vcl.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"$(IUEROOT)\vxl\Debug" /libpath:"$(IUEROOT)\vxl\vdgl\Debug"
