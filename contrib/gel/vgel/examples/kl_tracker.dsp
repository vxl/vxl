# Microsoft Developer Studio Project File - Name="kl_tracker" - Package Owner=<4>
...
# /libpath:"$(VXLROOT)/vxl/vidl/$(OUTDIR)" /libpath:"$(VXLROOT)/gel/vgel/$(OUTDIR)" /libpath:"$(VXLROOT)/gel/vgel/kl/$(OUTDIR)" /libpath:"$(VXLROOT)/oxl/mvl/$(OUTDIR)" /libpath:"$(VXLROOT)/gel/vtol/$(OUTDIR)" /libpath:"$(VXLROOT)/gel/vsol/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vgl/algo/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vgl/$(OUTDIR)" /libpath:"$(VXLROOT)/vcl/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vnl/algo/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/netlib/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vnl/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vbl/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vul/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vil/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vpl/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/jpeg/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/png/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/zlib/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/tiff/$(OUTDIR)"  "opengl32.lib" "glu32.lib" "vidl.lib" "vgel.lib" "vgel_kl.lib" "mvl.lib" "vtol.lib" "vsol.lib" "vgl_algo.lib" "vgl.lib" "vcl.lib" "vnl_algo.lib" "netlib.lib" "vnl.lib" "vbl.lib" "vul.lib" "vil.lib" "vpl.lib" "jpeg.lib" "png.lib" "zlib.lib" "tiff.lib" "mvl.lib" /STACK:10000000  == libraries linked in 
...
# ADD LINK32 /libpath:"$(VXLROOT)/vxl/vidl/$(OUTDIR)"
# ADD LINK32 /libpath:"$(VXLROOT)/gel/vgel/$(OUTDIR)"
# ADD LINK32 /libpath:"$(VXLROOT)/gel/vgel/kl/$(OUTDIR)"
# ADD LINK32 /libpath:"$(VXLROOT)/oxl/mvl/$(OUTDIR)"
