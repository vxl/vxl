...
!MESSAGE "vgel_kl - Win32 MinSizeRel" (based on "Win32 (x86) Static Library")
!MESSAGE "vgel_kl - Win32 Release" (based on "Win32 (x86) Static Library")
!MESSAGE "vgel_kl - Win32 RelWithDebInfo" (based on "Win32 (x86) Static Library")
# Begin Project
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vxl" /I "$(VXLROOT)/vcl/config.win32-VC60" /I "$(VXLROOT)/gel" /I "$(VXLROOT)/oxl"    -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_OPENGL /D "vgel_kl_EXPORTS"
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
!ELSEIF  "$(CFG)" == "vgel_kl - Win32 MinSizeRel"
...
!ELSEIF  "$(CFG)" == "vgel_kl - Win32 RelWithDebInfo"
...
# Name "vgel_kl - Win32 MinSizeRel"
# Name "vgel_kl - Win32 RelWithDebInfo"
