...
test_ifa_factory::test_ifa_factory()
{
...
void test_ifa_factory::reset()
{
  delete table_;
  table_ = new vcl_vector<ifp>;
}

vifa_int_face_attr_sptr test_ifa_factory::obtain_int_face_attr(vtol_intensity_face_sptr  face)
{
