...
public:
  vifa_coll_lines(vtol_edge_2d_sptr  e, double        angle_cutoff_deg = 5.0, double        endpt_distance = 3.0,
  ...
  static void  lms_fit(const vcl_vector<double>&  x, const vcl_vector<double>&  y, double&            A,
                       double&            B, double&            C);
...
private:
  static double  get_projected_length(const vtol_edge_2d&  e, const imp_line&    hyp_line, double&        v1_dist,
                                      double&        v2_dist);
