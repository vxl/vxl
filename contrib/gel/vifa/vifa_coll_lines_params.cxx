// This is contrib/gel/vifa/vifa_coll_lines_params.cxx
...
print_info(void)
{
	vcl_cout << "vifa_coll_lines_params:" << vcl_endl;
	vcl_cout << "  midpoint distance = " << _midpt_distance << vcl_endl;
	vcl_cout << "  angle tolerance   = " << _angle_tolerance << vcl_endl;
	vcl_cout << "  discard threshold = " << _discard_threshold << vcl_endl;
	vcl_cout << "  endpoint distance = " << _endpt_distance << vcl_endl;
}
