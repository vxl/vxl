...
int vifa_group_pgram::AngleLoc(imp_line_sptr  il)
{
  // Compute angle index
...
imp_line_sptr vifa_group_pgram::LineAtAngle(int  angle_bin)
{
...
//
void vifa_group_pgram::ComputeBoundingBox(void)
{
...
//
void vifa_group_pgram::ComputeDominantDirs(void)
{
