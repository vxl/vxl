...
public:
  ...
  vifa_group_pgram(imp_line_list&                 lg, const vifa_group_pgram_params& old_params,
...
inline void vifa_group_pgram::CheckUpdateBoundingBox(void)
{
  if( !bb_ )
    {
    bb_ = new vifa_bbox;
...
inline vifa_bbox_sptr vifa_group_pgram::GetBoundingBox(void)
{
