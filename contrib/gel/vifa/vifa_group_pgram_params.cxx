// This is contrib/gel/vifa/vifa_group_pgram_params.cxx
...
print_info(void)
{
	vcl_cout << "vifa_group_pgram_params:" << vcl_endl;
	vcl_cout << "  angle increment     = " << _angle_increment << vcl_endl;
	vcl_cout << "  max suppress radius = " << _max_suppress_radius << vcl_endl;
	vcl_cout << "  length ratio        = " << _length_ratio << vcl_endl;
}
