...
vifa_image_histogram::vifa_image_histogram(vil_image_view_base_sptr  image,
                                           double                    percentage)
{
...
void vifa_image_histogram::init(void)
{
  num = 1 << (byte_depth_ * 8);
...
void vifa_image_histogram::fill_histogram(vil_image_view_base_sptr  image,
                                          double                    /* percentage */)
{
