...
edge_2d_list & vifa_int_face_attr::GetEdges()
{
...
bool vifa_int_face_attr::ComputeAttributes()
{
  ComputeCacheValues();
...
// ones.
bool vifa_int_face_attr::GetAttributes(vcl_vector<float>&  attrs)
{
...
void vifa_int_face_attr::GetAttributeNames(vcl_vector<vcl_string>&  names)
{
...
bool vifa_int_face_attr::GetNativeAttributes(vcl_vector<float>& attrs)
{
...
float vifa_int_face_attr::AspectRatio()
{
  if( aspect_ratio_ < 0 )
    {
...
float vifa_int_face_attr::PerimeterLength()
{
  if( peri_length_ < 0 )
    {
...
float vifa_int_face_attr::WeightedPerimeterLength()
{
...
float vifa_int_face_attr::Complexity()
{
...
float vifa_int_face_attr::WeightedComplexity()
{
  float area = this->Area();
...
float vifa_int_face_attr::TwoPeakParallel()
{
...
float vifa_int_face_attr::FourPeakParallel()
{
...
float vifa_int_face_attr::EightyPercentParallel()
{
...
void vifa_int_face_attr::ComputeCacheValues()
{
