...
double vifa_int_face_attr_common::get_contrast_across_edge(vtol_edge_sptr  e, double dflt_cont)
{
...
void vifa_int_face_attr_common::init()
{
...
void vifa_int_face_attr_common::fit_lines()
{
...
void vifa_int_face_attr_common::find_collinear_lines()
{
...
float vifa_int_face_attr_common::compute_parallel_sal(vifa_group_pgram_params_sptr  gpp)
{
  float        sal = 0.f;
