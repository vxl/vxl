...
public:
  ...
  // : Full constructor
  vifa_int_face_attr_common(vdgl_fit_lines_params*    fitter_params, vifa_group_pgram_params*  gpp_s,
                            vifa_group_pgram_params*  gpp_w, vifa_coll_lines_params*   cpp,
                            vifa_norm_params*         np);
...
protected:
  ...
  bool      find_collinear_match(vtol_edge_2d_sptr edge, coll_list&        lines, double            dist_threshold,
