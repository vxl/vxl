...
public:
  ...
  virtual vifa_int_face_attr_sptr obtain_int_face_attr(vtol_intensity_face_sptr  face) = 0;

  virtual vifa_int_face_attr_sptr obtain_int_face_attr(vtol_intensity_face_sptr  face, vdgl_fit_lines_params*    fpp,
                                                       vifa_group_pgram_params*  gpp_s, vifa_group_pgram_params*  gpp_w,
                                                       vifa_norm_params*      np) = 0;
