...
iface_list & vifa_int_faces_adj_attr::GetFaces()
{
  if( !closure_valid_ )
    {
    faces_.clear();
...
bool vifa_int_faces_adj_attr::ComputeAttributes()
{
  if( !closure_valid_ )
    {
    this->compute_closure();
...
bool vifa_int_faces_adj_attr::GetAttributes(vcl_vector<float>& attrs)
{
...
void vifa_int_faces_adj_attr::GetAttributeNames(vcl_vector<vcl_string>& names)
{
...
// Assumes that
bool vifa_int_faces_adj_attr::GetNativeAttributes(vcl_vector<float>& attrs)
{
...
void vifa_int_faces_adj_attr::init()
{
  junk_percent_ = 0.0f;
...
iface_list * vifa_int_faces_adj_attr::get_adjacent_faces(vtol_intensity_face_sptr&  known_face)
{
