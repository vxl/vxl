...
vifa_int_faces_attr::vifa_int_faces_attr(vdgl_fit_lines_params*    fitter_params,
...
float vifa_int_faces_attr::CallAttrFunction(vifa_int_face_attr* seed_attr, int i)
{
  return (seed_attr->*(attr_get_funcs[i]) )();
}

void vifa_int_faces_attr::SetFaces(iface_list& v)
{
  // Save the new faces
  faces_ = v;
...
edge_2d_list & vifa_int_faces_attr::GetEdges()
{
...
// (center of mass).
void vifa_int_faces_attr::ComputeCentroid()
{
...
// individual face.
bool vifa_int_faces_attr::ComputeSingleFaceAttributes(bool forceP)
{
...
bool vifa_int_faces_attr::ComputeAttributes()
{
...
bool vifa_int_faces_attr::GetAttributes(vcl_vector<float>& attrs)
{
...
// inherited).
bool vifa_int_faces_attr::GetNativeAttributes(vcl_vector<float>& attrs)
{
...
void vifa_int_faces_attr::GetAttributeNames(vcl_vector<vcl_string>& names)
{
...
const char * vifa_int_faces_attr::GetBaseAttrName(int i)
{
...
vifa_histogram_sptr vifa_int_faces_attr::MakeAttrHist(vcl_vector<float>& attr_vals)
{
...
// area of all faces
float vifa_int_faces_attr::Area()
{
  if( !attr_map_.empty() )
    {
    area_ = 0;
...
float vifa_int_faces_attr::AspectRatio()
{
  return 0.f;
}

// a helper function
edge_list * vifa_int_faces_attr::GetPerimeterEdges()
{
...
float vifa_int_faces_attr::PerimeterLength()
{
  if( perimeter_ >= 0 )
    {
    // Wary of "if ... == -1.0f"
...
float vifa_int_faces_attr::WeightedPerimeterLength()
{
...
float vifa_int_faces_attr::Complexity()
{
  if( this->Area() <= 0 )
    {
    return 0.f;
...
float vifa_int_faces_attr::WeightedComplexity()
{
  if( this->Area() <= 0 )
    {
    return 0.f;
...
void vifa_int_faces_attr::SetNP()
{
  if( npobj_ )
    {
    npobj_->reset();
...
float vifa_int_faces_attr::TwoPeakParallel()
{
...
float vifa_int_faces_attr::FourPeakParallel()
{
...
float vifa_int_faces_attr::EightyPercentParallel()
{
