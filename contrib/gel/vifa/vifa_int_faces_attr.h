...
public:
  vifa_int_faces_attr(vdgl_fit_lines_params*       fitter_params = NULL, vifa_group_pgram_params*     gpp_s = NULL,
  ...
  vifa_int_faces_attr(iface_list&                  v, vdgl_fit_lines_params*       fitter_params = NULL,
                      vifa_group_pgram_params*     gpp_s = NULL, vifa_group_pgram_params*     gpp_w = NULL,
                      vifa_coll_lines_params*      cpp = NULL, vifa_norm_params*            np = NULL,
