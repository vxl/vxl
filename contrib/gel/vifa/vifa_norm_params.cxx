// This is contrib/gel/vifa/vifa_norm_params.cxx
...
print_info(void)
{
	vcl_cout << "vifa_norm_params:" << vcl_endl;
	vcl_cout << "  low % thresh    = " << _plow << vcl_endl;
	vcl_cout << "  high % thresh   = " << _phigh << vcl_endl;
	vcl_cout << "  low int thresh  = " << _ilow << vcl_endl;
	vcl_cout << "  high int thresh = " << _ihigh << vcl_endl;
	vcl_cout << "  int min         = " << _imin << vcl_endl;
	vcl_cout << "  int max         = " << _imax << vcl_endl;
}
