...
vifa_parallel_params::vifa_parallel_params(float  angle_min,
                                           float  angle_max,
                                           int  buckets)
{
  min_angle = angle_min;
...
vifa_parallel_params::vifa_parallel_params(const vifa_parallel_params& np)
...
vifa_parallel_params::vifa_parallel_params(vifa_parallel_params* np)
{
  if( np )
    {
    min_angle = np->min_angle;
...
void vifa_parallel_params::print_info(void)
{
