...
vmal_kl::vmal_kl(const vmal_kl_params & params):_params(params)
{
}
...
vcl_vector<vtol_vertex_2d_sptr>* vmal_kl::extract_points(vil_image & image)
{
...
KLT_PixelType* vmal_kl::convert_to_gs_image(vil_image &image)
{
