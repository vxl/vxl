												 ...
												 vnl_double_3 &trans, int bias)
{
	...
	norm0=norm0.normalize()*_radius; 
	vnl_double_2 norm1(-line1_p[1]+line1_q[1], -line1_q[0]+line1_p[0]);
	norm1=norm1.normalize()*_radius; 
	...
	vnl_double_3x3 r0;
	r0.set_identity();
	double costheta0=norm0[0]/_radius;
	double sintheta0=norm0[1]/_radius;
	...
	vnl_double_3x3 r1;
	r1.set_identity();
	double costheta1=norm1[0]/_radius;
	double sintheta1=norm1[1]/_radius;
