...
public:
	...
	~vmal_operators();
//-----------------------------------------------------------------------------
//: Project the point (x0,y0) on the segment [(ax,ay),(bx,by)]. (x,y) is the 
//:	projected point. It returns the orhtogonal distance. (x,y)=(-1,-1) if the 
//: projected point does not belong to the segment.
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//: Project the point x on the segment [a,b]. px is the 
//:	projected point. It returns the orhtogonal distance. px=(-1,-1) if the 
//: projected point does not belong to the segment.
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//: Compute the crossing point "inter" of a segment and a line. alpha is the angle
//: between the two. It returns true if the line crosses the segment inside 
//: [start_seg,end_seg], false otherwise.
//-----------------------------------------------------------------------------
