...
// : Constructor.
// ---------------------------------------------------------------------------
  vmal_rectifier(vmal_multi_view_data_vertex_sptr mvd_vertex, vmal_multi_view_data_edge_sptr mvd_edge, int ima_height,
                 int ima_width);

  vmal_rectifier(vcl_vector<vnl_vector<double> >* pts0, vcl_vector<vnl_vector<double> >* pts1, int ima_height,
                 int ima_width);
  ...
  void compute_joint_epipolar_transform_new(vnl_double_3* points0,                                           // Points in one view
                                            ...
                                            int & out_height, int & out_width, double sweeti, double sweetj, // Sweet spot in the first image
                                            bool affine /* = false */);

  void compute_initial_joint_epipolar_transforms(vnl_double_3* points0,                    // Points in one view
                                                 vnl_double_3* points1,                    // Points in the other view
                                                 int numpoints,                            // Number of matched points
                                                 vnl_double_3x3 & H0, vnl_double_3x3 & H1, // The matrices to be returned
  ...
  int compute_initial_joint_epipolar_transforms(const vnl_double_3x3 & Q, double ci, double cj, // Position of reference point in first image
  ...
  void factor_Q_matrix_SR(const vnl_double_3x3 & Q, // 3 x 3 matrix
                          vnl_double_3x3 & R,       // non-singular matrix
                          vnl_double_3x3 & S);      // Skew-symmetric part

  vnl_double_3x3 affine_correction(vnl_double_3* points0, vnl_double_3* points1, int numpoints,
                                   const vnl_double_3x3 & H0, const vnl_double_3x3 & H1);

  void apply_affine_correction(vnl_double_3* points0,                     // Points in one view
                               vnl_double_3* points1,                     // Points in the other view
                               int numpoints,                             // Number of matched points
                               vnl_double_3x3 & H0, vnl_double_3x3 & H1); // The matrices to be returned
