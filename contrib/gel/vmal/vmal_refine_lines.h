...
public:
  ...
  // ---------------------------------------------------------------------------
  void refine_lines_f(vnl_double_3 & line0p, vnl_double_3 & line0q, vnl_double_3 & line1p, vnl_double_3 & line1q,
                      const vnl_double_3x3 & F, vnl_double_3 & r_line0p, vnl_double_3 & r_line0q,
                      vnl_double_3 & r_line1p, vnl_double_3 & r_line1q);

  // ---------------------------------------------------------------------------
  // : Refine two lines using the homography matrix and keeping the intersection
  // ---------------------------------------------------------------------------
  void refine_lines_max_h(vnl_double_3 & line0p, vnl_double_3 & line0q, vnl_double_3 & line1p, vnl_double_3 & line1q,
                          const vnl_double_3x3 & H, vnl_double_3 & r_line0p, vnl_double_3 & r_line0q,
                          vnl_double_3 & r_line1p, vnl_double_3 & r_line1q);

  // ---------------------------------------------------------------------------
  // : Refine two lines using the homography matrix and extending to the union
  // ---------------------------------------------------------------------------
  void refine_lines_min_h(vnl_double_3 & line0p, vnl_double_3 & line0q, vnl_double_3 & line1p, vnl_double_3 & line1q,
                          const vnl_double_3x3 & H, vnl_double_3 & r_line0p, vnl_double_3 & r_line0q,
                          vnl_double_3 & r_line1p, vnl_double_3 & r_line1q);
