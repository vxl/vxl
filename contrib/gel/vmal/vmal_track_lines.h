...
// the homography.
// ---------------------------------------------------------------------------
  double lines_correlation(vtol_edge_2d_sptr line0, vtol_edge_2d_sptr line1, const vnl_double_3x3 & H,
                           vil1_memory_image_of<vxl_byte> & image0, vil1_memory_image_of<vxl_byte> & image1);
...
// -----------------------------------------------------------------------------
  vtol_edge_2d_sptr find_transfo(vtol_edge_2d_sptr line, vcl_vector<vtol_edge_2d_sptr>& fit_lines,
...
// -----------------------------------------------------------------------------
  void refine_line_at_min(vtol_edge_2d_sptr line0, vtol_edge_2d_sptr line1, vtol_edge_2d_sptr & new_line0,
                          vtol_edge_2d_sptr & new_line1, const vnl_double_3x3 & H);

  void sort_a_pair_of_line(vtol_edge_2d_sptr line0, vtol_edge_2d_sptr line1, vtol_edge_2d_sptr & new_line0,
                           vtol_edge_2d_sptr & new_line1);

  void cost_function(vtol_edge_2d_sptr line0, vtol_edge_2d_sptr t_line0, vtol_edge_2d_sptr line1,
                     const vil1_image & image0, const vil1_image & image1, const vnl_double_3x3 homo, double & result);
