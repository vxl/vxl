...
int main()
{
  ...
  vsol_point_2d_ref p2d = new vsol_point_2d(5.0,10.0);
  vcl_cout << "X and Y" << vcl_endl;
  vcl_cout << p2d->x() << " " << p2d->y() << vcl_endl;
  
  vsol_point_2d_ref p2d_1 = new vsol_point_2d(25.0,35.0);
  vcl_cout << "X and Y" << vcl_endl;
  ...
  vsol_point_2d_ref mid_2d = p2d_1->middle(*(p2d.ptr()));
  ...
  vsol_point_3d_ref p3d = new vsol_point_3d(5.0,10.0,15.0);
  vcl_cout << "X and Y and Z" << vcl_endl;
  vcl_cout << p3d->x() << " " << p3d->y() << " " << p3d->z() << vcl_endl;
  
  vsol_point_3d_ref p3d_1 = new vsol_point_3d(25.0,35.0,40.0);
  ...
  vsol_point_3d_ref mid_3d = p3d_1->middle(*(p3d.ptr()));
  vcl_cout << "middle" << vcl_endl;
