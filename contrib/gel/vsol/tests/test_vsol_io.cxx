...
void test_vsol_io()
{
  ...
  TEST("Testing polyline io", poly && poly_in && *poly == *poly_in, true);
  ...
  TEST("Testing polygon io", polyg && polyg_in && *polyg == *polyg_in, true);
  ...
  TEST("Testing box io", box && box_in && box->near_equal(*box_in,0.01f), true);
  bx_in.close();
