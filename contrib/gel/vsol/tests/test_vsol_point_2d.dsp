...
!MESSAGE "test_vsol_point_2d - Win32 MinSizeRel" (based on "Win32 (x86) Application")
!MESSAGE "test_vsol_point_2d - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "test_vsol_point_2d - Win32 RelWithDebInfo" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD CPP /I "$(IUEROOT)/WIN32-VC60/vcl" /I "$(IUEROOT)/WIN32-VC60/vxl" /I "$(IUEROOT)/vcl" /I "$(IUEROOT)/vcl/config.win32-VC60" /I "$(IUEROOT)/vxl" /I "$(IUEROOT)/gel"    -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_OPENGL /D "test_vsol_point_2d_EXPORTS"
...
!ELSEIF  "$(CFG)" == "test_vsol_point_2d - Win32 MinSizeRel"
# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 0
...
!ELSEIF  "$(CFG)" == "test_vsol_point_2d - Win32 RelWithDebInfo"
...
# Name "test_vsol_point_2d - Win32 MinSizeRel"
# Name "test_vsol_point_2d - Win32 RelWithDebInfo"
...
"test_vsol_point_2d.dsp" :  "$(SOURCE)" "$(INTDIR)" "$(OUTDIR)"
