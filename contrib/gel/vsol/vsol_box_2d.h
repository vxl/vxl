...
class vsol_box_2d : public vbl_ref_count, public vsol_box, public vul_timestamp
{
 protected:
 ...
 public:
  ...
  virtual std::string is_a() const { return std::string("vsol_box_2d"); }
...
//: Stream operator
std::ostream&  operator<<(std::ostream& s, vsol_box_2d const& p);
...
inline void vsl_print_summary(std::ostream& os, vsol_box_2d_sptr const& b)
{
  os << *b;
}
