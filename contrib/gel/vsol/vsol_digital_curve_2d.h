...
class vsol_digital_curve_2d : public vsol_curve_2d
{
 ...
 public:
  ...
  //---------------------------------------------------------------------------
  virtual vsol_digital_curve_2d const*cast_to_digital_curve_2d(void)const{return this;}
  virtual vsol_digital_curve_2d *cast_to_digital_curve_2d(void) {return this;}
