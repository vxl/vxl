...
vsol_line_3d::vsol_line_3d(const vnl_vector_fixed<double,3> &new_direction,
                           const vsol_point_3d_ref &new_middle)
{
...
// -- Constructor
//---------------------------------------------------------------------------
vsol_line_3d::vsol_line_3d(const vsol_point_3d_ref &new_p0,
...
//---------------------------------------------------------------------------
vsol_spatial_object_3d_ref vsol_line_3d::clone(void) const
{
...
//---------------------------------------------------------------------------
vsol_point_3d_ref vsol_line_3d::middle(void) const
{
...
//---------------------------------------------------------------------------
vsol_point_3d_ref vsol_line_3d::p0(void) const
{
  return p0_;
}
...
//---------------------------------------------------------------------------
vsol_point_3d_ref vsol_line_3d::p1(void) const
{
  return p1_;
}
...
//---------------------------------------------------------------------------
void vsol_line_3d::set_p0(const vsol_point_3d_ref &new_p0)
{
  p0_=new_p0;
}
...
//---------------------------------------------------------------------------
void vsol_line_3d::set_p1(const vsol_point_3d_ref &new_p1)
{
  p1_=new_p1;
}
...
// -- Is `p' in `this' ?
//---------------------------------------------------------------------------
bool vsol_line_3d::in(const vsol_point_3d_ref &p) const
{
  bool result;
  double dot_product;
  double ax;
...
vsol_line_3d::tangent_at_point(const vsol_point_3d_ref &p) const
{
  assert(false); // TO DO
  // require
  // assert(in(p));
