# Microsoft Developer Studio Project File - Name="vsrl_viewer" - Package Owner=<4>
...
# vsrl_viewer  == name of output library
...
CFG=vsrl_viewer - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "vsrl_viewer.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "vsrl_viewer.mak" CFG="vsrl_viewer - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "vsrl_viewer - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "vsrl_viewer - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "vsrl_viewer - Win32 Release"
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/core" /I "$(VXLROOT)/contrib/gel" /I "$(VXLROOT)/v3p/jpeg" /I "$(VXLROOT)/v3p/png" /I "$(VXLROOT)/v3p/zlib" /I "$(VXLROOT)/v3p/tiff" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_OPENGL -DHAS_JPEG -DHAS_PNG -DHAS_ZLIB -DHAS_TIFF /D "vsrl_viewer_EXPORTS"
...
!ELSEIF  "$(CFG)" == "vsrl_viewer - Win32 Debug"
...
# Name "vsrl_viewer - Win32 Release"
# Name "vsrl_viewer - Win32 Debug"

# Begin Group "Source Files"
# PROP Default_Filter "cxx"
# Begin Source File
SOURCE=.\vsrl_viewer.cxx
# End Source File
# End Group
# End Target
# End Project
