...
// inorder to spread out the disparaty from salient pixels
...
class vsrl_saliency_diffusion : public vsrl_diffusion
{
 public:
  ...
  // set the initial disparaty based on a step diffusion 
  // mechanism 
  
  void set_initial_disparaty(vsrl_diffusion *diffusion);
 ...
 protected:
  ...
  void difuse_disparaty(int num_iter);
