...
vtol_extract_topology_vertex_node::vtol_extract_topology_vertex_node( unsigned in_i, unsigned in_j )
  : i( in_i ),
  j( in_j ),
...
void
vtol_extract_topology_region_type::push_back( edgel_chain_sptr chain )
{
...
unsigned
vtol_extract_topology_region_type::size() const
{
  return list_.size();
}
...
vtol_extract_topology_region_type::operator[]( unsigned i ) const
{
...
vtol_one_chain_sptr
vtol_extract_topology_region_type::make_one_chain() const
{
