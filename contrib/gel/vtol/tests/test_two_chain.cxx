...
int main(int, char **)
{
  ...
  vtol_two_chain_ref tc1_copy = new vtol_two_chain(*tc1);

  Assert(*tc1 == *tc1_copy);

  Assert(!(*tc1 == *tc2));

  vsol_spatial_object_3d_ref tc2_clone = tc2->clone();
  ...
  vtol_vertex_2d_ref v9 = new vtol_vertex_2d(1.0,0.0);
  vtol_vertex_2d_ref v10 = new vtol_vertex_2d(2.0,1.0);
  vtol_vertex_2d_ref v11 = new vtol_vertex_2d(3.0,2.0);
  vtol_vertex_2d_ref v12 = new vtol_vertex_2d(4.0,3.0);
  ...
  vtol_face_2d_ref f3 = new vtol_face_2d(v_list3);
  ...
  vtol_two_chain_ref new_copy = new vtol_two_chain(*tc1);
  Assert(*new_copy == *tc1);
