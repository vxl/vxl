# Microsoft Developer Studio Project File - Name="test_zero_chain" - Package Owner=<4>
...
# /libpath:"$(VXLROOT)/gel/vtol/$(OUTDIR)" /libpath:"$(VXLROOT)/gel/vsol/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vgl/algo/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vgl/$(OUTDIR)" /libpath:"$(VXLROOT)/vcl/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vnl/algo/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/netlib/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vnl/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vbl/$(OUTDIR)" /libpath:"$(VXLROOT)/vxl/vul/$(OUTDIR)"  "opengl32.lib" "glu32.lib" "vtol.lib" "vsol.lib" "vgl_algo.lib" "vnl_algo.lib" "netlib.lib" "vnl.lib" "vbl.lib" "vgl.lib" "vul.lib" "vcl.lib" /STACK:10000000  == libraries linked in 
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vcl/config.win32-VC60" /I "$(VXLROOT)/vxl" /I "$(VXLROOT)/gel"    -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_OPENGL /D "test_zero_chain_EXPORTS"
