...
public:
  ...
  //
  static bool intersect_edges(vcl_vector<vtol_edge_sptr>& s1, vcl_vector<vtol_edge_sptr>& s2,
                              vcl_vector<vtol_edge_sptr>& s1_and_s2);

  static bool difference_edges(vcl_vector<vtol_edge_sptr>& s1, vcl_vector<vtol_edge_sptr>& s2,
