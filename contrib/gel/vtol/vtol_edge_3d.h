...
public:
  ...
  // inline const vsol_curve_3d_sptr get_curve(void) const { return _curve;}
  // inline vsol_curve_3d_sptr get_curve(void) { return _curve;}
