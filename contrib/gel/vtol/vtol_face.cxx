...
std::vector<vtol_vertex*> *vtol_face::outside_boundary_compute_vertices(void)
{
...
std::vector<vtol_vertex*> *vtol_face::compute_vertices(void)
{
...
std::vector<vtol_zero_chain*> *vtol_face::outside_boundary_compute_zero_chains(void)
{
...
std::vector<vtol_zero_chain*> *vtol_face::compute_zero_chains(void)
{
...
std::vector<vtol_edge*> *vtol_face::outside_boundary_compute_edges(void)
{
...
std::vector<vtol_edge*> *vtol_face::compute_edges(void)
{
...
std::vector<vtol_one_chain*> *vtol_face::outside_boundary_compute_one_chains(void)
{
  COPY_INF(one_chain);
}
...
std::vector<vtol_one_chain*> *vtol_face::compute_one_chains(void)
{
...
std::vector<vtol_face*>  *vtol_face::compute_faces(void)
{
  LIST_SELF(vtol_face);
}

//: Returns a list of all the two_chains which contain the vtol_face.
std::vector<vtol_two_chain*>  *vtol_face::compute_two_chains(void)
{
...
std::vector<vtol_block*> *vtol_face::compute_blocks(void)
{
