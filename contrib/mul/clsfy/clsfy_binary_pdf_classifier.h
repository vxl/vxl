...
//: The value of log probability density above which the answer is 1, below which is 0;
...
// Specify the log probability density limit;
  clsfy_binary_pdf_classifier(const vpdfl_pdf_base &pdf,
    double log_prob_limit):
		pdf_(pdf.clone()),
    log_prob_limit_(log_prob_limit) {};
...
//: The dimensionality of input vectors.
  unsigned virtual n_dims() const { assert(pdf_); return pdf_->n_dims();} 
