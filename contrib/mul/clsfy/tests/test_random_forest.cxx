...
//        const double epsilon=0.01;
...

    {
        ...
        }
        {
            ...
            vcl_cout<<"OOB False Positive Rate "<<double (fpr)/dtn<<vcl_endl;
            
            vcl_cout<<"OOB True Negative Rate "<<double (tnr)/dtn<<vcl_endl;
            vcl_cout<<"OOB False Negative Rate "<<double (fnr)/dtp<<vcl_endl;
