# Microsoft Developer Studio Project File - Name="test_fhs" - Package Owner=<4>
...
# test_fhs  == name of output library
# /libpath:"$(VXLROOT)/contrib/mul/fhs/$(OUTDIR)" /libpath:"$(VXLROOT)/contrib/mul/vimt/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vnl/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vil/algo/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vil/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/netlib/$(OUTDIR)" /libpath:"$(VXLROOT)/vcl/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vsl/$(OUTDIR)" "fhs.lib" "vimt.lib" "vnl.lib" "vil_algo.lib" "vil.lib" "netlib.lib" "vsl.lib" "vcl.lib" /STACK:10000000  == libraries linked in 
# TARGTYPE "Win32 (x86) Application" 0x0103

CFG=test_fhs - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "test_fhs.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "test_fhs.mak" CFG="test_fhs - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "test_fhs - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "test_fhs - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/contrib/mul" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "test_fhs_EXPORTS"
...
# ADD LINK32 /libpath:"$(VXLROOT)/contrib/mul/fhs/$(OUTDIR)"
