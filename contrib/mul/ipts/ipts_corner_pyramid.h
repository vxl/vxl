// This is mul/ipts/ipts_corner_pyramid.h
...
void ipts_corner_pyramid(const vimt_image_2d_of<float>& image, vimt_image_pyramid& corner_pyramid,
                         vimt_image_pyramid& smooth_pyramid, double scale_step);
