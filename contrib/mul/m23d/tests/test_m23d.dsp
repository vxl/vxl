# Microsoft Developer Studio Project File - Name="test_m23d" - Package Owner=<4>
...
# test_m23d  == name of output library
# /libpath:"$(VXLROOT)/contrib/mul/m23d/$(OUTDIR)" /libpath:"$(VXLROOT)/contrib/mul/mbl/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vnl/io/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vnl/$(OUTDIR)" /libpath:"$(VXLROOT)/vcl/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vsl/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vnl/algo/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/netlib/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vbl/io/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vbl/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vgl/io/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vgl/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vil/io/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vil/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vpl/$(OUTDIR)" "m23d.lib" "mbl.lib" "vnl_io.lib" "vnl_algo.lib" "netlib.lib" "vnl.lib" "vbl_io.lib" "vbl.lib" "vgl_io.lib" "vgl.lib" "vil_io.lib" "vil.lib" "vpl.lib" "vsl.lib" "vcl.lib" /STACK:10000000  == libraries linked in 
# TARGTYPE "Win32 (x86) Application" 0x0103

CFG=test_m23d - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "test_m23d.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "test_m23d.mak" CFG="test_m23d - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "test_m23d - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "test_m23d - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "test_m23d - Win32 Release"
# PROP BASE Use_MFC 0
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/contrib/mul" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_JPEG -DHAS_PNG -DHAS_ZLIB -DHAS_TIFF /D "test_m23d_EXPORTS"
...
# ADD LINK32 /libpath:"$(VXLROOT)/contrib/mul/m23d/$(OUTDIR)"
...
# ADD LINK32 "m23d.lib" "mbl.lib" "vnl_io.lib" "vnl_algo.lib" "netlib.lib" "vnl.lib" "vbl_io.lib" "vbl.lib" "vgl_io.lib" "vgl.lib" "vil_io.lib" "vil.lib" "vpl.lib" "vsl.lib" "vcl.lib" /STACK:10000000 
!ELSEIF  "$(CFG)" == "test_m23d - Win32 Debug"
# PROP BASE Use_MFC 0
...
# Name "test_m23d - Win32 Release"
# Name "test_m23d - Win32 Debug"
...
# End Source File
# Begin Source File
SOURCE=.\test_correction_matrix_error.cxx
# End Source File
# Begin Source File
SOURCE=.\test_make_ortho_projection.cxx
# End Source File
# Begin Source File
SOURCE=.\test_ortho_flexible_builder.cxx
# End Source File
# Begin Source File
SOURCE=.\test_ortho_rigid_builder.cxx
# End Source File
# Begin Source File
SOURCE=.\test_rotation_from_ortho_projection.cxx
# End Source File
# Begin Source File
