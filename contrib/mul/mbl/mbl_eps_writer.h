...
private:
  ...
  void draw_grey_image_block(const vil_image_view<vxl_byte>& image, double tx, double ty, double pixel_width_x,
  ...
  //  Image must be no bigger than 255x255.
  //  Some postscript can't cope with bigger blocks.
  void draw_rgb_image_block(const vil_image_view<vxl_byte>& image, double tx, double ty, double pixel_width_x,
                            double pixel_width_y);
  ...
  //  Image must be no bigger than 255x255.
  //  Some postscript can't cope with bigger blocks.
  void draw_image_block(const vil_image_view<vxl_byte>& image, double tx, double ty, double pixel_width_x,
                        double pixel_width_y);
...
public:
  ...
  void draw_box(double x, double y, double width, double height, bool filled = false);
  ...
  //  Size in points given by sx(),sy() * given values.
  void draw_image(const vil_image_view<vxl_byte>& image, double tx, double ty, double pixel_width_x,
                  double pixel_width_y);
