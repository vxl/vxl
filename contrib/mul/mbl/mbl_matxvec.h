...
void NC_VecXMat(const vnl_vector<double>& V, const vnl_matrix<double>& M, vnl_matrix<double>& R);
...
#if 0
void TC_MatXVec(const vnl_matrix<double>& M, const vnl_vector<double>& V, vnl_vector<double>& R,
