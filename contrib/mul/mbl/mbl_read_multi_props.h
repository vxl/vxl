...
public:
  ...
  void get_required_properties(const vcl_string& label, vcl_vector<vcl_string>& values,
  ...
  void get_optional_properties(const vcl_string& label, vcl_vector<vcl_string>& values,
                               const unsigned nmax = (unsigned)(-1) ); // =max<unsigned>
