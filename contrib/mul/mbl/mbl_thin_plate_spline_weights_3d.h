...
class mbl_thin_plate_spline_weights_3d
{
  ...
  void set_up_rhs(vnl_vector<double>& Bx, vnl_vector<double>& By, vnl_vector<double>& Bz,
                  const vcl_vector<vgl_point_3d<double> >& dest_pts);

  // : Compute spline-bending energy
  void compute_energy(vnl_vector<double>& W1, vnl_vector<double>& W2, vnl_vector<double>& W3,
...
public:
  ...
  void build(const vcl_vector<vgl_point_3d<double> >& source_pts, const vcl_vector<vgl_point_3d<double> >& dest_pts,
