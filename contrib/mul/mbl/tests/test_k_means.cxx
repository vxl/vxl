...
void test_k_means()
{
  ...
  i = 0;
  while( i < nCentres && bbox.inside(centres[i].data_block() ) )
    {
    i++;
    }
  ...
  i = 0;
  while( i < centres.size() && bbox.inside(centres[i].data_block() ) )
    {
    i++;
    }
  ...
  i = 0;
  while( i<centres.size() && centres[i] (0)> 0.5 )
    {
    i++;
    }
