...
int main2(int argc, char * argv[])
{
  ...
  vul_arg<vcl_string> format("-fmt",
                             "Specify the output format, e.g. \"table\", \"list\" (default is list). See help for more details.");
  vul_arg<bool>       nohead("-h", "Specify this to SUPPRESS column headers in tabular format", false);
  vul_arg<vcl_string> sep("-sep",
                          "String to use as a separator between columns in tabular format, e.g. \", \" or \"  \" (default=TAB)",
                          "\t");
  ...
  vul_arg<vcl_vector<int> > pc("-pc",
                               "Specify this switch with 1 or more comma-separated integers (e.g. 5,50,95) to record percentile(s)");
  vul_arg<vcl_vector<double> > quant("-q",
                                     "Specify this switch with 1 or more comma-separated floats (e.g. 0.05,0.50,0.95) to record quantile(s)");
