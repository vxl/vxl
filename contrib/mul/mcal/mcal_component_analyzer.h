...
public:
  ...
  virtual void build(mbl_data_wrapper<vnl_vector<double> >& data, vnl_vector<double>& mean, vnl_matrix<double>& modes,
  ...
  virtual void build_about_mean(mbl_data_wrapper<vnl_vector<double> >& data, const vnl_vector<double>& mean,
                                vnl_matrix<double>& modes, vnl_vector<double>& mode_var) = 0;

  // : Build mean and modes from data in array data[0..n-1]
  //  Utility function - wraps data and uses build(data,mean,modes)
  virtual void build_from_array(const vnl_vector<double>* data, int n, vnl_vector<double>& mean,
