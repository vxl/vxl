...
public:
  ...
  mcal_pair_cost2(const vnl_vector<double>& proj1, const vnl_vector<double>& proj2, const vnl_vector<double>& mode1,
                  const vnl_vector<double>& mode2, mcal_single_basis_cost& cost);
