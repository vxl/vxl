...
//  shade of grey.
void mfpf_draw_matches(const mfpf_point_finder& pf, const vimt_image_2d_of<float>& image, const mfpf_pose_set& matches,
                       unsigned m_draw, vimt_image_2d_of<vxl_byte>& out_image);
