...
private:
  ...
  void diff_image(const vimt_image_2d_of<float>& image, const vgl_point_2d<double>& p, const vgl_vector_2d<double>& u,
                  vil_image_view<double>& grad_x, vil_image_view<double>& grad_y, int search_ni = 0, int search_nj = 0);
...
public:
  ...
  // : Define filter kernel to search with
  void set(const vil_image_view<double>& kx, const vil_image_view<double>& ky, double ref_x, double ref_y);
  ...
  virtual void evaluate_region(const vimt_image_2d_of<float>& image, const vgl_point_2d<double>& p,
                               const vgl_vector_2d<double>& u, vimt_image_2d_of<double>& response);
