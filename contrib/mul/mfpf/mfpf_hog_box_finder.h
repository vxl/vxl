...
public:
  ...
  void set(unsigned nA_bins, bool full360, unsigned ni, unsigned nj, unsigned nc, double ref_x, double ref_y,
           const mfpf_vec_cost& cost, const mbl_cloneable_nzptr<mipa_vector_normaliser>& normaliser);
