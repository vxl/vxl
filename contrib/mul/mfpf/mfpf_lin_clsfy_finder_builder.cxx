...
void mfpf_lin_clsfy_finder_builder::set_region(const mfpf_region_form& form)
{
  ...
  if( form.form() == "ellipse" )
    ...
    {
    vcl_cerr << "mfpf_lin_clsfy_finder_builder::set_region : Unknown form: " << form << vcl_endl;
    vcl_abort();
    }
}
  ...
  const vgl_vector_2d<double>& u)
{
  ...
  vcl_ptrdiff_t s_istep = sample.istep();
...
void mfpf_lin_clsfy_finder_builder::build(mfpf_point_finder& pf)
{
  ...
  vcl_cout << "Classifier Mean Error: " << mean_error << vcl_endl;
...
void mfpf_lin_clsfy_finder_builder::config_as_box(vcl_istream & is)
{
...
void mfpf_lin_clsfy_finder_builder::config_as_ellipse(vcl_istream & is)
{
  // Cycle through string and produce a map of properties
  vcl_string          s = mbl_parse_block(is);
  vcl_istringstream   ss(s);
...
bool mfpf_lin_clsfy_finder_builder::set_from_stream(vcl_istream & is)
{
  // Cycle through string and produce a map of properties
  vcl_string          s = mbl_parse_block(is);
  vcl_istringstream   ss(s);
...
vcl_string mfpf_lin_clsfy_finder_builder::is_a() const
{
  return vcl_string("mfpf_lin_clsfy_finder_builder");
}
...
void mfpf_lin_clsfy_finder_builder::print_summary(vcl_ostream& os) const
{
