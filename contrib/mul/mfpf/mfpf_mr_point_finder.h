...
public:
  ...
  void get_sample_vector(const vimt_image_pyramid& image_pyr, const vgl_point_2d<double>& p,
                         const vgl_vector_2d<double>& u, unsigned L, vcl_vector<double>& v);
  ...
  void multi_search(const vimt_image_pyramid& im_pyr, const mfpf_pose& pose0, vcl_vector<mfpf_pose>& poses,
  ...
  //  Final responses may be further improved with refine_match().
  void multi_search_and_prune(const vimt_image_pyramid& im_pyr, const mfpf_pose& pose0, vcl_vector<mfpf_pose>& poses,
                              vcl_vector<double>& fits, int prune_level = -1);
