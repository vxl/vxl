...
public:
  ...
  void set_size_and_levels(const mfpf_point_finder_builder& builder0, double wi, double wj, double scale_step,
                           int min_n_samples, int max_n_samples, double base_pixel_width = 1.0);
