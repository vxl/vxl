...
public:
  ...
  void get_pose(const vnl_vector<double>& params, vgl_point_2d<double>& p, vgl_vector_2d<double>& u) const;
  ...
  bool check_and_refine_minima(vnl_vector<double>& params, double & fit, unsigned index, double dx);
...
{
  return search_ni_ == pf.search_ni_ &&
