...
void mfpf_find_overlaps(mfpf_point_finder& pf, const vcl_vector<mfpf_pose>& poses, const mfpf_pose& pose,
...
void mfpf_prune_and_sort_overlaps(mfpf_point_finder& pf, vcl_vector<mfpf_pose>& poses, vcl_vector<double>& fits,
                                  unsigned max_n = 0);
