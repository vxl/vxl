...
void mil_transform_2d::set_identity()
{
...
void mil_transform_2d::set_affine(const vnl_matrix<double>& M23)  // 2x3 matrix
{
...
void mil_transform_2d::set_projective(const vnl_matrix<double>& M33)   // 3x3 matrix
{
