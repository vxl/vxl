...
void test_scale_pyramid_builder_2d()
{
  int nx = 20, ny = 20;
  vcl_cout << "\n\n**************************************************** \n";
  vcl_cout << " Testing mil_scale_pyramid_builder_2d (byte)(nx="<<nx<<")\n";
  vcl_cout << "*********************************************************\n";
  ...
  mil_scale_pyramid_builder_2d<vil_byte> builder;
  ...
  vsl_add_to_binary_loader(mil_scale_pyramid_builder_2d<vil_byte>());
  ...
  mil_scale_pyramid_builder_2d<vil_byte> builder_in;
