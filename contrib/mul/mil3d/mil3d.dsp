...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/contrib/mul" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "mil3d_EXPORTS"
...
# End Source File
# Begin Source File
SOURCE=.\Templates/mil3d_image_3d_of+byte-.cxx
# End Source File
# Begin Source File
SOURCE=.\Templates/mil3d_gaussian_pyramid_builder_3d+float-.cxx
# End Source File
# Begin Source File
SOURCE=.\Templates/mil3d_gaussian_pyramid_builder_3d+byte-.cxx
# End Source File
# Begin Source File
