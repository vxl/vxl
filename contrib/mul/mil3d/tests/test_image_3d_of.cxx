...
bool deepEquality(const mil3d_image_3d_of<vil1_byte>& im0,
                  const mil3d_image_3d_of<vil1_byte>& im1)
{
  bool ret=false;
...
void test_image_3d_of_byte()
{
  ...
  mil3d_image_3d_of<vil1_byte> image(2,2,2);
