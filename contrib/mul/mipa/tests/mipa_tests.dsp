# Microsoft Developer Studio Project File - Name="test_mipa" - Package Owner=<4>
...
# test_mipa  == name of output library
# /libpath:"$(VXLROOT)/contrib/mul/mipa/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vnl/io/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vnl/algo/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vnl/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/netlib/$(OUTDIR)" /libpath:"$(VXLROOT)/vcl/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vsl/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vbl/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vul/$(OUTDIR)" "mipa.lib" "vnl_io.lib" "vnl_algo.lib" "vnl.lib" "netlib.lib" "vsl.lib" "vcl.lib" "vbl.lib" "vul.lib" /STACK:10000000  == libraries linked in 
# TARGTYPE "Win32 (x86) Application" 0x0103

CFG=test_mipa - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "test_mipa.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "test_mipa.mak" CFG="test_mipa - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "test_mipa - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "test_mipa - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "test_mipa - Win32 Release"
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/contrib/mul" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "test_mipa_EXPORTS"
...
# ADD LINK32 /libpath:"$(VXLROOT)/contrib/mul/mipa/$(OUTDIR)"
...
# ADD LINK32 "mipa.lib" "vnl_algo.lib" "vnl_io.lib" "vnl.lib" "netlib.lib" "vsl.lib" "vcl.lib" "vbl.lib" "vul.lib" /STACK:10000000 

!ELSEIF  "$(CFG)" == "test_mipa - Win32 Debug"
...
# Name "test_mipa - Win32 Release"
# Name "test_mipa - Win32 Debug"
