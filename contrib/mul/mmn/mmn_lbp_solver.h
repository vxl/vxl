...
public:
  ...
  double operator()(const vcl_vector<vnl_vector<double> >& node_cost, const vcl_vector<vnl_matrix<double> >& arc_cost,
  ...
  {
    max_cycle_detection_count_ =
      max_cycle_detection_count;
  }
