...
inline bool operator==(const mmn_triplet& t1, const mmn_triplet& t2)
{
  if( t1.v1 == t2.v1 )
    ...
    if( t1.v2 == t2.v2 )
      {
      return t1.v3 == t2.v3;                // Order 1-2-3
      }
    if( t1.v2 == t2.v3 )
      {
      return t1.v3 == t2.v2;                // Order 1-3-2
      }
    return false;
    }
  if( t1.v1 == t2.v2 )
    ...
    if( t1.v2 == t2.v1 )
      {
      return t1.v3 == t2.v3;                // Order 2-1-3
      }
    if( t1.v2 == t2.v3 )
      {
      return t1.v3 == t2.v1;                // Order 3-1-2
      }
    return false;
    }
  if( t1.v1 == t2.v3 )
    ...
    if( t1.v2 == t2.v1 )
      {
      return t1.v3 == t2.v2;                // Order 2-3-1
      }
    if( t1.v2 == t2.v2 )
      {
      return t1.v3 == t2.v1;                // Order 3-2-1
      }
    return false;
    }
  return false;
