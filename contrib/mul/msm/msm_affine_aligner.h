#ifndef msm_affine_aligner_h_
#define msm_affine_aligner_h_
//:
// \file
// \author Tim Cootes
...
//  Similarity transformation encoded as (a-1,b,tx,c,d-1,ty).
//  Transformation is then x'=ax+by+tx, y' = cx+dy+ty.
class msm_affine_aligner : public msm_aligner
{
 public:

  ~msm_affine_aligner() override = default;
