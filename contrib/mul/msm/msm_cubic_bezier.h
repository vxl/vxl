...
public:
  ...
  void get_extra_points(double approx_sep, vcl_vector<vgl_point_2d<double> >& new_pts,
                        vcl_vector<vgl_vector_2d<double> >& new_normals, vcl_vector<unsigned>& control_pt_index) const;
