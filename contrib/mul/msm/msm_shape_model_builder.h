...
public:
  ...
  void build_model(const vcl_vector<msm_points>& shapes, const vcl_vector<vcl_vector<unsigned> >& pts_used,
  ...
  void build_within_class_model(const vcl_vector<msm_points>& shapes, const vcl_vector<int>& id,
                                const vcl_vector<vcl_vector<unsigned> >& pts_used, msm_shape_model& shape_model);
  ...
  //  any of the files.
  void build_from_files(const vcl_string& points_dir, const vcl_vector<vcl_string>& filenames,
                        msm_shape_model& shape_model);
...
void msm_load_shapes(const vcl_string& points_dir, const vcl_vector<vcl_string>& filenames,
