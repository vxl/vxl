#ifndef msm_zoom_aligner_h_
#define msm_zoom_aligner_h_
// :
// \file
// \author Tim Cootes
...
//  Transformation encoded as (log(s),tx,ty).
//  Transformation is then x'=sx+tx, y' = sy+ty.
class msm_zoom_aligner : public msm_aligner
{
public:
