...
public:
  ...
  //  \return Mean of B
  virtual double bootstrap_compare(vnl_vector<double>& B, const double* data, int n, const pdf1d_pdf& pdf,
                                   int n_trials);
  ...
  //  \return Mean of B
  virtual double bootstrap_compare_form(vnl_vector<double>& B, const double* data, int n, const pdf1d_builder& builder,
                                        int n_trials);
