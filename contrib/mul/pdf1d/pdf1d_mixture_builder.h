...
private:
  ...
  void e_step(pdf1d_mixture& model, vcl_vector<vnl_vector<double> >& probs, const double* data,
              const vcl_vector<double>& wts) const;

  // : The Maximisation part of the EM algorithm
  double m_step(pdf1d_mixture& model, const vcl_vector<vnl_vector<double> >& probs, const double* data,
                const vcl_vector<double>& wts) const;
