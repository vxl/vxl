...
int pdf1d_select_pdf(const double* data, int n, vcl_vector<const pdf1d_pdf *>& pdf,
                     vcl_vector<pdf1d_builder *>& pdf_builder, pdf1d_compare_to_pdf_bhat& comparator);
...
//  Returns index of the chosen pdf.
int pdf1d_select_pdf_form(const double* data, int n, vcl_vector<pdf1d_builder *>& pdf_builder,
                          pdf1d_compare_to_pdf& comparator);
