...
//  vcl_cout<<B_mean<<" sd:"<<sqrt(B_var)<<vcl_endl;
...
//   vcl_cout<<vcl_endl;
//   vcl_cout<<"Average SD: "<<sqrt(B_var_stats.mean())<<vcl_endl;
// }
									 ...
									 const vcl_string& path)
{
  ...
  for (int i=1;i<20;++i)
  {
    ...
    ofs<<ns<<" "<<B_mean<<" "<<sqrt(B_var)<<vcl_endl;
  }
