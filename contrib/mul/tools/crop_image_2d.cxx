...
int main2(int argc, char* argv[])
{
  ...
  if( bbi.set() )
    ...
    if( bbi()[0] >= bbi()[2] || bbi()[1] >= bbi()[3] )
      ...
      vcl_cerr
        <<
      "ERROR: -bbi argument should indicate the lower and upper corners of a 2D box with strictly positive width and height.\n";
      return 1;
      }
  ...
  if( bbf.set() )
    ...
    if( bbf()[0] >= bbf()[2] || bbf()[1] >= bbf()[3] )
      ...
      vcl_cerr
        <<
      "ERROR: -bbf argument should indicate the lower and upper corners of a 2D box with strictly positive width and height within [0,1]\n";
      return 1;
      }
    fx0 = bbf()[0]; fy0 = bbf()[1];
    fx1 = bbf()[2]; fy1 = bbf()[3];
  ...
  if( bbw.set() )
    ...
    if( bbw()[0] >= bbw()[2] || bbw()[1] >= bbw()[3] )
      ...
      vcl_cerr
        <<
      "ERROR: -bbw argument should indicate the lower and upper corners of a 2D box with strictly positive width and height.\n";
      return 1;
      }
    x0 = bbw()[0]; y0 = bbw()[1];
    x1 = bbw()[2]; y1 = bbw()[3];
