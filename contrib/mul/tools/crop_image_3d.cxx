...
int main2(int argc, char* argv[])
{
  ...
  vul_arg<bool>                  ignore_bounds_errors("-ib",
                                                      "adjust any bounding box values outside image to image edge",
                                                      false);
  ...
  if( bbi.set() )
    ...
    if( bbi()[0] >= bbi()[3] || bbi()[1] >= bbi()[4] || bbi()[2] >= bbi()[5] )
      ...
      vcl_cerr
        <<
      "ERROR: -bbi argument should indicate the lower and upper corners of a 3D box with strictly positive width, height and depth\n";
      return 1;
      }
  ...
  if( bbf.set() )
    ...
    if( bbf()[0] >= bbf()[3] || bbf()[1] >= bbf()[4] || bbf()[2] >= bbf()[5] )
      ...
      vcl_cerr
        <<
      "ERROR: -bbf argument should indicate the lower and upper corners of a 3D box with strictly positive width, height and depth within [0,1]\n";
      return 1;
      }
  ...
  if( bbw.set() )
    ...
    if( bbw()[0] >= bbw()[3] || bbw()[1] >= bbw()[4] || bbw()[2] >= bbw()[5] )
      ...
      vcl_cerr
        <<
      "ERROR: -bbw argument should indicate the lower and upper corners of a 3D box with strictly positive width, height and depth.\n";
      return 1;
      }
  ...
  if( cw.set() )
    ...
    if( cw()[0] < 0 || cw()[1] || cw()[2] < 0 || cw()[3] < 0 || cw()[4] < 0 || cw()[5] < 0 )
      ...
      vcl_cerr
        <<
      "ERROR: -cw argument should specify cropping widths on each face of the bounding box. Negative values are not allowed.\n";
      return 1;
      }
