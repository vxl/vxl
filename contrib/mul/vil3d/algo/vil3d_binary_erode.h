...
inline bool vil3d_binary_erode(const bool* im, const vcl_ptrdiff_t* offset, unsigned n)
{
...
void vil3d_binary_erode(const vil3d_image_view<bool>& src_image, vil3d_image_view<bool>& dest_image,
