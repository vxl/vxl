...
void vil3d_signed_distance_transform(vil3d_image_view<float>& image, const float distance_link_i,
                                     const float distance_link_j, const float distance_link_k)
{
...
void vil3d_distance_transform(vil3d_image_view<float>& image, const float distance_link_i, const float distance_link_j,
                              const float distance_link_k)
{
  // Low to high pass
                                      ...
                                      const float distance_link_k)
{
  ...
  const float distance_link_ijk = vcl_sqrt(
      distance_link_i * distance_link_i + distance_link_j * distance_link_j + distance_link_k * distance_link_k);
