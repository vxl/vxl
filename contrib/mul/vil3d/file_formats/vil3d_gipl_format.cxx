...
bool vil3d_gipl_image::read_header(vil_stream *is)
{
  ...
  // std::cout<<"Voxel widths: "<<vox_width1<<" x "<<vox_width2<<" x "<<vox_width3<<std::endl;
...
bool vil3d_gipl_image::write_header(void)
{
  ...
  {
    std::vector<vxl_byte> tempbuf(sizeof(vxl_uint_16));

    std::memcpy(&tempbuf[0], &dim1_, sizeof(vxl_uint_16));
    ConvertHostToMSB((char*)&tempbuf[0],sizeof(vxl_uint_16));
    os_->write((char*)&tempbuf[0],sizeof(vxl_uint_16));

    std::memcpy(&tempbuf[0], &dim2_, sizeof(vxl_uint_16));
    ConvertHostToMSB((char*)&tempbuf[0],sizeof(vxl_uint_16));
    os_->write((char*)&tempbuf[0],sizeof(vxl_uint_16));

    std::memcpy(&tempbuf[0], &dim3_, sizeof(vxl_uint_16));
    ConvertHostToMSB((char*)&tempbuf[0],sizeof(vxl_uint_16));
    os_->write((char*)&tempbuf[0],sizeof(vxl_uint_16));

    std::memcpy(&tempbuf[0], &nplanes_, sizeof(vxl_uint_16));
    ConvertHostToMSB((char*)&tempbuf[0],sizeof(vxl_uint_16));
    os_->write((char*)&tempbuf[0],sizeof(vxl_uint_16));
  }
  ...
  default :
    std::cerr << "vil3d_gipl_format::write_header() WARNING\n"
             << "  Unable to deal with file format : " << pixel_format_ << std::endl;
    return false;
  }
  if (VXL_BIG_ENDIAN)
  ...
  else
  {
    ...
    std::memcpy(&tempbuf[0], &temp, sizeof(vxl_uint_16));
    ConvertHostToMSB((char*)&tempbuf[0],sizeof(vxl_uint_16));
    os_->write((char*)&tempbuf[0],sizeof(vxl_uint_16));
  }
  ...
  {
    std::vector<float> tempbuf(sizeof(float));

    std::memcpy(&tempbuf[0],&vox_width1_,sizeof(float));
    ConvertHostToMSB((char*)&tempbuf[0],sizeof(float));
    os_->write((char*)&tempbuf[0],sizeof(float));

    std::memcpy(&tempbuf[0],&vox_width2_,sizeof(float));
    ConvertHostToMSB((char*)&tempbuf[0],sizeof(float));
    os_->write((char*)&tempbuf[0],sizeof(float));

    std::memcpy(&tempbuf[0],&vox_width3_,sizeof(float));
    ConvertHostToMSB((char*)&tempbuf[0],sizeof(float));
    os_->write((char*)&tempbuf[0],sizeof(float));
  }
  ...
  {
    std::vector<vxl_byte> tempbuf(sizeof(vxl_byte));
    std::memcpy(&tempbuf[0],&orientation_flag_,sizeof(vxl_byte));
  ...
  {
    std::vector<double> tempbuf(sizeof(double));
    std::memcpy(&tempbuf[0],&min_val_,sizeof(double));
  ...
  {
    std::vector<double> tempbuf(sizeof(double));
    std::memcpy(&tempbuf[0],&max_val_,sizeof(double));
    ConvertHostToMSB((char*)&tempbuf[0],sizeof(double));
    os_->write((char*)&tempbuf[0],sizeof(double));
  }
  ...
  else
  {
    ...
    std::memcpy(&tempbuf[0],&origin1_,sizeof(double));
    ConvertHostToMSB((char*)&tempbuf[0],sizeof(double));
    os_->write((char*)&tempbuf[0],sizeof(double));

    std::memcpy(&tempbuf[0],&origin2_,sizeof(double));
    ConvertHostToMSB((char*)&tempbuf[0],sizeof(double));
    os_->write((char*)&tempbuf[0],sizeof(double));

    std::memcpy(&tempbuf[0],&origin3_,sizeof(double));
    ConvertHostToMSB((char*)&tempbuf[0],sizeof(double));
    os_->write((char*)&tempbuf[0],sizeof(double));
  }
  ...
  {
    std::vector<float> tempbuf(sizeof(float));
    std::memcpy(&tempbuf[0],&interslice_gap_,sizeof(float));
    ConvertHostToMSB((char*)&tempbuf[0],sizeof(float));
...
//else
  ...
  if (view.pixel_format() == VIL_PIXEL_FORMAT_BOOL)
  {
    std::cerr << "GIPL writer for bool format is not yet implemented" ;
    return false;
  }
  ...
  else if (view.pixel_format() == VIL_PIXEL_FORMAT_UINT_16)
  {
    ...
    else
    {
      ...
      for (unsigned k = 0; k < view.nk(); ++k)
      {
        for (unsigned j = 0; j < view.nj(); ++j)
        {
          std::memcpy(&tempbuf[0], uint_16_im->origin_ptr()+(k*view.nj()*view.ni())+ (j * view.ni()), byte_out_width);
  ...
  else if (view.pixel_format() == VIL_PIXEL_FORMAT_INT_16)
  {
    ...
    else
    {
      ...
      for (unsigned k = 0; k < view.nk(); ++k)
      {
        for (unsigned j = 0; j < view.nj(); ++j)
        {
          std::memcpy(&tempbuf[0], int_16_im->origin_ptr()+(k*view.nj()*view.ni())+ (j * view.ni()), byte_out_width);
  ...
  else if (view.pixel_format() == VIL_PIXEL_FORMAT_UINT_32)
  {
    ...
    else
    {
      ...
      for (unsigned k = 0; k < view.nk(); ++k)
      {
        for (unsigned j = 0; j < view.nj(); ++j)
        {
          std::memcpy(&tempbuf[0], uint_32_im->origin_ptr()+(k*view.nj()*view.ni())+ (j * view.ni()), byte_out_width);
  ...
  else if (view.pixel_format() == VIL_PIXEL_FORMAT_INT_32)
  {
    ...
    else
    {
      ...
      for (unsigned k = 0; k < view.nk(); ++k)
      {
        for (unsigned j = 0; j < view.nj(); ++j)
        {
          std::memcpy(&tempbuf[0], int_32_im->origin_ptr()+(k*view.nj()*view.ni())+ (j * view.ni()), byte_out_width);
  ...
  else if (view.pixel_format() == VIL_PIXEL_FORMAT_FLOAT)
  {
    ...
    else
    {
      ...
      for (unsigned k = 0; k < view.nk(); ++k)
      {
        for (unsigned j = 0; j < view.nj(); ++j)
        {
          std::memcpy(&tempbuf[0], float_im->origin_ptr()+(k*view.nj()*view.ni())+ (j * view.ni()), byte_out_width);
  ...
  else if (view.pixel_format() == VIL_PIXEL_FORMAT_DOUBLE)
  {
    ...
    else
    {
      ...
      for (unsigned k = 0; k < view.nk(); ++k)
      {
        for (unsigned j = 0; j < view.nj(); ++j)
        {
          std::memcpy(&tempbuf[0], double_im->origin_ptr()+(k*view.nj()*view.ni())+ (j * view.ni()), byte_out_width);
