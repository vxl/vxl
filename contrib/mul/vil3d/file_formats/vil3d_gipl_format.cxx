// This is mul/vil3d/vil3d_gipl_format.cxx
	...
	switch (gipl_pixel_type)
	{
	  case (1): // Binary
		  vcl_cout<<"vil3d_gipl_format::read_stream()";
			vcl_cout<<" Binary not yet implemented"<<vcl_endl;
			return false;
/*		case (7): // Char
...
*/
	  ...
	  default:
		  vcl_cout<<"vil3d_gipl_format::read_stream()";
			vcl_cout<<" Unknown pixel type"<<vcl_endl;
			return false;
	}
...
bool vil3d_gipl_format::write_stream(const vil3d_header_data_sptr& header,
                           const vil3d_image_view_base_sptr& image,
									         vil2_stream *os)
{
  vcl_cerr<<"Writing to GIPL format not yet implemented. Sorry."<<vcl_endl;
  return false;
}
