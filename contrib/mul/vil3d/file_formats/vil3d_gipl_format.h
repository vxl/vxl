...
#if 0
  vil3d_gipl_image(vil_stream* os, unsigned ni, unsigned nj, unsigned nk, unsigned nplanes, enum vil_pixel_format);
#endif // 0

  vil3d_gipl_image(vil_stream* os, unsigned ni, unsigned nj, unsigned nk, unsigned nplanes,
                   enum vil_pixel_format format, float vox_width1 = 1.0, float vox_width2 = 1.0, float vox_width3 = 1.0,
                   char orientation_flag = 0, // GIPL_UNDEFINED_ORIENTATION
                   double min_val = 0.0, double max_val = 0.0, double origin1 = 0.0, double origin2 = 0.0,
                   double origin3 = 0.0, float interslice_gap = 0.0);
...
#if 0
  bool put_view(const vil3d_image_view_base& im, unsigned i0 = 0, unsigned j0 = 0, unsigned k0 = 0);
