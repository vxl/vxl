...
//     TEST_NEAR("vil3d_tricub_interp at grid point",v1,33.3f,1e-5);

//     double v2 = vil3d_tricub_interp_raw(3.4,3,3,image0.origin_ptr(),istep,jstep,kstep);
//     TEST_NEAR("vil3d_tricub_interp at off-grid point",v2,33.34f,1e-5);
//     double v3 = vil3d_tricub_interp_raw(3.4,3.5,3,image0.origin_ptr(),istep,jstep,kstep);
//     TEST_NEAR("vil3d_tricub_interp at off-grid point",v3,33.84f,1e-5);
//     double v4 = vil3d_tricub_interp_raw(3.4,3.5,3.5,image0.origin_ptr(),istep,jstep,kstep);
//     TEST_NEAR("vil3d_tricub_interp at off-grid point",v4,38.84f,1e-5);
  }
...
//     TEST_NEAR("vil3d_safe_tricub_interp outside image",v_outside,0,1e-5);
  }
}
...
static void test_tricub_interp_int()
{
  ...
  {
    double v1 = vil3d_tricub_interp_raw(3,3,3,image0.origin_ptr(),istep,jstep,kstep);
    TEST_NEAR("vil3d_tricub_interp at grid point",v1,333.0f,1e-5);

    double v2 = vil3d_tricub_interp_raw(3.4,3,3,image0.origin_ptr(),istep,jstep,kstep);
    TEST_NEAR("vil3d_tricub_interp at off-grid point",v2,333.4f,1e-5);

    double v3 = vil3d_tricub_interp_raw(3.4,3.5,3,image0.origin_ptr(),istep,jstep,kstep);
    TEST_NEAR("vil3d_tricub_interp at off-grid point",v3,338.4f,1e-5);

    double v4 = vil3d_tricub_interp_raw(3.4,3.5,3.5,image0.origin_ptr(),istep,jstep,kstep);
    TEST_NEAR("vil3d_tricub_interp at off-grid point",v4,388.4f,1e-5);
  }
