...
vil3d_image_resource_sptr vil3d_crop(const vil3d_image_resource_sptr & src, unsigned i0, unsigned ni, unsigned j0,
                                     unsigned nj, unsigned k0, unsigned nk);
...
{
public:
  vil3d_crop_image_resource(vil3d_image_resource_sptr const &, unsigned i0, unsigned ni, unsigned j0, unsigned nj,
                            unsigned k0, unsigned nk);
