...
class vil3d_memory_image : public vil3d_image_resource
{
  ...
  vil3d_memory_image(unsigned ni, unsigned nj, unsigned nk, unsigned nplanes, vil_pixel_format format);

  friend vil3d_image_resource_sptr vil3d_new_image_resource(unsigned ni, unsigned nj, unsigned nk, unsigned nplanes,
...
public:
  ...
  // \return 0 if unable to get view of correct size.
  virtual vil3d_image_view_base_sptr get_view(unsigned i0, unsigned ni, unsigned j0, unsigned nj, unsigned k0,
                                              unsigned nk) const;
