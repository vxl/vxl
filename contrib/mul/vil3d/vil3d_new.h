...
vil3d_image_resource_sptr vil3d_new_image_resource(unsigned ni, unsigned nj, unsigned nk, unsigned nplanes,
                                                   vil_pixel_format format);

// : Make a new image on disk.
// \relatesalso vil3d_image_resource
vil3d_image_resource_sptr vil3d_new_image_resource(const char* filename, unsigned ni, unsigned nj, unsigned nk,
