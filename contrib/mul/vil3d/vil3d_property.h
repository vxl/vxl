...
//  Type is float.
#define vil3d_property_pixel_size_i "pixel_size_i"

//: Pixel length in metres.
//  Type is float.
#define vil3d_property_pixel_size_j "pixel_size_j"

//: Pixel depth in metres.
//  Type is float.
#define vil3d_property_pixel_size_k "pixel_size_k"

//: Original image origin in pixels.
// Measured right from left - i.e. in i direction.  Type is float.
#define vil3d_property_offset_i "offset_i"

//: Original image origin in pixels.
// Measured down from top - i.e. in j direction. Type is float.
#define vil3d_property_offset_j "offset_j"
