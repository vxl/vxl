...
void vil3d_sample_profile_trilin(vecType* v, const vil3d_image_view<imType>& image, double x0, double y0, double z0,
                                 double dx, double dy, double dz, unsigned n);
...
// \relatesalso vil3d_image_view
template <class imType, class vecType>
void vil3d_sample_profile_trilin_extend(vecType* v, const vil3d_image_view<imType>& image, double x0, double y0,
                                        double z0, double dx, double dy, double dz, unsigned n);
...
// \relatesalso vil3d_image_view
template <class imType, class vecType>
void vil3d_sample_profile_trilin_edgena(vecType* v, const vil3d_image_view<imType>& image, double x0, double y0,
                                        double z0, double dx, double dy, double dz, unsigned n);
