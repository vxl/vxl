#ifndef vil3d_tricub_interp_txx_
...
#define vil3d_I(dx, dy, dz) (pix1[(dx) * xstep + (dy) * ystep + (dz) * zstep])
  ...
  double xi00 = s0
    * vil3d_I(-1, -1, -1) + s1 * vil3d_I(+0, -1, -1) + s2 * vil3d_I(+1, -1, -1) + s3 * vil3d_I(+2, -1, -1);
  double xi10 = s0
    * vil3d_I(-1, +0, -1) + s1 * vil3d_I(+0, +0, -1) + s2 * vil3d_I(+1, +0, -1) + s3 * vil3d_I(+2, +0, -1);
  double xi20 = s0
    * vil3d_I(-1, +1, -1) + s1 * vil3d_I(+0, +1, -1) + s2 * vil3d_I(+1, +1, -1) + s3 * vil3d_I(+2, +1, -1);
  double xi30 = s0
    * vil3d_I(-1, +2, -1) + s1 * vil3d_I(+0, +2, -1) + s2 * vil3d_I(+1, +2, -1) + s3 * vil3d_I(+2, +2, -1);

  double xi01 = s0
    * vil3d_I(-1, -1, +0) + s1 * vil3d_I(+0, -1, +0) + s2 * vil3d_I(+1, -1, +0) + s3 * vil3d_I(+2, -1, +0);
  double xi11 = s0
    * vil3d_I(-1, +0, +0) + s1 * vil3d_I(+0, +0, +0) + s2 * vil3d_I(+1, +0, +0) + s3 * vil3d_I(+2, +0, +0);
  double xi21 = s0
    * vil3d_I(-1, +1, +0) + s1 * vil3d_I(+0, +1, +0) + s2 * vil3d_I(+1, +1, +0) + s3 * vil3d_I(+2, +1, +0);
  double xi31 = s0
    * vil3d_I(-1, +2, +0) + s1 * vil3d_I(+0, +2, +0) + s2 * vil3d_I(+1, +2, +0) + s3 * vil3d_I(+2, +2, +0);
  ...
  double xi03 = s0
    * vil3d_I(-1, -1, +2) + s1 * vil3d_I(+0, -1, +2) + s2 * vil3d_I(+1, -1, +2) + s3 * vil3d_I(+2, -1, +2);
  double xi13 = s0
    * vil3d_I(-1, +0, +2) + s1 * vil3d_I(+0, +0, +2) + s2 * vil3d_I(+1, +0, +2) + s3 * vil3d_I(+2, +0, +2);
  double xi23 = s0
    * vil3d_I(-1, +1, +2) + s1 * vil3d_I(+0, +1, +2) + s2 * vil3d_I(+1, +1, +2) + s3 * vil3d_I(+2, +1, +2);
  double xi33 = s0
    * vil3d_I(-1, +2, +2) + s1 * vil3d_I(+0, +2, +2) + s2 * vil3d_I(+1, +2, +2) + s3 * vil3d_I(+2, +2, +2);
...
#endif // vil3d_tricub_interp_txx_
