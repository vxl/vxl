...
public:
  ...
  vimt_transform_2d & set_affine(const vgl_point_2d<double> & p, const vgl_vector_2d<double> & u,
  ...
  friend vimt_transform_2d operator*(const vimt_transform_2d &, const vimt_transform_2d &);
