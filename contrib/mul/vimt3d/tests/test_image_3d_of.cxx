...
{
  vcl_cout << "***************************\n";
  vcl_cout << " Testing vimt3d_image_3d_of\n";
  vcl_cout << "***************************\n";
  ...
  TEST ("Opened test_image_3d_of.bvl.tmp for reading",
           (!bfs_in), false);
  ...
  bfs_in.close();
	...
	TEST("Image data",
	     vil3d_image_view_deep_equality(image.image(),image2.image()),true);

  vimt3d_image_3d_of<vxl_byte> image3;
	image3.deep_copy(image);
	TEST("deep_copy()",
	     vil3d_image_view_deep_equality(image.image(),image3.image()),true);
