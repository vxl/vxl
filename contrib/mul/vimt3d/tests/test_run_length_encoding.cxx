...
void test_run_length_encoding1()
{
  ...
  TEST("Run length encoded image relaoded correcttly: ", image2.image()(8,9,10)==14 , true );
  TEST("Run length encoded image relaoded correcttly: ", image2.image()(1,2,2)==0 , true );
