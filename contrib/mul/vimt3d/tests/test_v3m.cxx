...
static void test_v3m()
{
  ...
  vcl_string fname1 = vul_temp_filename() + ".v3m";
  ...
  vcl_string fname2 = vul_temp_filename() + ".v3m";
    {
  ...
  TEST( "Got expected image size with just headers",
        ir5->ni() == 3 && ir5->nj() == 4 && ir5->nk() == 5 && ir5->nplanes() == 6, true);
