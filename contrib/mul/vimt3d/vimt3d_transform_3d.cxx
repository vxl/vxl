...
void vimt3d_transform_3d::angles(double& phi_x, double& phi_y, double& phi_z) const
{
  ...
  double det = +xx_ * yy_ * zz_ - xx_ * zy_ * yz_ - yx_ * xy_ * zz_ + yx_ * zy_ * xz_ + zx_ * xy_ * yz_ - zx_ * yy_
    * xz_;
...
void vimt3d_transform_3d::params(vnl_vector<double>& v) const
{
  switch( form_ )
    ...
    case (Affine):    // not sure this is right - kds
      ...
      double det = +xx_ * yy_ * zz_ - xx_ * zy_ * yz_ - yx_ * xy_ * zz_ + yx_ * zy_ * xz_ + zx_ * xy_ * yz_ - zx_
        * yy_ * xz_;
...
void vimt3d_transform_3d::calcInverse() const
{
  ...
  switch( form_ )
    ...
    case Affine: {
      ...
      xt2_ =
        (xy_ * yz_ * zt_ - xy_ * yt_ * zz_ - yy_ * xz_ * zt_ + yy_ * xt_ * zz_ + zy_ * xz_ * yt_ - zy_ * xt_ * yz_)
        / det;
      ...
      yt2_ =
        (-xx_ * yz_ * zt_ + xx_ * yt_ * zz_ + yx_ * xz_ * zt_ - yx_ * xt_ * zz_ - zx_ * xz_ * yt_ + zx_ * xt_ * yz_)
        / det;
      ...
      zt2_ =
        ( xx_ * yy_ * zt_ - xx_ * yt_ * zy_ - yx_ * xy_ * zt_ + yx_ * xt_ * zy_ + zx_ * xy_ * yt_ - zx_ * xt_ * yy_)
        / det;
