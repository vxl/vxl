...
# ADD LINK32 vpdfl.lib vnl_io.lib vsl.lib mbl.lib vnl_algo.lib netlib.lib vnl.lib vcl.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"$(VXLROOT)\mul\vpdfl\Debug" /libpath:"$(VXLROOT)\vxl\vnl\io\Debug" /libpath:"$(VXLROOT)\vxl\vsl\Debug" /libpath:"$(VXLROOT)\mul\mbl\Debug" /libpath:"$(VXLROOT)\vxl\vnl\algo\Debug" /libpath:"$(VXLROOT)\v3p\netlib\Debug" /libpath:"$(VXLROOT)\vxl\vnl\Debug" /libpath:"$(VXLROOT)\vcl\Debug"
