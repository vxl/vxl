...
class CardinalSpline
{
 public:
  ...
  controlPoints(cPoints), Mc(4,4,0.0), s(0.25) { setMc(s); }
  ...
  void print_summary(vcl_ostream &os) const { os << "Cardinal Spline\n"; }
  ...
  bool operator!=(const CardinalSpline &c) { return !(*this==c); }
