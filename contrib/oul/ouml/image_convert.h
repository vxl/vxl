...
template <>
vil1_memory_image_of<unsigned char> * convert_image<vil1_rgb<unsigned char>, unsigned char>(
  const vil1_memory_image_of<vil1_rgb<unsigned char> > & from, unsigned char & var);
