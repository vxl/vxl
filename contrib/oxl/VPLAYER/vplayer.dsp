...
# ADD LINK32 nafxcw.lib vil.lib vgl.lib vbl.lib vnl.lib vcl.lib alloxl.lib opengl32.lib glu32.lib /nologo /subsystem:console /machine:I386 /libpath:"$(IUEROOT)\vxl\Release" /libpath:"$(IUEROOT)\v3p\Release" /libpath:"$(IUEROOT)\oxl\Release"
...
# ADD LINK32 alloxl.lib vgui_vrml.lib vil.lib vgl.lib vbl.lib vnl.lib vcl.lib Qv.lib glu32.lib opengl32.lib vfw32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"$(IUEROOT)\vxl\Debug" /libpath:"$(IUEROOT)\v3p\Debug" /libpath:"$(IUEROOT)\oxl\Debug"
