...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "$(IUEROOT)\vcl\config.win32-vc60" /I "$(IUEROOT)/vcl" /I "$(IUEROOT)" /I "$(IUEROOT)/vxl" /I "$(IUEROOT)/oxl" /I "$(IUEROOT)/Oxford" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "HAS_MVOX" /D "_AFX_DLL" /D "_AFX_NO_DEBUG_CRT" /FD /c
# SUBTRACT CPP /YX
...
# ADD LINK32 nafxcw.lib allvxl.lib alloxl.lib opengl32.lib glu32.lib mvox.lib /nologo /subsystem:console /machine:I386 /libpath:"$(IUEROOT)/vxl/Release" /libpath:"$(IUEROOT)/v3p/Release" /libpath:"$(IUEROOT)/oxl/Release" /libpath:"$(IUEROOT)/Oxford/Release"
...
# ADD LINK32 alloxl.lib vgui_vrml.lib allvxl.lib Qv.lib glu32.lib opengl32.lib vfw32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"$(IUEROOT)/vxl/Debug" /libpath:"$(IUEROOT)/v3p/Debug" /libpath:"$(IUEROOT)/oxl/Debug" /libpath:"$(IUEROOT)/Oxford/Debug"
