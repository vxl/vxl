...
#  /LIBPATH:"$(IUEROOT)/v3p/Qv/$(IntDir)"  /LIBPATH:"$(IUEROOT)/v3p/Qv"  /LIBPATH:"$(IUEROOT)/oxl/osl/$(IntDir)"  /LIBPATH:"$(IUEROOT)/oxl/osl"  /LIBPATH:"$(IUEROOT)/vxl/vnl/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vxl/vnl"  /LIBPATH:"$(IUEROOT)/vxl/vnl/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vxl/vnl"  /LIBPATH:"$(IUEROOT)/vcl/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vcl"  /LIBPATH:"$(IUEROOT)/vcl/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vcl"  /LIBPATH:"$(IUEROOT)/vxl/vnl/algo/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vxl/vnl/algo"  /LIBPATH:"$(IUEROOT)/vxl/vnl/algo/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vxl/vnl/algo"  /LIBPATH:"$(IUEROOT)/v3p/netlib/$(IntDir)"  /LIBPATH:"$(IUEROOT)/v3p/netlib"  /LIBPATH:"$(IUEROOT)/vxl/vil/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vxl/vil"  /LIBPATH:"$(IUEROOT)/vxl/vil/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vxl/vil"  /LIBPATH:"$(IUEROOT)/vxl/vpl/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vxl/vpl"  /LIBPATH:"$(IUEROOT)/vxl/vpl/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vxl/vpl"  /LIBPATH:"$(IUEROOT)/v3p/jpeg/$(IntDir)"  /LIBPATH:"$(IUEROOT)/v3p/jpeg"  /LIBPATH:"$(IUEROOT)/v3p/jpeg/$(IntDir)"  /LIBPATH:"$(IUEROOT)/v3p/jpeg"  /LIBPATH:"$(IUEROOT)/v3p/png/$(IntDir)"  /LIBPATH:"$(IUEROOT)/v3p/png"  /LIBPATH:"$(IUEROOT)/v3p/png/$(IntDir)"  /LIBPATH:"$(IUEROOT)/v3p/png"  /LIBPATH:"$(IUEROOT)/v3p/zlib/$(IntDir)"  /LIBPATH:"$(IUEROOT)/v3p/zlib"  /LIBPATH:"$(IUEROOT)/v3p/zlib/$(IntDir)"  /LIBPATH:"$(IUEROOT)/v3p/zlib"  /LIBPATH:"$(IUEROOT)/v3p/tiff/$(IntDir)"  /LIBPATH:"$(IUEROOT)/v3p/tiff"  /LIBPATH:"$(IUEROOT)/v3p/tiff/$(IntDir)"  /LIBPATH:"$(IUEROOT)/v3p/tiff"  /LIBPATH:"$(IUEROOT)/vxl/vbl/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vxl/vbl"  /LIBPATH:"$(IUEROOT)/vxl/vbl/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vxl/vbl"  /LIBPATH:"$(IUEROOT)/oxl/mvl/$(IntDir)"  /LIBPATH:"$(IUEROOT)/oxl/mvl"  /LIBPATH:"$(IUEROOT)/oxl/vgui/impl/mfc/$(IntDir)"  /LIBPATH:"$(IUEROOT)/oxl/vgui/impl/mfc"  /LIBPATH:"$(IUEROOT)/oxl/vgui/impl/mfc/$(IntDir)"  /LIBPATH:"$(IUEROOT)/oxl/vgui/impl/mfc"  /LIBPATH:"$(IUEROOT)/oxl/vgui/$(IntDir)"  /LIBPATH:"$(IUEROOT)/oxl/vgui"  /LIBPATH:"$(IUEROOT)/oxl/vgui/$(IntDir)"  /LIBPATH:"$(IUEROOT)/oxl/vgui"  /LIBPATH:"$(IUEROOT)/vxl/vgl/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vxl/vgl"  /LIBPATH:"$(IUEROOT)/vxl/vul/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vxl/vul"  /LIBPATH:"$(IUEROOT)/vxl/vul/$(IntDir)"  /LIBPATH:"$(IUEROOT)/vxl/vul"  /LIBPATH:"$(IUEROOT)/oxl/vrml/$(IntDir)"  /LIBPATH:"$(IUEROOT)/oxl/vrml"  "opengl32.lib" "glu32.lib" "Qv.lib" "osl.lib" "vnl.lib" "vcl.lib" "vnl_algo.lib" "netlib.lib" "vnl.lib" "vcl.lib" "vil.lib" "vpl.lib" "jpeg.lib" "png.lib" "zlib.lib" "tiff.lib" "vbl.lib" "mvl.lib" "vnl.lib" "vcl.lib" "vnl_algo.lib" "netlib.lib" "vnl.lib" "vcl.lib" "vbl.lib" "vgui_mfc.lib" "vgui.lib" "vnl.lib" "vcl.lib" "vnl_algo.lib" "netlib.lib" "vnl.lib" "vcl.lib" "vil.lib" "vpl.lib" "vgl.lib" "vcl.lib" "vbl.lib" "vul.lib" "vgl.lib" "vcl.lib" "vil.lib" "vpl.lib" "vnl.lib" "vcl.lib" "vul.lib" "vbl.lib" "vpl.lib" "vcl.lib" "vbl.lib" "vrml.lib" /STACK:10000000  == libraries linked in 
...
"vxl_vrml_viewer.dsp" :  "$(SOURCE)" "$(INTDIR)" "$(OUTDIR)"
	"cmake.exe" "$(IUEROOT)/oxl/apps/vxl_vrml_viewer/CMakeLists.txt" -DSP -H"$(IUEROOT)" -S"$(IUEROOT)/oxl/apps/vxl_vrml_viewer" -O"$(IUEROOT)/oxl/apps/vxl_vrml_viewer" -B"$(IUEROOT)"
