...
fmk_libdeps += lib_osl:lib_vil,lib_vnl-algo,lib_vul,lib_vbl,pkg_oxl

fmk_libdeps += lib_mvox:lib_mvl

fmk_libdeps += lib_oxp:lib_vul,lib_vbl,lib_vil,lib_vnl-algo
fmk_libdeps += lib_mvl:lib_vnl-algo,lib_vgl,lib_vul,lib_vbl,lib_vil
fmk_libdeps += lib_vrml:lib_vgl,lib_vnl,lib_vul,lib_vbl
