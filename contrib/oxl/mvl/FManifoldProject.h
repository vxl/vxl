...
public:
  ...
  double correct(vgl_homg_point_2d<double> const& point1, vgl_homg_point_2d<double> const& point2,
  ...
  double correct(double   x1, double   y1, double   x2, double   y2, double * ox1, double * oy1, double * ox2,
                 double * oy2) const;
