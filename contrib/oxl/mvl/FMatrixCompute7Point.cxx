...
// (I obtained these co-efficients from Maple (fingers crossed!!!))
//
...
//-------------------
int FMatrixCompute7Point::solve_cubic (double a, double b, double c, double d,
                                       double *x1, double *x2, double *x3)
{
   ...
   *x2 = -2.0*vcl_sqrt(q)*vcl_cos((theta + 2.0*vnl_math::pi)/3.0) - b/3.0;
   *x3 = -2.0*vcl_sqrt(q)*vcl_cos((theta - 2.0*vnl_math::pi)/3.0) - b/3.0;
   return 3;
}
