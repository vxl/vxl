...
{
  get_epipoles(0, 0);
  return FMatrix(vnl_cross_product_matrix(e12_->get_vector() )
                 * dot3(e13_->get_vector().as_ref() ).transpose().as_ref() );
}
...
{
  get_epipoles(0, 0);
  return FMatrix(vnl_cross_product_matrix(e13_->get_vector() )
                 * dot2(e12_->get_vector().as_ref() ).transpose().as_ref() );
}
