...
public:
  ...
  TripleMatchSetCorner(HomgInterestPointSet const* corners1, HomgInterestPointSet const* corners2,
  ...
  void extract_matches(vcl_vector<HomgPoint2D>& points1, vcl_vector<HomgPoint2D>& points2,
