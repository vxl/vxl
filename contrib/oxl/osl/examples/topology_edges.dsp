...
# topology_edges  == name of output library
...
!MESSAGE 
!MESSAGE "topology_edges - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "topology_edges - Win32 MinSizeRel" (based on "Win32 (x86) Application")
!MESSAGE "topology_edges - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "topology_edges - Win32 RelWithDebInfo" (based on "Win32 (x86) Application")
!MESSAGE 
...
!ELSEIF  "$(CFG)" == "topology_edges - Win32 MinSizeRel"
# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 0
...
!ELSEIF  "$(CFG)" == "topology_edges - Win32 RelWithDebInfo"
...
# Name "topology_edges - Win32 MinSizeRel"
# Name "topology_edges - Win32 RelWithDebInfo"
...
USERDEP__HACK=\
	...
	"$(IUEROOT)/oxl/osl/examples/CMakeLists.txt"\
...
"topology_edges.dsp" :  "$(SOURCE)" "$(INTDIR)" "$(OUTDIR)"
	"cmake.exe" "$(IUEROOT)/oxl/osl/examples/CMakeLists.txt" -DSP -H"$(IUEROOT)" -S"$(IUEROOT)/oxl/osl/examples" -O"$(IUEROOT)/oxl/osl/examples" -B"$(IUEROOT)"
