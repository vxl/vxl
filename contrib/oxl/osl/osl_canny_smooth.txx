...
//               + ...
template <class T>
void osl_canny_smooth_rothwell(T const * const *image_in, int _xsize, int _ysize,
...
template <class T>
void osl_canny_smooth(T const * const * image_in, int _xsize, int _ysize,
...
template void osl_canny_smooth_rothwell(T const * const *image_in, int _xsize, int _ysize, \
                                        float const *_kernel, int _width, int _k_size, \
                                        float * unpro_const *_smooth); \
template void osl_canny_smooth_rothwell_adaptive(T const * const *in, int _xsize, int _ysize, \
                                                 int x0, int y0, int image_size,  \
                                                 float const *_kernel, int _width, int _k_size, \
