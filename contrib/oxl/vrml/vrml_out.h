...
public:
  ...
  void write_faces_textured(vcl_list<v<float> gl_polygon> const& triangles, char const* imagefilename, int xsize,
                            int ysize);

  void write_faces_textured(vcl_list<v<float> gl_polygon> const& triangles, char const* imagefilename, int xsize,
                            int ysize, vnl_matrix<double> const& Pmatrix);

  void write_faces_textured(vcl_list<v<float> gl_polygon> const& triangles, char const* imagefilename, int xsize,
                            int ysize, vcl_vector<vcl_pair<vgl_point_3d<double>, vgl_point_3d<double> > > &);
