// This is contrib/prip/vdtop/vdtop_4_lower_homotopic_kernel.h
#ifndef vdtop_4_lower_homotopic_kernel_h_
#define vdtop_4_lower_homotopic_kernel_h_

//:
// \file
// \brief Provides a function for computing a 4-connected lower homotopic kernel of Bertrand and al ( G. Bertrand, J. C. Everat and M. Couprie, "Image segmentation through operators based upon topology", Journal of Electronic Imaging, Vol. 6, N. 4, 395-405, 1997).
