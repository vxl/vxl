#include "vdtop_veinerization_builder.h"
...
template <class T>
void _vdtop_compute_first_veinerization_pass(vil_image_view<T> & img, const T& max_value, vil_image_view<vdtop_8_neighborhood_mask> & masks)
{
