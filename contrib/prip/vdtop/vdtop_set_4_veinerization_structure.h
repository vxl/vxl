// This is contrib/prip/vmdtop/vdtop_set_4_veinerization_structure.h
...
template <class T>
void vdtop_compute_4_veinerization_mask(vil_image_view<T> & img,  vil_image_view<vdtop_8_neighborhood_mask> & masks, int & nb_vertices, int & nb_edges) ;

//: Set a map from vmap so that it has the structure of a 4-veinerization. See  Marchadier Jocelyn, Walter Kropatsch, Allan Hanbury "Homotopic transformations of combinatorial maps", DGCI2003,  Lectures Notes On Computer Science no. 2886, page 134-143, 2003 for details and motivations.
...
#include "vdtop_set_4_veinerization_structure.txx"
