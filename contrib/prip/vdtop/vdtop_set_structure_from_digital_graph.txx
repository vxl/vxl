...
template <class TMap>
void vdtop_set_structure_from_digital_graph(TMap & res, const vil_image_view<vdtop_8_neighborhood_mask> & mask,int nb_vertices, int nb_edges, vmap_2_map_tag)
{
	int plane = 0 ;
...
template <class TMap>
void vdtop_set_structure_from_digital_graph(TMap & res, const vil_image_view<vdtop_8_neighborhood_mask> & mask,int nb_vertices, int nb_edges, vmap_2_tmap_tag)
{
	int plane = 0 ;
