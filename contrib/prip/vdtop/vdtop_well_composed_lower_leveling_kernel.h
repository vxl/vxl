// This is contrib/prip/vdtop/vdtop_well_composed_lower_leveling_kernel.h
#ifndef vdtop_well_composed_lower_leveling_kernel_h_
#define vdtop_well_composed_lower_leveling_kernel_h_

//:
// \file
// \brief Provides a function for computing a well composed connected lower leveling kernel of Bertrand and al ( G. Bertrand, J. C. Everat and M. Couprie, "Image segmentation through operators based upon topology", Journal of Electronic Imaging, Vol. 6, N. 4, 395-405, 1997).
