...
template <class V = vmap_2_tmap_vertex, class E = vmap_2_tmap_edge, class F = vmap_2_tmap_face,
          class D = vmap_2_tmap_dart>
...
public:
  ...
  typedef vmap_ptr_iterator_wrapper<vertex_type, vertex_type &, vertex_type *,
                                    vertex_sequence_iterator> vertex_iterator;
  // : A const_vertex_iterator iterates on a read-only sequence of vertices.
  typedef vmap_ptr_iterator_wrapper<vertex_type, vertex_type const &, vertex_type const *,
                                    const_vertex_sequence_iterator>
  ...
  typedef vmap_ptr_iterator_wrapper<edge_type, edge_type const &, edge_type const *,
                                    const_edge_sequence_iterator> const_edge_iterator;
  ...
  typedef vmap_ptr_iterator_wrapper<face_type, face_type const &, face_type const *,
                                    const_face_sequence_iterator> const_face_iterator;
...
public:
  ...
  // : One dart. Hard to use : alpha dart = this->nb_darts()-1-arg.
  void set_dart(vmap_dart_index arg, vmap_dart_index arg_sigma, vmap_dart_index arg_alpha, vmap_vertex_index arg_vertex,
                vmap_edge_index arg_edge, vmap_face_index arg_face);
