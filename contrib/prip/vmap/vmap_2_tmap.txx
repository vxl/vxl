// This is prip/vmap/vmap_2_tmap.txx
#ifndef vmap_2_tmap_txx_
#define vmap_2_tmap_txx_
...
void vmap_2_tmap<V, E, F, D>::contraction(contraction_kernel const& arg_kernel)
{
  ...
  for( id = this->nb_darts() - 1; id >= ld; id-- )
    {
#if 0
    vmap_2_tmap_dart* d = (vmap_2_tmap_dart *)this->get_dart_pointer(id), * bv = &*d->vertex().begin(),
      * bf = &*d->face().begin();
...
void  vmap_2_map<V, E, F, D>::set_edge(vmap_edge_index arg,
                                       vmap_edge_index arg_edge1, vmap_vertex_index arg_vertex1,
                                       vmap_face_index arg_face1,
                                       vmap_edge_index arg_edge2, vmap_vertex_index arg_vertex2,
                                       vmap_face_index arg_face2)
{
