// This is contrib/prip/vpyr/vpyr_2_pyramid.txx
...
void vpyr_2_pyramid<TLevel>::set_base_structure(const M & arg)
{
    ...
    _level.clear() ;
    _level.insert(level_array_type::value_type(::vmap_top_level_index(),level_type(::vmap_top_level_index(),(typename level_type::pyramid_type&) *this))) ;
}
