// This is contrib/prip/vpyr/vpyr_2_tpyramid.h
...
template < class TLevel=vpyr_2_tpyramid_level<vpyr_2_tpyramid_level_vertex,vpyr_2_tpyramid_level_edge,vpyr_2_tpyramid_level_face,vpyr_2_tpyramid_level_dart> >
...
public:
  ...
  //:
  //typedef vmap_2_tmap<typename TLevel::vertex_type::base_type,typename TLevel::edge_type::base_type,typename TLevel::face_type::base_type, typename TLevel::dart_type::base_type > base_map_type ;
  typedef typename _Base::base_map_type base_map_type ;
	
  //:
  typedef vpyr_2_tpyramid_level< typename TLevel::vertex_type,typename TLevel::edge_type,typename TLevel::face_type, typename TLevel::dart_type > base_level_type ;
	
  typedef TLevel level_type ;
  
  //:
  friend class vpyr_2_tpyramid_level< typename TLevel::vertex_type,typename TLevel::edge_type,typename TLevel::face_type, typename TLevel::dart_type > ;
