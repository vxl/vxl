...
public:
  ...
  // :
  typedef vmap_2_tmap<typename V::base_type, typename E::base_type, typename F::base_type,
                      typename D::base_type> base_map_type;
...
public:
  ...
  typedef vpyr_2_tpyramid_level_element_iterator<vertex_type, vertex_type &, vertex_type *, vertex_sequence_iterator>
    vertex_iterator;
  // :
  typedef vpyr_2_tpyramid_level_element_iterator<vertex_type, const vertex_type &, const vertex_type *,
  ...
  // :
  typedef vpyr_2_tpyramid_level_element_iterator<edge_type, edge_type &, edge_type *,
                                                 edge_sequence_iterator> edge_iterator;
  // :
  typedef vpyr_2_tpyramid_level_element_iterator<edge_type, const edge_type &, const edge_type *,
                                                 const_edge_sequence_iterator>
    const_edge_iterator;
  ...
  // :
  typedef vpyr_2_tpyramid_level_element_iterator<face_type, face_type &, face_type *,
                                                 face_sequence_iterator> face_iterator;
  // :
  typedef vpyr_2_tpyramid_level_element_iterator<face_type, const face_type &, const face_type *,
                                                 const_face_sequence_iterator>
    const_face_iterator;
