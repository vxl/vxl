...
rgrl_converge_status::rgrl_converge_status( converge_type conv,
                                            status_type stat,
                                            double error,
                                            unsigned osc_count,
                                            double error_diff )
...
rgrl_converge_status::rgrl_converge_status( bool     in_has_converged,
...
bool
rgrl_converge_status::has_converged() const
{
  return conv_ == converged;
}

bool
rgrl_converge_status::has_stagnated() const
{
  return conv_ == stagnated;
}

bool
rgrl_converge_status::is_good_enough() const
{
  return status_ == good_enough || status_ == good_and_terminate;
}

bool
rgrl_converge_status::is_good_and_should_terminate() const
{
  return status_ == good_and_terminate;
}

bool
rgrl_converge_status::is_failed() const
{
  return status_ == failed;
}

rgrl_converge_status::converge_type
rgrl_converge_status::current_converge() const
{
  return conv_;
}

rgrl_converge_status::status_type
rgrl_converge_status::current_status() const
{
  return status_;
}

void
rgrl_converge_status::set_current_converge( converge_type c )
{
  conv_ = c;
}

void
rgrl_converge_status::set_current_status( status_type s )
{
  status_ = s;
}

void
rgrl_converge_status::set_objective_value( double obj )
{
  error_ = obj;
}

double
rgrl_converge_status::objective_value() const
{
  return error_;
}

double
rgrl_converge_status::error() const
{
  return error_;
}

unsigned int
rgrl_converge_status::oscillation_count() const
{
  return oscillation_count_;
}

double
rgrl_converge_status::error_diff() const
{
  return error_diff_;
}
