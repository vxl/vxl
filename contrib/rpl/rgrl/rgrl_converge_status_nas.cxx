...
rgrl_converge_status_nas::rgrl_converge_status_nas( bool     in_has_converged,
...
void
rgrl_converge_status_nas::set_init_scaling_factors( vnl_vector<double> const& scaling )
{
