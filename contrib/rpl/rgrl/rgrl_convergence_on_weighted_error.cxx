...
rgrl_convergence_on_weighted_error::rgrl_convergence_on_weighted_error( double tol )
  : tolerance_( tol )
{
}
...
rgrl_convergence_on_weighted_error::compute_status( rgrl_converge_status_sptr               prev_status,
...
double
rgrl_convergence_on_weighted_error::compute_alignment_error( rgrl_set_of<rgrl_match_set_sptr> const& current_match_sets )
const
{
...
double
rgrl_convergence_on_weighted_error::compute_alignment_error( rgrl_match_set_sptr const& current_match_set ) const
{
...
rgrl_converge_status_sptr
rgrl_convergence_on_weighted_error::verify( rgrl_transformation_sptr         const & /*xform_estimate*/,
                                            rgrl_set_of<rgrl_match_set_sptr> const& current_match_sets,
