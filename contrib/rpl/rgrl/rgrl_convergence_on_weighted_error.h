...
public:
  ...
  virtual
  rgrl_converge_status_sptr verify( rgrl_transformation_sptr         const& xform_estimate,
                                    rgrl_set_of<rgrl_match_set_sptr> const& current_match_sets,
...
protected:
  double compute_alignment_error( rgrl_set_of<rgrl_match_set_sptr> const& current_match_sets ) const;

  double compute_alignment_error( rgrl_match_set_sptr const& current_match_set ) const;
