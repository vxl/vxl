...
rgrl_convergence_tester::compute_status( rgrl_converge_status_sptr               prev_status,
...
rgrl_converge_status_sptr
rgrl_convergence_tester::verify( rgrl_view                   const& view,
...
rgrl_converge_status_sptr
rgrl_convergence_tester::initialize_status( rgrl_transformation_sptr                xform_estimate,
                                            rgrl_estimator_sptr                     xform_estimator,
...
rgrl_converge_status_sptr
rgrl_convergence_tester::initialize_status( rgrl_view       const& init_view,
                                            rgrl_scale_sptr const& prior_scale,
                                            bool                   penalize_scaling ) const
{
...
rgrl_converge_status_sptr
rgrl_convergence_tester::init_status( rgrl_view       const & /*init_view*/,
                                      rgrl_scale_sptr const & /*prior_scale*/,
                                      bool                   /*penalize_scaling*/ ) const
{
...
rgrl_converge_status_sptr
rgrl_convergence_tester::compute_status_helper( double new_error,
                                                bool good_enough,
