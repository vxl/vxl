...
public:
  ...
  //
  virtual rgrl_converge_status_sptr compute_status( rgrl_converge_status_sptr               prev_status,
                                                    rgrl_view                        const& prev_view,
                                                    rgrl_view                        const& current_view,
                                                    rgrl_set_of<rgrl_match_set_sptr> const& current_match_sets,
                                                    rgrl_set_of<rgrl_scale_sptr>     const& current_scales, bool                                    penalize_scaling =
                                                      false ) const  = 0;
  ...
  rgrl_converge_status_sptr compute_status( rgrl_converge_status_sptr               prev_status,
                                            rgrl_view                        const& prev_view,
                                            rgrl_view                        const& current_view,
  ...
  rgrl_converge_status_sptr initialize_status( rgrl_view       const& init_view, rgrl_scale_sptr const& prior_scale,
                                               bool                   penalize_scaling ) const;

  // : convenient function for initializing status
  rgrl_converge_status_sptr initialize_status( rgrl_transformation_sptr                xform_estimate,
                                               rgrl_estimator_sptr                     xform_estimator,
  ...
  virtual
  rgrl_converge_status_sptr verify( rgrl_view                        const& view,
                                    rgrl_set_of<rgrl_match_set_sptr> const& current_match_sets,
...
protected:
  ...
  virtual rgrl_converge_status_sptr init_status( rgrl_view       const& init_view, rgrl_scale_sptr const& prior_scale,
                                                 bool                   penalize_scaling ) const;

  // :  helper function for computing status
  virtual
  rgrl_converge_status_sptr compute_status_helper(double new_error, bool   good_enough,
