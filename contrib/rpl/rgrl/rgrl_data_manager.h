...
public:
  ...
  //
  void add_data( unsigned stage, rgrl_feature_set_sptr                    from_set,
                 rgrl_feature_set_sptr                    to_set, rgrl_matcher_sptr                        matcher = 0,
  ...
  //
  void add_data( rgrl_feature_set_sptr                    from_set, rgrl_feature_set_sptr                    to_set,
  ...
  //
  void get_data_at_stage( unsigned stage, vcl_vector<rgrl_feature_set_sptr>             & from_sets,
  ...
  //
  void get_data_at_stage( unsigned stage, rgrl_feature_set_sptr             & from_sets,
                          rgrl_feature_set_sptr             & to_sets, rgrl_matcher_sptr                 & matchers,
  ...
  //
  //  The stage is assumed to be 0.
  void get_data( vcl_vector<rgrl_feature_set_sptr>             & from_sets,
                 vcl_vector<rgrl_feature_set_sptr>             & to_sets,
                 vcl_vector<rgrl_matcher_sptr>                 & matchers,
                 vcl_vector<rgrl_weighter_sptr>                & weighters,
                 vcl_vector<rgrl_scale_estimator_unwgted_sptr> & unwgted_scale_ests,
  ...
  //
  //  The stage is assumed to be 0.
  void get_data( rgrl_feature_set_sptr             & from_sets, rgrl_feature_set_sptr             & to_sets,
                 rgrl_matcher_sptr                 & matchers, rgrl_weighter_sptr                & weighters,
                 rgrl_scale_estimator_unwgted_sptr & unwgted_scale_ests,
                 rgrl_scale_estimator_wgted_sptr   & wgted_scale_ests,
                 vcl_vector<rgrl_estimator_sptr>   & estimators) const;
...
private:
  void generate_defaults(rgrl_matcher_sptr&                  matcher, rgrl_weighter_sptr&                 weighter,
                         rgrl_scale_estimator_unwgted_sptr&  unwgted_scale_est );
