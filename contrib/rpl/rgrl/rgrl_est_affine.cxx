...
rgrl_est_affine::rgrl_est_affine( unsigned int dimension )
{
...
rgrl_est_affine::estimate( rgrl_set_of<rgrl_match_set_sptr> const& matches,
...
rgrl_transformation_sptr
rgrl_est_affine::estimate( rgrl_match_set_sptr matches,
                           rgrl_transformation const& cur_transform ) const
{
...
const vcl_type_info &
rgrl_est_affine::transformation_type() const
{
