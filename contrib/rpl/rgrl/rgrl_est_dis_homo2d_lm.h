...
public:
  // : Default constructor
  //
  rgrl_est_dis_homo2d_lm( vnl_vector<double> const& from_centre, vnl_vector<double> const& to_centre,
                          bool with_grad = true );
  ...
  // : change frome_centre
  void set_centres( vnl_vector<double> const& from_centre, vnl_vector<double> const& to_centre );
