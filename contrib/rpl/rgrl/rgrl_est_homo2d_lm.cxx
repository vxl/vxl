...
void
rgrl_homo2d_func::f(vnl_vector<double> const& x, vnl_vector<double>& fx)
{
  vnl_double_2 mapped;
...
void
rgrl_homo2d_func::gradf(vnl_vector<double> const& x, vnl_matrix<double>& jacobian)
{
...
rgrl_est_homo2d_lm::rgrl_est_homo2d_lm( bool with_grad )
...
rgrl_est_homo2d_lm::estimate( rgrl_set_of<rgrl_match_set_sptr> const& matches,
...
const vcl_type_info &
rgrl_est_homo2d_lm::transformation_type() const
{
