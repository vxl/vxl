...
rgrl_est_homo2d_proj::rgrl_est_homo2d_proj( bool with_grad )
...
rgrl_est_homo2d_proj::estimate( rgrl_set_of<rgrl_match_set_sptr> const& matches,
...
const vcl_type_info &
rgrl_est_homo2d_proj::transformation_type() const
{
