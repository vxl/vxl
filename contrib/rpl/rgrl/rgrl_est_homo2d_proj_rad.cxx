...
rgrl_est_homo2d_proj_rad::rgrl_est_homo2d_proj_rad( unsigned int rad_order,
...
rgrl_est_homo2d_proj_rad::estimate( rgrl_set_of<rgrl_match_set_sptr> const& matches,
...
const vcl_type_info &
rgrl_est_homo2d_proj_rad::transformation_type() const
{
