...
rgrl_est_homography2d::rgrl_est_homography2d( double condition_num_thrd )
...
rgrl_est_homography2d::estimate( rgrl_set_of<rgrl_match_set_sptr> const& matches,
...
rgrl_transformation_sptr
rgrl_est_homography2d::estimate( rgrl_match_set_sptr matches,
                                 rgrl_transformation const& cur_transform ) const
{
...
const vcl_type_info &
rgrl_est_homography2d::transformation_type() const
{
  return rgrl_trans_homography2d::type_id();
}

bool
rgrl_est_homography2d::normalize( rgrl_set_of<rgrl_match_set_sptr> const& matches,
...
void
rgrl_est_homography2d::estimate_covariance( const vcl_vector<vnl_vector<double> >& norm_froms,
