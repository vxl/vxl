...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_func<Tdim, Fdim>::convert_parameters( vnl_vector<double>& params,
...
rgrl_est_proj_func<Tdim, Fdim>::uncentre_proj( vnl_matrix_fixed<double, Tdim + 1, Fdim + 1> const& proj ) const
{
  // make the prejection matrix to centre around from_centre_
  vnl_matrix_fixed<double, Fdim + 1, Fdim + 1> from_centre_matrix;
  from_centre_matrix.set_identity();
...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_func<Tdim, Fdim>::full_proj_jacobian( vnl_matrix_fixed<double, Tdim,
                                                                     (Fdim + 1) * (Tdim + 1)>& complete_jac,
...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_func<Tdim, Fdim>::reduced_proj_jacobian( vnl_matrix_fixed<double, Tdim,
                                                                        (Fdim + 1) * (Tdim + 1) - 1>& base_jac,
                                                       vnl_matrix_fixed<double, Tdim + 1, Fdim + 1> const& proj,
                                                       vnl_vector_fixed<double, Fdim>           const& from ) const
{
...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_func<Tdim, Fdim>::proj_jac_wrt_loc( vnl_matrix_fixed<double, Tdim, Fdim>& jac_loc,
                                                  vnl_matrix_fixed<double, Tdim + 1, Fdim + 1> const& proj,
                                                  vnl_vector_fixed<double, Fdim>           const& from ) const
{
  // 1. linear gradient in homogeneous coordinate
...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_func<Tdim, Fdim>::restored_centered_proj( vnl_matrix_fixed<double, Tdim + 1, Fdim + 1>& proj_matrix,
...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_func<Tdim, Fdim>::f(vnl_vector<double> const& x, vnl_vector<double>& fx)
{
...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_func<Tdim, Fdim>::gradf(vnl_vector<double> const& x, vnl_matrix<double>& jacobian)
{
  typedef rgrl_match_set::const_from_iterator FIter;
  typedef FIter::to_iterator                  TIter;
...
template <unsigned int Tdim, unsigned int Fdim>
bool
rgrl_est_proj_func<Tdim, Fdim>::projective_estimate( vnl_matrix_fixed<double, Tdim + 1, Fdim + 1>& proj,
...
// --------------------------------------------------------------------
template <unsigned int Tdim, unsigned int Fdim>
rgrl_est_proj_lm::rgrl_est_proj_lm( bool with_grad )
...
template <unsigned int Tdim, unsigned int Fdim>
bool
rgrl_est_proj_lm::projective_estimate( vnl_matrix_fixed<double, Tdim + 1, Fdim + 1>& proj,
                                       vnl_matrix<double>& full_covar,
                                       vnl_vector_fixed<double, Fdim>& from_centre,
                                       vnl_vector_fixed<double, Tdim>& to_centre,
