...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_rad_func<Tdim, Fdim>::convert_parameters( vnl_vector<double>& params,
                                                        vnl_matrix_fixed<double, Tdim + 1,
                                                                         Fdim + 1> const&  proj_matrix,
...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_rad_func<Tdim, Fdim>::transfer_radial_params_into_temp_storage( vnl_vector<double> const& params ) const
{
...
inline
void
rgrl_est_proj_rad_func<Tdim, Fdim>::apply_radial_distortion( vnl_vector_fixed<double, Tdim>      & mapped,
...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_rad_func<Tdim, Fdim>::reduced_proj_rad_jacobian( vnl_matrix<double>                            & base_jac,
                                                               vnl_matrix_fixed<double, Tdim + 1, Fdim + 1> const& proj,
                                                               vcl_vector<double>                       const& rad_k,
                                                               vnl_vector_fixed<double,
                                                                                Fdim>           const& from ) const
{
...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_rad_func<Tdim, Fdim>::full_proj_rad_jacobian( vnl_matrix<double>                            & base_jac,
                                                            vnl_matrix_fixed<double, Tdim + 1, Fdim + 1> const& proj,
                                                            vcl_vector<double>                       const& rad_k,
...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_rad_func<Tdim, Fdim>::proj_jac_wrt_loc( vnl_matrix_fixed<double, Tdim, Fdim>          & jac_loc,
                                                      vnl_matrix_fixed<double, Tdim + 1, Fdim + 1> const& proj,
                                                      vcl_vector<double>                       const& rad_k,
                                                      vnl_vector_fixed<double, Fdim>           const& from ) const
{
...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_rad_func<Tdim, Fdim>::f(vnl_vector<double> const& x, vnl_vector<double>& fx)
{
...
template <unsigned int Tdim, unsigned int Fdim>
void
rgrl_est_proj_rad_func<Tdim, Fdim>::gradf(vnl_vector<double> const& x, vnl_matrix<double>& jacobian)
{
  typedef rgrl_match_set::const_from_iterator FIter;
  typedef FIter::to_iterator                  TIter;
...
template <unsigned int Tdim, unsigned int Fdim>
bool
rgrl_est_proj_rad_func<Tdim, Fdim>::projective_estimate(  vnl_matrix_fixed<double, Tdim + 1, Fdim + 1>& proj,
