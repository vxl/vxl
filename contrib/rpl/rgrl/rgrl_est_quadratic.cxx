...
rgrl_est_quadratic::rgrl_est_quadratic( unsigned int dimension,
...
rgrl_est_quadratic::estimate( rgrl_set_of<rgrl_match_set_sptr> const& matches,
...
rgrl_transformation_sptr
rgrl_est_quadratic::estimate( rgrl_match_set_sptr matches,
                              rgrl_transformation const& cur_transform ) const
{
...
const vcl_type_info &
rgrl_est_quadratic::transformation_type() const
{
  return rgrl_trans_quadratic::type_id();
}

double
rgrl_est_quadratic::max_of_9_elements(double elt1, double elt2, double elt3,
