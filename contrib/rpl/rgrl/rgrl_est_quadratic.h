...
public:
  ...
  //
  rgrl_est_quadratic( unsigned int dimension, double condition_num_thrd = 0.0);
...
private:
  ...
  double max_of_9_elements(double elt1, double elt2, double elt3, double elt4, double elt5, double elt6, double elt7,
                           double elt8, double elt9 ) const;
