...
rgrl_est_reduced_quad2d::rgrl_est_reduced_quad2d( unsigned int dimension,
...
rgrl_est_reduced_quad2d::estimate( rgrl_set_of<rgrl_match_set_sptr> const& matches,
                                   rgrl_transformation const & /*cur_transform*/ ) const
{
  ...
  if( sum_wgt < 1e-16 )
    {
    return 0;                      // sum_wgt approaching 0
...
rgrl_transformation_sptr
rgrl_est_reduced_quad2d::estimate( rgrl_match_set_sptr matches,
                                   rgrl_transformation const& cur_transform ) const
{
...
const vcl_type_info &
rgrl_est_reduced_quad2d::transformation_type() const
{
