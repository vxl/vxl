...
rgrl_est_similarity2d::rgrl_est_similarity2d( unsigned int dimension )
{
  assert(dimension == 2);
...
rgrl_est_similarity2d::estimate( rgrl_set_of<rgrl_match_set_sptr> const& matches,
...
rgrl_transformation_sptr
rgrl_est_similarity2d::estimate( rgrl_match_set_sptr matches,
                                 rgrl_transformation const& cur_transform ) const
{
...
const vcl_type_info &
rgrl_est_similarity2d::transformation_type() const
{
