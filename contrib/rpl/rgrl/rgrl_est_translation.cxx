...
rgrl_est_translation::rgrl_est_translation( unsigned int dimension )
{
...
rgrl_est_translation::estimate( rgrl_set_of<rgrl_match_set_sptr> const& matches,
...
rgrl_transformation_sptr
rgrl_est_translation::estimate( rgrl_match_set_sptr matches,
                                rgrl_transformation const& cur_transform ) const
{
...
const vcl_type_info &
rgrl_est_translation::transformation_type() const
{
