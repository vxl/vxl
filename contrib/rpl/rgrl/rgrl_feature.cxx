...
double
rgrl_feature::geometric_error( rgrl_feature const& other ) const
{
  return (this->location() - other.location() ).pre_multiply( this->error_projector_sqrt() ).two_norm();
}

double
rgrl_feature::geometric_error( rgrl_transformation const& xform, rgrl_feature const& other ) const
{
...
vnl_vector<double>
rgrl_feature::signature_error_vector( rgrl_feature const & ) const
{
...
rgrl_feature::error_projector_sqrt() const
{
