...
//: Running from multiple initial estimates, produced by the
//  initializer during registration Loop through the set of initial
//  estimates, and call the next \a run(.) in the loop
void 
rgrl_feature_based_registration::
...
{  
  ...
  do { // for each stage/resolution
    ...
    do { // for each re-match
      ...
      // at the begining of next iteration.
