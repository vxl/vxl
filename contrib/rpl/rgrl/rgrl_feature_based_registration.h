...
public:
  ...
  //
  void run( rgrl_mask_box              from_image_region, rgrl_mask_box              to_image_region,
            rgrl_estimator_sptr        estimator, rgrl_transformation_sptr   initial_xform,
            rgrl_scale_sptr            prior_scale = 0, unsigned                   init_resolution = 0);
...
private:
  ...
  void register_single_feature( rgrl_mask_box            from_image_region, rgrl_mask_box            to_image_region,
  ...
  void register_multi_feature( rgrl_mask_box            from_image_region, rgrl_mask_box            to_image_region,
                               rgrl_estimator_sptr      initial_xform_estimator,
                               rgrl_transformation_sptr xform_estimate, rgrl_scale_sptr          prior_scale,
                               unsigned                 init_resolution);
