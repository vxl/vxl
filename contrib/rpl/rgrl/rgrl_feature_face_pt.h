...
//    direction and N-1 tangent directions.  There could be a defined
//    image region surrounding these. 
...
class rgrl_feature_face_pt : public rgrl_feature {
public:
  ...
  //: Return a matrix whose columns form the subspace tangent to the
  //  face normal
...
private:
  ...
  //:  The basis for the subspace of vectors normal to the normal
  //  direction.  This is tangent subspace.  It is computed once,
