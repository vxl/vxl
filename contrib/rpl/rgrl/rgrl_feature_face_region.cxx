...
rgrl_feature_face_region::rgrl_feature_face_region( vnl_vector<double> const& location,
...
unsigned int
rgrl_feature_face_region::num_constraints() const
{
  return 1;
}

rgrl_feature_sptr
rgrl_feature_face_region::transform( rgrl_transformation const& xform ) const
{
...
rgrl_feature_sptr
rgrl_feature_face_region::transform_region( rgrl_transformation const& xform ) const
{
...
void
rgrl_feature_face_region::generate_pixel_coordinates( vnl_vector<double> const& spacing_ratio )
{
