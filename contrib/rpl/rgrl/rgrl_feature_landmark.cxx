...
rgrl_feature_landmark::rgrl_feature_landmark( vnl_vector<double> const& loc,
...
rgrl_feature_landmark::rgrl_feature_landmark( rgrl_feature_landmark const& other )
  : rgrl_feature(other),
...
rgrl_feature_landmark::rgrl_feature_landmark()
{
}

vnl_matrix<double> const &
rgrl_feature_landmark::error_projector() const
{
  return error_proj_;
}

vnl_matrix<double> const &
rgrl_feature_landmark::error_projector_sqrt() const
{
  // they are the same
  return error_proj_;
}
...
unsigned int
rgrl_feature_landmark::num_constraints() const
{
  return location_.size();
}

rgrl_feature_sptr
rgrl_feature_landmark::transform( rgrl_transformation const& xform ) const
{
...
double
rgrl_feature_landmark::absolute_signature_weight( rgrl_feature_sptr other ) const
{
...
//
double
rgrl_feature_landmark::max_similarity(const vcl_vector<vnl_vector<double> >& u,
...
// : write out feature
void
rgrl_feature_landmark::write( vcl_ostream& os ) const
{
  // tag
...
// : read in feature
bool
rgrl_feature_landmark::read( vcl_istream& is, bool skip_tag )
{
  if( !skip_tag )
    {
    // skip empty lines
...
rgrl_feature_sptr
rgrl_feature_landmark::clone() const
{
