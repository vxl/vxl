...
public:
  ...
  //
  // Works for 2d and 3d.
  rgrl_feature_landmark( vnl_vector<double> const& loc, vcl_vector<vnl_vector<double> > const& outgoing_directions );
...
protected:
  ...
  friend rgrl_feature_sptr rgrl_feature_reader( vcl_istream& is );
  ...
  //
  double max_similarity(const vcl_vector<vnl_vector<double> >& u, const vcl_vector<vnl_vector<double> >& v, int count,
