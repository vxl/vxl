...
rgrl_feature_point_region::rgrl_feature_point_region( vnl_vector<double> const& loc, double radius )
  : rgrl_feature_point( loc ),
  radius_(radius)
{     }

rgrl_feature_point_region::rgrl_feature_point_region( unsigned dim )
...
rgrl_feature_sptr
rgrl_feature_point_region::transform( rgrl_transformation const& xform ) const
{
...
void
rgrl_feature_point_region::generate_pixel_coordinates( vnl_vector<double> const& spacing_ratio )
{
...
rgrl_feature_sptr
rgrl_feature_point_region::clone() const
{
