...
template <unsigned N>
rgrl_feature_set_bins<N>::rgrl_feature_set_bins( feature_vector const& features,
                                                 double bin_size,
...
template <unsigned N>
void
rgrl_feature_set_bins<N>::features_in_region( feature_vector& results, rgrl_mask_box const& roi ) const
{
...
template <unsigned N>
void
rgrl_feature_set_bins<N>::features_within_radius( feature_vector& results, vnl_vector<double> const& center,
                                                  double radius ) const
{
...
template <unsigned N>
rgrl_feature_sptr
rgrl_feature_set_bins<N>::nearest_feature( rgrl_feature_sptr const& feature ) const
{
...
template <unsigned N>
rgrl_feature_sptr
rgrl_feature_set_bins<N>::nearest_feature( const vnl_vector<double>& loc ) const
{
  feature_vector results;
...
template <unsigned N>
void
rgrl_feature_set_bins<N>::features_within_radius( feature_vector& results, rgrl_feature_sptr const& feature,
...
template <unsigned N>
void
rgrl_feature_set_bins<N>::k_nearest_features( feature_vector& results, rgrl_feature_sptr const& feature,
...
template <unsigned N>
void
rgrl_feature_set_bins<N>::k_nearest_features( feature_vector& results, const vnl_vector<double> & loc,
                                              unsigned int k ) const
{
...
template <unsigned N>
rgrl_mask_box
rgrl_feature_set_bins<N>::bounding_box() const
{
...
template <unsigned N>
const vcl_type_info &
rgrl_feature_set_bins<N>::type() const
{
