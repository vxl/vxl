...
rgrl_feature_set_bins_2d::rgrl_feature_set_bins_2d( feature_vector const& features,
                                                    double bin_size,
...
void
rgrl_feature_set_bins_2d::features_in_region( feature_vector& results, rgrl_mask_box const& roi ) const
{
...
void
rgrl_feature_set_bins_2d::features_within_radius( feature_vector& results, vnl_vector<double> const& center,
                                                  double radius ) const
{
...
rgrl_feature_sptr
rgrl_feature_set_bins_2d::nearest_feature( rgrl_feature_sptr const& feature ) const
{
...
rgrl_feature_sptr
rgrl_feature_set_bins_2d::nearest_feature( const vnl_vector<double>& loc ) const
{
  feature_vector results;
...
void
rgrl_feature_set_bins_2d::features_within_radius( feature_vector& results, rgrl_feature_sptr const& feature,
...
void
rgrl_feature_set_bins_2d::k_nearest_features( feature_vector& results, rgrl_feature_sptr const& feature,
...
// :  Return the k nearest features based on Euclidean distance.
void
rgrl_feature_set_bins_2d::k_nearest_features( feature_vector& results, const vnl_vector<double> & loc,
                                              unsigned int k ) const
{
...
rgrl_mask_box
rgrl_feature_set_bins_2d::bounding_box() const
{
  return bounding_box_;
}

const vcl_type_info &
rgrl_feature_set_bins_2d::type() const
{
