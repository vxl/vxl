...
rgrl_mask_box
rgrl_feature_set_location_masked::bounding_box() const
{ return fea_set_sptr_->bounding_box(); }

void
rgrl_feature_set_location_masked::features_in_region( feature_vector& final_results, rgrl_mask_box const& roi ) const
{
...
//
void
rgrl_feature_set_location_masked::features_within_radius( feature_vector& final_results,
                                                          vnl_vector<double> const& center, double radius ) const
{
  feature_vector results;
...
//
rgrl_feature_sptr
rgrl_feature_set_location_masked::nearest_feature( rgrl_feature_sptr const& feature ) const
{
...
//
rgrl_feature_sptr
rgrl_feature_set_location_masked::nearest_feature( const vnl_vector<double>& loc ) const
{
...
//
void
rgrl_feature_set_location_masked::features_within_radius( feature_vector& results, rgrl_feature_sptr const& feature,
...
void
rgrl_feature_set_location_masked::k_nearest_features( feature_vector& results, const vnl_vector<double>& loc,
...
// : Return the k nearest features based on Euclidean distance
void
rgrl_feature_set_location_masked::k_nearest_features( feature_vector& results, rgrl_feature_sptr const& feature,
                                                      unsigned int k ) const
{
  if( mask_->inside(feature->location() ) )
    {
