...
public:
  ...
  rgrl_feature_trace_pt( vnl_vector<double> const& loc, vnl_vector<double> const& tangent );
  ...
  virtual vnl_vector<double> const & tangent() const;
  ...
  virtual vnl_matrix<double> const & normal_subspace();
