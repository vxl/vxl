...
unsigned int
rgrl_feature_trace_region::num_constraints() const
{
  return location_.size() - 1;
}

rgrl_feature_sptr
rgrl_feature_trace_region::transform( rgrl_transformation const& xform ) const
{
...
rgrl_feature_sptr
rgrl_feature_trace_region::transform_region( rgrl_transformation const& xform ) const
{
...
void
rgrl_feature_trace_region::generate_pixel_coordinates( vnl_vector<double> const&  spacing_ratio )
{
