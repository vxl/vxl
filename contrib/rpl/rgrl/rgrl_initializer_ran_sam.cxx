...
void
rgrl_initializer_ran_sam::set_gen_all_samples()
{
  generate_all_ = true;
}

void
rgrl_initializer_ran_sam::set_sampling_params( double max_outlier_frac,
...
void
rgrl_initializer_ran_sam::set_data(rgrl_match_set_sptr                init_match_set,
...
bool
rgrl_initializer_ran_sam::next_initial( rgrl_view_sptr           & view,
...
bool
rgrl_initializer_ran_sam::estimate()
{
  //
  ...
  unsigned int points_per = (int)vcl_floor(
      (double)transform_estiamtor_->param_dof() / match_set_->num_constraints_per_match() );
...
void
rgrl_initializer_ran_sam::calc_num_samples( unsigned int num_matches )
{
  if( generate_all_ )
    {
    //
...
void
rgrl_initializer_ran_sam::next_sample( unsigned int taken, unsigned int num_points,
...
rgrl_match_set_sptr
rgrl_initializer_ran_sam::get_matches(const vcl_vector<int>&  point_indices, unsigned int total_num_matches)
{
  rgrl_match_set_sptr
...
void
rgrl_initializer_ran_sam::trace_sample( const vcl_vector<int>& indices ) const
{
  vcl_cout << "\nNew sample: ";
