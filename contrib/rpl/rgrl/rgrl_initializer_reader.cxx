...
rgrl_initializer_reader::rgrl_initializer_reader(vcl_istream& istr,
...
bool
rgrl_initializer_reader::next_initial( rgrl_view_sptr           & view,
...
int
rgrl_initializer_reader::size() const
{
