...
rgrl_invariant_match::transform() const
{
...
rgrl_scale_sptr
rgrl_invariant_match::scale() const
{
  assert( is_estimate_set_ );
  return scale_;
}
...
rgrl_mask_box
rgrl_invariant_match::initial_region() const
{
  return from_->region();
}

bool
rgrl_invariant_match::has_initial_region() const
{
  return from_->has_region();
}

bool
rgrl_invariant_match::estimate()
{
  if( !is_estimate_set_ )
    {
