...
public:
  ...
  rgrl_invariant_single_landmark(vnl_vector<double> location, vnl_vector<double> vessel_dir1,
                                 vnl_vector<double> vessel_dir2, vnl_vector<double> vessel_dir3, double width1,
                                 double width2, double width3, double angular_std = 1, double width_ratio_std = 1);
  ...
  //  in radius
  rgrl_invariant_single_landmark(const rgrl_invariant_single_landmark& copy, double angular_std = 1,
...
private:
  ...
  void reorder_vessel( vcl_vector<vnl_vector<double> >& directions, vcl_vector<double>& local_widths,
