...
rgrl_mask_2d_image::rgrl_mask_2d_image( const vil_image_view<vxl_byte>& in_mask,
                                        int org_x, int org_y)
...
bool
rgrl_mask_2d_image::inside( vnl_vector<double> const& pt ) const
{
...
void
rgrl_mask_2d_image::update_bounding_box()
{
  // reset bounding box
...
rgrl_mask_sphere::rgrl_mask_sphere( unsigned dim )
  : rgrl_mask( dim ), center_( dim, 0.0 ), radius_sqr_( 0 )
{
}

rgrl_mask_sphere::rgrl_mask_sphere( const vnl_vector<double>& in_center,
                                    double in_radius )
...
bool
rgrl_mask_sphere::inside( vnl_vector<double> const& pt ) const
{
...
void
rgrl_mask_sphere::set_center( vnl_vector<double> const& pt )
{
  assert( pt.size() == center_.size() );
  center_ = pt;
...
void
rgrl_mask_sphere::set_radius( double radius )
{
...
void
rgrl_mask_sphere::update_bounding_box()
{
...
rgrl_mask_box::rgrl_mask_box( unsigned dim )
  : rgrl_mask( dim )
{
}

rgrl_mask_box::rgrl_mask_box( vnl_vector<double> const& x0, vnl_vector<double> const& x1 )
  : rgrl_mask( x0.size() )
{
...
bool
rgrl_mask_box::inside( vnl_vector<double> const& pt ) const
{
...
void
rgrl_mask_box::set_x0( vnl_vector<double> const& v )
{
...
void
rgrl_mask_box::set_x1( vnl_vector<double> const& v )
{
...
bool
rgrl_mask_box::operator==( const rgrl_mask_box& other ) const
{
