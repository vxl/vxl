...
rgrl_mask_3d_image::rgrl_mask_3d_image( const vil3d_image_view<vxl_byte> & in_mask,
...
bool
rgrl_mask_3d_image::inside( vnl_vector<double> const& pt ) const
{
...
void
rgrl_mask_3d_image::update_bounding_box()
{
  // reset bounding box
