...
rgrl_mask_oriented_box::rgrl_mask_oriented_box( vnl_vector<double> const& x0,
...
bool
rgrl_mask_oriented_box::inside( vnl_vector<double> const& pt ) const
{
...
void
rgrl_mask_oriented_box::set_len( vnl_vector<double> const& len )
{
...
void
rgrl_mask_oriented_box::set_axes( vnl_matrix<double> const& axes )
{
  // square matrix
...
vnl_vector<double>
rgrl_mask_oriented_box::origin() const
{
  return axes_ * omin_;
}

void
rgrl_mask_oriented_box::update_bounding_box()
{
...
double
rgrl_mask_oriented_box::average_vertices_dist( const rgrl_mask_oriented_box& other ) const
{
...
bool
rgrl_mask_oriented_box::operator==( const rgrl_mask_oriented_box& other ) const
{
