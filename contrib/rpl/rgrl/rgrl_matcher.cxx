...
// less than operator
bool
rgrl_matcher::flip_node::operator<( flip_node const& other ) const
{
...
rgrl_match_set_sptr
rgrl_matcher::compute_matches( rgrl_feature_set const&    from_features,
...
void
rgrl_matcher::add_one_flipped_match( rgrl_match_set_sptr&      inv_set,
                                     rgrl_view          const& current_view,
...
rgrl_match_set_sptr
rgrl_matcher::invert_matches( rgrl_match_set const&    current_set,
                              rgrl_view const&         current_view )
{
