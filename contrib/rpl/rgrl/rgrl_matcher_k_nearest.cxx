...
bool
rgrl_matcher_k_nearest::internal_dist_node::operator<( internal_dist_node const& rhs ) const
{
  return this->geo_err_ < rhs.geo_err_;
}

rgrl_matcher_k_nearest::rgrl_matcher_k_nearest( unsigned int k )
  : k_( k ),
  thres_( -1.0 )
{
}

rgrl_matcher_k_nearest::rgrl_matcher_k_nearest( unsigned int k, double dist_thres )
  : k_( k ),
  thres_( dist_thres )
{
...
rgrl_match_set_sptr
rgrl_matcher_k_nearest::compute_matches( rgrl_feature_set const&       from_set,
...
void
rgrl_matcher_k_nearest::add_one_flipped_match( rgrl_match_set_sptr&      inv_set,
                                               rgrl_view          const& current_view,
...
bool
rgrl_matcher_k_nearest::validate( rgrl_feature_sptr const& mapped, rgrl_mask_sptr const& roi_sptr ) const
{
