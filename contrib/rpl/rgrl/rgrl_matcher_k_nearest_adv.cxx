...
rgrl_matcher_k_nearest_adv::rgrl_matcher_k_nearest_adv( unsigned int k )
...
rgrl_matcher_k_nearest_adv::rgrl_matcher_k_nearest_adv( unsigned int k, double dist_thres, double min_mapped_scale,
                                                        double thres_reuse_match )
...
rgrl_match_set_sptr
rgrl_matcher_k_nearest_adv::compute_matches( rgrl_feature_set const&       from_set,
...
inline
bool
rgrl_matcher_k_nearest_adv::validate( rgrl_feature_sptr const& mapped, rgrl_mask_sptr const& roi_sptr ) const
{
