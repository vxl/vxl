...
rgrl_matcher_k_nearest_boundary::rgrl_matcher_k_nearest_boundary( unsigned int k, double dist_thres  )
  : rgrl_matcher_k_nearest(k, dist_thres)
{
}

rgrl_match_set_sptr
rgrl_matcher_k_nearest_boundary::compute_matches( rgrl_feature_set const&       from_set,
...
vbl_array_2d<bool>
rgrl_matcher_k_nearest_boundary::match_boundary_pts(feature_vector const& from_pts,
...
vbl_array_2d<bool>
rgrl_matcher_k_nearest_boundary::match_boundary_pts_helper(vbl_array_2d<double> const& dist_error,
