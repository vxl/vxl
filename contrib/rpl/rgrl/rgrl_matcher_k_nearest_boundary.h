...
private:
  ...
  vbl_array_2d<bool> match_boundary_pts(feature_vector const&  mapped_bd_pts,
  ...
  vbl_array_2d<bool> match_boundary_pts_helper(vbl_array_2d<double> const&  dist_error,
                                               vbl_array_2d<bool> const&    valid, int                          count,
