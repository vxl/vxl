...
rgrl_matcher_k_nearest_pick_one::rgrl_matcher_k_nearest_pick_one( unsigned int k )
  : rgrl_matcher_k_nearest_adv( k )
{
}

rgrl_matcher_k_nearest_pick_one::rgrl_matcher_k_nearest_pick_one( unsigned int k, double dist_thres,
                                                                  double min_mapped_scale, double thres_reuse_match )
  : rgrl_matcher_k_nearest_adv(k, dist_thres, min_mapped_scale, thres_reuse_match)
{
}

rgrl_match_set_sptr
rgrl_matcher_k_nearest_pick_one::compute_matches( rgrl_feature_set const&       from_set,
...
void
rgrl_matcher_k_nearest_pick_one::add_one_flipped_match( rgrl_match_set_sptr&      inv_set,
                                                        rgrl_view          const& current_view,
...
inline
bool
rgrl_matcher_k_nearest_pick_one::validate( rgrl_feature_sptr const& mapped, rgrl_mask_sptr const& roi_sptr ) const
{
