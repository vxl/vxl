...
rgrl_matcher_k_nearest_random::rgrl_matcher_k_nearest_random( unsigned int k, unsigned int max_num )
  : rgrl_matcher_k_nearest( k ),
  max_num_( max_num )
{
}

rgrl_matcher_k_nearest_random::rgrl_matcher_k_nearest_random( unsigned int k, unsigned int max_num, double dist_thres )
...
rgrl_match_set_sptr
rgrl_matcher_k_nearest_random::compute_matches( rgrl_feature_set const&       from_set,
...
void
rgrl_matcher_k_nearest_random::generate_random_indices( vcl_vector<bool>& to_use ) const
{
