...
public:
  ...
  //
  rgrl_matcher_pseudo( vil_image_view<PixelType> from_image, vil_image_view<PixelType> to_image,
                       rgrl_evaluator_sptr evaluator, rgrl_mask_sptr from_mask = 0, rgrl_mask_sptr to_mask = 0 );
