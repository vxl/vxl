...
public:
  ...
  //
  rgrl_matcher_pseudo_3d( vil3d_image_view<PixelType> const& from_image, vil3d_image_view<PixelType> const& to_image,
                          vnl_vector<double> const& from_spacing_ratio, vnl_vector<double> const& to_spacing_ratio,
                          rgrl_evaluator_sptr evaluator, rgrl_mask_sptr mask = 0 );
...
private:
  ...
  void match_mapped_region( rgrl_feature_sptr                    mapped_feature,
