...
template <class PixelType>
rgrl_match_set_sptr
rgrl_matcher_pseudo_int_3d<PixelType>::compute_matches( rgrl_feature_set const&    from_set,
                                                        ...
                                                        rgrl_match_set_sptr const & /*old_matches*/ )
{
  ...
  for( f_iterator_type fitr = from.begin(); fitr != from.end(); ++fitr )
    ...
    // set the weight = 0
    if( !rgrl_matcher_pseudo_int_3d_physical_in_range( to_image_, mask_, mapped_feature->location(),
                                                       to_spacing_ratio_ ) )
      {
...
template <class PixelType>
void
rgrl_matcher_pseudo_int_3d<PixelType>::map_region_intensities( rgrl_transformation      const& trans,
...
template <class PixelType>
void
rgrl_matcher_pseudo_int_3d<PixelType>::map_region_intensities( vcl_vector<vnl_vector<int> > const& pixel_locations,
...
template <class PixelType>
void
rgrl_matcher_pseudo_int_3d<PixelType>::slide_window(rgrl_feature_sptr         mapped_feature,
...
template <class PixelType>
double
rgrl_matcher_pseudo_int_3d<PixelType>::compute_response( rgrl_mapped_pixel_vector_type const& mapped_pixels,
...
template <class PixelType>
void
rgrl_matcher_pseudo_int_3d<PixelType>::sample_pixels_along_direction( vcl_vector<discrete_shift_node>& two_dir_shifts,
                                                                      vnl_double_3 dir,
