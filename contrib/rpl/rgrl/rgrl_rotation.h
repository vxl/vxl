...
void rgrl_rotation_3d_to_matrix(double const theta, double const alpha, double const phi, vnl_matrix<double> & R);
...
void rgrl_rotation_3d_from_matrix(vnl_matrix<double> const& R, double& phi, double& alpha, double& theta);
