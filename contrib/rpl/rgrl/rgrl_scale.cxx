...
bool
rgrl_scale::has_geometric_scale() const
{
  return has_geometric_scale_;
}

double
rgrl_scale::geometric_scale() const
{
  return geometric_scale_;
}

bool
rgrl_scale::has_signature_inv_covar() const
{
  return has_signature_inv_covar_;
}

vnl_matrix<double> const &
rgrl_scale::signature_inv_covar() const
{
  return signature_inv_covar_;
}

void
rgrl_scale::set_scales( double                     geometric_scale,
...
void
rgrl_scale::set_geometric_scale( double scale, type new_type )
{
...
void
rgrl_scale::set_signature_inv_covar( vnl_matrix<double> const& covar )
{
...
void
rgrl_scale::write( vcl_ostream& os ) const
{
...
bool
rgrl_scale::read( vcl_istream& is )
{
  vcl_streampos           pos;
