...
rgrl_scale_est_all_weights::rgrl_scale_est_all_weights( bool do_signature_scale )
  : do_signature_scale_( do_signature_scale )
{
}

rgrl_scale_sptr
rgrl_scale_est_all_weights::estimate_weighted( rgrl_match_set const& match_set,
...
bool
rgrl_scale_est_all_weights::compute_geometric_scale( double& return_scale,
...
bool
rgrl_scale_est_all_weights::compute_signature_inv_covar( vnl_matrix<double>& inv_covar,
