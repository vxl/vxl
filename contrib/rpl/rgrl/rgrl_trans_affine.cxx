...
rgrl_trans_affine::rgrl_trans_affine( unsigned int dimension )
...
rgrl_trans_affine::rgrl_trans_affine( vnl_matrix<double> const& in_A,
...
void
rgrl_trans_affine::map_loc( vnl_vector<double> const& from,
...
void
rgrl_trans_affine::map_dir( vnl_vector<double> const& from_loc,
...
vnl_matrix<double>
rgrl_trans_affine::transfer_error_covar( vnl_vector<double> const& p  ) const
{
...
rgrl_trans_affine::A() const
{
  return A_;
}

vnl_vector<double>
rgrl_trans_affine::t() const
{
  return trans_ - A_ * from_centre_;
}

void
rgrl_trans_affine::inv_map( const vnl_vector<double>& to,
...
rgrl_trans_affine::inverse_transform() const
{
...
void
rgrl_trans_affine::jacobian_wrt_loc( vnl_matrix<double>& jac, vnl_vector<double> const & /*from_loc*/ ) const
{
  jac = A_;
}

rgrl_transformation_sptr
rgrl_trans_affine::scale_by( double scale ) const
{
...
void
rgrl_trans_affine::write( vcl_ostream& os ) const
{
  // tag
  os << "AFFINE\n"
    // parameters
...
bool
rgrl_trans_affine::read( vcl_istream& is )
{
  // skip empty lines
