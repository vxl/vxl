...
//:
// \file
// \brief Derived class to represent an affine transformation in
// arbitrary dimensions.  It can be built from lower order (subgroup) 
// transformations so that many different transformations can be
// described. 
