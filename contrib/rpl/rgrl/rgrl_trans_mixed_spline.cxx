...
void
rgrl_trans_mixed_spline::map_loc( vnl_vector<double> const& from,
...
void
rgrl_trans_mixed_spline::map_dir( vnl_vector<double> const& from_loc,
...
void
rgrl_trans_mixed_spline::jacobian_wrt_loc( vnl_matrix<double>& jac, vnl_vector<double> const& from_loc ) const
{
  assert( !"rgrl_trans_mixed_spline::jacobian_wrt_loc() is not implemented!" );
}

rgrl_transformation_sptr
rgrl_trans_mixed_spline::scale_by( double scale ) const
{
...
vnl_matrix<double>
rgrl_trans_mixed_spline::transfer_error_covar( vnl_vector<double> const& p ) const
{
  unsigned dim = p.size();
...
// : make a clone copy
rgrl_transformation_sptr
rgrl_trans_mixed_spline::clone() const
{
