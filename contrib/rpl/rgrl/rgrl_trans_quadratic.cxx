...
rgrl_trans_quadratic::rgrl_trans_quadratic( unsigned int dim)
...
rgrl_trans_quadratic::rgrl_trans_quadratic( vnl_matrix<double> const& in_Q,
...
void
rgrl_trans_quadratic::set_from_center( vnl_vector<double> const& from_center )
{
  from_centre_ = from_center;
}

void
rgrl_trans_quadratic::map_loc( vnl_vector<double> const& from,
...
void
rgrl_trans_quadratic::map_dir( vnl_vector<double> const& from_loc,
...
vnl_matrix<double>
rgrl_trans_quadratic::transfer_error_covar( vnl_vector<double> const& p  ) const
{
...
rgrl_trans_quadratic::Q() const
{
  return Q_;
}

vnl_matrix<double> const &
rgrl_trans_quadratic::A() const
{
  return A_;
}

vnl_vector<double> const &
rgrl_trans_quadratic::t() const
{
  return trans_;
}

void
rgrl_trans_quadratic::inv_map( const vnl_vector<double>& to,
...
void
rgrl_trans_quadratic::jacobian_wrt_loc( vnl_matrix<double>& jacobian_Q, vnl_vector<double> const& from_loc ) const
{
...
rgrl_trans_quadratic::scale_by( double scale ) const
{
...
vnl_vector<double>
rgrl_trans_quadratic::higher_order_terms(vnl_vector<double> p) const
{
  int m = p.size();
...
void
rgrl_trans_quadratic::write( vcl_ostream& os ) const
{
...
bool
rgrl_trans_quadratic::read( vcl_istream& is )
{
  // skip empty lines
...
void
rgrl_trans_quadratic::inv_map( vnl_vector<double> const & /*to*/,
...
rgrl_transformation_sptr
rgrl_trans_quadratic::inverse_transform() const
{
...
// : make a clone copy
rgrl_transformation_sptr
rgrl_trans_quadratic::clone() const
{
  return new rgrl_trans_quadratic( *this );
}
