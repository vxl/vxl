...
public:
  ...
  //
  rgrl_trans_quadratic( vnl_matrix<double> const& Q, vnl_matrix<double> const& A, vnl_vector<double> const& trans,
  ...
  //
  rgrl_trans_quadratic( vnl_matrix<double> const& Q, vnl_matrix<double> const& A, vnl_vector<double> const& trans,
                        vnl_matrix<double> const& covar, vnl_vector<double> const& from_centre,
