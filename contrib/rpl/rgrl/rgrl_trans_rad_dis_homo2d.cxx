...
rgrl_trans_rad_dis_homo2d::rgrl_trans_rad_dis_homo2d( vnl_matrix<double> const& H,
                                                      double k1_from,
                                                      double k1_to,
...
vnl_matrix<double>
rgrl_trans_rad_dis_homo2d::transfer_error_covar( vnl_vector<double> const& from  ) const
{
  assert( is_covar_set() );
  assert( from.size() == 2 );
...
void
rgrl_trans_rad_dis_homo2d::inv_map( const vnl_vector<double> & /*to*/,
...
// : Return the jacobian of the transform.
void
rgrl_trans_rad_dis_homo2d::jacobian_wrt_loc( vnl_matrix<double>& jac, vnl_vector<double> const& from ) const
{
  // using chain rule:
...
void
rgrl_trans_rad_dis_homo2d::map_loc( vnl_vector<double> const& from,
...
void
rgrl_trans_rad_dis_homo2d::map_dir( vnl_vector<double> const& from_loc,
...
rgrl_trans_rad_dis_homo2d::scale_by( double scale ) const
{
...
rgrl_trans_rad_dis_homo2d::uncenter_H_matrix() const
{
...
rgrl_transformation_sptr
rgrl_trans_rad_dis_homo2d::inverse_transform() const
{
...
void
rgrl_trans_rad_dis_homo2d::write(vcl_ostream& os ) const
{
...
// for input
bool
rgrl_trans_rad_dis_homo2d::read(vcl_istream& is )
{
  int dim;
...
// : make a clone copy
rgrl_transformation_sptr
rgrl_trans_rad_dis_homo2d::clone() const
{
