...
public:
  ...
  rgrl_trans_rad_dis_homo2d( vnl_matrix<double> const& H, double k1_from, double k1_to,
                             vnl_vector<double> const& from_centre, vnl_vector<double> const& to_centre );

  // : Construct a centered transform.
  //
  rgrl_trans_rad_dis_homo2d( vnl_matrix<double> const& H, double k1_from, double k1_to, vnl_matrix<double> const& covar,
                             vnl_vector<double> const& from_centre, vnl_vector<double> const& to_centre );
