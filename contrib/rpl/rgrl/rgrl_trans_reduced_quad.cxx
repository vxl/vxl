...
rgrl_trans_reduced_quad::rgrl_trans_reduced_quad( unsigned int dim)
...
rgrl_trans_reduced_quad::rgrl_trans_reduced_quad( vnl_matrix<double> const& in_Q,
...
void
rgrl_trans_reduced_quad::set_from_center( vnl_vector<double> const& from_center )
{
  from_centre_ = from_center;
}

void
rgrl_trans_reduced_quad::map_loc( vnl_vector<double> const& from,
...
void
rgrl_trans_reduced_quad::map_dir( vnl_vector<double> const& from_loc,
...
vnl_matrix<double>
rgrl_trans_reduced_quad::transfer_error_covar( vnl_vector<double> const& p  ) const
{
  assert( is_covar_set() );
...
rgrl_trans_reduced_quad::Q() const
{
  return Q_;
}

vnl_matrix<double> const &
rgrl_trans_reduced_quad::A() const
{
  return A_;
}

vnl_vector<double> const &
rgrl_trans_reduced_quad::t() const
{
  return trans_;
}

void
rgrl_trans_reduced_quad::inv_map( const vnl_vector<double>& to,
...
void
rgrl_trans_reduced_quad::jacobian_wrt_loc( vnl_matrix<double>& jacobian_Q, vnl_vector<double> const& from_loc ) const
{
...
rgrl_trans_reduced_quad::scale_by( double scale ) const
{
...
vnl_vector<double>
rgrl_trans_reduced_quad::higher_order_terms(vnl_vector<double> p) const
{
  int m = p.size();
...
void
rgrl_trans_reduced_quad::write( vcl_ostream& os ) const
{
...
bool
rgrl_trans_reduced_quad::read( vcl_istream& is )
{
  int dim;
...
void
rgrl_trans_reduced_quad::inv_map( vnl_vector<double> const & /*to*/,
...
rgrl_transformation_sptr
rgrl_trans_reduced_quad::inverse_transform() const
{
...
// : make a clone copy
rgrl_transformation_sptr
rgrl_trans_reduced_quad::clone() const
{
