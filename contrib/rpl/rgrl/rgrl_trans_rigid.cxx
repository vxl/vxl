...
rgrl_trans_rigid::rgrl_trans_rigid( unsigned int dimension )
...
void
rgrl_trans_rigid::map_loc( vnl_vector<double> const& from,
...
void
rgrl_trans_rigid::map_dir( vnl_vector<double> const& from_loc,
...
vnl_matrix<double>
rgrl_trans_rigid::transfer_error_covar( vnl_vector<double> const& p  ) const
{
  assert( is_covar_set() );
...
rgrl_trans_rigid::R() const
{
  return R_;
}

vnl_vector<double>
rgrl_trans_rigid::t() const
{
  return trans_;
}

void
rgrl_trans_rigid::inv_map( const vnl_vector<double>& to,
...
void
rgrl_trans_rigid::jacobian_wrt_loc( vnl_matrix<double>& jac, vnl_vector<double> const & /*from_loc*/ ) const
{
  jac = R_;
}
...
rgrl_trans_rigid::inverse_transform() const
{
...
rgrl_transformation_sptr
rgrl_trans_rigid::scale_by( double scale ) const
{
...
void
rgrl_trans_rigid::write( vcl_ostream& os ) const
{
  // tag
  os << "RIGID\n"
    // parameters
...
bool
rgrl_trans_rigid::read( vcl_istream& is )
{
  int dim;
