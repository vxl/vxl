...
rgrl_trans_spline::rgrl_trans_spline( unsigned int dim )
  : x0_( dim, 0.0 ), delta_( dim, 0.0 )
{
}

rgrl_trans_spline::rgrl_trans_spline( vcl_vector<rgrl_spline_sptr> const& splines,
...
void
rgrl_trans_spline::point_in_knots( vnl_vector<double> const& point, vnl_vector<double> & spline_pt ) const
{
...
void
rgrl_trans_spline::map_loc( vnl_vector<double> const& from,
...
void
rgrl_trans_spline::map_dir( vnl_vector<double> const& from_loc,
...
void
rgrl_trans_spline::jacobian_wrt_loc( vnl_matrix<double>& spline_jacobian, vnl_vector<double> const& from_loc ) const
{
...
vnl_matrix<double>
rgrl_trans_spline::transfer_error_covar( vnl_vector<double> const& p ) const
{
...
void
rgrl_trans_spline::write( vcl_ostream& os ) const
{
  // output tag
  os << "BSPLINE\n";
...
bool
rgrl_trans_spline::read( vcl_istream& is )
{
  // skip empty lines
...
void
rgrl_trans_spline::inv_map( vnl_vector<double> const & /*to*/,
...
rgrl_trans_spline::inverse_transform() const
{
...
rgrl_transformation_sptr
rgrl_trans_spline::scale_by( double /*scale*/ ) const
{
