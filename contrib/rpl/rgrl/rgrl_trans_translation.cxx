...
rgrl_trans_translation::rgrl_trans_translation( unsigned int dimension )
  : trans_( vnl_vector<double>( dimension, 0.0 ) ),
  from_centre_( dimension, 0.0 )
{
}

rgrl_trans_translation::rgrl_trans_translation( vnl_vector<double> const& in_trans,
...
void
rgrl_trans_translation::map_loc( vnl_vector<double> const& from,
...
void
rgrl_trans_translation::map_dir( vnl_vector<double> const& from_loc,
...
vnl_matrix<double>
rgrl_trans_translation::transfer_error_covar( vnl_vector<double> const& p  ) const
{
  assert( is_covar_set() );
...
vnl_vector<double>
rgrl_trans_translation::t() const
{
  return trans_ -  from_centre_;
}

void
rgrl_trans_translation::inv_map( const vnl_vector<double>& to,
...
rgrl_trans_translation::inverse_transform() const
{
...
void
rgrl_trans_translation::jacobian_wrt_loc( vnl_matrix<double>& jac, vnl_vector<double> const & /*from_loc*/ ) const
{
...
rgrl_transformation_sptr
rgrl_trans_translation::scale_by( double scale ) const
{
...
void
rgrl_trans_translation::write( vcl_ostream& os ) const
{
  // tag
  os << "TRANSLATION\n"
    // parameters
...
bool
rgrl_trans_translation::read( vcl_istream& is )
{
  int dim;
...
// : make a clone copy
rgrl_transformation_sptr
rgrl_trans_translation::clone() const
{
  return new rgrl_trans_translation( *this );
}
