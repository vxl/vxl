...
public:
  ...
  // The resulting direction \a to_dir is a unit vector.
  //
  void map_direction( vnl_vector<double> const& from_loc, vnl_vector<double> const& from_dir,
                      vnl_vector<double>      & to_dir    ) const;
  ...
  vnl_vector<double> map_direction( vnl_vector<double> const& from_loc, vnl_vector<double> const& from_dir ) const;
...
protected:
  ...
  //
  virtual
  void map_loc( vnl_vector<double> const& from, vnl_vector<double>      & to    ) const = 0;
