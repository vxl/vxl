...
// : return a self copy
rgrl_view_sptr
rgrl_view::self_copy() const
{
  return new rgrl_view( *this );
}

bool
rgrl_view::is_at_finest_resolution() const
{
  return current_resolution_ == 0;
}

bool
rgrl_view::current_region_converged() const
{
  return current_region_ == global_region_;
}

bool
rgrl_view::regions_converged_to(const rgrl_view& other) const
{
...
rgrl_view_sptr
rgrl_view::scale_by( unsigned new_resol, double scaling ) const
{
...
bool
rgrl_view::features_in_region( feature_vector& features, rgrl_feature_set const& fea_set ) const
{
...
bool
rgrl_view::inside_current_region( vnl_vector<double> const& loc )
{
...
#if 0
bool
rgrl_view::operator==( const rgrl_view& other ) const
{
