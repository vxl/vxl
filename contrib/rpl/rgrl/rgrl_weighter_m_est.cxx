...
void
rgrl_weighter_m_est::compute_weights( rgrl_scale const&  scales,
...
double
rgrl_weighter_m_est::aux_sum_weighted_residuals( rgrl_scale const&  scale,
...
//
double
rgrl_weighter_m_est::aux_sum_rho_values( rgrl_scale const&  scale,
                                         rgrl_match_set&    match_set,
                                         rgrl_transformation const&  xform )
{
  typedef rgrl_match_set::from_iterator from_iter;
...
double
rgrl_weighter_m_est::aux_neg_log_likelihood( rgrl_scale const&  scale,
                                             rgrl_match_set&    match_set,
                                             rgrl_transformation const&  xform )
{
  typedef rgrl_match_set::from_iterator from_iter;
...
double
rgrl_weighter_m_est::aux_avg_neg_log_likelihood( rgrl_scale const&  scale,
                                                 rgrl_match_set&    match_set,
                                                 rgrl_transformation const&  xform )
{
  typedef rgrl_match_set::from_iterator from_iter;
