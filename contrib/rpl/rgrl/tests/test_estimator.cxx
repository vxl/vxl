...
test_est_affine_pt_to_pt()
{
  ...
  // Test zero error case
    ...
    vcl_vector<rgrl_feature_sptr> to_pts;
      ...
      TEST("Estimator type is correct", bool( (est->transformation_type() == rgrl_trans_affine::type_id() ) != 0 ),
           true );
...
test_est_rigid()
{
  ...
  A(1, 0) = cos_t * sin_a * sin_p + cos_p * sin_t;  A(1, 1) = -sin_a * sin_p * sin_t + cos_p * cos_t;
  A(1, 2) = -cos_a * sin_p;
  A(2, 0) = -cos_p * cos_t * sin_a + sin_p * sin_t;  A(2, 1) = cos_p * sin_a * sin_t + cos_t * sin_p;
  A(2, 2) = cos_a * cos_p;
