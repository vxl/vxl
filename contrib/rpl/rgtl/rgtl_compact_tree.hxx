...
public:
  ...
  cell_index_type get_child(cell_index_type c, child_index_type child_index) const;
...
private:
  ...
  cell_index_type const & leaf_data_owner(leaf_data_index_type leaf_data_index) const
  {
    return leaf_data_owners_[leaf_data_index];
  }
