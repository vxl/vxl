...
public:
  ...
  leaf_data_type const * leaf_data_value_set(rgtl_compact_tree_link const& l,
  ...
  leaf_data_type const * leaf_data_value_get(rgtl_compact_tree_link const& l) const
  {
    if( l )
      {
...
public:
  ...
  node_data_type const * node_data_value_set(rgtl_compact_tree_link const& l,
  ...
  node_data_type const * node_data_value_get(rgtl_compact_tree_link const& l) const
  {
    if( l )
      {
...
public:
  ...
  leaf_data_type const * leaf_data_value_set(link const &, leaf_data_type const &) { return 0; }
...
public:
  ...
  node_data_type const * node_data_value_set(link const &, node_data_type const &) { return 0; }
