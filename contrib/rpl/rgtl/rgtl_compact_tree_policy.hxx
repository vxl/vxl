...
#ifndef rgtl_compact_tree_policy_hxx
#define rgtl_compact_tree_policy_hxx
...
#include "rgtl_compact_tree_node_data.hxx"
...
//: Node data value policy for use when no node data are needed in
//  rgtl_compact_tree<>.
...
//: Leaf data value policy for use when no leaf data are needed in
//  rgtl_compact_tree<>.
...
//: Template to lookup the real class to use for a leaf or non-empty
//  node data value policy given to rgtl_compact_tree.  Used by
//  rgtl_compact_tree_policy_lookup when the policy is not
...
{
  //: Node data value policies are used through the node data policy
  //  template.
  template <typename Policy>
  struct get
  {
...
//: Template to detect whether or not a given policy is
//  rgtl_node_data_value_policy_empty or derived from it.
template <typename Policy>
...
//: Template to switch the policy lookup based on whether the policy
//  is for empty node data or real data.
...
//: Template to lookup the real class to use for a leaf or node data
//  value policy given to rgtl_compact_tree.
template <typename Policy>
