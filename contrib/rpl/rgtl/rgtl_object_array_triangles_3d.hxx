...
public:
  ...
  virtual bool object_intersects_box(int id, double const center[3], double const radius, double const lower[3],
                                     double const upper[3], double const corners[8][3]) const;
