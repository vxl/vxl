...
public:
  ...
  void get_child(child_index_type child_index, rgtl_octree_cell_location& child) const;
...
template <unsigned int D>
bool operator<(rgtl_octree_cell_location<D> const& l, rgtl_octree_cell_location<D> const& r);
...
template <unsigned int D>
vcl_ostream & operator<<(vcl_ostream& os, rgtl_octree_cell_location<D> const& cell);
