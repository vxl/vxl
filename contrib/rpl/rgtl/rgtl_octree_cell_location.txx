...
#define RGTL_OCTREE_CELL_LOCATION_INSTANTIATE( D ) \
  ...
  template bool operator<(rgtl_octree_cell_location<D> const& l, rgtl_octree_cell_location<D> const& r); \
  template bool operator==(rgtl_octree_cell_location<D> const& l, rgtl_octree_cell_location<D> const& r); \
  template vcl_ostream & operator<<(vcl_ostream& os, rgtl_octree_cell_location<D> const& cell)
