...
#ifndef rgtl_octree_dual_hxx
#define rgtl_octree_dual_hxx
...
struct gen_args
  ...
  struct impl_case_m1
    ...
    static void invoke(arg1_type arg1, arg2_type arg2)
    {
      ...
      meta::call2<typename gen_args<D - 1>::template apply<m, c, i, (j << 1) | 0, (inarg << 1) | 0, (child << 1) | 1>,
                  F>::invoke(arg1, arg2);
      meta::call2<typename gen_args<D - 1>::template apply<m, c, i, (j << 1) | 1, (inarg << 1) | 1, (child << 1) | 0>,
                  F>::invoke(arg1, arg2);
    }
  ...
  struct impl_case_m0c1
    ...
    static void invoke(arg1_type arg1, arg2_type arg2)
    {
      ...
      meta::call2<typename gen_args<D - 1>::template apply<m, (c >> 1), (i >> 1), j, inarg, (child << 1) | (i & 1)>,
                  F>::invoke(arg1, arg2);
    }
  ...
  struct impl_case_m0c0
    ...
    static void invoke(arg1_type arg1, arg2_type arg2)
    {
      ...
      meta::call2<typename gen_args<D - 1>::template apply<m, (c >> 1), i, (j << 1) | 0, inarg, (child << 1) | 0>,
                  F>::invoke(arg1, arg2);
      meta::call2<typename gen_args<D - 1>::template apply<m, (c >> 1), i, (j << 1) | 1, inarg, (child << 1) | 1>,
                  F>::invoke(arg1, arg2);
    }
