...
public:
  ...
  rgtl_octree_point_location(cell_location_type const& cell, unsigned int corner = 0);
...
template <unsigned int D>
bool operator<(rgtl_octree_point_location<D> const& l, rgtl_octree_point_location<D> const& r);

// : Print a logical point location in a human-readable form.
template <unsigned int D>
vcl_ostream & operator<<(vcl_ostream& os, rgtl_octree_point_location<D> const& point);
