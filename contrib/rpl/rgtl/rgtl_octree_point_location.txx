...
#define RGTL_OCTREE_POINT_LOCATION_INSTANTIATE( D ) \
  ...
  template bool operator<(rgtl_octree_point_location<D> const& l, rgtl_octree_point_location<D> const& r); \
  template vcl_ostream & operator<<(vcl_ostream& os, rgtl_octree_point_location<D> const& point)
