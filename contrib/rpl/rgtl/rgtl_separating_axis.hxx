...
#ifndef rgtl_separating_axis_hxx
#define rgtl_separating_axis_hxx
...
#include "rgtl_separating_axis_projection.hxx"
...
public:
  ...
  //: Default constructor is meant only for initializing arrays of
  //  axes.  Assignment from a fully-constructed object should be
  ...
  //: Update the lower or upper bound for a point on the plane at
  ...
  //: Update the lower and upper bound for a sphere centered at the
