...
#ifndef rgtl_sqt_object_array_hxx
#define rgtl_sqt_object_array_hxx
...
//----------------------------------------------------------------------------
//: Base class for a set of objects in D dimensions belonging to a SQT
...
//----------------------------------------------------------------------------
//: Base class for a set of objects in D dimensions belonging to a SQT
//  cell in a particular face during construction.
...
public:
  ...
  //: Get the id of the original object that was copied or split
  //  to form an object in the set.
  virtual int original_id(int) const = 0;

  //: Split the current set of objects into the chilren of the current
  //  SQT cell.
  virtual void split(cell_geometry_type const& cell_geometry,
                     sqt_object_set_face_ptr children[1<<(D-1)]) = 0;

  //: Get the range of projection of objects in this set onto the
  //  given direction.
...
//----------------------------------------------------------------------------
//: Abstract interface for an object array given to rgtl_sqt_objects at
...
public:
  ...
  //: Get a set of the objects that belong to the given SQT face
  //  with respect to the given SQT origin.
