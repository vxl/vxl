...
public:
  ...
  virtual void get_depth_range(float const direction[D], float& depth_min, float& depth_max) const = 0;

  virtual void get_depth_range(double const direction[D], double& depth_min, double& depth_max) const = 0;
...
public:
  ...
  virtual sqt_object_set_ptr new_set(double const origin[D], unsigned int face) const = 0;
