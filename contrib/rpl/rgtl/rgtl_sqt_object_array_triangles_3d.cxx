...
public:
  ...
  rgtl_sqt_object_set_triangles_3d(double const origin[3], triangle_array_type const& triangles);
  ...
  virtual void get_depth_range(float const direction[3], float& depth_min, float& depth_max) const;

  virtual void get_depth_range(double const direction[3], double& depth_min, double& depth_max) const;
...
// ----------------------------------------------------------------------------
template <unsigned int Face>
rgtl_sqt_object_set_triangles_3d<Face>::rgtl_sqt_object_set_triangles_3d(double const origin[3],
...
// ----------------------------------------------------------------------------
rgtl_sqt_object_array_triangles_3d::rgtl_sqt_object_array_triangles_3d(object_array_type const& oa) : original_(oa)
{
}
