...
vnl_matrix<double>
rrel_affine_est::A( const vnl_vector<double>& params ) const
{
...
vnl_vector<double>
rrel_affine_est::trans( const vnl_vector<double>& params ) const
{
...
//
bool
rrel_affine_est::fit_from_minimal_set( const vcl_vector<int>& point_indices,
...
bool
rrel_affine_est::weighted_least_squares_fit( vnl_vector<double>& params,
