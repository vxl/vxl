...
public:
  ...
  // the points stored.
  //
  void n_nearest( point_type const& pt, unsigned n, vcl_vector<point_type>& points,
  ...
  // and validation.
  //
  void n_nearest_exhaustive( point_type const& pt, unsigned n, vcl_vector<value_type>& values ) const;
  ...
  // and validation.
  //
  void n_nearest_exhaustive( point_type const& pt, unsigned n, vcl_vector<point_type>& points,
                             vcl_vector<value_type>& values  ) const;
  ...
  //
  void points_within_radius( point_type const& pt, coord_type const& radius, vcl_vector<point_type>& points,
                             vcl_vector<value_type>& values  ) const;
  ...
  // searched.
  //
  void points_in_bounding_box( point_type const& min_pt, point_type const& max_pt,
                               vcl_vector<value_type>& values ) const;
  ...
  // searched.
  //
  void points_in_bounding_box( point_type const& min_pt, point_type const& max_pt, vcl_vector<point_type>& points,
                               vcl_vector<value_type>& values  ) const;
...
public:
  ...
  void  n_nearest_impl( point_type const& pt, unsigned n, vcl_vector<value_type>& values,
  ...
  // This version will add the results to \p values, and, if \p points is
  // not null, to \p points.
  void  n_nearest_exhaustive_impl( point_type const& pt, unsigned n, vcl_vector<value_type>& values,
                                   vcl_vector<point_type>* points ) const;
  ...
  // This version will add the results to \p values, and, if \p points is
  // not null, to \p points.
  void points_within_radius_impl( point_type const& pt, coord_type const& radius, vcl_vector<value_type>& values,
                                  vcl_vector<point_type>* points ) const;
  ...
  // not null, to \p points.
  //
  void points_in_bounding_box_impl( point_type const& min_pt, point_type const& max_pt, vcl_vector<value_type>& values,
                                    vcl_vector<point_type>* points ) const;
