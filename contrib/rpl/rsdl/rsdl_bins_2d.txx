...
template <class COORD_T, class VALUE_T>
rsdl_bins_2d<COORD_T, VALUE_T>::rsdl_bins_2d( const vnl_vector_fixed<COORD_T, 2> & min_pt,
...
template <class COORD_T, class VALUE_T>
void
rsdl_bins_2d<COORD_T, VALUE_T>::reset( const vnl_vector_fixed<COORD_T, 2> & min_pt,
                                       const vnl_vector_fixed<COORD_T, 2> & max_pt,
                                       const vnl_vector_fixed<COORD_T, 2> & bin_sizes )
{
  min_pt_ = min_pt;
...
template <class COORD_T, class VALUE_T>
void
rsdl_bins_2d<COORD_T, VALUE_T>::remove_all_points()
{
...
template <class COORD_T, class VALUE_T>
void
rsdl_bins_2d<COORD_T, VALUE_T>::add_point( const vnl_vector_fixed<COORD_T, 2> & pt,
                                           const VALUE_T & value )
{
  int bin_x, bin_y;
...
template <class COORD_T, class VALUE_T>
bool
rsdl_bins_2d<COORD_T, VALUE_T>::get_value( const vnl_vector_fixed<COORD_T,  2> & pt, VALUE_T& value )
{
  int bin_x, bin_y;
...
template <class COORD_T, class VALUE_T>
bool
rsdl_bins_2d<COORD_T, VALUE_T>::change_point( const vnl_vector_fixed<COORD_T, 2> & pt,
                                              const VALUE_T & value )
{
  int bin_x, bin_y;
...
template <class COORD_T, class VALUE_T>
bool
rsdl_bins_2d<COORD_T, VALUE_T>::remove_point( const vnl_vector_fixed<COORD_T, 2> & pt )
{
  int bin_x, bin_y;
...
template <class COORD_T, class VALUE_T>
void
rsdl_bins_2d<COORD_T, VALUE_T>::n_nearest( const vnl_vector_fixed<COORD_T, 2>& query_pt,
                                           int n,
...
template <class COORD_T, class VALUE_T>
bool
rsdl_bins_2d<COORD_T, VALUE_T>::is_any_point_within_radius( const vnl_vector_fixed<COORD_T, 2> & query_pt,
...
template <class COORD_T, class VALUE_T>
void
rsdl_bins_2d<COORD_T, VALUE_T>::points_within_radius( const vnl_vector_fixed<COORD_T,  2> & query_pt,
                                                      COORD_T radius,
                                                      vcl_vector<VALUE_T> & values ) const
{
  radius += vcl_sqrt(dist_tolerance_sqr_);
  ...
  for( int bin_x = min_bin_x; bin_x <= max_bin_x; ++bin_x )
    ...
    for( int bin_y = min_bin_y; bin_y <= max_bin_y; ++bin_y )
      {
      bin_vector_type_ const& bin_element = bins_(bin_x, bin_y);
      for( typename bin_vector_type_::const_iterator p = bin_element.begin();
           p != bin_element.end(); ++p )
        {
        if( vnl_vector_ssd( query_pt, p->point_ ) < sq_radius )
          {
...
template <class COORD_T, class VALUE_T>
bool
rsdl_bins_2d<COORD_T, VALUE_T>::is_any_point_in_bounding_box( const vnl_vector_fixed<COORD_T, 2>& min_query_pt,
...
template <class COORD_T, class VALUE_T>
void
rsdl_bins_2d<COORD_T, VALUE_T>::points_in_bounding_box( const vnl_vector_fixed<COORD_T, 2>& min_query_pt,
...
template <class COORD_T, class VALUE_T>
void
rsdl_bins_2d<COORD_T, VALUE_T>::point_to_bin( COORD_T x, COORD_T y, int& bin_x, int& bin_y ) const
{
...
template <class COORD_T, class VALUE_T>
COORD_T
rsdl_bins_2d<COORD_T, VALUE_T>::min_sq_distance_to_bin( COORD_T x, COORD_T y, int bin_x, int bin_y ) const
{
  COORD_T sq_dist = 0;
...
template <class COORD_T, class VALUE_T>
void
rsdl_bins_2d<COORD_T, VALUE_T>::change_value( const VALUE_T& old_val, const VALUE_T& new_val )
{
  for( int bin_x = 0; bin_x < num_bins_x_; ++bin_x )
    {
    for( int bin_y = 0; bin_y < num_bins_y_; ++bin_y )
...
template <class COORD_T, class VALUE_T>
vcl_size_t
rsdl_bins_2d<COORD_T, VALUE_T>::num_pts() const
{
  vcl_size_t num = 0;
...
#define RSDL_BINS_2D_INSTANTIATE( COORD_T, VALUE_T ) \
  ...
  template vcl_ostream & operator<<( vcl_ostream& ostr, \
