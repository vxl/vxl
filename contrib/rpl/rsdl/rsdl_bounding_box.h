...
public:
  ...
  inline const double& min_cartesian( unsigned int i ) const { return min_point_.cartesian(i); }
  ...
  inline const double& max_cartesian( unsigned int i ) const { return max_point_.cartesian(i); }
  ...
  inline const double& min_angular( unsigned int i ) const { return min_point_.angular(i); }
  ...
  inline const double& max_angular( unsigned int i ) const { return max_point_.angular(i); }
