...
static void test_dist()
{
  ...
  for( unsigned int i = 0; i < Nc; ++i )
    {
    p_cart.push_back( p_cart_arr[i] );
    }
  for( unsigned int i = 0; i < Nc; ++i )
    {
    q_cart.push_back( q_cart_arr[i] );
    }
  for( unsigned int i = 0; i < Na; ++i )
    {
    p_ang.push_back( p_ang_arr[i] );
    }
  for( unsigned int i = 0; i < Na; ++i )
    {
    q_ang.push_back( q_ang_arr[i] );
    }
  ...
  for( unsigned int i = 0; i < Nc; ++i )
    {
    cart0.push_back( cart0_arr[i] );
    }
  for( unsigned int i = 0; i < Na; ++i )
    {
    ang0.push_back( ang0_arr[i] );
    }
