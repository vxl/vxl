...
!MESSAGE "vepl_example_add_random_noise - Win32 MinSizeRel" (based on "Win32 (x86) Application")
!MESSAGE "vepl_example_add_random_noise - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "vepl_example_add_random_noise - Win32 RelWithDebInfo" (based on "Win32 (x86) Application")
!MESSAGE 
...
!ELSEIF  "$(CFG)" == "vepl_example_add_random_noise - Win32 MinSizeRel"
# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 0
...
!ELSEIF  "$(CFG)" == "vepl_example_add_random_noise - Win32 RelWithDebInfo"
...
# Name "vepl_example_add_random_noise - Win32 MinSizeRel"
# Name "vepl_example_add_random_noise - Win32 RelWithDebInfo"
...
USERDEP__HACK=\
	...
	"$(IUEROOT)/tbl/vepl/CMakeLists.txt"\
	"$(IUEROOT)/tbl/vepl/CMakeListsLink.txt"\
	".\CMakeLists.txt"\
...
"vepl_example_add_random_noise.dsp" :  "$(SOURCE)" "$(INTDIR)" "$(OUTDIR)"
	"cmake.exe" ".\CMakeLists.txt" -DSP -H"$(IUEROOT)" -S"$(IUEROOT)/tbl/vepl/examples" -O"$(IUEROOT)/WIN32-VC60/tbl/vepl/examples" -B"$(IUEROOT)/WIN32-VC60"
