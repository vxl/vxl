// This is tbl/vepl/tests/vepl_test_dilate_disk.cxx
#include <iostream>
#include <string>
#include "test_driver.h"
//:
// \file
//  Test of the vepl_dilate_disk function.
//
...
int vepl_test_dilate_disk()
{
  std::cout << "Starting vepl_dilate_disk tests\n"
  ...
  std::string m = "vepl_dilate_disk";
#define args ,5
  ONE_TEST(vepl_dilate_disk,byte_img,byte_ori,vxl_byte,70355,m+"_byte",args);
  ONE_TEST(vepl_dilate_disk,shrt_img,shrt_ori,vxl_uint_16,17565395,m+"_short",args);
  ONE_TEST(vepl_dilate_disk,int__img,int__ori,vxl_uint_32,17565395,m+"_int",args);
  ONE_TEST(vepl_dilate_disk,flot_img,flot_ori,float,338,m+"_float",args);
  ONE_TEST(vepl_dilate_disk,dble_img,dble_ori,double,338,m+"_double",args);
  ONE_TEST(vepl_dilate_disk,colr_img,colr_ori,vil_rgb<vxl_byte>,4200,m+"_colour",args);
  ONE_TEST(vepl_dilate_disk,colp_img,colp_ori,vxl_byte,4200,m+"_planar",args);

  return 0;
}

TESTMAIN(vepl_test_dilate_disk);
