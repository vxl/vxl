...
!MESSAGE "vepl_test_erode_disk - Win32 MinSizeRel" (based on "Win32 (x86) Application")
!MESSAGE "vepl_test_erode_disk - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "vepl_test_erode_disk - Win32 RelWithDebInfo" (based on "Win32 (x86) Application")
!MESSAGE 
...
!ELSEIF  "$(CFG)" == "vepl_test_erode_disk - Win32 MinSizeRel"
# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 0
...
!ELSEIF  "$(CFG)" == "vepl_test_erode_disk - Win32 RelWithDebInfo"
...
# Name "vepl_test_erode_disk - Win32 MinSizeRel"
# Name "vepl_test_erode_disk - Win32 RelWithDebInfo"
...
"vepl_test_erode_disk.dsp" :  "$(SOURCE)" "$(INTDIR)" "$(OUTDIR)"
	"cmake.exe" ".\CMakeLists.txt" -DSP -H"$(IUEROOT)" -S"$(IUEROOT)/tbl/vepl/tests" -O"$(IUEROOT)/WIN32-VC60/tbl/vepl/tests" -B"$(IUEROOT)/WIN32-VC60"
