...
//:
// \file
//  Test of the vepl_x_gradient function.
//
...
{
  std::cout << "Starting vepl_x_gradient tests\n"
  ...
  std::string m = "vepl_x_gradient";
#define args
  ONE_TEST(vepl_x_gradient,byte_img,byte_ori,vxl_byte,90104,m+"_byte",args);
  ONE_TEST(vepl_x_gradient,shrt_img,shrt_ori,vxl_uint_16,23199224,m+"_short",args);
  ONE_TEST(vepl_x_gradient,int__img,int__ori,vxl_uint_32,8912376,m+"_int",args);
  ONE_TEST(vepl_x_gradient,flot_img,flot_ori,float,282,m+"_float",args);
  ONE_TEST(vepl_x_gradient,dble_img,dble_ori,double,282,m+"_double",args);
  ONE_TEST(vepl_x_gradient,colr_img,colr_ori,vil_rgb<vxl_byte>,107504,m+"_colour",args);
  ONE_TEST(vepl_x_gradient,colp_img,colp_ori,vxl_byte,107504,m+"_planar",args);

  return 0;
}

TESTMAIN(vepl_test_x_gradient);
