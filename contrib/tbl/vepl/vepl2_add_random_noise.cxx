// This is tbl/vepl/vepl2_add_random_noise.cxx
...
vil_image_resource_sptr vepl2_add_random_noise(vil_image_resource_sptr image, double maxdev)
{
  ...
  //
    ...
    vcl_cerr << __FILE__ ": vepl2_add_random_noise() not implemented for " << image << '\n';
