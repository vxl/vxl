// This is tbl/vepl/vepl2_gradient_mag.cxx
...
vil_image_resource_sptr vepl2_gradient_mag(vil_image_resource_sptr image, double scale, double shift)
{
  ...
  //
    ...
    vcl_cerr << __FILE__ ": vepl2_gradient_mag() not implemented for " << image << '\n';
