// This is tbl/vepl/vepl2_median.cxx
...
vil_image_resource_sptr vepl2_median(vil_image_resource_sptr image, float radius)
{
  ...
  //
    ...
    vcl_cerr << __FILE__ ": vepl2_median() not implemented for " << image << '\n';
