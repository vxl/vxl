// This is tbl/vepl/vepl2_moment.cxx
...
vil_image_resource_sptr vepl2_moment(vil_image_resource_sptr image, int order, int width, int height)
{
  ...
  //
    ...
    vcl_cerr << __FILE__ ": vepl2_moment() not implemented for " << image << '\n';
