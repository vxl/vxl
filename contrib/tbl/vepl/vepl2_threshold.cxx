// This is tbl/vepl/vepl2_threshold.cxx
...
vil_image_resource_sptr vepl2_threshold(vil_image_resource_sptr image, double threshold, double below, double above)
{
  ...
  //
    ...
    vcl_cerr << __FILE__ ": vepl2_threshold() not implemented for " << image << '\n';
