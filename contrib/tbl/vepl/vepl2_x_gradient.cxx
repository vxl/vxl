// This is tbl/vepl/vepl2_x_gradient.cxx
...
vil_image_resource_sptr vepl2_x_gradient(vil_image_resource_sptr image, double scale, double shift)
{
  ...
  //
    ...
    vcl_cerr << __FILE__ ": vepl2_x_gradient() not implemented for " << image << '\n';
