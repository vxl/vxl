...
vil_image_resource_sptr vepl_y_gradient(vil_image_resource_sptr image, double scale, double shift)
{
  ...
  //
    ...
    {
    vcl_cerr << __FILE__ ": vepl_y_gradient() not implemented for " << image << '\n';
    }
