...
vil_image_resource_sptr vepl_y_gradient(const vil_image_resource_sptr& image, double scale, double shift)
{
  ...
  //
    ...
    std::cerr << __FILE__ ": vepl_y_gradient() not implemented for " << image << '\n';
