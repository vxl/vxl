# Microsoft Developer Studio Project File - Name="vepl1_example_histogram" - Package Owner=<4>
...
# vepl1_example_histogram  == name of output library
...
CFG=vepl1_example_histogram - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "vepl1_example_histogram.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "vepl1_example_histogram.mak" CFG="vepl1_example_histogram - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "vepl1_example_histogram - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "vepl1_example_histogram - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "vepl1_example_histogram - Win32 Release"
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/contrib/tbl" /I "$(VXLROOT)/v3p/jpeg" /I "$(VXLROOT)/v3p/png" /I "$(VXLROOT)/v3p/zlib" /I "$(VXLROOT)/v3p/tiff" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_JPEG -DHAS_PNG -DHAS_ZLIB -DHAS_TIFF /D "vepl1_example_histogram_EXPORTS"
...
!ELSEIF  "$(CFG)" == "vepl1_example_histogram - Win32 Debug"
...
# Name "vepl1_example_histogram - Win32 Release"
# Name "vepl1_example_histogram - Win32 Debug"
