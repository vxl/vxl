#ifndef vepl1_median_h_
#define vepl1_median_h_
//:
// \file
// \brief median filter with circular element
//
//   vepl1_median filtering is an operation that replaces a pixel with the
...
vil1_image vepl1_median(vil1_image const& , float radius=1.0);

#endif // vepl1_median_h_
