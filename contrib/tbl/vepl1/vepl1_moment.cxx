// This is tbl/vepl1/vepl1_moment.cxx
...
vil1_image vepl1_moment(vil1_image const& image, int order, int width, int height)
{
  ...
  // byte rgb
    ...
    vcl_cerr << __FILE__ ": vepl1_moment() cannot be implemented for colour images\n";
    return 0;
  }
  ...
  //
    ...
    vcl_cerr << __FILE__ ": vepl1_moment() not implemented for " << image << vcl_endl;
    return 0;
  }
}
