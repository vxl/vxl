...
# ADD CPP  /I "$(VXLROOT)\vcl" /I "$(VXLROOT)\core" /I "$(VXLROOT)\vcl" /I "$(VXLROOT)\vcl\config.win32" /I "$(VXLROOT)\core" /I "$(VXLROOT)\contrib\tbl" /I "$(VXLROOT)\contrib\mul"   -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DINSTANTIATE_TEMPLATES -DINSTANTIATE_TEMPLATES /D "vepl2_example1_threshold_EXPORTS"
