...
#define args
  ...
  ONE_TEST(vepl2_gradient_dir,int__img,int__ori,unsigned int,21757788,m+"_int",args);
  ...
  ONE_TEST(vepl2_gradient_dir,colr_img,colr_ori,vil2_rgb<unsigned char>,123506,m+"_colour",args);
