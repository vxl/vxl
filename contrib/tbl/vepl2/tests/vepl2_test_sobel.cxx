...
#define args
  ONE_TEST(vepl2_sobel,byte_img,byte_ori,unsigned char,242,m+"_byte",args);
  ONE_TEST(vepl2_sobel,shrt_img,shrt_ori,unsigned short,65522,m+"_short",args);
  ONE_TEST(vepl2_sobel,flot_img,flot_ori,float,301,m+"_float",args);
  ONE_TEST(vepl2_sobel,colr_img,colr_ori,vil_rgb,118,m+"_colour",args);
