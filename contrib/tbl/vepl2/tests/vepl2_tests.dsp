# Microsoft Developer Studio Project File - Name="vepl2_tests" - Package Owner=<4>
...
# vepl2_tests  == name of output library
# /libpath:"$(VXLROOT)/contrib/tbl/vepl2/$(OUTDIR)" /libpath:"$(VXLROOT)/contrib/tbl/vepl2/$(OUTDIR)" /libpath:"$(VXLROOT)/contrib/tbl/vipl2/$(OUTDIR)" /libpath:"$(VXLROOT)/contrib/tbl/vipl2/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vil/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vil/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vpl/$(OUTDIR)" /libpath:"$(VXLROOT)/core/vpl/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/jpeg/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/jpeg/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/png/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/png/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/zlib/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/zlib/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/tiff/$(OUTDIR)" /libpath:"$(VXLROOT)/v3p/tiff/$(OUTDIR)" "vepl2.lib" "vipl2.lib" "vil.lib" "vpl.lib" "jpeg.lib" "png.lib" "zlib.lib" "tiff.lib" /STACK:10000000  == libraries linked in 
# TARGTYPE "Win32 (x86) Application" 0x0103

CFG=vepl2_tests - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "vepl2_tests.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "vepl2_tests.mak" CFG="vepl2_tests - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "vepl2_tests - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "vepl2_tests - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "vepl2_tests - Win32 Release"
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" /I "$(VXLROOT)/contrib/tbl" /I "$(VXLROOT)/v3p/jpeg" /I "$(VXLROOT)/v3p/png" /I "$(VXLROOT)/v3p/zlib" /I "$(VXLROOT)/v3p/tiff" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE -DHAS_JPEG -DHAS_PNG -DHAS_ZLIB -DHAS_TIFF /D "vepl2_tests_EXPORTS"
...
# ADD LINK32 /libpath:"$(VXLROOT)/contrib/tbl/vepl2/$(OUTDIR)"
# ADD LINK32 /libpath:"$(VXLROOT)/contrib/tbl/vipl2/$(OUTDIR)"
...
# ADD LINK32 "vepl2.lib" "vipl2.lib" "vil.lib" "vpl.lib" "jpeg.lib" "png.lib" "zlib.lib" "tiff.lib" /STACK:10000000 

!ELSEIF  "$(CFG)" == "vepl2_tests - Win32 Debug"
...
# Name "vepl2_tests - Win32 Release"
# Name "vepl2_tests - Win32 Debug"
