...
vil2_image_view_base_sptr vepl2_dilate_disk(vil2_image_view_base const& image, float radius)
{
  ...
  // byte greyscale
    ...
    vipl_dilate_disk<vil2_image_view_base,vil2_image_view_base,vxl_byte,vxl_byte> op(radius);
  ...
  // short
    ...
    vipl_dilate_disk<vil2_image_view_base,vil2_image_view_base,unsigned short,unsigned short> op(radius);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
  ...
  // int
    ...
    vipl_dilate_disk<vil2_image_view_base,vil2_image_view_base,unsigned,unsigned> op(radius);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
  ...
  // float
    ...
    vipl_dilate_disk<vil2_image_view_base,vil2_image_view_base,float,float> op(radius);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
  ...
  // double
    ...
    vipl_dilate_disk<vil2_image_view_base,vil2_image_view_base,double,double> op(radius);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
