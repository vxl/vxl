...
vil_image_view_base_sptr vepl2_dilate_disk(vil_image_view_base const& image, float radius)
{
  // multi-planar image
  ...
  // short
    ...
    vipl_dilate_disk<vil_image_view_base,vil_image_view_base,unsigned short,unsigned short> op(radius);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
  ...
  // int
    ...
    vipl_dilate_disk<vil_image_view_base,vil_image_view_base,unsigned,unsigned> op(radius);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
