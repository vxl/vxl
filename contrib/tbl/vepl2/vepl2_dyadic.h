...
void vepl2_dyadic_sum(vil_image_view_base_sptr , vil_image_view_base const& );
//: subtract the second image from the first one pixelwise
void vepl2_dyadic_dif(vil_image_view_base_sptr , vil_image_view_base const& );
//: replace pixels of the first image by minimum pixel value of both
void vepl2_dyadic_min(vil_image_view_base_sptr , vil_image_view_base const& );
//: replace pixels of the first image by maximum pixel value of both
void vepl2_dyadic_max(vil_image_view_base_sptr , vil_image_view_base const& );
