// This is tbl/vepl2/vepl2_gaussian_convolution.cxx
#include "vepl2_gaussian_convolution.h"
...
vil2_image_view_base_sptr vepl2_gaussian_convolution(vil2_image_view_base const& image, double sigma, double cutoff)
{
  ...
  // byte greyscale
    ...
    vipl_gaussian_convolution<vil2_image_view_base,vil2_image_view_base,vxl_byte,vxl_byte,vipl_trivial_pixeliter> op(sigma, cutoff);
  ...
  // short
    ...
    vipl_gaussian_convolution<vil2_image_view_base,vil2_image_view_base,vxl_uint_16,vxl_uint_16,vipl_trivial_pixeliter> op(sigma, cutoff);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
  ...
  // int
    ...
    vipl_gaussian_convolution<vil2_image_view_base,vil2_image_view_base,vxl_uint_32,vxl_uint_32,vipl_trivial_pixeliter> op(sigma, cutoff);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
  ...
  // float
    ...
    vipl_gaussian_convolution<vil2_image_view_base,vil2_image_view_base,float,float,vipl_trivial_pixeliter> op(sigma, cutoff);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
  ...
  // double
    ...
    vipl_gaussian_convolution<vil2_image_view_base,vil2_image_view_base,double,double,vipl_trivial_pixeliter> op(sigma, cutoff);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
  ...
  //
    ...
    vcl_cerr << __FILE__ ": vepl2_gaussian_convolution() not implemented for " << image.is_a() << '\n';
    return 0;
  }
}
