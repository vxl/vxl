...
vil_image_resource_sptr vepl2_gaussian_convolution(vil_image_resource_sptr image, double sigma, double cutoff)
{
  ...
  //
    ...
    vcl_cerr << __FILE__ ": vepl2_gaussian_convolution() not implemented for " << image << '\n';
