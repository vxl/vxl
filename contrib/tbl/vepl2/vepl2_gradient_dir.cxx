...
vil_image_resource_sptr vepl2_gradient_dir(vil_image_resource_sptr image, double scale, double shift)
{
  ...
  //
    ...
    vcl_cerr << __FILE__ ": vepl2_gradient_dir() not implemented for " << image << '\n';
