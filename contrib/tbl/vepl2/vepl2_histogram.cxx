...
vcl_vector<unsigned int> vepl2_histogram(vil_image_view_base const& image)
{
  // byte rgb
  ...
  // short greyscale
    ...
    vipl_histogram<vil_image_view_base,vcl_vector<unsigned int>, unsigned short,unsigned int> op;
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(&out);
    op.filter();
    return out;
