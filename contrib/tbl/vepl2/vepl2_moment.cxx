...
vil2_image_view_base_sptr vepl2_moment(vil2_image_view_base const& image, int order, int width, int height)
{
  ...
  // byte greyscale
    ...
    vipl_moment<vil2_image_view_base,vil2_image_view_base,vxl_byte,vxl_byte,vipl_trivial_pixeliter> op(order, width, height);
  ...
  // short
    ...
    vipl_moment<vil2_image_view_base,vil2_image_view_base,vxl_uint_16,vxl_uint_16,vipl_trivial_pixeliter> op(order, width, height);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
  ...
  // int
    ...
    vipl_moment<vil2_image_view_base,vil2_image_view_base,vxl_uint_32,vxl_uint_32,vipl_trivial_pixeliter> op(order, width, height);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
  ...
  // float
    ...
    vipl_moment<vil2_image_view_base,vil2_image_view_base,float,float,vipl_trivial_pixeliter> op(order, width, height);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
  ...
  // double
    ...
    vipl_moment<vil2_image_view_base,vil2_image_view_base,double,double,vipl_trivial_pixeliter> op(order, width, height);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
    return out;
