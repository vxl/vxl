...
vil2_image_view_base_sptr vepl2_x_gradient(vil2_image_view_base const& image, double scale, double shift)
{
  ...
  if (image.nplanes() == 1 && image.pixel_format() == VIL2_PIXEL_FORMAT_RGB_BYTE) {
    ...
    vil2_image_view<r_g_b>* out = new vil2_image_view<r_g_b>(image.ni(),image.nj(),1);
    vipl_x_gradient<vil2_image_view_base,vil2_image_view_base,r_g_b,r_g_b>
  ...
  // byte greyscale
    ...
    vipl_x_gradient<vil2_image_view_base,vil2_image_view_base,vxl_byte,vxl_byte>
  ...
  // short
    ...
    vipl_x_gradient<vil2_image_view_base,vil2_image_view_base,vxl_uint_16,vxl_uint_16>
  ...
  // int
    ...
    vipl_x_gradient<vil2_image_view_base,vil2_image_view_base,vxl_uint_32,vxl_uint_32>
  ...
  // float
    ...
    vipl_x_gradient<vil2_image_view_base,vil2_image_view_base,float,float>
  ...
  // double
    ...
    vipl_x_gradient<vil2_image_view_base,vil2_image_view_base,double,double>
      op(scale, shift);
    op.put_in_data_ptr(&image);
    op.put_out_data_ptr(out);
    op.filter();
