#ifndef vepl2_x_gradient_h_
#define vepl2_x_gradient_h_
...
vil2_image_view_base_sptr vepl2_x_gradient(vil2_image_view_base const& , double scale=1.0, double shift=0.0);

#endif // vepl2_x_gradient_h_
