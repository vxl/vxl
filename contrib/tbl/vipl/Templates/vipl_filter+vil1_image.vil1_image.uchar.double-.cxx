...
template class vipl_filter<vil1_image, vil1_image, unsigned char, double, 2, vipl_trivial_pixeliter>;

#include <vipl/filter/vipl_filter_2d.txx>
template class vipl_filter_2d<vil1_image, vil1_image, unsigned char, double, vipl_trivial_pixeliter>;
