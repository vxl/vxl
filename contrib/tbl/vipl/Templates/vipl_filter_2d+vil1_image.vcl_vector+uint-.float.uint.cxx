...
template class vipl_filter<vil1_image, vcl_vector<unsigned>, float, unsigned, 2, vipl_trivial_pixeliter>;

#include <vipl/filter/vipl_filter_2d.txx>
template class vipl_filter_2d<vil1_image, vcl_vector<unsigned>, float, unsigned, vipl_trivial_pixeliter>;
#endif
