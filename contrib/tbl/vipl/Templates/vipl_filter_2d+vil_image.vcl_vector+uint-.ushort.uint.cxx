...
template class vipl_filter<vil_image, vcl_vector<unsigned>, unsigned short, unsigned, 2, vipl_trivial_pixeliter>;

#include <vipl/filter/vipl_filter_2d.txx>
template class vipl_filter_2d<vil_image, vcl_vector<unsigned>, unsigned short, unsigned, vipl_trivial_pixeliter>;
