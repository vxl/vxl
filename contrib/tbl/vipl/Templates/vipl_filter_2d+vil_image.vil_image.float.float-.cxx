...
{
  vipl_section_container<float> *rtn = new vipl_section_container<float>((vipl_section_container<float>*)0);
...
template class vipl_filter<vil_image, vil_image, float, float, 2 VCL_DFL_TMPL_ARG(vipl_trivial_pixeliter)>;

#include <vipl/filter/vipl_filter_2d.h>
#include <vipl/filter/vipl_filter_2d.txx>
template class vipl_filter_2d<vil_image, vil_image, float, float VCL_DFL_TMPL_ARG(vipl_trivial_pixeliter)>;
