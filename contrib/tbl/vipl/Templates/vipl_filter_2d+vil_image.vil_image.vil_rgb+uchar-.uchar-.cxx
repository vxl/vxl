...
vipl_filterable_section_container_generator(const vil_image& im, rgbcell*)
{
...
template class vipl_filter<vil_image, vil_image, rgbcell, unsigned char, 2 VCL_DFL_TMPL_ARG(vipl_trivial_pixeliter)>;

#include <vipl/filter/vipl_filter_2d.h>
#include <vipl/filter/vipl_filter_2d.txx>
template class vipl_filter_2d<vil_image, vil_image, rgbcell, unsigned char VCL_DFL_TMPL_ARG(vipl_trivial_pixeliter)>;
