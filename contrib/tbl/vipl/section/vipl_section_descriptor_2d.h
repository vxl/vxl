...
class vipl_section_container_2d;                             // template forward reference
template <class DataType>
class vipl_section_iterator;                             // template forward reference
...
protected:
  ...
  vipl_section_descriptor_2d(const vipl_section_descriptor<DataType>* desc,
