...
template bool difference(vil_image_view<short> const &, vil_image_view<short> const &, double, vcl_string const &,
                         short);

template bool difference(vil_image_view<float> const &, vil_image_view<float> const &, double, vcl_string const &,
                         float);
