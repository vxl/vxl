...
//  vipl_erode_disk<vil1_image,vil1_image,T,T>
...
#define ALL_TESTS(x,m,p) \
  ONE_TEST(x,p,byte_img,byte_ori,vil1_image,unsigned char,76567,m+"_byte"); \
  ONE_TEST(x,p,shrt_img,shrt_ori,vil1_image,unsigned short,19530000,m+"_short"); \
/*ONE_TEST(x,p,flot_img,flot_ori,vil1_image,float,0,m+"_float"); */ \
/*ONE_TEST(x,p,colr_img,colr_ori,vil1_image,vil1_rgb_byte,0,m+"_colour") */
...
int vipl_test_erode_disk() {
  ...
  vil1_image colr_img = CreateTest3planeImage(32,32),colr_ori = CreateTest3planeImage(32,32);
#endif
  vcl_cout << " done\n";
