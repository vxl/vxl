...
template class vipl_filter<section<ubyte,2>, section<ubyte,2>, ubyte, ubyte, 2 VCL_DFL_TMPL_ARG(vipl_trivial_pixeliter)>;

#include <vipl/filter/vipl_filter_2d.h>
#include <vipl/filter/vipl_filter_2d.txx>
template class vipl_filter_2d<section<ubyte,2>, section<ubyte,2>, ubyte, ubyte VCL_DFL_TMPL_ARG(vipl_trivial_pixeliter)>;
