...
# testlib  == name of output library
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vxl" /I "$(VXLROOT)/vcl/config.win32-VC60" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "testlib_EXPORTS"
