# Microsoft Developer Studio Project File - Name="vbl_io_test_all" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Console Application" 0x0103

CFG=vbl_io_test_all - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "vbl_io_test_all.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "vbl_io_test_all.mak" CFG="vbl_io_test_all - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "vbl_io_test_all - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "vbl_io_test_all - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!IF  "$(CFG)" == "vbl_io_test_all - Win32 Release"
...
!ELSEIF  "$(CFG)" == "vbl_io_test_all - Win32 Debug"
