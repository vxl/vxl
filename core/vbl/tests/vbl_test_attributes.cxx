...
vbl_test_attributes_1d()
{
  ...
  bounds(v, mnvb, mxvb);
  double mn = mean(v);
  TEST("min,max,bounds 1d", mnv == 0.04 && mxv == 10.0 && mnvb == 0.04 && mxvb == 10.0, true);
...
vbl_test_attributes_2d()
{
  ...
  bounds(v, mnvb, mxvb);
  double mn = mean(v);
  TEST("min,max,bounds 2d", mnv == 0.04 && mxv == 10.0 && mnvb == 0.04 && mxvb == 10.0, true);
...
vbl_test_attributes_3d()
{
  ...
  bounds(v, mnvb, mxvb);
  double mn = mean(v);
  TEST("min,max,bounds 3d", mnv == 0.04 && mxv == 10.0 && mnvb == 0.04 && mxvb == 10.0, true);
