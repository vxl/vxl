...
vbl_test_local_minima_2d()
{
  ...
  std::cout << '\n';
  success = success && minima[0][nc / 2] > 0 && minima[nr / 2][0] > 0 && minima[nr - 1][nc / 2] > 0 &&
            minima[nr / 2][nc - 1] > 0 && minima[0][0] > 0 && minima[nr - 1][0] > 0 && minima[0][nc - 1] > 0 &&
            minima[nr - 1][nc - 1] > 0;
...
vbl_test_local_minima_3d()
{
  ...
  // set face centers
  v[n1 / 2][n2 / 2][0] = 0.05;
  v[n1 / 2][n2 / 2][n3 - 1] = 0.05;
  v[0][n2 / 2][n3 / 2] = 0.05;
  v[n1 - 1][n2 / 2][n3 / 2] = 0.05;
  v[n1 / 2][0][n3 / 2] = 0.05;
  ...
  success = success && minima[n1 / 2][n2 / 2][n3 / 2] > 0 && minima[0][0][0] > 0 && minima[n1 - 1][0][0] > 0 &&
            minima[0][n2 - 1][0] > 0 && minima[n1 - 1][n2 - 1][0] > 0 && minima[0][0][n3 - 1] > 0 &&
            minima[n1 - 1][0][n3 - 1] > 0 && minima[0][n2 - 1][n3 - 1] > 0 && minima[n1 - 1][n2 - 1][n3 - 1] > 0;

  success = success && minima[n1 / 2][0][0] > 0 && minima[0][n2 / 2][0] > 0 && minima[0][0][n3 / 2] > 0 &&
            minima[n1 / 2][n2 - 1][0] > 0 && minima[n1 - 1][n2 / 2][0] > 0 && minima[n1 - 1][0][n3 / 2] > 0;

  // set face centers
  success = success && minima[n1 / 2][n2 / 2][0] > 0 && minima[n1 / 2][n2 / 2][n3 - 1] > 0 &&
            minima[0][n2 / 2][n3 / 2] > 0 && minima[n1 - 1][n2 / 2][n3 / 2] > 0 && minima[n1 / 2][0][n3 / 2] > 0 &&
            minima[n1 / 2][n2 - 1][n3 / 2] > 0;
  TEST("test 3-d maxima", success, true);
}

static void
vbl_test_local_minima()
{
  vbl_test_local_minima_1d();
  vbl_test_local_minima_2d();
  vbl_test_local_minima_3d();
