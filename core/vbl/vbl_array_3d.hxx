...
template <class T>
void
vbl_array_3d<T>::construct(size_type n1, size_type n2, size_type n3)
{
  row1_count_ = n1;
  row2_count_ = n2;
  row3_count_ = n3;
...
template <class T>
void
vbl_array_3d<T>::resize(size_type n1, size_type n2, size_type n3)
{
...
template <class T>
void
vbl_array_3d<T>::fill(const T & value)
{
...
template <class T>
std::ostream &
operator<<(std::ostream & os, vbl_array_3d<T> const & A)
{
...
template <class T>
std::ostream &
operator<<(std::ostream & os, const vbl_array_3d<std::vector<T>> & A)
{
  typedef typename vbl_array_3d<T>::size_type size_type;
  os << "vbl_array_3d [";
  for (size_type i = 0; i < A.get_row1_count(); ++i)
...
template <class T>
std::istream &
operator>>(std::istream & is, vbl_array_3d<T> & A)
{
  typedef typename vbl_array_3d<T>::size_type size_type;
  for (size_type i = 0; i < A.get_row1_count(); ++i)
    for (size_type j = 0; j < A.get_row2_count(); ++j)
...
template <class T>
std::istream &
operator>>(std::istream & is, vbl_array_3d<std::vector<T>> & A)
{
  typedef typename vbl_array_3d<T>::size_type size_type;
  for (size_type i = 0; i < A.get_row1_count(); ++i)
    for (size_type j = 0; j < A.get_row2_count(); ++j)
