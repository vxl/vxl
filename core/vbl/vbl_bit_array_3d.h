...
public:
  ...
  vbl_bit_array_3d(unsigned int sizex, unsigned int sizey, unsigned int sizez) { construct(sizex, sizey, sizez); }
  ...
  vbl_bit_array_3d(unsigned int sizex, unsigned int sizey, unsigned int sizez, bool v[]);
  //: Copy constructor
  vbl_bit_array_3d(const vbl_bit_array_3d &);
  // Destructor
  ~vbl_bit_array_3d() { delete[] data_; }

  //: Assignment operator
  vbl_bit_array_3d &
  operator=(const vbl_bit_array_3d &);

  //: Comparison
  bool
  operator==(const vbl_bit_array_3d & a) const;
  //:
  bool
  operator!=(const vbl_bit_array_3d & a) const
  {
  ...
  void
  resize(unsigned int m, unsigned int n, unsigned int p)
  {
    destruct();
    construct(m, n, p);
  }
  ...
  clear()
  {
    ...
    {
      destruct();
      row1_count_ = row2_count_ = row3_count_ = 0;
    }
  }

  //: Set the value of a cell
  void
  put(unsigned int i1, unsigned int i2, unsigned int i3, bool v);

  //: Set the value of a cell; default is to set the value on
  void
  set(unsigned int i1, unsigned int i2, unsigned int i3, bool v = true)
  {
    put(i1, i2, i3, v);
  }
  ...
  bool
  get(unsigned int i1, unsigned int i2, unsigned int i3) const;

  //: Change the value of a cell
  void
  flip(unsigned int i1, unsigned int i2, unsigned int i3);

  //: Return the value of a cell
  bool
  operator()(unsigned int i1, unsigned int i2, unsigned int i3) const;
...
private:
  ...
  void
  construct(unsigned int m, unsigned int n, unsigned int p);

  void
  index(unsigned int x, unsigned int y, unsigned int z, unsigned long & byteindex, unsigned char & bitindex) const;
};

std::ostream &
operator<<(std::ostream & os, const vbl_bit_array_3d &);
