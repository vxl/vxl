...
template <class T>
vbl_array_1d<T>
vbl_local_minima(const vbl_array_1d<T> & in, T thresh = T(0))
{
  vbl_array_1d<T> m(in.size(), T(0));
  if (local_minima(in, m, thresh))
    return m;
  else
    return vbl_array_1d<T>();
}
...
template <class T>
vbl_array_2d<T>
vbl_local_minima(const vbl_array_2d<T> & in, T thresh = T(0))
{
  vbl_array_2d<T> m(in.rows(), in.cols(), T(0));
  if (local_minima(in, m, thresh))
    return m;
  else
    return vbl_array_2d<T>();
}
...
template <class T>
vbl_array_3d<T>
vbl_local_minima(const vbl_array_3d<T> & in, T thresh = T(0))
{
  vbl_array_3d<T> m = in;
  if (local_minima(in, m, thresh))
    return m;
  else
    return vbl_array_3d<T>();
}
...
template <class T>
bool
local_minima(const vbl_array_1d<T> & in, vbl_array_1d<T> & minima, T thresh = T(0));

//: DEPRECATED
// \deprecated in favour of vbl_local_minima
template <class T>
bool
local_minima(const vbl_array_2d<T> & in, vbl_array_2d<T> & minima, T thresh = T(0));

//: DEPRECATED
// \deprecated in favour of vbl_local_minima
template <class T>
bool
local_minima(const vbl_array_3d<T> & in, vbl_array_3d<T> & minima, T thresh = T(0));
