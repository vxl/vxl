...
//---------------------------------------------------------------------------
vnl_vector<double>
vcsl_displacement::execute(const vnl_vector<double> & v, double time) const
{
  // require
  assert(is_valid());
...
//---------------------------------------------------------------------------
vnl_vector<double>
vcsl_displacement::inverse(const vnl_vector<double> & v, double time) const
{
  // require
  assert(is_valid());
...
//---------------------------------------------------------------------------
vnl_vector<double>
vcsl_displacement::vector_value(double time) const
{
