...
public:
  ...
  virtual vnl_vector<double> from_local_to_cs(const vnl_vector<double> & v, const vcsl_spatial_sptr & other,
                                              double time);
...
protected:
  ...
  virtual void path_from_local_to_cs(const vcsl_spatial_sptr & other, double time,
                                     vcl_vector<vcsl_spatial_transformation_sptr> & path,
                                     VCSL_SPATIAL_VECTOR_BOOL & sens);

  // : Find the sequence of transformations from `this' to `other'
  //  Called only by path_from_local_to_cs()
  virtual bool recursive_path_from_local_to_cs(const vcsl_spatial_sptr & other, double time,
                                               vcl_vector<vcsl_spatial_transformation_sptr> & path,
                                               VCSL_SPATIAL_VECTOR_BOOL & sens);
