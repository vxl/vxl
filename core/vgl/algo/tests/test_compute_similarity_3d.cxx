...
test_compute_similarity_3d()
{
  ...
  TEST_NEAR(
    "RMS alignment error",
    alignment_error(transform_points(points1, est_sim.scale(), est_sim.rotation(), est_sim.translation()), points2),
    0.0,
    1e-8);
  ...
  TEST_NEAR(
    "RMS alignment error",
    alignment_error(transform_points(points1, est_sim2.scale(), est_sim2.rotation(), est_sim2.translation()), points2),
    0.0,
    10 * sigma);
}
