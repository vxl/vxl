...
vgl_point_3d<double> p38(71.525802612305,132.054992675781,73.299896240234);
  pts.push_back(p0);  pts.push_back(p1);  pts.push_back(p2);  pts.push_back(p3);  pts.push_back(p4);
  pts.push_back(p5);  pts.push_back(p6);  pts.push_back(p7);  pts.push_back(p8);  pts.push_back(p9);
  pts.push_back(p10);  pts.push_back(p11);  pts.push_back(p12);  pts.push_back(p13);  pts.push_back(p14);
  pts.push_back(p15);  pts.push_back(p16);  pts.push_back(p17);  pts.push_back(p18);  pts.push_back(p19);
  pts.push_back(p20);  pts.push_back(p21);  pts.push_back(p22);  pts.push_back(p23);  pts.push_back(p24);
  pts.push_back(p25);  pts.push_back(p26);  pts.push_back(p27);  pts.push_back(p28);  pts.push_back(p29);
  pts.push_back(p30);  pts.push_back(p31);  pts.push_back(p32);  pts.push_back(p33);  pts.push_back(p34);
  pts.push_back(p35);  pts.push_back(p36);  pts.push_back(p37);  pts.push_back(p38);
