...
test_projective_basis()
{
  ...
  collinear_points.push_back(pcl2);
  collinear_points.push_back(pcl3);
  vgl_h_matrix_2d<double> collinear_basis;
  TEST("collinear degeneracy", collinear_basis.projective_basis(collinear_points), false);
}
...
test_projective_basis_from_lines()
{
  ...
  basis_lines.push_back(l2);
  basis_lines.push_back(l3);
  vgl_h_matrix_2d<double> Basis;
  Basis.projective_basis(basis_lines);
  std::cout << "Transform to Canonical Frame\n"
            << Basis << '\n'
  ...
  concurrent_lines.push_back(lcl2);
  concurrent_lines.push_back(lcl3);
  vgl_h_matrix_2d<double> concurrent_basis;
  TEST("concurrent degeneracy", concurrent_basis.projective_basis(concurrent_lines), false);
}
...
test_norm_trans()
{
  ...
  std::cout << "Sxx = " << std::sqrt(Sxx / 5.0) << " Sxy = " << std::sqrt(Sxy / 5.0)
...
test_compute_linear_lines()
{
  ...
  lines1.push_back(l10);
  lines1.push_back(l11);
  lines1.push_back(l12);
  lines1.push_back(l13);
  lines1.push_back(l14);
  lines1.push_back(l15);
  ...
  lines2.push_back(l20);
  lines2.push_back(l21);
  lines2.push_back(l22);
  lines2.push_back(l23);
  lines2.push_back(l24);
  lines2.push_back(l25);
...
test_compute_rigid_body()
{
  ...
  points1.push_back(ps10);
  points1.push_back(ps11);
  ...
  points0.push_back(p01);
  points0.push_back(p02);
  points0.push_back(p03);
