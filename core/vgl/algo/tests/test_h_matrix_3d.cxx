...
static void test_compute_linear_points()
{
  ...
  vgl_h_matrix_3d<double> H1; H1.set_identity().set_rotation_roll_pitch_yaw(45.0 * vnl_math::pi_over_180,
                                                                            15.0 * vnl_math::pi_over_180,
                                                                            10.0 * vnl_math::pi_over_180);
...
static void test_compute_affine_points()
{
  ...
  vgl_h_matrix_3d<double> H2; H2.set_identity().set_rotation_roll_pitch_yaw(45.0 * vnl_math::pi_over_180,
                                                                            15.0 * vnl_math::pi_over_180,
                                                                            10.0 * vnl_math::pi_over_180);
