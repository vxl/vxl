...
static void test_accessors()
{
  ...
  TEST( "get_rows(vnl_vector 3x)", v1 == vnl_double_4(1, 0, 0, 0) && v2 == vnl_double_4(0, 0.6, 0.8,
                                                                                        0) &&
        v3 == vnl_double_4(0, -0.8, 0.6, 0), true );
  ...
  TEST_NEAR( "operator()(point projection)",
             vgl_distance(P(vgl_homg_point_3d<double>(1.0, 2.0, 0.0, 0.0) ), vgl_homg_point_2d<double>(1.0, 1.2,
                                                                                                       -1.6) ), 0,
             1e-10 );
