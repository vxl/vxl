...
test_point_box()
{
  ...
  // insert  points
  vgl_point_2d<float> p0(0.0f, 0.0f), p1(1.0f, 0.0f), p2(1.0f, 1.0f), p3(0.5f, 0.5f), p4(0.65f, 0.65f);
  tr.add(p0);
  tr.add(p1);
  tr.add(p2);
  tr.add(p3);
...
test_box_box()
{
  ...
  // points
  vgl_point_2d<float> p0(0.0f, 0.0f), p1(1.0f, 0.0f), p2(1.0f, 1.0f), p3(0.45f, 0.45f), p4(0.91f, 0.91f),
