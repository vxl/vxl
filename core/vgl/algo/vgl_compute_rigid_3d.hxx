...
template <class T>
vgl_compute_rigid_3d<T>::vgl_compute_rigid_3d(const std::vector<vgl_point_3d<T>> & points1,
...
template <class T>
void
vgl_compute_rigid_3d<T>::add_points(const vgl_point_3d<T> & p1, const vgl_point_3d<T> & p2)
{
...
template <class T>
void
vgl_compute_rigid_3d<T>::center_points(std::vector<vgl_point_3d<T>> & pts, vgl_vector_3d<T> & t) const
{
  t.set(0, 0, 0);
...
template <class T>
void
vgl_compute_rigid_3d<T>::scale_points(std::vector<vgl_point_3d<T>> & pts, T & s) const
{
  s = 0.0;
  vgl_point_3d<T> origin(0, 0, 0);
  for (unsigned i = 0; i < pts.size(); ++i)
...
template <class T>
bool
vgl_compute_rigid_3d<T>::estimate()
{
