...
template <class T>
void
vgl_fit_lines_2d<T>::add_point(const vgl_point_2d<T> & p)
{
  curve_.push_back(p);
#ifdef DEBUG
  std::cout << p << '\n';
...
template <class T>
void
vgl_fit_lines_2d<T>::add_point(T x, T y)
{
...
template <class T>
void
vgl_fit_lines_2d<T>::output(unsigned int start_index, unsigned int end_index)
{
...
#define VGL_FIT_LINES_2D_INSTANTIATE(T) template class vgl_fit_lines_2d<T>
