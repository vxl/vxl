// This is core/vgl/algo/vgl_fit_sphere_3d.txx
#ifndef vgl_fit_sphere_3d_txx_
#define vgl_fit_sphere_3d_txx_
// :
// \file
...
public:
  sphere_residual_function(vcl_vector<vgl_homg_point_3d<double> >  const& pts ) :
    vnl_least_squares_function(4, static_cast<unsigned>(pts.size() ), vnl_least_squares_function::use_gradient), pts_(
      pts) {}
  //
  // x = [x0, y0, z0, r]^t
