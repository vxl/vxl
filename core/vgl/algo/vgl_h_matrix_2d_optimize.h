...
public:
  ...
  vgl_h_matrix_2d<double> optimize(vcl_vector<vgl_homg_point_2d<double> > const& p1,
  ...
  vgl_h_matrix_2d<double> optimize(vcl_vector<vgl_homg_line_2d<double> > const& l1,
