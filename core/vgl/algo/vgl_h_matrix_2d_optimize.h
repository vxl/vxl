...
public:
  projection_lsqf(const std::vector<vgl_homg_point_2d<double>> & from_points,
                  const std::vector<vgl_homg_point_2d<double>> & to_points)
  ...
  void
  f(const vnl_vector<double> & hv, vnl_vector<double> & proj_err) override
  {
    assert(hv.size() == 9);
...
{
public:
  vgl_h_matrix_2d_optimize(const vgl_h_matrix_2d<double> & initial_h)
    : verbose_(false)
    , trace_(false)
    , ftol_(1e-9)
    , gtol_(1e-9)
  ...
  bool
  optimize(const std::vector<vgl_homg_point_2d<double>> & points1,
  ...
  bool
  optimize(const std::vector<vgl_homg_line_2d<double>> & lines1,
  ...
  optimize(const std::vector<vgl_homg_point_2d<double>> & p1, const std::vector<vgl_homg_point_2d<double>> & p2)
  {
    vgl_h_matrix_2d<double> H;
    optimize_p(p1, p2, H);
    return H;
  ...
  vgl_h_matrix_2d<double>
  optimize(const std::vector<vgl_homg_line_2d<double>> & l1, const std::vector<vgl_homg_line_2d<double>> & l2)
  {
    vgl_h_matrix_2d<double> H;
    optimize_l(l1, l2, H);
    return H;
  ...
  vgl_h_matrix_2d<double>
  optimize(const std::vector<vgl_homg_point_2d<double>> & p1,
