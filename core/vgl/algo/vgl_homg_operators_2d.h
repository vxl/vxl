...
public:
  ...
  static void cross(const vgl_homg_point_2d<Type>& a, const vgl_homg_point_2d<Type>& b, vgl_homg_point_2d<Type>& a_cross_b);
  static void unitize(vgl_homg_point_2d<Type>& a);
  
  static double angle_between_oriented_lines (const vgl_homg_line_2d<Type>& line1, const vgl_homg_line_2d<Type>& line2);
  static double abs_angle (const vgl_homg_line_2d<Type>& line1, const vgl_homg_line_2d<Type>& line2);
  
  static double distance_squared (const vgl_homg_point_2d<Type>& point1, const vgl_homg_point_2d<Type>& point2);
  static double perp_distance_squared (const vgl_homg_line_2d<Type>& line, const vgl_homg_point_2d<Type>& point);
  static double perp_dist_squared (const vgl_homg_point_2d<Type>& point, const vgl_homg_line_2d<Type>& line);
  static bool is_within_distance(const vgl_homg_point_2d<Type>& p1, const vgl_homg_point_2d<Type>& p2, double d) {
    return distance_squared(p1, p2) < d*d;
  }

  static double line_angle (const vgl_homg_line_2d<Type>& line);

  static vgl_homg_line_2d<Type> join (const vgl_homg_point_2d<Type>& point1, const vgl_homg_point_2d<Type>& point2);
  static vgl_homg_line_2d<Type> join_oriented (const vgl_homg_point_2d<Type>& point1, const vgl_homg_point_2d<Type>& point2);
  static vgl_homg_point_2d<Type> intersection (const vgl_homg_line_2d<Type>& line1, const vgl_homg_line_2d<Type>& line2);
  static vgl_homg_line_2d<Type> perp_line_through_point (const vgl_homg_line_2d<Type>& line, const vgl_homg_point_2d<Type>& point);

  static vgl_homg_point_2d<Type> perp_projection (const vgl_homg_line_2d<Type>& line, const vgl_homg_point_2d<Type>& point);
  static vgl_homg_point_2d<Type> midpoint (const vgl_homg_point_2d<Type>& p1, const vgl_homg_point_2d<Type>& p2);
  ...
  static vgl_homg_point_2d<Type> Conjugate(const vgl_homg_point_2d<Type>& a, const vgl_homg_point_2d<Type>& b, const vgl_homg_point_2d<Type>& c,
                          double cr);
