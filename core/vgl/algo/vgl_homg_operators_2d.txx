...
template <class Type>
double
vgl_homg_operators_2d<Type>::perp_dist_squared(
...
template <class Type>
double
vgl_homg_operators_2d<Type>::angle_between_oriented_lines(
                                  const vgl_homg_line_2d<Type>& line1,
                                  const vgl_homg_line_2d<Type>& line2)
{
  double angle1 = line_angle (line1);
  double angle2 = line_angle (line2);
...
template <class Type>
vnl_vector<Type>
vgl_homg_operators_2d<Type>::most_orthogonal_vector(const vcl_vector<vgl_homg_line_2d<Type> >& inpoints)
{
...
template <class Type>
vnl_vector<Type>
vgl_homg_operators_2d<Type>::most_orthogonal_vector_svd(const vcl_vector<vgl_homg_line_2d<Type> >& lines)
{
...
template <class Type>
vgl_homg_point_2d<Type>
vgl_homg_operators_2d<Type>::lines_to_point(const vcl_vector<vgl_homg_line_2d<Type> >& lines)
{
...
template <class Type>
double vgl_homg_operators_2d<Type>::perp_distance_squared(const vgl_homg_line_2d<Type>& line,
                                                          const vgl_homg_point_2d<Type>& point)
{
