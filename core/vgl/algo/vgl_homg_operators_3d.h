...
public:
  ...
  static vgl_homg_plane_3d<Type> points_to_plane(const vgl_homg_point_3d<Type> &, const vgl_homg_point_3d<Type> &,
...
#endif // 0
  static vgl_homg_point_3d<Type> intersection(const vgl_homg_plane_3d<Type> &, const vgl_homg_plane_3d<Type> &,
  ...
  static double cross_ratio(const vgl_homg_point_3d<Type>& p1, const vgl_homg_point_3d<Type>& p2,
                            const vgl_homg_point_3d<Type>& p3, const vgl_homg_point_3d<Type>& p4);

  static double cross_ratio(const vgl_homg_plane_3d<Type>& p1, const vgl_homg_plane_3d<Type>& p2,
                            const vgl_homg_plane_3d<Type>& p3, const vgl_homg_plane_3d<Type>& p4);
  ...
  static vgl_homg_point_3d<Type> conjugate(const vgl_homg_point_3d<Type>& a, const vgl_homg_point_3d<Type>& b,
                                           const vgl_homg_point_3d<Type>& c, double cr = -1.0);
