// This is core/vgl/algo/vgl_homg_operators_3d.hxx
#ifndef vgl_homg_operators_3d_hxx_
#define vgl_homg_operators_3d_hxx_
//:
// \file
...
template <class Type>
double
vgl_homg_operators_3d<Type>::angle_between_oriented_lines(const vgl_homg_line_3d & l1, const vgl_homg_line_3d & l2)
{
  const vgl_homg_point_3d<Type> & dir1 = l1.point_infinite();
  const vgl_homg_point_3d<Type> & dir2 = l2.point_infinite();
...
template <class Type>
Type
vgl_homg_operators_3d<Type>::distance_squared(const vgl_homg_point_3d<Type> & point1,
...
template <class Type>
Type
vgl_homg_operators_3d<Type>::distance(const vgl_homg_point_3d<Type> & point1, const vgl_homg_point_3d<Type> & point2)
{
...
vgl_homg_operators_3d<Type>::intersect_line_and_plane(const vgl_homg_line_3d & line,
...
template <class Type>
double
vgl_homg_operators_3d<Type>::perp_dist_squared(const vgl_homg_line_3d & l, const vgl_homg_point_3d<Type> & p)
{
...
vgl_homg_operators_3d<Type>::perp_line_through_point(const vgl_homg_line_3d & l, const vgl_homg_point_3d<Type> & p)
{
  if (p.ideal())
  {
...
template <class Type>
vgl_homg_point_3d<Type>
vgl_homg_operators_3d<Type>::perp_projection(const vgl_homg_line_3d & l, const vgl_homg_point_3d<Type> & p)
{
  const vgl_homg_point_3d<Type> & q = l.point_finite();
  Type a[3] = { q.x() / q.w(), q.y() / q.w(), q.z() / q.w() };
  Type b[3] = { p.x() / p.w() - a[0], p.y() / p.w() - a[1], p.z() / p.w() - a[2] };

  const vgl_homg_point_3d<Type> & i = l.point_infinite();
...
template <class Type>
Type
vgl_homg_operators_3d<Type>::plane_plane_angle(const vgl_homg_plane_3d<Type> & plane1,
...
template <class Type>
vnl_vector_fixed<Type, 4>
vgl_homg_operators_3d<Type>::get_vector(const vgl_homg_point_3d<Type> & p)
{
...
template <class Type>
vnl_vector_fixed<Type, 4>
vgl_homg_operators_3d<Type>::get_vector(const vgl_homg_plane_3d<Type> & p)
{
...
template <class Type>
void
vgl_homg_operators_3d<Type>::unitize(vgl_homg_point_3d<Type> & a)
{
...
template <class Type>
vgl_homg_point_3d<Type>
vgl_homg_operators_3d<Type>::midpoint(const vgl_homg_point_3d<Type> & p1, const vgl_homg_point_3d<Type> & p2)
{
...
template <class Type>
double
vgl_homg_operators_3d<Type>::cross_ratio(const vgl_homg_point_3d<Type> & a,
...
template <class Type>
double
vgl_homg_operators_3d<Type>::cross_ratio(const vgl_homg_plane_3d<Type> & a,
...
// Default for cr is -1.
{
  ...
  return vgl_homg_point_3d<T>(T(x2 * kx - cr * x1 * mx) * ny * nz,
                              T(y2 * ky - cr * y1 * my) * nx * nz,
                              T(z2 * kz - cr * z1 * mz) * nx * ny,
                              nx * ny * nz);
}

template <class T>
double
vgl_homg_operators_3d<T>::perp_dist_squared(const vgl_homg_point_3d<T> & point, const vgl_homg_plane_3d<T> & plane)
{
...
template <class T>
vgl_homg_point_3d<T>
operator*(const vnl_matrix_fixed<T, 4, 4> & m, const vgl_homg_point_3d<T> & p)
{
...
template <class T>
vgl_homg_plane_3d<T>
operator*(const vnl_matrix_fixed<T, 4, 4> & m, const vgl_homg_plane_3d<T> & p)
{
...
template <class T>
vgl_homg_point_2d<T>
operator*(const vnl_matrix_fixed<T, 3, 4> & m, const vgl_homg_point_3d<T> & p)
{
...
template <class T>
vgl_homg_plane_3d<T>
operator*(const vnl_matrix_fixed<T, 4, 3> & m, const vgl_homg_line_2d<T> & l)
{
...
#define VGL_HOMG_OPERATORS_3D_INSTANTIATE(T)                                                                \
  ...
  template vgl_homg_point_3d<T> operator*(vnl_matrix_fixed<T, 4, 4> const &, vgl_homg_point_3d<T> const &); \
  template vgl_homg_plane_3d<T> operator*(vnl_matrix_fixed<T, 4, 4> const &, vgl_homg_plane_3d<T> const &); \
  template vgl_homg_point_2d<T> operator*(vnl_matrix_fixed<T, 3, 4> const &, vgl_homg_point_3d<T> const &); \
  template vgl_homg_plane_3d<T> operator*(vnl_matrix_fixed<T, 4, 3> const &, vgl_homg_line_2d<T> const &)

#endif // vgl_homg_operators_3d_hxx_
