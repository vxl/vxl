...
vgl_rtree_node<V, B, C>::vgl_rtree_node(node * parent_node, const V & v)
  : parent(parent_node)
  //
  , total_vts(1)
  , local_vts(1)
...
template <class V, class B, class C>
void
vgl_rtree_node<V, B, C>::update_total_vts(int diff)
{
...
template <class V, class B, class C>
void
vgl_rtree_node<V, B, C>::update_total_chs(int diff)
{
  for (node * p = this; p; p = p->parent)
    p->total_chs += diff;
}
...
template <class V, class B, class C>
void
vgl_rtree_node<V, B, C>::update_vertex_count(int diff)
{
  local_vts += diff;
...
template <class V, class B, class C>
void
vgl_rtree_node<V, B, C>::update_child_count(int diff)
{
  local_chs += diff;
...
template <class V, class B, class C>
bool
vgl_rtree_node<V, B, C>::find(const V & v, node ** n, int * i) const
{
  B tmp;
  C::init(tmp, v);
...
template <class V, class B, class C>
bool
vgl_rtree_node<V, B, C>::find(const B & b, const V & v, node ** n_out, int * i_out) const
{
  if (C::meet(b, bounds))
  {
...
template <class V, class B, class C>
void
vgl_rtree_node<V, B, C>::print() const
{
...
// which it was placed.
template <class V, class B, class C>
vgl_rtree_node<V, B, C> *
vgl_rtree_node<V, B, C>::add(const V & v)
{
...
template <class V, class B, class C>
void
vgl_rtree_node<V, B, C>::erase(unsigned int i)
{
  assert(i < local_vts);

  if (total_vts > 1)
  { // there are other vertices.
  ...
  { // it's the only vertex in this node and below.
...
template <class V, class B, class C>
unsigned int
vgl_rtree_node<V, B, C>::find_index_in_parent() const
{
  assert(parent);
...
template <class V, class B, class C>
void
vgl_rtree_node<V, B, C>::compute_bounds()
{
  if (local_vts > 0)
  {
    C::init(bounds, vts[0]);
...
template <class V, class B, class C>
void
vgl_rtree_node<V, B, C>::get(const B & region, std::vector<V> & vs) const
{
#ifdef DEBUG
...
template <class V, class B, class C>
void
vgl_rtree_node<V, B, C>::get(const vgl_rtree_probe<V, B, C> & region, std::vector<V> & vs) const
{
  // get vertices from this node :
  for (unsigned int i = 0; i < local_vts; ++i)
...
template <class V, class B, class C>
void
vgl_rtree_node<V, B, C>::get_all(std::vector<V> & vs) const
{
...
template <class V, class B, class C>
void
vgl_rtree_iterator_base<V, B, C>::operator_pp()
{
  if (!current)
    return;
...
template <class V, class B, class C>
void
vgl_rtree_iterator_base<V, B, C>::operator_mm()
{
...
template <class V, class B, class C>
bool
operator==(const vgl_rtree_iterator_base<V, B, C> & a, const vgl_rtree_iterator_base<V, B, C> & b)
{
