...
"vgl_conic_example.dsp" :  "$(SOURCE)" "$(INTDIR)" "$(OUTDIR)"
	"cmake.exe" ".\CMakeLists.txt" -DSP -H"$(IUEROOT)" -S"$(IUEROOT)/vxl/vgl/examples" -O"$(IUEROOT)/WIN32-VC60/vxl/vgl/examples" -B"$(IUEROOT)/WIN32-VC60"
