...
//   23 Oct.2003 - Peter Vanroose - made the program more readable by adding overloads for almost_equal() for all geom
//   types
// \endverbatim
...
void
golden_test_vgl_io(bool save_file = false);
...
template <class T>
inline bool
almost_equal(const vgl_point_2d<T> & p1, const vgl_point_2d<T> & p2)
{
...
template <class T>
inline bool
almost_equal(const vgl_point_3d<T> & p1, const vgl_point_3d<T> & p2)
{
  return almost_equal(p1.x(), p2.x()) && almost_equal(p1.y(), p2.y()) && almost_equal(p1.z(), p2.z());
}

template <class T>
inline bool
almost_equal(const vgl_homg_point_2d<T> & p1, const vgl_homg_point_2d<T> & p2)
{
  return almost_equal(p1.x() * p2.w(), p2.x() * p1.w()) && almost_equal(p1.y() * p2.w(), p2.y() * p1.w()) &&
         almost_equal(p1.y() * p2.x(), p2.y() * p1.x());
}

template <class T>
inline bool
almost_equal(const vgl_homg_point_3d<T> & p1, const vgl_homg_point_3d<T> & p2)
{
  return almost_equal(p1.x() * p2.w(), p2.x() * p1.w()) && almost_equal(p1.y() * p2.w(), p2.y() * p1.w()) &&
         almost_equal(p1.z() * p2.w(), p2.z() * p1.w()) && almost_equal(p1.x() * p2.z(), p2.x() * p1.z()) &&
         almost_equal(p1.y() * p2.z(), p2.y() * p1.z()) && almost_equal(p1.x() * p2.y(), p2.x() * p1.y());
}

template <class T>
inline bool
almost_equal(const vgl_line_2d<T> & l1, const vgl_line_2d<T> & l2)
{
  return almost_equal(l1.a() * l2.c(), l2.a() * l1.c()) && almost_equal(l1.b() * l2.c(), l2.b() * l1.c()) &&
         almost_equal(l1.b() * l2.a(), l2.b() * l1.a());
}

template <class T>
inline bool
almost_equal(const vgl_homg_line_2d<T> & l1, const vgl_homg_line_2d<T> & l2)
{
  return almost_equal(l1.a() * l2.c(), l2.a() * l1.c()) && almost_equal(l1.b() * l2.c(), l2.b() * l1.c()) &&
         almost_equal(l1.b() * l2.a(), l2.b() * l1.a());
}
...
template <class T>
inline bool
almost_equal(const vgl_homg_plane_3d<T> & p1, const vgl_homg_plane_3d<T> & p2)
{
  return almost_equal(p1.nx() * p2.d(), p2.nx() * p1.d()) && almost_equal(p1.ny() * p2.d(), p2.ny() * p1.d()) &&
         almost_equal(p1.nz() * p2.d(), p2.nz() * p1.d()) && almost_equal(p1.nx() * p2.nz(), p2.nx() * p1.nz()) &&
         almost_equal(p1.ny() * p2.nz(), p2.ny() * p1.nz()) && almost_equal(p1.nx() * p2.ny(), p2.nx() * p1.ny());
}

template <class T>
inline bool
almost_equal(const vgl_homg_line_3d_2_points<T> & l1, const vgl_homg_line_3d_2_points<T> & l2)
{
  return almost_equal(l1.point_finite(), l2.point_finite()) && almost_equal(l1.point_infinite(), l2.point_infinite());
}

template <class T>
inline bool
almost_equal(const vgl_line_segment_2d<T> & l1, const vgl_line_segment_2d<T> & l2)
{
  return almost_equal(l1.point1(), l2.point1()) && almost_equal(l1.point2(), l2.point2());
}

template <class T>
inline bool
almost_equal(const vgl_line_segment_3d<T> & l1, const vgl_line_segment_3d<T> & l2)
{
  return almost_equal(l1.point1(), l2.point1()) && almost_equal(l1.point2(), l2.point2());
}
...
template <class T>
inline bool
almost_equal(const vgl_box_2d<T> & b1, const vgl_box_2d<T> & b2)
{
  return almost_equal(b1.min_x(), b2.min_x()) && almost_equal(b1.min_y(), b2.min_y()) &&
         almost_equal(b1.max_x(), b2.max_x()) && almost_equal(b1.max_y(), b2.max_y());
}

template <class T>
inline bool
almost_equal(const vgl_box_3d<T> & b1, const vgl_box_3d<T> & b2)
{
  return almost_equal(b1.min_x(), b2.min_x()) && almost_equal(b1.min_y(), b2.min_y()) &&
         almost_equal(b1.min_z(), b2.min_z()) && almost_equal(b1.max_x(), b2.max_x()) &&
         almost_equal(b1.max_y(), b2.max_y()) && almost_equal(b1.max_z(), b2.max_z());
}
...
void
golden_test_vgl_io(bool save_file)
{
  //------------------------------------------------------------------------
  // Create objects:
  ...
  vgl_homg_line_2d<double> double_homg_line_2d_out(double_homg_point_2d_out, double_homg_point_2d_out2),
    double_homg_line_2d_in;
  vgl_homg_line_2d<float> float_homg_line_2d_out(float_homg_point_2d_out, float_homg_point_2d_out2),
    float_homg_line_2d_in;

  // vgl_homg_line_3d_2_points

  vgl_homg_line_3d_2_points<double> double_homg_line_3d_2_points_out(double_homg_point_3d_out,
                                                                     double_homg_point_3d_out2),
    double_homg_line_3d_2_points_in;
  vgl_homg_line_3d_2_points<float> float_homg_line_3d_2_points_out(float_homg_point_3d_out, float_homg_point_3d_out2),
    float_homg_line_3d_2_points_in;

  // vgl_line_segment_2d

  vgl_line_segment_2d<double> double_line_segment_2d_out(double_point_2d_out, double_point_2d_out2),
    double_line_segment_2d_in;
  vgl_line_segment_2d<float> float_line_segment_2d_out(float_point_2d_out, float_point_2d_out2),
    float_line_segment_2d_in;

  // vgl_line_segment_3d

  vgl_line_segment_3d<double> double_line_segment_3d_out(double_point_3d_out, double_point_3d_out2),
    double_line_segment_3d_in;
  vgl_line_segment_3d<float> float_line_segment_3d_out(float_point_3d_out, float_point_3d_out2),
  ...
  vgl_homg_plane_3d<float> float_homg_plane_3d_out(float_homg_normal, float_homg_point_3d_out), float_homg_plane_3d_in;
...
#define TEST_equal_2(x) TEST(#x "_out2 == " #x "_in2", almost_equal(x##_out2, x##_in2), true);
  ...
  TEST_equal(polygon);
  TEST(
    "double_point_2d_out == double_point_2d_in_bis", almost_equal(double_point_2d_out, double_point_2d_in_bis), true);
