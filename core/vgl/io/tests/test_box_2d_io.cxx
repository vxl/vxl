...
test_box_2d_double_io()
{
  ...
  TEST("Created vgl_box_2d_test_double_io.bvl.tmp for writing", (!bfs_out), false);
  vsl_b_write(bfs_out, p_out);
  bfs_out.close();

  vsl_b_ifstream bfs_in("vgl_box_2d_test_double_io.bvl.tmp", std::ios::in | std::ios::binary);
  TEST("Opened vgl_box_2d_test_double_io.bvl.tmp for reading", (!bfs_in), false);
