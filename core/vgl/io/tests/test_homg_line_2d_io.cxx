// This is vxl/vgl/io/tests/test_homg_line_2d_io.cxx
...
void test_homg_line_2d_double_io()
{
  ...
  TEST ("Created vgl_homg_line_2d_test_double_io.bvl.tmp for writing",
        (!bfs_out), false);
  vsl_b_write(bfs_out, p_out);
  bfs_out.close();

  vsl_b_ifstream bfs_in("vgl_homg_line_2d_test_double_io.bvl.tmp");
  TEST ("Opened vgl_homg_line_2d_test_double_io.bvl.tmp for reading",
        (!bfs_in), false);
