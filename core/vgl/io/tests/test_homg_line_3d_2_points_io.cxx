...
test_homg_line_3d_2_points_double_io()
{
  ...
  TEST("Made vgl_homg_line_3d_2_points_test_double_io.bvl.tmp for writing", (!bfs_out), false);
  vsl_b_write(bfs_out, p_out);
  bfs_out.close();

  vsl_b_ifstream bfs_in("vgl_homg_line_3d_2_points_test_double_io.bvl.tmp");
  TEST("Opened vgl_homg_line_3d_2_points_test_double_io.bvl.tmp for reading", (!bfs_in), false);
