...
test_homg_plane_3d_double_io()
{
  ...
  TEST("Created vgl_homg_plane_3d_test_double_io.bvl.tmp for writing", (!bfs_out), false);
  vsl_b_write(bfs_out, p_out);
  bfs_out.close();

  vsl_b_ifstream bfs_in("vgl_homg_plane_3d_test_double_io.bvl.tmp");
  TEST("Opened vgl_homg_plane_3d_test_double_io.bvl.tmp for reading", (!bfs_in), false);
...
void
test_homg_plane_3d_io()
{
  test_homg_plane_3d_double_io();
}

TESTMAIN(test_homg_plane_3d_io);
