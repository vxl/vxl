...
test_homg_point_1d_float_io()
{
  ...
  TEST("Created vgl_homg_point_1d_test_float_io.bvl.tmp for writing", (!bfs_out), false);
  vsl_b_write(bfs_out, p_out);
  bfs_out.close();

  vsl_b_ifstream bfs_in("vgl_homg_point_1d_test_float_io.bvl.tmp");
  TEST("Opened vgl_homg_point_1d_test_float_io.bvl.tmp for reading", (!bfs_in), false);
