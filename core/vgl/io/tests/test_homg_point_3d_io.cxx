...
{
  vcl_cout << "***********************" << vcl_endl;
  vcl_cout << "Testing vgl_homg_point_3d<double> io" << vcl_endl;
  vcl_cout << "***********************" << vcl_endl;
  //// test constructors, accessors
  vgl_homg_point_3d<double> p_out(1.2,3.4,5.6,7.8), p_in;
...
void test_homg_point_3d_prime()
{
  test_homg_point_3d_double_io();
}


TESTMAIN(test_homg_point_3d_prime);
