...
test_line_3d_2_points_float_io()
{
  ...
  TEST("Writing to vgl_line_3d_2_points_test_float_io.bvl.tmp", (!bfs_out), false);
  ...
  TEST("Opened vgl_line_3d_2_points_test_float_io.bvl.tmp for reading", (!bfs_in), false);
...
test_line_3d_2_points_double_io()
{
  ...
  TEST("Writing to vgl_line_3d_2_points_test_double_io.bvl.tmp", (!bfs_out), false);
  vsl_b_write(bfs_out, p_out);
  TEST("Finished writing file successfully", (!bfs_out), false);
  bfs_out.close();

  vsl_b_ifstream bfs_in("vgl_line_3d_2_points_test_double_io.bvl.tmp");
  TEST("Opened vgl_line_3d_2_points_test_double_io.bvl.tmp for reading", (!bfs_in), false);
  vsl_b_read(bfs_in, p_in);
  TEST("Finished reading file successfully", (!bfs_in), false);
  bfs_in.close();
