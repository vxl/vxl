// This is core/vgl/io/tests/test_point_3d_io.cxx
#include <iostream>
#ifdef _MSC_VER
...
test_point_3d_double_io()
{
  ...
  TEST("Created vgl_point_3d_test_double_io.bvl.tmp for writing", (!bfs_out), false);
  vsl_b_write(bfs_out, p_out);
  bfs_out.close();

  vsl_b_ifstream bfs_in("vgl_point_3d_test_double_io.bvl.tmp");
  TEST("Opened vgl_point_3d_test_double_io.bvl.tmp for reading", (!bfs_in), false);
