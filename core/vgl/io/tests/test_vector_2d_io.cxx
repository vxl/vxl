...
test_vector_2d_double_io()
{
  ...
  TEST("Created vgl_vector_2d_test_double_io.bvl.tmp for writing", (!bfs_out), false);
  vsl_b_write(bfs_out, v_out);
  bfs_out.close();

  vsl_b_ifstream bfs_in("vgl_vector_2d_test_double_io.bvl.tmp");
  TEST("Opened vgl_vector_2d_test_double_io.bvl.tmp for reading", (!bfs_in), false);
...
test_vector_2d_float_io()
{
  ...
  TEST("Created vgl_vector_2d_test_float_io.bvl.tmp for writing", (!bfs_out), false);
  vsl_b_write(bfs_out, v_out);
  bfs_out.close();

  vsl_b_ifstream bfs_in("vgl_vector_2d_test_float_io.bvl.tmp");
  TEST("Opened vgl_vector_2d_test_float_io.bvl.tmp for reading", (!bfs_in), false);
  vsl_b_read(bfs_in, v_in);
  TEST("Finished reading file successfully", (!bfs_in), false);
  bfs_in.close();
...
test_vector_2d_int_io()
{
  ...
  TEST("Created vgl_vector_2d_test_int_io.bvl.tmp for writing", (!bfs_out), false);
  vsl_b_write(bfs_out, v_out);
  bfs_out.close();

  vsl_b_ifstream bfs_in("vgl_vector_2d_test_int_io.bvl.tmp");
  TEST("Opened vgl_vector_2d_test_int_io.bvl.tmp for reading", (!bfs_in), false);
  vsl_b_read(bfs_in, v_in);
  TEST("Finished reading file successfully", (!bfs_in), false);
  bfs_in.close();
