// This is core/vgl/io/vgl_io_conic.hxx
#ifndef vgl_io_conic_hxx_
#define vgl_io_conic_hxx_
//:
// \file
...
template <class T>
void
vsl_b_write(vsl_b_ostream & os, const vgl_conic<T> & conic)
{
...
template <class T>
void
vsl_b_read(vsl_b_istream & is, vgl_conic<T> & conic)
{
  if (!is)
    return;
...
template <class T>
void
vsl_print_summary(std::ostream & os, const vgl_conic<T> & conic)
{
  os << conic;
}
