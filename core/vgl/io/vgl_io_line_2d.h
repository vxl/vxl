// This is core/vgl/io/vgl_io_line_2d.h
...
template <class T>
void
vsl_b_write(vsl_b_ostream & os, const vgl_line_2d<T> & v);

//: Binary load vgl_line_2d from stream.
template <class T>
void
vsl_b_read(vsl_b_istream & is, vgl_line_2d<T> & v);

//: Print human readable summary of a vgl_line_2d object to a stream
template <class T>
void
vsl_print_summary(std::ostream & os, const vgl_line_2d<T> & v);
