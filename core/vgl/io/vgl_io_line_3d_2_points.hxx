// This is core/vgl/io/vgl_io_line_3d_2_points.hxx
#ifndef vgl_io_line_3d_2_points_hxx_
#define vgl_io_line_3d_2_points_hxx_
//:
// \file
...
template <class T>
void
vsl_b_write(vsl_b_ostream & os, const vgl_line_3d_2_points<T> & p)
{
...
template <class T>
void
vsl_b_read(vsl_b_istream & is, vgl_line_3d_2_points<T> & p)
{
  if (!is)
    return;
...
template <class T>
void
vsl_print_summary(std::ostream & os, const vgl_line_3d_2_points<T> & p)
{
  os << '(';
  vsl_print_summary(os, p.point1());
  os << ',';
  vsl_print_summary(os, p.point2());
  os << ')';
}
...
#endif // vgl_io_line_3d_2_points_hxx_
