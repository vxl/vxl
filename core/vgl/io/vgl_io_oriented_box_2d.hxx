...
template <class T>
void
vsl_b_write(vsl_b_ostream & os, const vgl_oriented_box_2d<T> & p)
{
...
template <class T>
void
vsl_b_read(vsl_b_istream & is, vgl_oriented_box_2d<T> & p)
{
  if (!is)
    return;
...
template <class T>
void
vsl_print_summary(std::ostream & os, const vgl_oriented_box_2d<T> & p)
{
