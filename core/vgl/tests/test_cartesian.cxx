...
test_vector_2d()
{
...

  {
    std::stringstream is;
    is << "4.4 -5 7e1";
    vgl_vector_2d<double> p(0.0, 0.0);
    is >> p;
    std::cout << p << std::endl;
...
test_vector_3d()
{
  ...
  std::stringstream is;
  is << "4.4 -5 7e1 10,11 , 12 (12 , 13,14 )";
  vgl_vector_3d<float> p;
  is >> p;
...
test_line_2d()
{
  ...
  TEST("identical line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p01, p11), vgl_line_segment_2d<double>(p11, p01)),
       true);
  TEST("disjoint horizontal collinear line segments: do not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p01, p11), vgl_line_segment_2d<double>(p21, p31)),
       false);
  TEST("touching horizontal collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p01, p11), vgl_line_segment_2d<double>(p11, p21)),
       true);
  TEST("touching horizontal collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p01, p11), vgl_line_segment_2d<double>(p21, p11)),
       true);
  TEST("overlapping horizontal collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p01, p21), vgl_line_segment_2d<double>(p11, p31)),
       true);
  TEST("internally touching horizontal collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p01, p21), vgl_line_segment_2d<double>(p21, p11)),
       true);
  TEST("internally overlapping horizontal collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p01, p31), vgl_line_segment_2d<double>(p21, p11)),
       true);
  TEST("parallel horizontal line segments: do not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p01, p11), vgl_line_segment_2d<double>(p12, p02)),
       false);
  TEST("disjoint vertical collinear line segments: do not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p10, p11), vgl_line_segment_2d<double>(p12, p13)),
       false);
  TEST("touching vertical collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p10, p11), vgl_line_segment_2d<double>(p11, p12)),
       true);
  TEST("touching vertical collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p10, p11), vgl_line_segment_2d<double>(p12, p11)),
       true);
  TEST("overlapping vertical collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p10, p12), vgl_line_segment_2d<double>(p11, p13)),
       true);
  TEST("internally touching vertical collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p10, p12), vgl_line_segment_2d<double>(p12, p11)),
       true);
  TEST("internally overlapping vertical collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p10, p13), vgl_line_segment_2d<double>(p12, p11)),
       true);
  TEST("parallel vertical line segments: do not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p10, p11), vgl_line_segment_2d<double>(p21, p20)),
       false);
  TEST("disjoint oblique collinear line segments: do not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p30, p21), vgl_line_segment_2d<double>(p12, p03)),
       false);
  TEST("touching oblique collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p20, p11), vgl_line_segment_2d<double>(p11, p02)),
       true);
  TEST("touching oblique collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p20, p11), vgl_line_segment_2d<double>(p02, p11)),
       true);
  TEST("overlapping oblique collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p30, p12), vgl_line_segment_2d<double>(p21, p03)),
       true);
  TEST("internally touching oblique collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p30, p12), vgl_line_segment_2d<double>(p12, p21)),
       true);
  TEST("internally overlapping oblique collinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p30, p03), vgl_line_segment_2d<double>(p12, p21)),
       true);
  TEST("parallel oblique line segments: do not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p20, p11), vgl_line_segment_2d<double>(p21, p30)),
       false);
  TEST("disjoint noncollinear line segments: do not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p10, p21), vgl_line_segment_2d<double>(p00, p01)),
       false);
  TEST("touching noncollinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p10, p21), vgl_line_segment_2d<double>(p10, p01)),
       true);
  TEST("intersecting noncollinear line segments: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p00, p21), vgl_line_segment_2d<double>(p01, p20)),
       true);
  // Degenerate cases: line segments of length 0
  TEST("point on horizontal line segment: intersects",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p01, p21), vgl_line_segment_2d<double>(p11, p11)),
       true);
  TEST("point collinear with horizontal line segment: does not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p01, p21), vgl_line_segment_2d<double>(p31, p31)),
       false);
  TEST("point not collinear with horizontal line segment: does not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p01, p21), vgl_line_segment_2d<double>(p12, p12)),
       false);
  TEST("point on vertical line segment: intersects",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p10, p12), vgl_line_segment_2d<double>(p11, p11)),
       true);
  TEST("point collinear with vertical line segment: does not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p10, p12), vgl_line_segment_2d<double>(p13, p13)),
       false);
  TEST("point not collinear with vertical line segment: does not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p10, p12), vgl_line_segment_2d<double>(p21, p21)),
       false);
  TEST("point on oblique line segment: intersects",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p03, p21), vgl_line_segment_2d<double>(p12, p12)),
       true);
  TEST("point collinear with oblique line segment: does not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p03, p21), vgl_line_segment_2d<double>(p30, p30)),
       false);
  TEST("point not collinear with oblique line segment: does not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p03, p21), vgl_line_segment_2d<double>(p11, p11)),
       false);
  TEST("two identical points: intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p01, p01), vgl_line_segment_2d<double>(p01, p01)),
       true);
  TEST("two different points: does not intersect",
       vgl_lineseg_test_lineseg(vgl_line_segment_2d<double>(p01, p01), vgl_line_segment_2d<double>(p12, p12)),
       false);

  TEST("four almost collinear points: do not intersect",
       vgl_lineseg_test_lineseg<double>(328.99996948242187,
                                        127.99999237060547,
                                        271.98755895963365,
                                        178.20118501723579,
                                        181.43250686733217,
...
test_line_3d()
{
  ...
  std::stringstream is;
  is << "4 5 6  (7, 8, 9)";
  vgl_line_segment_3d<float> l_s;
  is >> l_s;
  std::cout << l_s << std::endl;
  TEST("istream vgl_line_segment_3d",
       l_s,
       vgl_line_segment_3d<float>(vgl_point_3d<float>(4, 5, 6), vgl_point_3d<float>(7, 8, 9)));
}
...
test_plane_3d()
{
  ...
  std::stringstream is;
  is << "4.5 -5 7e1 5e-1   -6x+7y-8z+9=0";
...
test_box_2d()
{
  ...
  b = vgl_box_2d<double>(d0, d2);
  std::cout << b << std::endl;
  TEST("construct from two points", b, b2);
  b = vgl_box_2d<double>(d1, 2, 2, vgl_box_2d<double>::centre);
  std::cout << b << std::endl;
  TEST("construct from centroid", b, b2);
  b = vgl_box_2d<double>(p12, 2, 2, vgl_box_2d<double>::centre);
  std::cout << b << std::endl;
  TEST("construct from centroid", b, b2);
  p12 = b2.min_point();
  b = vgl_box_2d<double>(p12, 2, 2, vgl_box_2d<double>::min_pos);
  std::cout << b << std::endl;
  TEST("construct from min_pos", b, b2);
  p12 = b2.max_point();
  b = vgl_box_2d<double>(p12, 2, 2, vgl_box_2d<double>::max_pos);
  std::cout << b << std::endl;
...
test_box_3d()
{
  ...
  b = vgl_box_3d<double>(d0, d2);
  std::cout << b << std::endl;
  TEST("construct from two points", b, b2);
  b = vgl_box_3d<double>(d1, 2, 2, 2, vgl_box_3d<double>::centre);
  std::cout << b << std::endl;
  TEST("construct from centroid", b, b2);
  b = vgl_box_3d<double>(p123, 2, 2, 2, vgl_box_3d<double>::centre);
  std::cout << b << std::endl;
  TEST("construct from centroid", b, b2);
  p123 = b2.min_point();
  b = vgl_box_3d<double>(p123, 2, 2, 2, vgl_box_3d<double>::min_pos);
  std::cout << b << std::endl;
  TEST("construct from min_pos", b, b2);
  p123 = b2.max_point();
  b = vgl_box_3d<double>(p123, 2, 2, 2, vgl_box_3d<double>::max_pos);
  std::cout << b << std::endl;
  TEST("construct from max_pos", b, b2);
...
inline double
ratio(float f1, float f2, float f3)
{
  return (f3 - f1) / (f2 - f1);
}
...
inline double
cross_ratio(float f1, float f2, float f3, float f4)
{
