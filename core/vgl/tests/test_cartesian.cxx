...
static void test_line_2d()
{
  ...
  TEST("four almost collinear points: do not intersect",
       vgl_lineseg_test_lineseg<double>(328.99996948242187, 127.99999237060547, 271.98755895963365, 178.20118501723579,
                                        181.43250686733217, 257.93771209135798, 102.99999237060547,
                                        326.99996948242187), false);
  ...
  TEST("istream line_segment_2d", l_s,
       vgl_line_segment_2d<float>(vgl_point_2d<float>(4, 6), vgl_point_2d<float>(7, 9) ) );
}
...
static void test_line_3d()
{
  ...
  TEST("istream vgl_line_segment_3d", l_s,
