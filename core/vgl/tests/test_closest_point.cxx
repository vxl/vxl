...
static void testPoly3DClosestPoint()
{
  ...
  TEST_NEAR("Distance test", vgl_distance_to_non_closed_polygon(poly_x, poly_y, poly_z, 4, 1.5, 1.5, 0.25), vcl_sqrt(
              0.5), 1e-8);
...
static void testLine3DClosestPoints()
{
  ...
  // Test general case of non-parallel, non-intersecting lines
    {
    vgl_line_3d_2_points<double> l1(vgl_point_3d<double>(0, 0, 0), vgl_point_3d<double>(1, 0,
                                                                                        0) );
    vgl_line_3d_2_points<double> l2(vgl_point_3d<double>(0, 0, 1), vgl_point_3d<double>(0, 1,
                                                                                        1) );
    bool                                                  u = false;
  ...
  // Test common case of non-parallel, intersecting lines
    ...
    vgl_line_3d_2_points<double> l1(vgl_point_3d<double>(0, 0, 0), vgl_point_3d<double>(1, 0,
                                                                                        0) );
    vgl_line_3d_2_points<double> l2(vgl_point_3d<double>(0, 0, 0), vgl_point_3d<double>(0, 1,
                                                                                        0) );
    bool                                                  u = false;
    vcl_pair<vgl_point_3d<double>, vgl_point_3d<double> > c = vgl_closest_points(l1, l2, &u);
    bool                                                  success = (c.first == vgl_point_3d<double>(0, 0, 0) &&
  ...
  // Test special case of parallel, non-collinear lines
    ...
    vgl_line_3d_2_points<double> l1(vgl_point_3d<double>(0, 0, 0), vgl_point_3d<double>(1, 0,
                                                                                        0) );
    vgl_line_3d_2_points<double> l2(vgl_point_3d<double>(0, 0, 1), vgl_point_3d<double>(1, 0,
                                                                                        1) );
    bool                                                  u = true;
    vcl_pair<vgl_point_3d<double>, vgl_point_3d<double> > c = vgl_closest_points(l1, l2, &u);
    bool                                                  success = (c.first == vgl_point_3d<double>(0, 0, 0) &&
  ...
  // Test special case of collinear lines
    ...
    vgl_line_3d_2_points<double> l1(vgl_point_3d<double>(0, 0, 0), vgl_point_3d<double>(1, 0,
                                                                                        0) );
    vgl_line_3d_2_points<double> l2(vgl_point_3d<double>(0, 0, 0), vgl_point_3d<double>(1, 0,
                                                                                        0) );
    bool                                                  u = true;
    vcl_pair<vgl_point_3d<double>, vgl_point_3d<double> > c = vgl_closest_points(l1, l2, &u);
    bool                                                  success = (c.first == vgl_point_3d<double>(0, 0, 0) &&
...
static void testLineSegment3DClosestPoints()
{
  ...
  // Test general case of non-parallel, non-intersecting lines, with internal points closest
    {
    vgl_line_segment_3d<double> l1(vgl_point_3d<double>(-1, 0, 0), vgl_point_3d<double>(1, 0,
                                                                                        0) );
    vgl_line_segment_3d<double> l2(vgl_point_3d<double>(0, -1, 1), vgl_point_3d<double>(0, 1,
                                                                                        1) );
    bool                                                  u = false;
    vcl_pair<vgl_point_3d<double>, vgl_point_3d<double> > c = vgl_closest_points(l1, l2, &u);
    bool                                                  success = (c.first == vgl_point_3d<double>(0, 0, 0) &&
  ...
  // Test general case of non-parallel, non-intersecting lines, with end points closest
    {
    vgl_line_segment_3d<double> l1(vgl_point_3d<double>(1, 0, 0), vgl_point_3d<double>(2, 0,
                                                                                       0) );
    vgl_line_segment_3d<double> l2(vgl_point_3d<double>(0, 1, 1), vgl_point_3d<double>(0, 2,
                                                                                       1) );
    bool                                                  u = false;
    vcl_pair<vgl_point_3d<double>, vgl_point_3d<double> > c = vgl_closest_points(l1, l2, &u);
  ...
  // Test common case of non-parallel, intersecting lines
    {
    vgl_line_segment_3d<double> l1(vgl_point_3d<double>(0, 0, 0), vgl_point_3d<double>(1, 0,
                                                                                       0) );
    vgl_line_segment_3d<double> l2(vgl_point_3d<double>(0, 0, 0), vgl_point_3d<double>(0, 1,
                                                                                       0) );
    bool                                                  u = false;
    vcl_pair<vgl_point_3d<double>, vgl_point_3d<double> > c = vgl_closest_points(l1, l2, &u);
    bool                                                  success = (c.first == vgl_point_3d<double>(0, 0, 0) &&
  ...
  // Test special case of parallel, non-collinear lines with endpoints closest
    ...
    vgl_line_segment_3d<double> l1(vgl_point_3d<double>(1, 0, 0), vgl_point_3d<double>(2, 0,
                                                                                       0) );
    vgl_line_segment_3d<double> l2(vgl_point_3d<double>(-2, 0, 1), vgl_point_3d<double>(-1, 0,
                                                                                        1) );
    bool                                                  u = false;
    vcl_pair<vgl_point_3d<double>, vgl_point_3d<double> > c = vgl_closest_points(l1, l2, &u);
    bool                                                  success = (c.first == vgl_point_3d<double>(1, 0, 0) &&
  ...
  // Test special case of parallel, non-collinear lines with non-unique internal points closest
    {
    vgl_line_segment_3d<double> l1(vgl_point_3d<double>(0, 0, 0), vgl_point_3d<double>(2, 0,
                                                                                       0) );
    vgl_line_segment_3d<double> l2(vgl_point_3d<double>(-2, 0, 1), vgl_point_3d<double>(1, 0,
                                                                                        1) );
    bool                                                  u = true;
  ...
  // Test special case of collinear lines, non-overlapping
    ...
    vgl_line_segment_3d<double> l1(vgl_point_3d<double>(1, 0, 0), vgl_point_3d<double>(2, 0,
                                                                                       0) );
    vgl_line_segment_3d<double> l2(vgl_point_3d<double>(-2, 0, 0), vgl_point_3d<double>(-1, 0,
                                                                                        0) );
    bool                                                  u = false;
    vcl_pair<vgl_point_3d<double>, vgl_point_3d<double> > c = vgl_closest_points(l1, l2, &u);
    bool                                                  success = (c.first == vgl_point_3d<double>(1, 0, 0) &&
  ...
  // Test special case of collinear lines, touching at endpoints
    ...
    vgl_line_segment_3d<double> l1(vgl_point_3d<double>(0, 0, 0), vgl_point_3d<double>(2, 0,
                                                                                       0) );
    vgl_line_segment_3d<double> l2(vgl_point_3d<double>(-2, 0, 0), vgl_point_3d<double>(0, 0,
                                                                                        0) );
    bool                                                  u = false;
    vcl_pair<vgl_point_3d<double>, vgl_point_3d<double> > c = vgl_closest_points(l1, l2, &u);
    bool                                                  success = (c.first == vgl_point_3d<double>(0, 0, 0) &&
...
static void test_infinite_line_3d_closest_points()
{
  ...
  vgl_infinite_line_3d<double> l1(vgl_point_3d<double>(-1, 0, 0),
                                  vgl_point_3d<double>(1, 0, 0) );
  vgl_infinite_line_3d<double> l2(vgl_point_3d<double>(0, 2, 1),
                                  vgl_point_3d<double>(0, 3, 1) );
  bool                                                  u = false;
  vcl_pair<vgl_point_3d<double>, vgl_point_3d<double> > c = vgl_closest_points(l1, l2, &u);
  bool                                                  success = (c.first == vgl_point_3d<double>(0, 0, 0) &&
                                                                   c.second == vgl_point_3d<double>(0, 0, 1) &&
