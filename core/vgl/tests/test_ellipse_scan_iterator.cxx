...
static void test_circle()
{
  ...
  vgl_ellipse_scan_iterator<double> circle1( 0, 0, 1.001, 1.001, 0 );
  TEST("unit circle", circle1.count(), 5 );

  vgl_ellipse_scan_iterator<double> circle2( 10, 10, 1.001, 1.001, 0 );
  ...
  vgl_ellipse_scan_iterator<double> circle4( 0, 0, 3.001, 3.001, 0 );
  TEST("radius 3 circle", circle4.count(), 29 );

  vgl_ellipse_scan_iterator<double> circle5( -5, 15, 3.001, 3.001, 0 );
...
static void test_ellipse()
{
  ...
  vgl_ellipse_scan_iterator<float> ellipse1( 0, 0, 1.001f, 2.001f, 0 );
  TEST("centred ellipse radius 1,2", ellipse1.count(), 7 );

  vgl_ellipse_scan_iterator<float> ellipse2( 10, -10, 2.001f, 1.001f, 0 );
...
{
  vgl_ellipse_scan_iterator<double> ellipse1( 0, 0, 0.01, 3.001, 0 );
  TEST("vertical sliver: 0.01,3", ellipse1.count(), 7 );

  vgl_ellipse_scan_iterator<double> ellipse2( 0, 0, 2.001, 0.01, 0 );
  TEST("horizontal sliver: 2,0.01", ellipse2.count(), 5 );

  vgl_ellipse_scan_iterator<double> ellipse3( 0, 0, 2.001, 0.01, 0 );
  TEST("horizontal sliver: 2,0.01", ellipse3.count(), 5 );
...
static void test_degenerate()
{
  ...
  vgl_ellipse_scan_iterator<float> ellipse2( 0, 0, 2.001f, 0, 3.14f );
  TEST("horizontal line", ellipse2.count(), 5 );

  vgl_ellipse_scan_iterator<float> ellipse3( 0, 0, 0, 2.001f, 3.14f );
