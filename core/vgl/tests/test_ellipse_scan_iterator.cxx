...
static void test_ellipse()
{
  ...
  vgl_ellipse_scan_iterator ellipse2( 10, -10, 2, 1, 0 );
  TEST("offset ellipse radius 2,1", ellipse2.count(), 7 );

  vgl_ellipse_scan_iterator ellipse3( 0, 0, 2, 1, 0.1 );
  TEST("centred, rotated ellipse radius 2,1", ellipse3.count(), 5 );

  vgl_ellipse_scan_iterator ellipse4( 0, 0, 2, 3, -3.1415/4.0 );
...
static void test_sliver()
{
  ...
  vgl_ellipse_scan_iterator ellipse2( 0, 0, 2, 0.1, 0 );
  TEST("horizontal sliver: 2,0.1", ellipse2.count(), 5 );

  vgl_ellipse_scan_iterator ellipse3( 0, 0, 2, 0.1, 0 );
  TEST("horizontal sliver: 2,0.1", ellipse3.count(), 5 );

  vgl_ellipse_scan_iterator ellipse4( 0, 0, 0.1, 3, 1.4 );
...
static void test_degenerate()
{
  ...
  vgl_ellipse_scan_iterator ellipse2( 0, 0, 2, 0, 0 );
  TEST("horizontal line", ellipse2.count(), 5 );

  vgl_ellipse_scan_iterator ellipse3( 0, 0, 0, 2, 0 );
  TEST("vertical line", ellipse3.count(), 5 );

  vgl_ellipse_scan_iterator ellipse4( 0, 0, 0, 0, 0 );
  TEST("point at integer coordinates", ellipse4.count(), 1 );

  vgl_ellipse_scan_iterator ellipse5( 0.1, 0.1, 0, 0, 0 );
