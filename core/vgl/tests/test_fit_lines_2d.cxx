...
static void test_line_segment_methods()
{
  ...
  double angle = seg.tangent_angle();
  TEST_NEAR("line angle", seg.tangent_angle(),63.43495 , 1e-04);
  vgl_vector_2d<double> dir = seg.direction(), norm = seg.normal();
  vcl_cout << "segment angle = " << angle << "\n";
  vcl_cout << "direction " << dir << "\n";
  vcl_cout << "normal " << norm << "\n";
}
static void test_line_2d_regression()
{
  ...
  vcl_cout << "fitted line " << reg.get_line() << "\n";
