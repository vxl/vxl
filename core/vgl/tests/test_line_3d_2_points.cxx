...
test_direction_vector()
{
  ...
  const vgl_point_3d<double> p2(1, 2, 3);
  const vgl_line_3d_2_points<double> l1(p1, p2);
  const vgl_vector_3d<double> u = p2 - p1;
...
{
  const vgl_point_3d<double> p1(0, 0, 0);
  const vgl_point_3d<double> p2(1, 2, 4);
  const vgl_point_3d<double> p3(0.5, 1.0, 2.0);
  const vgl_line_3d_2_points<double> l1(p1, p2);
