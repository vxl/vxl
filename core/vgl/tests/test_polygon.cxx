...
test_self_intersection()
{
...

  {
    ...
    TEST("non-self-intersecting quad", e1.empty() && e2.empty() && ip.empty(), true);
  }

  {
    ...
    vgl_selfintersections(p, e1, e2, ip);
    TEST("simple self-intersecting quad",
         e1.size() == 1 && e1[0].first == 0 && e1[0].second == 0 && e2[0].first == 0 && e2[0].second == 2 &&
           ip[0] == vgl_point_2d<double>(0.5, 0.5),
         true);
  }
  {
    vgl_polygon<double> p;
    ...
    vgl_selfintersections(p, e1, e2, ip);
    TEST("collinear non-self-intersecting polygon ", e1.empty() && e2.empty() && ip.empty(), true);
  }
  {
    vgl_polygon<double> p;
    ...
    e1s[1] = upair(0, 0);
    e2s[1] = upair(2, 0);
    ips[1] = vgl_point_2d<double>(.75, .75);
    e1s[2] = upair(0, 1);
    e2s[2] = upair(2, 3);
    ips[2] = vgl_point_2d<double>(.5, 1);
    e1s[3] = upair(1, 1);
    e2s[3] = upair(2, 3);
    ips[3] = vgl_point_2d<double>(.5, 2);
    e1s[4] = upair(1, 2);
    e2s[4] = upair(2, 0);
    ips[4] = vgl_point_2d<double>(2, .75);
  ...
  }
  {
    ...
    e1s[1] = upair(0, 1);
    e2s[1] = upair(0, 3);
    ips[1] = vgl_point_2d<double>(0, 1);
    e1s[2] = upair(0, 0);
    e2s[2] = upair(0, 4);
    ips[2] = vgl_point_2d<double>(0, 1);
    e1s[3] = upair(0, 1);
    e2s[3] = upair(0, 4);
    ips[3] = vgl_point_2d<double>(0, 1);
    e1s[4] = upair(0, 0);
    e2s[4] = upair(1, 2);
    ips[4] = vgl_point_2d<double>(0, 1);
    e1s[5] = upair(0, 1);
    e2s[5] = upair(1, 2);
    ips[5] = vgl_point_2d<double>(0, 1);
    e1s[6] = upair(0, 3);
    e2s[6] = upair(1, 2);
    ips[6] = vgl_point_2d<double>(0, 1);
    e1s[7] = upair(0, 4);
    e2s[7] = upair(1, 2);
    ips[7] = vgl_point_2d<double>(0, 1);
    e1s[8] = upair(0, 0);
    e2s[8] = upair(1, 1);
    ips[8] = vgl_point_2d<double>(-1, 0);
    e1s[9] = upair(0, 5);
    e2s[9] = upair(1, 1);
    ips[9] = vgl_point_2d<double>(-1, 0);
    e1s[10] = upair(0, 4);
    e2s[10] = upair(1, 3);
    ips[10] = vgl_point_2d<double>(-1, 3);
    e1s[11] = upair(0, 5);
    e2s[11] = upair(1, 3);
    ips[11] = vgl_point_2d<double>(-1, 3);
