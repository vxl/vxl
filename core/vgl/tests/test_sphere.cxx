...
test_sphere()
{
  ...
  // Default sphere
  const vgl_sphere_3d<double> s;
  // Unit sphere, centered at the origin
  const vgl_sphere_3d<double> u(0, 0, 0, 1.0);
  ...
  // l1 is the X-axis
  const vgl_line_3d_2_points<double> l1(vgl_point_3d<double>(-2, 0, 0), vgl_point_3d<double>(2, 0, 0));
  ...
  const vgl_line_3d_2_points<double> l2(vgl_point_3d<double>(-2, 1, 0), vgl_point_3d<double>(2, 1, 0));
