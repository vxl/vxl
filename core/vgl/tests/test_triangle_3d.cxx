...
inline void test_intersecting4()
{
  ...
  TEST("Intersecting Coplanar, edge label 1 correct", edge_p1 == 2 || edge_p1 == 5 || edge_p1 == 0 || edge_p1 == 3,
       true);
  TEST("Intersecting Coplanar, edge label 2 correct", edge_p2 == 1 || edge_p2 == 4 || edge_p2 == 0 || edge_p2 == 3,
       true);
}
...
inline void test_point_containment()
{
  ...
  // three arbitrary coplanar points (note that coplanarity is assumed by the two methods!)
    ...
    TEST("sort of inside 4 - barycentric method with coplanar tol", vgl_triangle_3d_test_inside(in4, p1, p2, p3,
                                                                                                0.2), true);
