...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/core" /I "$(VXLROOT)/vcl/config.win32" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "vgl_EXPORTS"
...
# End Source File
# Begin Source File
SOURCE=.\Templates/vgl_ray_3d+double-.cxx
# End Source File
# Begin Source File
