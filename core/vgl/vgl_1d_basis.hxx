...
template <class T>
vgl_1d_basis<T>::vgl_1d_basis(const T & o, const T & u, const T & i)
  : origin_(o)
  , unity_(u)
  , inf_pt_(i)
  , affine_(false)
...
template <class T>
vgl_1d_basis<T>::vgl_1d_basis(const T & o, const T & u)
  : origin_(o)
  , unity_(u)
  , affine_(true)
{
...
vgl_1d_basis<T>::project(const T & p)
{
...
template <class T>
std::ostream &
operator<<(std::ostream & s, const vgl_1d_basis<T> & b)
{
