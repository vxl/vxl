...
vgl_affine_coordinates_3d(const std::vector<vgl_point_3d<T>> & pts, std::vector<vgl_point_3d<T>> & affine_pts)
{
  ...
  T det = -dv0v2 * dv0v2 * dv1v1 + 2 * dv0v1 * dv0v2 * dv1v2 - dv0v0 * dv1v2 * dv1v2 - dv0v1 * dv0v1 * dv2v2 +
          dv0v0 * dv1v1 * dv2v2;
  T tol = vgl_tolerance<T>::position;
  assert(fabs(det) > tol);
  for (unsigned i = 0; i < pts.size(); ++i)
  {
    ...
    T alpha = (-dv1v2 * dv1v2 * dvpv0 + dv1v1 * dv2v2 * dvpv0 + dv0v2 * dv1v2 * dvpv1 - dv0v1 * dv2v2 * dvpv1 -
               dv0v2 * dv1v1 * dvpv2 + dv0v1 * dv1v2 * dvpv2) /
              det;
    T beta = (dv0v2 * dv1v2 * dvpv0 - dv0v1 * dv2v2 * dvpv0 - dv0v2 * dv0v2 * dvpv1 + dv0v0 * dv2v2 * dvpv1 +
              dv0v1 * dv0v2 * dvpv2 - dv0v0 * dv1v2 * dvpv2) /
             det;
    T gamma = (-dv0v2 * dv1v1 * dvpv0 + dv0v1 * dv1v2 * dvpv0 + dv0v1 * dv0v2 * dvpv1 - dv0v0 * dv1v2 * dvpv1 -
               dv0v1 * dv0v1 * dvpv2 + dv0v0 * dv1v1 * dvpv2) /
              det;
...
#define VGL_AFFINE_COORDINATES_INSTANTIATE(T)                                         \
  template void vgl_affine_coordinates_2d(std::vector<vgl_point_2d<T>> const & pts,   \
                                          std::vector<vgl_point_2d<T>> & affine_pts); \
  template void vgl_affine_coordinates_3d(std::vector<vgl_point_3d<T>> const & pts,   \
                                          std::vector<vgl_point_3d<T>> & affine_pts); \
  template void vgl_affine_coordinates_3d(std::vector<vgl_point_2d<T>> const & pts1,  \
