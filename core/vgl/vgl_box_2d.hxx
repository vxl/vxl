...
template <class Type>
vgl_box_2d<Type>::vgl_box_2d(const Type corner1[2], const Type corner2[2])
{
...
template <class Type>
vgl_box_2d<Type>::vgl_box_2d(const vgl_point_2d<Type> & corner1, const vgl_point_2d<Type> & corner2)
{
...
template <class Type>
vgl_box_2d<Type>::vgl_box_2d(const Type ref_point[2], Type w, Type h, typename vgl_box_2d<Type>::point_type t)
{
...
template <class Type>
Type
vgl_box_2d<Type>::centroid_x() const
{
  assert(!is_empty());
...
template <class Type>
Type
vgl_box_2d<Type>::centroid_y() const
{
  assert(!is_empty());
...
template <class Type>
vgl_point_2d<Type>
vgl_box_2d<Type>::min_point() const
{
  assert(!is_empty());
...
template <class Type>
vgl_point_2d<Type>
vgl_box_2d<Type>::max_point() const
{
  assert(!is_empty());
...
template <class Type>
vgl_point_2d<Type>
vgl_box_2d<Type>::centroid() const
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_2d<Type>::set_centroid_x(Type cent_x)
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_2d<Type>::set_centroid_y(Type cent_y)
{
  assert(!is_empty());
...
template <class T>
inline void
set_dim_2d(T & minv, T & maxv, T spread);

// All this code is to avoid drift in the centroid.
template <>
inline void
set_dim_2d(int & minv, int & maxv, int spread)
{
  int sum = minv + maxv;
...
template <class Type>
void
vgl_box_2d<Type>::set_width(Type w)
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_2d<Type>::set_height(Type h)
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_2d<Type>::expand_about_centroid(Type expand)
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_2d<Type>::scale_about_centroid(double s)
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_2d<Type>::scale_about_origin(double s)
{
...
template <class Type>
void
vgl_box_2d<Type>::setmin_position(const Type min_position[2])
{
...
template <class Type>
void
vgl_box_2d<Type>::setmax_position(const Type max_position[2])
{
...
template <class Type>
void
vgl_box_2d<Type>::set_min_point(const vgl_point_2d<Type> & min_pt)
{
  min_pos_[0] = min_pt.x();
  if (max_pos_[0] < min_pos_[0])
    max_pos_[0] = min_pos_[0];
...
template <class Type>
void
vgl_box_2d<Type>::set_max_point(const vgl_point_2d<Type> & max_pt)
{
  max_pos_[0] = max_pt.x();
  if (max_pos_[0] < min_pos_[0])
    min_pos_[0] = max_pos_[0];
...
template <class Type>
std::ostream &
vgl_box_2d<Type>::print(std::ostream & s) const
{
  if (is_empty())
    return s << "<vgl_box_2d (empty)>";
  else
    return s << "<vgl_box_2d " << min_pos_[0] << ',' << min_pos_[1] << " to " << max_pos_[0] << ',' << max_pos_[1]
             << '>';
}

template <class Type>
std::ostream &
vgl_box_2d<Type>::write(std::ostream & s) const
{
  return s << min_pos_[0] << ' ' << min_pos_[1] << ' ' << max_pos_[0] << ' ' << max_pos_[1] << '\n';
}

template <class Type>
std::istream &
vgl_box_2d<Type>::read(std::istream & s)
{
  return s >> min_pos_[0] >> min_pos_[1] >> max_pos_[0] >> max_pos_[1];
}
...
template <class Type>
void
vgl_box_2d<Type>::add(const vgl_point_2d<Type> & p)
{
  if (is_empty())
  {
...
template <class Type>
void
vgl_box_2d<Type>::add(const vgl_box_2d<Type> & b)
{
  if (b.is_empty())
    return;
  add(b.min_point());
...
template <class Type>
bool
vgl_box_2d<Type>::contains(const vgl_point_2d<Type> & p) const
{
...
template <class Type>
bool
vgl_box_2d<Type>::contains(const vgl_box_2d<Type> & b) const
{
  return contains(b.min_x(), b.min_y()) && contains(b.max_x(), b.max_y());
}

//: Make the box empty
template <class Type>
void
vgl_box_2d<Type>::empty()
{
  min_pos_[0] = min_pos_[1] = (Type)1;
...
template <class Type>
std::ostream &
operator<<(std::ostream & s, const vgl_box_2d<Type> & p)
{
  return p.print(s);
}
...
template <class Type>
std::istream &
operator>>(std::istream & is, vgl_box_2d<Type> & p)
{
  return p.read(is);
}
