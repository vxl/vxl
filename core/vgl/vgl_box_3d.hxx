...
template <class Type>
vgl_box_3d<Type>::vgl_box_3d(const Type corner1[3], const Type corner2[3])
{
...
template <class Type>
vgl_box_3d<Type>::vgl_box_3d(const vgl_point_3d<Type> & corner1, const vgl_point_3d<Type> & corner2)
{
...
template <class Type>
vgl_box_3d<Type>::vgl_box_3d(Type xmin, Type ymin, Type zmin, Type xmax, Type ymax, Type zmax)
{
...
template <class Type>
vgl_box_3d<Type>::vgl_box_3d(const Type ref_point[3], Type w, Type h, Type d, typename vgl_box_3d<Type>::point_type t)
{
...
template <class Type>
vgl_point_3d<Type>
vgl_box_3d<Type>::centroid() const
{
...
template <class Type>
Type
vgl_box_3d<Type>::centroid_x() const
{
  assert(!is_empty());
...
template <class Type>
Type
vgl_box_3d<Type>::centroid_y() const
{
  assert(!is_empty());
...
template <class Type>
Type
vgl_box_3d<Type>::centroid_z() const
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_3d<Type>::set_centroid_x(Type cx)
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_3d<Type>::set_centroid_y(Type cy)
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_3d<Type>::set_centroid_z(Type cz)
{
  assert(!is_empty());
...
template <class T>
inline void
set_dim_3d(T & minv, T & maxv, T spread);

// All this code is to avoid drift in the centroid.
template <>
inline void
set_dim_3d(int & minv, int & maxv, int spread)
{
  int sum = minv + maxv;
...
template <class Type>
void
vgl_box_3d<Type>::set_width(Type w)
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_3d<Type>::set_height(Type h)
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_3d<Type>::set_depth(Type d)
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_3d<Type>::expand_about_centroid(Type expand)
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_3d<Type>::scale_about_centroid(double s)
{
  assert(!is_empty());
...
template <class Type>
void
vgl_box_3d<Type>::scale_about_origin(double s)
{
...
template <class Type>
void
vgl_box_3d<Type>::set_min_position(const Type min_position[3])
{
...
template <class Type>
void
vgl_box_3d<Type>::set_max_position(const Type max_position[3])
{
...
template <class Type>
void
vgl_box_3d<Type>::set_min_point(const vgl_point_3d<Type> & min_pt)
{
  min_pos_[0] = min_pt.x();
  if (max_pos_[0] < min_pos_[0])
    max_pos_[0] = min_pos_[0];
...
template <class Type>
void
vgl_box_3d<Type>::set_max_point(const vgl_point_3d<Type> & max_pt)
{
  max_pos_[0] = max_pt.x();
  if (max_pos_[0] < min_pos_[0])
    min_pos_[0] = max_pos_[0];
...
template <class Type>
std::ostream &
vgl_box_3d<Type>::print(std::ostream & s) const
{
  if (is_empty())
    return s << "<vgl_box_3d (empty)>";
  else
    return s << "<vgl_box_3d " << min_pos_[0] << ',' << min_pos_[1] << ',' << min_pos_[2] << " to " << max_pos_[0]
             << ',' << max_pos_[1] << ',' << max_pos_[2] << '>';
}

template <class Type>
vgl_point_3d<Type>
vgl_box_3d<Type>::min_point() const
{
  assert(!is_empty());
...
template <class Type>
vgl_point_3d<Type>
vgl_box_3d<Type>::max_point() const
{
  assert(!is_empty());
...
vgl_box_3d<Type>::vertices() const
{
  assert(!is_empty());
...
template <class Type>
std::ostream &
vgl_box_3d<Type>::write(std::ostream & s) const
{
  return s << min_pos_[0] << ' ' << min_pos_[1] << ' ' << min_pos_[2] << ' ' << max_pos_[0] << ' ' << max_pos_[1] << ' '
           << max_pos_[2] << '\n';
}

template <class Type>
std::istream &
vgl_box_3d<Type>::read(std::istream & s)
{
  return s >> min_pos_[0] >> min_pos_[1] >> min_pos_[2] >> max_pos_[0] >> max_pos_[1] >> max_pos_[2];
}
...
template <class Type>
void
vgl_box_3d<Type>::add(const vgl_point_3d<Type> & p)
{
  if (is_empty())
  {
...
template <class Type>
void
vgl_box_3d<Type>::add(const vgl_box_3d<Type> & b)
{
  if (b.is_empty())
    return;
  add(b.min_point());
...
template <class Type>
bool
vgl_box_3d<Type>::contains(const vgl_point_3d<Type> & p) const
{
...
template <class Type>
bool
vgl_box_3d<Type>::contains(const vgl_box_3d<Type> & b) const
{
  return contains(b.min_x(), b.min_y(), b.min_z()) && contains(b.max_x(), b.max_y(), b.max_z());
}

//: Make the box empty
template <class Type>
void
vgl_box_3d<Type>::empty()
{
  min_pos_[0] = min_pos_[1] = min_pos_[2] = (Type)1;
