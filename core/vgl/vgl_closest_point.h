...
//  Also returns the index of the polygon line segment where this point lies.
template <class T>
int vgl_closest_point_to_non_closed_polygon(T& ret_x, T& ret_y, T& ret_z, T const px[], T const py[], T const pz[],
                                            unsigned int n, T x, T y, T z);
...
//  Also returns the index of the polygon line segment where this point lies.
template <class T>
int vgl_closest_point_to_closed_polygon(T& ret_x, T& ret_y, T& ret_z, T const px[], T const py[], T const pz[],
                                        unsigned int n, T x, T y, T z);
...
vcl_pair<vgl_point_3d<T>, vgl_point_3d<T> > vgl_closest_points(const vgl_line_3d_2_points<T>& l1,
                                                               const vgl_line_3d_2_points<T>& l2, bool* unique = 0);
...
vcl_pair<vgl_point_3d<T>, vgl_point_3d<T> > vgl_closest_points(const vgl_line_segment_3d<T>& l1,
                                                               const vgl_line_segment_3d<T>& l2, bool* unique = 0);
