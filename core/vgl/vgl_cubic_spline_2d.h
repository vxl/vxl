...
public:
  ...
  void
  set_knots(const std::vector<vgl_point_2d<Type>> & knots, bool closed)
  {
    knots_ = knots;
    closed_curve_ = closed;
  }
  ...
  //: Equality operator
  bool
  operator==(const vgl_cubic_spline_2d<Type> & spl) const;
...
template <class Type>
void
vgl_cubic_spline_2d<Type>::coefficients(Type vm1, Type v0, Type v1, Type v2, Type & a0, Type & a1, Type & a2, Type & a3)
  const
{
...
template <class Type>
void
vgl_cubic_spline_2d<Type>::knot_indices(Type t, unsigned & im1, unsigned & i0, unsigned & i1, unsigned & i2, Type & u)
  const
{
...
template <class Type>
bool
vgl_cubic_spline_2d<Type>::operator==(const vgl_cubic_spline_2d<Type> & spl) const
{
...
template <class Type>
vgl_point_2d<Type>
vgl_cubic_spline_2d<Type>::operator()(Type t) const
{
...
template <class Type>
vgl_vector_2d<Type>
vgl_cubic_spline_2d<Type>::tangent(Type t) const
{
...
template <class Type>
std::ostream &
operator<<(std::ostream & ostr, const vgl_cubic_spline_2d<Type> & spl)
{
  if (!ostr)
  {
...
template <class Type>
std::istream &
operator>>(std::istream & istr, vgl_cubic_spline_2d<Type> & spl)
{
  if (!istr)
  {
