...
double vgl_distance_origin(vgl_homg_line_2d<T> const& l)
{
  if( l.c() == 0 )
    ...
    {
    return vcl_abs(static_cast<double>(l.c() ) ) / vcl_sqrt(static_cast<double>( l.a() * l.a() + l.b() * l.b() ) );
    }
}
...
double vgl_distance_origin(vgl_homg_plane_3d<T> const& pl)
{
  if( pl.d() == 0 )
    ...
    {
    return vcl_abs(static_cast<double>(pl.d() ) )
           / vcl_sqrt(static_cast<double>( pl.a() * pl.a() + pl.b() * pl.b() + pl.c() * pl.c() ) );
    }
}
...
double vgl_distance(vgl_homg_line_2d<T> const& l, vgl_homg_point_2d<T> const& p)
{
  ...
  if( num == 0 )
    ...
    {
    return vcl_abs(static_cast<double>(num) ) / vcl_sqrt(static_cast<double>(l.a() * l.a() + l.b() * l.b() ) ) / p.w(); // could be inf
    }
}
...
double vgl_distance(vgl_plane_3d<T> const& l, vgl_point_3d<T> const& p)
{
  ...
  if( num == 0 )
    ...
    {
    return vcl_abs(static_cast<double>(num) )
           / vcl_sqrt(static_cast<double>(l.nx() * l.nx() + l.ny() * l.ny() + l.nz() * l.nz() ) );
    }
}
...
double vgl_distance(vgl_homg_plane_3d<T> const& l, vgl_homg_point_3d<T> const& p)
{
  ...
  if( num == 0 )
    ...
    {
    return vcl_abs(static_cast<double>(num / p.w() ) )
           / vcl_sqrt(static_cast<double>(l.nx() * l.nx() + l.ny() * l.ny() + l.nz() * l.nz() ) );
    }
}
