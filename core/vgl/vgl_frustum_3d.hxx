...
//:
template <class Type>
vgl_frustum_3d<Type>::vgl_frustum_3d(const std::vector<vgl_ray_3d<Type>> & corner_rays,
                                     const vgl_vector_3d<Type> & norm,
                                     Type d0,
                                     Type d1)
{
  ...
  for (int i = 0; i < nc; ++i)
  {
    ...
    faces_[pln_index].push_back(j);
    faces_[pln_index].push_back(j_next);
...
template <class Type>
bool
vgl_frustum_3d<Type>::operator==(const vgl_frustum_3d<Type> & other) const
{
  // check addresses
  if (this == &other)
    return true;
...
template <class Type>
vgl_box_3d<Type>
vgl_frustum_3d<Type>::bounding_box() const
{
  vgl_box_3d<Type> box;
  int n = static_cast<int>(verts_.size());
  for (int i = 0; i < n; ++i)
...
template <class Type>
vgl_point_3d<Type>
vgl_frustum_3d<Type>::centroid() const
{
  int n = static_cast<int>(verts_.size());
...
template <class Type>
bool
vgl_frustum_3d<Type>::is_convex() const
{
...
template <class Type>
bool
vgl_frustum_3d<Type>::contains(const Type & x, const Type & y, const Type & z) const
{
...
template <class Type>
bool
vgl_frustum_3d<Type>::contains(const vgl_point_3d<Type> & p) const
{
...
template <class Type>
std::ostream &
operator<<(std::ostream & s, const vgl_frustum_3d<Type> & f)
{
  s << "<vgl_frustum_3d [\n";
