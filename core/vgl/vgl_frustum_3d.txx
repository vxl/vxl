...
// :
template <class Type>
vgl_frustum_3d<Type>::vgl_frustum_3d(vcl_vector<vgl_ray_3d<Type> >  const& corner_rays,
...
template <class Type>
bool vgl_frustum_3d<Type>::contains(Type const& x, Type const& y, Type const& z) const
{
