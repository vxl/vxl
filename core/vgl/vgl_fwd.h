...
template <class Type> class vgl_box_2d;
template <class Type> class vgl_box_3d;
...
template <class Type> class vgl_line_2d;
template <class Type> class vgl_line_segment_2d;
template <class Type> class vgl_line_segment_3d;
template <class Type> class vgl_plane_3d;
template <class Type> class vgl_point_2d;
template <class Type> class vgl_point_3d;
template <class Type> class vgl_plane_3d;
