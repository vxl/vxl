// This is core/vgl/vgl_homg_line_2d.hxx
#ifndef vgl_homg_line_2d_hxx_
#define vgl_homg_line_2d_hxx_
//:
// \file
...
template <class Type>
vgl_homg_line_2d<Type>::vgl_homg_line_2d(const vgl_line_2d<Type> & l)
  : a_(l.a())
  , b_(l.b())
  , c_(l.c())
{}
...
template <class Type>
void
vgl_homg_line_2d<Type>::get_two_points(vgl_homg_point_2d<Type> & p1, vgl_homg_point_2d<Type> & p2) const
{
  if (b() == 0)
    p1.set(-c(), a(), a());
  else
...
template <class Type>
vgl_homg_line_2d<Type>::vgl_homg_line_2d(const vgl_homg_point_2d<Type> & p1, const vgl_homg_point_2d<Type> & p2)
{
  set(p1.y() * p2.w() - p1.w() * p2.y(), p1.w() * p2.x() - p1.x() * p2.w(), p1.x() * p2.y() - p1.y() * p2.x());
...
template <class Type>
std::ostream &
operator<<(std::ostream & os, const vgl_homg_line_2d<Type> & l)
{
  os << "<vgl_homg_line_2d";
  vp(os, l.a(), "x");
  vp(os, l.b(), "y");
...
template <class Type>
std::istream &
operator>>(std::istream & is, vgl_homg_line_2d<Type> & p)
{
  Type a, b, c;
  is >> a >> b >> c;
  p.set(a, b, c);
...
template <class Type>
void
vgl_homg_line_2d<Type>::normalize()
{
