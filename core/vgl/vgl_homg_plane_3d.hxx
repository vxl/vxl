...
template <class Type>
vgl_homg_plane_3d<Type>::vgl_homg_plane_3d(const vgl_plane_3d<Type> & pl)
  : a_(pl.a())
  , b_(pl.b())
  , c_(pl.c())
  , d_(pl.d())
...
template <class Type>
vgl_homg_plane_3d<Type>::vgl_homg_plane_3d(const vgl_homg_point_3d<Type> & p1,
                                           const vgl_homg_point_3d<Type> & p2,
                                           const vgl_homg_point_3d<Type> & p3)
  : a_(p1.w() * (p2.y() * p3.z() - p2.z() * p3.y()) + p2.w() * (p3.y() * p1.z() - p3.z() * p1.y()) +
       p3.w() * (p1.y() * p2.z() - p1.z() * p2.y()))
  , b_(p1.w() * (p2.z() * p3.x() - p2.x() * p3.z()) + p2.w() * (p3.z() * p1.x() - p3.x() * p1.z()) +
       p3.w() * (p1.z() * p2.x() - p1.x() * p2.z()))
  , c_(p1.w() * (p2.x() * p3.y() - p2.y() * p3.x()) + p2.w() * (p3.x() * p1.y() - p3.y() * p1.x()) +
       p3.w() * (p1.x() * p2.y() - p1.y() * p2.x()))
  , d_(p1.x() * (p2.z() * p3.y() - p2.y() * p3.z()) + p2.x() * (p1.y() * p3.z() - p1.z() * p3.y()) +
...
template <class Type>
vgl_homg_plane_3d<Type>::vgl_homg_plane_3d(const vgl_homg_line_3d_2_points<Type> & l1,
                                           const vgl_homg_line_3d_2_points<Type> & l2)
{
...
template <class Type>
vgl_homg_plane_3d<Type>::vgl_homg_plane_3d(const vgl_vector_3d<Type> & n, const vgl_homg_point_3d<Type> & p)
  : a_(n.x() * p.w())
  , b_(n.y() * p.w())
  , c_(n.z() * p.w())
...
template <class Type>
void
vgl_homg_plane_3d<Type>::normalize()
{
...
template <class Type>
bool
vgl_homg_plane_3d<Type>::operator==(const vgl_homg_plane_3d<Type> & p) const
{
  return (this == &p) ||
...
template <class Type>
std::ostream &
operator<<(std::ostream & s, const vgl_homg_plane_3d<Type> & p)
{
  return s << " <vgl_homg_plane_3d " << p.a() << " x + " << p.b() << " y + " << p.c() << " z + " << p.d() << " w = 0 >";
}

template <class Type>
std::istream &
operator>>(std::istream & s, vgl_homg_plane_3d<Type> & p)
{
  Type a, b, c, d;
  s >> a >> b >> c >> d;
  p.set(a, b, c, d);
