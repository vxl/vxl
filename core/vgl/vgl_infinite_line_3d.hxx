...
#endif
template <class Type>
vgl_infinite_line_3d<Type>::vgl_infinite_line_3d(const vgl_point_3d<Type> & p1, const vgl_point_3d<Type> & p2)
  : vgl_infinite_line_3d<Type>(p1, p2 - p1)
{}

template <class Type>
void
vgl_infinite_line_3d<Type>::compute_uv_vectors(vgl_vector_3d<Type> & u, vgl_vector_3d<Type> & v) const
{
...
template <class Type>
vgl_infinite_line_3d<Type>::vgl_infinite_line_3d(const vgl_point_3d<Type> & p, const vgl_vector_3d<Type> & dir)
{
...
template <class Type>
vgl_point_3d<Type>
vgl_infinite_line_3d<Type>::point() const
{
...
template <class Type>
bool
vgl_infinite_line_3d<Type>::contains(const vgl_point_3d<Type> & p) const
{
...
template <class Type>
std::istream &
operator>>(std::istream & s, vgl_infinite_line_3d<Type> & p)
{
