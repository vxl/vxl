                      ...
                      vgl_point_3d<T>& p1)
{
  ...
  if( ymin_good &&
    ...
    else /* npts == 2*/ if( sqr_length(pt_ymin - dp0) > sqr_length(dp1 - dp0) )
      {
      dp1 = pt_ymin;
      }
    }
  ...
  if( ymax_good &&
    ...
    else /* npts == 2*/ if( sqr_length(pt_ymax - dp0) > sqr_length(dp1 - dp0) )
      {
      dp1 = pt_ymax;
      }
    }
  ...
  if( zmin_good &&
    ...
    else /* npts == 2*/ if( sqr_length(pt_zmin - dp0) > sqr_length(dp1 - dp0) )
      {
      dp1 = pt_zmin;
      }
    }
  ...
  if( zmax_good &&
    ...
    else /* npts == 2*/ if( sqr_length(pt_zmax - dp0) > sqr_length(dp1 - dp0) )
      {
      dp1 = pt_zmax;
      }
    }
...
#define VGL_INTERSECTION_BOX_INSTANTIATE(T) \
  ...
  template bool vgl_intersection(vgl_box_3d<T> const &, vgl_infinite_line_3d<T> const &, vgl_point_3d<T> &, \
                                 vgl_point_3d<T> &); \
...
#define VGL_INTERSECTION_INSTANTIATE(T) \
  ...
  template unsigned vgl_intersection(vgl_box_2d<T> const &, vgl_line_segment_2d<T> const &, vgl_point_2d<T> &, \
                                     vgl_point_2d<T> &); \
  template bool vgl_intersection(vgl_line_2d<T> const &, vgl_line_2d<T> const &, vgl_point_2d<T> &); \
  template bool vgl_intersection(vgl_point_2d<T> const &, vgl_point_2d<T> const &, vgl_point_2d<T> const &, \
                                 vgl_point_2d<T> const &, double); \
