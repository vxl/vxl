...
template <class Type>
vgl_line_2d<Type>::vgl_line_2d(const vgl_point_2d<Type> & p1, const vgl_point_2d<Type> & p2)
  : a_(p1.y() - p2.y())
  , b_(p2.x() - p1.x())
...
template <class Type>
vgl_line_2d<Type>::vgl_line_2d(const vgl_point_2d<Type> & p, const vgl_vector_2d<Type> & v)
  : a_(-v.y())
  , b_(v.x())
  , c_(-a_ * p.x() - b_ * p.y())
{}
...
template <class Type>
vgl_line_2d<Type>::vgl_line_2d(const vgl_homg_line_2d<Type> & l)
  : a_(l.a())
  , b_(l.b())
  , c_(l.c())
{
...
template <class Type>
void
vgl_line_2d<Type>::get_two_points(vgl_point_2d<Type> & p1, vgl_point_2d<Type> & p2) const
{
  if (b() == 0)
    p1.set(-c() / a(), 1);
  else
...
template <class Type>
double
vgl_line_2d<Type>::slope_degrees() const
{
...
template <class Type>
double
vgl_line_2d<Type>::slope_radians() const
{
...
template <class Type>
std::ostream &
operator<<(std::ostream & os, const vgl_line_2d<Type> & l)
{
  os << "<vgl_line_2d";
  vp(os, l.a(), "x");
  vp(os, l.b(), "y");
...
template <class Type>
std::istream &
operator>>(std::istream & is, vgl_line_2d<Type> & line)
{
  if (!is.good())
