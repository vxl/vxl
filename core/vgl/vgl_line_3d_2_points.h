...
public:
  ...
  inline vgl_line_3d_2_points(const vgl_line_3d_2_points<Type> & that)
    ...
    , point2_(that.point2_)
  {}

  //: Construct from two points
  inline vgl_line_3d_2_points(const vgl_point_3d<Type> & p1, const vgl_point_3d<Type> & p2)
    : point1_(p1)
    , point2_(p2)
  {
    assert(p1 != p2);
  ...
  //: comparison
  bool
  operator==(const vgl_line_3d_2_points<Type> & l) const;
  bool
  operator!=(const vgl_line_3d_2_points<Type> & l) const
  {
    return !operator==(l);
  ...
  //: Assignment
  inline void
  set(const vgl_point_3d<Type> & p1, const vgl_point_3d<Type> & p2)
  {
    assert(p1 != p2);
    point1_ = p1;
    point2_ = p2;
...
template <class Type>
inline bool
collinear(const l & l1, const vgl_point_3d<Type> & p)
{
...
template <class Type>
inline bool
coplanar(const l & l1, const vgl_point_3d<Type> & p1, const vgl_point_3d<Type> & p2)
{
...
coplanar(const l & l1, const l & l2, const l & l3)
{
  ...
  if (collinear(l1, p))
    p = l2.point2();
  return coplanar(l1, l2) && coplanar(l1, l3) && coplanar(l1, p, l3.point1()) && coplanar(l1, p, l3.point2());
}
...
template <class Type>
std::ostream &
operator<<(std::ostream & s, const l &);

//: Read parameters from stream
// \relatesalso vgl_line_3d_2_points
template <class Type>
std::istream &
operator>>(std::istream & is, l &);
