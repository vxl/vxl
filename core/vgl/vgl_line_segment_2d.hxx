...
template <class Type>
std::istream &
operator>>(std::istream & s, vgl_line_segment_2d<Type> & p)
{
  std::string temp;
  s >> std::skipws >> std::ws;
  char c = s.peek();
...
template <class Type>
Type
vgl_line_segment_2d<Type>::a() const
{
...
template <class Type>
Type
vgl_line_segment_2d<Type>::b() const
{
...
template <class Type>
Type
vgl_line_segment_2d<Type>::c() const
{
...
template <class Type>
vgl_vector_2d<Type>
vgl_line_segment_2d<Type>::direction() const
{
...
template <class Type>
vgl_vector_2d<Type>
vgl_line_segment_2d<Type>::normal() const
{
...
template <class Type>
vgl_point_2d<Type>
vgl_line_segment_2d<Type>::mid_point() const
{
...
template <class Type>
double
vgl_line_segment_2d<Type>::slope_degrees() const
{
...
template <class Type>
double
vgl_line_segment_2d<Type>::slope_radians() const
{
  double dy = point2_.y() - point1_.y();
  double dx = point2_.x() - point1_.x();
