...
template <class T>
vgl_oriented_box_2d<T>::vgl_oriented_box_2d(T width, T height, const vgl_point_2d<T> & center, T angle_in_rad)
{
  if (width < height)
  {
...
template <class T>
vgl_oriented_box_2d<T>::vgl_oriented_box_2d(const vgl_point_2d<T> & p0,
                                            const vgl_point_2d<T> & p1,
...
template <class T>
vgl_oriented_box_2d<T>::vgl_oriented_box_2d(const vgl_point_2d<T> & maj_p1,
                                            const vgl_point_2d<T> & maj_p2,
                                            const vgl_point_2d<T> & min_p1,
                                            const vgl_point_2d<T> & min_p2)
{
...
template <class T>
vgl_box_2d<T>
vgl_oriented_box_2d<T>::enclosing_box() const
{
  vgl_box_2d<T> ret;
  std::vector<vgl_point_2d<T>> corns = this->corners();
  for (typename std::vector<vgl_point_2d<T>>::iterator cit = corns.begin(); cit != corns.end(); ++cit)
    ret.add(*cit);
  return ret;
}
template <class T>
std::pair<T, T>
vgl_oriented_box_2d<T>::width_height() const
{
...
vgl_oriented_box_2d<T>::corners() const
{
...
template <class T>
vgl_point_2d<T>
vgl_oriented_box_2d<T>::centroid() const
{
  const vgl_point_2d<T> & pmaj0 = major_axis_.point1();
  const vgl_point_2d<T> & pmaj1 = major_axis_.point2();
...
template <class T>
std::ostream &
operator<<(std::ostream & os, const vgl_oriented_box_2d<T> & obox)
{
...
template <class T>
std::istream &
operator>>(std::istream & is, vgl_oriented_box_2d<T> & obox)
{
  // is.skipws;
...
template <class T>
vgl_point_2d<T>
vgl_oriented_box_2d<T>::transform_to_obox(const vgl_point_2d<T> & p) const
{
...
template <class T>
bool
vgl_oriented_box_2d<T>::contains(const vgl_point_2d<T> & p) const
{
...
template <class T>
bool
vgl_oriented_box_2d<T>::near_equal(const vgl_oriented_box_2d<T> & ob, T tol) const
{
  if (*this == ob)
    return true;
...
template <class T>
T
vgl_oriented_box_2d<T>::angle_in_rad() const
{
  const vgl_point_2d<T> & tp1 = major_axis_.point1();
  const vgl_point_2d<T> & tp2 = major_axis_.point2();
...
template <class T>
static vgl_point_2d<T>
rotate_point(vgl_point_2d<T> cent, vgl_point_2d<T> p, T ang_rad)
{
...
vgl_oriented_box_2d<T>::rotate(const vgl_point_2d<T> & rot_center, T angle_rad) const
{
  vgl_point_2d<T> rot_maj_p1 = rotate_point(rot_center, major_axis_.point1(), angle_rad);
  vgl_point_2d<T> rot_maj_p2 = rotate_point(rot_center, major_axis_.point2(), angle_rad);
