...
public:
  ...
  //: Copy constructor
  vgl_point_3d(vgl_point_3d<Type> const& p) : x_(p.x()), y_(p.y()), z_(p.z()) {}
  //: Destructor
  ~vgl_point_3d () {}
#endif

  //: Assignment
  inline vgl_point_3d<Type>& operator=(const vgl_point_3d<Type>& that) {
    x_ = that.x(); y_ = that.y(); z_ = that.z(); return *this;
  }
  ...
  inline bool operator!=(const vgl_point_3d<Type> &p) const { return !operator==(p); }
...
// Always false.
template <class Type>
inline bool is_ideal(vgl_point_3d<Type> const&, Type = 0) { return false; }
...
template <class Type>
inline vgl_point_3d<Type>& operator+=(vgl_point_3d<Type>& p,
                                      vgl_vector_3d<Type> const& v) {
...
template <class Type>
inline vgl_point_3d<Type> centre(vgl_point_3d<Type> const& p1,
                                 vgl_point_3d<Type> const& p2) {
...
template <class Type>
inline vgl_point_3d<Type> centre(vcl_vector<vgl_point_3d<Type> > const& v) {
  int n=v.size();
