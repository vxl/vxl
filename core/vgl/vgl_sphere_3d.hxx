...
template <class T>
bool
vgl_sphere_3d<T>::contains(const vgl_point_3d<T> & p) const
{
...
template <class T>
bool
vgl_sphere_3d<T>::clip(const vgl_line_3d_2_points<T> & line, vgl_point_3d<T> & p1, vgl_point_3d<T> & p2) const
{
...
template <class T>
std::ostream &
vgl_sphere_3d<T>::print(std::ostream & os) const
{
  return os << "<vgl_sphere_3d centre=" << c_ << "radius=" << r_ << '>';
}
...
template <class T>
std::istream &
vgl_sphere_3d<T>::read(std::istream & is)
{
  if (!is.good())
...
template <class Type>
void
vgl_sphere_3d<Type>::spherical_to_cartesian(Type elevation_rad, Type azimuth_rad, Type & x, Type & y, Type & z) const
{
...
template <class Type>
void
vgl_sphere_3d<Type>::spherical_to_cartesian(Type elevation_rad, Type azimuth_rad, vgl_point_3d<Type> & pt) const
{
...
template <class Type>
void
vgl_sphere_3d<Type>::cartesian_to_spherical(Type x, Type y, Type z, Type & elevation_rad, Type & azimuth_rad) const
{
  double xd = static_cast<double>(x - c_.x()), yd = static_cast<double>(y - c_.y()),
         zd = static_cast<double>(z - c_.z());
...
template <class Type>
void
vgl_sphere_3d<Type>::cartesian_to_spherical(const vgl_point_3d<Type> & pt,
                                            Type & elevation_rad,
                                            Type & azimuth_rad) const
{
...
template <class T>
std::ostream &
operator<<(std::ostream & os, const vgl_sphere_3d<T> & sph)
{
  return sph.print(os);
}
...
template <class T>
std::istream &
operator>>(std::istream & is, vgl_sphere_3d<T> & sph)
{
  return sph.read(is);
}
