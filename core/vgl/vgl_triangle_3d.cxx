                                        ...
                                        const vgl_point_3d<double>& p3 )
{
  ...
  double int_ang =
    vcl_acos(dot_product(vec1, vec2) ) + vcl_acos(dot_product(vec2, vec3) ) + vcl_acos(dot_product(vec3, vec1) );
  ...
  )
{
  ...
  if( collinear(a_p1, a_p2, a_p3) )
    ...
    if( a_p1 != a_p2 &&
        (ret =
           vgl_triangle_3d_line_intersection(vgl_line_segment_3d<double>(a_p1, a_p2), b_p1, b_p2, b_p3,
                                             i_pnt) ) != None )
    ...
    if( a_p2 != a_p3 &&
        (ret =
           vgl_triangle_3d_line_intersection(vgl_line_segment_3d<double>(a_p2, a_p3), b_p1, b_p2, b_p3,
                                             i_pnt) ) != None )
      {// half-degenerate tri_b behaves as line. Find line intersection
      i_line.set(i_pnt, i_pnt);
      if( ret == Coplanar )
    ...
    if( a_p1 != a_p3 &&
        (ret =
           vgl_triangle_3d_line_intersection(vgl_line_segment_3d<double>(a_p1, a_p3), b_p1, b_p2, b_p3,
                                             i_pnt) ) != None )
      {// half-degenerate tri_b behaves as line. Find line intersection
      i_line.set(i_pnt, i_pnt);
      if( ret == Coplanar )
  ...
  if( collinear(b_p1, b_p2, b_p3) )
    ...
    if( b_p1 != b_p2 &&
        (ret =
           vgl_triangle_3d_line_intersection(vgl_line_segment_3d<double>(b_p1, b_p2), a_p1, a_p2, a_p3,
                                             i_pnt) ) != None )
      {// half-degenerate tri_b behaves as line. Find line intersection
      i_line.set(i_pnt, i_pnt);
      if( ret == Coplanar )
    ...
    if( b_p2 != b_p3 &&
        (ret =
           vgl_triangle_3d_line_intersection(vgl_line_segment_3d<double>(b_p2, b_p3), a_p1, a_p2, a_p3,
                                             i_pnt) ) != None )
      {// half-degenerate tri_b behaves as line. Find line intersection
      i_line.set(i_pnt, i_pnt);
      if( ret == Coplanar )
    ...
    if( b_p1 != b_p3 &&
        (ret =
           vgl_triangle_3d_line_intersection(vgl_line_segment_3d<double>(b_p1, b_p3), a_p1, a_p2, a_p3,
                                             i_pnt) ) != None )
      {// half-degenerate tri_b behaves as line. Find line intersection
      i_line.set(i_pnt, i_pnt);
      if( ret == Coplanar )
