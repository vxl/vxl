...
inline double
vgl_triangle_3d_longest_side(const vgl_point_3d<double> & p1,
                             const vgl_point_3d<double> & p2,
                             const vgl_point_3d<double> & p3)
{
...
//  \return length of the longest side
inline double
vgl_triangle_3d_shortest_side(const vgl_point_3d<double> & p1,
                              const vgl_point_3d<double> & p2,
                              const vgl_point_3d<double> & p3)
{
...
//  \return The closest point on the triangle. This may be inside the triangle, or it may be a point on one of the
//  triangle edges.
vgl_point_3d<double>
...
//  The triangle is represented by its vertices \a p1, \a p2, \a p3.
//  \param q The reference point.
//  \return The distance to the closest point on the triangle. (The closest point may be inside the triangle, or it may
//  be a point on one of the triangle edges.)
double
