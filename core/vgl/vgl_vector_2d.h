...
// \relatesalso vgl_vector_2d
template <class T>
inline v      operator+(v const& a, v const& b) { return v(a.x() + b.x(), a.y() + b.y() ); }
...
// \relatesalso vgl_vector_2d
template <class T>
inline v & operator+=(v& a, v const& b) { a.x_ += b.x_; a.y_ += b.y_; return a; }
...
// \relatesalso vgl_vector_2d
template <class T>
inline v      operator-(v const& b) { return v(-b.x(), -b.y() ); }

// : c=f*b: return a scaled version of the vector.
// \relatesalso vgl_vector_2d
template <class T>
inline v      operator*(double s, v const& b) { return v(T(s * b.x() ), T(s * b.y() ) ); }

// : c=a*f: return a scaled version of the vector.
// \relatesalso vgl_vector_2d
template <class T>
inline v      operator*(v const& a, double s) { return v(T(a.x() * s), T(a.y() * s) ); }
...
// \relatesalso vgl_vector_2d
template <class T>
inline v & operator*=(v& a, double s) { a.set(T(a.x() * s), T(a.y() * s) ); return a; }
...
// \relatesalso vgl_vector_2d
template <class T>
inline T      dot_product(v const& a, v const& b) { return a.x() * b.x() + a.y() * b.y(); }

// : dot product or inner product of two vectors.
// \relatesalso vgl_vector_2d
template <class T>
inline T      inner_product(v const& a, v const& b) { return a.x() * b.x() + a.y() * b.y(); }

// : cross product of two vectors (area of enclosed parallellogram).
// \relatesalso vgl_vector_2d
template <class T>
inline T      cross_product(v const& a, v const& b) { return a.x() * b.y() - a.y() * b.x(); }
