...
template <class T>
double
angle(const vgl_vector_2d<T> & a, const vgl_vector_2d<T> & b)
{
...
template <class T>
double
signed_angle(const vgl_vector_2d<T> & a, const vgl_vector_2d<T> & b)
{
...
template <class T>
bool
orthogonal(const vgl_vector_2d<T> & a, const vgl_vector_2d<T> & b, double eps)
{
...
template <class T>
bool
parallel(const vgl_vector_2d<T> & a, const vgl_vector_2d<T> & b, double eps)
{
...
template <class T>
vgl_vector_2d<T>
rotated(const vgl_vector_2d<T> & a, double angle)
{
...
template <class T>
std::ostream &
operator<<(std::ostream & s, const vgl_vector_2d<T> & p)
{
...
template <class T>
std::istream &
vgl_vector_2d<T>::read(std::istream & is)
{
  if (!is.good())
...
template <class T>
std::istream &
operator>>(std::istream & is, vgl_vector_2d<T> & p)
{
  return p.read(is);
}
