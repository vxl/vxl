...
// \relatesalso vgl_vector_3d
template <class T>
inline double length(v const& a) { return a.length(); }

// : Return the squared length of a vector.
// \relatesalso vgl_vector_3d
template <class T>
inline T sqr_length(v const& a) { return a.sqr_length(); }

// : c=a+b: add two vectors.
// \relatesalso vgl_vector_3d
template <class T>
inline v      operator+(v const& a, v const& b) { return v(a.x() + b.x(), a.y() + b.y(), a.z() + b.z() ); }
...
// \relatesalso vgl_vector_3d
template <class T>
inline v & operator+=(v& a, v const& b) { a.x_ += b.x_; a.y_ += b.y_; a.z_ += b.z_; return a; }
...
// \relatesalso vgl_vector_3d
template <class T>
inline v      operator+(v const& b) { return b; }

// : -a: unary minus operator (additive inverse).
// \relatesalso vgl_vector_3d
template <class T>
inline v      operator-(v const& b) { return v(-b.x(), -b.y(), -b.z() ); }

// : c=f*b: return a scaled version of the vector.
// \relatesalso vgl_vector_3d
template <class T>
inline v      operator*(double s, v const& b) { return v(T(s * b.x() ), T(s * b.y() ), T(s * b.z() ) ); }

// : c=a*f: return a scaled version of the vector.
// \relatesalso vgl_vector_3d
template <class T>
inline v      operator*(v const& a, double s) { return v(T(a.x() * s), T(a.y() * s), T(a.z() * s) ); }
...
// \relatesalso vgl_vector_3d
template <class T>
inline v & operator*=(v& a, double s) { a.set(T(a.x() * s), T(a.y() * s), T(a.z() * s) ); return a; }
...
// \relatesalso vgl_vector_3d
template <class T>
inline T      dot_product(v const& a, v const& b) { return a.x() * b.x() + a.y() * b.y() + a.z() * b.z(); }

// : dot product or inner product of two vectors.
// \relatesalso vgl_vector_3d
template <class T>
inline T      inner_product(v const& a, v const& b) { return a.x() * b.x() + a.y() * b.y() + a.z() * b.z(); }

// : cross product of two vectors (is orthogonal to both)
// \relatesalso vgl_vector_3d
template <class T>
inline v      cross_product(v const& a, v const& b)
{ return v(a.y() * b.z() - a.z() * b.y(), a.z() * b.x() - a.x() * b.z(), a.x() * b.y() - a.y() * b.x() ); }

// : cosine of the angle between two vectors.
// \relatesalso vgl_vector_3d
template <class T>
inline double cos_angle(v const& a, v const& b) { return inner_product(a, b) / (a.length() * b.length() ); }

// : smallest angle between two vectors (in radians, between 0 and Pi).
// \relatesalso vgl_vector_3d
template <class T>
double angle(v const& a, v const& b);                           // return acos(cos_angle(a,b));
...
// \relatesalso vgl_vector_3d
template <class T>
inline double operator/(v const& a, v const& b)
...
// \relatesalso vgl_vector_3d
template <class T>
inline v & normalize(v& a) { double l = a.length(); return l ? a /= l : a; }

// : Return a normalised version of a.
//  If a is zero length, return (0,0).
// \relatesalso vgl_vector_3d
template <class T>
inline v      normalized(v const& a) { double l = a.length(); return l ? a / l : a; }
