...
template <class T>
void
x_write(std::ostream & os, const vgl_vector_3d<T> & v, std::string element_name)
{
...
#define VGL_XIO_VECTOR_3D_INSTANTIATE(T) template void x_write(std::ostream &, const vgl_vector_3d<T> &, std::string)
