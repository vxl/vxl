...
bool
wx_docview_view::OnCreate(wxDocument * doc, long flags)
{
...
void
wx_docview_view::OnDraw(wxDC * dc)
{}

void
wx_docview_view::OnUpdate(wxView * WXUNUSED(sender), wxObject * WXUNUSED(hint))
{
  if (frame_ && canvas_)
  {
    canvas_->Refresh();
...
bool
wx_docview_view::OnClose(bool WXUNUSED(delete_window))
{
