...
void
wx_xrc_frame::on_about(wxCommandEvent & event)
{
  wxString msg;
...
void
wx_xrc_frame::on_quit(wxCommandEvent & event)
{
  Close();
}

void
wx_xrc_frame::move_point(double x, double y)
{
  point_->x = x;
  point_->y = y;
  tab_->post_redraw();
