...
private:
  ...
  void
  establish_overlays(); // hardware overlays.
  ...
  special(int, int, int);
  virtual void
  keyboard_up(unsigned char, int, int);
  virtual void
  special_up(int, int, int);

  //
  static std::vector<vgui_glut_adaptor *> &
  all();
  static vgui_glut_adaptor *
  get_adaptor(int window_id);

  // static callbacks :
  static void
  display_callback();
  static void
  overlay_display_callback();
  static void
  ...
  static void
  passive_motion_callback(int x, int y);
  static void
  entry_callback(int);
  static void
  visibility_callback(int state);
  // static void            idle_callback();
  static void
  timer_callback(int);
  static void
  special_callback(int, int, int);
  static void
  keyboard_up_callback(unsigned char, int, int);
  static void
  special_up_callback(int, int, int);
  static void
  menustatus_callback(int, int, int);
};
