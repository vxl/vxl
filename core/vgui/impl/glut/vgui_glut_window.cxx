...
void
vgui_glut_window::reshape(unsigned w, unsigned h)
{
  int old = glutGetWindow();
  glutSetWindow(static_cast<vgui_glut_adaptor *>(glutwin)->get_id());
...
void
vgui_glut_window::reposition(int x, int y)
{
  int old = glutGetWindow();
  glutSetWindow(static_cast<vgui_glut_adaptor *>(glutwin)->get_id());
...
void
vgui_glut_window::hello_from_adaptor()
{}
