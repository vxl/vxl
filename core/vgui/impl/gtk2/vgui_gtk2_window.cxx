...
{
  if (debug)
    std::cerr << "vgui_gtk2_window::vgui_gtk2_window\n";
...
void
vgui_gtk2_window::set_menubar(const vgui_menu & menu)
{
  if (debug)
    std::cerr << "vgui_gtk2_window::set_menubar\n";
...
void
vgui_gtk2_window::show()
{

  if (debug)
    std::cerr << "vgui_gtk2_window::show\n";
  gtk_widget_show(window);
}

void
vgui_gtk2_window::hide()
{
  if (debug)
    std::cerr << "vgui_gtk2_window::hide\n";
}

void
vgui_gtk2_window::reshape(unsigned w, unsigned h)
{
  if (debug)
    std::cerr << "vgui_gtk2_window::reshape\n";
