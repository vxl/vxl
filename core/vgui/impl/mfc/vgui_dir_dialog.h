...
public:
  void
  CheckDir(const CString & ss); // Display directory contents

protected:
  afx_msg void
  OnOpen(); // Open button clicked
...
{
public:
  vgui_dir_dialog(LPCTSTR initial = NULL, LPCTSTR filter = NULL, CWnd * pParentWnd = NULL);
