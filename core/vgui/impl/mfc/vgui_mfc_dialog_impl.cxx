...
void *
vgui_mfc_dialog_impl::choice_field_widget(const char * /*txt*/, const std::vector<std::string> & labels, int & val)
{
...
void *
vgui_mfc_dialog_impl::inline_tableau_widget(const vgui_tableau_sptr tab, unsigned width, unsigned height)
{
...
void
vgui_mfc_dialog_impl::OnBrowse(UINT uID)
{
...
vgui_mfc_dialog_impl::ask()
{
  ...
  for (std::vector<element>::iterator e_iter2 = elements.begin(); e_iter2 != elements.end(); ++e_iter2)
  {
    ...
    else if (l.type == inline_tabl)
    {
      ...
      widg->CreateEx(
        WS_EX_CLIENTEDGE, TempsNewClass, NULL, WS_CHILD | WS_BORDER | ES_LEFT | ES_AUTOHSCROLL, r, this, IDOK);
