...
BOOL
vgui_mfc_view::PreCreateWindow(CREATESTRUCT & cs)
{
...
BOOL
vgui_mfc_view::OnPreparePrinting(CPrintInfo * pInfo)
{
  // default preparation
...
void
vgui_mfc_view::OnBeginPrinting(CDC * /*pDC*/, CPrintInfo * /*pInfo*/)
{
  // TODO: add extra initialization before printing
}

void
vgui_mfc_view::OnEndPrinting(CDC * /*pDC*/, CPrintInfo * /*pInfo*/)
{
...
#ifdef _DEBUG
void
vgui_mfc_view::AssertValid() const
{
  CView::AssertValid();
}

void
vgui_mfc_view::Dump(CDumpContext & dc) const
{
  CView::Dump(dc);
}

CDocument *
vgui_mfc_view::GetDocument() // non-debug version is inline
{
...
int
vgui_mfc_view::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
