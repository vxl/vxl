...
public:
  ...
  static vgui_key
  translate(Qt::Key k);
  static vgui_modifier
  translate(Qt::KeyboardModifiers m);

  static Qt::Key
  translate(vgui_key k);
  static Qt::KeyboardModifiers
  translate(vgui_modifier m);
...
public:
  ...
  vgui_qt_internal_timer()
    : adaptor(0)
    , id(0)
  {}
  vgui_qt_internal_timer(vgui_qt_adaptor * a, int i)
    : adaptor(a)
    , id(i)
  {}
