...
public:
  ...
  void *
  color_chooser_widget(const char *, std::string &); //, std::string&);
  void *
  inline_color_chooser_widget(const char *, std::string &); //, std::string&);
  void *
...
public:
  ...
  file() const
  {
    return std::string(edit_->text().toLatin1());
  }
