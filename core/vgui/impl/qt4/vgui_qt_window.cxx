...
//-----------------------------------------------------------------------------
void
vgui_qt_window::setup_widget(int w, int h, const char * title)
{
...
//--------------------------------------------------------------------------------
void
vgui_qt_window::set_menubar(const vgui_menu & menu)
{
  use_menubar = true;
  ...
  for (unsigned int i = 0; i < menu.size(); ++i)
  {
    ...
    else if (menu[i].is_command())
    {
      ...
      action->setShortcut(vgui_key_to_qt(menu[i].short_cut.key, menu[i].short_cut.mod));
