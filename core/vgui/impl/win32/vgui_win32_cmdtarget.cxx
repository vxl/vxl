...
BOOL
vgui_win32_cmdtarget::OnCmdMsg(UINT message, WPARAM wParam, LPARAM lParam)
{
#ifdef DEBUG
...
const AFX_MSGMAP *
vgui_win32_cmdtarget::GetMessageMap() const
{
  return &vgui_win32_cmdtarget::messageMap;
}

const AFX_MSGMAP vgui_win32_cmdtarget::messageMap = { NULL, &vgui_win32_cmdtarget::messageEntries_[0] };
