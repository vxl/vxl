...
LRESULT
vgui_win32_window::WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
...
LRESULT
vgui_win32_window::DefWndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
...
void
vgui_win32_window::reshape(unsigned w, unsigned h)
{
  cx_ = w;
  cy_ = h;
...
void
vgui_win32_window::reposition(int x, int y)
{
  wx_ = x;
  wy_ = y;
  MoveWindow(hwnd_, wx_, wy_, cx_, cy_, TRUE);
...
void
vgui_win32_window::set_statusbar(bool on)
{
  if (statusbar_)
...
void
vgui_win32_window::enable_hscrollbar(bool b)
{
...
void
vgui_win32_window::enable_vscrollbar(bool b)
{
...
void
vgui_win32_window::menu_dispatcher(int menuId)
{
...
BOOL
vgui_win32_window::OnCmdMsg(UINT message, WPARAM wParam, LPARAM lParam)
{
  if (adaptor_)
