...
public:
  ...
  vgui_win32_window(HINSTANCE hInst,
                    const char * appname,
                    int width,
                    int height,
                    const vgui_menu & menubar,
                    const char * title);
  vgui_win32_window(HINSTANCE hInst, const char * appname, int width, int height, const char * title);
  ~vgui_win32_window();
  ...
  virtual void
  set_adaptor(vgui_adaptor * adaptor)
  { /*adaptor_ = adaptor;*/
  }
...
private:
  ...
  void
  initWindow(HINSTANCE hInst, const char * appname, int width, int height, const char * title);
