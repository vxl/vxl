...
void fast_null(double const P0[4],
               ...
               double f[4])
{
  f[0] = -P0[1] * P1[2] * P2[3] + P0[1] * P1[3] * P2[2] + P1[1] * P0[2] * P2[3] - P1[1] * P0[3] * P2[2] - P2[1]
    * P0[2] * P1[3] + P2[1] * P0[3] * P1[2];
  f[1] =  P0[0] * P1[2] * P2[3] - P0[0] * P1[3] * P2[2] - P1[0] * P0[2] * P2[3] + P1[0] * P0[3] * P2[2] + P2[0]
    * P0[2] * P1[3] - P2[0] * P0[3] * P1[2];
  f[2] = -P0[0] * P1[1] * P2[3] + P0[0] * P1[3] * P2[1] + P1[0] * P0[1] * P2[3] - P1[0] * P0[3] * P2[1] - P2[0]
    * P0[1] * P1[3] + P2[0] * P0[3] * P1[1];
  f[3] =  P0[0] * P1[1] * P2[2] - P0[0] * P1[2] * P2[1] - P1[0] * P0[1] * P2[2] + P1[0] * P0[2] * P2[1] + P2[0]
    * P0[1] * P1[2] - P2[0] * P0[2] * P1[1];
}
