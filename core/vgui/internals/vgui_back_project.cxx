...
fast_null(const double P0[4], const double P1[4], const double P2[4], double f[4])
{
  ...
  f[1] = P0[0] * P1[2] * P2[3] - P0[0] * P1[3] * P2[2] - P1[0] * P0[2] * P2[3] + P1[0] * P0[3] * P2[2] +
         P2[0] * P0[2] * P1[3] - P2[0] * P0[3] * P1[2];
  f[2] = -P0[0] * P1[1] * P2[3] + P0[0] * P1[3] * P2[1] + P1[0] * P0[1] * P2[3] - P1[0] * P0[3] * P2[1] -
         P2[0] * P0[1] * P1[3] + P2[0] * P0[3] * P1[1];
  f[3] = P0[0] * P1[1] * P2[2] - P0[0] * P1[2] * P2[1] - P1[0] * P0[1] * P2[2] + P1[0] * P0[2] * P2[1] +
         P2[0] * P0[1] * P1[2] - P2[0] * P0[2] * P1[1];
}
                                ...
                                double X[4])
{
  ...
  //             f0           f1           f2
  double f0[4];
  fast_null(P1, P2, pi, f0);
  double f1[4];
  fast_null(P2, P0, pi, f1);
  double f2[4];
  fast_null(P0, P1, pi, f2);
...
vgui_back_project_d3d4_d4(const double x[3], const double pi[4], double X[4])
{
  ...
  vgui_transpose_4x4(P);
  double M[4][4];
  glGetDoublev(GL_MODELVIEW_MATRIX, &M[0][0]);
  vgui_transpose_4x4(M);
  double T[4][4];
