...
void
vgui_dialog_impl::bool_field(const char * txt, bool & val)
{
...
void
vgui_dialog_impl::pushbutton_field(vgui_command_sptr cmnd, const char * txt, const void * icon)
{
...
void
vgui_dialog_impl::int_field(const char * txt, int & val)
{
...
void
vgui_dialog_impl::long_field(const char * txt, long & val)
{
...
void
vgui_dialog_impl::float_field(const char * txt, float & val)
{
...
void
vgui_dialog_impl::double_field(const char * txt, double & val)
{
...
void
vgui_dialog_impl::string_field(const char * txt, std::string & val)
{
...
void
vgui_dialog_impl::choice_field(const char * txt, const std::vector<std::string> & labels, int & val)
{
  vgui_int_field * field = new vgui_int_field(txt, val);
...
void
vgui_dialog_impl::file_browser(const char * txt, std::string & regexp, std::string & val)
{
...
void
vgui_dialog_impl::inline_file_browser(const char * txt, std::string & regexp, std::string & val)
{
  vgui_file_field * field = new vgui_file_field(txt, regexp, val);
...
void
vgui_dialog_impl::color_chooser(const char * txt, std::string & val)
{
  vgui_string_field * field = new vgui_string_field(txt, val);
...
void
vgui_dialog_impl::inline_color_chooser(const char * txt, std::string & val)
{
  vgui_string_field * field = new vgui_string_field(txt, val);
...
void
vgui_dialog_impl::inline_tab(const vgui_tableau_sptr tab, unsigned width, unsigned height)
{
...
void *
vgui_dialog_impl::bool_field_widget(const char *, bool &)
{
  return nullptr;
}
void *
vgui_dialog_impl::int_field_widget(const char *, int &)
{
  return nullptr;
}
void *
vgui_dialog_impl::long_field_widget(const char *, long &)
{
  return nullptr;
}
void *
vgui_dialog_impl::float_field_widget(const char *, float &)
{
  return nullptr;
}
void *
vgui_dialog_impl::double_field_widget(const char *, double &)
{
  return nullptr;
}
void *
vgui_dialog_impl::string_field_widget(const char *, std::string &)
{
  return nullptr;
}
void *
vgui_dialog_impl::choice_field_widget(const char *, const std::vector<std::string> &, int &)
{
  return nullptr;
}
void *
vgui_dialog_impl::text_message_widget(const char *)
{
  return nullptr;
}
void *
vgui_dialog_impl::file_browser_widget(const char *, std::string &, std::string &)
{
  return nullptr;
}
void *
vgui_dialog_impl::inline_file_browser_widget(const char *, std::string &, std::string &)
{
  return nullptr;
}
void *
vgui_dialog_impl::color_chooser_widget(const char * txt, std::string & val)
{
  return string_field_widget(txt, val);
}
void *
vgui_dialog_impl::inline_color_chooser_widget(const char * txt, std::string & val)
{
  return string_field_widget(txt, val);
}
void *
vgui_dialog_impl::inline_tableau_widget(const vgui_tableau_sptr, unsigned /*width*/, unsigned /*height*/)
{
  return nullptr;
}
void *
vgui_dialog_impl::pushbutton_field_widget(const char *, const void *)
{
  return nullptr;
}
