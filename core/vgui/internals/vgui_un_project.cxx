...
bool
vgui_un_project(double const * const * H, double const X[4], double Y[4])
{
...
bool
vgui_un_project(double const H[4][4], double const X[4], double Y[4])
{
...
bool
vgui_un_project(double const H[16], double const X[4], double Y[4])
{
