...
double fps_hermes(float src_scale, float dest_scale, HermesFormat* src_format, XImage* backbuffer)
{
  HermesFormat* dest_format =
    Hermes_FormatNew(backbuffer->bits_per_pixel, backbuffer->red_mask, backbuffer->green_mask, backbuffer->blue_mask, 0,
                     0);
  ...
  do
    ...
    succeed = Hermes_ConverterCopy(converter, global_data,
                                   0, 0, (int)(src_scale * 512), (int)(src_scale * 512), 512 * bytes_per_pixel,
                                   backbuffer->data,
...
#  endif
  ...
  vpl_sleep(1);
    ...
    Hermes_Init();
    HermesFormat* dest_format =
      Hermes_FormatNew(backbuffer->bits_per_pixel, backbuffer->red_mask, backbuffer->green_mask, backbuffer->blue_mask,
                       0, 0);
      {
      vcl_cerr << "\nHermesClear - ";
