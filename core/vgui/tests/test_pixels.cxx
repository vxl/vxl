...
test_pixels()
{
  ...
  // rgba
  {
    vgui_pixel_rgba<8, 8, 8, 8> pix;
    pix.R = 255U;
    pix.G = 0U;
    pix.B = 255U;
    pix.A = 0U;
    print_binary("rgba8888", &pix, sizeof(pix));
  }
  // abgr
  {
    vgui_pixel_abgr<8, 8, 8, 8> pix;
    pix.R = 255U;
    pix.G = 0U;
    pix.B = 255U;
    pix.A = 0U;
    print_binary("abgr8888", &pix, sizeof(pix));
  }
  // bgra
  {
    vgui_pixel_bgra<8, 8, 8, 8> pix;
    pix.R = 255U;
    pix.G = 0U;
    pix.B = 255U;
    pix.A = 0U;
    print_binary("bgra8888", &pix, sizeof(pix));
  }
