...
//
  ...
  vxl_byte* Rmap = RGBrmuc.Rmap();
  vxl_byte* Gmap = RGBrmuc.Gmap();
  vxl_byte* Bmap = RGBrmuc.Bmap();
  float* fRmap = RGBrmuc.fRmap();
  float* fGmap = RGBrmuc.fGmap();
