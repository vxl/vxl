...
public:
  ...
  vgui_blender_tableau(char const* file, vgui_range_map_params_sptr const& rmp = 0, float a = 1.0);

  // : Constructor - don't use this, use vgui_blender_tableau_new.
  //  Creates a blender with the given image and alpha value.
  vgui_blender_tableau(vil1_image const& img, vgui_range_map_params_sptr const& rmp = 0, float a = 1.0);

  // : Constructor - don't use this, use vgui_blender_tableau_new.
  //  Creates a blender with the given image and alpha value.
  vgui_blender_tableau(vil_image_view_base const& img, vgui_range_map_params_sptr const& rmp = 0, float a = 1.0);

  // : Constructor - don't use this, use vgui_blender_tableau_new.
  //  Creates a blender with the given image and alpha value.
  vgui_blender_tableau(vil_image_resource_sptr const& img, vgui_range_map_params_sptr const& rmp = 0, float a = 1.0);
