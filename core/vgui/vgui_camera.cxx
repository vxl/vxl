...
vgui_camera::get_glprojmatrix(int imagesizex, int imagesizey) const
{
  vnl_matrix_fixed<double, 3, 4> C;

  // undo the viewport transformation.
  C(0, 0) = 2.0 / imagesizex;
  C(0, 1) = 0;
  C(0, 2) = 0;
  C(0, 3) = -1;
  C(1, 0) = 0;
  C(1, 1) = -2.0 / imagesizey;
  C(1, 2) = 0;
  C(1, 3) = 1;
  C(2, 0) = 0;
  C(2, 1) = 0;
  ...
  double d1 =
    (ABC(0) - pmatrix(2, 0)) * 1 + (ABC(1) - pmatrix(2, 1)) * 0 + (ABC(2) - pmatrix(2, 2)) * -0.5 + pmatrix(2, 3);
