...
// program.
static void
macro(int a, int b, int c) // cunningly, this is no longer a macro.
{
...
vgui_color_white()
{
  macro(vgui_color_WHITE);
}
void
vgui_color_yellow()
{
  macro(vgui_color_YELLOW);
}
void
vgui_color_purple()
{
  macro(vgui_color_PURPLE);
}
void
vgui_color_red()
{
  macro(vgui_color_RED);
}
void
vgui_color_cyan()
{
  macro(vgui_color_CYAN);
}
void
vgui_color_green()
{
  macro(vgui_color_GREEN);
}
void
vgui_color_blue()
{
  macro(vgui_color_BLUE);
}
void
vgui_color_black()
{
  macro(vgui_color_BLACK);
}
