...
public:
  ...
  vgui_composite_tableau(const vgui_tableau_sptr & child0, const vgui_tableau_sptr & child1);

  //: Constructor - don't use this, use vgui_composite_tableau_new.
  //  Creates a composite with three child tableaux.
  vgui_composite_tableau(const vgui_tableau_sptr & child0,
                         const vgui_tableau_sptr & child1,
                         const vgui_tableau_sptr & child2);

  //: Constructor - don't use this, use vgui_composite_tableau_new.
  //  Takes a vector of child tableaux.
  vgui_composite_tableau(const std::vector<vgui_tableau_sptr> & children);
  ...
  void
  remove(const vgui_tableau_sptr &);
...
protected:
  ...
  bool
  add_child(const vgui_tableau_sptr & t);
...
struct vgui_composite_tableau_new : public vgui_composite_tableau_sptr
{
  ...
  vgui_composite_tableau_new()
    : base(new vgui_composite_tableau())
  {}

  //: Constructor - creates a pointer to a composite with two children.
  vgui_composite_tableau_new(const vgui_tableau_sptr & child0, const vgui_tableau_sptr & child1)
    : base(new vgui_composite_tableau(child0, child1))
  {}

  //: Constructor - creates a pointer to a composite with three children.
  vgui_composite_tableau_new(const vgui_tableau_sptr & child0,
                             const vgui_tableau_sptr & child1,
                             const vgui_tableau_sptr & child2)
  ...
  //  Takes a vector of child tableaux.
  vgui_composite_tableau_new(const std::vector<vgui_tableau_sptr> & children)
