...
public:
  ...
  vgui_soview2D_polygon * add_polygon(unsigned n, float const * x, float const * y, bool filled = false);
  ...
  vgui_soview2D_image * add_image(float x, float y, float w, float h, char * data, unsigned int format,
                                  unsigned int type);
