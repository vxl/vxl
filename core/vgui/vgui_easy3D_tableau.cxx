...
vgui_easy3D_tableau::vgui_easy3D_tableau() : style_(vgui_style::new_style() )
{
  style_->rgba[0] = 0.0f;
  style_->rgba[1] = 1.0f;
  style_->rgba[2] = 0.0f;
...
vgui_lineseg3D *
vgui_easy3D_tableau::add_line( float x0, float y0, float z0,
...
vgui_triangle3D *
vgui_easy3D_tableau::add_triangle( float x0, float y0, float z0,
                                   float x1, float y1, float z1,
