...
void vgui_easy3D_tableau::add(vgui_soview3D* object) {
...
vgui_point3D* vgui_easy3D_tableau::add_point(float x, float y, float z)
{
...
void vgui_easy3D_tableau::set_foreground(float r, float g, float b)
{
  fg[0] = r;
  fg[1] = g;
  fg[2] = b;
...
void vgui_easy3D_tableau::set_line_width(float w)
{
  line_width = w;
}

void vgui_easy3D_tableau::set_point_radius(float r)
{
  point_size = r;
}
