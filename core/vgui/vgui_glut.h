...
inline int
vgui_glutCreateWindow(const char * title)
{
...
inline void
vgui_glutSetWindowTitle(const char * title)
{
...
inline void
vgui_glutSetIconTitle(const char * title)
{
...
inline void
vgui_glutAddMenuEntry(const char * label, int value)
{
...
inline void
vgui_glutAddSubMenu(const char * label, int sub)
{
...
inline void
vgui_glutChangeToMenuEntry(int item, const char * label, int value)
{
...
inline void
vgui_glutChangeToSubMenu(int item, const char * label, int sub)
{
...
inline int
vgui_glutExtensionSupported(const char * name)
{
