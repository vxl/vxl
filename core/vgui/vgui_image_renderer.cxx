...
void vgui_image_renderer::create_buffer(vgui_range_map_params_sptr const& rmp)
{
  delete buffer;
...
void vgui_image_renderer::draw_pixels()
{
  buffer->draw_as_image() || buffer->draw_as_rectangle();
}

bool vgui_image_renderer::render_directly(vgui_range_map_params_sptr const& rmp)
{
...
bool vgui_image_renderer::old_range_map_params(vgui_range_map_params_sptr const& rmp)
{
  // Cases
