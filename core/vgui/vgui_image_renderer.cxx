...
//-----------------------------------------------------------------------------
void
vgui_image_renderer::need_resection() const
{
...
void
vgui_image_renderer::reread_image()
{
  delete buffer;
  buffer = nullptr;
  valid_buffer = false;
...
vgui_image_renderer::create_buffer(const vgui_range_map_params_sptr & rmp)
{
  ...
  buffer = new vgui_section_buffer(0, 0, the_image.width(), the_image.height(), GL_NONE, GL_NONE);
...
void
vgui_image_renderer::draw_pixels()
{
