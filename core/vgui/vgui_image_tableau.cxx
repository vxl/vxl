...
vgui_image_tableau::vgui_image_tableau( vil_image_view_base const& I,
                                        vgui_range_map_params_sptr const& mp )
  : vgui_tableau(),
  pixels_centered_( true ),
  renderer_( 0 ),
...
vgui_image_tableau::vgui_image_tableau( vil_image_resource_sptr const& I,
                                        vgui_range_map_params_sptr const& mp )
  : vgui_tableau(),
  pixels_centered_( true ),
  renderer_( 0 ),
...
vcl_string
vgui_image_tableau::type_name() const
{
...
vcl_string
vgui_image_tableau::file_name() const
{
  return name_;
}
...
vcl_string
vgui_image_tableau::pretty_name() const
{
...
vil1_image
vgui_image_tableau::get_image() const
{
  if( renderer_ )
    {
...
vgui_image_tableau::get_image_view() const
{
  if( vil_renderer_ )
    {
...
vgui_image_tableau::get_image_resource() const
{
  if( vil_renderer_ )
    {
...
void
vgui_image_tableau::set_image(char const * f,
                              vgui_range_map_params_sptr const& mp)
{
  name_ = f;
...
void
vgui_image_tableau::reread_image()
{
...
unsigned
vgui_image_tableau::width() const
{
  if( renderer_ )
    {
...
unsigned
vgui_image_tableau::height() const
{
  if( renderer_ )
    {
...
bool
vgui_image_tableau::get_bounding_box(float low[3], float high[3]) const
{
