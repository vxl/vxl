...
enum vgui_key
{
  ...
  vgui_CURSOR_UP,
  vgui_CURSOR_RIGHT,
  vgui_CURSOR_DOWN, // cursor movement
  vgui_PAGE_UP,
  /* */ vgui_PGUP = vgui_PAGE_UP,
  vgui_PAGE_DOWN,
  /* */ vgui_PGDN = vgui_PAGE_DOWN,
  vgui_HOME,
  vgui_END,
  vgui_DELETE,
  vgui_INSERT // other things
};
...
vgui_key
vgui_key_CTRL(int character);

std::ostream &
operator<<(std::ostream & s, vgui_key k);
