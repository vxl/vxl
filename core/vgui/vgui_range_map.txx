...
template <class Type>
vxl_byte vgui_range_map<Type>::map_pixel_byte(const Type pix, const Type min, const Type max,
...
template <class Type>
float vgui_range_map<Type>::map_pixel_float(const Type pix, const Type min, const Type max,
                                            const float gamma, const long double ratio)
{
  int num_bits = (sizeof(Type) * 8);
...
template <class Type>
vbl_array_1d<vxl_byte>  vgui_range_map<Type>::compute_byte_table(const Type min, const Type max, const float gamma,
...
template <class Type>
vbl_array_1d<float> vgui_range_map<Type>::compute_float_table(const Type min, const Type max, const float gamma,
                                                              const long double ratio)
{
