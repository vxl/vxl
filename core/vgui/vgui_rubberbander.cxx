...
void vgui_rubberbander::init(vgui_rubberbander_client* the_client)
{
  client_ = the_client;
  active = false;
  obj_type = none_enum;
...
vgui_rubberbander::vgui_rubberbander(vgui_rubberbander_client *client)
{
  init(client);
}
