...
vcl_string vgui_selector_tableau::file_name() const
{
...
vcl_string vgui_selector_tableau::pretty_name() const
{
...
// ----------------------------------------------------------------------------
void vgui_selector_tableau::add(vgui_tableau_sptr const& tab, vcl_string name)
{
...
{
public:
  vgui_selector_switch_command(vgui_selector_tableau* s, const vcl_string& n) : selector(s), name(n) {}
...
{
public:
  vgui_selector_toggle_command(vgui_selector_tableau* s, const vcl_string& n) : selector(s), name(n) {}
                                      ...
                                      vgui_menu & menu)
{
  ...
  position_menu.add("Move to Bottom", new vgui_selector_position_command(this,
                                                                         vgui_selector_position_command::TO_BOTTOM) );
