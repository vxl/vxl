...
public:
  ...
  //:
  vgui_shell_tableau_bindings &
  set_quit(vgui_event_condition cond)
  {
    quit = cond;
    return *this;
  }
  ...
  //:
  vgui_shell_tableau_bindings &
  set_close(vgui_event_condition cond)
  {
    close = cond;
    return *this;
  }
  ...
  vgui_shell_tableau_bindings &
  set_graph(vgui_event_condition cond)
  {
    graph = cond;
    return *this;
  }
  ...
  //:
  static void
  set_default_quit(vgui_event_condition cond)
  {
    default_quit = cond;
  }
  ...
  //:
  static void
  set_default_close(vgui_event_condition cond)
  {
    default_close = cond;
  }
  ...
  //:
  static void
  set_default_graph(vgui_event_condition cond)
  {
    default_graph = cond;
  }
...
public:
  ...
  vgui_shell_tableau(const vgui_tableau_sptr &);
  vgui_shell_tableau(const vgui_tableau_sptr &, const vgui_tableau_sptr &);
  vgui_shell_tableau(const vgui_tableau_sptr &, const vgui_tableau_sptr &, const vgui_tableau_sptr &);
  vgui_shell_tableau(const vgui_tableau_sptr &,
                     const vgui_tableau_sptr &,
                     const vgui_tableau_sptr &,
                     const vgui_tableau_sptr &);
  ...
  vgui_clear_tableau_sptr
  get_clear() const
  {
    return clear;
  }
  vgui_tview_launcher_tableau_sptr
  get_graph() const
  {
    return graph;
  }
...
struct vgui_shell_tableau_new : public vgui_shell_tableau_sptr
{
  ...
  {}
  vgui_shell_tableau_new(const vgui_tableau_sptr & a)
    : base(new vgui_shell_tableau(a))
  {}
  vgui_shell_tableau_new(const vgui_tableau_sptr & a, const vgui_tableau_sptr & b)
    : base(new vgui_shell_tableau(a, b))
  {}
  vgui_shell_tableau_new(const vgui_tableau_sptr & a, const vgui_tableau_sptr & b, const vgui_tableau_sptr & c)
    : base(new vgui_shell_tableau(a, b, c))
  {}
  vgui_shell_tableau_new(const vgui_tableau_sptr & a,
                         const vgui_tableau_sptr & b,
                         const vgui_tableau_sptr & c,
                         const vgui_tableau_sptr & d)
