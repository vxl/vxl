...
public:
  ...
  // rendering. See draw().
  //
  vgui_soview2D_image( float x, float y, vil1_image const& img, bool blend = false, GLenum format = GL_NONE,
                       GLenum type = GL_NONE );
  ...
  // rendering. See draw().
  //
  vgui_soview2D_image( float x, float y, vil_image_view_base const& img, bool blend = false, GLenum format = GL_NONE,
                       GLenum type = GL_NONE );
