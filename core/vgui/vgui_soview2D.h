...
public:
  ...
  virtual float
  distance_squared(float x, float y) const = 0;

  //: Returns the centroid of this soview2D.
  virtual void
  get_centroid(float * x, float * y) const = 0;
...
public:
  ...
  vgui_soview2D_point(float x_, float y_)
    : x(x_)
    , y(y_)
  {}
...
public:
  ...
  vgui_soview2D_group(std::vector<vgui_soview2D *> ls_)
    : ls(ls_)
  {}
  ...
  virtual void
  set_style(const vgui_style_sptr &);
...
public:
  ...
  type_name() const
  {
    return "vgui_soview2D_infinite_line";
  }
...
public:
  ...
  vgui_soview2D_linestrip(unsigned, const float *, const float *);
  ...
  type_name() const
  {
    return "vgui_soview2D_linestrip";
  }
...
public:
  ...
  vgui_soview2D_polygon(unsigned, const float *, const float *, bool fill);
