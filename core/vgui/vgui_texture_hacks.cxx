...
macro(void, glDeleteTextures, (GLsizei a, const GLuint * b), (a, b));
macro(void, glGenTextures, (GLsizei a, GLuint * b), (a, b));
macro(GLboolean, glIsTexture, (GLuint a), (a));
macro(void, glPrioritizeTextures, (GLsizei a, const GLuint * b, const GLclampf * c), (a, b, c));
