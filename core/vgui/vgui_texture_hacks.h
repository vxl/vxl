...
GLboolean
urgh_glAreTexturesResident(GLsizei, const GLuint *, GLboolean *);
void urgh_glBindTexture(GLenum, GLuint);
void
urgh_glDeleteTextures(GLsizei, const GLuint *);
void
urgh_glGenTextures(GLsizei, GLuint *);
GLboolean urgh_glIsTexture(GLuint);
void
urgh_glPrioritizeTextures(GLsizei, const GLuint *, const GLclampf *);
