...
std::vector<vgui_toolkit *> *
vgui_toolkit::registry()
{
...
vgui_toolkit::~vgui_toolkit()
{
  ...
  // deregister
  std::vector<vgui_toolkit *>::iterator i = std::find(registry()->begin(), registry()->end(), this);
