...
void vgui_vil_image_renderer::draw_pixels()
{
  buffer_->draw_as_image() || buffer_->draw_as_rectangle();
}

bool vgui_vil_image_renderer::render_directly(vgui_range_map_params_sptr const& rmp)
{
  if( !rmp )
    {
    return false;
...
void vgui_vil_image_renderer::render(vgui_range_map_params_sptr const& rmp)
{
  if( !the_image_ )
    {
    return;
...
bool vgui_vil_image_renderer::old_range_map_params(vgui_range_map_params_sptr const& rmp)
{
  // Cases
