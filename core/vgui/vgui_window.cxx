...
void
vgui_window::reshape(unsigned, unsigned)
{
  vgui_macro_warning << "vgui_window::reshape() dummy implementation\n";
}

void
vgui_window::reposition(int, int)
{
...
int
vgui_window::set_hscrollbar(int /*pos*/)
{
...
int
vgui_window::set_vscrollbar(int /*pos*/)
{
