...
public:
  // Constructors
  wxSliderPanel();
  wxSliderPanel(wxWindow* parent, wxWindowID id = wxID_ANY, wxWindowID base_id = 10100,
                const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize,
                long style = wxVSCROLL | wxSUNKEN_BORDER | wxTAB_TRAVERSAL,
                const wxString& name = wxT("wxSliderPanel") );

  // : Creation
  bool Create(wxWindow* parent, wxWindowID id = wxID_ANY, wxWindowID base_id = 10100,
              const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize,
              long style = wxVSCROLL | wxSUNKEN_BORDER | wxTAB_TRAVERSAL, const wxString& name = wxT("wxSliderPanel") );
  ...
  void CreateSliders(const vcl_vector<double>& init_vals, const vcl_vector<double>& min_vals,
