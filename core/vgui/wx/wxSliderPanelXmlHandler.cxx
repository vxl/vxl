...
wxObject *
wxSliderPanelXmlHandler::DoCreateResource()
{
  long base_id = GetLong(wxT("base_id"), 10100);

  wxSliderPanel * panel =
    new wxSliderPanel(m_parentAsWindow, GetID(), base_id, GetPosition(), GetSize(), GetStyle(), GetName());
...
bool
wxSliderPanelXmlHandler::CanHandle(wxXmlNode * node)
{
