...
wxVideoControl::CreateControls()
{
  ...
  slider_ = new wxSlider(this, wxNewId(), 0, 0, num_frames_, wxDefaultPosition, wxSize(100, -1), wxSL_HORIZONTAL);
  ...
  frame_text_->Connect(-1, wxEVT_KILL_FOCUS, (wxObjectEventFunction)&wxVideoControl::OnKillTextFocus);


  slider_->Connect(-1, wxEVT_KEY_DOWN, (wxObjectEventFunction)&wxVideoControl::OnKeyDown);
}


//: Set the number of frames
void
wxVideoControl::set_num_frames(unsigned int num_frames)
{
...
void
wxVideoControl::set_frame(unsigned int frame, bool send_message)
{
  frame_ = frame;
...
void
wxVideoControl::OnSliderTrack(wxScrollEvent & event)
{
...
void
wxVideoControl::OnSliderChange(wxScrollEvent & event)
{
...
void
wxVideoControl::OnEnterText(wxCommandEvent & event)
{
  long fnum;
...
//: Event handler
void
wxVideoControl::OnButton(wxCommandEvent & event)
{
  int id = event.GetId();
...
//: Event handler
void
wxVideoControl::OnKeyDown(wxKeyEvent & event)
{
