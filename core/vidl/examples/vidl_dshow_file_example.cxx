...
main()
{
  ...
  {
    if (test1.seek_frame(0))
    {
      test_out2.write_frame(test1.current_frame());
    }
    if (test1.seek_frame(1))
    {
      test_out2.write_frame(test1.current_frame());
    }
    if (test1.seek_frame(2))
    {
      test_out2.write_frame(test1.current_frame());
    }
    if (test1.seek_frame(0))
    ...
    if (test2.seek_frame(0))
    {
      test_out2.write_frame(test2.current_frame());
    }
    if (test2.seek_frame(1))
    {
      test_out2.write_frame(test2.current_frame());
    }
    if (test2.seek_frame(2))
    {
      test_out2.write_frame(test2.current_frame());
    }
    if (test2.seek_frame(0))
