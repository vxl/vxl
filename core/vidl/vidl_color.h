...
inline void
vidl_type_convert(const vxl_byte & in, bool & out)
{
  out = (in & 0x80) > 0; // threshold
}

inline void
vidl_type_convert(const vxl_uint_16 & in, bool & out)
{
  out = (in & 0x8000) > 0; // threshold
}

inline void
vidl_type_convert(const bool & in, vxl_byte & out)
{
  out = in ? 0xFF : 0x00;
}

inline void
vidl_type_convert(const bool & in, vxl_uint_16 & out)
{
  out = in ? 0xFFFF : 0x0000;
}

inline void
vidl_type_convert(const vxl_byte & in, vxl_uint_16 & out)
{
  out = static_cast<vxl_uint_16>(in << 8);
}

inline void
vidl_type_convert(const vxl_uint_16 & in, vxl_byte & out)
{
  out = static_cast<vxl_byte>(in >> 8);
}

inline void
vidl_type_convert(const vxl_byte & in, vxl_ieee_32 & out)
{
  out = static_cast<vxl_ieee_32>(in) / 0xFF;
}

inline void
vidl_type_convert(const vxl_uint_16 & in, vxl_ieee_32 & out)
{
  out = static_cast<vxl_ieee_32>(in) / 0xFFFF;
}

inline void
vidl_type_convert(const bool & in, vxl_ieee_32 & out)
{
  out = static_cast<vxl_ieee_32>(in ? 1 : 0);
}

inline void
vidl_type_convert(const vxl_ieee_32 & in, vxl_byte & out)
{
  out = static_cast<vxl_byte>(in * 255);
}

inline void
vidl_type_convert(const vxl_ieee_32 & in, vxl_uint_16 & out)
{
  out = static_cast<vxl_uint_16>(in * 65535);
}

inline void
vidl_type_convert(const vxl_ieee_32 & in, bool & out)
{
  out = in > 0.5; // threshold
}

inline void
vidl_type_convert(const vxl_byte & in, vxl_ieee_64 & out)
{
  out = static_cast<vxl_ieee_64>(in) / 255.0;
}

inline void
vidl_type_convert(const vxl_uint_16 & in, vxl_ieee_64 & out)
{
  out = static_cast<vxl_ieee_64>(in) / 0xFFFF;
}

inline void
vidl_type_convert(const bool & in, vxl_ieee_64 & out)
{
  out = in ? 1 : 0;
}

inline void
vidl_type_convert(const vxl_ieee_64 & in, vxl_byte & out)
{
  out = static_cast<vxl_byte>(in * 255);
}

inline void
vidl_type_convert(const vxl_ieee_64 & in, vxl_uint_16 & out)
{
  out = static_cast<vxl_uint_16>(in * 65535);
}

inline void
vidl_type_convert(const vxl_ieee_64 & in, bool & out)
{
  out = in > 0.5; // threshold
}
...
inline void
vidl_type_convert(const inT & in, outT & out)
{
...
template <class outT>
inline void
vidl_color_convert_yuv2rgb(double y, double u, double v, double & r, double & g, double & b)
{
  r = y + 1.1402 * v;
...
// ITU-R BT.601 (formerly CCIR 601) standard conversion
inline void
vidl_color_convert_yuv2rgb(vxl_byte y, vxl_byte u, vxl_byte v, double & r, double & g, double & b)
{
...
inline void
vidl_color_convert_yuv2rgb(vxl_byte y, vxl_byte u, vxl_byte v, vxl_byte & r, vxl_byte & g, vxl_byte & b)
{
...
// ITU-R BT.601 (formerly CCIR 601) standard conversion
inline void
vidl_color_convert_rgb2yuv(double r, double g, double b, double & y, double & u, double & v)
{
...
// ITU-R BT.601 (formerly CCIR 601) standard conversion
inline void
vidl_color_convert_rgb2yuv(double r, double g, double b, vxl_byte & y, vxl_byte & u, vxl_byte & v)
{
...
// Based on conversion used in libdc1394
inline void
vidl_color_convert_rgb2yuv(vxl_byte r, vxl_byte g, vxl_byte b, vxl_byte & y, vxl_byte & u, vxl_byte & v)
{
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_MONO, VIDL_PIXEL_COLOR_MONO>
{
  ...
  template <class inT, class outT>
  static inline void
  convert(const inT in[1], outT out[1])
  {
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_RGB, VIDL_PIXEL_COLOR_RGB>
{
  ...
  template <class inT, class outT>
  static inline void
  convert(const inT in[3], outT out[3])
  {
    vidl_type_convert(*in, *out);
    vidl_type_convert(*++in, *++out);
    vidl_type_convert(*++in, *++out);
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_RGBA, VIDL_PIXEL_COLOR_RGBA>
{
  ...
  template <class inT, class outT>
  static inline void
  convert(const inT in[4], outT out[4])
  {
    vidl_type_convert(*in, *out);
    vidl_type_convert(*++in, *++out);
    vidl_type_convert(*++in, *++out);
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_RGBA, VIDL_PIXEL_COLOR_RGB>
{
  ...
  template <class inT, class outT>
  static inline void
  convert(const inT in[4], outT out[3])
  {
    vidl_type_convert(*in, *out);
    vidl_type_convert(*++in, *++out);
    vidl_type_convert(*++in, *++out);
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_RGB, VIDL_PIXEL_COLOR_RGBA>
{
  ...
  template <class inT, class outT>
  static inline void
  convert(const inT in[3], outT out[4])
  {
    vidl_type_convert(*in, *out);
    vidl_type_convert(*++in, *++out);
    vidl_type_convert(*++in, *++out);
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_RGB, VIDL_PIXEL_COLOR_YUV>
{
  ...
  template <class inT>
  static inline void
  convert(const inT in[3], vxl_byte out[3])
  {
    double r, g, b;
    vidl_type_convert(in[0], r);
    vidl_type_convert(in[1], b);
    vidl_type_convert(in[2], g);
    vidl_color_convert_rgb2yuv(r, g, b, out[0], out[1], out[2]);
  }

  static inline void
  convert(const vxl_byte in[3], vxl_byte out[3])
  {
    vidl_color_convert_rgb2yuv(in[0], in[1], in[2], out[0], out[1], out[2]);
  }
};
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_RGBA, VIDL_PIXEL_COLOR_YUV>
{
  template <class outT>
  static inline void
  convert(const vxl_byte in[4], outT out[3])
  {
    vidl_color_convert_rgb2yuv(in[0], in[1], in[2], out[0], out[1], out[2]);
  }
};
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_YUV, VIDL_PIXEL_COLOR_RGB>
{
  ...
  template <class outT>
  static inline void
  convert(const vxl_byte in[3], outT out[3])
  {
    double r, g, b;
    vidl_color_convert_yuv2rgb(in[0], in[1], in[2], r, g, b);
    vidl_type_convert(r, out[0]);
    vidl_type_convert(g, out[1]);
    vidl_type_convert(b, out[2]);
  }
  ...
  convert(const vxl_byte in[3], vxl_byte out[3])
  {
    vidl_color_convert_yuv2rgb(in[0], in[1], in[2], out[0], out[1], out[2]);
  }
};
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_YUV, VIDL_PIXEL_COLOR_RGBA>
{
  template <class outT>
  static inline void
  convert(const vxl_byte in[3], outT out[4])
  {
    vidl_color_convert_yuv2rgb(in[0], in[1], in[2], out[0], out[1], out[2]);
    out[3] = vidl_pixel_limits<outT>::max();
  }
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_YUV, VIDL_PIXEL_COLOR_MONO>
{
  ...
  template <class inT, class outT>
  static inline void
  convert(const inT in[3], outT out[1])
  {
    // The Y channel is the greyscale value
    vidl_type_convert(*in, *out);
  }
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_MONO, VIDL_PIXEL_COLOR_YUV>
{
  ...
  template <class inT, class outT>
  static inline void
  convert(const inT in[1], outT out[3])
  {
    // The Y channel is the greyscale value
    vidl_type_convert(*in, *out);
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_RGB, VIDL_PIXEL_COLOR_MONO>
{
  ...
  static inline void
  convert(const vxl_byte in[3], vxl_byte out[1])
  {
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_RGBA, VIDL_PIXEL_COLOR_MONO>
{
  template <class inT, class outT>
  static inline void
  convert(const inT in[4], outT out[1])
  {
    // use double as intermediate type
    double r, g, b;
    vidl_type_convert(in[0], r);
  ...
  // fast approximation for bytes
  static inline void
  convert(const vxl_byte in[4], vxl_byte out[1])
  {
    //: FIXME verify that this works!
    out[0] = (306 * in[0] + 601 * in[1] + 117 * in[2]) >> 10;
  }
...
struct vidl_color_converter<VIDL_PIXEL_COLOR_MONO, VIDL_PIXEL_COLOR_RGBA>
{
  template <class inT, class outT>
  static inline void
  convert(const inT in[1], outT out[4])
  {
    // Set all channels to the same value
    vidl_type_convert(*in, *out);
    out[2] = out[1] = out[0];
...
struct vidl_color_component
{
  ...
  get(const cmp_type * ptr, unsigned int i)
  {
    return ptr[i];
  }
  ...
  static inline void
  get_all(const cmp_type * ptr, cmp_type * data)
  {
    std::memcpy(data, ptr, sizeof(cmp_type) * vidl_pixel_traits_of<FMT>::num_channels);
  }

  static inline void
  set(cmp_type * ptr, unsigned int i, cmp_type val)
  {
    ptr[i] = val;
  }
  ...
  // it may be more efficient to access all color channels at once
  static inline void
  set_all(cmp_type * ptr, const cmp_type * data)
  {
...
struct vidl_color_component<VIDL_PIXEL_FORMAT_BGR_24>
{
  ...
  get(const vxl_byte * ptr, unsigned int i)
  {
    return ptr[2 - i];
  }

  static inline void
  get_all(const vxl_byte * ptr, vxl_byte * data)
  {
    data[0] = ptr[2];
    data[1] = ptr[1];
    data[2] = ptr[0];
  ...
  static inline void
  set(vxl_byte * ptr, unsigned int i, vxl_byte val)
  {
    ptr[2 - i] = val;
  }

  static inline void
  set_all(vxl_byte * ptr, const vxl_byte * data)
  {
    ptr[2] = data[0];
    ptr[1] = data[1];
    ptr[0] = data[2];
...
struct vidl_color_component<VIDL_PIXEL_FORMAT_RGB_565>
{
  ...
  get(const vxl_byte * ptr, unsigned int i)
  {
    ...
    {
      case 0:
        return vxl_byte((*p & 0xF800) >> 8); // R
      case 1:
        return vxl_byte((*p & 0x07E0) >> 3); // G
      case 2:
        return vxl_byte((*p & 0x001F) << 3); // B
      default:
        assert(!"i should be one of 0, 1, or 2");
    }
    return 0;
  }
  ...
  set(vxl_byte * ptr, unsigned int i, vxl_byte val)
  {
    ...
    switch (i)
    {
      case 0:
        *p &= 0x07FF;
        *p |= static_cast<vxl_uint_16>(v << 11);
        break; // R
      case 1:
        *p &= 0xF81F;
        *p |= static_cast<vxl_uint_16>(v << 5);
        break; // G
      case 2:
        *p &= 0xFFE0;
        *p |= v;
