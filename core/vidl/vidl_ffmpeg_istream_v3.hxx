// This is core/vidl/vidl_ffmpeg_istream_v3.hxx
#ifndef vidl_ffmpeg_istream_v3_hxx_
#define vidl_ffmpeg_istream_v3_hxx_
#include <string>
#include <iostream>
...
vidl_ffmpeg_istream::frame_number() const
{
  ...
  return (unsigned int)(((is_->last_dts - is_->start_time) * is_->vid_str_->r_frame_rate.num /
...
vidl_ffmpeg_istream::advance()
{
  ...
  while (got_picture == 0)
  {
    ...
    {
      if (avcodec_decode_video2(codec, is_->frame_, &got_picture, &is_->packet_) < 0)
      {
...
#endif // vidl_ffmpeg_istream_v3_hxx_
