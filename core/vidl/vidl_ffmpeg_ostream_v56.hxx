...
vidl_ffmpeg_ostream::open()
{
  ...
  else if (codec && (codec->id == AV_CODEC_ID_RAWVIDEO || codec->id == AV_CODEC_ID_HUFFYUV))
  {
  ...
  // DEPRECATED https://www.ffmpeg.org/doxygen/3.1/structAVCodecContext.html video_enc->intra_quant_bias =
  // params_.video_intra_quant_bias_; DEPRECATED https://www.ffmpeg.org/doxygen/3.1/structAVCodecContext.html
  ...
  // "https://www.ffmpeg.org/doxygen/3.1/structAVCodecContext.html#aa71b3450f1a508330e907db117ae410e"
