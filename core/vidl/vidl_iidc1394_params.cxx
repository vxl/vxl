...
vidl_iidc1394_params::video_mode_string(video_mode_t m)
{
  switch (m)
  {
    ...
    case MODE_640x480_MONO8:
      return "640x480 Mono(8 bit)";
    case MODE_640x480_MONO16:
      return "640x480 Mono(16 bit)";
    case MODE_800x600_YUV422:
      return "800x600 YUV(4:2:2)";
    case MODE_800x600_RGB8:
      return "800x600 RGB";
    case MODE_800x600_MONO8:
      return "800x600 Mono(8 bit)";
    case MODE_1024x768_YUV422:
      return "1024x768 YUV(4:2:2)";
    case MODE_1024x768_RGB8:
      return "1024x768 RGB";
    case MODE_1024x768_MONO8:
      return "1024x768 Mono(8 bit)";
    case MODE_800x600_MONO16:
      return "800x600 Mono(16 bit)";
    case MODE_1024x768_MONO16:
      return "1024x768 Mono(16 bit)";
    case MODE_1280x960_YUV422:
      return "1280x960 YUV(4:2:2)";
    case MODE_1280x960_RGB8:
      return "1280x960 RGB";
    case MODE_1280x960_MONO8:
      return "1280x960 Mono(8 bit)";
    case MODE_1600x1200_YUV422:
      return "1600x1200 YUV(4:2:2)";
    case MODE_1600x1200_RGB8:
      return "1600x1200 RGB";
    case MODE_1600x1200_MONO8:
      return "1600x1200 Mono(8 bit)";
    case MODE_1280x960_MONO16:
      return "1280x960 Mono(16 bit)";
    case MODE_1600x1200_MONO16:
      return "1600x1200 Mono(16 bit)";
    case MODE_EXIF:
      return "Exif";
    case MODE_FORMAT7_0:
      return "Format 7 : Mode 0";
    case MODE_FORMAT7_1:
      return "Format 7 : Mode 1";
    case MODE_FORMAT7_2:
      return "Format 7 : Mode 2";
    case MODE_FORMAT7_3:
      return "Format 7 : Mode 3";
    case MODE_FORMAT7_4:
      return "Format 7 : Mode 4";
    case MODE_FORMAT7_5:
      return "Format 7 : Mode 5";
    case MODE_FORMAT7_6:
      return "Format 7 : Mode 6";
    case MODE_FORMAT7_7:
      return "Format 7 : Mode 7";
    default:
      return "invalid mode";
  }
}
...
vidl_iidc1394_params::pixel_format(video_mode_t m)
{
  switch (m)
  {
    ...
    case MODE_640x480_YUV411:
      return VIDL_PIXEL_FORMAT_UYVY_411;
