...
bool
vidl_image_list_istream::open(const vcl_string& glob)
{
...
bool
vidl_image_list_istream::open(const vcl_vector<vcl_string>& paths)
{
  image_paths_.clear();
...
bool
vidl_image_list_istream::advance()
{
  current_frame_ = NULL;
...
bool
vidl_image_list_istream::seek_frame(unsigned int frame_nr)
{
