...
class VIDL_EXPORT vidl_image_list_istream : public vidl_istream
{
public:
  //: Constructor - default
  ...
  {
    return is_open() && index_ < image_paths_.size();
  }
  ...
  {
    return int(image_paths_.size());
  }

  //: Return the current frame number
  unsigned int
  frame_number() const override
  {
    return index_;
  }
  ...
  bool
  seek_frame(unsigned int frame_number) override;
