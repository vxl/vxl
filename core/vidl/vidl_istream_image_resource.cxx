...
vidl_istream_image_resource::vidl_istream_image_resource(const vidl_istream_sptr & i_stream, int frame)
  : istream_(i_stream)
  , frame_number_(frame)
{
  assert(istream_);
...
vidl_istream_image_resource::~vidl_istream_image_resource() = default;
...
vidl_istream_image_resource::get_copy_view(unsigned i0, unsigned ni, unsigned j0, unsigned nj) const
{
  if (!istream_)
    return nullptr;
