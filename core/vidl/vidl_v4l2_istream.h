...
public:
  ...
  width() const
  {
    return (unsigned int)dev.get_width();
  }
  ...
  height() const
  {
    return (unsigned int)dev.get_height();
  }
  ...
  format() const
  {
    return v4l2_to_vidl(dev.get_v4l2_format());
  }
