...
struct vidl_v4l_params
{
  ...
  vidl_v4l_params()
    ...
    , whiteness_(49152)
    , depth_(24)
    , pixel_format_(VIDL_PIXEL_FORMAT_YUV_420P)
  {}

  //: get the current resolution
  vidl_v4l_params &
  resolution(unsigned int ni, unsigned int nj)
  {
    ni_ = ni;
    nj_ = nj;
    return *this;
  ...
  //: palette
  vidl_v4l_params &
  pixel_format(vidl_pixel_format pf)
  {
    pixel_format_ = pf;
    return *this;
  }
