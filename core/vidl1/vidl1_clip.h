...
class vidl_clip : public vbl_ref_count
{
 ...
 public:
  ...
  // Constructors
  vidl_clip(vidl_codec_sptr codec,
            int start = 0,
            int end = 0,
            int increment = 1);

  vidl_clip(vcl_list<vil_image_resource_sptr> &images,
            int start = 0,
            int end = 0,
            int increment = 1);

  vidl_clip(vcl_vector<vil_image_resource_sptr> &images,
            int start = 0,
            int end = 0,
            int increment = 1);
 ...
 protected:
  ...
  // Data Members
  vcl_vector<vidl_frame_sptr> frames_; //!< Where are the frames stored
