...
class vidl_vil1_movie : public vbl_ref_count
{
 ...
 public:
  ...
  class frame_iterator
  {
   ...
   private :
    vidl_vil1_movie* movie_;
    int frame_number_;

   public :
    // Constructors / destructors
    frame_iterator (vidl_vil1_movie* movie, int frame_number) :
      movie_(movie), frame_number_(frame_number) {}

    frame_iterator (vidl_vil1_movie* movie) :
    ...
    vidl_vil1_movie* get_movie () const  { return movie_; }
  };
