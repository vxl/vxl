// This is core/vidl_vil1/vidl_vil1_mpegcodec_helper.h
#ifndef vidl_vil1_mpegcodec_helper_h
#define vidl_vil1_mpegcodec_helper_h
//:
// \file
// \brief Contains classes vidl_vil1_mpegcodec_data and vidl_vil1_mpegcodec_helper
// \author l.e.galup
// \date July 2002
//
...
struct vidl_vil1_mpegcodec_data : public vo_instance_t
{
 public:
...
{
  friend class vidl_vil1_mpegcodec;

 public:
  vidl_vil1_mpegcodec_helper(vo_open_t * vopen,
                             vcl_string filename,
                             frame_buffer * buffers);
  ...
  vidl_vil1_mpegcodec_data::output_format_t get_format() const {return output_->output_format;}
...
#endif // vidl_vil1_mpegcodec_helper_h
