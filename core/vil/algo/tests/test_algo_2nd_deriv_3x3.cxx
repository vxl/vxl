...
test_algo_2nd_deriv_3x3()
{
  ...
  image_d2j.set_size(ni, nj);
  vil_image_view<vxl_byte> image_d2I_didj;
  image_d2I_didj.set_size(ni, nj);
  image_d2i.fill(10);
  image_d2j.fill(10);
  image_d2I_didj.fill(10);
  vxl_byte v = 11, m = 9;
  image_d2i(i + 1, j - 1) = v;
  image_d2i(i - 1, j - 1) = v;
  image_d2i(i + 1, j) = v;
  ...
  image_d2I_didj(i - 1, j + 1) = v;
  image_d2I_didj(i - 1, j - 1) = m;
  image_d2I_didj(i + 1, j + 1) = m;
  image_d2I_didj(i + 1, j - 1) = v;
