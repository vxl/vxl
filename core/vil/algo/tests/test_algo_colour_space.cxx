...
test_algo_colour_space()
{
  ...
  TEST("Test RGB/YUV on red",
       std::abs(red_rgb[0] - color2[0]) < 1e-12 && std::abs(red_rgb[1] - color2[1]) < 1e-12 &&
         std::abs(red_rgb[2] - color2[2]) < 1e-12,
       true);
  ...
  TEST("Test RGB/YUV on green",
       std::abs(green_rgb[0] - color2[0]) < 1e-12 && std::abs(green_rgb[1] - color2[1]) < 1e-12 &&
         std::abs(green_rgb[2] - color2[2]) < 1e-12,
       true);
  ...
  TEST("Test RGB/YUV on blue",
       std::abs(blue_rgb[0] - color2[0]) < 1e-12 && std::abs(blue_rgb[1] - color2[1]) < 1e-12 &&
         std::abs(blue_rgb[2] - color2[2]) < 1e-12,
       true);
  ...
  TEST("Test RGB/YPbPr on red",
       std::abs(red_rgb[0] - color2[0]) < 1e-6 && std::abs(red_rgb[1] - color2[1]) < 1e-6 &&
         std::abs(red_rgb[2] - color2[2]) < 1e-6,
       true);
  ...
  TEST("Test RGB/YPbPr on green",
       std::abs(green_rgb[0] - color2[0]) < 1e-6 && std::abs(green_rgb[1] - color2[1]) < 1e-6 &&
         std::abs(green_rgb[2] - color2[2]) < 1e-6,
       true);
  ...
  TEST("Test RGB/YPbPr on blue",
       std::abs(blue_rgb[0] - color2[0]) < 1e-6 && std::abs(blue_rgb[1] - color2[1]) < 1e-6 &&
         std::abs(blue_rgb[2] - color2[2]) < 1e-6,
       true);
  ...
  TEST("Test RGB/YCbCr on red",
       unsigned_red_rgb[0] - unsigned_color2[0] < 1 && unsigned_red_rgb[1] - unsigned_color2[1] < 1 &&
         unsigned_red_rgb[2] - unsigned_color2[2] < 1,
       true);
  ...
  TEST("Test RGB/YCbCr on green",
       unsigned_green_rgb[0] - unsigned_color2[0] < 1 && unsigned_green_rgb[1] - unsigned_color2[1] < 1 &&
         unsigned_green_rgb[2] - unsigned_color2[2] < 1,
       true);
  ...
  TEST("Test RGB/YCbCr on blue",
       unsigned_blue_rgb[0] - unsigned_color2[0] < 1 && unsigned_blue_rgb[1] - unsigned_color2[1] < 1 &&
         unsigned_blue_rgb[2] - unsigned_color2[2] < 1,
       true);
}
