...
test_algo_gaussian_filter_5tap_byte_float()
{
  ...
  const vil_gauss_filter_5tap_params params(1.0);
...
test_algo_vil_gauss_filter_gen_ntaps()
{
  ...
  const double correct_filter1[] = { 0.03873542550599, 0.11308483122135, 0.21500681127034, 0.26634586400464,
  ...
  const double correct_filter2[] = { 0.12372451934878,  0.09009370132564, -0.13740317011788, -0.29755721841539,
  ...
  const double correct_filter3[] = { 0.00000000000003, 0.00000028665154, 0.00620937867420, 0.49379033467422,
                                     0.49379033467422, 0.00620937867420, 0.00000028665154, 0.00000000000003 };
  ...
  const double correct_filter4[] = { 0.18846314959135,  0.16222013702815,  0.11021993712191,  0.03909677625858,
                                     -0.03909677625858, -0.11021993712191, -0.16222013702815, -0.18846314959135 };
...
test_algo_gauss_filter_2d()
{
  ...
  std::vector<double> filter(2 * half_width + 1);
  vil_gauss_filter_gen_ntap(sd, 0, filter);
  const double f_c = filter[half_width]; // Centre value of filter
  const double f_0 = filter[0];          // Value at end of filter
