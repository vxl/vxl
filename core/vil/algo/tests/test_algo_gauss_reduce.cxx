...
static void
test_algo_gauss_reduce_byte(unsigned nx)
{
  std::cout << "*********************************************\n"
  ...
  vil_gauss_reduce_1plane(image0.top_left_ptr(),
                          image0.ni(),
                          image0.nj(),
                          image0.istep(),
                          image0.jstep(),
                          reduced_x.top_left_ptr(),
                          reduced_x.istep(),
                          reduced_x.jstep());
  ...
  vil_gauss_reduce_1plane(image1.top_left_ptr(),
                          image1.nj(),
                          image1.ni(),
                          image1.jstep(),
                          image1.istep(),
                          reduced_y.top_left_ptr(),
                          reduced_y.jstep(),
                          reduced_y.istep());
...
static void
test_algo_gauss_reduce_int_32(unsigned nx)
{
  std::cout << "***********************************************\n"
...
static void
test_algo_gauss_reduce_uint_16(unsigned nx)
{
  std::cout << "************************************************\n"
...
static void
test_algo_gauss_reduce_float(unsigned int nx)
{
  std::cout << "**********************************************\n"
...
static void
test_algo_gauss_reduce_121_byte(unsigned nx, unsigned ny)
{
  std::cout << "*******************************************************\n"
  ...
  vil_gauss_reduce_121_1plane(image0.top_left_ptr(),
                              image0.ni(),
                              image0.nj(),
                              image0.istep(),
                              image0.jstep(),
...
static void
test_algo_gauss_reduce_121_int_32(unsigned nx, unsigned ny)
{
  std::cout << "********************************************************\n"
...
static void
test_algo_gauss_reduce_121_uint_16(unsigned nx, unsigned ny)
{
  std::cout << "**********************************************************\n"
...
static void
test_algo_gauss_reduce_121_float(unsigned nx, unsigned ny)
{
  std::cout << "********************************************************\n"
...
static void
test_algo_gauss_reduce_121_byte_multiplane(unsigned nx, unsigned ny, unsigned np)
{
  std::cout << "*************************************************************\n"
...
static void
test_algo_gauss_reduce_2_3_float(unsigned nx, unsigned ny)
{
  std::cout << "********************************************************\n"
  ...
  vil_gauss_reduce_2_3_1plane(image0.top_left_ptr(),
                              image0.ni(),
                              image0.nj(),
                              image0.istep(),
                              image0.jstep(),
