                       ...
                       vil_image_view<destT>& d2I_didj)
{
  ...
  for (int p=0;p<np;++p)
  {
    vil_2nd_deriv_3x3_1plane(src.top_left_ptr()+p*src.planestep(),
                         ...
                         d2I_di2.istep(),d2I_di2.jstep(),
                         d2I_dj2.top_left_ptr()+p*d2I_dj2.planestep(),
                         d2I_dj2.istep(),d2I_dj2.jstep(),
                         d2I_didj.top_left_ptr()+p*d2I_didj.planestep(),
                         d2I_didj.istep(),d2I_didj.jstep(), ni,nj);
  }
                              ...
                              unsigned ni, unsigned nj)
{
  ...
  d2j_data   += d2Idj_jstep;
  d2ij_data += d2I_didj_jstep;
  destT* d2i; destT* d2j;destT* d2ij;
  for (unsigned j=1;j<nj1;++j)
  {
    ...
    *d2i = 0; d2i  += d2Idi_istep;
    *d2j = 0; d2j  += d2Idj_istep;
    *d2ij =0; d2ij += d2I_didj_istep;
  ...
  for (unsigned i=0;i<ni;++i)
  {
    *d2i=zero;    d2i+=d2Idi_istep;
    *d2j=zero;    d2j+=d2Idj_istep;
    *d2ij = zero; d2ij += d2I_didj_istep;
    *d2i_data = zero; d2i_data+=d2Idi_istep;
    *d2j_data = zero; d2j_data+=d2Idj_istep;
    *d2ij_data = zero; d2ij_data += d2I_didj_istep;
  }
}
