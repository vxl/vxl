...
inline bool vil_binary_dilate(const bool* im, const vcl_ptrdiff_t* offset, unsigned n)
{
...
// \relatesalso vil_structuring_element
void vil_binary_dilate(const vil_image_view<bool>& src_image, vil_image_view<bool>& dest_image,
...
void vil_binary_dilate(const vil_image_view<bool>& src_image, vil_image_view<bool>& dest_image,
                       const vil_structuring_element& element, const vil_border<vil_image_view<bool> >& border);
