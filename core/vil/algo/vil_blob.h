...
void vil_blob_labels(const vil_image_view<bool>& src_binary, vil_blob_connectivity conn,
...
// 4-conn neighbours.
void vil_blob_labels_to_edge_labels(const vil_image_view<unsigned>& src_label, vil_blob_connectivity conn,
                                    vil_image_view<unsigned>& dest_label);
