// This is core/vil/algo/vil_checker_board.hxx
#ifndef vil_checker_board_hxx_
#define vil_checker_board_hxx_
//:
// \file
...
{
  assert(src1.ni() == src2.ni() && src1.nj() == src2.nj() && src1.nplanes() == src2.nplanes());
  ...
  assert(des.ni() == src1.ni() && des.nj() == src1.nj() && des.nplanes() == src1.nplanes());
