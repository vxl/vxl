...
vil_image_resource_sptr vil_convolve_1d(const vil_image_resource_sptr& src_im, const destT dt, const kernelT* kernel,
                                        int k_lo, int k_hi, const accumT ac, vil_convolve_boundary_option start_option,
                                        vil_convolve_boundary_option end_option);
...
class vil_convolve_1d_resource : public vil_image_resource
{
  ...
  friend vil_image_resource_sptr vil_convolve_1d VCL_NULL_TMPL_ARGS(const vil_image_resource_sptr& src_im,
                                                                    const destT dt, const kernelT* kernel, int k_lo,
                                                                    int k_hi, const accumT ac,
                                                                    vil_convolve_boundary_option start_option,
                                                                    vil_convolve_boundary_option end_option);
