...
void vil_corners(const vil_image_view<float>& grad_i, const vil_image_view<float>& grad_j, vil_image_view<float>& dest,
                 double k = 0.04);

void vil_corners(const vil_image_view<double>& grad_i, const vil_image_view<double>& grad_j,
...
// \relatesalso vil_image_view
void vil_corners_rohr(const vil_image_view<float>& grad_i, const vil_image_view<float>& grad_j,
