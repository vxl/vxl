...
vil_image_resource_sptr vil_correlate_1d(const vil_image_resource_sptr& src_im, const destT dt, const kernelT* kernel,
...
class vil_correlate_1d_resource : public vil_image_resource
{
  ...
  friend vil_image_resource_sptr vil_correlate_1d VCL_NULL_TMPL_ARGS(const vil_image_resource_sptr& src_im,
                                                                     const destT dt, const kernelT* kernel,
                                                                     vcl_ptrdiff_t k_lo, vcl_ptrdiff_t k_hi,
                                                                     const accumT ac,
                                                                     vil_convolve_boundary_option start_option,
                                                                     vil_convolve_boundary_option end_option);
