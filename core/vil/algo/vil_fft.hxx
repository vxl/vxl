...
vil_fft_2d_base(std::complex<T> * data,
                unsigned n0,
                std::ptrdiff_t step0, // ni, istep
                unsigned n1,
                std::ptrdiff_t step1, // nj, jstep
                unsigned n2,
                std::ptrdiff_t step2, // nplanes, planestep
                int dir)
{
...
{
  vil_fft_2d_base(img.top_left_ptr(), img.ni(), img.istep(), img.nj(), img.jstep(), img.nplanes(), img.planestep(), 1);
  vil_fft_2d_base(img.top_left_ptr(), img.nj(), img.jstep(), img.ni(), img.istep(), img.nplanes(), img.planestep(), 1);
}
