...
template <class T>
inline void
vil_next_point_below_thresh4(int & i,
                             int & j,
                             int & dir,
                             const T *& p,
                             int ni1,
...
template <class T>
inline void
vil_next_point_above_thresh4(int & i,
                             int & j,
                             int & dir,
                             const T *& p,
                             int ni1,
...
template <class T>
inline void
vil_find_4con_boundary_below_threshold(std::vector<int> & bi,
                                       std::vector<int> & bj,
...
template <class T>
inline void
vil_find_4con_boundary_above_threshold(std::vector<int> & bi,
                                       std::vector<int> & bj,
                                       const vil_image_view<T> & image,
                                       const T & threshold,
                                       int p0_i,
