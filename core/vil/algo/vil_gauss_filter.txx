    ...
    if( ni == 1 )
      ...
      for( unsigned p = 0; p < n_planes; ++p )
        ...
        for( unsigned j = 0; j < nj; ++j )
          ...
          work(1, j, p) = vl_round(kpn1 * src_im(0, j, p) + kp0 * src_im(1, j, p) + kp1 * src_im(2, j,
                                                                                                 p) + kp2
                                   * src_im(3, j, p), destT() );
          work(2, j, p) = vl_round(kp2 * src_im(0, j, p) + kp1 * src_im(1, j, p) + kp0 * src_im(2, j,
                                                                                                p) + kpn1
                                   * src_im(3, j, p), destT() );
          work(3, j,
               p) = vl_round(                     ke2 * src_im(1, j, p) + ke1 * src_im(2, j, p) + ke0 * src_im(3, j,
                                                                                                               p),
                                                  destT() );
          }
        }
    ...
    if( nj == 1 )
      ...
      for( unsigned p = 0; p < n_planes; ++p )
        ...
        for( unsigned i = 0; i < ni; ++i )
          ...
          dest_im(i, 3, p) = vl_round(                   ke2 * work(i, 1, p) + ke1 * work(i, 2, p) + ke0 * work(i, 3,
                                                                                                                p),
                                                         destT() );
          }
        }
