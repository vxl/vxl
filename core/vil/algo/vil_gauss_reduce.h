...
template <class T>
void
vil_gauss_reduce(const vil_image_view<T> & src, vil_image_view<T> & dest, vil_image_view<T> & work_im);
...
template <class T>
void
vil_gauss_reduce_121(const vil_image_view<T> & src, vil_image_view<T> & dest);
...
class vil_gauss_reduce_params
{
  ...
  double filt_pen_edge2_, filt_pen_edge1_, filt_pen_edge0_, filt_pen_edge_n1_;
...
template <class T>
void
vil_gauss_reduce_general(const vil_image_view<T> & src_im,
