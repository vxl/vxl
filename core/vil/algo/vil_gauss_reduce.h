...
//
// Amended by Martin Roberts 15th Sep 2005
// Au contraire, let's have a generic template implementation after all
// The previous specific types one plane functions become template specialisations
...
template <class T>
void vil_gauss_reduce_general(const vil_image_view<T>& src_im, vil_image_view<T>& dest_im, vil_image_view<T>& worka,
                              vil_image_view<T>& workb, const vil_gauss_reduce_params& params);
...
template <class T>
void vil_gauss_reduce_1plane(const T* src_im, unsigned src_nx, unsigned src_ny, vcl_ptrdiff_t s_x_step,
                             vcl_ptrdiff_t s_y_step, T* dest_im, vcl_ptrdiff_t d_x_step, vcl_ptrdiff_t d_y_step);
...
void vil_gauss_reduce_1plane(const vxl_byte* src_im, unsigned src_nx, unsigned src_ny, vcl_ptrdiff_t s_x_step,
                             vcl_ptrdiff_t s_y_step, vxl_byte* dest_im, vcl_ptrdiff_t d_x_step, vcl_ptrdiff_t d_y_step);
...
//  sub-sampled 2D image.
VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_1plane(const float* src_im, unsigned src_nx, unsigned src_ny, vcl_ptrdiff_t s_x_step,
                             vcl_ptrdiff_t s_y_step, float* dest_im, vcl_ptrdiff_t d_x_step, vcl_ptrdiff_t d_y_step);
...
//  sub-sampled 2D image.
VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_1plane(const int* src_im, unsigned src_nx, unsigned src_ny, vcl_ptrdiff_t s_x_step,
                             vcl_ptrdiff_t s_y_step, int* dest_im, vcl_ptrdiff_t d_x_step, vcl_ptrdiff_t d_y_step);

VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_1plane(const double* src_im, unsigned src_nx, unsigned src_ny, vcl_ptrdiff_t s_x_step,
                             vcl_ptrdiff_t s_y_step, double* dest_im, vcl_ptrdiff_t d_x_step, vcl_ptrdiff_t d_y_step);
...
//  sub-sampled 2D image.
VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_1plane(const vxl_int_16* src_im, unsigned src_nx, unsigned src_ny, vcl_ptrdiff_t s_x_step,
                             vcl_ptrdiff_t s_y_step, vxl_int_16* dest_im, vcl_ptrdiff_t d_x_step,
...
template <class T>
void vil_gauss_reduce_121_1plane(const T* src_im, unsigned src_nx, unsigned src_ny, vcl_ptrdiff_t s_x_step,
                                 vcl_ptrdiff_t s_y_step, T* dest_im, vcl_ptrdiff_t d_x_step, vcl_ptrdiff_t d_y_step);

// : Smooth and subsample single plane src_im in x to produce dest_im using 121 filter in x and y
//  Smooths with a 3x3 filter and subsamples
VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_121_1plane(const vxl_byte* src_im, unsigned src_nx, unsigned src_ny, vcl_ptrdiff_t s_x_step,
                                 vcl_ptrdiff_t s_y_step, vxl_byte* dest_im, vcl_ptrdiff_t d_x_step,
                                 vcl_ptrdiff_t d_y_step);

// : Smooth and subsample single plane src_im in x to produce dest_im using 121 filter in x and y
//  Smooths with a 3x3 filter and subsamples
VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_121_1plane(const float* src_im, unsigned src_nx, unsigned src_ny, vcl_ptrdiff_t s_x_step,
                                 vcl_ptrdiff_t s_y_step, float* dest_im, vcl_ptrdiff_t d_x_step,
                                 vcl_ptrdiff_t d_y_step);

// : Smooth and subsample single plane src_im in x to produce dest_im using 121 filter in x and y
//  Smooths with a 3x3 filter and subsamples
VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_121_1plane(const int* src_im, unsigned src_nx, unsigned src_ny, vcl_ptrdiff_t s_x_step,
                                 vcl_ptrdiff_t s_y_step, int* dest_im, vcl_ptrdiff_t d_x_step, vcl_ptrdiff_t d_y_step);

VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_121_1plane(const double* src_im, unsigned src_nx, unsigned src_ny, vcl_ptrdiff_t s_x_step,
                                 vcl_ptrdiff_t s_y_step, double* dest_im, vcl_ptrdiff_t d_x_step,
                                 vcl_ptrdiff_t d_y_step);

// : Smooth and subsample single plane src_im in x to produce dest_im using 121 filter in x and y
//  Smooths with a 3x3 filter and subsamples
VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_121_1plane(const vxl_int_16* src_im, unsigned src_nx, unsigned src_ny, vcl_ptrdiff_t s_x_step,
                                 vcl_ptrdiff_t s_y_step, vxl_int_16* dest_im, vcl_ptrdiff_t d_x_step,
                                 vcl_ptrdiff_t d_y_step);
...
template <class T>
void vil_gauss_reduce_2_3_1plane(const T* src_im, unsigned src_ni, unsigned src_nj, vcl_ptrdiff_t s_x_step,
                                 vcl_ptrdiff_t s_y_step, T* dest_im, vcl_ptrdiff_t d_x_step, vcl_ptrdiff_t d_y_step);
...
//  Note, 131 filter only an approximation
VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_2_3_1plane(const vxl_byte* src_im, unsigned src_ni, unsigned src_nj, vcl_ptrdiff_t s_x_step,
                                 vcl_ptrdiff_t s_y_step, vxl_byte* dest_im, vcl_ptrdiff_t d_x_step,
                                 vcl_ptrdiff_t d_y_step);
...
//  Note, 131 filter only an approximation
VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_2_3_1plane(const int* src_im, unsigned src_ni, unsigned src_nj, vcl_ptrdiff_t s_x_step,
                                 vcl_ptrdiff_t s_y_step, int* dest_im, vcl_ptrdiff_t d_x_step, vcl_ptrdiff_t d_y_step);
...
//  Note, 131 filter only an approximation
VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_2_3_1plane(const vxl_int_16* src_im, unsigned src_ni, unsigned src_nj, vcl_ptrdiff_t s_x_step,
                                 vcl_ptrdiff_t s_y_step, vxl_int_16* dest_im, vcl_ptrdiff_t d_x_step,
                                 vcl_ptrdiff_t d_y_step);
...
//  Note, 131 filter only an approximation
VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_2_3_1plane(const float* src_im, unsigned src_ni, unsigned src_nj, vcl_ptrdiff_t s_x_step,
                                 vcl_ptrdiff_t s_y_step, float* dest_im, vcl_ptrdiff_t d_x_step,
                                 vcl_ptrdiff_t d_y_step);
...
//  Note, 131 filter only an approximation
VCL_DEFINE_SPECIALIZATION
void vil_gauss_reduce_2_3_1plane(const double* src_im, unsigned src_ni, unsigned src_nj, vcl_ptrdiff_t s_x_step,
                                 vcl_ptrdiff_t s_y_step, double* dest_im, vcl_ptrdiff_t d_x_step,
                                 vcl_ptrdiff_t d_y_step);
