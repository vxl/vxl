...
public:
  ...
  void light_lines_3x3(vil_image_view<vxl_byte>& line_dir, vil_image_view<float>& line_str,
                       const vil_image_view<Type>& image, float edge_thresh = 0.1f);
  ...
  void dark_lines_3x3(vil_image_view<vxl_byte>& line_dir, vil_image_view<float>& line_str,
                      const vil_image_view<Type>& image, float edge_thresh = 0.1f);
  ...
  //  This version looks for light lines on a dark background only
  //  using a 5x5 filter
  void light_lines_5x5(vil_image_view<vxl_byte>& line_dir, vil_image_view<float>& line_str,
                       const vil_image_view<Type>& image, float edge_thresh = 0.1f);
  ...
  //  This version looks for dark lines on a light background only
  //  using a 5x5 filter
  void dark_lines_5x5(vil_image_view<vxl_byte>& line_dir, vil_image_view<float>& line_str,
                      const vil_image_view<Type>& image, float edge_thresh = 0.1f);
