...
template <class Type>
void
vil_line_filter<Type>::light_lines_3x3(vil_image_view<vxl_byte> & line_dir,
...
template <class Type>
void
vil_line_filter<Type>::dark_lines_3x3(vil_image_view<vxl_byte> & line_dir,
                                      vil_image_view<float> & line_str,
                                      const vil_image_view<Type> & image,
                                      float edge_thresh)
{
...
template <class Type>
void
vil_line_filter<Type>::light_lines_5x5(vil_image_view<vxl_byte> & line_dir,
                                       vil_image_view<float> & line_str,
                                       const vil_image_view<Type> & image,
                                       float edge_thresh)
{
...
template <class Type>
void
vil_line_filter<Type>::dark_lines_5x5(vil_image_view<vxl_byte> & line_dir,
                                      vil_image_view<float> & line_str,
                                      const vil_image_view<Type> & image,
                                      float edge_thresh)
{
