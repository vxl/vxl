...
vil_region_finder<pix_type, predicate_type>::vil_region_finder( image_view const& in_image,
...
template <class pix_type, class predicate_type>
void
vil_region_finder<pix_type, predicate_type>::same_int_region( unsigned i, unsigned j,
...
template <class pix_type, class predicate_type>
void
vil_region_finder<pix_type, predicate_type>::same_int_region( unsigned i, unsigned j, pix_type p,
                                                              vcl_vector<unsigned>& ri,
                                                              vcl_vector<unsigned>& rj )
{
