// This is core/vil/algo/vil_sobel_1x3.hxx
#ifndef vil_sobel_1x3_hxx_
#define vil_sobel_1x3_hxx_
//:
// \file
...
void
vil_sobel_1x3(const vil_image_view<srcT> & src, vil_image_view<destT> & grad_ij)
{
...
template <class srcT, class destT>
void
vil_sobel_1x3(const vil_image_view<srcT> & src, vil_image_view<destT> & grad_i, vil_image_view<destT> & grad_j)
{
  unsigned np = src.nplanes();
  unsigned ni = src.ni();
  unsigned nj = src.nj();
...
template <class srcT, class destT>
void
vil_sobel_1x3_1plane(const srcT * src,
...
#define VIL_SOBEL_1X3_INSTANTIATE(srcT, destT)                                                    \
  template void vil_sobel_1x3(const vil_image_view<srcT> & src, vil_image_view<destT> & grad_ij); \
  template void vil_sobel_1x3(                                                                    \
    const vil_image_view<srcT> & src, vil_image_view<destT> & grad_i, vil_image_view<destT> & grad_j)

#endif // vil_sobel_1x3_hxx_
