// This is core/vil2/algo/vil2_sobel_1x3.txx
#ifndef vil2_sobel_1x3_txx_
#define vil2_sobel_1x3_txx_
//:
//  \file
//  \brief Apply sobel gradient filter to an image
//  \author Tim Cootes

#include "vil2_sobel_1x3.h"
...
#undef VIL2_SOBEL_1X3_INSTANTIATE
#define VIL2_SOBEL_1X3_INSTANTIATE(srcT, destT) \
template void vil2_sobel_1x3(const vil2_image_view< srcT >& src, \
                                   vil2_image_view<destT >& grad_ij); \
template void vil2_sobel_1x3(const vil2_image_view< srcT >& src, \
                                   vil2_image_view<destT >& grad_i, \
                                   vil2_image_view<destT >& grad_j)

#endif // vil2_sobel_1x3_txx_
