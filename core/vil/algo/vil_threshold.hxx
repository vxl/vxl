...
template <class srcT>
void
vil_threshold_above(const vil_image_view<srcT> & src, vil_image_view<bool> & dest, srcT t)
{
...
template <class srcT>
void
vil_threshold_below(const vil_image_view<srcT> & src, vil_image_view<bool> & dest, srcT t)
{
  unsigned ni = src.ni(), nj = src.nj(), np = src.nplanes();
  dest.set_size(ni, nj, np);
...
template <class srcT>
void
vil_threshold_inside(const vil_image_view<srcT> & src, vil_image_view<bool> & dest, srcT t0, srcT t1)
{
  unsigned ni = src.ni(), nj = src.nj(), np = src.nplanes();
  dest.set_size(ni, nj, np);
...
template <class srcT>
void
vil_threshold_outside(const vil_image_view<srcT> & src, vil_image_view<bool> & dest, srcT t0, srcT t1)
{
  unsigned ni = src.ni(), nj = src.nj(), np = src.nplanes();
  dest.set_size(ni, nj, np);
...
#define VIL_THRESHOLD_INSTANTIATE(srcT)                                                                                \
  template void vil_threshold_above(const vil_image_view<srcT> & src, vil_image_view<bool> & dest, srcT t);            \
  template void vil_threshold_below(const vil_image_view<srcT> & src, vil_image_view<bool> & dest, srcT t);            \
  template void vil_threshold_inside(const vil_image_view<srcT> & src, vil_image_view<bool> & dest, srcT t0, srcT t1); \
  template void vil_threshold_outside(const vil_image_view<srcT> & src, vil_image_view<bool> & dest, srcT t0, srcT t1)
