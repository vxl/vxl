// This is core/vil/file_formats/vil_dicom2.h
#ifndef vil_dicom2_file_format_h_
#define vil_dicom2_file_format_h_
#ifdef VCL_NEEDS_PRAGMA_INTERFACE
#pragma interface
#endif
//:
// \file
// \brief Reader/Writer for DICOM2 format 2D images.
...
//: Loader for DICOM2 files
class vil_dicom2_file_format : public vil_file_format
{
 public:
...
class vil_dicom2_image : public vil_image_resource
{
 ...
 public:
  vil_dicom2_image(vil_stream* is, unsigned ni,
                   ...
                   vil_pixel_format format);
  vil_dicom2_image(vil_stream* is);
  ~vil_dicom2_image();
...
#endif // vil_dicom2_file_format_h_
