#ifndef vil2_dicom_header_h_
#define vil2_dicom_header_h_
...
enum vil2_dicom_header_type
{
  VIL2_DICOM_HEADER_DTUNKNOWN=0, /*!< Value for unknown dicom types */
  VIL2_DICOM_HEADER_DTPART10,    /*!< Value for Part10 dicom files */
  VIL2_DICOM_HEADER_DTNON_PART10 /*!< Value for non Part10 dicom files */
};
...
const unsigned VIL2_DICOM_HEADER_MAXHEADERSIZE             =100;

// Define the dicom groups
const vxl_uint_16 VIL2_DICOM_HEADER_COMMANDGROUP             =0x0000;
const vxl_uint_16 VIL2_DICOM_HEADER_METAFILEGROUP            =0x0002;
const vxl_uint_16 VIL2_DICOM_HEADER_BASICDIRGROUP            =0x0004;
const vxl_uint_16 VIL2_DICOM_HEADER_IDENTIFYINGGROUP         =0x0008;
const vxl_uint_16 VIL2_DICOM_HEADER_PATIENTINFOGROUP         =0x0010;
const vxl_uint_16 VIL2_DICOM_HEADER_ACQUISITIONGROUP         =0x0018;
const vxl_uint_16 VIL2_DICOM_HEADER_RELATIONSHIPGROUP        =0x0020;
const vxl_uint_16 VIL2_DICOM_HEADER_IMAGEGROUP               =0x0028;
const vxl_uint_16 VIL2_DICOM_HEADER_STUDYGROUP               =0x0032;
const vxl_uint_16 VIL2_DICOM_HEADER_VISITGROUP               =0x0038;
const vxl_uint_16 VIL2_DICOM_HEADER_WAVEFORMGROUP            =0x003a;
const vxl_uint_16 VIL2_DICOM_HEADER_PROCEDUREGROUP           =0x0040;
const vxl_uint_16 VIL2_DICOM_HEADER_DEVICEGROUP              =0x0050;
const vxl_uint_16 VIL2_DICOM_HEADER_NMIMAGEGROUP             =0x0054;
const vxl_uint_16 VIL2_DICOM_HEADER_MEDIAGROUP               =0x0088;
const vxl_uint_16 VIL2_DICOM_HEADER_BASICFILMSESSIONGROUP    =0x2000;
const vxl_uint_16 VIL2_DICOM_HEADER_BASICFILMBOXGROUP        =0x2010;
const vxl_uint_16 VIL2_DICOM_HEADER_BASICIMAGEBOXGROUP       =0x2020;
const vxl_uint_16 VIL2_DICOM_HEADER_BASICANNOTATIONBOXGROUP  =0x2030;
const vxl_uint_16 VIL2_DICOM_HEADER_BASICIMAGEOVERLAYBOXGROUP=0x2040;
const vxl_uint_16 VIL2_DICOM_HEADER_PRINTJOBGROUP            =0x2100;
const vxl_uint_16 VIL2_DICOM_HEADER_PRINTERGROUP             =0x2110;
const vxl_uint_16 VIL2_DICOM_HEADER_TEXTGROUP                =0x4000;
const vxl_uint_16 VIL2_DICOM_HEADER_RESULTSGROUP             =0x4008;
const vxl_uint_16 VIL2_DICOM_HEADER_CURVEGROUP               =0x5000;
const vxl_uint_16 VIL2_DICOM_HEADER_OVERLAYGROUP             =0x6000;
const vxl_uint_16 VIL2_DICOM_HEADER_PIXELGROUP               =0x7fe0;
const vxl_uint_16 VIL2_DICOM_HEADER_PADGROUP                 =0xfffc;
const vxl_uint_16 VIL2_DICOM_HEADER_DELIMITERGROUP           =0xfffe;

// Useful elements of the Meta File group
const vxl_uint_16 VIL2_DICOM_HEADER_MFGROUPLENGTH            =0x0000;
const vxl_uint_16 VIL2_DICOM_HEADER_MFTRANSFERSYNTAX         =0x0010;

// Useful elements of the Identifying group
const vxl_uint_16 VIL2_DICOM_HEADER_IDGROUPLENGTH            =0x0000; // UL
const vxl_uint_16 VIL2_DICOM_HEADER_IDLENGTHTOEND            =0x0001; // RET
const vxl_uint_16 VIL2_DICOM_HEADER_IDSPECIFICCHARACTER      =0x0005; // CS
const vxl_uint_16 VIL2_DICOM_HEADER_IDIMAGETYPE              =0x0008; // CS
const vxl_uint_16 VIL2_DICOM_HEADER_IDSOPCLASSID             =0x0016; // UI
const vxl_uint_16 VIL2_DICOM_HEADER_IDSOPINSTANCEID          =0x0018; // UI
const vxl_uint_16 VIL2_DICOM_HEADER_IDSTUDYDATE              =0x0020; // DA
const vxl_uint_16 VIL2_DICOM_HEADER_IDSERIESDATE             =0x0021; // DA
const vxl_uint_16 VIL2_DICOM_HEADER_IDACQUISITIONDATE        =0x0022; // DA
const vxl_uint_16 VIL2_DICOM_HEADER_IDIMAGEDATE              =0x0023; // DA
const vxl_uint_16 VIL2_DICOM_HEADER_IDSTUDYTIME              =0x0030; // TM
const vxl_uint_16 VIL2_DICOM_HEADER_IDSERIESTIME             =0x0031; // TM
const vxl_uint_16 VIL2_DICOM_HEADER_IDACQUISITIONTIME        =0x0032; // TM
const vxl_uint_16 VIL2_DICOM_HEADER_IDIMAGETIME              =0x0033; // TM
const vxl_uint_16 VIL2_DICOM_HEADER_IDACCESSIONNUMBER        =0x0050; // SH
const vxl_uint_16 VIL2_DICOM_HEADER_IDMODALITY               =0x0060; // CS
const vxl_uint_16 VIL2_DICOM_HEADER_IDMANUFACTURER           =0x0070; // LO
const vxl_uint_16 VIL2_DICOM_HEADER_IDINSTITUTIONNAME        =0x0080; // LO
const vxl_uint_16 VIL2_DICOM_HEADER_IDINSTITUTIONADDRESS     =0x0081; // ST
const vxl_uint_16 VIL2_DICOM_HEADER_IDREFERRINGPHYSICIAN     =0x0090; // PN
const vxl_uint_16 VIL2_DICOM_HEADER_IDSTATIONNAME            =0x1010; // SH
const vxl_uint_16 VIL2_DICOM_HEADER_IDSTUDYDESCRIPTION       =0x1030; // LO
const vxl_uint_16 VIL2_DICOM_HEADER_IDSERIESDESCRIPTION      =0x103E; // LO
const vxl_uint_16 VIL2_DICOM_HEADER_IDATTENDINGPHYSICIAN     =0x1050; // PN
const vxl_uint_16 VIL2_DICOM_HEADER_IDOPERATORNAME           =0x1070; // PN
const vxl_uint_16 VIL2_DICOM_HEADER_IDMANUFACTURERMODEL      =0x1090; // LO

// Useful elements from the Patient Info group
const vxl_uint_16 VIL2_DICOM_HEADER_PIGROUPLENGTH            =0x0000; // UL
const vxl_uint_16 VIL2_DICOM_HEADER_PIPATIENTNAME            =0x0010; // PN
const vxl_uint_16 VIL2_DICOM_HEADER_PIPATIENTID              =0x0020; // LO
const vxl_uint_16 VIL2_DICOM_HEADER_PIPATIENTBIRTHDATE       =0x0030; // DA
const vxl_uint_16 VIL2_DICOM_HEADER_PIPATIENTSEX             =0x0040; // CS
const vxl_uint_16 VIL2_DICOM_HEADER_PIPATIENTAGE             =0x1010; // AS
const vxl_uint_16 VIL2_DICOM_HEADER_PIPATIENTWEIGHT          =0x1030; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_PIPATIENTHISTORY         =0x21B0; // LT

// Useful elements from the Acquisition group
const vxl_uint_16 VIL2_DICOM_HEADER_AQSCANNINGSEQUENCE       =0x0020; // CS
const vxl_uint_16 VIL2_DICOM_HEADER_AQSEQUENCEVARIANT        =0x0021; // CS
const vxl_uint_16 VIL2_DICOM_HEADER_AQSCANOPTIONS            =0x0022; // CS
const vxl_uint_16 VIL2_DICOM_HEADER_AQMRACQUISITIONTYPE      =0x0023; // CS
const vxl_uint_16 VIL2_DICOM_HEADER_AQSEQUENCENAME           =0x0024; // SH
const vxl_uint_16 VIL2_DICOM_HEADER_AQANGIOFLAG              =0x0025; // CS
const vxl_uint_16 VIL2_DICOM_HEADER_AQSLICETHICKNESS         =0x0050; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_AQREPETITIONTIME         =0x0080; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_AQECHOTIME               =0x0081; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_AQINVERSIONTIME          =0x0082; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_AQNUMBEROFAVERAGES       =0x0083; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_AQECHONUMBERS            =0x0086; // IS
const vxl_uint_16 VIL2_DICOM_HEADER_AQMAGNETICFIELDSTRENGTH  =0x0087; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_AQSLICESPACING           =0x0088; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_AQECHOTRAINLENGTH        =0x0091; // IS
const vxl_uint_16 VIL2_DICOM_HEADER_AQPIXELBANDWIDTH         =0x0095; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_AQSOFTWAREVERSION        =0x1020; // LO
const vxl_uint_16 VIL2_DICOM_HEADER_AQPROTOCOLNAME           =0x1030; // LO
const vxl_uint_16 VIL2_DICOM_HEADER_AQHEARTRATE              =0x1088; // IS
const vxl_uint_16 VIL2_DICOM_HEADER_AQCARDIACNUMBEROFIMAGES  =0x1090; // IS
const vxl_uint_16 VIL2_DICOM_HEADER_AQTRIGGERWINDOW          =0x1094; // IS
const vxl_uint_16 VIL2_DICOM_HEADER_AQRECONTRUCTIONDIAMETER  =0x1100; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_AQRECEIVINGCOIL          =0x1250; // SH
const vxl_uint_16 VIL2_DICOM_HEADER_AQPHASEENCODINGDIRECTION =0x1312; // CS
const vxl_uint_16 VIL2_DICOM_HEADER_AQFLIPANGLE              =0x1314; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_AQSAR                    =0x1316; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_AQPATIENTPOSITION        =0x5100; // CS

// Useful elements from the Relationship group
const vxl_uint_16 VIL2_DICOM_HEADER_RSSTUDYINSTANCEUID       =0x000D; // UI
const vxl_uint_16 VIL2_DICOM_HEADER_RSSERIESINSTANCEUID      =0x000E; // UI
const vxl_uint_16 VIL2_DICOM_HEADER_RSSTUDYID                =0x0010; // SH
const vxl_uint_16 VIL2_DICOM_HEADER_RSSERIESNUMBER           =0x0011; // IS
const vxl_uint_16 VIL2_DICOM_HEADER_RSAQUISITIONNUMBER       =0x0012; // IS
const vxl_uint_16 VIL2_DICOM_HEADER_RSIMAGENUMBER            =0x0013; // IS
const vxl_uint_16 VIL2_DICOM_HEADER_RSPATIENTORIENTATION     =0x0020; // CS
const vxl_uint_16 VIL2_DICOM_HEADER_RSIMAGEPOSITION          =0x0032; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_RSIMAGEORIENTATION       =0x0037; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_RSFRAMEOFREFERENCEUID    =0x0052; // UI
const vxl_uint_16 VIL2_DICOM_HEADER_RSIMAGESINACQUISITION    =0x1002; // IS
const vxl_uint_16 VIL2_DICOM_HEADER_RSPOSITIONREFERENCE      =0x1040; // LO
const vxl_uint_16 VIL2_DICOM_HEADER_RSSLICELOCATION          =0x1041; // DS

// Useful elements from the Image group
const vxl_uint_16 VIL2_DICOM_HEADER_IMSAMPLESPERPIXEL        =0x0002; // US
const vxl_uint_16 VIL2_DICOM_HEADER_IMPHOTOMETRICINTERP      =0x0004; // CS
const vxl_uint_16 VIL2_DICOM_HEADER_IMROWS                   =0x0010; // US
const vxl_uint_16 VIL2_DICOM_HEADER_IMCOLUMNS                =0x0011; // US
const vxl_uint_16 VIL2_DICOM_HEADER_IMPLANES                 =0x0012; // US
const vxl_uint_16 VIL2_DICOM_HEADER_IMPIXELSPACING           =0x0030; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_IMBITSALLOCATED          =0x0100; // US
const vxl_uint_16 VIL2_DICOM_HEADER_IMBITSSTORED             =0x0101; // US
const vxl_uint_16 VIL2_DICOM_HEADER_IMHIGHBIT                =0x0102; // US
const vxl_uint_16 VIL2_DICOM_HEADER_IMPIXELREPRESENTATION    =0x0103; // US
const vxl_uint_16 VIL2_DICOM_HEADER_IMSMALLIMPIXELVALUE      =0x0106; // SS
const vxl_uint_16 VIL2_DICOM_HEADER_IMLARGEIMPIXELVALUE      =0x0107; // SS
const vxl_uint_16 VIL2_DICOM_HEADER_IMPIXELPADDINGVALUE      =0x0120; // SS
const vxl_uint_16 VIL2_DICOM_HEADER_IMWINDOWCENTER           =0x1050; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_IMWINDOWWIDTH            =0x1051; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_IMRESCALEINTERCEPT       =0x1052; // DS
const vxl_uint_16 VIL2_DICOM_HEADER_IMRESCALESLOPE           =0x1053; // DS

// Useful elements from the Pixel group
const vxl_uint_16 VIL2_DICOM_HEADER_PXGROUPLENGTH            =0x0000; // UL
const vxl_uint_16 VIL2_DICOM_HEADER_PXPIXELDATA              =0x0010; // OW

// Tags needed in the Delimeter group
const vxl_uint_16 VIL2_DICOM_HEADER_DLITEM                   =0xe000;
const vxl_uint_16 VIL2_DICOM_HEADER_DLITEMDELIMITATIONITEM   =0xe00d;
const vxl_uint_16 VIL2_DICOM_HEADER_DLSEQDELIMITATIONITEM    =0xe0dd;


// Defines for the Value Representations for Part10 meta header
const char * const VIL2_DICOM_HEADER_APPLICATIONENTRY          ="AE";
const char * const VIL2_DICOM_HEADER_AGESTRING                 ="AS";
const char * const VIL2_DICOM_HEADER_ATTRIBUTETAG              ="AT";
const char * const VIL2_DICOM_HEADER_CODESTRING                ="CS";
const char * const VIL2_DICOM_HEADER_DATE                      ="DA";
const char * const VIL2_DICOM_HEADER_DECIMALSTRING             ="DS";
const char * const VIL2_DICOM_HEADER_DATETIME                  ="DT";
const char * const VIL2_DICOM_HEADER_FLOATINGPOINTDOUBLE       ="FD";
const char * const VIL2_DICOM_HEADER_FLOATINGPOINTSINGLE       ="FL";
const char * const VIL2_DICOM_HEADER_INTEGERSTRING             ="IS";
const char * const VIL2_DICOM_HEADER_LONGSTRING                ="LO";
const char * const VIL2_DICOM_HEADER_LONGTEXT                  ="LT";
const char * const VIL2_DICOM_HEADER_OTHERBYTE                 ="OB";
const char * const VIL2_DICOM_HEADER_OTHERWORD                 ="OW";
const char * const VIL2_DICOM_HEADER_PERSONNAME                ="PN";
const char * const VIL2_DICOM_HEADER_SHORTSTRING               ="SH";
const char * const VIL2_DICOM_HEADER_SIGNEDLONG                ="SL";
const char * const VIL2_DICOM_HEADER_SEQUENCE                  ="SQ";
const char * const VIL2_DICOM_HEADER_SIGNEDSHORT               ="SS";
const char * const VIL2_DICOM_HEADER_SHORTTEXT                 ="ST";
const char * const VIL2_DICOM_HEADER_TIME                      ="TM";
const char * const VIL2_DICOM_HEADER_UNIQUEIDENTIFIER          ="UI";
const char * const VIL2_DICOM_HEADER_UNSIGNEDLONG              ="UL";
const char * const VIL2_DICOM_HEADER_UNKNOWN                   ="UN";
const char * const VIL2_DICOM_HEADER_UNSIGNEDSHORT             ="US";
const char * const VIL2_DICOM_HEADER_UNLIMITEDTEXT             ="UT";

const vxl_uint_32 VIL2_DICOM_HEADER_ALLSET                   = 0xffffffff;

// For determining the endian of the file or the transfer type (JPEG or RLE)
const char * const VIL2_DICOM_HEADER_IMPLICITLITTLE            ="1.2.840.10008.1.2";
const char * const VIL2_DICOM_HEADER_EXPLICITLITTLE            ="1.2.840.10008.1.2.1";
const char * const VIL2_DICOM_HEADER_EXPLICITBIG               ="1.2.840.10008.1.2.2";
const char * const VIL2_DICOM_HEADER_JPEGBASELINE_P1           ="1.2.840.10008.1.2.4.50";
const char * const VIL2_DICOM_HEADER_JPEGDEFLOSSY_P2_4         ="1.2.840.10008.1.2.4.51";
const char * const VIL2_DICOM_HEADER_JPEGEXTENDED_P3_5         ="1.2.840.10008.1.2.4.52";
const char * const VIL2_DICOM_HEADER_JPEGSPECTRAL_P6_8         ="1.2.840.10008.1.2.4.53";
const char * const VIL2_DICOM_HEADER_JPEGSPECTRAL_P7_9         ="1.2.840.10008.1.2.4.54";
const char * const VIL2_DICOM_HEADER_JPEGFULLPROG_P10_12       ="1.2.840.10008.1.2.4.55";
const char * const VIL2_DICOM_HEADER_JPEGFULLPROG_P11_13       ="1.2.840.10008.1.2.4.56";
const char * const VIL2_DICOM_HEADER_JPEGLOSSLESS_P14          ="1.2.840.10008.1.2.4.57";
const char * const VIL2_DICOM_HEADER_JPEGLOSSLESS_P15          ="1.2.840.10008.1.2.4.58";
const char * const VIL2_DICOM_HEADER_JPEGEXTHIER_P16_18        ="1.2.840.10008.1.2.4.59";
const char * const VIL2_DICOM_HEADER_JPEGEXTHIER_P17_19        ="1.2.840.10008.1.2.4.60";
const char * const VIL2_DICOM_HEADER_JPEGSPECHIER_P20_22       ="1.2.840.10008.1.2.4.61";
const char * const VIL2_DICOM_HEADER_JPEGSPECHIER_P21_23       ="1.2.840.10008.1.2.4.62";
const char * const VIL2_DICOM_HEADER_JPEGFULLHIER_P24_26       ="1.2.840.10008.1.2.4.63";
const char * const VIL2_DICOM_HEADER_JPEGFULLHIER_P25_27       ="1.2.840.10008.1.2.4.64";
const char * const VIL2_DICOM_HEADER_JPEGLLESSHIER_P28         ="1.2.840.10008.1.2.4.65";
const char * const VIL2_DICOM_HEADER_JPEGLLESSHIER_P29         ="1.2.840.10008.1.2.4.66";
const char * const VIL2_DICOM_HEADER_JPEGLLESSDEF_P14_SV1      ="1.2.840.10008.1.2.4.70";
const char * const VIL2_DICOM_HEADER_RLELOSSLESS               ="1.2.840.10008.1.2.5";
...
const float VIL2_DICOM_HEADER_DEFAULTINTERCEPT = 0.0;
const float VIL2_DICOM_HEADER_DEFAULTSLOPE = 1.0;
...
class vil2_dicom_header_format
{
 public:
  ...
  bool isDicomFormat(vil2_stream &);
...
//  \return The system endian for the architecture running the application
  ...
  vil2_dicom_header_endian fileEndian(void);
 ...
 private:
  ...
  vil2_dicom_header_type determineFileType(vil2_stream &fs);
  ...
  vil2_dicom_header_endian calculateEndian(void);
  ...
  vil2_dicom_header_endian determineMetaInfo(vil2_stream &fs);
 ...
 private:
  ...
  vil2_dicom_header_info last_read_;
