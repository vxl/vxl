...
vil_dicom_stream_producer::vil_dicom_stream_producer(vil_stream * in_vs)
  : vs_(in_vs)
{
  vs_->ref();
}
...
OFBool
vil_dicom_stream_producer::good() const
{
  return vs_->ok();
}
...
OFCondition
vil_dicom_stream_producer::status() const
{
...
vil_dicom_stream_factory::vil_dicom_stream_factory(vil_stream * in_vs)
  : vs_(in_vs)
{
  vs_->ref();
}
...
DcmInputStream *
vil_dicom_stream_factory::create() const
{
...
vil_dicom_stream_input::vil_dicom_stream_input(vil_stream * vs)
...
vil_dicom_stream_input::newFactory() const
{
  return 0;
}
