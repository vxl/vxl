...
public:
  ...
  virtual vil_image_resource_sptr make_output_image(vil_stream* vs, unsigned int ni, unsigned int nj,
                                                    unsigned int planes, vil_pixel_format format);
...
public:
  ...
  vil_iris_generic_image(vil_stream* is, unsigned int ni, unsigned int nj, unsigned int planes,
...
protected:
  ...
  vil_image_view_base_sptr get_section_verbatim( unsigned int x0, unsigned int ni, unsigned int y0,
                                                 unsigned int nj) const;
