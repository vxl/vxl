...
public:
  ...
  virtual
  vil_image_resource_sptr make_output_image(vil_stream* vs, unsigned ni, unsigned nj, unsigned nplanes,
...
public:
  ...
  vil_j2k_image( vil_stream* vs, unsigned ni, unsigned nj, unsigned nplanes, enum vil_pixel_format format,
  ...
  virtual vil_image_view_base_sptr get_copy_view_decimated(unsigned i0, unsigned ni, unsigned j0, unsigned nj,
                                                           double i_factor, double j_factor) const;

  virtual vil_image_view_base_sptr get_copy_view_decimated_by_size(unsigned i0, unsigned ni, unsigned j0, unsigned nj,
  ...
  static vil_image_view_base_sptr s_decode_jpeg_2000_by_size( vil_stream* vs, unsigned i0, unsigned ni, unsigned j0,
                                                              unsigned nj, unsigned int output_width,
  ...
  static bool s_encode_jpeg2000(vil_stream* vs, const char* out_filename, unsigned compression_ratio = 1,
                                unsigned num_lines_block = 1024, bool verbose = false);

  // : encode an entire image by loading the input resource from file
  //  Uses the stream-based method of the same name
  static bool s_encode_jpeg2000(const char* in_filename, const char* out_filename, unsigned compression_ratio = 1,
                                unsigned num_lines_block = 1024, bool verbose = false);
