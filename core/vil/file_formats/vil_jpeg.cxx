                                                       ...
                                                       unsigned ny) const
{
  ...
  return new vil_image_view<vxl_byte>(chunk, reinterpret_cast<vxl_byte *>(chunk->data() ), nx, ny, bpp, bpp, bpp * nx,
                                      1);
}
                              ...
                              unsigned x0, unsigned y0)
{
  ...
  if( (view2.planestep() == 1 || view2.nplanes() == 1) && view2.istep() == jc->jobj.input_components )
    ...
    vil_image_view<vxl_byte> line = vil_image_view<vxl_byte>(chunk,
                                                             ...
                                                             view2.ni(), 1, view2.nplanes(), view2.nplanes(),
                                                             view2.nplanes() * view2.ni(), 1);
