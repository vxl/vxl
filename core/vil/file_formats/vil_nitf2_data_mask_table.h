...
{
public:
  vil_nitf2_data_mask_table( unsigned int numBlocksX, unsigned int numBlocksY, unsigned int numBands,
  ...
  // :
  // band argument is ignored if imode != "S"... i.e. all bands have the same pad pixel in that case
