...
vil_nitf2_field_definitions *
vil_nitf2_des::create_field_definitions(vil_nitf2_classification::file_version ver, int data_width)
{
...
void
vil_nitf2_des::add_shared_field_defs_1(vil_nitf2_field_definitions * defs)
{
  (*defs)
    .field("DE", "Data Extension Subheader", NITF_ENUM(2, vil_nitf2_enum_values().value("DE")), false, nullptr, nullptr)
    .field("DESID", "Unique DES Type Identifier", NITF_STR(25), false, nullptr, nullptr)
    .field("DESVER", "Version of the Data Definition", NITF_INT(2, false), false, nullptr, nullptr);
}

void
vil_nitf2_des::add_shared_field_defs_2(vil_nitf2_field_definitions * defs, int data_width)
{
...
{
  if (m_field_sequence1)
    delete m_field_sequence1;
  if (m_field_sequence2)
    delete m_field_sequence2;
}
