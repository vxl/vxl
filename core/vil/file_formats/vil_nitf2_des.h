...
protected:
  ...
  static field_definition_map &
  all_definitions();

  static void
  add_shared_field_defs_1(vil_nitf2_field_definitions * defs);
  static void
  add_shared_field_defs_2(vil_nitf2_field_definitions * defs, int data_width);
  static vil_nitf2_field_definitions *
  create_field_definitions(vil_nitf2_classification::file_version ver, int data_width);
