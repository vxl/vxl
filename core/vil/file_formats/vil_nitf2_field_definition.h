...
public:
  ...
  vil_nitf2_field_definition(
    ...
    vcl_string units = "", vcl_string description = "");
...
public:
  ...
  vil_nitf2_field_definitions & field(vcl_string tag, vcl_string pretty_name, vil_nitf2_field_formatter* formatter,
                                      ...
                                      vil_nitf2_field_functor<bool>* condition_functor = 0, vcl_string units = "",
                                      vcl_string description = "");
