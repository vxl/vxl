...
public:
  virtual bool
  operator()(vil_nitf2_field_sequence * record, const vil_nitf2_index_vector & indexes, T & out_value) = 0;
  virtual ~vil_nitf2_field_functor() = default;

  // Virtual copy method
  virtual vil_nitf2_field_functor<T> *
  copy() const = 0;
};
