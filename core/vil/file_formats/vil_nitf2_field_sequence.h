...
public:
  ...
  bool get_value(vcl_string tag, const vil_nitf2_index_vector& indexes, int& out_value,
                 bool ignore_extra_indexes = false) const;

  bool get_value(vcl_string tag, const vil_nitf2_index_vector& indexes, double& out_value,
                 bool ignore_extra_indexes = false) const;

  bool get_value(vcl_string tag, const vil_nitf2_index_vector& indexes, char& out_value,
                 bool ignore_extra_indexes = false) const;

  bool get_value(vcl_string tag, const vil_nitf2_index_vector& indexes, void *& out_value,
                 bool ignore_extra_indexes = false) const;

  bool get_value(vcl_string tag, const vil_nitf2_index_vector& indexes, vcl_string& out_value,
                 bool ignore_extra_indexes = false) const;

  bool get_value(vcl_string tag, const vil_nitf2_index_vector& indexes, vil_nitf2_location *& out_value,
                 bool ignore_extra_indexes = false) const;

  bool get_value(vcl_string tag, const vil_nitf2_index_vector& indexes, vil_nitf2_date_time& out_value,
                 bool ignore_extra_indexes = false) const;

#if VXL_HAS_INT_64
  bool get_value(vcl_string tag, const vil_nitf2_index_vector& indexes, vil_nitf2_long& out_value,
                 bool ignore_extra_indexes = false) const;
  ...
  bool read(vil_nitf2_istream& input, const vil_nitf2_field_definitions* field_defs = 0,
  ...
  virtual bool write(vil_nitf2_ostream &, const vil_nitf2_field_definitions* field_defs = 0,
                     vil_nitf2_index_vector indexes = vil_nitf2_index_vector() );
  ...
  void set_array_fields_dimension(const vil_nitf2_field_definitions* field_defs, const vil_nitf2_index_vector& index,
                                  int repeat_count);
