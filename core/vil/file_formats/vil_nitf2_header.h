...
public:
  ...
  static std::string
  section_num_tag(section_type sec);
  static std::string
  section_len_header_tag(section_type sec);
  static std::string
  section_len_data_tag(section_type sec);
  ...
  {
    if (m_field_sequence_classification && m_field_sequence_classification->get_value(tag, out_value))
      return true;
    else if (m_field_sequence2 && m_field_sequence2->get_value(tag, out_value))
      return true;
    else
      return m_field_sequence1.get_value(tag, out_value);
  }
  ...
  {
    if (m_field_sequence_classification && m_field_sequence_classification->get_value(tag, i, out_value))
      return true;
    else if (m_field_sequence2 && m_field_sequence2->get_value(tag, i, out_value))
      return true;
    else
      return m_field_sequence1.get_value(tag, i, out_value);
  }
