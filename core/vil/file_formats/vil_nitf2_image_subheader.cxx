...
bool vil_nitf2_image_subheader::get_date_time(int& year, int& month, int& day, int& hour, int& min)
{
...
bool vil_nitf2_image_subheader::get_date_time(int& year, int& month, int& day, int& hour, int& min, int& sec)
{
  vcl_string date_time = "";
  bool       success = this->get_property("IDATIM", date_time);
...
bool vil_nitf2_image_subheader::get_sun_params( double& sun_el, double& sun_az)
{
...
void vil_nitf2_image_subheader::add_ICHIPB_definitions()
{
  ...
  if( !tr )
    ...
    .field("OP_COL_11", "Output product column number component of grid point index (1,1)", NITF_DBL(12, 3,
                                                                                                     false), false)

    .field("OP_ROW_12", "Output product row number component of grid point index (1,2)", NITF_DBL(12, 3, false), false)
    .field("OP_COL_12", "Output product column number component of grid point index (1,2)", NITF_DBL(12, 3,
                                                                                                     false), false)

    .field("OP_ROW_21", "Output product row number component of grid point index (2,1)", NITF_DBL(12, 3, false), false)
    .field("OP_COL_21", "Output product column number component of grid point index (2,1)", NITF_DBL(12, 3,
                                                                                                     false), false)

    .field("OP_ROW_22", "Output product row number component of grid point index (2,2)", NITF_DBL(12, 3, false), false)
    .field("OP_COL_22", "Output product column number component of grid point index (2,2)", NITF_DBL(12, 3,
                                                                                                     false), false)
    ...
    .field("FI_COL_11", "Output product column number component of grid point index (1,1)", NITF_DBL(12, 3,
                                                                                                     false), false)

    .field("FI_ROW_12", "Output product row number component of grid point index (1,2)", NITF_DBL(12, 3, false), false)
    .field("FI_COL_12", "Output product column number component of grid point index (1,2)", NITF_DBL(12, 3,
                                                                                                     false), false)

    .field("FI_ROW_21", "Output product row number component of grid point index (2,1)", NITF_DBL(12, 3, false), false)
    .field("FI_COL_21", "Output product column number component of grid point index (2,1)", NITF_DBL(12, 3,
                                                                                                     false), false)

    .field("FI_ROW_22", "Output product row number component of grid point index (2,2)", NITF_DBL(12, 3, false), false)
    .field("FI_COL_22", "Output product column number component of grid point index (2,2)", NITF_DBL(12, 3,
                                                                                                     false), false)
...
bool vil_nitf2_image_subheader::get_correction_offset(double & u_off, double & v_off)
{
  // Now get the sub-header TRE parameters
  vil_nitf2_tagged_record_sequence           isxhd_tres;
  vil_nitf2_tagged_record_sequence::iterator tres_itr;
...
bool vil_nitf2_image_subheader::get_rpc_params( vcl_string& rpc_type, vcl_string& image_id,
