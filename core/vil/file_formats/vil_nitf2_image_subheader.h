...
public:
  ...
  bool get_rpc_params( vcl_string& rpc_type, vcl_string& image_id, vcl_string& image_corner_geo_locations,
                       double* rpc_data );
...
private:
  ...
  static void add_geo_field_defs( vil_nitf2_field_definitions* defs,
