...
bool
vil_nitf2_tagged_record_definition::undefine(const std::string & name)
{
...
vil_nitf2_tagged_record_definition *
vil_nitf2_tagged_record_definition::find(const std::string & name)
{
  auto definition = all_definitions().find(name);
  if (definition == all_definitions().end())
    return nullptr;
...
void
vil_nitf2_tagged_record_definition::register_test_tre()
{
