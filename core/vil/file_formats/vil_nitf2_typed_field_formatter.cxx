...
bool vil_nitf2_long_long_formatter::read_vcl_stream(vcl_istream& input, vil_nitf2_long& out_value, bool& out_blank)
{
  char* cstr;
...
vil_nitf2_enum_string_formatter::vil_nitf2_enum_string_formatter(int field_width,
                                                                 const vil_nitf2_enum_values& value_map)
...
bool vil_nitf2_tagged_record_sequence_formatter::read( vil_nitf2_istream& input,
...
bool vil_nitf2_tagged_record_sequence_formatter::write(vil_nitf2_ostream & /*output*/,
                                                       vil_nitf2_tagged_record_sequence & /*value*/ )
{
  return false;
}
