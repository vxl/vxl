...
bool
vil_nitf2_date_time_formatter::read_vcl_stream(std::istream & input, vil_nitf2_date_time & out_value, bool & out_blank)
{
  return out_value.read(input, field_width, out_blank);
}

bool
vil_nitf2_date_time_formatter::write_vcl_stream(std::ostream & output, const vil_nitf2_date_time & value)
{
...
bool
vil_nitf2_location_formatter::write_vcl_stream(std::ostream & output, vil_nitf2_location * const & value)
{
  return value->write(output, field_width);
}
...
bool
vil_nitf2_integer_formatter::write_vcl_stream(std::ostream & output, const int & value)
{
...
vil_nitf2_long_long_formatter::vil_nitf2_long_long_formatter(int field_width, bool show_sign)
...
bool
vil_nitf2_long_long_formatter::write_vcl_stream(std::ostream & output, const vil_nitf2_long & value)
{
  output << std::setw(field_width) << std::right << std::setfill('0');
  if (show_sign)
  {
...
vil_nitf2_double_formatter::vil_nitf2_double_formatter(int field_width, int precision, bool show_sign)
...
bool
vil_nitf2_double_formatter::write_vcl_stream(std::ostream & output, const double & value)
{
  ...
  output << std::internal << std::setfill('0') << std::setprecision(precision) << value;
  return !output.fail();
}
...
vil_nitf2_exponential_formatter::vil_nitf2_exponential_formatter(int mantissa_width, int exponent_width)
  : vil_nitf2_typed_field_formatter<double>(vil_nitf2::type_double, mantissa_width + exponent_width + 5)
  , mantissa_width(mantissa_width)
  , exponent_width(exponent_width)
{}

vil_nitf2_field_formatter *
vil_nitf2_exponential_formatter::copy() const
{
...
bool
vil_nitf2_exponential_formatter::write_vcl_stream(std::ostream & output, const double & value)
{
...
bool
vil_nitf2_binary_formatter::read(vil_stream & input, void *& out_value, bool & out_blank)
{
...
bool
vil_nitf2_binary_formatter::write(vil_nitf2_ostream & output, void * const & value)
{
...
bool
vil_nitf2_char_formatter::read_vcl_stream(std::istream & input, char & out_value, bool & out_blank)
{
  input.get(out_value);
...
bool
vil_nitf2_char_formatter::write_vcl_stream(std::ostream & output, const char & value)
{
  output << value;
  return !output.fail();
}
...
vil_nitf2_string_formatter::vil_nitf2_string_formatter(int field_width, enum_char_set char_set)
...
bool
vil_nitf2_string_formatter::write_vcl_stream(std::ostream & output, const std::string & value)
{
...
vil_nitf2_enum_string_formatter::vil_nitf2_enum_string_formatter(int field_width, vil_nitf2_enum_values value_map)
  : vil_nitf2_string_formatter(field_width)
...
void
vil_nitf2_enum_string_formatter::validate_value_map()
{
...
bool
vil_nitf2_enum_string_formatter::is_valid_value(const std::string & token) const
{
...
vil_nitf2_enum_values::value(std::string token, std::string pretty_name)
{
  ...
  {
    std::cerr << "vil_nitf2_enum_values: WARNING: Ignoring definition " << token
...
vil_nitf2_tagged_record_sequence_formatter::vil_nitf2_tagged_record_sequence_formatter()
  : vil_nitf2_typed_field_formatter<vil_nitf2_tagged_record_sequence>(vil_nitf2::type_tagged_record_sequence,
                                                                      1 /* ignored */)
{}
                                                 ...
                                                 bool & out_blank)
{
  ...
  if (input.tell() != end)
  { // TO DO: what does end equal at EOF?
...
bool
vil_nitf2_tagged_record_sequence_formatter::write(vil_nitf2_ostream & /*output*/,
                                                  const vil_nitf2_tagged_record_sequence & /*value*/)
{
  return false;
}
