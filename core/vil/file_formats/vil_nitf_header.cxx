...
//
// $Revision: 1.1 $ $Date: 2003/12/26 00:20:06 $
// $Author: mlaymon $
//
// Description:	Implementation of headers included in an NITFS message.
...
//#include <IUCameras/RationalCamera.h>
...
vil_nitf_header::~vil_nitf_header()
{
    ...
    // COMMENT OUT UNTIL I DECIDE WHAT TO DO ABOUT NITFVersion
//    if (version_) version_->unref();
   // Version objects are singletons.  They should not be deleted.
    //if (version_) delete version_ ;
}
