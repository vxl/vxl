...
//
//  Base class for all image subheaders.  Extracted from NITFHeader.h from
//  TargetJr.
//
//  $Revision: 1.1 $ 
//  $Date: 2003/12/26 00:20:40 $
//  $Author: mlaymon $
//
...
public:
  ...
  //       UTMN, UTMS and DECIMAL_DEG are valid only for version 2.1
      ...
      char*  IGEOLO ;  //:< String of length 60 containing rough coordinates of four corners of image in order (0,0), (0, maxCol), (maxRow, maxCol), (maxRow, 0).  Order should be upper left, upper right, lower right, lower left.
