...
//     an NITF message.  Extracted from NITFHeader.h
//
...
class vil_nitf_message_header : public vil_nitf_header
{
    public:
      ...
      // apply to version 2.0 and above
         ...
         int    NUMS ;                   // Number of symbol segments.  NOTE: reference to NUMS in NITF spec talks about graphic segments, not symbol segments. 
