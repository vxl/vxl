...
public:
  ...
  vil_image_resource_sptr make_output_image(vil_stream* vs, unsigned int ni, unsigned int nj, unsigned int nplanes,
...
{
public:
  vil_openjpeg_image(vil_stream* is, unsigned int ni, unsigned int nj, unsigned int nplanes, vil_pixel_format format,
  ...
  virtual vil_image_view_base_sptr get_copy_view(unsigned int i0, unsigned int ni, unsigned int j0,
  ...
  virtual vil_image_view_base_sptr get_copy_view_reduced(unsigned i0, unsigned ni, unsigned j0, unsigned nj,
                                                         unsigned reduction) const;

  virtual bool put_view(const vil_image_view_base& im, unsigned int i0, unsigned int j0);
...
private:
  ...
  vil_image_view_base_sptr opj2vil(void * opj_view, unsigned int i0, unsigned int ni, unsigned int j0,
                                   unsigned int nji) const;
