...
//Find an appropriate filename extension for the image. If the size of 
//the image lies between existing scales then use 
...
//:This method copies the resource into the pyramid.  Use add_resource
// if the existing resource is to be just inserted into the level stack.
