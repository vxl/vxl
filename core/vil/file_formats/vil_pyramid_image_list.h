...
public:
  ...
  virtual vil_pyramid_image_resource_sptr make_pyramid_image_from_base(char const* directory,
...
public:
  ...
  virtual vil_image_view_base_sptr get_copy_view(unsigned int i0, unsigned int n_i, unsigned int j0, unsigned int n_j,
  ...
  vil_image_view_base_sptr get_copy_view(unsigned int i0, unsigned int n_i, unsigned int j0, unsigned int n_j,
