// This is core/vil2/tests/test_algo_fft.cxx
...
MAIN( test_algo_fft )
{
  ...
  vil2_image_view<vcl_complex<double> > img0 (4, 8, 2);
  ...
  // copy image
  vil2_image_view<vcl_complex<double> > img1;
  img1.deep_copy (img0);

  // FFT and inverse FFT
  vil2_fft_2d_fwd (img1);
  vil2_fft_2d_bwd (img1);

  // make sure original image is recovered
  double d = vil2_math_ssd_complex (img0, img1, double());
