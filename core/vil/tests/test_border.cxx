...
test_border_constant_byte()
{
  ...
  const vil_border<vil_image_view<vxl_byte>> border = vil_border_create_constant(im, 13);
  const vil_border_accessor<vil_image_view<vxl_byte>> accessor = vil_border_create_accessor(im, border);
...
test_border_constant_hsv()
{
  ...
  const vil_border<vil_image_view<float>> border = vil_border_create_constant(im, 13.3f);
  const vil_border_accessor<vil_image_view<float>> accessor = vil_border_create_accessor(im, border);
...
test_border_geodesic()
{
  ...
  const vil_border_accessor<vil_image_view<vxl_byte>> accessor =
    vil_border_create_accessor(im, vil_border_create_geodesic(im));
...
test_border_reflect()
{
  ...
  const vil_border_accessor<vil_image_view<vxl_byte>> accessor =
    vil_border_create_accessor(im, vil_border_create_reflect(im));
...
test_border_periodic()
{
  ...
  const vil_border_accessor<vil_image_view<vxl_byte>> accessor =
    vil_border_create_accessor(im, vil_border_create_periodic(im));
