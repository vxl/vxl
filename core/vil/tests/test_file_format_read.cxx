...
struct Compare
  {
  virtual ~Compare() {}
  virtual bool operator()( vil_image_view<ImgPixelType> const &, int p, int i, int j,
...
test_file_format_read( int argc, char* argv[] )
{
  ...
  TEST("16-bit pgm ascii", CheckFile(
         CompareGrey<vxl_uint_16>(), "ff_grey16bit_true.txt", "ff_grey16bit_ascii.pgm" ), true);
  ...
  TEST("8-bit ppm ascii as planar",
       CheckFile(ComparePlanes<vxl_byte, 3>(), "ff_planar8bit_true.txt", "ff_rgb8bit_ascii.ppm" ), true);
  TEST("8-bit ppm raw", CheckFile(CompareRGB<vxl_byte>(), "ff_rgb8bit_true.txt", "ff_rgb8bit_raw.ppm" ), true);
  TEST("8-bit ppm raw as planar", CheckFile(ComparePlanes<vxl_byte,
                                                          3>(), "ff_planar8bit_true.txt", "ff_rgb8bit_raw.ppm" ), true);
  TEST("16-bit ppm ascii", CheckFile(CompareRGB<vxl_uint_16>(), "ff_rgb16bit_true.txt", "ff_rgb16bit_ascii.ppm" ),
       true);
  ...
  TEST("8-bit grey, normal image to 4 quanta",
       CheckFile(CompareGreyNear<vxl_byte>(4), "ff_grey8bit_true.txt", "ff_grey8bit_compressed.jpg" ), true);
  TEST("8-bit RGB, easy image accurate to 3 quanta",
       CheckFile(CompareRGBNear<vxl_byte>(3), "ff_rgb8biteasy_true.txt", "ff_rgb8biteasy_compressed.jpg" ), true);

  vcl_cout << "Windows bitmap [bmp]\n";
  TEST("8-bit greyscale (xv created)", CheckFile(
         CompareGrey<vxl_byte>(), "ff_grey8bit_true.txt", "ff_grey8bit.bmp" ), true);
  // TEST("8-bit GA uncompressed", CheckFile(CompareGreyAlpha<vxl_byte>(), "ff_ga8bit_true.txt", "ff_ga8bit.bmp" ), true);
  TEST("8-bit RGB (xv created)", CheckFile(ComparePlanes<vxl_byte,
                                                         3>(), "ff_planar8bit_true.txt", "ff_rgb8bit_xv.bmp" ), true);
  TEST("8-bit RGB (Top-down scans, Photoshop created)",
       CheckFile(ComparePlanes<vxl_byte, 3>(), "ff_planar8bit_true.txt", "ff_rgb8bit_topdown_ps.bmp" ), true);
  TEST("8-bit RGBA uncompressed (Photoshop created)",
       CheckFile(CompareRGBA<vxl_byte>(), "ff_rgba8bit_true.txt", "ff_rgba8bit_uncompressed_ps.bmp" ), true);
  ...
  TEST("8-bit RGB uncompressed", CheckFile(
         CompareRGB<vxl_byte>(), "ff_rgb8bit_true.txt", "ff_rgb8bit_uncompressed.png" ), true);
  TEST("8-bit RGB compressed", CheckFile(
         CompareRGB<vxl_byte>(), "ff_rgb8bit_true.txt", "ff_rgb8bit_compressed.png" ), true);
  TEST("8-bit RGB Indexed",    CheckFile(
         CompareRGB<vxl_byte>(), "ff_rgb8bit_true.txt", "ff_rgb8bit_indexed_4bpp.png" ), true);
  TEST("8-bit GA compressed", CheckFile(
         CompareGreyAlpha<vxl_byte>(), "ff_ga8bit_true.txt", "ff_ga8bit_compressed.png" ), true);
  TEST("10-bit grey with bitdepth=true (from labview)",
       CheckFile(CompareGrey<vxl_uint_16>(), "ff_grey10bit_true.txt", "ff_grey10bit_labview_bitdepth_true.png" ), true);
  ...
  TEST("16-bit grey with bitdepth=true (from labview)",
       CheckFile(CompareGrey<vxl_uint_16>(), "ff_grey16bit_true.txt", "ff_grey16bit_labview_bitdepth_true.png" ), true);
  ...
  TEST("8-bit RGB uncompressed", CheckFile(
         CompareRGB<vxl_byte>(), "ff_rgb8bit_true.txt", "ff_rgb8bit_uncompressed.tif" ), true);

  TEST("8-bit RGB packbits", CheckFile(CompareRGB<vxl_byte>(), "ff_rgb8bit_true.txt", "ff_rgb8bit_packbits.tif" ),
       true);
  ...
  TEST("8-bit RGBA uncompressed",
       CheckFile(CompareRGBA<vxl_byte>(), "ff_rgba8bit_true.txt", "ff_rgba8bit_uncompressed.tif" ), true);
  TEST("8-bit RGBA without RowsPerStrip",
       CheckFile(CompareRGBA<vxl_byte>(), "no_rowsperstrip_true.txt", "no_rowsperstrip.tif" ), true);
  TEST("8-bit GA uncompressed",
       CheckFile(CompareGreyAlpha<vxl_byte>(), "ff_ga8bit_true.txt", "ff_ga8bit_uncompressed.tif" ), true);
  ...
  TEST("8-bit unsigned int (IMODE=P)",
       CheckFile(ComparePlanes<vxl_byte, 3>(), "ff_nitf_8bit_true.txt", "ff_nitf_8bit_p.nitf" ), true);
  TEST("8-bit unsigned int (IMODE=B)",
       CheckFile(ComparePlanes<vxl_byte, 3>(), "ff_nitf_8bit_true.txt", "ff_nitf_8bit_b.nitf" ), true);
  TEST("8-bit unsigned int (IMODE=R)",
       CheckFile(ComparePlanes<vxl_byte, 3>(), "ff_nitf_8bit_true.txt", "ff_nitf_8bit_r.nitf" ), true);
  TEST("8-bit unsigned int (IMODE=S)",
       CheckFile(ComparePlanes<vxl_byte, 3>(), "ff_nitf_8bit_true.txt", "ff_nitf_8bit_s.nitf" ), true);
  TEST("16-bit unsigned int (ABPP=13)",
       CheckFile(CompareGrey<vxl_uint_16>(), "ff_nitf_16bit_true.txt", "ff_nitf_16bit.nitf" ), true);
  vcl_cout << "NITF 2.0 [nitf] (uncompressed)\n";
  TEST("32-bit signed int", CheckFile(CompareGrey<vxl_int_32>(), "ff_nitf_32bit_true.txt", "ff_nitf_32bit.nitf" ),
       true);
  TEST("32-bit float", CheckFile(CompareGreyFloat<float>(), "ff_nitf_float_true.txt", "ff_nitf_float.nitf" ), true);
  TEST("64-bit float (double)", CheckFile(
         CompareGreyFloat<double>(), "ff_nitf_float_true.txt", "ff_nitf_double.nitf" ), true);
  vcl_cout << "NSIF 1.0 [nitf] (uncompressed)\n";
  TEST("1-bit bool (NSIF w/ LUT to parse)",
       CheckFile(CompareGrey<bool>(), "ff_nitf_1bit_lut_true.txt", "ff_nitf_1bit_lut.nsif" ), true);
  ...
  TEST("8-bit grey, no colourmap", CheckFile(
         CompareGrey<vxl_byte>(), "ff_grey8bit_true.txt", "ff_grey8bit_nocol.ras" ), true);
  TEST("8-bit RGB, no colourmap", CheckFile(CompareRGB<vxl_byte>(), "ff_rgb8bit_true.txt", "ff_rgb8bit_raw.ras" ),
       true);
  ...
  TEST("8-bit grey big endian",
       CheckFile(CompareGrey<vxl_uint_8>(), "ff_grey8bit_true.txt", "ff_grey8bit_bigendian.viff" ), true);
  TEST("8-bit RGB big endian",
       CheckFile(ComparePlanes<vxl_uint_8, 3>(), "ff_planar8bit_true.txt", "ff_rgb8bit_bigendian.viff" ), true);
  TEST("16-bit grey big endian",
       CheckFile(CompareGrey<vxl_uint_16>(), "ff_grey16bit_true.txt", "ff_grey16bit_bigendian.viff" ), true);
  TEST("16-bit RGB big endian",
       CheckFile(ComparePlanes<vxl_uint_16, 3>(), "ff_planar16bit_true.txt", "ff_rgb16bit_bigendian.viff" ), true);
  TEST("32-bit grey big endian",
       CheckFile(CompareGrey<vxl_uint_32>(), "ff_grey32bit_true.txt", "ff_grey32bit_bigendian.viff" ), true);
  TEST("32-bit float grey big endian",
       CheckFile(CompareGreyFloat<float>(), "ff_grey_float_true.txt", "ff_grey_float_bigendian.viff" ), true);
  TEST("64-bit float grey big endian",
       CheckFile(CompareGreyFloat<double>(), "ff_grey_float_true.txt", "ff_grey_double_bigendian.viff" ), true);

  TEST("8-bit grey little endian",
       CheckFile(CompareGrey<vxl_uint_8>(), "ff_grey8bit_true.txt", "ff_grey8bit_littleendian.viff" ), true);
  TEST("8-bit RGB little endian",
       CheckFile(ComparePlanes<vxl_uint_8, 3>(), "ff_planar8bit_true.txt", "ff_rgb8bit_littleendian.viff" ), true);
  TEST("16-bit grey little endian",
       CheckFile(CompareGrey<vxl_uint_16>(), "ff_grey16bit_true.txt", "ff_grey16bit_littleendian.viff" ), true);
  TEST("16-bit RGB little endian",
       CheckFile(ComparePlanes<vxl_uint_16, 3>(), "ff_planar16bit_true.txt", "ff_rgb16bit_littleendian.viff" ), true);
  TEST("32-bit grey little endian",
       CheckFile(CompareGrey<vxl_uint_32>(), "ff_grey32bit_true.txt", "ff_grey32bit_littleendian.viff" ), true);
  TEST("32-bit float grey little endian",
       CheckFile(CompareGreyFloat<float>(), "ff_grey_float_true.txt", "ff_grey_float_littleendian.viff" ), true);
  TEST("64-bit float grey little endian",
       CheckFile(CompareGreyFloat<double>(), "ff_grey_float_true.txt", "ff_grey_double_littleendian.viff" ), true);
  ...
  TEST("16-bit greyscale uncompressed",
       CheckFile(CompareGrey<vxl_uint_16>(), "ff_grey16bit_true_for_dicom.txt", "ff_grey16bit_uncompressed.dcm"), true);
  // These only pass if the DCMTK-based DICOM loader is available
  TEST("16-bit greyscale uncompressed 2",
       CheckFile(CompareGrey<vxl_uint_16>(), "ff_grey16bit_true.txt", "ff_grey16bit_uncompressed2.dcm" ), true);
  TEST("8-bit greyscale uncompressed",
       CheckFile(CompareGrey<vxl_uint_8>(), "ff_grey8bit_true.txt", "ff_grey8bit_uncompressed.dcm" ), true);
  TEST("8-bit greyscale uncompressed 2",
       CheckFile(CompareGrey<vxl_uint_8>(), "ff_grey8bit_true.txt", "ff_grey8bit_uncompressed2.dcm" ), true);
  TEST("16-bit greyscale uncompressed 3",
       CheckFile(CompareGrey<vxl_uint_16>(), "ff_grey16bit_true.txt", "ff_grey16bit_uncompressed3.dcm" ), true);
  TEST("12-bit greyscale float uncompressed",
       CheckFile(
         CompareGreyFloat<float>(), "ff_grey_float_true_for_dicom.txt", "ff_grey_float_12bit_uncompressed.dcm" ), true);
#endif // HAS_DCMTK
}
