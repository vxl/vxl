// This is core/vil2/tests/test_greyscale_dilate.cxx
...
void test_greyscale_dilate_byte()
{
  vcl_cout << "*******************************\n"
           << " Testing vil2_greyscale_dilate\n"
           << "*******************************\n";
  ...
  vil2_greyscale_dilate(image0,image1,element_i);
  ...
  vil2_greyscale_dilate(image1,image2,element_j);
