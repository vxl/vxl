...
// Test the complex image slightly differently.
// This version is almost identical to the default one
// apart from #if 0/#if 1, and an extra typedef.
VCL_DEFINE_SPECIALIZATION
void test_image_resource(vcl_string type, vil_pixel_format format, vcl_complex<float>  /*dummy*/)
{
  typedef vcl_complex<float> T;
...
#if 0 // Can't do clamping, or math_value_range on a complex<T>
  T v1, v2;
