...
void
test_image_view_rgba(vil_image_view<S> & /*image2*/, vil_image_view<T> & /*image7*/)
{
...
template <>
void
test_image_view_rgba(vil_image_view<vxl_byte> & image2, vil_image_view<float> & image7)
{
  ...
  vil_transform(vil_plane(vil_view_as_planes(image6), 1), image2, [](const vxl_byte x) -> vxl_byte { return x + 1; });
...
template <>
void
test_image_view_rgba(vil_image_view<float> & image2, vil_image_view<double> & image7)
{
  image2.set_size(10, 10, 2);
  ...
  image2 = vil_plane(vil_view_as_planes(image6), 1);
  vil_transform(vil_plane(vil_view_as_planes(image6), 1), image2, [](const float x) -> float { return x + 1; });
...
template <class S, class T>
void
test_image_view(S /*d1*/, const std::string & s_name, T /*d2*/)
{
...

  {
    ...
    TEST("Shallow copy (size)",
         image0.ni() == image1.ni() && image0.nj() == image1.nj() && image0.nplanes() == image1.nplanes(),
         true);
  ...
  TEST("Shallow copy 2", image2.ni() == 4 && image2.nj() == 5 && image2.nplanes() == 3, true);
...

  {
    ...
    TEST("Deep copy (size)",
         image0.ni() == image4.ni() && image0.nj() == image4.nj() && image0.nplanes() == image4.nplanes(),
         true);
  ...
  TEST("vil_crop size", image_win.ni() == 4 && image_win.nj() == 4 && image_win.nplanes() == image0.nplanes(), true);
  ...
  TEST("vil_reformat_copy, vil_crop and vil_deep_equality", vil_image_view_deep_equality(test_image, image2), true);
  test_image(2, 2, 2) = 44;
...
template <>
inline bool
convert_components_from_planes(vil_image_view<my_int> &, const vil_image_view_base &)
{
  return false;
...
template <>
void
vil_print_value(std::ostream & os, const my_int & v, unsigned)
{
  os << double(v);
}
