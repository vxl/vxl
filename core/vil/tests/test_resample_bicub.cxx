// This is core/vil2/tests/test_resample_bicub.cxx
...
void test_resample_bicub_byte()
{
  vcl_cout << "*****************************\n"
           << " Testing vil2_resample_bicub\n"
           << "*****************************\n";
  ...
  vil2_resample_bicub(image0,dest_im,x0,y0,dx1,dy1,dx2,dy2,4,3);
  ...
  vil2_resample_bicub(image0,dest_im,x0,y0,dx2,dy2,dx1,dy1,4,3);
  TEST_NEAR("dest(0,0)",dest_im(0,0),55,1e-6);
