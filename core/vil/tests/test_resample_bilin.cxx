// This is core/vil2/tests/test_resample_bilin.cxx
...
void test_resample_bilin_byte()
{
  ...
  vil2_resample_bilin(image0,dest_im,x0,y0,dx2,dy2,dx1,dy1,4,3);
  TEST_NEAR("dest(0,0)",dest_im(0,0),55,1e-6);
  ...
  TEST_NEAR("dest_im(3,2,1)",dest_im(3,2,1),178.5,1e-6);
