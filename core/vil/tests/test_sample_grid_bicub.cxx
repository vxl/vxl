...
void test_sample_grid_bicub_byte()
{
  vcl_cout << "********************************\n"
           << " Testing vil2_sample_grid_bicub\n"
           << "********************************\n";
  ...
  vil2_sample_grid_bicub(&vec[0],image0,x0,y0,dx1,dy1,dx2,dy2,4,3);
  TEST_NEAR("First value",vec[0],55,1e-6);
  TEST_NEAR("Third value",vec[2],75,1e-6);
  TEST_NEAR("Last value",vec[11],78,1e-6);

  vil2_sample_grid_bicub(&vec[0],image0,x0,y0,dx2,dy2,dx1,dy1,4,3);
  TEST_NEAR("First value",vec[0],55,1e-6);
  ...
  vcl_cout<<"Fully in image\n";
  x0 = 5.0;
  vil2_sample_grid_bicub(&vec2[0],image0,x0,y0,dx1,dy1,dx2,dy2,4,3);
