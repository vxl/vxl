...
method(int i, vil_image_view<imT> & image, int n_loops)
{
  ...
  {
    case 1:
      t = method1(image, n_loops);
      break;
    case 2:
      t = method2(image, n_loops);
      break;
    case 3:
      t = method3(image, n_loops);
      break;
    case 4:
      t = method4(image, n_loops);
      break;
    case 5:
      t = method5(image, n_loops);
      break;
    case 6:
      t = method6(image, n_loops);
      break;
    case 7:
      t = method7(image, n_loops);
      break;
    case 8:
      t = method8(image, n_loops);
      break;
    default:
      t = -1;
  }
...
compute_stats(int i, vil_image_view<imT> & image, int n_loops)
{
  ...
  std::cout << "Method " << i << ") Mean: " << int(stats.mean() + 0.5) << "us  +/-"
            << int(0.5 * (stats.max() - stats.min()) + 0.5) << "us" << std::endl;
}
