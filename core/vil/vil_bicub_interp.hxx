...
#define VIL_BICUB_INTERP_INSTANTIATE(T)                                              \
  template double vil_bicub_interp_unsafe(                                           \
    double x, double y, const T * data, std::ptrdiff_t xstep, std::ptrdiff_t ystep); \
  template double vil_bicub_interp_raw(double x, double y, const T * data, std::ptrdiff_t xstep, std::ptrdiff_t ystep)
