...
template <class T>
inline double
vil_bilin_interp_unsafe(double x, double y, const T * data, std::ptrdiff_t xstep, std::ptrdiff_t ystep)
{
  int p1x = int(x);
  double normx = x - p1x;
  int p1y = int(y);
...
template <class T>
inline double
vil_bilin_interp_unsafe(double x,
                        double y,
                        const T * data,
                        int /*nx*/,
                        int /*ny*/,
...
template <class T>
inline double
vil_bilin_interp_raw(double x, double y, const T * data, std::ptrdiff_t xstep, std::ptrdiff_t ystep)
{
  int p1x = int(x);
  double normx = x - p1x;
  int p1y = int(y);
...
template <class T>
inline double
vil_bilin_interp_safe(double x, double y, const T * data, int nx, int ny, std::ptrdiff_t xstep, std::ptrdiff_t ystep)
{
  if (x < 0)
    return 0.0;
  if (y < 0)
...
template <class T>
inline double
vil_bilin_interp_safe_edgena(double x,
                             double y,
                             const T * data,
                             int nx,
                             int ny,
...
template <class T>
inline double
vil_bilin_interp_safe(const vil_image_view<T> & view, double x, double y, unsigned p = 0)
{
  return vil_bilin_interp_safe(x, y, &view(0, 0, p), view.ni(), view.nj(), view.istep(), view.jstep());
}
...
template <class T>
inline double
vil_bilin_interp_safe_edgena(const vil_image_view<T> & view, double x, double y, unsigned p = 0)
{
  return vil_bilin_interp_safe_edgena(x, y, &view(0, 0, p), view.ni(), view.nj(), view.istep(), view.jstep());
}
...
template <class T>
inline double
vil_bilin_interp(double x, double y, const T * data, int nx, int ny, std::ptrdiff_t xstep, std::ptrdiff_t ystep)
{
  assert(x >= 0);
  assert(y >= 0);
  assert(x <= nx - 1);
...
template <class T>
inline double
vil_bilin_interp(const vil_image_view<T> & view, double x, double y, unsigned p = 0)
{
  return vil_bilin_interp(x, y, &view(0, 0, p), view.ni(), view.nj(), view.istep(), view.jstep());
}
...
template <class T>
inline double
vil_bilin_interp_safe_extend(double x,
                             double y,
                             const T * data,
                             int nx,
                             int ny,
...
template <class T>
inline double
vil_bilin_interp_safe_extend(const vil_image_view<T> & view, double x, double y, unsigned p = 0)
{
  return vil_bilin_interp_safe_extend(x, y, &view(0, 0, p), view.ni(), view.nj(), view.istep(), view.jstep());
}
