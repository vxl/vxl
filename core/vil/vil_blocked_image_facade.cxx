...
vil_image_view_base_sptr
vil_blocked_image_facade::get_block(unsigned block_index_i, unsigned block_index_j) const
{
...
bool
vil_blocked_image_facade::put_block(unsigned block_index_i, unsigned block_index_j, const vil_image_view_base & view)
{
