...
{
public:
  vil_blocked_image_facade(const vil_image_resource_sptr & src, const unsigned sbi = 0, const unsigned sbj = 0);
  ...
  bool
  put_block(unsigned block_index_i, unsigned block_index_j, const vil_image_view_base & view) override;
...
protected:
  // Internal functions
  vil_image_view_base_sptr
  fill_block(vil_image_view_base_sptr & view) const;
