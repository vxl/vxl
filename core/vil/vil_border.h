...
public:
  ...
  inline const pixel_type & operator()(const imT& im, int i, int j, int p = 0) const
  {
...
protected:
  inline const pixel_type & in_border(const imT& im, int i, int j, int p = 0) const
  {
    switch( border_kind_ )
      {
...
public:
  ...
  inline const pixel_type & operator()(int i, int j, int p = 0) const
