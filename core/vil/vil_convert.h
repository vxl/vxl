...
//   30 Mar.2007 - Peter Vanroose - Commented out deprecated versions of vil_convert_cast &
...
macro(vxl_byte, vxl_byte) macro(vxl_int_16, vxl_byte) macro(vxl_uint_16, vxl_byte) macro(vxl_int_32, vxl_byte)
  macro(vxl_uint_32, vxl_byte) macro(float, vxl_byte) macro(double, vxl_byte) macro(vxl_byte, vxl_sbyte)
    macro(vxl_int_16, vxl_sbyte) macro(vxl_uint_16, vxl_sbyte) macro(vxl_int_32, vxl_sbyte)
      macro(vxl_uint_32, vxl_sbyte) macro(float, vxl_sbyte) macro(double, vxl_sbyte) macro(vxl_int_16, vxl_int_16)
        macro(float, vxl_int_16) macro(double, vxl_int_16) macro(vxl_uint_16, vxl_uint_16) macro(float, vxl_uint_16)
          macro(double, vxl_uint_16) macro(vxl_int_32, vxl_int_32) macro(float, vxl_int_32) macro(double, vxl_int_32)
            macro(vxl_uint_32, vxl_uint_32) macro(float, vxl_uint_32) macro(double, vxl_uint_32) macro(double, float)
#  if VXL_HAS_INT_64
              macro(vxl_int_64, vxl_byte) macro(vxl_uint_64, vxl_byte) macro(vxl_int_64, vxl_sbyte)
                macro(vxl_uint_64, vxl_sbyte) macro(vxl_int_64, vxl_int_64) macro(float, vxl_int_64)
                  macro(double, vxl_int_64) macro(vxl_uint_64, vxl_uint_64) macro(float, vxl_uint_64)
                    macro(double, vxl_uint_64)
#  endif
#  undef macro
#  define macro(inout)                                                                     \
    template <>                                                                            \
    inline void vil_convert_cast_pixel<inout, inout>::operator()(inout v, inout & d) const \
    {                                                                                      \
      d = v;                                                                               \
    }
                      macro(vxl_byte) macro(vxl_sbyte) macro(vxl_uint_16) macro(vxl_int_16) macro(vxl_uint_32)
                        macro(vxl_int_32)
#  if VXL_HAS_INT_64
                          macro(vxl_uint_64) macro(vxl_int_64)
#  endif
                            macro(float) macro(double)
#  undef macro
                              template <>
                              inline void vil_convert_cast_pixel<vil_rgb<vxl_byte>, vil_rgb<vxl_byte>>::operator()(
                                vil_rgb<vxl_byte> v,
                                vil_rgb<vxl_byte> & d) const
{
  d.r = v.r, d.g = v.g, d.b = v.b;
}
template <>
inline void
vil_convert_cast_pixel<vil_rgba<vxl_byte>, vil_rgba<vxl_byte>>::operator()(vil_rgba<vxl_byte> v,
                                                                           vil_rgba<vxl_byte> & d) const
{
  d.r = v.r, d.g = v.g, d.b = v.b, d.a = v.a;
}
#  define macro(in)                                                                                                \
    template <>                                                                                                    \
...
macro(vxl_byte) macro(vxl_sbyte) macro(vxl_int_16) macro(vxl_uint_16) macro(vxl_int_32) macro(vxl_uint_32)
#  if VXL_HAS_INT_64
  macro(vxl_int_64) macro(vxl_uint_64)
#  endif
#  undef macro
#  define macro(out)                                                                                                 \
    template <>                                                                                                      \
...
inline void
vil_convert_cast(const vil_image_view<inP> & src, vil_image_view<outP> & dest)
{
...
macro(vil_rgb<float>, vil_rgb<vxl_byte>) macro(vil_rgb<double>, vil_rgb<vxl_byte>)
  macro(vil_rgb<float>, vil_rgb<vxl_sbyte>) macro(vil_rgb<double>, vil_rgb<vxl_sbyte>)
    macro(vil_rgb<float>, vil_rgb<vxl_int_16>) macro(vil_rgb<double>, vil_rgb<vxl_int_16>)
      macro(vil_rgb<float>, vil_rgb<vxl_uint_16>) macro(vil_rgb<double>, vil_rgb<vxl_uint_16>)
        macro(vil_rgb<float>, vil_rgb<vxl_int_32>) macro(vil_rgb<double>, vil_rgb<vxl_int_32>)
          macro(vil_rgb<float>, vil_rgb<vxl_uint_32>) macro(vil_rgb<double>, vil_rgb<vxl_uint_32>)
#  if VXL_HAS_INT_64
            macro(vil_rgb<float>, vil_rgb<vxl_int_64>) macro(vil_rgb<double>, vil_rgb<vxl_int_64>)
              macro(vil_rgb<float>, vil_rgb<vxl_uint_64>) macro(vil_rgb<double>, vil_rgb<vxl_uint_64>)
#  endif
#  undef macro
#  define macro(in, out)                                                          \
    template <>                                                                   \
    ...
    {                                                                             \
      ...
      d.b = (out::value_type)(v.b);                                               \
                ...
                macro(vil_rgb<float>, vil_rgb<float>) macro(vil_rgb<double>, vil_rgb<double>)
#  undef macro
#  define macro(in, out)                                                          \
    template <>                                                                   \
    inline void vil_convert_round_pixel<in, out>::operator()(in v, out & d) const \
    {                                                                             \
      ...
      d.a = (out::value_type)(v.a + 0.5);                                         \
                  ...
                  macro(vil_rgba<float>, vil_rgba<vxl_byte>) macro(vil_rgba<double>, vil_rgba<vxl_byte>)
                    macro(vil_rgba<float>, vil_rgba<vxl_sbyte>) macro(vil_rgba<double>, vil_rgba<vxl_sbyte>)
                      macro(vil_rgba<float>, vil_rgba<vxl_int_16>) macro(vil_rgba<double>, vil_rgba<vxl_int_16>)
                        macro(vil_rgba<float>, vil_rgba<vxl_uint_16>) macro(vil_rgba<double>, vil_rgba<vxl_uint_16>)
                          macro(vil_rgba<float>, vil_rgba<vxl_int_32>) macro(vil_rgba<double>, vil_rgba<vxl_int_32>)
                            macro(vil_rgba<float>, vil_rgba<vxl_uint_32>) macro(vil_rgba<double>, vil_rgba<vxl_uint_32>)
#  if VXL_HAS_INT_64
                              macro(vil_rgba<float>, vil_rgba<vxl_int_64>) macro(vil_rgba<double>, vil_rgba<vxl_int_64>)
...
#  define macro(in, out)                                                          \
    ...
    {                                                                             \
      ...
      d.a = (out::value_type)(v.a);                                               \
                                    ...
                                    macro(vil_rgba<float>, vil_rgba<float>) macro(vil_rgba<double>, vil_rgba<double>)
#  undef macro
...
#  define macro(in, out)                                                          \
    ...
    inline void vil_convert_round_pixel<in, out>::operator()(in v, out & d) const \
    {                                                                             \
      d = (out)(v > 0.0 ? v + 0.5 : v - 0.5);                                     \
    }
                                      macro(float, vxl_byte) macro(double, vxl_byte) macro(float, vxl_sbyte)
                                        macro(double, vxl_sbyte) macro(float, vxl_int_16) macro(double, vxl_int_16)
                                          macro(float, vxl_uint_16) macro(double, vxl_uint_16) macro(float, vxl_int_32)
                                            macro(double, vxl_int_32) macro(float, vxl_uint_32)
                                              macro(double, vxl_uint_32)
#  if VXL_HAS_INT_64
                                                macro(float, vxl_int_64) macro(double, vxl_int_64)
                                                  macro(float, vxl_uint_64) macro(double, vxl_uint_64)
#  endif
#  undef macro
#endif // DOXYGEN_SHOULD_SKIP_THIS
...
template <class inP, class outP>
inline void
vil_convert_round(const vil_image_view<inP> & src, vil_image_view<outP> & dest)
{
  if (vil_pixel_format_of(inP()) == vil_pixel_format_of(outP()))
    dest = src;
  else
...
public:
  ...
  void
  operator()(vil_rgb<inP> v, outP & d) const
  {
    vil_convert_round_pixel<double, outP>()(rw_ * v.r + gw_ * v.g + bw_ * v.b, d);
  }
  void
  operator()(vil_rgba<inP> v, outP & d) const
  {
    vil_convert_round_pixel<double, outP>()(rw_ * v.r + gw_ * v.g + bw_ * v.b, d);
  }
};
...
template <class inP, class outP>
inline void
vil_convert_merge_alpha(const vil_image_view<inP> & src, vil_image_view<outP> & dest, const unsigned nplanes)
{
...
inline void
vil_convert_rgb_to_grey(const vil_image_view<rgbP> & src,
...
template <class inP, class outP>
inline void
vil_convert_planes_to_grey(const vil_image_view<inP> & src,
                           vil_image_view<outP> & dest,
                           double rw = 0.2125,
                           double gw = 0.7154,
                           double bw = 0.0721)
{
  ...
  for (unsigned j = 0; j < src.nj(); ++j)
    for (unsigned i = 0; i < src.ni(); ++i)
      vil_convert_round_pixel<double, outP>()(src(i, j, 0) * rw + src(i, j, 1) * gw + src(i, j, 2) * bw, dest(i, j));
}
...
template <class T>
inline void
vil_convert_stretch_range(const vil_image_view<T> & src, vil_image_view<vxl_byte> & dest)
{
  T min_b, max_b;
...
template <class inP>
inline void
vil_convert_stretch_range(const vil_image_view<inP> & src,
...
template <class inP>
inline void
vil_convert_stretch_range(const vil_image_view<inP> & src, vil_image_view<float> & dest, float dest_lo, float dest_hi)
{
  inP min_b = 0, max_b = 0;
  vil_math_value_range(src, min_b, max_b);
  float b = 0.0;
...
//: Convert src image<inP> to dest image<double> by stretching input range [src_lo, src_hi] to output range [dest_lo,
//: dest_hi].
// Inputs < src_lo are mapped to dest_lo, and inputs > src_hi to dest_hi.
template <class inP>
inline void
vil_convert_stretch_range_limited(const vil_image_view<inP> & src,
                                  vil_image_view<double> & dest,
                                  const inP src_lo,
                                  const inP src_hi,
                                  ...
                                  const double dest_hi)
{
  ...
  for (unsigned p = 0; p < src.nplanes(); ++p)
    for (unsigned j = 0; j < src.nj(); ++j)
      ...
      {
        inP s = src(i, j, p);
        dest(i, j, p) = s <= src_lo ? dest_lo : s >= src_hi ? dest_hi : dest_lo + dds * static_cast<double>(s - src_lo);
      }
}

//: Convert src image<inP> to dest image<float> by stretching input range [src_lo, src_hi] to output range [dest_lo,
//: dest_hi].
// Inputs < src_lo are mapped to dest_lo, and inputs > src_hi to dest_hi.
template <class inP>
inline void
                                  ...
                                  const float dest_hi)
{
  ...
  for (unsigned p = 0; p < src.nplanes(); ++p)
    for (unsigned j = 0; j < src.nj(); ++j)
      ...
      {
        inP s = src(i, j, p);
        dest(i, j, p) = s <= src_lo ? dest_lo : s >= src_hi ? dest_hi : dest_lo + dds * static_cast<float>(s - src_lo);
      }
}

//: Convert src image<inP> to dest image<ushort> by stretching input range [src_lo, src_hi] to output range [dest_lo,
//: dest_hi].
// Inputs < src_lo are mapped to dest_lo, and inputs > src_hi to dest_hi.
template <class inP>
inline void
...
//: Convert src image<inP> to dest image<ubyte> by stretching input range [src_lo, src_hi] to output range [dest_lo,
//: dest_hi].
// Inputs < src_lo are mapped to dest_lo, and inputs > src_hi to dest_hi.
template <class inP>
inline void
                                  ...
                                  const inP src_hi)
{
  ...
  for (unsigned p = 0; p < src.nplanes(); ++p)
    for (unsigned j = 0; j < src.nj(); ++j)
      ...
      {
        inP s = src(i, j, p);
        dest(i, j, p) = s <= src_lo ? 0 : static_cast<vxl_byte>(s >= src_hi ? 255 : (dds * (s - src_lo) + 0.5));
      }
}
...
vil_convert_cast(outP /*dummy*/, const vil_image_view_base_sptr & src)
{
  if (!src)
...
#endif // DOXYGEN_SHOULD_SKIP_THIS
    default:
      vil_exception_warning(vil_exception_unsupported_pixel_format(src->pixel_format(), "vil_convert_cast"));
      dest = nullptr;
  }
  return dest;
}
...
template <class outP>
inline vil_image_view_base_sptr
vil_convert_round(outP /*dummy*/, const vil_image_view_base_sptr & src)
{
  ...
  if (vil_pixel_format_component_format(src->pixel_format()) == vil_pixel_format_of(outP()))
    return src;
...
#  if VXL_HAS_INT_64
      macro(VIL_PIXEL_FORMAT_UINT_64, vxl_uint_64) macro(VIL_PIXEL_FORMAT_INT_64, vxl_int_64)
#  endif
        macro(VIL_PIXEL_FORMAT_UINT_32, vxl_uint_32) macro(VIL_PIXEL_FORMAT_INT_32, vxl_int_32)
          macro(VIL_PIXEL_FORMAT_UINT_16, vxl_uint_16) macro(VIL_PIXEL_FORMAT_INT_16, vxl_int_16)
            macro(VIL_PIXEL_FORMAT_FLOAT, float) macro(VIL_PIXEL_FORMAT_DOUBLE, double)
#  undef macro
#endif // DOXYGEN_SHOULD_SKIP_THIS
              default
      : vil_exception_warning(vil_exception_unsupported_pixel_format(src->pixel_format(), "vil_convert_round"));
    dest = nullptr;
  }
  return dest;
}
...
inline vil_image_view_base_sptr
vil_convert_to_component_order(const vil_image_view_base_sptr & src)
{
  if (!src)
    return vil_image_view_base_sptr();
...
#  define macro(F, T)                                                                                                  \
    ...
    {                                                                                                                  \
      ...
      if (!src_ref)                                                                                                    \
        return vil_image_view_base_sptr();                                                                             \
      if (src_ref.planestep() == 1)                                                                                    \
        return src;                                                                                                    \
      const unsigned ni = src->ni(), nj = src->nj(), nplanes = src->nplanes();                                         \
      vil_memory_chunk_sptr chunk =                                                                                    \
        new vil_memory_chunk(ni * nj * nplanes * sizeof(T), vil_pixel_format_component_format(F));                     \
      dest =                                                                                                           \
        new vil_image_view<T>(chunk, reinterpret_cast<T *>(chunk->data()), ni, nj, nplanes, nplanes, nplanes * ni, 1); \
...
#  undef macro
      ...
      : vil_exception_warning(
          vil_exception_unsupported_pixel_format(src->pixel_format(), "vil_convert_to_compound_order"));
    dest = nullptr;
  }
  return dest;
}
...
inline vil_image_view_base_sptr
vil_convert_to_grey_using_average(const vil_image_view_base_sptr & src)
{
  if (!src)
    return vil_image_view_base_sptr();
...
#  define macro(F, T)                                                                         \
    ...
    {                                                                                         \
      /* try to do it quickly */                                                              \
      if (src->nplanes() == 1 && vil_pixel_format_component_format(src->pixel_format()) == 1) \
        return src;                                                                           \
      /* create output view */                                                                \
...
#  undef macro
              ...
              default
      : vil_exception_warning(
          vil_exception_unsupported_pixel_format(src->pixel_format(), "vil_convert_to_grey_using_average"));
    return nullptr;
  }
}
...
// The input image's pixel type and storage arrangement may not be preserved.
inline vil_image_view_base_sptr
vil_convert_to_grey_using_rgb_weighting(double rw, double gw, double bw, const vil_image_view_base_sptr & src)
{
  if (!src)
    return vil_image_view_base_sptr();
...
#  define macro(F, T)                                                                       \
    ...
    {                                                                                       \
      /* try to do it quickly */                                                            \
      if (src->nplanes() == 1 && vil_pixel_format_num_components(src->pixel_format()) == 1) \
...
#  undef macro
              ...
              default
      : vil_exception_warning(
          vil_exception_unsupported_pixel_format(src->pixel_format(), "vil_convert_to_grey_using_rgb_weighting"));
    return vil_image_view_base_sptr();
  }
}
...
inline vil_image_view_base_sptr
vil_convert_to_grey_using_rgb_weighting(const vil_image_view_base_sptr & src)
{
...
// \endcode
inline vil_image_view_base_sptr
vil_convert_to_n_planes(unsigned n_planes, const vil_image_view_base_sptr & src)
{
  if (!src || n_planes == 0)
    return vil_image_view_base_sptr();
...
#  define macro(F, T)                                                                                               \
    ...
    {                                                                                                               \
      ...
      if (src_ref.nplanes() >= n_planes) /* reduce number of planes */                                              \
        return vil_image_view_base_sptr(new vil_image_view<T>(vil_planes(vil_image_view<T>(src), 0, 1, n_planes))); \
      else                                                                                                          \
      { /* expand number of planes with copying */                                                                  \
...
#endif // DOXYGEN_SHOULD_SKIP_THIS
              default
      : vil_exception_warning(vil_exception_unsupported_pixel_format(src->pixel_format(), "vil_convert_to_n_planes"));
...
template <class outP>
inline vil_image_view_base_sptr
vil_convert_stretch_range(outP /*dummy*/, const vil_image_view_base_sptr & src)
{
...
#endif // DOXYGEN_SHOULD_SKIP_THIS
              default
      : vil_exception_warning(vil_exception_unsupported_pixel_format(src->pixel_format(), "vil_convert_stretch_range"));
