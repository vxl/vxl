...
template <class T>
void
vil_copy_deep(const vil_image_view<T> & src, vil_image_view<T> & dest)
{
  dest.deep_copy(src);
}
...
template <class T>
vil_image_view<T>
vil_copy_deep(const vil_image_view<T> & src)
{
...
template <class T>
void
vil_copy_reformat(const vil_image_view<T> & src, vil_image_view<T> & dest)
{
...
template <class T>
void
vil_copy_to_window(const vil_image_view<T> & src, vil_image_view<T> & dest, unsigned i0, unsigned j0)
{
...
#define VIL_COPY_INSTANTIATE(T)                                                                                        \
  ...
  template void vil_copy_to_window(const vil_image_view<T> & src, vil_image_view<T> & dest, unsigned i0, unsigned j0); \
