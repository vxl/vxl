...
vil_flip_lr_image_resource::get_copy_view(unsigned i0, unsigned ni, unsigned j0, unsigned nj) const
{
  if (i0 + ni > src_->ni())
    return nullptr;
...
vil_image_view_base_sptr
vil_flip_lr_image_resource::get_view(unsigned i0, unsigned ni, unsigned j0, unsigned nj) const
{
  if (i0 + ni > src_->ni())
    return nullptr;
...
bool
vil_flip_lr_image_resource::put_view(const vil_image_view_base & im, unsigned i0, unsigned j0)
{
  if (i0 + im.ni() > src_->ni())
    return false;
...
vil_image_view_base_sptr
vil_flip_ud_image_resource::get_copy_view(unsigned i0, unsigned ni, unsigned j0, unsigned nj) const
{
  if (j0 + nj > src_->nj())
    return nullptr;
...
vil_image_view_base_sptr
vil_flip_ud_image_resource::get_view(unsigned i0, unsigned ni, unsigned j0, unsigned nj) const
{
  if (i0 + ni > src_->ni())
    return nullptr;
...
//: Put the data in this view back into the image source.
bool
vil_flip_ud_image_resource::put_view(const vil_image_view_base & im, unsigned i0, unsigned j0)
{
  if (i0 + im.ni() > src_->ni())
    return false;
  switch (im.pixel_format())
