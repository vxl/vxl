...
vcl_string vil2_flip_lr_image_resource::is_a() const
{
  static const vcl_string class_name_="vil2_flip_lr_image_resource";
  return class_name_;
}

//: Return true if the name of the class matches the argument
bool vil2_flip_lr_image_resource::is_class(vcl_string const& s) const
{
  return s==vil2_flip_lr_image_resource::is_a() || vil2_image_resource::is_class(s);
}
...
//: Return the name of the class;
vcl_string vil2_flip_ud_image_resource::is_a() const
{
  static const vcl_string class_name_="vil2_flip_ud_image_resource";
  return class_name_;
}

//: Return true if the name of the class matches the argument
bool vil2_flip_ud_image_resource::is_class(vcl_string const& s) const
{
  return s==vil2_flip_ud_image_resource::is_a() || vil2_image_resource::is_class(s);
}
