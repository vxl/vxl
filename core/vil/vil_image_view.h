...
public:
  ...
  vil_image_view(const T* top_left, unsigned ni, unsigned nj, unsigned nplanes, vcl_ptrdiff_t i_step,
                 vcl_ptrdiff_t j_step, vcl_ptrdiff_t plane_step);
  ...
  vil_image_view(const vil_memory_chunk_sptr& mem_chunk, const T* top_left, unsigned ni, unsigned nj, unsigned nplanes,
  ...
  //  through the view.
  void set_to_memory(const T* top_left, unsigned ni, unsigned nj, unsigned nplanes, vcl_ptrdiff_t i_step,
                     vcl_ptrdiff_t j_step, vcl_ptrdiff_t plane_step);
