...
vil_load_image_resource(const char * filename, bool verbose = true);

//: Load from a stream.
// Won't use plugins.
// \relatesalso vil_image_resource
vil_image_resource_sptr
vil_load_image_resource_raw(vil_stream *, bool verbose = true);

//: Load an image resource object from a file.
// Won't use plugins.
// \relatesalso vil_image_resource
vil_image_resource_sptr
vil_load_image_resource_raw(const char *, bool verbose = true);

//: Load from a filename with a plugin.
// \relatesalso vil_image_resource
vil_image_resource_sptr
vil_load_image_resource_plugin(const char *);
...
vil_load_pyramid_resource(const char * directory_or_file, bool verbose = true);

//: Convenience function for loading an image into an image view.
// \relatesalso vil_image_view
vil_image_view_base_sptr
vil_load(const char *, bool verbose = true);
...
// \relatesalso vil_image_resource
vil_image_resource_sptr
vil_load_image_resource(const wchar_t * filename, bool verbose = true);

//: Load an image resource object from a file.
// Won't use plugins.
vil_image_resource_sptr
vil_load_image_resource_raw(const wchar_t *, bool verbose = true);

//: Convenience function for loading an image into an image view.
// \relatesalso vil_image_view
vil_image_view_base_sptr
vil_load(const wchar_t *, bool verbose = true);
