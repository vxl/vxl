...
template <class aT, class bT, class dT>
void
vil_math_image_abs_difference_1d_sse(const aT * pxA, const bT * pxB, dT * pxD, unsigned len);
...
#define VIL_MATH_IMAGE_ABS_DIFF_1D_SSE_SPECIALIZE_DECL(aT, bT, dT)                                               \
  template <>                                                                                                    \
  void vil_math_image_abs_difference_1d_sse<aT, bT, dT>(const aT * pxA, const bT * pxB, dT * pxD, unsigned len); \
  template <>                                                                                                    \
  void vil_math_image_abs_difference_1d<aT, bT, dT>(const aT * pxA,                                              \
                                                    std::ptrdiff_t isA,                                          \
                                                    const bT * pxB,                                              \
                                                    std::ptrdiff_t isB,                                          \
                                                    dT * pxD,                                                    \
...
#define VIL_MATH_IMAGE_ABS_DIFF_1D_SSE_SPECIALIZE_IMPL(aT, bT, dT)                             \
  template <>                                                                                  \
  inline void vil_math_image_abs_difference_1d<aT, bT, dT>(const aT * pxA,                     \
                                                           std::ptrdiff_t isA,                 \
                                                           const bT * pxB,                     \
                                                           std::ptrdiff_t isB,                 \
                                                           dT * pxD,                           \
