...
template <class T>
vil_pyramid_image_view<T>::vil_pyramid_image_view(unsigned levels, unsigned ni, unsigned nj, unsigned n_planes)
  : nlevels_(levels)
  , max_levels_(256)
{
...
template <class T>
vil_pyramid_image_view<T>::vil_pyramid_image_view(const std::vector<vil_image_view_base_sptr> & images,
...
template <class T>
void
vil_pyramid_image_view<T>::add_view(vil_image_view_base_sptr & image, double scale)
{
...
template <class T>
void
vil_pyramid_image_view<T>::scale_down(const vil_image_view<T> & image_in, vil_image_view_base_sptr & image_out)
{
...
#define VIL_PYRAMID_IMAGE_VIEW_INSTANTIATE(T) template class vil_pyramid_image_view<T>
