...
inline int
vil_round_rnd_halfinttoeven(float x)
{
...
inline int
vil_round_rnd_halfinttoeven(double x)
{
#  if defined(VIL_CHECK_FPU_ROUNDING_MODE) && defined(__GNUC__)
  assert(fegetround() == FE_TONEAREST);
#  endif
...
inline int
vil_round_rnd_halfintup(float x)
{
  return vil_round_rnd_halfinttoeven(2 * x + 0.5f) >> 1;
}
inline int
vil_round_rnd_halfintup(double x)
{
  return vil_round_rnd_halfinttoeven(2 * x + 0.5) >> 1;
}
...
inline int
vil_round_rnd(float x)
{
  return vil_round_rnd_halfinttoeven(x);
}
inline int
vil_round_rnd(double x)
{
  return vil_round_rnd_halfinttoeven(x);
}
