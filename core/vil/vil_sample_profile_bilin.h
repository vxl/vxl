...
void vil_sample_profile_bilin(vecType* v, const vil_image_view<imType>& image, double x0, double y0, double dx,
                              double dy, int n);
...
// \relatesalso vil_image_view
template <class imType, class vecType>
void vil_sample_profile_bilin_edgena(vecType* v, const vil_image_view<imType>& image, double x0, double y0, double dx,
                                     double dy, int n);
