...
vxl_uint_64 vil_stream_read_big_endian_uint_64(vil_stream * s)
{
  ...
  return (vxl_uint_64(bytes[0]) << 56) | (vxl_uint_64(bytes[1]) << 48) | (vxl_uint_64(bytes[2]) << 40)
         | (vxl_uint_64(bytes[3]) << 32)
         | (vxl_uint_64(bytes[0]) << 24) | (vxl_uint_64(bytes[1]) << 16) | (vxl_uint_64(bytes[2]) << 8) |  vxl_uint_64(
    bytes[3]);
}
...
vxl_uint_64 vil_stream_read_little_endian_uint_64(vil_stream * s)
{
  ...
  return (vxl_uint_64(bytes[3]) << 56) | (vxl_uint_64(bytes[2]) << 48) | (vxl_uint_64(bytes[1]) << 40)
         | (vxl_uint_64(bytes[0]) << 32)
         | (vxl_uint_64(bytes[3]) << 24) | (vxl_uint_64(bytes[2]) << 16) | (vxl_uint_64(bytes[1]) << 8) |  vxl_uint_64(
    bytes[0]);
}
