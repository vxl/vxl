...
inline void
vil_transform(vil_image_view<T> & image, F functor)
{
...
inline void
vil_transform(const vil_image_view<inP> & src, vil_image_view<outP> & dest, Op functor)
{
...
template <class inP, class outP, class Op>
inline void
vil_transform2(const vil_image_view<inP> & src, vil_image_view<outP> & dest, Op functor)
{
  const unsigned ni = src.ni(), nj = src.nj(), np = src.nplanes();
...
inline void
vil_transform(const vil_image_view<inA> & srcA,
