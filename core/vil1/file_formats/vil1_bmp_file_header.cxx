...
void
vil1_bmp_file_header::print(std::ostream & s) const
{
...
void
vil1_bmp_file_header::read(vil1_stream * s)
{
...
void
vil1_bmp_file_header::write(vil1_stream * s) const
{
...
bool
vil1_bmp_file_header::signature_valid() const
{
