...
void vil1_jpeg_init_destination(j_compress_ptr cinfo);

jpeg_boolean vil1_jpeg_empty_output_buffer(j_compress_ptr cinfo);

void vil1_jpeg_term_destination(j_compress_ptr cinfo);

void vil1_jpeg_stream_dst_set(j_compress_ptr cinfo, vil1_stream * vs);

void vil1_jpeg_stream_dst_rewind(j_compress_ptr cinfo, vil1_stream * vs);
