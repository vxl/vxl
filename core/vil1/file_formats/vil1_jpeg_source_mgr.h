...
void vil1_jpeg_init_source(j_decompress_ptr cinfo);

jpeg_boolean vil1_jpeg_fill_input_buffer(j_decompress_ptr cinfo);

void vil1_jpeg_skip_input_data(j_decompress_ptr cinfo, long num_bytes);

void vil1_jpeg_term_source(j_decompress_ptr cinfo);

void vil1_jpeg_stream_src_set(j_decompress_ptr cinfo, vil1_stream * vs);

void vil1_jpeg_stream_src_rewind(j_decompress_ptr cinfo, vil1_stream * vs);
