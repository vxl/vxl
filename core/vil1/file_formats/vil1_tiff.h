...
public:
  ...
  void
  get_resolution(float & x_res, float & y_res, unsigned short & units) const;
  void
  set_resolution(float x_res, float y_res, unsigned short units);
  ...
  bool
  set_property(const char * tag, const void * prop = nullptr) const override;
