...
test_memory_image_of()
{
  ...
  const char * const file_name_2 = !tmp_nam.empty() ? tmp_nam.c_str() : "vil1_test_memory_image_of.pgm";
  {
  ...
  const char * const file_name_1 = !tmp_nam.empty() ? tmp_nam.c_str() : "vil1_test_memory_image_of.ppm";
