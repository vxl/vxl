...
# ADD CPP /nologo /MD /W3 /GX /O2 /Ob2 /I "$(IUEROOT)\vcl\config.win32-vc60" /I "$(IUEROOT)\v3p\tiff" /I "$(IUEROOT)\v3p\jpeg" /I "$(IUEROOT)\v3p\png" /I "$(IUEROOT)\v3p\zlib" /I "$(IUEROOT)\vcl" /I "$(IUEROOT)\vxl" /D "WIN32" /D "NDEBUG" /D "_LIB" /YX /FD /c /Zl
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /Zi /Od /Ob2 /I "$(IUEROOT)\vcl\config.win32-vc60" /I "$(IUEROOT)\v3p\tiff" /I "$(IUEROOT)\v3p\jpeg" /I "$(IUEROOT)\v3p\png" /I "$(IUEROOT)\v3p\zlib" /I "$(IUEROOT)\vcl" /I "$(IUEROOT)\vxl" /D "WIN32" /D "_DEBUG" /D "_LIB" /FR /FD /GZ /c /Zl
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /Zi /Od /Ob2 /I "$(IUEROOT)\vcl\config.win32-vc60" /I "$(IUEROOT)\v3p\tiff" /I "$(IUEROOT)\v3p\jpeg" /I "$(IUEROOT)\v3p\png" /I "$(IUEROOT)\v3p\zlib" /I "$(IUEROOT)\vcl" /I "$(IUEROOT)\vxl" /D "WIN32" /D "_DEBUG" /D "_LIB" /FD /GZ /c /Zl
...
# ADD CPP /nologo /MT /W3 /GX /O2 /Ob2 /I "$(IUEROOT)\vcl\config.win32-vc60" /I "$(IUEROOT)\v3p\tiff" /I "$(IUEROOT)\v3p\jpeg" /I "$(IUEROOT)\v3p\png" /I "$(IUEROOT)\v3p\zlib" /I "$(IUEROOT)\vcl" /I "$(IUEROOT)\vxl" /D "WIN32" /D "NDEBUG" /D "_LIB" /YX /FD /c /Zl
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
