...
unsigned
vil1_32bit_read_big_endian(vil1_stream *);
unsigned
vil1_32bit_read_little_endian(vil1_stream *);

void
vil1_32bit_write_big_endian(vil1_stream *, unsigned);
void
vil1_32bit_write_little_endian(vil1_stream *, unsigned);
