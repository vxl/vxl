#ifndef vil_block_cache_image_h_
#define vil_block_cache_image_h_
#ifdef __GNUC__
#pragma interface
#endif
/*
...
class vil_block_cache_image : public vil_image_impl {
public:
  vil_block_cache_image(vil_image , unsigned blocksizex, unsigned blocksizey);
  ~vil_block_cache_image();
