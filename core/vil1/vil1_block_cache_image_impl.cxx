...
vil1_image
vil1_block_cache_image_impl::get_plane(unsigned int p) const
{
...
bool
vil1_block_cache_image_impl::get_section(void * buf, int x0, int y0, int w, int h) const
{
...
std::string
vil1_block_cache_image_impl::is_a() const
{
