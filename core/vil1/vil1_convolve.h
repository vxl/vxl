...
void vil1_convolve_1d_x(vil1_convolve_signal_1d<I1 const> const & kernel,
                        vil1_convolve_signal_2d<I2 const> const & input, AC * /*accumulator type*/,
                        vil1_convolve_signal_2d<O> const & output, vil1_convolve_boundary_option b,
...
template <class I1, class I2, class AC, class O>
void vil1_convolve_separable(I1 const kernel[], unsigned N, vil1_memory_image_of<I2>& buf,
                             vil1_memory_image_of<AC>& tmp, vil1_memory_image_of<O>& out);
...
template <class I1, class I2, class AC, class O>
void vil1_convolve_1d_x(I1 const * half_kernel, unsigned kernel_size, vil1_convolve_signal_2d<I2 const> const & input,
                        AC * /*accumulator type*/, vil1_convolve_signal_2d<O> const & output,
                        vil1_convolve_boundary_option b, vil1_convolve_boundary_option e);

// *** the following function is implemented in vil1_convolve_1d_y.txx

// : Convolution in y-direction, using a symmetric kernel.
template <class I1, class I2, class AC, class O>
void vil1_convolve_1d_y(I1 const * half_kernel, unsigned kernel_size, vil1_convolve_signal_2d<I2 const> const & input,
                        AC * /*accumulator type*/, vil1_convolve_signal_2d<O> const & output,
                        vil1_convolve_boundary_option b, vil1_convolve_boundary_option e);
