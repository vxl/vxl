...
void vil1_convolve_simple(                                                        // input 1
  ...
  int x1, int y1, unsigned w1, unsigned h1, vil1_memory_image_of<I2> const & IN2, // input 2
  int x2, int y2, unsigned w2, unsigned h2, AC *,                                 // dummy
...
template <class I1, class I2, class AC, class O>
void vil1_convolve_simple(vil1_memory_image_of<I1> const & input1, vil1_memory_image_of<I2> const & input2, AC *, // dummy
