...
void
vil1_convolve_simple(I1 const * const * input1,
                     unsigned w1,
                     unsigned h1,
                     I2 const * const * input2,
                     unsigned w2,
                     unsigned h2,
                     AC *,
                     O * const * out)
...
#define VIL1_CONVOLVE_SIMPLE_INSTANTIATE0(I1, I2, AC, O) \
  template void vil1_convolve_simple(                    \
    I1 const * const *, unsigned, unsigned, I2 const * const *, unsigned, unsigned, AC *, O * const *)
...
template <class I1, class I2, class AC, class O>
void
vil1_convolve_simple(vil1_memory_image_of<I1> const & input1, // input 1
                     int x1,
                     int y1,
                     unsigned w1,
                     unsigned h1,
                     ...
                     int yo)
{
  ...
  static void (*f)(I1 const * const *, unsigned, unsigned, I2 const * const *, unsigned, unsigned, AC *, O * const *) =
    nullptr;
  if (!f)
    f = vil1_convolve_simple;
  (*f)(const_cast<I1 const * const *>(/* xxx */ &in1[0]),
       w1,
       h1,
       const_cast<I2 const * const *>(/* xxx */ &in2[0]),
       w2,
       h2,
       (AC *)nullptr,
...
template <class I1, class I2, class AC, class O>
void
vil1_convolve_simple(const vil1_memory_image_of<I1> & in1,
                     const vil1_memory_image_of<I2> & in2,
                     AC *,
...
#define VIL1_CONVOLVE_SIMPLE_INSTANTIATE2(I1, I2, AC, O) \
  template void vil1_convolve_simple(                    \
    vil1_memory_image_of<I1> const &, vil1_memory_image_of<I2> const &, AC *, vil1_memory_image_of<O> &)
