...
bool
vil1_image_impl::get_property(const char *, void *) const
{
  return false;
}

bool
vil1_image_impl::set_property(const char *, const void *) const
{
  return false;
}
...
bool
vil1_image_impl::put_section(const void * /*buf*/, int /*x0*/, int /*y0*/, int /*width*/, int /*height*/)
{
  return false;
}
