...
bool
vil1_interpolate_nearest(const vil1_memory_image_of<T> & img, double src_x, double src_y, U * out)
{
...
template <class T, class U>
bool
vil1_interpolate_bilinear(const vil1_memory_image_of<T> & img, double src_x, double src_y, U * out)
{
...
template <class T, class U>
bool
vil1_interpolate_bilinear_grad(const vil1_memory_image_of<T> & img,
                               double src_x,
                               double src_y,
                               U * out_i,
                               U * out_dx,
...
template <class T, class U>
bool
vil1_interpolate_bicubic(const vil1_memory_image_of<T> & img, double src_x, double src_y, U * out)
{
  int src_x_int = (int)src_x;
  int src_y_int = (int)src_y;
...
#define I(dx, dy) (img(src_x_int + (dx), src_y_int + (dy)))
  *out = U(0.25 * ((s0 * I(-1, -1) + s1 * I(+0, -1) + s2 * I(+1, -1) + s3 * I(+2, -1)) * t0 +
