...
vil1_memory_image_impl::vil1_memory_image_impl(int planes, int w, int h,
                                               ...
                                               const& format)
{
  init((void*)nullptr, planes, w, h, format.components, format.bits_per_component,
...
vil1_memory_image_impl::vil1_memory_image_impl(vil1_memory_image_impl const& i)
  : vil1_image_impl()
{
  init((void*)nullptr, i.planes_, i.width_, i.height_, i.components_,
...
void vil1_memory_image_impl::resize(int planes, int width, int height)
{
  ...
  if (!is_foreign_buf_)
    delete [] buf_;
  init((void*)nullptr, planes, width, height, components_,
