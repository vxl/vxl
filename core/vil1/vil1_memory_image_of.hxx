...
template <class T>
vil1_memory_image_of<T>::vil1_memory_image_of(const vil1_memory_image_of<T> & that)
  : vil1_memory_image(that)
{}

template <class T>
vil1_memory_image_of<T>::vil1_memory_image_of(const vil1_image & image)
...
template <class T>
void
vil1_memory_image_of<T>::set(vil1_image const & image)
{
...
vil1_memory_image_of<T>::operator=(const vil1_memory_image_of<T> & that)
{
...
template <class T>
vil1_memory_image_of<T> &
vil1_memory_image_of<T>::operator=(const vil1_image & that)
{
...
template <class T>
void
vil1_memory_image_of<T>::resize(int width, int height)
{
  if (ptr)
...
template <class T>
void
vil1_memory_image_of<T>::resize(int planes, int width, int height)
{
  assert(ptr);
...
template <class T>
void
vil1_memory_image_of<T>::fill(const T & v)
{
  int w = width();
  int h = height();
  for (int y = 0; y < h; ++y)
...
#define VIL1_MEMORY_IMAGE_OF_INSTANTIATE(T) template class vil1_memory_image_of<T>
