...
O
vil1_ncc(const vil1_memory_image_of<I1> & a, const vil1_memory_image_of<I2> & b, O *)
{
...
#define VIL1_NCC_INSTANTIATE(I1, I2, O)                                                         \
  template O vil1_ncc(vil1_memory_image_of<I1> const &, vil1_memory_image_of<I2> const &, O *); \
  template O vil1_ncc(I1 const * const *, int, int, I2 const * const *, int, int, int, O *)
