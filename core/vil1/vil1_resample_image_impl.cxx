...
bool
vil1_resample_image_impl::get_section(void * buf, int x0, int y0, int w, int h) const
{
  assert(buf != nullptr);
#ifdef DEBUG
  ...
  {
    case VIL1_BYTE:
      return vil1_resample_image(base, new_width, new_height, (vxl_byte *)buf, (unsigned *)nullptr, x0, y0, w, h);
    case VIL1_RGB_BYTE:
      return vil1_resample_image(
        base, new_width, new_height, (vil1_rgb<vxl_byte> *)buf, (vil1_rgb<int> *)nullptr, x0, y0, w, h);
