...
#define SPECIALIZE_CLAMP_PIXEL(T)                                                                         \
  ...
  {                                                                                                       \
    return vil1_rgb<T>(                                                                                   \
      vil1_clamp_pixel(d.r, min, max), vil1_clamp_pixel(d.g, min, max), vil1_clamp_pixel(d.b, min, max)); \
  }
...
#define VIL1_RGB_INSTANTIATE_LS(T) /*template std::ostream& operator<<(std::ostream&, const vil1_rgb<T >& ) */
