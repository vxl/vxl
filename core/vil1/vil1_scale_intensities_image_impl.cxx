...
vil1_image
vil1_scale_intensities_image_impl::get_plane(unsigned int p) const
{
  vil1_image_impl * const i = new vil1_scale_intensities_image_impl(base.get_plane(p), scale_, shift_);
  return i;
}

bool
vil1_scale_intensities_image_impl::put_section(const void *, int, int, int, int)
{
  return false;
}

bool
vil1_scale_intensities_image_impl::get_section(void * buf, int x0, int y0, int w, int h) const
{
