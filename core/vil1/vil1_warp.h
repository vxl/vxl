...
vil1_image vil1_warp(vil1_image const& in, vil1_warp_mapping const& mapper, int out_width = -1, int out_height = -1);

// : Warp, specifying interpolation
vil1_image vil1_warp(vil1_image const& in, vil1_warp_mapping const& mapper, vil1_warp_interpolation_type i,
