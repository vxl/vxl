...
template <class T>
bool vnl_generalized_schur(vnl_matrix<vcl_complex<T> > * A, vnl_matrix<vcl_complex<T> > * B,
                           vnl_vector<vcl_complex<T> > * alpha, vnl_vector<vcl_complex<T> > * beta,
                           vnl_matrix<vcl_complex<T> > * L, vnl_matrix<vcl_complex<T> > * R);

VCL_DEFINE_SPECIALIZATION
bool vnl_generalized_schur(vnl_matrix<vcl_complex<double> > * A, vnl_matrix<vcl_complex<double> > * B,
                           vnl_vector<vcl_complex<double> > * alpha, vnl_vector<vcl_complex<double> > * beta,
                           vnl_matrix<vcl_complex<double> > * L, vnl_matrix<vcl_complex<double> > * R);
...
{
  return static_cast<vcl_complex<T> >(a);
}
