...
T vnl_determinant(vnl_matrix<T> const &M, bool balance)
{
  ...
  {
   case 1: return M(0,0);
   case 2: return vnl_determinant(M.get_row(0), M.get_row(1));
   case 3: return vnl_determinant(M.get_row(0), M.get_row(1), M.get_row(2));
   case 4: return vnl_determinant(M.get_row(0), M.get_row(1), M.get_row(2), M.get_row(3));
   default:
    if (balance)
    {
      vnl_matrix<T> tmp(M);
