...
void vnl_fft_gpfa(float  * a, float  * b, float const  * triggs, long inc, long jump, long n, long lot, long isign,
                  long const pqr[3], long * info);

void vnl_fft_gpfa(double * a, double * b, double const * triggs, long inc, long jump, long n, long lot, long isign,
                  long const pqr[3], long * info);
