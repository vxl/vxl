...
template<class T> 
vnl_fft1d<T>::vnl_fft1d (const T *RData, unsigned int iLen, 
			 const vnl_fftxd_prime_factors<T> &oPF, int dir)
  : base(iLen)
{
  // copy data into complex format
...
template<class T> 
vnl_fft1d<T>::vnl_fft1d (const T *RData, const T *IData, unsigned int iLen, 
			 const vnl_fftxd_prime_factors<T> &oPF, int dir)
  : base(iLen)
{
  // copy data into complex format
...
template<class T> 
vnl_fft1d<T>::vnl_fft1d (const vnl_complex<T> *CData, unsigned int iLen, 
			 const vnl_fftxd_prime_factors<T> &oPF, int dir)
  : base(CData,iLen)
{
  doFFT (oPF, dir);
...
extern "C" {
  extern void dgpfa_(double *a, double *b, const double *triggs, 
		     const int&inc, const int&jump, const int&n, 
		     const int&lot, const int&isign, const int *, int *);
  extern void gpfa_ (float  *a, float  *b, const float  *triggs, 
		     const int&inc, const int&jump, const int&n, 
		     const int&lot, const int&isign, const int *, int *);
};
...
template<class T> 
int vnl_fft1d<T>::doFFT_IP (vnl_complex<T> *cdata, unsigned int iLen, 
