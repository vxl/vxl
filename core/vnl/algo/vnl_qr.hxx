...
#  define macro(p, T)                                                                                         \
    inline void vnl_linpack_qrdc(vnl_netlib_qrdc_proto(T)) { v3p_netlib_##p##qrdc_(vnl_netlib_qrdc_params); } \
    inline void vnl_linpack_qrsl(vnl_netlib_qrsl_proto(T)) { v3p_netlib_##p##qrsl_(vnl_netlib_qrsl_params); }
macro(s, float);
macro(d, double);
