...
vnl_decnum binom(vnl_decnum const& a,
                 vnl_decnum const& b) { if( a < zero || b < zero || a < b ) { return zero;
...
node build_tree(vcl_string const& expr, unsigned long s, int l)
{
  ...
  if( j == l && expr[s] >= 'a' && expr[s] <= 'z' ) // function
    ...
    if( j >= l ) {ErrorExit(expr, "missing parameter list for function", s); }
      ...
      {
      n.func1 = &vnl_math::abs, n.func2 = 0, n.func3 = 0;
      }
    else if( expr.substr(s, j) == "floor(" )
      {
      n.func1 = &floor, n.func2 = 0, n.func3 = 0;
      }
    else if( expr.substr(s, j) == "ceil(" )
      {
      n.func1 = &ceil, n.func2 = 0, n.func3 = 0;
      }
    else if( expr.substr(s, j) == "round(" )
      {
      n.func1 = &round, n.func2 = 0, n.func3 = 0;
      }
    else if( expr.substr(s, j) == "min(" )
      {
      n.func1 = 0, n.func2 = &min, n.func3 = 0;
      }
    else if( expr.substr(s, j) == "max(" )
      {
      n.func1 = 0, n.func2 = &max, n.func3 = 0;
      }
    else if( expr.substr(s, j) == "binom(" )
      {
      n.func1 = 0, n.func2 = &binom, n.func3 = 0;
      }
    else if( expr.substr(s, j) == "pow(" )
      {
      n.func1 = 0, n.func2 = 0, n.func3 = &pow;
      }
  ...
  if( expr[s + j] == '*' ) { n.func1 = 0, n.func2 = &prod, n.func3 = 0; }
    ...
    {
    n.func1 = 0, n.func2 = &quot, n.func3 = 0;
    }
  else if( expr[s + j] == '%' )
    {
    n.func1 = 0, n.func2 = &modulo, n.func3 = 0;
    }
  else if( expr[s + j] == '+' )
    {
    n.func1 = 0, n.func2 = &sum, n.func3 = 0;
    }
  else if( expr[s + j] == '-' )
    {
    n.func1 = 0, n.func2 = &diff, n.func3 = 0;
    }
