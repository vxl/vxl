...
test_bignum_io()
{
  ...
  vnl_bignum nil(0), big(-3245444l), verybig("4235702934875938745092384750293845"), p_inf("Infinity"), m_inf("-Inf");

  vsl_b_ofstream bfs_out("vnl_bignum_test_io.bvl.tmp");
  TEST("Created vnl_bignum_test_io.bvl.tmp for writing", (!bfs_out), false);
