...
void
vsl_b_write(vsl_b_ostream & os, const vnl_real_polynomial & p)
{
...
void
vsl_b_read(vsl_b_istream & is, vnl_real_polynomial & p)
{
  if (!is)
    return;
...
void
vsl_print_summary(std::ostream & os, const vnl_real_polynomial & p)
{
  p.print(os);
}
