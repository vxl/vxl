...
inline bool test_matrix_x_vector(const vnl_matrix<float> & mat, const vnl_vector<float> & vec,
                                 vnl_vector<float> & result)
{
  unsigned n = vec.size();
...
inline bool test_vector_x_matrix(const vnl_vector<float> & vec, const vnl_matrix<float> & mat,
                                 vnl_vector<float> & result)
{
  unsigned n = vec.size();
