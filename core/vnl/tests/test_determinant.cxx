...
void test_determinant() {
  ...
  //   vnl_test_assert_near("M1", vnl_determinant(M1[0]), d1, eps);
  // }
  // 
  // {
  //   double N1[1][1] = {
  ...
  //   vnl_test_assert_near("N1", vnl_determinant(N1[0]), d1, eps);
  // }

  {
    ...
    vnl_test_assert_near("M2", vnl_determinant(M2[0], M2[1]), d2, eps);
  }

  {
    ...
    vnl_test_assert_near("N2", vnl_determinant(N2[0], N2[1]), d2, eps);
  }

  {
    ...
    vnl_test_assert_near("M3", vnl_determinant(M3[0], M3[1], M3[2]), d3, eps);
  }

  {
    ...
    vnl_test_assert_near("N3", vnl_determinant(N3[0], N3[1], N3[2]), d3, eps);
  }

  {
    ...
    vnl_test_assert_near("M4", vnl_determinant(M4[0],M4[1],M4[2],M4[3]), d4, eps);
  }

  {
    ...
    vnl_test_assert_near("N4", vnl_determinant(N4[0],N4[1],N4[2],N4[3]), d4, eps);
  }
}
