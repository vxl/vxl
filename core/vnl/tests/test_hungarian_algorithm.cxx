...
static void test_hungarian_algorithm_1()
{
  ...
  for( unsigned int i = 0; i < assignment2.size(); ++i )
    {
    vcl_cout << ' ' << assignment2[i];
    }
  vcl_cout << " )\n";

  TEST("assignment vector",
       assignment2[0] == 2 && assignment2[1] == 1 && assignment2[2] == 0 && assignment2[3] == 4 && assignment2[4] == 3 &&
       assignment2[5] == 5,
       true);
