...
void test_polynomial_rational()
{
  ...
  TEST("-f1", f3.degree() == 3 && f3[3] == -1 && f3[2] == vnl_rational(-1, 2) && f3[1] == vnl_rational(-1,
                                                                                                       3) &&
       f3[0] == vnl_rational(-1, 4), true);

  f3 = f1 + f2;
  vcl_cout << "f1+f2 =" << f3 << vcl_endl;
  TEST("f1(x)+f2(x)", f1.evaluate(vnl_rational(7, 9) ) + f2.evaluate(vnl_rational(7, 9) ),
       f3.evaluate(vnl_rational(7, 9) ) );
  TEST("f1+f2",
       f3.degree() == 4 && f3[4] == 1 && f3[3] == 4 && f3[2] == vnl_rational(11, 2) && f3[1] == vnl_rational(22,
                                                                                                             3) &&
       f3[0] == vnl_rational(37, 4), true);

  f3 = f2 + f1;
  vcl_cout << "f2+f1 =" << f3 << vcl_endl;
  TEST("f2(x)+f1(x)", f2.evaluate(vnl_rational(7, 9) ) + f1.evaluate(vnl_rational(7, 9) ),
       f3.evaluate(vnl_rational(7, 9) ) );
  TEST("f2+f1",
       f3.degree() == 4 && f3[4] == 1 && f3[3] == 4 && f3[2] == vnl_rational(11, 2) && f3[1] == vnl_rational(22,
                                                                                                             3) &&
  ...
  TEST("f1(x)-f2(x)", f1.evaluate(vnl_rational(7, 9) ) - f2.evaluate(vnl_rational(7, 9) ),
       f3.evaluate(vnl_rational(7, 9) ) );
  TEST("f1-f2",
       f3.degree() == 4 && f3[4] == -1 && f3[3] == -2 &&
       f3[2] == vnl_rational(-9, 2) && f3[1] == vnl_rational(-20, 3) && f3[0] == vnl_rational(-35, 4), true);
  ...
  TEST("f2(x)-f1(x)", f2.evaluate(vnl_rational(7, 9) ) - f1.evaluate(vnl_rational(7, 9) ),
       f3.evaluate(vnl_rational(7, 9) ) );
  TEST("f2-f1",
       f3.degree() == 4 && f3[4] == 1 && f3[3] == 2 && f3[2] == vnl_rational(9, 2) && f3[1] == vnl_rational(20,
                                                                                                            3) &&
       f3[0] == vnl_rational(35, 4), true);
  ...
  TEST("f2%f1", f3.degree() == 2 && f3[2] == vnl_rational(41, 12) && f3[1] == vnl_rational(71,
                                                                                           12) &&
       f3[0] == vnl_rational(67, 8), true);
