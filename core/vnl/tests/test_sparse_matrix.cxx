...
void test_sparse_int()
{
  ...
  TEST("c1=m0*c0",
       (c1 = m0 * c0, c1.rows() == m0.rows() && c1.columns() == c0.columns() && c1.get(1111, 0) == m0(1111,
                                                                                                      2222) ), true);
  vnl_sparse_matrix<int> r0(1, 2000); r0(0, 1111) = 1;
  vnl_sparse_matrix<int> r1;
  TEST("r1=r0*m0",
       (r1 = r0 * m0, r1.rows() == r0.rows() && r1.columns() == m0.columns() && r1.get(0, 2222) == m0(1111,
                                                                                                      2222) ), true);
...
void test_sparse_float()
{
  ...
  TEST("d0=d2*5.f",
       (d0 = d2 * 5.f, (d0.get(0, 0) == 0.f && d0.get(0, 1) == 0.f && d0.get(1, 0) == 0.f && d0.get(1,
                                                                                                    1) == 15.f) ),
       true);
  TEST("d2*=5.f",  (d2 *= 5.f,  d2), d0);
  TEST("transpose",
       (d1 = d2, d2 = d1.transpose(), (d2.rows() == 4 && d2.cols() == 3 && d2.get(0, 0) == 0.f && d2.get(1,
                                                                                                         1) == 15.f) ),
       true);
}
