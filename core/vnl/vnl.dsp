...
# ADD CPP /nologo /MDd /W3 /Gm /GX /Zi /Od /Ob2 /I "$(IUEROOT)\vxl\config.win32-VC60" /I "$(IUEROOT)" /I "$(IUEROOT)/vcl" /I "$(IUEROOT)/vxl" /D "_DEBUG" /D "WIN32" /D "_MBCS" /D "_LIB" /D "_AFXDLL" /FD /GZ /c
...
SOURCE=.\Templates\vnl_sparse_matrix_instances.cxx
# End Source File
# Begin Source File
