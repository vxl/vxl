...
VNL_EXPORT int
magnitude_cmp(const vnl_bignum &, const vnl_bignum &);
VNL_EXPORT void
add(const vnl_bignum &, const vnl_bignum &, vnl_bignum &);
VNL_EXPORT void
subtract(const vnl_bignum &, const vnl_bignum &, vnl_bignum &);
VNL_EXPORT void
multiply_aux(const vnl_bignum &, unsigned short d, vnl_bignum &, unsigned short i);
VNL_EXPORT unsigned short
normalize(const vnl_bignum &, const vnl_bignum &, vnl_bignum &, vnl_bignum &);
VNL_EXPORT void
divide_aux(const vnl_bignum &, unsigned short, vnl_bignum &, unsigned short &);
VNL_EXPORT unsigned short
estimate_q_hat(const vnl_bignum &, const vnl_bignum &, unsigned short);
VNL_EXPORT unsigned short
multiply_subtract(vnl_bignum &, const vnl_bignum &, unsigned short, unsigned short);
VNL_EXPORT void
divide(const vnl_bignum &, const vnl_bignum &, vnl_bignum &, vnl_bignum &);
VNL_EXPORT vnl_bignum
...
operator<<(std::ostream & s, const vnl_bignum & r);

//: simple input
// \relatesalso vnl_bignum
VNL_EXPORT std::istream &
operator>>(std::istream & s, vnl_bignum & r);
    ...
    explicit constructor_helper(const T arg)
    {
      if (arg < 0)
      {
        ...
        constexpr auto absolute_value_of_lowest =
          static_cast<unsigned_type>(static_cast<unsigned_type>(-(lowest + 1)) + 1U);

        absolute_value = (arg == lowest) ? absolute_value_of_lowest : static_cast<unsigned_type>(-arg);
        sign = -1;
      }
      else
      {
...
public:
  ...
  vnl_bignum(const vnl_bignum &); // Copy constructor
  ...
  operator short()
  {
    return ((const vnl_bignum *)this)->operator short();
  }
  inline
  operator int()
  {
    return ((const vnl_bignum *)this)->operator int();
  }
  inline
  operator long()
  {
    return ((const vnl_bignum *)this)->operator long();
  }
  inline
  operator float()
  {
    return ((const vnl_bignum *)this)->operator float();
  }
  inline
  operator double()
  {
    return ((const vnl_bignum *)this)->operator double();
  }
  inline
  operator long double()
  {
    return ((const vnl_bignum *)this)->operator long double();
  }
  ...
  vnl_bignum &
  operator=(const vnl_bignum &); // Assignment operator

  vnl_bignum
  operator<<(int l) const; // Bit shift
  vnl_bignum
  operator>>(int l) const; // Bit shift
  vnl_bignum
  operator+(const vnl_bignum & r) const;
  inline vnl_bignum &
  operator+=(const vnl_bignum & r)
  {
  ...
  bool
  operator==(const vnl_bignum &) const; // equality
  bool
  operator<(const vnl_bignum &) const; // less than
  inline bool
  operator!=(const vnl_bignum & r) const
  {
    return !operator==(r);
  ...
  inline bool
  operator==(long double r) const
  {
    return r == this->operator long double();
  }
  inline bool
  operator!=(long double r) const
  {
  ...
  abs() const
  {
    return operator<(0L) ? operator-() : *this;
  }
  ...
  inline bool
  is_plus_infinity() const
  {
    return is_infinity() && sign == 1;
  }
  inline bool
  is_minus_infinity() const
  {
    return is_infinity() && sign == -1;
  }

  void
  dump(std::ostream & = std::cout) const; // Dump contents of vnl_bignum
  ...
  decrement(vnl_bignum & bnum);
  friend void
  multiply_aux(const vnl_bignum &, unsigned short, vnl_bignum &, unsigned short);
  ...
  right_shift(const vnl_bignum & b1, int l);
  friend std::ostream &
  operator<<(std::ostream &, const vnl_bignum &);
  friend std::istream &
  operator>>(std::istream &, vnl_bignum &);
  friend VNL_EXPORT std::string &
  vnl_bignum_to_string(std::string & s, const vnl_bignum & b);
  friend VNL_EXPORT vnl_bignum &
  vnl_bignum_from_string(vnl_bignum & b, const std::string & s);

private:
  void
  xtoBigNum(const char * s); // convert hex to vnl_bignum
  int
  dtoBigNum(const char * s); // convert decimal to vnl_bignum
  void
  otoBigNum(const char * s); // convert octal to vnl_bignum
  void
  exptoBigNum(const char * s); // convert exponential to vnl_bignum

  void
  resize(short); // Resize vnl_bignum data
  vnl_bignum &
  trim(); // Trim vnl_bignum data
};


//: Convert the number to a decimal representation in a string.
// \relatesalso vnl_bignum
VNL_EXPORT std::string &
vnl_bignum_to_string(std::string & s, const vnl_bignum & b);
...
// \relatesalso vnl_bignum
inline vnl_bignum
operator+(const vnl_bignum & r1, long r2)
{
  return r1 + vnl_bignum(r2);
}
inline vnl_bignum
operator+(const vnl_bignum & r1, int r2)
{
  return r1 + long(r2);
}
inline vnl_bignum
operator+(const vnl_bignum & r1, double r2)
{
  return r1 + vnl_bignum(r2);
}
inline vnl_bignum
operator+(const vnl_bignum & r1, long double r2)
{
  return r1 + vnl_bignum(r2);
}
inline vnl_bignum
operator+(long r2, const vnl_bignum & r1)
{
  return r1 + r2;
}
inline vnl_bignum
operator+(int r2, const vnl_bignum & r1)
{
  return r1 + r2;
}
inline vnl_bignum
operator+(double r2, const vnl_bignum & r1)
{
  return r1 + r2;
}
inline vnl_bignum
operator+(long double r2, const vnl_bignum & r1)
{
  return r1 + r2;
}
...
// \relatesalso vnl_bignum
inline vnl_bignum
operator-(const vnl_bignum & r1, const vnl_bignum & r2)
{
  return r1 + (-r2);
}
inline vnl_bignum
...
inline vnl_bignum
operator/(long r1, const vnl_bignum & r2)
{
  vnl_bignum result(r1);
  return result /= r2;
}
...
inline vnl_bignum
operator/(int r1, const vnl_bignum & r2)
{
  vnl_bignum result((long)r1);
  return result /= r2;
}

inline vnl_bignum
operator/(double r1, const vnl_bignum & r2)
{
  vnl_bignum result(r1);
  return result /= r2;
}
...
inline vnl_bignum
operator/(long double r1, const vnl_bignum & r2)
{
  vnl_bignum result(r1);
  return result /= r2;
}
...
{
  vnl_bignum result(r1);
  return result %= vnl_bignum((long)r2);
}
...
{
inline vnl_bignum
abs(const vnl_bignum & x)
{
  return x.abs();
}
inline vnl_bignum
squared_magnitude(const vnl_bignum & x)
{
  return x * x;
}
inline vnl_bignum
sqr(const vnl_bignum & x)
{
  return x * x;
}
inline bool
isnan(const vnl_bignum &)
{
  return false;
}
inline bool
isfinite(const vnl_bignum & x)
{
