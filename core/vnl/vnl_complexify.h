...
template <class T>
vnl_diag_matrix<vcl_complex<T> > vnl_complexify(vnl_diag_matrix<T> const& R);
...
template <class T>
vnl_sym_matrix<vcl_complex<T> > vnl_complexify(vnl_sym_matrix<T> const& R);
...
// \relatesalso vnl_diag_matrix
template <class T>
vnl_diag_matrix<vcl_complex<T> > vnl_complexify(vnl_diag_matrix<T> const& R, vnl_diag_matrix<T> const& I);
...
// \relatesalso vnl_diag_matrix
template <class T>
vnl_sym_matrix<vcl_complex<T> > vnl_complexify(vnl_sym_matrix<T> const& R, vnl_sym_matrix<T> const& I);
