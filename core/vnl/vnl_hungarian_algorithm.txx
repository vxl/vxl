...
template <class T>
void
vnl_hungarian_algorithm<T>::SetCostMatrix( vnl_matrix<T> const& cost_in )
{
  m_Cost_in = cost_in;
  m_TotalCost = 0;
...
template <class T>
void
vnl_hungarian_algorithm<T>::clear_vector( vcl_vector<bool>& v )
{
...
#endif // vnl_hungarian_algorithm_txx_
