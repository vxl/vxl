...
#include <vcl_config_compiler.h> //for VCL_CONSTEXPR definition
...
{
  //: pi, e and all that
  static VCL_CONSTEXPR double e                = 2.71828182845904523536;
  static VCL_CONSTEXPR double log2e            = 1.44269504088896340736;
  static VCL_CONSTEXPR double log10e           = 0.43429448190325182765;
  static VCL_CONSTEXPR double ln2              = 0.69314718055994530942;
  static VCL_CONSTEXPR double ln10             = 2.30258509299404568402;
  static VCL_CONSTEXPR double pi               = 3.14159265358979323846;
  static VCL_CONSTEXPR double twopi            = 6.28318530717958647692;
  static VCL_CONSTEXPR double pi_over_2        = 1.57079632679489661923;
  static VCL_CONSTEXPR double pi_over_4        = 0.78539816339744830962;
  static VCL_CONSTEXPR double pi_over_180      = 0.01745329251994329577;
  static VCL_CONSTEXPR double one_over_pi      = 0.31830988618379067154;
  static VCL_CONSTEXPR double two_over_pi      = 0.63661977236758134308;
  static VCL_CONSTEXPR double deg_per_rad      = 57.2957795130823208772;
  static VCL_CONSTEXPR double sqrt2pi          = 2.50662827463100024161;
  static VCL_CONSTEXPR double two_over_sqrtpi  = 1.12837916709551257390;
  static VCL_CONSTEXPR double one_over_sqrt2pi = 0.39894228040143267794;
  static VCL_CONSTEXPR double sqrt2            = 1.41421356237309504880;
  static VCL_CONSTEXPR double sqrt1_2          = 0.70710678118654752440;
  static VCL_CONSTEXPR double sqrt1_3          = 0.57735026918962573106;
  static VCL_CONSTEXPR double euler            = 0.57721566490153286061;

  //: IEEE double machine precision
  static VCL_CONSTEXPR double eps              = 2.2204460492503131e-16;
  static VCL_CONSTEXPR double sqrteps          = 1.490116119384766e-08;
  //: IEEE single machine precision
  static VCL_CONSTEXPR float  float_eps        = 1.192092896e-07f;
  static VCL_CONSTEXPR float  float_sqrteps    = 3.4526698307e-4f;
