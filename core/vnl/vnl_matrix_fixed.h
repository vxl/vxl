...
VCL_TEMPLATE_EXPORT template <class T, unsigned int num_rows, unsigned int num_cols>
...
template <class T, unsigned M, unsigned N, unsigned O>
inline
vnl_matrix_fixed<T, M, O> vnl_matrix_fixed_mat_mat_mult(const vnl_matrix_fixed<T, M, N>& a, const vnl_matrix_fixed<T, N,
                                                                                                                   O>& b);
