...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix<T>
vnl_matrix_fixed_ref_const<T,nrows,ncols>::extract (vxl::indexsize_t rowz, vxl::indexsize_t colz,
                                                    vxl::indexsize_t top, vxl::indexsize_t left) const
{
#ifndef NDEBUG
...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix_fixed_ref<T,nrows,ncols> const&
vnl_matrix_fixed_ref<T,nrows,ncols>::scale_row(vxl::indexsize_t row_index, T value) const
{
#ifndef NDEBUG
  if (row_index >= nrows)
...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix_fixed_ref<T,nrows,ncols> const&
vnl_matrix_fixed_ref<T,nrows,ncols>::scale_column(vxl::indexsize_t column_index, T value) const
{
#ifndef NDEBUG
...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix<T>
vnl_matrix_fixed_ref_const<T,nrows,ncols>::get_n_rows (vxl::indexsize_t row, vxl::indexsize_t n) const
{
#ifndef NDEBUG
  if (row + n > nrows)
...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix<T>
vnl_matrix_fixed_ref_const<T,nrows,ncols>::get_n_columns (vxl::indexsize_t column, vxl::indexsize_t n) const
{
#ifndef NDEBUG
  if (column + n > ncols)
...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix_fixed_ref<T,nrows,ncols> const&
vnl_matrix_fixed_ref<T,nrows,ncols>::set_row(vxl::indexsize_t row_index, T const *v) const
{
  for (vxl::indexsize_t j = 0; j < ncols; j++)
...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix_fixed_ref<T,nrows,ncols> const&
vnl_matrix_fixed_ref<T,nrows,ncols>::set_row(vxl::indexsize_t row_index, vnl_vector_fixed<T,ncols> const &v) const
{
...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix_fixed_ref<T,nrows,ncols> const&
vnl_matrix_fixed_ref<T,nrows,ncols>::set_row(vxl::indexsize_t row_index, vnl_vector<T> const &v) const
{
  set_row(row_index,v.data_block());
  return *this;
}
...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix_fixed_ref<T,nrows,ncols> const&
vnl_matrix_fixed_ref<T,nrows,ncols>::set_row(vxl::indexsize_t row_index, T v) const
{
  for (vxl::indexsize_t j = 0; j < ncols; j++)
    (*this)(row_index,j) = v;
  return *this;
...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix_fixed_ref<T,nrows,ncols> const&
vnl_matrix_fixed_ref<T,nrows,ncols>::set_column(vxl::indexsize_t column_index, T const *v) const
{
  for (vxl::indexsize_t i = 0; i < nrows; i++)
...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix_fixed_ref<T,nrows,ncols> const&
vnl_matrix_fixed_ref<T,nrows,ncols>::set_column(vxl::indexsize_t column_index, vnl_vector_fixed<T,nrows> const &v) const
{
...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix_fixed_ref<T,nrows,ncols> const&
vnl_matrix_fixed_ref<T,nrows,ncols>::set_column(vxl::indexsize_t column_index, vnl_vector<T> const &v) const
{
  set_column(column_index,v.data_block());
  return *this;
}
...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix_fixed_ref<T,nrows,ncols> const&
vnl_matrix_fixed_ref<T,nrows,ncols>::set_column(vxl::indexsize_t column_index, T v) const
{
  for (vxl::indexsize_t j = 0; j < nrows; j++)
...
template<class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
vnl_matrix_fixed_ref<T,nrows,ncols> const&
vnl_matrix_fixed_ref<T,nrows,ncols>::set_columns(vxl::indexsize_t starting_column, vnl_matrix<T> const& m) const
{
#ifndef NDEBUG
  if (nrows != m.rows() ||
  ...
  for (vxl::indexsize_t j = 0; j < m.cols(); ++j)
    for (vxl::indexsize_t i = 0; i < nrows; i++)
...
template <class T, vxl::indexsize_t nrows, vxl::indexsize_t ncols>
void
vnl_matrix_fixed_ref_const<T,nrows,ncols>::assert_size_internal(vxl::indexsize_t rs,vxl::indexsize_t cs) const
{
