...
template <class T>
vnl_matrix<T>
vnl_rank_row_reduce(const vnl_matrix<T> & mat, vnl_rank_pivot_type t)
{
  vnl_matrix<T> a = mat;
  bool changed = true;
    ...
    for (unsigned int r = 0; r < m; ++r)
    {
      ...
      for (unsigned int s = 0; s < m; ++s)
      {
        ...
        for (unsigned int d = 0; d < n; ++d)
          if (d != c)
            a[s][d] -= a[r][d] * a[r][c] * a[s][c];
        a[s][c] = T(0);
        changed = true;
      }
    }
  }
  if (t == vnl_rank_pivot_one)
    return a;
  changed = true;
  while (changed)
  {
...
template <class T>
vnl_matrix<T>
vnl_rank_column_reduce(const vnl_matrix<T> & mat, vnl_rank_pivot_type t)
{
  vnl_matrix<T> a = mat;
  bool changed = true;
  unsigned int m = a.rows();
...
template <class T>
vnl_matrix<T>
vnl_rank_row_column_reduce(const vnl_matrix<T> & mat, vnl_rank_pivot_type t)
{
  vnl_matrix<T> a = mat;
  bool changed = true;
  unsigned int m = a.rows();
...
template <class T>
unsigned int
vnl_rank(const vnl_matrix<T> & mat, vnl_rank_type t)
{
  unsigned int rank = 0;
  if (t == vnl_rank_row)
  {
