...
vnl_matrix<T> vnl_rank_row_reduce(vnl_matrix<T> const& mat, vnl_rank_pivot_type t)
{
  ...
  while( changed )
    ...
    for( unsigned int r = 0; r < m; ++r )
      {
      unsigned int c = 0; while( c < n && a[r][c] != 1 && a[r][c] != -1 )
        {
        ++c;
        }
  ...
  while( changed )
    ...
    for( unsigned int r = 0; r < m; ++r )
      {
      unsigned int c = 0; while( c < n && a[r][c] == 0 )
        {
        ++c;
        }
...
vnl_matrix<T> vnl_rank_column_reduce(vnl_matrix<T> const& mat, vnl_rank_pivot_type t)
{
  ...
  while( changed )
    ...
    for( unsigned int c = 0; c < n; ++c )
      {
      unsigned int r = 0; while( r < m && a[r][c] != 1 && a[r][c] != -1 )
        {
        ++r;
        }
  ...
  while( changed )
    ...
    for( unsigned int c = 0; c < n; ++c )
      {
      unsigned int r = 0; while( r < m && a[r][c] == 0 )
        {
        ++r;
        }
