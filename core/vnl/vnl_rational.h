...
public:
  ...
  template <typename T>
  using enable_if_signed_integral_type =
  ...
  //  Copy constructor
  inline vnl_rational(const vnl_rational & from)
    : num_(from.numerator())
    , den_(from.denominator())
  {}
  //  Destructor
  inline ~vnl_rational() = default;
  //  Assignment: overwrite an existing vnl_rational
  inline void
  set(int_type num, int_type den)
  {
    assert(num != 0 || den != 0);
    num_ = num;
    den_ = den;
  ...
  inline vnl_rational &
  operator=(const vnl_rational & rhs)
  {
    num_ = rhs.numerator();
    den_ = rhs.denominator();
    return *this;
  }

  //: Returns true if the two rationals have the same representation
  inline bool
  operator==(const vnl_rational & rhs) const
  {
  ...
  inline vnl_rational &
  operator+=(const vnl_rational & r)
  {
    if (den_ == r.denominator())
      num_ += r.numerator();
    else
    {
      int_type c = vnl_rational::gcd(den_, r.denominator());
      if (c == 0)
        c = 1;
  ...
  inline bool
  operator>(const vnl_rational & r) const
  {
    return r < *this;
  }
  inline bool
...
inline std::ostream &
operator<<(std::ostream & s, const vnl_rational & r)
{
...
// \relatesalso vnl_rational
inline vnl_rational
operator+(const vnl_rational & r1, const vnl_rational & r2)
{
  vnl_rational result(r1);
  return result += r2;
}

inline vnl_rational
operator+(const vnl_rational & r1, vnl_rational::int_type r2)
{
  vnl_rational result(r1);
  return result += r2;
}
...
inline vnl_rational
operator+(const vnl_rational & r1, const T r2)
{
  vnl_rational result(r1);
  return result += vnl_rational::int_type{ r2 };
}

inline vnl_rational
operator+(vnl_rational::int_type r2, const vnl_rational & r1)
{
  vnl_rational result(r1);
  return result += r2;
}
...
template <typename T, typename SFINAE = vnl_rational::enable_if_signed_integral_type<T>>
inline vnl_rational
operator+(const T r2, const vnl_rational & r1)
{
  vnl_rational result(r1);
  return result += vnl_rational::int_type{ r2 };
}
...
inline vnl_rational
operator/(vnl_rational::int_type r1, const vnl_rational & r2)
{
  vnl_rational result(r1);
  return result /= r2;
}
...
template <typename T, typename SFINAE = vnl_rational::enable_if_signed_integral_type<T>>
inline vnl_rational
operator/(const T r1, const vnl_rational & r2)
{
  vnl_rational result(vnl_rational::int_type{ r1 });
  return result /= r2;
}
...
inline vnl_rational::int_type
truncate(const vnl_rational & r)
{
  return r.truncate();
}
inline vnl_rational::int_type
floor(const vnl_rational & r)
{
  return r.floor();
}
inline vnl_rational::int_type
ceil(const vnl_rational & r)
{
  return r.ceil();
}
inline vnl_rational::int_type
round(const vnl_rational & r)
{
  return r.round();
}
...
{
inline vnl_rational
abs(const vnl_rational & x)
{
  return x < 0L ? -x : x;
}
inline vnl_rational
squared_magnitude(const vnl_rational & x)
{
  return x * x;
}
inline vnl_rational
sqr(const vnl_rational & x)
{
  return x * x;
}
inline bool
isnan(const vnl_rational &)
{
  return false;
}
inline bool
isfinite(const vnl_rational & x)
{
  return x.denominator() != 0L;
}
} // namespace vnl_math
