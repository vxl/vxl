...
void test_gaussian_sphere_type(T epsilon, const vcl_string& type_name)
{
  ...
  // cumulative probability, box probability
  {
    ...
    cum_test1[0] = (1+vnl_erf((test1[0]-mean[0])/vcl_sqrt(2*var)))/2;
    cum_test1[1] = (1+vnl_erf((test1[1]-mean[1])/vcl_sqrt(2*var)))/2;
    cum_test1[2] = (1+vnl_erf((test1[2]-mean[2])/vcl_sqrt(2*var)))/2;
    ...
    cum_test2[0] = (1+vnl_erf((test2[0]-mean[0])/vcl_sqrt(2*var)))/2;
    cum_test2[1] = (1+vnl_erf((test2[1]-mean[1])/vcl_sqrt(2*var)))/2;
    cum_test2[2] = (1+vnl_erf((test2[2]-mean[2])/vcl_sqrt(2*var)))/2;
