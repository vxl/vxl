...
template <class T>
void
test_update_mog_type(T epsilon, const std::string & type_name, T inf)
{
  ...
  TEST_NEAR(
    "cumulative prob at minus inf", mixture.cumulative_prob(vnl_vector_fixed<T, 3>(-inf, -inf, -inf)), 0, epsilon);
