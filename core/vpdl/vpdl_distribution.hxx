...
public:
  ...
  invert(const vpdl_distribution<T, n> & /*dist*/, const T & /*p*/)
  {
...
public:
  ...
  //: Do the actual inversion
  static inline vector
  invert(const vpdl_distribution<T, 1> & dist, const T & p)
  {
...
public:
  ...
  //: Do the actual inversion
  static inline vector
  invert(const vpdl_distribution<T, 0> & dist, const T & /*p*/)
  {
...
template <class T, unsigned int n>
T
vpdl_distribution<T, n>::box_prob(const vector & min_pt, const vector & max_pt) const
{
