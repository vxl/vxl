...
template <class T>
inline unsigned int
vpdt_size(const vnl_vector<T> & v)
{
  return v.size();
}
...
template <class T>
inline unsigned int
vpdt_size(const vnl_matrix<T> & m)
{
...
inline unsigned int
vpdt_size(const vnl_vector_fixed<T, n> & /*v*/)
{
  return n;
}
...
template <class T, unsigned int n>
inline unsigned int
vpdt_size(const vnl_matrix_fixed<T, n, n> & /*m*/)
{
  return n;
}
...
template <class T>
inline void
vpdt_set_size(vnl_vector<T> & v, unsigned int s)
{
  v.set_size(s);
}
...
template <class T>
inline void
vpdt_set_size(vnl_matrix<T> & m, unsigned int s)
{
  m.set_size(s, s);
}
...
template <class T>
inline void
vpdt_set_size(T & /*v*/, unsigned int /*s*/)
{}
...
template <class T>
inline void
vpdt_fill(vnl_vector<T> & v, const T & val)
{
  v.fill(val);
}
...
template <class T>
inline void
vpdt_fill(vnl_matrix<T> & m, const T & val)
{
  m.fill(val);
}
...
template <class T, unsigned int n>
inline void
vpdt_fill(vnl_vector_fixed<T, n> & v, const T & val)
{
  v.fill(val);
}
...
template <class T, unsigned int n>
inline void
vpdt_fill(vnl_matrix_fixed<T, n, n> & m, const T & val)
{
  m.fill(val);
}
...
template <class T>
inline T &
vpdt_index(vnl_vector<T> & v, unsigned int i)
{
  assert(i < v.size());
  return v[i];
}
...
template <class T>
inline const T &
vpdt_index(const vnl_vector<T> & v, unsigned int i)
{
  assert(i < v.size());
  return v[i];
}
...
template <class T, unsigned int n>
inline T &
vpdt_index(vnl_vector_fixed<T, n> & v, unsigned int i)
{
  assert(i < n);
  return v[i];
}
...
template <class T, unsigned int n>
inline const T &
vpdt_index(const vnl_vector_fixed<T, n> & v, unsigned int i)
{
  assert(i < n);
  return v[i];
}
...
template <class T>
inline const T &
vpdt_index(const T & v, unsigned int /*i*/)
{
  return v;
}
...
template <class T>
inline T &
vpdt_index(vnl_matrix<T> & v, unsigned int i, unsigned int j)
{
  assert(i < v.rows() && j < v.columns());
  return v(i, j);
}
//: Index into a vnl_matrix (const)
template <class T>
inline const T &
vpdt_index(const vnl_matrix<T> & v, unsigned int i, unsigned int j)
{
  assert(i < v.rows() && j < v.columns());
  return v(i, j);
}
...
template <class T, unsigned int n>
inline T &
vpdt_index(vnl_matrix_fixed<T, n, n> & v, unsigned int i, unsigned int j)
{
  assert(i < n && j < n);
  return v(i, j);
}
...
template <class T, unsigned int n>
inline const T &
vpdt_index(const vnl_matrix_fixed<T, n, n> & v, unsigned int i, unsigned int j)
{
  assert(i < n && j < n);
  return v(i, j);
}
...
template <class T>
inline T &
vpdt_index(T & v, unsigned int /*i*/, unsigned int /*j*/)
{
  return v;
}
//: Index into a scalar (const)
template <class T>
inline const T &
vpdt_index(const T & v, unsigned int /*i*/, unsigned int /*j*/)
{
  return v;
}
...
inline float
outer_product(const float & v1, const float & v2)
{
  return v1 * v2;
}
inline double
outer_product(const double & v1, const double & v2)
{
  return v1 * v2;
}
