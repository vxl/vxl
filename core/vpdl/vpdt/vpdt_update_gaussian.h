...
//: Specialized classes to update covariance of different types
template <class F>
struct vpdt_update_covariance<F,
                              ...
                              typename vpdt_field_traits<F>::type_is_vector>
{
  ...
  static inline void
  increment(Covar & c, const T & s, const vector & d)
  {
  ...
  static inline void
  enforce_min(Covar & c, const T & min_var)
  {
...
template <class F>
struct vpdt_update_covariance<F,
                              typename vpdt_field_traits<F>::vector_type,
                              typename vpdt_field_traits<F>::type_is_vector>
{
  //: the data type used for scalars
  typedef typename vpdt_field_traits<F>::scalar_type T;
  ...
  //: update the covariance matrix with a weighted vector difference
  static inline void
  increment(vector & c, const T & s, const vector & d)
  {
  ...
  //: enforce a minimum covariance value in all dimensions
  static inline void
  enforce_min(vector & c, const T & min_var)
  {
                              ...
                              typename vpdt_field_traits<F>::type_is_vector>
{
  ...
  //: update the covariance matrix with a weighted vector difference
  static inline void
  increment(T & c, const T & s, const vector & d)
  {
    c += s * dot_product(d, d);
  }
  ...
  //: enforce a minimum covariance value in all dimensions
  static inline void
  enforce_min(T & c, const T & min_var)
  {
    if (c < min_var)
      c = min_var;
  }
                              ...
                              typename vpdt_field_traits<F>::type_is_scalar>
{
  ...
  //: update the covariance matrix with a weighted vector difference
  static inline void
  increment(T & c, const T & s, const T & d)
  {
    c += s * d * d;
  }
...
void
vpdt_update_gaussian(vpdt_gaussian<F, Covar> & gaussian,
