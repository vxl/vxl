...
test_rational_adjust_onept()
{
  ...
  double neu_u2[20] = { -1.45002e-005,
                        ...
                        0.00335227,
                        -0.00171778 };
  double den_u2[20] = { -1.11389e-007, 1.12986e-007,  2.60026e-008,  1.37888e-006,
  ...
  double neu_v2[20] = { -1.34506e-007, 3.30571e-006,  1.12006e-007,  -0.000720573, 2.18505e-005,
  ...
  good = vpgl_rational_adjust_onept::adjust(cams, corrs, cam_trans, intersection);
  TEST("vpgl_rational_adjust_onept::adjust", good, true);
  std::cout << "3-d intersection point " << intersection << '\n';
  for (unsigned i = 0; i < 2; ++i)
    std::cout << "T[" << i << "] " << cam_trans[i] << '\n';
...
TESTMAIN(test_rational_adjust_onept);
