...
static void
get_cams_and_pts(std::vector<vgl_point_2d<double>> & points, std::vector<vpgl_perspective_camera<double>> & cameras)
{

  add_pt_and_cam(vgl_homg_point_3d<double>(0.0, 1.0, 1.0), vgl_vector_3d<double>(-1.0, 1.0, 1.0), points, cameras);

  add_pt_and_cam(vgl_homg_point_3d<double>(1.0, 0.0, 1.0), vgl_vector_3d<double>(1.0, -1.0, 1.0), points, cameras);

  add_pt_and_cam(vgl_homg_point_3d<double>(1.0, 1.0, 0.0), vgl_vector_3d<double>(1.0, 1.0, -1.0), points, cameras);

  add_pt_and_cam(vgl_homg_point_3d<double>(1.0, 1.0, 1.0), vgl_vector_3d<double>(0.0, 0.0, 0.0), points, cameras);
}
