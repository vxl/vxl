...
public:
  ...
  void fill_camera_from_params(const vnl_vector<double>& params){
    vnl_matrix_fixed<double, 3, 4> Ma(0.0);
    Ma[0][0] = params[0]; Ma[0][1] = params[1]; Ma[0][2] = params[2]; Ma[0][3] = params[3];
    Ma[1][0] = params[4]; Ma[1][1] = params[5]; Ma[1][2] = params[6]; Ma[1][3] = params[7]; Ma[2][3] = 1.0;
    Ca_.set_matrix(Ma);
  }
  //: The robust estimate
