...
vpgl_affine_camera<double> *
vpgl_affine_rectification::compute_affine_cam(const std::vector<vgl_point_2d<double>> & image_pts,
                                            ...
                                            vpgl_affine_fundamental_matrix<double> & FA)
{
  ...
  /*if (std::abs(FA.get_matrix()[0][0]) > 10*std::numeric_limits<double>::epsilon() ||
      ...
      std::cerr << "In vpgl_affine_rectification::compute_affine_f() -- the computed matrix is not an affine fundamental
  matrix! the input cameras may have not been affine cameras!\n"; return false;
  }*/
                                                 ...
                                                 vnl_matrix_fixed<double, 3, 3> & H2)
{
  ...
  H2[0][0] = scaling[0] * H2[0][0];
  H2[0][1] = scaling[0] * H2[0][1];
  H2[1][0] = scaling[0] * H2[1][0];
  H2[1][1] = scaling[0] * H2[1][1];
  ...
  vnl_matrix_fixed<double, 3, 3> interm;
  interm.set_identity();
