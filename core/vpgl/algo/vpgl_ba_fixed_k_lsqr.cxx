...
void
vpgl_ba_fixed_k_lsqr::jac_Aij(unsigned int i,
                              unsigned int /*j*/,
...
void
vpgl_ba_fixed_k_lsqr::jac_Bij(unsigned int /*i*/,
                              unsigned int /*j*/,
                              const vnl_double_3x4 & Pi,
                              const vnl_vector<double> & /*ai*/,
                              const vnl_vector<double> & bj,
...
void
vpgl_ba_fixed_k_lsqr::jac_Cij(unsigned int /*i*/,
                              unsigned int /*j*/,
                              const vnl_double_3x4 & /*Pi*/,
                              const vnl_vector<double> & /*ai*/,
                              const vnl_vector<double> & /*bj*/,
...
//: construct the \param j-th perspective camera from a pointer to the j-th parameters of \param b and parameters \param
// c
vgl_homg_point_3d<double>
vpgl_ba_fixed_k_lsqr::param_to_point(int /*j*/, const double * bj, const vnl_vector<double> & /*c*/) const
{
...
vpgl_ba_fixed_k_lsqr::param_to_pt_vector(int /*j*/, const double * bj, const vnl_vector<double> & /*c*/) const
{
  return vnl_vector_fixed<double, 4>(bj[0], bj[1], bj[2], 1.0);
}

//: construct the \param i-th perspective camera from a pointer to the i-th parameters of \param a and parameters \param
// c
...
//\param c
vnl_double_3x4
vpgl_ba_fixed_k_lsqr::param_to_cam_matrix(int i, const double * ai, const vnl_vector<double> & /*c*/) const
{
