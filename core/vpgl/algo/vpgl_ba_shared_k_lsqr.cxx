...
//: Constructor
vpgl_ba_shared_k_lsqr::vpgl_ba_shared_k_lsqr(const vpgl_calibration_matrix<double> & K,
...
//: construct the \param j-th perspective camera from a pointer to the j-th parameter of \param b and parameters \param
// c
vgl_homg_point_3d<double>
vpgl_ba_shared_k_lsqr::param_to_point(int /*j*/, const double * bj, const vnl_vector<double> & /*c*/) const
{
...
vpgl_ba_shared_k_lsqr::param_to_pt_vector(int /*j*/, const double * bj, const vnl_vector<double> & /*c*/) const
{
  return vnl_vector_fixed<double, 4>(bj[0], bj[1], bj[2], 1.0);
}

//: construct the \param i-th perspective camera from a pointer to the i-th parameter of \param a and parameters \param
// c
...
//: compute a 3x4 camera matrix of camera \param i from a pointer to the i-th parameters of \param a and parameters
//\param c
vnl_double_3x4
vpgl_ba_shared_k_lsqr::param_to_cam_matrix(int /*i*/, const double * ai, const vnl_vector<double> & c) const
{
  Km_(0, 0) = c[0];
  Km_(1, 1) = c[0] * K_.y_scale();
...
void
vpgl_ba_shared_k_lsqr::create_param_vector(const std::vector<vpgl_perspective_camera<double>> & cameras,
                                           vnl_vector<double> & a,
                                           vnl_vector<double> & c)
{
