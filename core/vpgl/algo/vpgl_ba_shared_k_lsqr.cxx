...
void
vpgl_ba_shared_k_lsqr::create_param_vector(const vcl_vector<vpgl_perspective_camera<double> >& cameras,
                                           vnl_vector<double>& a,
                                           vnl_vector<double>& c)
{
...
vnl_vector<double>
vpgl_ba_shared_k_lsqr::create_param_vector(const vcl_vector<vgl_point_3d<double> >& world_points)
{
