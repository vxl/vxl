...
public:
  ...
  vpgl_backproject_dem(const vil_image_resource_sptr & dem, double zmin = 0.0, double zmax = -1.0);
  ...
  bool
  bproj_dem(const vpgl_camera<double> * cam,
  ...
  bool
  bproj_dem(const vpgl_rational_camera<double> & rcam,
            const vnl_double_2 & image_point,
            double max_z,
            double min_z,
            const vnl_double_3 & initial_guess,
