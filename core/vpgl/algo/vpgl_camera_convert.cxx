...
bool vpgl_generic_camera_convert::pyramid_est(vpgl_local_rational_camera<double> const& rat_cam,
                                              ...
                                              vcl_vector<unsigned int> scl,
                                              vcl_vector<vbl_array_2d<vgl_ray_3d<double> > > & ray_pyr )
                                           ...
                                           double local_z_min, double local_z_max, unsigned level)
{
  ...
  for( unsigned int bigi = 0; bigi <= numi; bigi++ )
    ...
    for( unsigned int bigj = 0; bigj <= numj; bigj++ )
      ...
      if( !vpgl_generic_camera_convert::pyramid_est(rat_cam, ni, nj, offseti, offsetj, local_z_min, local_z_max,
                                                    n_levels, nr, nc, scl, ray_pyr ) )
        {
        return false;
        }
...
#endif
#if 1
bool vpgl_generic_camera_convert::convert_bruteforce( vpgl_local_rational_camera<double> const& rat_cam,
                                                      int gni, int gnj, vpgl_generic_camera<double> & gen_cam,
                                                      double local_z_min, double local_z_max, unsigned level)
{
  vgl_plane_3d<double> high(0.0, 0.0, 1.0, -local_z_max);
...
#endif
bool vpgl_generic_camera_convert::convert( vpgl_proj_camera<double> const& prj_cam, int ni, int nj,
                                           vpgl_generic_camera<double> & gen_cam, unsigned level)
{
  ...
  double                            scale =
    (level < 32) ? double(1L << level) : vcl_pow(2.0, static_cast<double>(level) );
  for( int j = 0; j < nj; ++j )
    {
    for( int i = 0; i < ni; ++i )
      {
...
bool vpgl_generic_camera_convert::convert( vpgl_perspective_camera<double> const& per_cam, int ni, int nj,
                                           vpgl_generic_camera<double> & gen_cam, unsigned level)
{
  vbl_array_2d<vgl_ray_3d<double> > rays(nj, ni);
  vgl_ray_3d<double>                ray;
...
bool vpgl_generic_camera_convert::convert_with_margin( vpgl_perspective_camera<double> const& per_cam, int ni, int nj,
                                                       vpgl_generic_camera<double> & gen_cam, int margin,
                                                       unsigned level)
{
...
bool vpgl_generic_camera_convert::convert( vpgl_affine_camera<double> const& aff_cam, int ni, int nj,
                                           vpgl_generic_camera<double> & gen_cam, unsigned level)
{
...
bool vpgl_generic_camera_convert::convert( vpgl_camera_double_sptr const& camera, int ni, int nj,
                                           vpgl_generic_camera<double> & gen_cam, unsigned level)
{
