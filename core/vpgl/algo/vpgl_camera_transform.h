...
class vpgl_camera_transform_f : public vnl_least_squares_function
{
 public:
  ...
  virtual void compute_cams_selective(vnl_vector<double> const& x, vcl_vector<vpgl_perspective_camera<double> >& output_cams);
...
class vpgl_camera_transform
{
 public:
  ...
  static void normalize_img_pts(const vcl_vector<vpgl_perspective_camera<double> >& input_cams,
                                ...
                                vcl_vector< vcl_vector < vcl_pair<vnl_vector_fixed<double, 2>, unsigned> > >& cam_ids_img_pts_norm);

  //: normalize the points using the inverse of the K matrix 
  static void K_normalize_img_pts(const vcl_vector<vpgl_perspective_camera<double> >& input_cams, vnl_matrix_fixed<double, 3, 3> const& input_correspondence_covariance,
                                const vcl_vector< vcl_vector < vcl_pair<vnl_vector_fixed<double, 2>, unsigned> > >& cam_ids_img_pts,
