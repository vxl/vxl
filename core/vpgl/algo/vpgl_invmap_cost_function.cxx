...
void vpgl_invmap_cost_function::set_params(vnl_vector_fixed<double, 3> const& xyz, vnl_vector_fixed<double, 2> & x)
{
  switch( pp_ )
    {
    case X_Y:
...
void vpgl_invmap_cost_function::set_params(vnl_vector_fixed<double, 3> const& xyz, vnl_vector<double> & x)
{
...
void vpgl_invmap_cost_function::point_3d(vnl_vector_fixed<double, 2> const& x, vnl_vector_fixed<double, 3>& xyz)
{
...
void vpgl_invmap_cost_function::point_3d(vnl_vector<double> const& x, vnl_vector_fixed<double, 3>& xyz)
{
