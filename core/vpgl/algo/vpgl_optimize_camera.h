...
//: this class optimizes the rotation of a perspective camera given an initial estimate and a known internal calibration
//: and position
...
//: this class optimizes the rotation/translation of a perspective camera given an initial estimate and a known internal
//: calibration
...
public:
  ...
  void
  gradf(const vnl_vector<double> & x, vnl_matrix<double> & jacobian) override;
