...
public:
  ...
  vpgl_adjust_lsqr(vpgl_rational_camera<double>  const& rcam, vcl_vector<vgl_point_2d<double> > const& img_pts,
                   vcl_vector<vgl_point_3d<double> > const& geo_pts, unsigned num_unknowns, unsigned num_residuals);
...
public:
  ...
  static bool adjust(vpgl_rational_camera<double> const& initial_rcam, vcl_vector<vgl_point_2d<double> > img_pts,
                     vcl_vector<vgl_point_3d<double> > geo_pts, vpgl_rational_camera<double> & adj_rcam);
