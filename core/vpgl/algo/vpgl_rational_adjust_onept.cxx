...
bool vpgl_rational_adjust_onept::find_intersection_point(vcl_vector<vpgl_rational_camera<double> > const& cams,
                                                         vcl_vector<float> const& cam_weights,
...
bool vpgl_rational_adjust_onept::refine_intersection_pt(vcl_vector<vpgl_rational_camera<double> > const& cams,
                                                        vcl_vector<float> const& cam_weights,
                                                        vcl_vector<vgl_point_2d<double> > const& image_pts,
                                                        vgl_point_3d<double> const& initial_pt,
...
bool vpgl_rational_adjust_onept::adjust(vcl_vector<vpgl_rational_camera<double> > const& cams,
                                        vcl_vector<vgl_point_2d<double> > const& corrs,
...
bool vpgl_rational_adjust_onept::adjust_with_weights(vcl_vector<vpgl_rational_camera<double> > const& cams,
