...
//:
// \file
// \brief Determines the 3D location of a point in world space given the 2D location of the point as seen by a
...
public:
  ...
  static double
  triangulate(const std::vector<vgl_point_2d<double>> & points,
