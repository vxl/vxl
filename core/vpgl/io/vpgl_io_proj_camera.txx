...
template <class T>
void vsl_print_summary(vcl_ostream& os,const vpgl_proj_camera<T> & c)
{
  os << c << '\n';
}
...
template void vsl_print_summary(vcl_ostream& os,const vpgl_proj_camera<T > & b)

#endif // vpgl_io_proj_camera_txx_
