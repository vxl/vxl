...
vpgl_calibration_matrix<T>::get_matrix() const
{
...
template <class T>
void
vpgl_calibration_matrix<T>::set_focal_length(T new_focal_length)
{
...
template <class T>
void
vpgl_calibration_matrix<T>::set_principal_point(const vgl_point_2d<T> & new_principal_point)
{
...
template <class T>
void
vpgl_calibration_matrix<T>::set_x_scale(T new_x_scale)
{
...
template <class T>
void
vpgl_calibration_matrix<T>::set_y_scale(T new_y_scale)
{
...
template <class T>
void
vpgl_calibration_matrix<T>::set_skew(T new_skew)
{
  skew_ = new_skew;
}
...
template <class T>
bool
vpgl_calibration_matrix<T>::operator==(const vpgl_calibration_matrix<T> & that) const
{
  if (this == &that) // same object => equal.
    return true;

  return this->focal_length_ == that.focal_length_ && this->principal_point_ == that.principal_point_ &&
         this->x_scale_ == that.x_scale_ && this->y_scale_ == that.y_scale_ && this->skew_ == that.skew_;
}
...
template <class T>
vgl_point_2d<T>
vpgl_calibration_matrix<T>::map_to_focal_plane(const vgl_point_2d<T> & p_image) const
{
...
template <class T>
vgl_point_2d<T>
vpgl_calibration_matrix<T>::map_to_image(const vgl_point_2d<T> & p_focal_plane) const
{
