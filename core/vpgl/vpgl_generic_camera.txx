...
// ------------------------------------------
template <class T>
vpgl_generic_camera<T>::vpgl_generic_camera( vcl_vector<vbl_array_2d<vgl_ray_3d<T> > > const& rays,
...
template <class T>
void vpgl_generic_camera<T>::refine_ray_at_point(int nearest_c, int nearest_r,
                                                 vgl_point_3d<T> const& p,
...
template <class T>
void vpgl_generic_camera<T>::refine_projection(int nearest_c, int nearest_r, vgl_point_3d<T> const& p,
                                               T& u, T& v) const
{
