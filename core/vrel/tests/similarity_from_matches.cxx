...
bool
similarity_from_matches::fit_from_minimal_set(const std::vector<int> & match_indices, vnl_vector<double> & params) const
{
  assert(match_indices.size() == 2);
  if (matches_[match_indices[0]].point_id_ == matches_[match_indices[1]].point_id_ ||
      (matches_[match_indices[0]].to_loc_ - matches_[match_indices[1]].to_loc_).squared_magnitude() < 1.0e-6)
  {
...
void
similarity_from_matches::compute_residuals(const vnl_vector<double> & params, std::vector<double> & residuals) const
{
                                         ...
                                         std::vector<double> & weights) const
{
  ...
  vrel_estimation_problem::compute_weights(residuals, obj, scale, weights);
                                                    ...
                                                    const std::vector<double> * weights) const
{
  ...
  vnl_matrix_fixed<double, 2, 4> Xi(0.0);
  Xi(0, 2) = Xi(1, 3) = 1.0;
