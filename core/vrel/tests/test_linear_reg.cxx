...
test_linear_reg()
{
  ...
  //
  auto * lr1 = new vrel_linear_regression(pts, true);
  ...
  auto * lr2 = new vrel_linear_regression(pts, false);
  ...
  point_indices[2] = 5;
  TEST("fit_from_minimal_sample (2)",
       lr3->fit_from_minimal_set(point_indices, par) && close((par - true_params).magnitude(), 0),
       true);
