// This is core/vrel/tests/test_lms_lts.cxx
...
test_lms_lts()
{
  ...
  double obj = lms1->fcn(test_lms.begin(), test_lms.end(), 0.0, nullptr);
  ...
  corr_obj = vnl_math::sqr(-1.0) + vnl_math::sqr(-2.0) + vnl_math::sqr(1.2) + vnl_math::sqr(-1.5) + vnl_math::sqr(2.2) +
             vnl_math::sqr(1.1) + vnl_math::sqr(2.15) + vnl_math::sqr(-2.1) + vnl_math::sqr(-0.8) + vnl_math::sqr(0.6);
  obj = lts1->fcn(test_lts.begin(), test_lts.end(), 0.0, nullptr);
