...
class null_m_est : public vrel_m_est_obj
{
 public:
  ...
  void wgt( vect_const_iter b, vect_const_iter e, vect_const_iter s, vect_iter w) const override { vrel_m_est_obj::wgt(b,e,s,w); }
  void wgt( vect_const_iter b, vect_const_iter e, double s, vect_iter w) const override { vrel_m_est_obj::wgt(b,e,s,w); }
};
