...
vrel_affine_est::
vrel_affine_est( const std::vector< vgl_point_2d<double> > & from_pts,
...
vrel_affine_est::vrel_affine_est(
...
void
vrel_affine_est::compute_residuals( const vnl_vector<double>& params,
