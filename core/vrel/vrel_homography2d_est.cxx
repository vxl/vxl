...
bool
vrel_homography2d_est :: fit_from_minimal_set( const std::vector<int>& point_indices,
...
void
vrel_homography2d_est :: compute_residuals( const vnl_vector<double>& params,
...
void
vrel_homography2d_est :: homog_to_params(const vnl_matrix<double>& m,
...
void
vrel_homography2d_est :: params_to_homog(const vnl_vector<double>& p,
