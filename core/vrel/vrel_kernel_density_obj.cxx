// This is core/vrel/vrel_kernel_density_obj.cxx
#include <iostream>
#include <algorithm>
...
vrel_kernel_density_obj::vrel_kernel_density_obj(
    vrel_kernel_scale_type scale_type)
    : scale_type_(scale_type)

{}

double
vrel_kernel_density_obj::fcn(vect_const_iter /*res_begin*/, vect_const_iter /*res_end*/,
                             vect_const_iter /*scale_begin*/,
                             vnl_vector<double>* /*param_vector*/ ) const
{
  std::cerr << "vrel_kernel_density_obj::fcn() not implemented\n";
  return 0;
}

double
vrel_kernel_density_obj::fcn(vect_const_iter res_begin,
...
double
vrel_kernel_density_obj::best_x(vect_const_iter res_begin,
                                vect_const_iter res_end,
...
double
vrel_kernel_density_obj::bandwidth(vect_const_iter res_begin, vect_const_iter res_end,
                                   double prior_scale) const
{
...
double
vrel_kernel_density_obj::kernel_density(vect_const_iter res_begin,
                                        vect_const_iter res_end,
                                        double x,
                                        double h) const
{
...
double
vrel_kernel_density_obj::kernel_function(double u) const
{
  if (vnl_math::abs(u) > 1)
    return 0;
