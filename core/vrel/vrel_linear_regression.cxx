...
vrel_linear_regression::vrel_linear_regression( const std::vector< vnl_vector<double> >& pts,
                                                bool use_intercept )
  : rand_vars_( pts.size() ),
    ind_vars_( pts.size() )
{
...
//
bool
vrel_linear_regression::fit_from_minimal_set( const std::vector<int>& point_indices,
...
void
vrel_linear_regression::compute_residuals( const vnl_vector<double>& params,
