// This is core/vrel/vrel_lms_obj.cxx
#include <iostream>
#include <algorithm>
#include <vector>
#include "vrel_lms_obj.h"
#include "vrel_util.h"
...
vrel_lms_obj::vrel_lms_obj(unsigned int num_sam_inst, double inlier_frac)
  : num_sam_inst_(num_sam_inst)
  , inlier_frac_(inlier_frac)
{}

vrel_lms_obj::~vrel_lms_obj() = default;


double
vrel_lms_obj::fcn(vect_const_iter begin,
                  vect_const_iter end,
...
double
vrel_lms_obj::scale(vect_const_iter begin, vect_const_iter end) const
{
  ...
  return vrel_util_median_abs_dev_scale(vec_copy.begin(), vec_copy.end(), num_sam_inst_);
}
