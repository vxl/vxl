#ifndef vrel_m_est_obj_h_
#define vrel_m_est_obj_h_
...
class vrel_m_est_obj : public vrel_wls_obj
{
public:
  //: Constructor.
  vrel_m_est_obj() = default;

  //: Destructor.
  ~vrel_m_est_obj() override = default;
