...
vrel_mlesac_obj::vrel_mlesac_obj(unsigned int residual_dof, double outlier_sigma, double outlier_frac)
...
double
vrel_mlesac_obj::fcn( vect_const_iter begin, vect_const_iter end,
