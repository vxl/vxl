...
bool operator< ( vrel_muse_key_type const& left_t, vrel_muse_key_type const& right_t )
{
...
void
vrel_muse_table::calculate_all( unsigned int k, unsigned int n,
                                vrel_muse_table_entry & entry )
{
...
double
vrel_muse_table::calculate_standard_dev( unsigned int k, unsigned int n,
...
double
vrel_muse_table::calculate_divisor( unsigned int /* k */, unsigned int n,
                                    double expected_kth ) const
{
...
double
vrel_muse_table::calculate_sq_divisor( unsigned int k, unsigned int n,
                                       double expected_kth ) const
{
