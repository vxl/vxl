#ifndef vrel_ran_sam_search_h_
#define vrel_ran_sam_search_h_
//:
// \file
...
//  The code organization follows the design of the vrel
...
//  See discussion in vrel_estimation_problem.
//
