...
vrel_shift2d_est::vrel_shift2d_est(const std::vector<vgl_homg_point_2d<double>> & from_pts,
                                   const std::vector<vgl_homg_point_2d<double>> & to_pts)
  : vrel_estimation_problem(2 /*dof*/, 1 /*points to instantiate*/)
{
...
vrel_shift2d_est::vrel_shift2d_est(std::vector<vnl_vector<double>> from_pts, std::vector<vnl_vector<double>> to_pts)
  : vrel_estimation_problem(2 /*dof*/, 1 /*points to instantiate*/)
...
vrel_shift2d_est::~vrel_shift2d_est() = default;

unsigned int
vrel_shift2d_est::num_samples() const
{
...
void
vrel_shift2d_est::compute_residuals(const vnl_vector<double> & params, std::vector<double> & residuals) const
{
...
bool
vrel_shift2d_est::weighted_least_squares_fit(vnl_vector<double> & params,
...
void
vrel_shift2d_est::compute_del_pts()
{
  ...
  for (unsigned i = 0; i < from_pts_.size(); i++)
  {
    ...
    del[0] = to_pts_[i][0] / to_pts_[i][2] - from_pts_[i][0] / from_pts_[i][2];
    del[1] = to_pts_[i][1] / to_pts_[i][2] - from_pts_[i][1] / from_pts_[i][2];
