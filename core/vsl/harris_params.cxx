...
// -- Make default harris_params object
harris_params::harris_params() 
{
  set_defaults();
}

harris_params::harris_params(int corner_count_max_, 
			     float gauss_sigma_)
{
  set_defaults();
...
void harris_params::set_defaults()
{
  verbose = true;
  col_start_index = 0;
  row_start_index = 0;
...
void harris_params::set_adaptive(int corner_count_low_,
