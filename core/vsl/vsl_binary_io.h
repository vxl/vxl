...
public:
  ...
  add_serialisation_record(void * pointer, int other_data = 0);

  //: Returns a unique identifier for the object.
  // Returns 0 if there is no record of the object.
  virtual unsigned long
  get_serial_number(void * pointer) const;
...
bool
vsl_b_istream_test(std::istream & is);
...
public:
  ...
  virtual void
  add_serialisation_record(unsigned long serial_number, void * pointer, int other_data = 0);

  //: Returns the pointer to the object identified by the unique serial number.
  // Returns 0 if no record has been added.
  virtual void *
  get_serialisation_pointer(unsigned long serial_number) const;

  //: Returns the user defined data associated with the unique serial number
  // Returns 0 if no record has been added.
  virtual int
  get_serialisation_other_data(unsigned long serial_number) const;

  //: Modify the user-defined data associated with the unique serial number
  // If there is no record of the object, this function will abort.
  virtual int
  set_serialisation_other_data(unsigned long serial_number, int other_data);
...
public:
  ...
  vsl_b_ifstream(const std::string & filename, std::ios::openmode mode = std::ios::in)
    : vsl_b_istream(new std::ifstream(filename.c_str(), mode | std::ios::binary))
  {}
...
void
vsl_b_write(vsl_b_ostream & os, bool b);
...
void
vsl_b_write(vsl_b_ostream & os, char n);
//: Read char from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, char & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, char n)
{
  os << n;
}
...
void
vsl_b_write(vsl_b_ostream & os, signed char n);
//: Read  signed char from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, signed char & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, signed char n)
{
  os << n;
}
...
void
vsl_b_write(vsl_b_ostream & os, unsigned char n);
//: Read  from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, unsigned char & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, unsigned char n)
{
  os << n;
}
...
//: Write  to vsl_b_ostream
void
vsl_b_write(vsl_b_ostream & os, const std::string & n);
//: Read  from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, std::string & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, const std::string & n)
{
  os << n;
}
...
void
vsl_b_write(vsl_b_ostream & os, const char * s);
//: Read  from vsl_b_istream
// \deprecated in favour of std::string version.
...
void
vsl_b_read(vsl_b_istream & is, char * s);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, const char * s)
{
  os << s;
}
...
//: Write  to vsl_b_ostream
void
vsl_b_write(vsl_b_ostream & os, int VCL_64BIT_ATTR n);
//: Read  from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, int VCL_64BIT_ATTR & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, int VCL_64BIT_ATTR n)
{
  os << int(n);
}
...
//: Write  to vsl_b_ostream
void
vsl_b_write(vsl_b_ostream & os, unsigned int n);
//: Read  from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, unsigned int & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, unsigned int n)
{
  os << n;
}
...
//: Write  to vsl_b_ostream
void
vsl_b_write(vsl_b_ostream & os, short n);
//: Read  from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, short & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, short n)
{
  os << n;
}
...
//: Write  to vsl_b_ostream
void
vsl_b_write(vsl_b_ostream & os, unsigned short n);
//: Read  from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, unsigned short & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, unsigned short n)
{
  os << n;
}
...
//: Write  to vsl_b_ostream
void
vsl_b_write(vsl_b_ostream & os, long n);
//: Read  from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, long & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, long n)
{
  os << n;
}
...
//: Write  to vsl_b_ostream
void
vsl_b_write(vsl_b_ostream & os, unsigned long n);
//: Read  from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, unsigned long & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, unsigned long n)
{
  os << n;
}
...
//: Write  to vsl_b_ostream
void
vsl_b_write(vsl_b_ostream & os, vxl_int_64 n);
//: Read  from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, vxl_int_64 & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, vxl_int_64 n)
{
  os << n;
}
...
//: Write  to vsl_b_ostream
void
vsl_b_write(vsl_b_ostream & os, vxl_uint_64 n);
//: Read  from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, vxl_uint_64 & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, vxl_uint_64 n)
{
  os << n;
}
...
void
vsl_b_write(vsl_b_ostream & os, float n);
//: Read  from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, float & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, float n)
{
  os << n;
}
...
void
vsl_b_write(vsl_b_ostream & os, double n);
//: Read  from vsl_b_istream
void
vsl_b_read(vsl_b_istream & is, double & n);
//: Print to a stream
inline void
vsl_print_summary(std::ostream & os, double n)
{
  os << n;
}
