...
vsl_block_t
allocate_up_to(std::size_t nbytes)
{
...
vsl_block_binary_read_int_impl(vsl_b_istream & is, T * begin, std::size_t nelems)
{
  ...
  if (block.size == nbytes)
  {
    ...
    n_bytes_converted = vsl_convert_from_arbitrary_length((unsigned char *)block.ptr, begin, nelems);
  }
...
template void
vsl_block_binary_write_float_impl(vsl_b_ostream &, const double *, std::size_t);
template void
vsl_block_binary_write_float_impl(vsl_b_ostream &, const float *, std::size_t);

template void
vsl_block_binary_read_float_impl(vsl_b_istream &, double *, std::size_t);
template void
vsl_block_binary_read_float_impl(vsl_b_istream &, float *, std::size_t);

template void
vsl_block_binary_write_int_impl(vsl_b_ostream &, const long *, std::size_t);
template void
vsl_block_binary_write_int_impl(vsl_b_ostream &, const unsigned long *, std::size_t);
template void
vsl_block_binary_write_int_impl(vsl_b_ostream &, const int *, std::size_t);
template void
vsl_block_binary_write_int_impl(vsl_b_ostream &, const unsigned int *, std::size_t);
template void
vsl_block_binary_write_int_impl(vsl_b_ostream &, const short *, std::size_t);
template void
vsl_block_binary_write_int_impl(vsl_b_ostream &, const unsigned short *, std::size_t);

template void
vsl_block_binary_read_int_impl(vsl_b_istream &, long *, std::size_t);
template void
vsl_block_binary_read_int_impl(vsl_b_istream &, unsigned long *, std::size_t);
template void
vsl_block_binary_read_int_impl(vsl_b_istream &, int *, std::size_t);
template void
vsl_block_binary_read_int_impl(vsl_b_istream &, unsigned int *, std::size_t);
template void
vsl_block_binary_read_int_impl(vsl_b_istream &, short *, std::size_t);
template void
vsl_block_binary_read_int_impl(vsl_b_istream &, unsigned short *, std::size_t);

template void
vsl_block_binary_write_byte_impl(vsl_b_ostream &, const signed char *, std::size_t);
template void
vsl_block_binary_write_byte_impl(vsl_b_ostream &, const unsigned char *, std::size_t);

template void
vsl_block_binary_read_byte_impl(vsl_b_istream &, signed char *, std::size_t);
template void
vsl_block_binary_read_byte_impl(vsl_b_istream &, unsigned char *, std::size_t);

#if VXL_INT_64_IS_LONGLONG
template void
vsl_block_binary_write_int_impl(vsl_b_ostream &, const vxl_int_64 *, std::size_t);
template void
vsl_block_binary_write_int_impl(vsl_b_ostream &, const vxl_uint_64 *, std::size_t);
template void
vsl_block_binary_read_int_impl(vsl_b_istream &, vxl_int_64 *, std::size_t);
template void
vsl_block_binary_read_int_impl(vsl_b_istream &, vxl_uint_64 *, std::size_t);
