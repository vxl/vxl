...
VCL_VC60_STATIC inline void vsl_block_binary_write(vsl_b_ostream &os, const double* begin, unsigned nelems)
{
...
// block being read.
VCL_DEFINE_SPECIALIZATION
VCL_VC60_STATIC inline void vsl_block_binary_write(vsl_b_ostream &os, const float* begin, unsigned nelems)
{
  vsl_b_write(os, true); // Error check that this is a specialised version
...
VCL_DEFINE_SPECIALIZATION
VCL_VC60_STATIC inline void vsl_block_binary_write(vsl_b_ostream &os, const int* begin, unsigned nelems)
{
  vsl_b_write(os, true); // Error check that this is a specialised version
...
// size of the block being read.
VCL_DEFINE_SPECIALIZATION
VCL_VC60_STATIC inline void vsl_block_binary_write(vsl_b_ostream &os, const unsigned int* begin, unsigned nelems)
{
  vsl_b_write(os, true); // Error check that this is a specialised version
...
// size of the block being read.
VCL_DEFINE_SPECIALIZATION
VCL_VC60_STATIC inline void vsl_block_binary_write(vsl_b_ostream &os, const short* begin, unsigned nelems)
{
  vsl_b_write(os, true); // Error check that this is a specialised version
...
// size of the block being read.
VCL_DEFINE_SPECIALIZATION
VCL_VC60_STATIC inline void vsl_block_binary_write(vsl_b_ostream &os, const unsigned short* begin, unsigned nelems)
{
  vsl_b_write(os, true); // Error check that this is a specialised version
...
// size of the block being read.
VCL_DEFINE_SPECIALIZATION
VCL_VC60_STATIC inline void vsl_block_binary_write(vsl_b_ostream &os, const long* begin, unsigned nelems)
{
  vsl_b_write(os, true); // Error check that this is a specialised version
...
// size of the block being read.
VCL_DEFINE_SPECIALIZATION
VCL_VC60_STATIC inline void vsl_block_binary_write(vsl_b_ostream &os, const unsigned long* begin, unsigned nelems)
{
  vsl_b_write(os, true); // Error check that this is a specialised version
...
template <class T>
VCL_VC60_STATIC inline void vsl_block_binary_write(vsl_b_ostream &os, const T* begin, unsigned nelems)
{
