...
//             to output an vsl_EdgelGroup which bundles edgel chains and
...
//                       up to vsl_EdgeDetectorParams and added new syle
...
class vsl_edge_detector : public vsl_edge_detector_params {
public:
  vsl_edge_detector(vsl_edge_detector_params const &);
...
private:
  ...
  void Fill_holes();
  void Thin_edges();
  void Follow_curves(vcl_list<vsl_Edge*>*);
