...
public:
  vsl_harris_params();
  vsl_harris_params(int max_corners_max, float gauss_sigma);
  vsl_harris_params(int max_corners_max, float gauss_sigma, float relative_minimum, float scale_factor);
