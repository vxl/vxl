...
bool vtol_zero_chain_3d::operator== (vtol_zero_chain_3d & z2)
{
  ...
  topology_list_3d *inf2 = z2.get_inferiors();
  vtol_topology_object_3d *v1, *v2;

  
  if (inf1->size() == inf2->size())
    {
      topology_list_3d::iterator i1,i2;
...
bool vtol_zero_chain_3d::operator==(vsol_spatial_object_3d& obj)
{
  /* need to fix 
 
  if ((obj.get_spatial_type() == vsol_spatial_object_3d::TOPOLOGYOBJECT) &&
      (((vtol_topology_object_3d &)obj).get_topology_type() == vtol_topology_object_3d::ZEROCHAIN))
