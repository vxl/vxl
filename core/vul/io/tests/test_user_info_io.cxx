...
test_user_info_io()
{
  ...
  TEST("p_out == p_in",
       p_out.uid == p_in.uid && p_out.gid == p_in.gid && p_out.name == p_in.name &&
         p_out.home_directory == p_in.home_directory && p_out.full_name == p_in.full_name &&
         p_out.shell == p_in.shell && p_out.passwd == p_in.passwd,
       true);
