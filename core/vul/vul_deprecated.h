#ifndef vul_deprecated_h_
#define vul_deprecated_h_
...
// a debugger!
  ...
  void vul_deprecated_warn( const char* func_name );
  void vul_deprecated_abort( const char* func_name );
  #ifdef VXL_WARN_DEPRECATED_ABORT
    #define VXL_DEPRECATED(f) vul_deprecated_abort( f )
  #else
    #ifdef VXL_WARN_DEPRECATED_ONCE
      #define VXL_DEPRECATED(f) static bool vul_deprecated_flag = true; \
                                if( vul_deprecated_flag ) {vul_deprecated_warn( f ); vul_deprecated_flag=false;}
    #else
      #define VXL_DEPRECATED(f) vul_deprecated_warn( f )
    #endif
  #endif
#else
