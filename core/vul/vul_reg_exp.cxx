...
reginsert(char, char *);
static void
regtail(char *, const char *);
static void
regoptail(char *, const char *);
...
//
static void
regoptail(char * p, const char * val)
{
...
//
static int
regtry(const char *, const char **, const char **, const char *);
static int
regmatch(const char *);
static int
regrepeat(const char *);
...
bool
vul_reg_exp::find(std::string const & s)
{
  return find(s.c_str());
}
