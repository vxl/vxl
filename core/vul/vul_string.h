...
extern char *
vul_string_c_upcase(char *);
//: Converts all alphabetical characters to lowercase.
extern char *
vul_string_c_downcase(char *);
//: Capitalizes all words in a string.
// A word is defined as a sequence of characters separated by
// non-alphanumerics.
extern char *
vul_string_c_capitalize(char *);
//: Removes any occurrences of rem from str, and returns the modified string.
extern char *
vul_string_c_trim(char * str, const char * rem);
//: Removes any prefix occurrence of rem from str and returns modified string.
extern char *
vul_string_c_left_trim(char * str, const char * rem);
//: Removes any suffix occurrence of rem from str and returns modified string.
extern char *
vul_string_c_right_trim(char * str, const char * rem);
//: Reverses the order of the characters in string.
extern char *
vul_string_c_reverse(char *);

// std::string functions:

//: Converts all alphabetical characters to uppercase.
extern std::string &
vul_string_upcase(std::string &);
//: Converts all alphabetical characters to lowercase.
extern std::string &
vul_string_downcase(std::string &);
//: Capitalizes all words in string.
extern std::string &
vul_string_capitalize(std::string &);
//: Removes any occurrences of rem from str and returns modified string
extern std::string &
vul_string_trim(std::string &, const char *);
//: Removes any prefix occurrence of rem from str and returns modified string
extern std::string &
vul_string_left_trim(std::string &, const char *);
//: Removes any suffix occurrence of rem from str and returns modified string
extern std::string &
vul_string_right_trim(std::string &, const char *);
//: Reverses the order of the characters in string
extern std::string &
vul_string_reverse(std::string &);

//: Reads an integer from a string
extern int
vul_string_atoi(const std::string &);
