...
#   endif
    ...
    using element_type = Scalar; // Deprecate for vnl removal


    // Return the length, number of elements, dimension of this vector.
    inline unsigned long Size() const { return static_cast<unsigned long> (this->size() ); }

    template<typename OtherDerived>
    bool is_equal( Eigen::MatrixBase<OtherDerived> const& rhs, const double tol) const
    {
    ...
    inline Scalar get(size_t i) const
    {
      return this->operator()(i);
    }

    inline Scalar get(size_t r, size_t c) const
    {
    ...
    inline void put(size_t i, Scalar const & v)
    {
      this->operator()(i) = v; // Assign data value
    }

    inline void put(size_t r, size_t c, Scalar const & v)
    {
      this->operator()(r, c) = v; // Assign data value
    }


    inline Scalar front() const
    {
      return *(this->begin());
    }

    inline Scalar back() const
    {
      return *(this->end()--);
    }

    inline bool set_size(size_t n)
    {
      this->resize(n);
      return true;
    }

    inline bool set_size(size_t r, size_t c)
    {
      this->resize(r, c);
      return true;
    }
    ...
    {
      return vnl_c_vector<Scalar>::one_norm(this->array().data(), this->size());
    }
    ...
    {
      this->array();
      return vnl_c_vector<Scalar>::two_norm(this->array().data(), this->size());
    }
    ...
    {
      return vnl_c_vector<Scalar>::inf_norm(this->array().data(), this->size());
    }
