...
build_ycc_rgb_table (j_decompress_ptr cinfo)
{
  ...
  cconvert->Cb_b_tab = (int *)
    (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, JPOOL_IMAGE,
				(MAXJSAMPLE+1) * SIZEOF(int));
  cconvert->Cr_g_tab = (jpegINT32 *)
    (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, JPOOL_IMAGE,
				(MAXJSAMPLE+1) * SIZEOF(jpegINT32));
  cconvert->Cb_g_tab = (jpegINT32 *)
    (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, JPOOL_IMAGE,
				(MAXJSAMPLE+1) * SIZEOF(jpegINT32));
		 ...
		 JSAMPARRAY output_buf, int num_rows)
{
  ...
  register jpegINT32 * Crgtab = cconvert->Cr_g_tab;
  register jpegINT32 * Cbgtab = cconvert->Cb_g_tab;
  SHIFT_TEMPS
