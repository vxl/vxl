 ...
 * intermediate jpegINT32 array would be needed.)
 *
...
{
  jpegINT32 tmp0, tmp1, tmp2, tmp3;
  jpegINT32 tmp10, tmp11, tmp12, tmp13;
  jpegINT32 z1, z2, z3, z4, z5;
  JCOEFPTR inptr;
  ...
  for (ctr = 0; ctr < DCTSIZE; ctr++) {
    ...
    z2 = (jpegINT32) wsptr[2];
    z3 = (jpegINT32) wsptr[6];
    
    z1 = MULTIPLY(z2 + z3, FIX_0_541196100);
    tmp2 = z1 + MULTIPLY(z3, - FIX_1_847759065);
    tmp3 = z1 + MULTIPLY(z2, FIX_0_765366865);
    
    tmp0 = ((jpegINT32) wsptr[0] + (jpegINT32) wsptr[4]) << CONST_BITS;
    tmp1 = ((jpegINT32) wsptr[0] - (jpegINT32) wsptr[4]) << CONST_BITS;
    ...
    tmp0 = (jpegINT32) wsptr[7];
    tmp1 = (jpegINT32) wsptr[5];
    tmp2 = (jpegINT32) wsptr[3];
    tmp3 = (jpegINT32) wsptr[1];
