...
/* Subroutine */ int dtgex2_(wantq, wantz, n, a, lda, b, ldb, q, ldq, z__, 
...
integer *lwork, *info;
{
    ...
    extern /* Subroutine */ int dlagv2_(), dgeqr2_(), dgerq2_(), dorg2r_(), 
	    dorgr2_(), dorm2r_(), dormr2_();
    static doublereal be[2], ai[2];
    extern /* Subroutine */ int dtgsy2_();
    static doublereal ar[2], sa, sb, li[16]	/* was [4][4] */;
    extern doublereal dlamch_();
    static doublereal dscale, ir[16]	/* was [4][4] */, ss, ws;
    extern /* Subroutine */ int dlacpy_(), dlartg_(), dlassq_();
