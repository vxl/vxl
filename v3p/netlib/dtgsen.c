...
/* Subroutine */ int dtgsen_(ijob, wantq, wantz, select, n, a, lda, b, ldb, 
	alphar, alphai, beta, q, ldq, z__, ldz, m, pl, pr, dif, work, lwork, 
	iwork, liwork, info)
integer *ijob;
...
integer *lwork, *iwork, *liwork, *info;
{
    ...
    extern /* Subroutine */ int dlacpy_(), xerbla_(), dtgexc_(), dlassq_();
