# Microsoft Developer Studio Project File - Name="showme" - Package Owner=<4>
...
# showme  == name of output library
#  /libpath:"$(VXLROOT)/v3p/netlib/$(OUTDIR)"  "netlib.lib" /STACK:10000000  == libraries linked in 
# TARGTYPE "Win32 (x86) Application" 0x0103

CFG=showme - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "showme.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "showme.mak" CFG="showme - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "showme - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "showme - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vxl" /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vcl/config.win32-VC60"    -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "showme_EXPORTS"
...
# Name "showme - Win32 Release"
# Name "showme - Win32 Debug"
