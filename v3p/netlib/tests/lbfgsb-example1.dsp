# Microsoft Developer Studio Project File - Name="lbfgsb-example1" - Package Owner=<4>
...
# lbfgsb-example1  == name of output library
#  /libpath:"$(VXLROOT)/v3p/netlib/$(OUTDIR)" "netlib.lib" /STACK:10000000  == libraries linked in 
# TARGTYPE "Win32 (x86) Application" 0x0103

CFG=lbfgsb-example1 - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "lbfgsb-example1.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "lbfgsb-example1.mak" CFG="lbfgsb-example1 - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "lbfgsb-example1 - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "lbfgsb-example1 - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "lbfgsb-example1 - Win32 Release"
...
# ADD CPP /I "$(VXLROOT)/vcl/config.win32" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "lbfgsb-example1_EXPORTS"
...
!ELSEIF  "$(CFG)" == "lbfgsb-example1 - Win32 Debug"
...
# Name "lbfgsb-example1 - Win32 Release"
# Name "lbfgsb-example1 - Win32 Debug"

# Begin Group "Source Files"
# PROP Default_Filter "c"
# Begin Source File
SOURCE=.\lbfgsb-example1.c
# End Source File
# End Group
# End Target
# End Project
