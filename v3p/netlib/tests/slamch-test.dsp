# Microsoft Developer Studio Project File - Name="slamch_test" - Package Owner=<4>
...
# slamch_test  == name of output library
#  /libpath:"$(VXLROOT)/v3p/netlib/$(OUTDIR)" "netlib.lib" /STACK:10000000  == libraries linked in 
# TARGTYPE "Win32 (x86) Application" 0x0103

CFG=slamch_test - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "slamch_test.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "slamch_test.mak" CFG="slamch_test - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "slamch_test - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "slamch_test - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "slamch_test - Win32 Release"
...
# ADD CPP /I "$(VXLROOT)/vcl/config.win32" -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "slamch_test_EXPORTS"
...
!ELSEIF  "$(CFG)" == "slamch_test - Win32 Debug"
...
# Name "slamch_test - Win32 Release"
