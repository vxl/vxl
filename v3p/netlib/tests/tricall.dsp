# Microsoft Developer Studio Project File - Name="tricall" - Package Owner=<4>
...
# tricall  == name of output library
#  /libpath:"$(VXLROOT)/v3p/netlib/$(OUTDIR)"  "netlib.lib" /STACK:10000000  == libraries linked in 
# TARGTYPE "Win32 (x86) Application" 0x0103

CFG=tricall - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "tricall.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "tricall.mak" CFG="tricall - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "tricall - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "tricall - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD CPP /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vxl" /I "$(VXLROOT)/vcl" /I "$(VXLROOT)/vcl/config.win32-VC60"    -DVXL_WARN_DEPRECATED -DVXL_WARN_DEPRECATED_ONCE /D "tricall_EXPORTS"
...
!ELSEIF  "$(CFG)" == "tricall - Win32 Debug"
...
# Name "tricall - Win32 Release"
# Name "tricall - Win32 Debug"
