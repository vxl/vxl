...
extern PNG_EXPORT(png_const_charp,png_get_copyright) PNGARG((png_structp png_ptr));
extern PNG_EXPORT(png_const_charp,png_get_header_ver) PNGARG((png_structp png_ptr));
extern PNG_EXPORT(png_const_charp,png_get_header_version) PNGARG((png_structp png_ptr));
extern PNG_EXPORT(png_const_charp,png_get_libpng_ver) PNGARG((png_structp png_ptr));
