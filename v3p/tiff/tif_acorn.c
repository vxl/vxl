...
extern os_error *xosgbpb_write (os_f file, byte *data, int size, int *unwritten);
...
extern os_error *xosgbpb_read (os_f file, byte *buffer, int size, int *unread);
...
extern os_error *xosfind_openout (bits flags, char *file_name, char *path, os_f *file);
...
extern os_error *xosfind_openup (bits flags, char *file_name, char *path, os_f *file);
extern os_f osfind_openup (bits flags, char *file_name, char *path);
...
extern os_error *xosargs_read_ptr (os_f file, int *ptr);
...
extern os_error *xosargs_set_ptr (os_f file, int ptr);
...
extern os_error *xosargs_read_ext (os_f file, int *ext);
