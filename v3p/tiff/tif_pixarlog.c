...
static void
horizontalAccumulateF(uint16 *wp, int n, int stride, float *op, float *ToLinearF)
{
...
static void
horizontalAccumulate12(uint16 *wp, int n, int stride, int16 *op, float *ToLinearF)
{
    register unsigned int  cr, cg, cb, ca, mask;
    register float  t0, t1, t2, t3;
...
static void
horizontalAccumulate16(uint16 *wp, int n, int stride, uint16 *op, uint16 *ToLinear16)
{
    register unsigned int  cr, cg, cb, ca, mask;
...
static void
horizontalAccumulate8(uint16 *wp, int n, int stride, unsigned char *op, unsigned char *ToLinear8)
{
    register unsigned int  cr, cg, cb, ca, mask;
...
static void
horizontalAccumulate8abgr(uint16 *wp, int n, int stride, unsigned char *op, unsigned char *ToLinear8)
{
    register unsigned int  cr, cg, cb, ca, mask;
