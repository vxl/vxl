...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "$(IUEROOT)\v3p\jpeg" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /D "JPEG_SUPPORT" /D "HAVE_IEEEFP" /D USE_VARARGS=0 /D "USE_PROTOTYPES" /D "USE_CONST" /YX /Zl /FD /GZ /c
