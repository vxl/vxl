...
//
//"vcl_vector.cc", line 164: Error: Overloading ambiguity between
//      "operator>>(istream&, vnl_matrix<signed char>&)"
// and
//      "operator>>(istream&, vnl_vector<signed char>&)".
// "vcl_vector.cc", line 173: Error: Overloading ambiguity between
//      "operator>>(istream&, vnl_matrix<signed char>&)"
// and
//      "operator>>(istream&, vnl_vector<signed char>&)".
//
