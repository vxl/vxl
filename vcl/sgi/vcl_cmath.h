...
inline long double vcl_atan2(long double y,long double x){return ::atan2(y, x);}
...
inline long double vcl_pow(long double x, long double a) { return ::pow(x, a); }
