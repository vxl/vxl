...
VCL_COPY_INSTANTIATE(vcl_deque<T >::iterator, std::back_insert_iterator<vcl_deque<T > >); \
VCL_COPY_INSTANTIATE(vcl_deque<T >::const_iterator, std::back_insert_iterator<vcl_deque<T > >); \
