...
template std::pair<vcl_list<T >::const_iterator, vcl_list<T >::const_iterator> std::mismatch(vcl_list<T >::const_iterator, vcl_list<T >::const_iterator, vcl_list<T >::const_iterator)
